...
Tencent Cloud 게임 멀티미디어 엔진 SDK의 사용을 환영합니다. Unity 개발자가 Tencent Cloud 게임 멀티미디어 엔진 제품 API를 디버깅하고 연결하는 데 도움이 되도록 여기에 Unity 개발에 적합한 액세스 기술 문서를 소개합니다.
...
팀 음성 액세스 세부 정보는 [GME 팀 음성](https://cloud.tencent.com/document/product/607/17972)을 참조하십시오
...
### 방 유형 변화 알림
사용자가 자발적으로 방 유형을 수정하거나 방 안의 다른 사용자가 방 유형을 수정하는 경우, 방 유형에 변화가 있으면 해당 콜백 함수는 호출되고 해당 콜백 함수를 통해 비즈니스 레이어에 방 유형 변화를 알리고 방 유형을 리턴합니다. EnterRoom 인터페이스를 참조합니다.
```
위탁 함수:
...
|매개변수    |값         |의미|
| ------------- |:-------------:|-------------|
| AUDIODEVICE_CAPTURE    	|1       	|캡처 장치|
| AUDIODEVICE_PLAYER   	 	|2 			|재생 장치|
