## 소개
Tencent Cloud 게임 멀티미디어 엔진 SDK의 사용을 환영합니다. Android 개발자가 Tencent Cloud 게임 멀티미디어 엔진 제품 API를 디버깅하고 연결하는 데 도움이 되도록 여기에 Android 개발에 적합한 액세스 기술 문서를 소개합니다.
...
| loopBack  	|boolean    	|믹스하여 발송 여부, 일반적으로 TRUE로 설정하며 즉, 다른 사람도 반주를 들을 수 있습니다.	|
