...
- Devices with enabled notification bar: number of devices whose notification bar is enabled to receive push messages.
- Devices with disabled notification bar: number of devices whose notification bar is disabled to receive push messages.
- Enabled notification bar ratio: number of devices with enabled notification bar/number of valid devices.
- Industry average: average enabled notification bar ratio of applications in the industry of your application (you can enter the product management page to view or modify the application's industry).
