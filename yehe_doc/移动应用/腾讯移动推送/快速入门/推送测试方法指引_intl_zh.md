...
| 备注 | 只能通过TPNS 通道测试,离线消息最多可以保存3条，保存时间最长为72小时  |
...
| 预期结果 | 消息提醒为自定义铃声 |
| 备注 | Android支持自定义声音、震动、呼吸灯。特别说明：(仅TPNS 通道支持自定义，厂商通道不支持)<br>iOS支持自定义声音 |
