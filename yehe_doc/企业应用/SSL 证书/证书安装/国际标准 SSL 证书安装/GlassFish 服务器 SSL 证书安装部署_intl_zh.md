...
2. 2. 在弹出的 “证书下载” 窗口中，服务器类型选择 **Apache**、**JKS**，单击**下载**并解压缩 `cloud.tencent.com` 证书文件包到本地目录。
...
3. 远程登录 GlassFish 服务器。例如，使用 [“PuTTY” 工具](https://intl.cloud.tencent.com/document/product/213/32502) 登录。
