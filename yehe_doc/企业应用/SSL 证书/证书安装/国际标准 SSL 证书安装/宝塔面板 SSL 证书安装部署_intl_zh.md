...
>- 安装 SSL 证书前，请您在服务器上开启 “443” 端口，避免证书安装后无法启用 HTTPS。具体可参考 [服务器如何开启443端口？](https://intl.cloud.tencent.com/document/product/1007/36738)


## 前提条件
- 已下载 SSL 证书压缩包至本地计算机。  
- 以宝塔 Linux 面板 7.7.0 为例，已登录宝塔 Web 面板。
...
>
1. 请在弹出的 “站点修改” 窗口，单击开启**强制 HTTPS** 即可完成配置。
