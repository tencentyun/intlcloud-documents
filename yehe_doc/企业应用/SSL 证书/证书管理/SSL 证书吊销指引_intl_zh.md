...
<tr><td>重颁发后的证书不能进行吊销操作。如需吊销，需吊销原证书，重颁发证书与原证书将一同自动吊销。</td></tr>
<tr><td>签发时间在2020年3月25日前暂无法使用自主吊销功能，如需吊销请通过 <a href="https://intl.cloud.tencent.com/contact-sales">在线咨询</a> 联系客服进行处理。</td></tr>
</table>
...
>- 若此证书采用 DNS 验证的方式，请在3天内添加 DNS 解析记录，否则此次吊销操作将会失败，扫描认证通过后证书即可被吊销。
