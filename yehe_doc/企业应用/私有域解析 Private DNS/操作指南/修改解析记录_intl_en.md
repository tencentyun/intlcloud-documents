...
2. In the **Private Domain List**, select the domain for which you want to modify a record or click **Records** in the **Operation** column to enter its **Records** page as shown below:
