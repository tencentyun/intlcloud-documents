...
如果您希望添加的私有域解析记录既可以解析在私有域内配置有解析记录的私有域名，同时也可以解析在私有域解析内未配置的公共域名。请您开启 [子域名递归解析](https://intl.cloud.tencent.com/document/product/1097/40566) 功能。
...
因此在关联 VPC 之前，请务必将正在访问的域名先添加至私有域内，具体操作请参考 [创建私有域](https://intl.cloud.tencent.com/document/product/1097/40558)。
...
>?添加解析记录可参考 [解析记录设置](https://intl.cloud.tencent.com/document/product/1097/40569)。
>
| 私有域 | 记录类型 | 记录值 | TTL | 
|---------|---------|---------|---------|
