...
- 按私有域数量计费： **每个私有域/0.015美元/天**
- 按解析请求量计费： **0.004美元/万次请求**

### 增值服务计费方式
基于“按量计费方式”基础，提供预付费增值服务。当账号下存在预付费“域名包/流量包”时，优先按预付费服务抵扣，超出部分按照后付费进行次日结算。详情请参见 [增值服务优惠包说明](https://www.tencentcloud.com/document/product/1097/50828)。
...
那么在 A 账号下，一天的使用费用为：**0.015美元* 3（3个私有域名的基础配置费） + 0.004美元 * 10 = 0.085 美元**
...
## 增值服务包抵扣
私有域解析 Private DNS 支持增值服务优惠包抵扣方式进行计费，登录 [私有域解析 Private DNS 增值购买页](https://buy.intl.cloud.tencent.com/privatedns) 即可查看对应收费项。
使用说明请参见 [增值服务优惠包使用说明](https://www.tencentcloud.com/document/product/1097/50828)。
