...
- 若授权 DNSPod 接入服务的全读写策略，示例如下：
	- 授权子账户的  DNSPod  服务的完全管理权限（创建、管理等全部操作）。
	- 策略名称：QcloudDNSPodFullAccess。
...
- 若授权 DNSPod 服务的只读权限，示例如下：
	- 授权子账户 DNSPod 服务的只读访问权限，即可以查看 DNSPod 服务所有资源的权限，但子账户无法创建、更新或删除资源。
	- 策略名称：QcloudDNSPodReadOnlyAccess。
