...
## 前期准备
1. 开通移动解析 HTTPDNS 服务，详情请参见 [开通移动解析 HTTPDNS](https://intl.cloud.tencent.com/document/product/1130/44461)。
2. 服务开通后，您需在移动解析 HTTPDNS 控制台添加解析域名才可正常使用，详情请参见 [添加域名](https://intl.cloud.tencent.com/document/product/1130/44465)。
4. 在移动解析 HTTPDNS 控制台申请接入 SDK，详情请参见 [开通 SDK](https://intl.cloud.tencent.com/document/product/1130/44474)。
...
使用 iOS SDK 需求获取的配置如下：
 ...
 -  **IOS APPID**： IOS 端 SDK 的 `appId（应用 ID）` 鉴权信息。
