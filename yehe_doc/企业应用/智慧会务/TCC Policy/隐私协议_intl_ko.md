...
<table>
  ...
  <td>로그 데이터 액세스로그: 페이지 주소, 페이지 제목, 사용자 ID, 플레이 상태, 재생 시간 </td>
   <td> 관련 서비스에 대한 페이지 보기를 보고하고 대시보드 데이터를 생성(<a href="https://intl.cloud.tencent.com/document/product/301/17347">텐센트 클라우드 컨퍼런스에 대한 데이터 개인 정보 보호 및 보안 계약에 설명됨, </a>하기 위해 이용합니다.  )</td>
