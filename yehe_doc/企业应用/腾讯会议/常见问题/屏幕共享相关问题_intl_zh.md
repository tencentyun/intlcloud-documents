...
#### 其他问题导致的黑或灰屏
如果确认不符合上述两种表现，您可以使用 [在线支持](https://intl.cloud.tencent.com/support) 进行处理，腾讯会议的维护人员会协助您定位并解决问题。
...
## 腾讯会议中无法共享特定软件的问题？
您可以在使用共享屏幕时，选择**共享桌面**即可，具体操作请参见 [共享屏幕](https://intl.cloud.tencent.com/document/product/1054/40879)。
...
可能与电脑或手机性能以及您所在网络环境有关，建议尝试清理电脑或断开并连接其他网络热点进行尝试，如长时间出现不流畅体验，请及时记录下问题并使用 [在线支持](https://intl.cloud.tencent.com/support) 进行处理。
