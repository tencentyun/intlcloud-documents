...
**PC 端**
在会议中下方菜单栏，选择**设置 > 虚拟背景和美颜**或者**应用 > 美颜**，在“美颜”板块选择最适合您的美颜效果。
...
1. VooV Meeting默认视频界面显示9名参会者，当您希望显示更多参会者视频画面时，可选择25人同屏。
...
### VooV Meeting是否支持将 A 会议室转播到 B 会议室？
...
`C:\Users\Windows用户名称\Documents\VooVMeeting\`
