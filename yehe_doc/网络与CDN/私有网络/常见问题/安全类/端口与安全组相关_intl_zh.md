## 端口相关
### 登录实例前，需要放通什么端口？
一般而言，对于 Linux 实例要放通22号端口，对于 Windows 实例需要放通3389号端口。更多适用于其他实例类型的端口请参考 [安全组应用案例](https://intl.cloud.tencent.com/document/product/215/35519)。
...
详细操作步骤，请参见 [添加安全组规则](https://intl.cloud.tencent.com/document/product/215/35513)。
...
更多端口说明，请参见 [服务器常用端口](https://intl.cloud.tencent.com/document/product/215/35520)。
...
- **解决方案**
 ...
 - 安全组具体设置规则，请参见 [安全组 - 安全组规则](https://intl.cloud.tencent.com/document/product/213/12452)。
...
支持通过 API 接口跨项目跨地域克隆安全组，详细请参见[ CloneSecurityGroup](https://intl.cloud.tencent.com/document/product/215/39444)。
