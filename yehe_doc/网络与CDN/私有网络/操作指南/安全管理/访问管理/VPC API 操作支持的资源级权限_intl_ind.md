...
er-collapse:
 ...
 <tr height=3D18 style=3D'height:13.5pt'>
  <td height=3D18 width=3D72 style=3D'height:13.5pt;width:54pt'>Operasi API</t=
d>
  <td width=3D72 style=3D'width:54pt'>Sumber daya</td>
  <td width=3D72 style=3D'width:54pt'>Ketentuan</td>
  <td width=3D72 style=3D'width:54pt'>Catatan</td>
 </tr>
...
none'>cPeeringConnection</span></td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya VPC<br>
    qcs::vpc:$region:$account:vpc/*<br>
    qcs::vpc:$region:$account:vpc/$vpcId</td>
  <td>vpc:regi<span style=3D'display:none'>on</span></td>
  <td colspan=3D3 style=3D'mso-ignore:colspan'>`vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
 </tr>
 <tr height=3D324 style=3D'height:243.0pt'>
  <td height=3D324 style=3D'height:243.0pt' >—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya koneksi peering<br>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:accepter_vpc` mewakili VPC penerima. Nilai ini adalah VPC penerima.<br>
    `vpc:requester_vpc` mewakili VPC inisiator. Nilai ini adalah VPC inisiator.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
 ...
 <tr height=3D216 style=3D'height:162.0pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya VPC<br>
    qcs::vpc:$region:$account:vpc/*<br>
    qcs::vpc:$region:$account:vpc/$vpcId (vpcId penerima)</td>
  <td>vpc:regi<span style=3D'display:none'>on</span></td>
  <td colspan=3D3 style=3D'mso-ignore:colspan'>`vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
 </tr>
...
none'>cPeeringConnectionEx</span></td>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:accepter_vpc` mewakili VPC penerima. Nilai ini adalah VPC penerima.<br>
    `vpc:accepter_vpc_region` mewakili wilayah penerima.<br>
    `vpc:requester_vpc` mewakili VPC inisiator. Nilai ini adalah VPC inisiator.<br>
    `vpc:requester_vpc_region` mewakili wilayah tempat inisiator berada.</td>
...
none'>nnEx</span></td>
 ...
 <tr height=3D216 style=3D'height:162.0pt'>
  <td height=3D216 style=3D'height:162.0pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya gateway VPN<br>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>

 </tr>
 <tr height=3D108 style=3D'height:81.0pt'>
  <td height=3D108 style=3D'height:81.0pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya gateway pelanggan<br>
 ...
 <tr height=3D198 style=3D'height:148.5pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya tunnel VPN<br>
    qcs::vpc:$region:$account:vpnx/*</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:vpngw<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
    `vpc:vpngw` mewakili gateway VPN developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
...
none'>ivateIpAddresses</span></td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya ENI<br>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    ...
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
    `vpc:subnet` merepresentasikan subnet developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
...
none'>eRouteTable</span></td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya subnet<br>
 ...
 <tr height=3D216 style=3D'height:162.0pt'>
  <td height=3D216 style=3D'height:162.0pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya tabel rute<br>
...
none'>assicLinkVpc</span></td>
 ...
 <tr height=3D234 style=3D'height:175.5pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya CVM<br>
  ...
  <td colspan=3D4 style=3D'mso-ignore:colspan'>`cvm:region` merepresentasikan wilayah tempat CVM berada.</td>
 </tr>
 <tr height=3D234 style=3D'height:175.5pt'>
...
none'>tworkInterface</span></td>
 ...
 <tr height=3D234 style=3D'height:175.5pt'>
  ...
  <td>cvm:regi<span style=3D'display:none'>on</span></td>
  <td colspan=3D4 style=3D'mso-ignore:colspan'>`cvm:region` merepresentasikan wilayah tempat CVM berada
.</td>
 </tr>
 <tr height=3D180 style=3D'height:135.0pt'>
...
none'>rectConnectGateway</span></td>
 ...
 <tr height=3D126 style=3D'height:94.5pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya gateway direct connect<br>
...
none'>tGateway</span></td>
 ...
 <tr height=3D126 style=3D'height:94.5pt'>
  <td height=3D126 style=3D'height:94.5pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya NAT gateway<br>
...
none'>tworkAcl</span></td>
 ...
 <tr height=3D126 style=3D'height:94.5pt'>
  <td height=3D126 style=3D'height:94.5pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya ACL jaringan<br>
...
none'>uteTable</span></td>
 ...
 <tr height=3D126 style=3D'height:94.5pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
    `vpc:region` merepresentasikan wilayah tempat VPC tersebut berada.</td>
...
none'>bnet</span></td>
 ...
 <tr height=3D126 style=3D'height:94.5pt'>
  <td height=3D126 style=3D'height:94.5pt'>—</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya gateway subnet<br>
    | Subnet | qcs::vpc:$region:$account:vpc/$vpcId |
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
...
none'>cPeeringConnection</span></td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya VPC (inisiator)<br>
    qcs::vpc:$region:$account:vpc/*<br>
    | VPC | qcs::vpc:$region:$account:vpc/$vpcId |
  <td>vpc:regi<span style=3D'display:none'>on</span></td>
  <td colspan=3D3 style=3D'mso-ignore:colspan'>`vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
...
none'>cPeeringConnectionEx</span></td>
 ...
 <tr height=3D432 style=3D'height:324.0pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:accepter_vpc<br>
    ...
    vpc:requester_vpc_region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:accepter_vpc` mewakili VPC penerima. Nilai ini adalah VPC penerima.<br>
    `vpc:accepter_vpc_region` mewakili wilayah tempat penerima berada.<br>
    `vpc:requester_vpc` mewakili VPC inisiator. Nilai ini adalah VPC inisiator.<br>
    `vpc:requester_vpc_region` mewakili wilayah tempat inisiator berada.</td>
...
none'>nConn</span></td>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    ...
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>`vpc:vpc` mewakili VPC developer.<br>
    `vpc:vpngw` merepresentasikan gateway developer.<br>
    `vpc:usergw` merepresentasikan gateway pelanggan developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
...
none'>etworkInterface</span></td>
 ...
 <tr height=3D288 style=3D'height:216.0pt'>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>Sumber daya CVM<br>
    qcs::cvm:$region:$account:instance/*<br>
    qcs::cvm:$region:$account:instance/$instanceId(otorisasi diperlukan sebelum dan sesudah migrasi)</t=
d>
  <td>cvm:regi<span style=3D'display:none'>on</span></td>
  <td colspan=3D4 style=3D'mso-ignore:colspan'>`cvm:region` merepresentasikan wilayah tempat CVM berada
</td>
...
none'>rivateIpAddress</span></td>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:subnet<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc merepresentasikan VPC developer.<br>
    `vpc:subnet` merepresentasikan subnet developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
...
none'>ivateIpAddress</span></td>
  ...
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc<br>
    vpc:subnet<br>
    vpc:region</td>
  <td class=3Dxl65 width=3D72 style=3D'width:54pt'>vpc:vpc merepresentasikan VPC developer.<b=
r>
    `vpc:subnet` merepresentasikan subnet developer.<br>
    `vpc:region` mewakili wilayah tempat VPC tersebut berada.</td>
