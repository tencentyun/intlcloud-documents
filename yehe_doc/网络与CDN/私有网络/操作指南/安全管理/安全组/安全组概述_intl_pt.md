...
## Limites de uso
Para mais informações sobre as restrições e cotas de grupos de segurança, consulte [Visão geral dos limites de uso](https://intl.cloud.tencent.com/document/product/213/15379).
...
- Origem ou destino: o IP de origem para uma regra de entrada ou o IP de destino para uma regra de saída. Pode ser um endereço IP, um intervalo de IP ou um grupo de segurança. Para mais informações, consulte [Adição de uma regra de grupo de segurança](https://intl.cloud.tencent.com/document/product/215/35513).
