...
## Limites de uso
Para obter mais informações sobre as restrições e cotas de grupos de segurança, consulte [Visão geral dos limites de uso](https://intl.cloud.tencent.com/document/product/213/15379).
