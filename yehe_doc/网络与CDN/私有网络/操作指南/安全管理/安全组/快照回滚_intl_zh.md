...
>?目前快照功能处于灰度使用中，如有需要请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
>

## 前提条件
安全组配置[ 快照策略](https://intl.cloud.tencent.com/document/product/215/46788)，且至少完成了一次快照备份。
