...
**解决方法**：[添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，在 “类型” 中选择 “Linux 登录”，开通22号协议端口，放通 Linux SSH 登录。
...
**解决方法**：[添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，在 “类型” 中选择 “Windows 登录”，开通3389号协议端口，放通 Windows 远程登录。
...
**解决方法**：使用 ping 程序进行测试。即在 [添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，将 “类型” 选择为 “Ping”，开通 ICMP 协议端口，允许其他云服务器通过 ICMP 协议访问该云服务器。
...
**解决方法**：如需通过 Telnet 远程登录云服务器，则需在 [添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，配置以下安全组规则：
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
...
**解决方法**：如需通过通过 HTTP 或者 HTTPS 的方式访问网站，则需在 [添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，根据实际需求配置以下安全组规则：
- 允许公网上的所有 IP 访问该网站
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
...
**解决方法**：[添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，在 “类型” 中选择 “自定义”，开通1101号协议端口，允许外部访问指定的业务端口。
...
**解决方法**：[添加入站规则](https://intl.cloud.tencent.com/document/product/215/35513) 时，在 “类型” 中选择 “自定义”，配置1102号协议端口，将 “策略” 设置为 “拒绝”，拒绝外部访问指定的业务端口。
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
