...
>?
>- 广播和组播功能处于内测阶段，如有需要，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 
>- 目前支持组播和广播的地域为：北京、上海、广州、成都、重庆、南京、中国香港、新加坡、首尔、东京、孟买、曼谷、多伦多、硅谷、弗吉尼亚、法兰克福、莫斯科。
>
...
## 相关操作
私有网络维度的组播功能的操作指导请参考 [开启或关闭组播功能](https://intl.cloud.tencent.com/document/product/215/40072)。
