私有网络是使用云服务的基础，当一个地域未创建任何私有网络，在该地域创建云服务器、负载均衡或数据库时，您可以选择腾讯云为您自动创建默认私有网络和子网，而无需自行创建，如下图所示。
![](https://main.qcloudimg.com/raw/98878feb887075f6535eca50a76d3d0c.png)
实例创建成功后，一个默认的私有网络和子网也会随之创建成功，该默认私有网络和子网与您自行创建的私有网络和子网功能完全一致，且不占用您在某个地域下的配额，如果您不再需要可自行删除。一个地域只能有一个默认私有网络和子网。
...
如果默认私有网络不符合您的要求，或者您希望创建一个新的私有网络时，您可以参考本章节，在私有网络控制台新建私有网络。
...
可单击如下红框图标，直接跳转至云服务器购买页面进行购买，详情请参见 [快速搭建 IPv4 私有网络](https://intl.cloud.tencent.com/document/product/215/31891)。
