...
>?目前 HAVIP 产品处于灰度优化中，如有需要，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
...
常见配置案例请参考：
+ [最佳实践 - 用 HAVIP+Keepallved 搭建高可用主备集群](https://intl.cloud.tencent.com/document/product/215/31877)
+ [最佳实践 - 用 HAVIP + Windows Server Failover Cluster 搭建高可用 DB](https://intl.cloud.tencent.com/document/product/215/31878) 

## 相关文档
高可用虚拟 IP 与普通内网 IP 类似，均支持在控制台绑定或解绑 EIP，如果您有公网通信的需求，可参考 [绑定或解绑 EIP](https://intl.cloud.tencent.com/document/product/215/40083)，如无，可不绑定 EIP。
