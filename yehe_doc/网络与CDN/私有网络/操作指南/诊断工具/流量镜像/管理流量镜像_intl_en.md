...
1. Open the link you obtained after [submitting a ticket](https://console.cloud.tencent.com/workorder/category) and log in to the Traffic Mirror console. In the top **Region** selector, choose the region where the traffic mirror has been created.
2. Locate the traffic mirror to which you want to add tags, and click **Edit tags** under the **Operation** column.
3. In the pop-up dialog box, configure as follows:
...
1. Open the link you obtained after [submitting a ticket](https://console.cloud.tencent.com/workorder/category) and log in to the Traffic Mirror console. In the top **Region** selector, choose the region where the traffic mirror has been created.
2. Locate the traffic mirror to be deleted, click **Delete** under the **Operation** column, and confirm the deletion.
