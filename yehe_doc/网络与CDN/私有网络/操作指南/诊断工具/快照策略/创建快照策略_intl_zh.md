...
<tr>
<td>COS 桶名称</td>
<td>存储桶名称由<b>自定义名称 - 开发商 AppID</b> 构成。仅支持小写字母、数字和 - 的组合，域名字数总和不能超过60字符，存储桶名称一旦设置不能更改</td>
</tr>
</table>
4. 单击**确定**完成快照策略的配置。

## 后续操作
[关联安全组](https://intl.cloud.tencent.com/document/product/215/46790)