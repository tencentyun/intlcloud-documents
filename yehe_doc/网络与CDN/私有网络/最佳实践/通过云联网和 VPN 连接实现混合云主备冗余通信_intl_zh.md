...
>?更多详细配置请参考：
>+ 如果是1.0和2.0版本的 VPN 网关，请参考 [建立 VPC 到 IDC 的连接（SPD 策略）](https://intl.cloud.tencent.com/document/product/1037/39683)。
>+ 如果是3.0版本的 VPN 网关，请参考[ 建立 VPC 到 IDC 的连接（路由表）](https://intl.cloud.tencent.com/document/product/1037/39675)
