...
实践内容将结合使用腾讯云的新产品 [高可用虚拟 IP (HAVIP)](https://intl.cloud.tencent.com/document/product/215/31817)，并给出与组播相关的使用建议。
## 本文小引
...
- 腾讯云 VPC 内支持部署 keepalived 来搭建主备高可用集群，与物理网络相比，主要区别是：
 - 使用的 VIP 必须是从腾讯云申请的 [HAVIP](https://intl.cloud.tencent.com/document/product/215/31817)。
...
## 详细步骤
### 步骤1：申请 VIP
 申请 VIP 的详细操作步骤，请参见文档 [高可用虚拟 IP](https://intl.cloud.tencent.com/document/product/215/31817)。
