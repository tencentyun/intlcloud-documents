...
如下功能均免费使用：
- 基础功能：私有网络、子网、路由表。
- 其它功能：弹性网卡、安全组、网络 ACL、参数模板、[HAVIP](https://intl.cloud.tencent.com/document/product/215/31817)、网络探测、基础网络互通、组播、广播。
...
| 网络流日志		 | 网络流日志计费，请参见 [计费说明](https://intl.cloud.tencent.com/document/product/682/18963)。 | 
