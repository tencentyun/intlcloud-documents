...
## Notes
If your current cross-region dedicated tunnel meets any of the following cases, [submit a ticket](https://console.cloud.tencent.com/workorder/category) before migration:
...
3. On the **Basic configuration** page, set parameters as needed. 
![]()
>?
...
>
4. Click **Next**. On the **Advanced configuration** page displayed, enter the VLAN ID. 
![]()
>!
...
![]()
1. On the page displayed, enter the IDC IP range and click **Save**. 
![]()
...
1. Log in to the [CCN console](https://console.cloud.tencent.com/vpc/ccn), click **+ New**, set parameters as needed, and click **OK**. 
![]()
2. After the CCN instance is created, click the CCN instance ID on the CCN list page to enter the CCN instance details page. 
![]()
...
2. Click the test CCN instance ("ccn-msg8kju5" in this example) to enter the instance details page. Click the **Associated Instances** tab, click **Add an instance**, and set parameters as needed. 
![]()
