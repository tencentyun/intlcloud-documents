...
| 场景 | 操作|
|---------|---------|
| IDC 与腾讯云接入点不在同一机房 | 在腾讯云控制台申请物理专线，具体操作请参见 [申请物理专线](https://intl.cloud.tencent.com/document/product/216/19244)。同时，您需要联系符合专线接入审核标准的运营商进行需求沟通。 |
| IDC 与腾讯云接入点在同一机房| 在腾讯云控制台申请物理专线，具体操作请参见[ 申请物理专线](https://intl.cloud.tencent.com/document/product/216/19244)。 |
...
进行专线验收时，您需要完成创建整个专线接入线路，具体请参见[ 快速入门](https://intl.cloud.tencent.com/document/product/216/7557)。然后分别进行压测验收测试、时延测试、和可靠性测试。
