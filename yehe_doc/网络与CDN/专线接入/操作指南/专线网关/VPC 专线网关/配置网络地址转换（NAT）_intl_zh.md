...
>?本文仅是 V3R1 版本的 NAT 网络型专线网关网络地址转换指导，升级后的 V3R2 版本专线侧仅需在 [创建专线网关](https://intl.cloud.tencent.com/document/product/216/19256) 时绑定相应的私有 NAT 实例即可，其中 IP 映射关系需要在 NAT 侧进行配置
>
...
>
 ...
 5. （可选）如果您需修改本端 IP 映射，可在 IP 映射页中，单击 IP 映射所在行右侧的【修改 IP 映射】，即可修改本端 IP 映射的原 IP、映射 IP 和备注，单击**确定**后，IP 映射生效。
...
>
 ...
 5. （可选）如果您需修改映射 IP 池，可在映射 IP 池页中，单击映射 IP 池所在行右侧的**修改映射 IP 池**，即可修改该映射 IP 池的 IP 和备注。
