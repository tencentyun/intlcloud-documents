当专用通道状态为“已连接”后，您还可以在专线接入控制台进行变更通道参数、修改通道带宽等操作。本文将分别介绍通道1.0和通道2.0如何在控制台进行通道变更、修改带宽等操作。
...
## 修改通道带宽
- 专用通道 1.0
请在“通道变更”对话框中修改通道带宽，详情请参见[ 变更通道](https://intl.cloud.tencent.com/document/product/216/19251)。
- 专用通道 2.0
