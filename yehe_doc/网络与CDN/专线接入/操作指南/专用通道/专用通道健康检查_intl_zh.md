...
## 前提条件
- 在变更通道前，需已 [申请通道](https://intl.cloud.tencent.com/document/product/216/19250)。
- 专用通道已做主备。
...
## 创建通道过程中配置健康检查
1. 登录 [专线接入控制台](https://console.cloud.tencent.com/dc/conn-exclusive)，在左侧导航栏单击独享专用通道。
2. 在“专用通道”页面单击**新建**，然后在创建页面完成**基本配置**，并在**高级配置**中依据界面提示完成其他参数以及健康检查配置。
本节仅介绍健康检查如何配置，其他参数配置请参见 [独享专用通道](https://intl.cloud.tencent.com/document/product/216/48574) 或者 [共享专用通道](https://intl.cloud.tencent.com/document/product/216/48575)。
<table>
<tr>
<th width="20%">健康检查配置参数</th>
<th width="30%">含义</th>
