...
若需选择”专线网关“，则在 VPC 产品下选择。
 ...
 4. 选择以下任意一种方式设置告警触发条件。
    ...
    - 手动配置
    选择“手动配置”后请按需设置触发条件，如果需要新建指标，请单击“添加指标”。指标详情请参见 [告警指标说明](https://intl.cloud.tencent.com/document/product/216/38403)。
...
>
 ![]()
>?如果需要配置事件告警，请参见 [快速配置云监控事件告警推送](https://intl.cloud.tencent.com/document/product/1108/45202)。
4. 配置告警通知。
