...
3. 在“新建策略”页面进行以下配置：
 ...
 >?若您没有告警规则模板，请单击【新增触发条件模板】进行配置，具体配置请参见 [配置触发条件模板](https://intl.cloud.tencent.com/document/product/248/38911) 。若新建的模板没有显示，请单击右侧的【刷新】。
    - 手动配置
  选择“手动配置”后，请按需配置“指标告警”和“事件告警”。
       - 设置触发条件，如果需要新建指标，请单击“添加指标”。指标详情请参见[告警指标说明](https://intl.cloud.tencent.com/document/product/216/38403)。
 ...
 >
       - 勾选事件告警，则需选择具体事件，例如物理专线 Down。如果需要添加新的事件告警，请单击“添加事件”，事件详情请参见[告警事件说明](https://intl.cloud.tencent.com/document/product/216/38403)。
