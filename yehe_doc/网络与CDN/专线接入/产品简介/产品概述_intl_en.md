...
<td>Each link provides a bandwidth of up to 100 Gbps. You can have multiple 10 Gbps links for network load balancing, so it can theoretically support unlimited bandwidth.</td>
