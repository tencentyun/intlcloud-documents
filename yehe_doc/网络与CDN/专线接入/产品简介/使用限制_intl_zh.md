 ...
 **专线2.0**
 - `127.0.0.0/8`、 `224.0.0.0/4`、`240.0.0.0/4`、`255.255.255.255`、`169.254.0.0/16`（`169.254.64.0/23`除外）。
 - 边界 IP 所在网段的子网和网段内的 IP。如有互访需要，请[ 提交工单](https://console.cloud.tencent.com/workorder/category)开启“互联 IP 重分布”。
...
图中用户侧交换机 B 通过两条专线（专线1和专线2)连接腾讯云，分别与腾讯云侧交换机 A 和交换机 A1 相连。
