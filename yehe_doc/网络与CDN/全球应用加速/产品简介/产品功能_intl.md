...
## Obtaining real user IPs
- GAAP supports TOA module to obtain real user IPs, ensuring effective IP passthrough for data analysis purpose. For more information, please see [Obtaining the Real IPs of Access Users](https://intl.cloud.tencent.com/document/product/608/14429).
