...
3. Click **+New**. 
4. In the pop-up window, enter a name for the CCN instance and a description. Select billing mode, service level, bandwidth limit mode, and the ID of the VPC you want to associate with.![](	https://main.qcloudimg.com/raw/b72cc7c286f94d8b958def554dfc0150.png)
