...
2. 将 VPC1（广州）、VPC2（上海）与对应的云联网实例关联，具体操作请参见 [关联网络实例](https://intl.cloud.tencent.com/document/product/1003/30064)。
...
![](https://qcloudimg.tencent-cloud.cn/raw/83a1e5bde6e3250b39772f3fdb8a2f43.png)
	  具体迁移步骤如下：
		...
		2. 查看对等连接网络流量监控数据，具体操作请参见 [查看网络流量监控数据](https://intl.cloud.tencent.com/document/product/553/18842)。
...
![](https://qcloudimg.tencent-cloud.cn/raw/99c098e813feb896b44bee223827d625.png)
 ...
 由于路由根据最长掩码匹配原则转发，您需要先调整对等连接路由策略目的段，再手动开启云联网路由即可使其生效。具体迁移步骤如下：
      ...
      3. 查看对等连接网络流量监控数据，具体操作请参见 [查看网络流量监控数据](https://intl.cloud.tencent.com/document/product/553/18842)。
      >?若无流量从对等连接通过，即可删除对等连接。
