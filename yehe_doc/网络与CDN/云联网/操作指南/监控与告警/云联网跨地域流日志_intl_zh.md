...
>?
>+ 目前网络流日志处于内测中，如有需要，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
>+ 流日志本身不会产生费用，数据存储在日志服务中，将按日志服务的 [标准收费](https://intl.cloud.tencent.com/document/product/614/37509)。
...
<p><b>说明</b>：日志集和日志主题及索引的配置请参见 <a href="https://intl.cloud.tencent.com/document/product/682/18967">创建日志集和日志主题</a>。
</td>
</tr>
<tr>
<td>标签键</td>
...
>?字段解释请参见[ 附录](#appendix)，日志分析请参见[ 快速分析](https://intl.cloud.tencent.com/document/product/614/42002)。
...
|ccnid |text  |云联网唯一标识，如需确定云联网的信息请 [联系我们](https://intl.cloud.tencent.com/document/product/1003/41737)。 |
...
|log-status | text |流日志的日志记录状态：<br>OK：表示数据正常记录到指定目标。<br/> NODATA：表示捕获窗口中没有传入或传出网络流量，此时“packets”和“bytes”字段会显示为“-1”。 |
 ...
 ### 如何查看指定地域间流日志？
以上海地域为例，在上海地域开启流日志后，会采集以上海为源地域的所有出流量，以及以上海为目的地域的入流量，如需采集地域间流日志，您可以通过 CLS 的 srcregion 和 dstregion 来过滤出期望的流日志，详情可参考[ 上下文检索分析](https://intl.cloud.tencent.com/document/product/614/39795)。
