...
1. Log in to the [ENI console](https://console.cloud.tencent.com/vpc/eni?rid=1) and [bind the ENI to a CVM](https://intl.cloud.tencent.com/document/product/576/18535).
