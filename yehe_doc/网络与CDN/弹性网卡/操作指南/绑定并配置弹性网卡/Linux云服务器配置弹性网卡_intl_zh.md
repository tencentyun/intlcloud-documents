...
>+ 当云服务器已有弹性网卡时，例如主网卡，请务必确保存量弹性网卡的路由均已正确配置，再执行工具配置新弹性网卡；如可以接受云服务器重启对业务的影响，也可在配置完成后，参考[ 步骤5 ](#step5)重启云服务器使工具配置对所有网卡均生效。
...
#### 前提条件
已将弹性网卡绑定到云服务器，具体参考 [绑定弹性网卡](https://intl.cloud.tencent.com/document/product/576/18535)。
