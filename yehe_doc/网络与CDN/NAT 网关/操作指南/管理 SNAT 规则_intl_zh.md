...
>- NAT 网关支持将同一个 EIP 同时用于配置 SNAT 规则和端口转发规则，端口转发规则的详细信息请参考[管理端口转发规则](https://intl.cloud.tencent.com/document/product/1015/30237)。
>
...
## 前提条件
创建 SNAT 规则前，请确保子网所在的路由表需指向对应的 NAT 网关，详细操作请参见 [配置指向 NAT 网关的路由](https://intl.cloud.tencent.com/document/product/1015/30236)。
