...
>+ 流日志数据存储在日志服务 CLS 中，请确保已完成 [授权流日志访问 CLS 权限](https://intl.cloud.tencent.com/document/product/682/47040)，否则无法在 CLS 上查询到日志数据。
>
...
日志集和日志主题及索引的配置请参见 <a href="https://intl.cloud.tencent.com/document/product/682/18967">创建日志集和日志主题</a>。
</dx-alert>
</td>
</tr>
<tr>
...
5. 等待约6分钟后，单击**存储位置**，或**查看**进入日志服务的“检索分析”界面，选择要查看日志的地域，时间段等，单击**检索分析**，查看日志记录。
	...
	日志记录举例如下：
![]()
>?字段解释请参见[ 流日志记录](https://intl.cloud.tencent.com/document/product/682/18933)，日志分析请参见[ 快速分析](https://intl.cloud.tencent.com/document/product/614/42002)。
