...
>?由于标准协议限制，对于同一 [协议，目的IP，目的端口]，连接数上限 = 绑定的 EIP 数 * 55000，如需提升连接数，请新增绑定 EIP 或调整目的 IP/端口，目的 IP/端口。
>
...
费用详情请参见 [计费说明](https://intl.cloud.tencent.com/document/product/1015/30248)。
