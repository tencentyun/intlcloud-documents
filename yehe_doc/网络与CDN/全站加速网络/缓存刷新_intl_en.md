...
## Operation Guide
### How to use
Log in to the [ECDN Console](https://console.cloud.tencent.com/ecdn), click **Purge and Prefetch** on the left sidebar, and submit a **Purge URL** or **Purge Directory** task:
