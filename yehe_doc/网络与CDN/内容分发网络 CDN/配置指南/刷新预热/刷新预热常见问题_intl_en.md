...
- Purge: when there’re updates on the original server or domain name configuration, you can submit a purge task to make sure your users are served with the fresh resources and the domain name can be accessed normally. For more information, see [Purge Cache](https://intl.cloud.tencent.com/document/product/228/6299).
