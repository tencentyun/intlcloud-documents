...
>2. 每个环境中每次仅支持部署一个版本。
>3. URL 刷新功能会同时作用于生产环境和模拟环境，目录刷新和 URL 预热功能仅作用于生产环境。刷新预热功能介绍请参见 [刷新预热](https://intl.cloud.tencent.com/document/product/228/6299)。
>4. [带宽封顶配置](https://intl.cloud.tencent.com/document/product/228/7541) 等数据/用量监控功能仅作用于生产环境。
