...
Se um IP de cliente corresponder a um IP ou intervalo de IP na lista de bloqueio, o nó do CDN acessado retornará código de status 403 imediatamente.
**Lista de permissões de IP**
Se um IP de cliente não corresponder a nenhum IP ou intervalo de IP na lista de permissões, o nó do CDN acessado retornará diretamente um código de status 403.
...
2. Um usuário com o IP de cliente `2.1.1.1` acessa o recurso `http://www.test.com/test.txt`. Como o IP não corresponde a nenhum IP na lista de permissões, um código de status 403 será retornado.
