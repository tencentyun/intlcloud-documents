...
|Back-to-Origin of Range|	オン/オフの設定が可能です：<br>オン：Back-to-Origin of Rangeを有効にする場合、Back-to-Originリクエスト時にBack-to-Origin of Rangeリクエストが使用されます。<br>オフ：Back-to-Origin of Rangeを無効にする場合、Back-to-Originリクエスト時にBack-to-Origin of Rangeリクエストが使用されません。|
