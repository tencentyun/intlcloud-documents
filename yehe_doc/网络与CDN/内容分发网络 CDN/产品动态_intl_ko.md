...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| -------- | ------------------------------------------------------ | ---------- | ------------------------------------------------------------ |
|DNSPod CNAME 원클릭 설정 |Tencent Cloud CDN과 [DNSPod](https://console.dnspod.cn/)의 리졸브 설정 기능을 연결하였습니다. Tencent Cloud DNSPod에 호스팅된 도메인은 [CDN 콘솔](https://console.cloud.tencent.com/cdn/domains)을 통해 CNAME의 원클릭 설정이 가능합니다. 설정 작업 절차와 시간을 줄이고 빠르게 CDN 가속 서비스를 활성화할 수 있습니다. |2021-08-26|DNSPod CNAME 원클릭 설정|
...
|3rd party 버킷에 Origin-pull 지원|3rd party 버킷에 Origin-pull 지원(현재 AWS S3와 Alibaba Cloud OSS만 지원), Origin-pull 인증 활성화 지원.|2021-07-14|[원본 서버 설정](https://intl.cloud.tencent.com/document/product/228/6289)|
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| -------- | ------------------------------------------------------ | ---------- | ------------------------------------------------------------ |
|URL 퍼지/프리패치 일일 한도 원클릭 업그레이드 지원|URL 퍼지/프리패치 일일 잔여 한도가 적을 때, 한도 원클릭 업그레이드가 가능합니다.|2021-06-23 |[캐시 제거](https://intl.cloud.tencent.com/document/product/228/6299), [캐시 프리패치](https://intl.cloud.tencent.com/document/product/228/39000)|
...
| OCSP 스테이플링 설정            | OCSP 스테이플링 원클릭 일괄 설정을 전체 개방합니다. OCSP 스테이플링을 활성화하면 TLS 핸드셰이크 효율을 높일 수 있어 사용자 인증 시간을 단축할 수 있습니다. | 2020-06-30 | [OCSP 고정 설정](https://intl.cloud.tencent.com/document/product/228/35216) |
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| ----------------------------- | --------------------------------------------- | ---------- | ------------------------------------------------------------ |
| 글로벌 CDN <br>캐시 퍼지 기능 통합 | 중국 내/외 콘솔을 통합하여 CDN 캐시 퍼지 기능을 통합하였습니다. | 2019-11-14 | [캐시 제거](https://intl.cloud.tencent.com/document/product/228/6299) |
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| ------------------------------------- | ------------------------------------------------------------ | ---------- | ------------------------------------------------------------ |
| 중국 내 CDN <br>다양한 퍼지 로직을 지원하는 디렉터리 퍼지 | 중국 내 CDN에 다양한 디렉터리 퍼지 로직이 추가되어 정기적으로 노드 캐시 리소스를 정리해 원본 서버에서 다시 최신 리소스를 가져와 캐시합니다. | 2018-05-31 | [캐시 제거](https://intl.cloud.tencent.com/document/product/228/6299) |
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| ------------------------------------- | ------------------------------------------------------------ | ---------- | ------------------------------------------------------------ |
| 중국 내 CDN <br>HTTPS 301 강제 리디렉션 지원  | 모든 CDN 노드에 전송되는 HTTP 요청을 강제로 HTTPS로 리디렉션하며 301 영구 리디렉션을 지원합니다. | 2017-09-30 | [강제 리디렉션의 설정](https://intl.cloud.tencent.com/document/product/228/35214) |
...
| 중국 내 CDN <br>HTTPS 강제 리디렉션 지원                | 지정된 리디렉션 방식으로 모든 CDN 노드에 전송되는 HTTP 요청을 HTTPS로 강제 리디렉션합니다. | 2016-12-14 | [강제 리디렉션의 설정](https://intl.cloud.tencent.com/document/product/228/35214) |
| 중국 내 CDN 마스터/슬레이브 원본 서버 설정 지원                       | 원본 가져오기의 높은 가용성을 보장합니다.                                         | 2016-12-14 | [원본 서버 설정](https://intl.cloud.tencent.com/document/product/228/6289) |
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| ------------------------------------- | ------------------------------------------------------------ | ---------- | ------------------------------------------------------------ |
| 중국 외 CDN <br>퍼지 및 프리패치 지원             | 중국 외 CDN에 캐시 퍼지와 캐시 프리패치 기능이 추가되었습니다.                        | 2016-11-25 | [캐시 제거](https://intl.cloud.tencent.com/document/product/228/6299  )<br> [캐시 프리패치](https://intl.cloud.tencent.com/document/product/228/39000  ) |
...
| 업데이트 명칭                                  |  업데이트 설명                                                     | 배포일   | 관련 문서                                                     |
| -------------------- | -------------------- | ---------- | ------------------------------------------------------------ |
| 디렉터리 퍼지 지원         | 디렉터리에 따라 리소스를 퍼지합니다. | 2015-06-12 | [캐시 제거](https://intl.cloud.tencent.com/document/product/228/6299) |
