...
Tencent Cloud CDNは強大なグローバルリソースストックを有しています。世界中に2800+のアクセラレーションノードがあり、中国本土のすべての省および中国本土以外の70+の国と地区をカバーしています。ネットワーク全体の予備帯域幅は160Tbps+に達し、1億+のアクティブ接続数をサポートすることで、お客様の業務のアクセラレーションを強力に支援します。
...
2017年より、Tencent Cloud CDNは、中国本土以外のアクセラレーションを大々的に展開しています。2021年5月時点で、中国本土以外に計800+のアクセラレーションノードを有し、利用可能な総予備帯域幅は50Tbps+を超え、70+の国と地区をカバーしています。お客様のサービスがワンクリックで海外進出できるようにご支援いたします。
