### Servidor de origem
Refere-se ao seu servidor empresarial em execução estável. No console do CDN, é possível selecionar um servidor externo ou o COS como o servidor de origem.

### Servidor de origem externo
...
### Conteúdo dinâmico
Refere-se ao conteúdo que varia nas respostas a várias solicitações do mesmo recurso.
...
### Nome de domínio
Refere-se a um conjunto de endereços de servidor fáceis de lembrar e usar pelos usuários, e que podem ser um site, e-mail, FTP, etc. É usado para identificar a localização eletrônica de um computador (às vezes chamada de localização geográfica) durante a transferência de dados.
