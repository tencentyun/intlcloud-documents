...
| Configuration | Description                                                     |
| -------- | ------------------------------------------------------------ |
| Origin Server Type | Customer Origin: select this if you already have your own business server. (i.e., origin server). <br/><a href = "https://cloud.tencent.com/product/cos">Tencent Cloud COS</a>: if resources are stored in COS, the bucket can be directly selected as the origin server. |
