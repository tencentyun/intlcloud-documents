...
>!File verification does not support domain name retrieval. You can retrieve your domain name only if you use the DNS verification method.
...
```
4. If the resolution record takes effect, call the [AddCdnDomain](https://intl.cloud.tencent.com/document/product/228/34015) operation to add the domain name.
