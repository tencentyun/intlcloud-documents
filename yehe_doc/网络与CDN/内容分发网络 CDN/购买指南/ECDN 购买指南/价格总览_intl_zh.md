...
<table>
		<tr>
			<th scope="col" style="text-align: center;width: 145px;">计费模式</td>
			<th scope="col" style="text-align: center;width: 200px;">免费流量额度（GB/万次）</td>
			<th scope="col" style="text-align: center;width: 200px;">超额流量单价（美元/GB）</td>
		</tr>
		<tr>
