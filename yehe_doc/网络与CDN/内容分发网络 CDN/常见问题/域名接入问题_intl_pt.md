...
Geralmente, demora menos de 30 minutos para que a configuração do CDN entre em vigor. Se a configuração não entrar em vigor em 30 minutos após a configuração, você pode [enviar um tíquete](https://console.cloud.tencent.com/workorder/category) para obter ajuda.
