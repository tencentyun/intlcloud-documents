...
您可以创建指定采集范围（例如弹性网卡、NAT 网关、云联网跨地域流量）的网络流日志，来采集该范围内传入/传出的流量。创建流日志后，您可以在 [日志服务（CLS）](https://intl.cloud.tencent.com/document/product/614/11254) 中查看和检索数据，也可以在高级分析仪表盘中直观查看日志数据。
