修改为：腾讯云 VPN 支持 IPSec协议 和 SSL协议 两种虚拟网络连接，打通 IDC 、内部办公网络、移动端和腾讯云私有网络 VPC 全连接。
...
VPN 通道在运营商公网中运行，公网的网络阻塞、抖动会影响 VPN 网络质量。若业务对延时、抖动敏感，建议您通过专线接入 VPC 或云联网，更多详情，请参见 [专线接入服务](https://intl.cloud.tencent.com/zh/product/dc)。
...
### SSL 服务端
VPN 网关中用于提供 SSL 服务的服务模块，主要实现数据包的封装与解封装。从而需要在 VPN 网关中进行 SSL 服务端的相关配置，如配置本端网段、客户端网段、以及通信协议、端口及算法等，更多详情请参见 [创建 SSL 服务端](https://intl.cloud.tencent.com/zh/document/product/1037/43905)。
