A VPN connection is a secure network connection over the public network. It can securely connect the customer IDC to the private office network and the Tencent Cloud Virtual Private Cloud (VPC) through an encrypted tunnel over the public network. A VPN gateway provides IPsec VPN connections.
