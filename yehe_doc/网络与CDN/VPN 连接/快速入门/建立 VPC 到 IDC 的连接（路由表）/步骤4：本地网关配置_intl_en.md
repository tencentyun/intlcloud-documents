...
>!
>- In both scenarios below, you should configure the same VPN tunnel on your local gateway as that configured in [Step 3](https://intl.cloud.tencent.com/document/product/1037/39679). Otherwise, the VPN tunnel cannot be connected.
