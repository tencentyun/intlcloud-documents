This document describes how to download the SSL VPN server configuration information.
...
3. On the SSL VPN Server admin page, click the Download button next to the search box.
![]()
