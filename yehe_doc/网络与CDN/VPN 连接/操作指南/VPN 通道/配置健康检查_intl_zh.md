...
## 前提条件
- 已 [创建 VPN 网关 ](https://intl.cloud.tencent.com/document/product/1037/39688)和[ 对端网关的配置](https://intl.cloud.tencent.com/document/product/1037/39691)。
- 本端和对端网段不能重叠。
- 对端 IDC 必须配置静态的公网 IP。

## 方式一：VPN 通道创建时配置健康检查
该处仅介绍健康检查参数配置和参数说明，VPN 通道创建请参考[ 创建 VPN 通道](https://intl.cloud.tencent.com/document/product/1037/39635)。
