...
## Prerequisites
- You have created a VPN gateway as instructed in [Creating a VPN Gateway](https://intl.cloud.tencent.com/document/product/1037/39688) and configured the customer gateway as instructed in [Creating Customer Gateways](https://intl.cloud.tencent.com/document/product/1037/39691). The version of the VPN gateway must be v3.0 or later.
...
This section only introduces the parameters for health checks. For other steps for creating a VPN tunnel, see [Creating a VPN Tunnel](https://intl.cloud.tencent.com/document/product/1037/39635).
