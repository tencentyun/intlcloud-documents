...
>?Anycast 公网加速处于内测阶段，如需使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
>
...
<tr><td><a href="#widthcost">公网网络费用</a></td><td>按量计费</td><td>Anycast EIP 绑定云资源后，访问公网时，仅收取公网网络费用，不收取 IP 资源费用。Anycast EIP 使用 <a href="https://intl.cloud.tencent.com/document/product/684/15255">月95计费</a>。</td></tr>
</table>

>? 标准账户类型在 EIP 上收取 IP 资源费用或公网网络费用，传统账户类型在 EIP 上收取 IP 资源费用，在绑定云资源实例上收取，如CVM 实例收取公网网络费用。判断账户类型的方式请参见 [判断账户类型](https://intl.cloud.tencent.com/document/product/684/15246)。

### [IP 资源费用](id:ipcost)
Anycast EIP 未绑定云资源时，会收取 IP 资源费用，详情请参见 [IP 资源费用](https://intl.cloud.tencent.com/document/product/213/17156)。
...
<th align="left" width="35%" colspan="4">加速地域（单价：美元/Mbps/月）</th>
</tr>
<tr>
<td align="left">亚太</td>
<td align="left">欧洲</td>
...
最终收费 = （10 + 200 + 300）× 18.86 =9618.6（美元）
