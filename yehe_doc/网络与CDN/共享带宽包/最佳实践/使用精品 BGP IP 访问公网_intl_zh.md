...
>?
>- 目前仅标准账户类型支持精品 BGP IP，传统账户类型需升级后才能使用，升级详情请参见 [账户类型升级说明](https://intl.cloud.tencent.com/document/product/684/15246)。
>- 仅中国香港地域支持精品 BGP IP，价格详情请参见 [精品 BGP 带宽包](https://intl.cloud.tencent.com/document/product/684/15254)。
>- 如需体验，请提交 [工单申请](https://console.cloud.tencent.com/workorder/category)。
...
<tr>
<td>数量</td>
<td>请按需选择申请的数量且确保 EIP 总数未超过产品总配额，详情请参见 <a href="https://intl.cloud.tencent.com/document/product/213/5733#.E9.85.8D.E9.A2.9D.E9.99.90.E5.88.B6">配额限制</a>。</td>
</tr>
<tr>
<td><span>名称</span></td>
<td>EIP 实例名称，非必填。</td>
...
>- EIP 绑定 CVM 实例的数量限制，根据 CVM 实例 CPU 配置的差异有所不同，请参见 <a href="https://intl.cloud.tencent.com/document/product/213/5733">使用限制</a>。
>
