...
WebSocket은 클라이언트와 서버 간의 데이터 교환을 용이하게 하고 서버에서 클라이언트로 능동적인 데이터 푸시를 허용합니다. WebSocket API에서는 브라우저와 서버 간에 한 번의 핸드셰이크만 있으면 영구 연결을 생성하고 양방향 데이터 전송을 수행할 수 있습니다.</br>
[[상단으로 이동]](#1)
<span id="3"></span>
### 왜 WS/WSS를 사용해야 하나요?
...
**WS/WSS는 기본적으로 활성화되어 있으며 추가 구성이 필요하지 않습니다.**
