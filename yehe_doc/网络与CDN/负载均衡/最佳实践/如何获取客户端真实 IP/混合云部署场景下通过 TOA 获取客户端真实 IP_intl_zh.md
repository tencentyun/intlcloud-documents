...
## 应用场景
### 混合云部署场景
在 [混合云部署](https://intl.cloud.tencent.com/document/product/214/38442) 中，IDC 的 IP 和云上 VPC 的 IP 可能会有地址重叠，因此需要配置 SNAT IP，进行 SNAT 转换源 IP。对于服务端而言，无法获得真实源 IP，因此需要通过 TOA 进行获取。
...
1. 已创建 NAT64 版本的 CLB 实例，详情请参见 [创建 IPv6 NAT64 负载均衡实例](https://intl.cloud.tencent.com/document/product/214/34556)。
2. 登录 [负载均衡控制台](https://console.cloud.tencent.com/clb)，创建 TCP 监听器，详情请参见 [配置 TCP 监听器](https://intl.cloud.tencent.com/document/product/214/32517)。
...
8. 若以上步骤皆没有排查出具体原因，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
:::
</dx-accordion>
