...
### Overdue Policies
- Starting from the point when your account balance becomes negative, the pay-as-you-go load balancers are still available for the next 24 hours, and the billing continues. 24 hours later (Point 2 in the figure above), the load balancers will be isolated and suspended. The billing stops. 
