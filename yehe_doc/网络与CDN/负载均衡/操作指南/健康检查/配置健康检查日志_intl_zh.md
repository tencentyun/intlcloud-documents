...
健康检查日志功能目前处于内测阶段，如需使用，请提交 [工单申请](https://console.tencentcloud.com/workorder/category)。
</dx-alert>
...
>?
>- 存储类型分为标准存储和低频存储，详情请参见 [存储类型概述](https://www.tencentcloud.com/document/product/614/42003)。
>- 日志保存支持永久保存和按固定时长保存。
...
## 相关文档
[日志服务 CLS 快速入门](https://intl.cloud.tencent.com/document/product/614/31592)
