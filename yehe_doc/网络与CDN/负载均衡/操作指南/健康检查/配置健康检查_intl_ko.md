...
2. ‘상태 확인’ 탭에서 ‘TCP’를 프로토콜로 선택하십시오.
![]()
<table>
<tr>
<th>매개변수</th><th>설명</th>
...
<tr>
<td>프로토콜 확인</td><td>‘HTTP’를 선택하면 HTTP 상태 확인이 수행됩니다.</td>
</tr>
<tr>
<td>포트 확인</td><td>선택 사항입니다. 특정 포트를 확인해야 하는 경우가 아니면 포트를 지정하지 않는 것이 좋습니다. 여기서 포트를 지정하지 않으면 리얼 서버 포트가 확인됩니다.</td>
</tr>
...
<li>리얼 서버에서 지원하는 버전이 HTTP 1.1인 경우 요청의 Host 필드에 인증이 필요합니다. 즉, 확인 도메인을 구성해야 하며, 그렇지 않으면 오류 코드 404가 반환됩니다.</li>
</ul></td>
</tr>
<tr>
...
<tr>
<td>HTTP 버전</td><td>리얼 서버의 HTTP 버전입니다. HTTP 1.1만 지원됩니다. 리얼 서버는 요청의 Host 필드를 인증해야 합니다. 즉, 확인 도메인을 구성해야 합니다. 그렇지 않으면 오류 코드 404가 반환됩니다.
</td>
</tr>
<tr>
<td>정상 상태 코드</td><td>상태 코드가 선택된 것의 경우 리얼 서버는 활성(정상)으로 간주됩니다. 옵션: http_1xx, http_2xx, http_3xx, http_4xx 및 http_5xx. 여러 상태 코드를 선택할 수 있습니다.</td>
...
<tr>
<td>확인 간격</td><td><ul><li>두 상태 확인 사이의 간격입니다. </li><li>값 범위: 5 - 300초.</li></ul></td>
</tr>
<tr>
...
| 확인 간격 | <li>두 상태 확인 사이의 간격입니다. </li><li>값 범위: 5 - 300초.</li> | 5초 |
