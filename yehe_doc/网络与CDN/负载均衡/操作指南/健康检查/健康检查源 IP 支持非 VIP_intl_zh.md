本文介绍如何将 CLB 健康检查的源 IP 由默认的 CLB 的虚拟服务地址（[VIP](https://intl.cloud.tencent.com/document/product/214/32394)）设置为100.64网段。

>?该功能目前处于内测中，如需使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
>
...
- [健康检查探测标识](https://intl.cloud.tencent.com/document/product/214/6097)
