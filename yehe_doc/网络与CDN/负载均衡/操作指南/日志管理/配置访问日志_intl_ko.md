...
- 이 기능은 CLS 사용 가능한 리전에서만 지원됩니다. CLS의 [Available Regions](https://intl.cloud.tencent.com/document/product/614/18940)를 참고하십시오.
...
3. ‘검색 분석’ 페이지에서 로그셋, 로그 테마 및 시간 범위를 선택하고 [검색 및 분석]을 클릭하여 CLB에서 CLS에 보고한 액세스 로그를 검색합니다. 검색 구문에 대한 자세한 내용은 [Legacy CLS Search Syntax](https://intl.cloud.tencent.com/document/product/614/37882)를 참고하십시오.
...
5. ‘로그 테마 추가’ 팝업 창에서 왼쪽의 CLB 인스턴스를 선택하여 오른쪽 목록에 추가하고 [저장]을 클릭합니다.
>?
...
>?검색 구문에 대한 자세한 내용은 [Overview and Syntax Rules](https://intl.cloud.tencent.com/document/product/614/30439)를 참고하십시오.
...
<tr><td>ssl_handshake_time</td><td> SSL 핸드셰이크에 소요되는 시간입니다. </td><td>double</td></tr>
...
<tr><td>request</td><td> 요청 방법. POST 및 GET 요청만 지원됩니다.</td><td>text</td></tr>
