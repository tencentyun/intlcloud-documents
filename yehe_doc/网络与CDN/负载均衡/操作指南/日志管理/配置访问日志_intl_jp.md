...
>- この機能はCLSをサポートしているリージョンでのみサポートされています。詳細については、CLSの[アベイラビリティリージョン](https://intl.cloud.tencent.com/document/product/614/18940)をご参照ください。
...
2. **検索分析**ページで、ログセット、ログトピックおよび時間範囲を選択し、**検索分析**をクリックすると、CLBがCLSに送信したアクセスログを検索できます。検索構文の詳細については、[構文とルール](https://intl.cloud.tencent.com/document/product/614/37882)をご参照ください。
...
>?
>- ストレージタイプには標準ストレージと低頻度ストレージがあります。詳細については、[ストレージタイプの概要](https://intl.cloud.tencent.com/document/product/614/42003)をご参照ください。
...
<tr><td>ssl_handshake_time</td><td>SSLハンドシェイクの各段階の消費時間を記録します。形式はx:x:x:x:x:x:xです。このうち、
