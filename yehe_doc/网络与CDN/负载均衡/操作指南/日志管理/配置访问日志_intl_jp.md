...
- この機能はCLSをサポートしているリージョンでのみサポートされています。詳細については、[アベイラビリティリージョン](https://intl.cloud.tencent.com/document/product/614/18940)をご参照ください。
...
5. ポップアップした「ログトピックの追加」ダイアログボックスで、左側のCLBインスタンスを選択して右側のリストに追加し、【保存】をクリックします。
>?
...
>?検索構文の詳細については、[構文とルール](https://intl.cloud.tencent.com/document/product/614/30439)をご参照ください。
...
<tr><td>ssl_handshake_time</td><td> SSLハンドシェイクにかかった時間です。 </td><td>double</td></tr>
...
<tr><td>request</td><td>リクエストメソッドです。POSTおよびGETリクエストをサポートしています。</td><td>text</td></tr>
