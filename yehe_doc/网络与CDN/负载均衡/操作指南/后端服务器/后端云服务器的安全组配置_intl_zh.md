## CVM 安全组简介
负载均衡的后端云服务器实例可以通过 [安全组](https://intl.cloud.tencent.com/document/product/213/12452) 进行访问控制，起到防火墙的作用。
您可以将一个或多个安全组与后端云服务器关联，并对每个安全组添加一条或多条规则控制不同服务器的流量访问权限。您可以随时修改某个安全组的规则，新规则会自动应用于与该安全组关联的所有实例。有关更多信息，请参阅 [安全组操作指南](https://intl.cloud.tencent.com/document/product/213/12452)。在 [私有网络](https://intl.cloud.tencent.com/document/product/215/535) 环境中，您还可以使用 [网络 ACL](https://intl.cloud.tencent.com/document/product/215/31850) 进行访问控制。
...
](https://intl.cloud.tencent.com/document/product/214/14733) 来配置 CLB 上的安全组规则。
- **应用场景 1：**
...
### 使用云 API 管理后端服务器安全组
请参考 [绑定安全组接口](https://intl.cloud.tencent.com/document/product/213/33265) 和 [解绑安全组接口](https://intl.cloud.tencent.com/document/product/213/33253)。
