...
3. After configuring the above items, click **Buy now**, and return to [Instance Management](https://console.cloud.tencent.com/loadbalance/index?rid=1&forward=1) page where you can view the IPv6 CLB instance you just purchased.
