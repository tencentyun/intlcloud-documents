...
## 升级影响
- 升级后，将根据实际消耗性能，按小时收取性能容量单位 LCU 费用，详情请参见 [性能容量单位 LCU 计费说明](https://intl.cloud.tencent.com/document/product/214/41563)。
...
## 升级限制
- 目前性能容量型实例处于内测中，如需升级或购买，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
- 支持批量升级多个按量计费的共享型实例。
