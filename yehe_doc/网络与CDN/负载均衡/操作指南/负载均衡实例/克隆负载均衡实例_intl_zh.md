...
>?目前克隆实例功能处于内测中，如需使用，请提交 [工单申请](https://console.cloud.tencent.com/workorder/category)。
>
...
## 通过 API 克隆实例
请参见 API 接口 [克隆负载均衡实例](https://intl.cloud.tencent.com/document/product/214/44335)。
