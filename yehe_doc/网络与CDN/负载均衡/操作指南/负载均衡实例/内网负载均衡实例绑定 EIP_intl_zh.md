...
>?内网 CLB 绑定弹性公网 IP 功能处于内测阶段，如需使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
...
1. 登录腾讯云 [负载均衡购买页](https://buy.intl.cloud.tencent.com/lb)。
2. 按需选择以下负载均衡相关配置，其余配置详情请参见 [购买方式](https://intl.cloud.tencent.com/document/product/214/8849)。
<table>
<thead>
<tr>
<th width="18%">参数</th>
...
>?加速 IP 和静态单线 IP 目前处于内测阶段，如需使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 。
>
<img src="" width="60%">
...
## 相关文档
- [绑定弹性公网 IP API 文档](https://intl.cloud.tencent.com/document/product/215/16700)
- [购买方式](https://intl.cloud.tencent.com/document/product/214/8849)
