...
<td>URL 路径</td>
<td>
转发 URL 路径：<ul style="margin-bottom:0px;"><li>长度限制：1 - 200个字符。</li><li>支持正则表达式。</li><li>具体配置规则，详情请参见 <a href="https://intl.cloud.tencent.com/document/product/214/9032">转发 URL 路径配置规则</a>。</li></ul>| /index |
