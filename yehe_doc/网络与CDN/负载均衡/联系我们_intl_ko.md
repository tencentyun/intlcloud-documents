...
## 티켓 시스템
당사 제품을 사용할 때 OPS 또는 기술적인 문제가 발생하면 [Tencent Cloud 공식 웹사이트](https://intl.cloud.tencent.com/)에 로그인하고 화면의 지시에 따라 티켓을 제출할 수 있습니다. 최대한 빨리 연락드리겠습니다.
티켓 관련 링크:
...
- 추가 정보 필요: 기술 지원 팀에서 티켓을 받고 검토했지만 처리를 위해 더 많은 정보가 필요합니다. 이 단계에서 티켓을 종료할 수 있습니다.
 >?추가 정보와 함께 티켓을 다시 제출하면 티켓이 ‘처리 대기 중’ 상태로 되돌아갑니다.
