Tencent Cloud는 **2021년 11월 2일 00:00:00(UTC +8)**부터 모든 CLB(Cloud Load Balancer) 인스턴스의 아키텍처를 업그레이드할 계획입니다. 업그레이드 후 각 공유 CLB 인스턴스는 5만 개 동시 연결, 초당 5000개 연결 생성 및 5000 QPS의 보장된 성능을 제공합니다.
