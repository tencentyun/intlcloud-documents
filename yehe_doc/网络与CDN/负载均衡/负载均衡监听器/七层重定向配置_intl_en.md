...
### Directions
1. Configure the CLB HTTPS listener in the [CLB Console](https://console.cloud.tencent.com/clb) and set up the web environment of `https://example.com`. For more information, please see [Configuring an HTTPS Listener
