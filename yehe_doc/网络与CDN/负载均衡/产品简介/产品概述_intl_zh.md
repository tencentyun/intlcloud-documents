## 什么是负载均衡
负载均衡（Cloud Load Balancer，CLB）是对多台 [云服务器](https://intl.cloud.tencent.com/document/product/213/495) 进行流量分发的服务。负载均衡可以通过流量分发扩展应用系统对外的服务能力，通过消除单点故障提升应用系统的可用性。
...
- [CVM](https://intl.cloud.tencent.com/document/product/213) 实例：应用程序在云上运行的虚拟服务器。
- [弹性伸缩](https://intl.cloud.tencent.com/document/product/377)：弹性地控制实例数量。在弹性伸缩中启用负载均衡实例，则伸缩的实例将自动加入负载均衡组，同时终止的实例将自动被移出负载均衡组。
- [云监控](https://intl.cloud.tencent.com/document/product/248)：帮助您监控负载均衡及所有后端实例的运行状况并执行所需操作。
