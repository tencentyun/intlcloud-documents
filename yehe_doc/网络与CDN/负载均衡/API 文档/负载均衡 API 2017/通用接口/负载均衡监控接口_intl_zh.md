...
## 请求参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，详情请参见 [公共请求参数](https://intl.cloud.tencent.com/document/product/214/11594) 。其中，此接口的 Action 字段为 GetMonitorData。
...
&&lt<a href="https://intl.cloud.tencent.com/document/api/213/6976" target="_blank">公共请求参数</a> &gt;
...
<pre>
https://monitor.api.qcloud.com/v2/index.php?Action=GetMonitorData
&&lt;<a href="https://intl.cloud.tencent.com/document/api/213/6976" target="_blank">公共请求参数</a> &gt;
&namespace=qce/lb_public
&metricName=connum
&dimensions.0.name=vip
&dimensions.0.value=111.111.111.11
...
<pre>
https://monitor.api.qcloud.com/v2/index.php?Action=GetMonitorData
&<<a href="https://intl.cloud.tencent.com/document/api/214">公共请求参数</a>>
...
<td> code
<td> Int
<td> 公共错误码，0表示成功，其他值表示失败。详见错误码页面的 <a href="https://intl.cloud.tencent.com/document/product/214/11602" title="公共错误码" target="_blank">公共错误码</a>。
<tr>
<td> codeDesc
<td> String
<td> 英文错误码。
