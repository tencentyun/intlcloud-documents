...
| hasVideoPermission | Sets whether video file playback is authorized |
...
| addAckData | Confirms whether the data is sent successfully |
...
| TEB_HISTROYDATA_SYNCCOMPLETED | Callback for the completion of the whiteboard historical data synchronization |
...
| TEB_GOTOSTEP | Callback for the whiteboard page animation steps |
