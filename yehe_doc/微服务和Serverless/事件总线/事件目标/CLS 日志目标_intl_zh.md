...
为保证日志正常查看，如果您是子账号，至少需要拥有日志服务 CLS 只读权限 `QcloudCLSReadOnlyAccess`。主账号为子账号授权方法请参见 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。
...
:::
::: 自定义日志集投递
新建投递目标时，如需指定日志投递主题，可选择使用日志自定义投递能力。在使用日志自定义投递能力之前，需保证账号已经开通 [日志服务](https://intl.cloud.tencent.com/products/cls)。
![](https://qcloudimg.tencent-cloud.cn/raw/5a57cd1c90ec1cfd5c66a1d6ad6427e6.png)

#### 计费说明
日志服务为独立计费产品，绑定自定义日志集后，扣费规则以日志服务侧为准，详情可参见 [日志服务计费详情](https://intl.cloud.tencent.com/document/product/614/37509)。
:::
</dx-tabs>
