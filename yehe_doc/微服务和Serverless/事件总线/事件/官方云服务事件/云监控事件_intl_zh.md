...
目前，事件总线 EventBridge 已全面接入 [腾讯云云监控](https://intl.cloud.tencent.com/zh/document/product/248)。您在开通事件总线后，所有的云监控事件将自动为您投递到 [云服务事件集](https://intl.cloud.tencent.com/document/product/1108/42284)。
...
<tbody>
		...
		<tr>
			...
			<td class="div-td-7">检查专用通道 BGP 会话发布路由条目是否达到限制条目的 80%（默认限制 100 条，详情请参见专线接入 <a href="https://intl.cloud.tencent.com/document/product/216/546">使用限制</a>）</td>
		</tr>
    		<tr>
