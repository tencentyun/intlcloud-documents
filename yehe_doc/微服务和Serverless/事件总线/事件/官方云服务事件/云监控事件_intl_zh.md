...
目前，事件总线 EventBridge 已全面接入 [腾讯云云监控](https://intl.cloud.tencent.com/document/product/248)。您在开通事件总线后，所有的云监控事件将自动为您投递到 [云服务事件集](https://intl.cloud.tencent.com/document/product/1108/42284)。
