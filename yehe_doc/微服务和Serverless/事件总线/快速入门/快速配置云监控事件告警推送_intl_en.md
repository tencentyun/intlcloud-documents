## Overview
After EventBridge is activated, it will automatically create a **default Tencent Cloud service event bus** in the **Guangzhou** region, to which alarm events (Cloud Monitor events and CloudAudit events) generated by services connected to it will be automatically delivered. You can also set event rules and delivery targets to configure an alarm linkage.
