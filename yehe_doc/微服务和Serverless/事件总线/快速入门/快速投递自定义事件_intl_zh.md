...
该事件模式的含义是，接收所有来自 Ckafka 且在 target-topic 下的消息。事件模式的具体编写方法，请参见 [事件模式](https://intl.cloud.tencent.com/document/product/1108/42288)。
4. 单击**下一步**后配置事件目标，可选的事件目标包括 [SCF 云函数](https://intl.cloud.tencent.com/document/product/1108/46254)和 [Ckafka](https://intl.cloud.tencent.com/document/product/1108/46249)。此处以云函数为例，事件内容将以参数的形式传递给云函数：
