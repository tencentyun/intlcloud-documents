...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Configuration Data**  (EventBusID, RuleID, rules, TargetID) | We only process this data for the purposes of providing the Feature to you in accordance to your specific configuration. |
|**Event Data**   (business data provided by you in relation to a rule error or event abnormality)                                                              |We only process this data for the purposes of providing the Feature to you. Please note that this data is integrated with and stored in our TDMQ feature.                                                              |
# 3. **SERVICE REGION**
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Configuration Data**|We retain such data until you manually delete such data. Otherwise, when you delete your account or terminate your use of the Feature, we will delete such data after 15 days. |
|**Event Data**|Stored for 15 days. |
