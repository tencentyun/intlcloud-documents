...
>? 一键迁移能力仅在**广州**地域展示，子账号使用前，确保主账号已将控制台所需基本权限赋予子账号，保证可以正常迁移使用，子账号授权请参见 [账号权限管理](https://intl.cloud.tencent.com/document/product/1108/42272)。
>
1. 登录 [事件总线控制台](https://console.cloud.tencent.com/eb)，进入事件集列表页面，点击右上角**更多** > **已有策略迁移**。如下图所示：
