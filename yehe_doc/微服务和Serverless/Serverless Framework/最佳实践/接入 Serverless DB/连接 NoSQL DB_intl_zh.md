...
1. **创建云开发环境配置文件**：通过 [Serverless Framework 组件](https://intl.cloud.tencent.com/document/product/1040/33164) 创建云开发环境，在其中创建并使用 NoSQL DB。
...
25s › tcbdemo › Success
```
2. 部署成功后，您可通过 [云函数控制台](https://console.cloud.tencent.com/scf/index?rid=1)，查看并进行函数调试。测试步骤请参见 [云端测试](https://intl.cloud.tencent.com/document/product/583/32742)，测试成功如下图所示：
