...
- **基于云函数的命令行开发工具**
   ...
   点击此处 [快速开始部署第一个函数应用](https://intl.cloud.tencent.com/document/product/1040/39133)。
...
-  **传统应用框架的快速迁移**
   ...
   点击此处 [快速开始部署第一个框架应用](https://intl.cloud.tencent.com/document/product/1040/39134)。
...
## 相关操作
下一步：[下载安装](https://intl.cloud.tencent.com/document/product/1040/37034)
