...
## 前提条件
已 [安装 Serverless Framework](https://intl.cloud.tencent.com/document/product/1040/37034)。
...
### 构建多组件应用
Serverless Framework 提供了多个基础资源组件，用户可以通过不同组件的结合使用，快速完成云端资源的创建与部署，无需在控制台手动操作（参考 [基础组件列表与配置方式](https://intl.cloud.tencent.com/document/product/1040/39135)）。
