### どのようにしてTEMを購入しますか。
TEMは現在ベータ版テスト段階であり、[TEMコンソール](https://console.cloud.tencent.com/tem) に直接ログインして無料で本製品を体験することができます。詳細については[購入ガイド](https://www.tencentcloud.com/document/product/1094/47757)をご参照ください。
