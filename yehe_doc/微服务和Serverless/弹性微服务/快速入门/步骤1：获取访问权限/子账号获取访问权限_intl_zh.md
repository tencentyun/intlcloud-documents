...
关于主账号和子账号的详细定义及功能说明请参考 [访问管理 - 用户类型](https://intl.cloud.tencent.com/document/product/598/32633)。
...
3. 使用 弹性微服务过程中，涉及到对其他产品的调用，需要主账号对子账号进行授权。详细说明参考 [授予访问其他云产品权限](#授予访问其他云产品权限)。
