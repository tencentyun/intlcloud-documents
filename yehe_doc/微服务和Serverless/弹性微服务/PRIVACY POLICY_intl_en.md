...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Log Data**: APPID, event type, event object (environment/service), event description, change status (whether the execution of the event is successful), creation/end time and source. | We use this information for troubleshooting and monitoring operations.Please note that this data is stored and backed up in our TencentDB for MySQL feature. | We process this information as it is necessary for us to perform our contract with you to provide the Feature. |
...
| ------------------------ | ------------------------------------------------------------ |
| Log Data                 | Stored for the duration of your use of the Feature, and then deleted within 30 days. |
