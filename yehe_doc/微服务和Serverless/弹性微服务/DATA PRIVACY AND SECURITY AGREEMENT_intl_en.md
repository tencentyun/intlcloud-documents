...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Configuration Data** (environment configuration data and service configuration data) | We only process this data for the purposes of providing the Feature to you.Please note that this data is stored and backed up in our TencentDB for MySQL feature. |
...
| ------------------------ | ------------------------------------------------------------ |
| Configuration Data       | Stored for the duration of your use of the Feature, and then deleted within 30 days. |
