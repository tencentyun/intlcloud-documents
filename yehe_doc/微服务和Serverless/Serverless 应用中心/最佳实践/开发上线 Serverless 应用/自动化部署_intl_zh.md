...
- 已创建 Serverless 应用项目。参考 [开发项目](https://intl.cloud.tencent.com/document/product/1040/38253) 创建您的 Serverless 项目并创建各个环境与分支。
...
- 已创建 Serverless 应用项目。如果您未创建 Serverless 应用项目，请参考 [开发项目 ](https://intl.cloud.tencent.com/document/product/1040/38253)创建您的 Serverless 项目并创建各个环境与分支。
