...
1. 通过 [函数操作](https://intl.cloud.tencent.com/document/product/583/36707)，快速上手 Serverless Cloud Framework。
2. 通过 [开发调试](https://intl.cloud.tencent.com/document/product/583/36268)，了解 Serverless Cloud Framework 如何开发及调试云函数。
