...
## 前提条件
Serverless Cloud Framework 帮助您将项目快速部署到**腾讯云 Serverless 应用中心**，因此在部署前，请确认您已经 [注册腾讯云账号](https://intl.cloud.tencent.com/document/product/378/17985) 并完成 [实名认证](https://www.tencentcloud.com/document/product/378/10495)。
