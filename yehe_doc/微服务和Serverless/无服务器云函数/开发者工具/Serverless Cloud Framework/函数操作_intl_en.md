...
## Prerequisites
- You have installed [Serverless Cloud Framework 1.67.2 or later](https://intl.cloud.tencent.com/document/product/1040/37034).
```
...
```
cd demo # Enter the project directory. Change to your actual project's directory name here
scf info
```
