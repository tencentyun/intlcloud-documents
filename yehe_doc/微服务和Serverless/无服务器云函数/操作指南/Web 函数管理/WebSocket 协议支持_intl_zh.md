...
- 更详细的函数状态码可见 [云函数状态码列表](https://intl.cloud.tencent.com/document/product/583/35311)。
...
- 单次请求或返回包最大体积：256KB，可 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 提升配额限制。
- 单连接请求大小限制：128KB/s，可 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 提升配额限制。
- 单连接请求 QPS 限制：10，可 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 提升配额限制。
