...
- **同步调用**
API 网关以同步调用的方式来调用函数，会在 API 网关中配置的超时时间未到前等待函数返回。调用类型详情请参见 [调用类型](https://intl.cloud.tencent.com/document/product/583/9694)。

### 触发器配置
API 网关触发器分别支持在 **[云函数控制台](https://console.cloud.tencent.com/scf/index)** 或在 **[API网关控制台](https://console.cloud.tencent.com/apigateway/index)** 中进行配置。触发器配置详情可参见 [API 网关触发器配置](https://intl.cloud.tencent.com/document/product/583/12513)。
