...
在地域维度，个人用户弹性并发的扩容速度默认限制为500并发/分钟，企业用户为1000并发/分钟。例如客户有10w并发的诉求，按照最大弹性并发的扩容速度，需要10w/ 1000 =100分钟就能完成扩容操作，需要提升配额可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 联系我们。
...
云函数平台提供函数粒度的并发管理能力，供您灵活控制不同函数的并发情况。详情可参见 [并发管理](https://intl.cloud.tencent.com/zh/document/product/583/39464)。
