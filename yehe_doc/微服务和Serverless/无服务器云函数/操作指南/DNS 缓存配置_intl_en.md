...
1. Log in to the [SCF console](https://console.cloud.tencent.com/scf/list?rid=1&ns=default) and select the target function to enter the function details page.
