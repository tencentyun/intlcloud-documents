...
## 策略语法
创建自定义策略流程可参考 CAM 的 [创建自定义策略](https://intl.cloud.tencent.com/document/product/598/35596)。SCF 的策略语法遵循 CAM 的 [语法结构](https://intl.cloud.tencent.com/document/product/598/10604) 和 [资源描述方式](https://intl.cloud.tencent.com/document/product/598/10606)，策略语法以 JSON 格式为基础，所有资源均可采用下述的六段式描述方式，示例如下：
