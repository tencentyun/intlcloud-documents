...
>! 本文涉及功能仅支持 [异步执行](https://intl.cloud.tencent.com/document/product/583/39466) 函数。
...
<td><a href="https://intl.cloud.tencent.com/document/product/583/39734">拉取函数异步事件列表</a></td>
</tr>
<tr>
...
<td><a href="https://intl.cloud.tencent.com/zh/document/product/583/39733">终止正在运行中的函数异步事件</a></td>
</tr>
</tbody>
</table>
...
在调用函数时，SCF 会分配一个实例处理函数请求或事件。函数代码运行完毕返回后，该实例会处理其他请求。如果在请求到来时，所有实例都在运行中，云函数则会分配一个新的实例。（更多实例相关信息请参考 [并发概述](https://intl.cloud.tencent.com/document/product/583/37040)）
