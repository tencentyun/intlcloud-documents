...
- 购买容器镜像服务企业版实例，详情可参见 [快速入门](https://intl.cloud.tencent.com/document/product/1051/35484)。
- 使用容器镜像服务个人版镜像仓库，详情可参见 [快速入门](https://intl.cloud.tencent.com/document/product/1051/38866)。
...
<tr>
<td>Command</td>
<td>填写容器的启动命令，例如 <code>"nginx"</code>。<br>该参数为可选参数，如果不填写，则默认使用镜像中的  Entrypoint / CMD。</td>
</tr>
<tr>
<td>Args</td>
<td>填写容器的启动参数，例如 <code>"-args","value"</code>。该参数为可选参数，如果不填写，则默认使用镜像中的 CMD。</td>
</tr>
</tbody></table>
4. 单击【完成】，即可创建函数。
