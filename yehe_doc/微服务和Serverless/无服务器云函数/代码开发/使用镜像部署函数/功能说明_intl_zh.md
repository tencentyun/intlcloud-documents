...
请求体包含事件数据，结构请参见 [触发器事件消息结构汇总](https://intl.cloud.tencent.com/document/product/583/31439)。
...
### 使用预置并发
镜像部署搭配预置并发功能，预先启动函数实例，达到最优降低冷启动的体验，详情请参见 [预置并发](https://intl.cloud.tencent.com/document/product/583/37704)。
...
#### 镜像大小
目前仅支持镜像（解压前）小于1Gi，如有特殊需要，可 [提交工单](https://console.tencentcloud.com/workorder/category) 申请。建议您根据镜像的大小来选择适合的函数实例执行内存。
