...
本文以 GitHub、Jenkins、CODING 三个平台为例介绍如何结合 [Serverless Framework CLI](https://intl.cloud.tencent.com/document/product/583/36262) 为 Serverless 项目快速搭建 CI/CD。
...
- 如果使用 Web 函数，请将[ scf_bootstrap](https://intl.cloud.tencent.com/document/product/583/40690) 文件放在项目根目录下。
