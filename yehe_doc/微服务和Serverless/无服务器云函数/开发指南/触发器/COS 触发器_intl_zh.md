...
- **异步调用**：COS 始终使用异步调用类型来调用函数，结果不会返回给调用方。有关调用类型的更多信息，请参阅 [调用类型](https://intl.cloud.tencent.com/document/product/583/9694)。
...
| `cos:ObjectCreated:Origin` | 通过 [COS 回源](https://intl.cloud.tencent.com/document/product/436/31508) 创建对象时触发云函数。 |
