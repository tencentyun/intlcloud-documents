...
SCF users are entitled to a certain free tier of resource usage and invocations each month as shown below. There is no free tier for public network outbound traffic. SCF is billed by the actual Tencent Cloud resource usage. If you need to use other postpaid Tencent Cloud resources, please top up your account first as instructed in [Payment Methods](https://intl.cloud.tencent.com/zh/document/product/555/7425) before making purchases.
...
## Questions?
If you have any questions during use, please [submit a ticket](https://console.intl.cloud.tencent.com/workorder) for assistance.
