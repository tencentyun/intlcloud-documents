...
## Prerequisites
Before using SCF, you need to sign up for a [Tencent Cloud account](https://intl.cloud.tencent.com/account/register) and complete the [identity verification](https://intl.cloud.tencent.com/document/product/378/3629) first.
...
6. On the **Trigger management** page, click **Create trigger**.
7. In the pop-up window, confirm the trigger information and click **Submit** as shown below: 
![](https://qcloudimg.tencent-cloud.cn/raw/cdd0d4f3cd88b6414ef270115757d85f.png)
8. On the **Trigger management** page, you can access the deployed Express project as shown below: 
![](https://qcloudimg.tencent-cloud.cn/raw/ebf66a5d16ecfd1470c32e1942b691cd.png)
9. Click the access path URL to access the Express project.
