...
本文将介绍如何通过 SCF 使用 SpringBoot 搭建一个待办应用。SCF 提供事件触发的 [事件函数](https://intl.cloud.tencent.com/document/product/583/9210) 和 HTTP 请求触发的 [Web 函数](https://intl.cloud.tencent.com/document/product/583/40688) 两种函数类型，在 SpringBoot 场景下推荐使用 Web 函数。

## 前提条件

请参考 [云函数 JAVA 开发指南](https://intl.cloud.tencent.com/document/product/583/12214) 准备开发环境和工具。
