...
>! API Gateway triggers can trigger both event functions and web functions. This document only describes the request method of **event function** triggering. For more information on web function triggering, please see [Trigger Management](https://intl.cloud.tencent.com/document/product/583/40691).
