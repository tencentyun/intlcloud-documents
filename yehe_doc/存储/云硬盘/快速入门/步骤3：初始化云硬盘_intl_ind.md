...
## Directions (Petunjuk)
<dx-tabs>
::: Memformat,membuat\ssistem\sfile,dan\smenulis\sfile\s(Windows)
...
1. Login ke instans CVM Windows sebagai pengguna admin. Lihat [Login ke Instans Windows Menggunakan RDP (Direkomendasikan)](https://intl.cloud.tencent.com/document/product/213/5435). 
...
::: Memformat,membuat\ssistem\sfile,dan\smenulis\sfile\s(Linux)
...
1. Login ke instans CVM Linux sebagai pengguna root. Lihat [Login ke Instans Linux Menggunakan Metode Login Standar](https://intl.cloud.tencent.com/document/product/213/5436).
