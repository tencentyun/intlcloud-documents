...
## Prerequisites
- You have mounted the `cbs-test` cloud disk to a CVM. For detailed directions, see [Step 2. Mounting Cloud Disks](https://intl.cloud.tencent.com/document/product/362/39991).
...
8. Select a drive letter or drive path, and click **Next**. In this example, E is assigned as the drive letter.
...
>- When Linux CVM restarts or starts up, data disks will not be automatically mounted. You can refer to [Step 9](#Step09) - [Step 14](#Step14) to configure disk automount at startup.
>
1. [Log in to a Linux CVM instance](https://intl.cloud.tencent.com/document/product/213/5436) as the root user.
...
A cloud disk is an expandable storage device on cloud. You can expand its capacity to fit your business at any time without losing any data in it. For detailed directions, see [Step 4. Expanding Cloud Disks](https://intl.cloud.tencent.com/document/product/362/31646).
