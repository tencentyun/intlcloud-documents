...
## Ticket System (Sistem Tiket)
Jika Anda mengalami masalah OPS atau teknis apa pun ketika menggunakan produk, login ke situs web resmi Tencent Cloud dan kirimkan tiket sesuai petunjuk. Kami akan segera menanggapinya.
Ticket Links (Tautan Tiket):
- Ticket Submission (Pengiriman Tiket): [Submitting a ticket] (Mengirim tiket) (https://console.cloud.tencent.com/workorder/category)
- Status check (Pemeriksaan status): [Ticket list] (Daftar Tiket) (https://console.cloud.tencent.com/workorder)
