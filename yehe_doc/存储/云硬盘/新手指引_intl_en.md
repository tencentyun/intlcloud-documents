...
## 3. Understand and Use Snapshots
...
- [Mounting Cloud Disks](https://intl.cloud.tencent.com/document/product/362/31645)
- [Initializing Cloud Disks](https://intl.cloud.tencent.com/document/product/362/31646)
...
| Create the snapshot of a cloud disk at a specific time point to save the cloud disk data at the specific time point. | [Creating Snapshots](https://intl.cloud.tencent.com/document/product/362/5755) |
...
| Roll back snapshot data to the cloud disk for which the snapshot is created to restore the cloud disk data to the status when the snapshot is created. | [Rolling Back Snapshots](https://intl.cloud.tencent.com/document/product/362/5756) |

## 7. FAQs
#### Usage FAQs
- [In what scenarios are cloud disks used?](https://intl.cloud.tencent.com/document/product/362/32409)
- [Where can I view cloud disk details?](https://intl.cloud.tencent.com/document/product/362/32409#.E5.A6.82.E4.BD.95.E6.9F.A5.E7.9C.8B.E4.BA.91.E7.A1.AC.E7.9B.98.E8.AF.A6.E7.BB.86.E4.BF.A1.E6.81.AF.EF.BC.9F)
...
- [Can I change the type of the cloud disk I have purchased?](https://intl.cloud.tencent.com/document/product/362/32409#.E5.9C.A8.E6.88.90.E5.8A.9F.E8.B4.AD.E4.B9.B0.E5.90.8E.EF.BC.8C.E6.98.AF.E5.90.A6.E6.94.AF.E6.8C.81.E6.9B.B4.E6.8D.A2.E4.BA.91.E7.A1.AC.E7.9B.98.E7.9A.84.E7.B1.BB.E5.9E.8B.EF.BC.9F)
- [Can my system disk be partitioned?](https://intl.cloud.tencent.com/document/product/362/32409#.E7.B3.BB.E7.BB.9F.E7.9B.98.E8.83.BD.E5.90.A6.E8.BF.9B.E8.A1.8C.E5.88.86.E5.8C.BA.E6.93.8D.E4.BD.9C.EF.BC.9F)
...
- [Do I need to shut down the CVM to roll back a snapshot?](https://intl.cloud.tencent.com/document/product/362/17820)
- [Will associated snapshots be deleted when the CVM is terminated?](https://intl.cloud.tencent.com/document/product/362/17820)
...
- If you find product documentation problems, such as links, content, or API errors, you can click **Document Feedback** on the right of the document page or select the content that has problems to submit your feedback.
