...
The table below compares the performances of the three CBS services.

|        Performance Metric       |               Enhanced SSD Cloud Storage             | SSD Cloud Storage                                                    | Premium Cloud Storage                                                 |
| -------------- | ------------------------------|------------------------------ | ------------------------------------------------------------ |
| Maximum size (GB)     | 32,000 | 32,000 | 32,000 |
| Maximum IOPS    | 50,000 | 26,000 | 6,000 |
| Random IOPS performance      | Maximum random IOPS = 1800 + storage capacity (GB) × 50<br/>Maximum random IOPS does not exceed 50,000 | Maximum random IOPS = 1800 + storage capacity (GB) × 30<br/>Maximum random IOPS does not exceed 26,000 | Maximum random IOPS = 1,800 + storage capacity (GB) × 8<br>Maximum random IOPS does not exceed 6,000. |
| Maximum throughput (MB/sec)    | 350 MB/sec | 260 MB/sec | 150 MB/sec |
| Throughput (MB/sec) performance | Maximum throughput = 120 + storage capacity (GB) × 0.5<br/>Maximum throughput does not exceed 350 MB/sec | Maximum throughput = 120 + storage capacity (GB) × 0.2<br/>Maximum throughput does not exceed 260 MB/sec | Maximum throughput = 100 + storage capacity (GB) × 0.15<br>Maximum throughput does not exceed 150 MB/sec |
| Random 1-round read/write latency           | 0.3-1 ms                                                    | 0.5-3 ms                                                    | 0.8-4 ms                                                    |
