...
> [Images] (Citra) (https://intl.cloud.tencent.com/document/product/213/4940) menggunakan layanan CBS snapshot untuk penyimpanan data. Akibatnya, citra kustom yang disimpan akan memakan kapasitas snapshot Anda dan menimbulkan biaya.

## Commercialization Details (Detail Komersialisasi)
...
### Snapshot dan citra
- Citra menggunakan layanan CBS snapshot untuk penyimpanan data. Ketika suatu citra dibuat, sebuah snapshot secara otomatis dibuat dan diikat ke citra yang sesuai. Untuk menghapus snapshot, Anda harus terlebih dahulu [delete the image] (menghapus citranya) (https://intl.cloud.tencent.com/document/product/213/6036). Anda dapat memeriksa detail citra untuk mendapatkan informasi tentang snapshot yang berkaitan dengan citra kustom tersebut.
- Ketika menggunakan citra bersama, hanya akun Tencent Cloud yang membuat citra bersama itulah yang harus membayar biaya snapshot terkait. Pengguna lainnya tidak perlu membayar.
- Snapshot terkait yang dibuat oleh citra kustom ditagihkan berdasarkan kapasitas sebenarnya, yang dapat ditemukan di ikhtisar snapshot.
- Jika akun Tencent Cloud Anda terlambat membayar, Anda tidak bisa membuat citra kustom. Jadi, pastikan Anda memiliki saldo yang cukup di akun Anda sebelum membuat citra kustom.
...
- Standar penagihan: penagihan snapshot berbeda-beda untuk setiap wilayah. Untuk informasi selengkapnya, lihat [Pricing List] (Daftar Harga)(https://intl.cloud.tencent.com/document/product/362/2413).
- Kebijakan pembekuan: jika akun Tencent Cloud Anda terlambat membayar, layanan snapshot akan segera ditangguhkan, termasuk pembuatan, pemulihan, replikasi lintas wilayah, dan kebijakan snapshot terjadwal. Semua snapshot akan dihapus jika akun terlambat membayar lebih dari 30 hari.
...
<table>
	 ...
	 <tr>
         <td nowrap="nowrap">Hong Kong, Macao dan Taiwan, Tiongkok (Hong Kong)</td>
         <td>60GB</td>
...
- Snapshot manual: Anda dapat membuat snapshot untuk data disk cloud secara manual pada titik waktu tertentu. Snapshot ini dapat digunakan untuk membuat lebih banyak disk cloud dengan data yang identik, atau untuk memulihkan disk cloud ke status di titik waktu saat snapshot dibuat. Untuk informasi selengkapnya, lihat [Creating Snapshots] (Membuat Snapshot) (https://intl.cloud.tencent.com/document/product/362/5755).
- Snapshot terjadwal: untuk bisnis yang terus diperbarui, Anda dapat menggunakan snapshot terjadwal untuk membuat pencadangan data berkelanjutan. Untuk mencapai pencadangan berkelanjutan data disk cloud selama periode waktu tertentu, Anda hanya perlu mengonfigurasi kebijakan pencadangan dan mengaitkannya dengan disk cloud, yang secara signifikan meningkatkan keamanan data. Untuk informasi selengkapnya, lihat [Scheduled Snapshot] (Snapshot Terjadwal) (https://intl.cloud.tencent.com/document/product/362/35238).

<a id="reduceoverhead" (mengurangioverhead)></a>
...
- Hapus citra kustom yang tidak lagi digunakan beserta snapshot terkaitnya.
...
- Periksa dan hapus citra kustom yang sudah ada beserta snapshot terkaitnya: periksa dan hapus citra kustom yang disimpan di setiap wilayah, kemudian hapus juga snapshot terkaitnya.
