...
Sebaiknya Anda menggunakan FIO dengan mesin I/O libaio untuk melakukan pengujian. Harap menginstal FIO dan libaio dengan merujuk ke [Tool Installation] (Penginstalan Alat) (#toolInstallation).
...
## Tool Installation (Penginstalan Alat)
1. Masuk ke CVM dengan mengikuti petunjuk dalam [Log in to Linux Instance Using Standard Login Method] (Login ke Instans Linux Menggunakan Metode Login Standar) (https://intl.cloud.tencent.com/document/product/213/5436). Kami menggunakan CVM yang menjalankan OS CentOS 7.6 sebagai contoh.
