...
xfs_growfs /dev/vdc1
```
13. Run the following command to manually mount the new partition.
```
...
mount /dev/vdc1 /data
```
14. Run the following command to view the new partition.
```
df -h
```
...
## Documentation
[Extending Partitions and File Systems (Windows)](https://cloud.tencent.com/document/product/362/6737)
