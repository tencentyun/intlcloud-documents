## Scenario
This document walks you through the scenario of how to initialize cloud disks by taking a cloud disk with a capacity of less than 2 TB as an example. For more information, see [Initialization Scenarios](https://intl.cloud.tencent.com/document/product/362/31596).
...
17. Run the following command to back up the `/etc/fstab` file to a directory, `/home`, for example:
```
cp -r /etc/fstab /home
```
