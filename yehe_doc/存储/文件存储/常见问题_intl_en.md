...
### I installed Windows IIS Web service in Windows Server 2016 operating system, but IIS and CIFS Protocol still can't work together?
...
If the CVM instance resides in the basic network, you can create a VPC and a subnet in Guangzhou Zone 2 and then create a file system in this network. With Classiclink, you can connect the basic network and the VPC for access. For more information, please see [Managing Basic Networks](https://intl.cloud.tencent.com/document/product/215/31807).
...
#### Solution
Run Windows Update to upgrade the OS to the latest version to fix this problem.
