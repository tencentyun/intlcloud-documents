...
## 步骤2：登录云联网内的实例
>? 本文以标准登录方式（WebShell）登录实例为例，更多登录方式请参见 [登录 Linux 实例](https://intl.cloud.tencent.com/document/product/213/5436)。
>
1. 在云联网内的某个 VPC 下创建一个实例，详情请参见云服务器的 [通过购买页创建实例](https://intl.cloud.tencent.com/document/product/213/4855) 文档。
