...
>?
>
>- 智能封面是付费服务，按照视频时长进行计费，具体费用请参见媒体处理费用。
...
- 控制台方式：您可使用 [数据万象控制台](https://console.cloud.tencent.com/ci) 可视化创建任务，详情请见智能封面任务文档。
- API 方式：您可使用 API 接口，创建智能封面任务，详情请见 [API 文档](https://intl.cloud.tencent.com/document/product//1045/43699)。

#### 删除、查询、搜索任务

您可通过 API 方式对任务进行 [删除](https://intl.cloud.tencent.com/document/product//1045/43694)、[查询](https://intl.cloud.tencent.com/document/product//1045/43696) 任务信息、[搜索](https://intl.cloud.tencent.com/document/product//1045/43697) 指定条件下的任务操作。
