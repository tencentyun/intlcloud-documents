...
>? 音视频拼接为付费功能，隶属于文件转码计费项，按照输出文件大小进行计费。详情请参见媒体处理费用。
>
...
- 自定义模板：您可通过控制台方式 创建模板，或通过 API 方式 [创建](https://intl.cloud.tencent.com/document/product/1045/43647) 、[修改](https://intl.cloud.tencent.com/document/product/1045/43650)、[查找](https://intl.cloud.tencent.com/document/product/1045/43649)、[删除](https://intl.cloud.tencent.com/document/product/1045/43648) 模板。
...
- 控制台方式：您可使用数据万象控制台，可视化创建任务，使用详情请参见音视频拼接任务文档。
-  API 方式：您可使用 API 接口创建音视频拼接任务，使用详情请参见 [API 文档](https://intl.cloud.tencent.com/document/product/1045/43703)。

#### 删除、查询、搜索任务

您可使用 API 接口方式进行 [删除](https://intl.cloud.tencent.com/document/product/1045/43702) 任务、[查询](https://intl.cloud.tencent.com/document/product/1045/43704) 任务信息、[搜索](https://intl.cloud.tencent.com/document/product/1045/43705) 指定条件下的任务操作。
