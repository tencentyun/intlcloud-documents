...
The billable items of CI include [image processing fees](), [media processing fees](), [file processing fees](), and [traffic fees]().
...
CI offers a limited free tier to all new users (i.e., individual and enterprise users activating CI for the first time). For more information, see [Free Tier]().
