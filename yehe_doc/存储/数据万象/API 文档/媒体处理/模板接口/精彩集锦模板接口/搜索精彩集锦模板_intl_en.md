## Feature Description
This API (`DescribeMediaTemplates`) is used to search for video montage templates.
...
|:---           |:--       |:--                    |   :--     |   :--    |
| Tag           | None        | Task type: VideoMontage       | String    |Yes |
...
| Tag                | Response.TemplateList | Task type: VideoMontage                                          | String    |
| UpdateTime         | Response.TemplateList | Update time                                                     | String    |
| CreateTime         | Response.TemplateList | Creation time                                                     | String    |
| VideoMontage           | Response.TemplateList | Template parameters                                                | Container |

`VideoMontage` has the following sub-nodes:

| Node Name (Keyword) | Parent Node | Description | Type |
| :----------------- | :----------------------------- | :------- | :-------- |
| Container          | Response.TemplateList.VideoMontage | Same as `Request.Container` in the video montage template creation API `CreateMediaTemplate`. | Container |
| Duration           | Response.TemplateList.VideoMontage | Same as `Request.Duration` in the video montage template creation API `CreateMediaTemplate`. | String    |
| Video              | Response.TemplateList.VideoMontage | Same as `Request.Video` in the video montage template creation API `CreateMediaTemplate`. | Container |
| Audio              | Response.TemplateList.VideoMontage | Same as `Request.Audio` in the video montage template creation API `CreateMediaTemplate`. | Container |
