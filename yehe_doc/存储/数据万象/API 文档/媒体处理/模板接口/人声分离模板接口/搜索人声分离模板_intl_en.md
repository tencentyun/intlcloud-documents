## Feature Description
This API (`DescribeMediaTemplates`) is used to search for voice separation templates.
...
| Tag                | Response.TemplateList | Task type: VoiceSeparate                                        | String    |
| UpdateTime         | Response.TemplateList | Update time                                                     | String    |
| CreateTime         | Response.TemplateList | Creation time                                                     | String    |
| VoiceSeparate      | Response.TemplateList | Template parameters                                                | Container |

`VoiceSeparate` has the following sub-nodes:

| Node Name (Keyword) | Parent Node | Description | Type |
| :----------------- | :----------------------------- | :------------------------------------ | :-------- |
| AudioMode          | Response.TemplateList.VoiceSeparate | Same as `Request.AudioMode` in the voice separation template creation API `CreateMediaTemplate`.     | String |
| AudioConfig        | Response.TemplateList.VoiceSeparate | Same as `Request.AudioConfig` in the voice separation template creation API `CreateMediaTemplate`.   | Container |
