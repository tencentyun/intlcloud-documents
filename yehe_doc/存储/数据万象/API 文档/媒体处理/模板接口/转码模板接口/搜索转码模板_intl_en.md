...
| :----------------- | :----- | :------------------------------- | :------ | :--- |
| tag           | None        | Template type: Transcode       | String    | Yes |
...
| Tag                | Response.TemplateList | Template type: Transcode                                        | String    |
| UpdateTime         | Response.TemplateList | Update time                                                     | String    |
| CreateTime         | Response.TemplateList | Creation time                                                     | String    |
| TransTpl           | Response.TemplateList | Same as `Response.TransTpl` in the transcoding template creation API `CreateMediaTemplate`. | Container |
