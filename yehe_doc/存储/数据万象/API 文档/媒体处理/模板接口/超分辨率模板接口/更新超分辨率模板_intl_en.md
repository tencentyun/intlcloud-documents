...
| :----------------- | :----- | :------------- | :-------- | -------- |
| Request            | None     | Same as `Request` in the super resolution template creation API `CreateMediaTemplate`. | Container | Yes   |
...
| :----------------- | :----- | :--------------------------------------------------- | :-------- |
| Response           | None     | Response container. Same as `Response` in the super resolution template creation API `CreateMediaTemplate`. | Container |
