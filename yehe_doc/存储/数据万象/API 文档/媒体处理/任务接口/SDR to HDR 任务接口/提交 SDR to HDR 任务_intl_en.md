...
This API (`CreateMediaJobs`) is used to submit an SDR-to-HDR task.
...
| Node Name (Keyword) | Parent Node | Description | Type | Required |
| ------------------ | ------- | -------------------------------------------------------- | --------- | ---- |
| Tag                | Request | Task type: SDRtoHDR                                   | String    | Yes   |
...
| Tag                | Response.JobsDetail | Task type: SDRtoHDR                              | String    |
