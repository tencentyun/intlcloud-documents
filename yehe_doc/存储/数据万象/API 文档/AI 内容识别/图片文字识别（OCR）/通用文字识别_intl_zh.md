...
- 成功调用接口会产生 [通用文字识别费用]() 和 [COS 读请求费用](https://intl.cloud.tencent.com/document/product/436/40100)。
...
- 调用接口需携带签名，具体规则请参见 [请求签名](https://intl.cloud.tencent.com/document/product/1045/33452) 文档。
