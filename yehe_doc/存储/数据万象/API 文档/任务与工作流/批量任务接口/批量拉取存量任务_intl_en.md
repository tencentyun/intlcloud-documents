...
The API (`DescribeInventoryTriggerJobs`) is used to pull jobs that meet specified conditions.
...
| JobsDetail | Response | Job details. Same as the `Response.JobsDetail` node in the `CreateInventoryTriggerJob` API. |  Container |
