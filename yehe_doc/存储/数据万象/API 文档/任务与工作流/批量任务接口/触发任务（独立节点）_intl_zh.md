...
| 节点名称（关键字） | 父节点                   | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ------------------------ | ------------------------------------------------------------ | ------ | ---- |
| Index             | Request.Operation.Output.StreamExtract  | 流的编号，对应媒体信息中的 Response.MediaInfo.Stream.Video.Index </br>和 Response.MediaInfo.Stream.Audio.Index，详见 [获取媒体信息接口](https://www.tencentcloud.com/document/product/1045/43732)，当输入媒体格式为 mxf 格式时，只支持提取 video 流                                             | String | 是   |
