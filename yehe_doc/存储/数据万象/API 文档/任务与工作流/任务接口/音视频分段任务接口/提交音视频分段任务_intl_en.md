...
| Node Name (Keyword) | Parent Node | Description | Type | Required |
| ------------------| ----------------- | ----------------------------------------------------------- | --------- | ---- |
| Segment            | Request.Operation | Segmentation parameters                                                 | Container | Yes   |
...
| ------------------ | :------------------------ | -------------------------------------- | --------- | ---- |---- |
| Format             | Request.Operation.Segment  | Container format                                | String | Yes   |aac, mp3, flac, mp4, ts, mkv, avi|
| Duration           | Request.Operation.Segment  | Segment duration, in seconds                         | String | Yes   | The value must be an integer equal to or greater than 5. |
...
| Object             | Request.Operation.Output | Result file name. The ${Number} parameter must be included and used as the output sequence number of each audio/video segment after custom segmentation.     | String | Yes   |
...
| Tag                | Response.JobsDetail | Task type: Segment                              | String    |
