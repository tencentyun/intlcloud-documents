...
| Audio              | Request.Operation.<br/>ConcatTemplate | 音频参数，同创建拼接模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49907" target="_blank">CreateMediaTemplate</a> 接口中的 Request.ConcatTemplate.Audio | Container      | 否       | 无     | 无                             |
| Video              | Request.Operation.<br/>ConcatTemplate | 视频参数，同创建拼接模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49907" target="_blank">CreateMediaTemplate</a> 接口中的  <br/>Request.ConcatTemplate.Video | Container      | 否       | 无     | 无                             |
| Container          | Request.Operation.<br/>ConcatTemplate | 封装格式，同创建拼接模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49907" target="_blank">CreateMediaTemplate</a> 接口中的 Request.ConcatTemplate.Container | Container      | 是       | 无     | 无                             |
| AudioMix           | Request.Operation.<br/>ConcatTemplate | 混音参数, 详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945" target="_blank">AudioMix</a>  | Container数组      | 否       |无      | 仅在 Audio.Remove 为 false 时生效 |
...
常见的错误信息请参见 [错误码](https://intl.cloud.tencent.com/document/product/1045/33700) 文档。
