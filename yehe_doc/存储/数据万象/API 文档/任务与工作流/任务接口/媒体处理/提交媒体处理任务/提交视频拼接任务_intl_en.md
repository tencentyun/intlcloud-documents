...
| Audio               |  Request.Operation.<br/>ConcatTemplate | Audio parameter. Same as `Request.ConcatTemplate.Audio` in the splicing template creation API CreateMediaTemplate.  | Container    | No   | None  | None |
| Video               |  Request.Operation.<br/>ConcatTemplate | Video parameter. Same as `Request.ConcatTemplate.Video` in the splicing template creation API CreateMediaTemplate.  | Container    | No   | None  | None |
| Container           |  Request.Operation.<br/>ConcatTemplate | Container format. Same as `Request.ConcatTemplate.Container` in the splicing template creation API CreateMediaTemplate.   | Container    | Yes   | None  | None |
| AudioMix           | Request.Operation.<br/>ConcatTemplate | Audio mix parameter. Same as `Request.ConcatTemplate.AudioMix` in the splicing template creation API CreateMediaTemplate.   | Container    | Yes   | None  | None |
