...
| Type               | Request.Operation.Translation | File type    | String | Yes   | The mappings between source file types and target file types are as follows: <br/>docx: docx<br/> pptx: pptx<br/>xlsx: xlsx<br/>txt: txt<br/>xml: xml<br/>html: html<br/>markdown: markdown<br/>pdf: pdf, docx |
