...
| Url       | Request.Input | URL that supports public network downloads. At least one of `Url` and `Object` must be passed in. If both parameters are passed in, `Object` is preferred. | String | No   |
