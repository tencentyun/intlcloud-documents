...
| StartTime           | Request.Watermark | Watermark start time | String    | No   | 0   | 1. [0, video duration] <br/> 2. Unit: second <br/> 3. Supports the float format, accurate to the millisecond. |
| EndTime             | Request.Watermark | Watermark end time | String    | No   | Video end time  | 1. [0, video duration] <br/> 2. Unit: second <br/> 3. Supports the float format, accurate to the millisecond. |
