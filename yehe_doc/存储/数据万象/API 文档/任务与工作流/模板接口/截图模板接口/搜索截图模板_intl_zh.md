...
| Snapshot           | Response.TemplateList | 其详细的模板参数               | Container |
...
| Width              | TemplateList.Snapshot | 宽           | String | 否   | 视频原<br/>始宽度 | <li>值范围：[1，4096]</li><li>单位：px</li><li>若只设置 Width 时，按照视频原始比例计算 Height</li> |
| Height             | TemplateList.Snapshot | 高           | String | 否   | 视频原<br/>始高度 | <li>值范围：[1，4096]</li><li>单位：px</li><li>若只设置 Height 时，按照视频原始比例计算 Width</li> |
