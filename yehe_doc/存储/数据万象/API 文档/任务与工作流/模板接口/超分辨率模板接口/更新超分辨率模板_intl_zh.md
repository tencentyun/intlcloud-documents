...
UpdateMediaTemplate 用于更新超分辨率模板。
...
| :----------------- | :----- | :------------- | :-------- | -------- |
| Request            | 无     | 同新增超分辨率模板 CreateMediaTemplate 中的 Request | Container | 是   |
...
| 节点名称（关键字） | 父节点 | 描述                                                 | 类型      |
| :----------------- | :----- | :--------------------------------------------------- | :-------- |
| Response           | 无     | 保存结果的容器，同新增超分辨率模板 CreateMediaTemplate 中的 Response | Container |
