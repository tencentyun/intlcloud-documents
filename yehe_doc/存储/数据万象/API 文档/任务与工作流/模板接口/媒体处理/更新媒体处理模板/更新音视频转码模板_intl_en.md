...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49911" target="_blank">Same as `Request` in the transcoding template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49911" target="_blank">Same as `Response` in the transcoding template creation API.</a> | Container |
