...
This API is used to update a screenshot template.
...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49909" target="_blank">Same as `Request` in the screenshot template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49909" target="_blank">Same as `Response` in the screenshot template creation API.</a> | Container |
