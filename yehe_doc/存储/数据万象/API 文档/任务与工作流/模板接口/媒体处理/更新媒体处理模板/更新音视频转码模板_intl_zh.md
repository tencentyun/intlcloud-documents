...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | 无     | <a href="https://intl.cloud.tencent.com/document/product/1045/49911" target="_blank">同创建转码模板接口的 Request</a> | Container | 是   |
...
| 节点名称（关键字） | 父节点 | 描述                                                | 类型      |
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | 无     | <a href="https://intl.cloud.tencent.com/document/product/1045/49911" target="_blank">同创建转码模板接口的 Response</a> | Container |
