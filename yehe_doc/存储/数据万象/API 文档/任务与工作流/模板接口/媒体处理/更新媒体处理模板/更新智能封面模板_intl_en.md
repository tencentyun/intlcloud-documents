...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/50614" target="_blank">Same as `Request` in the intelligent thumbnail template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/50614" target="_blank">Same as `Response` in the intelligent thumbnail template creation API.</a> | Container |
