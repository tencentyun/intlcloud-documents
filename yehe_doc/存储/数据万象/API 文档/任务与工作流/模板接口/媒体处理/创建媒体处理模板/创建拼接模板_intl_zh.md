...
该请求操作的实现使用公共请求头，了解公共请求头详情请参见 [公共请求头部](https://intl.cloud.tencent.com/document/product/1045/43609) 文档。
...
| ------------------ | ---------------------- | -------- | --------- | ---- | ---------- | ------------------------------------------------------------ |
| ConcatFragment     | Request.ConcatTemplate | 拼接节点 | Container数组 | 是   | 无         | 无                                                           |
...
Container数组 类型 ConcatFragment 的具体数据描述如下：
...
| Crf                | Request.ConcatTemplate.<br/>Video | 码率-质量控制因子  | String | 否   | 视频原始码率 | <li>值范围：(0, 51]</li><li>如果设置了 Crf，则 Bitrate 的设置失效</li><li>当 Bitrate 为空时，默认为25 </li>          |
