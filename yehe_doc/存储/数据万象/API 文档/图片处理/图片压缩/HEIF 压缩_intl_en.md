...
[CI](https://intl.cloud.tencent.com/document/product/1045/33422) launched the HEIF compression feature. It converts images to the .heif format, which has a super high compression ratio. A .webp image is over 80% smaller than a .jpg image with the same quality. iOS adopts .heif as the default format for photos, and Android P natively supports .heif.

## Restrictions

- Format: Images in JPG, PNG, BMP, WebP, TPG, or AVIF format can be converted to HEIF format.
...
To use HEIF compression, enable the image advanced compression feature for your bucket on its configuration page. For more information, see [Setting Image Advanced Compression](https://intl.cloud.tencent.com/document/product/436/40117).
...
>? HEIF compression is billed at image advanced compression prices. For detailed pricing, see Image Processing Fees.
>
...
| /format/&lt;Format> | Compression format, which is `heif` here.                                       |
...
You can convert the image to HEIF format by using the following request URL:
