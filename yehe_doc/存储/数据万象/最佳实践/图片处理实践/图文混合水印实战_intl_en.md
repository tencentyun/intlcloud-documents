...
Below are the processing parameters in the red box in the above figure:
```
...
```
4. Add the concatenated parameters at the end of the image download URL:
```
...
```
Then, you can get the image with a hybrid watermark:
