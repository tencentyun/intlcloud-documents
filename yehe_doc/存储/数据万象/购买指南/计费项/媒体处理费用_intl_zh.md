...
| 人声分离费用       | 指使用人声分离服务产生的费用，根据**输出文件时长**收费。     |          |                |
...
| 语音合成费用       | 指使用语音合成服务产生的费用，根据**输入字符数**收费。       |          |                |
| 音频降噪费用       | 指使用音频降噪服务产生的费用，根据**音频处理时长**收费。     |          |                |
...
> 如：A用户本月语音合成用量为89万字符，实际收费为：19* 0.4422+（89 - 19）万 * 0.4127 = 37.2908美元
...
| 人声分离费用     | 0        | 0.012美元/分钟                                   | 500分钟    | 500*0.012=6美元        |
