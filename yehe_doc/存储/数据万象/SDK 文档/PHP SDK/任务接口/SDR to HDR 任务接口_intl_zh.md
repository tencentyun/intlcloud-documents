...
| API                                                          | 操作描述             |
| ------------------------------------------------------------ | -------------------- |
| [提交 SDR to HDR 任务](https://intl.cloud.tencent.com/document/product/436/47252) | 提交 SDR to HDR 任务 |
...
$cosClient = new Qcloud\Cos\Client(
    array(
        ...
        'credentials'=> array(
            ...
            'secretKey' => $secretKey)));
try {
    // 提交 SDR to HDR 任务 https://intl.cloud.tencent.com/document/product/436/47252
