...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/49906) | 创建模板 | 用于创建一个新的模板 |
...
>? 其余参数请参见 [创建模板接口](https://intl.cloud.tencent.com/document/product/1045/49906)，与其参数一致。
