...
| API | Description |
| ------------------------------------------ | -------------------------- |
| [Blind watermarking](https://cloud.tencent.com/document/product/460/19017) | Adds blind watermark to or extracts blind watermark from local image and uploads it to bucket. |
