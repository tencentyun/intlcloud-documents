...
下面为您介绍如何使用 Java SDK 完成一个基础操作，例如初始化客户端、创建存储桶、查询存储桶列表、上传对象、查询对象列表、下载对象和删除对象。数据万象的媒体处理接口集成至对象存储服务 XML Java SDK，您可完成 [模板操作](https://intl.cloud.tencent.com/document/product/1045/47020)、任务操作、[工作流操作](https://intl.cloud.tencent.com/document/product/1045/47022)、队列操作 等相关操作。
