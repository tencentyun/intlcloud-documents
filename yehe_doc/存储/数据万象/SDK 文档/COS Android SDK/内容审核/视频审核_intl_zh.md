...
| API                                                          | 操作名         | 操作描述                         |
| ------------------------------------------------------------ | -------------- | -------------------------------- |
| [PostVideoAudit](https://intl.cloud.tencent.com/document/product/436/48249) | 提交视频审核任务 | 用于提交视频审核任务         |
| [GetVideoAudit](https://intl.cloud.tencent.com/document/product/436/48250) | 查询视频审核任务结果 | 用于查询视频审核任务结果         |
