...
| API                                                          | 操作名         | 操作描述                         |
| ------------------------------------------------------------ | -------------- | -------------------------------- |
| [SensitiveContentRecognition](https://intl.cloud.tencent.com/document/product/436/48537) | 图片同步审核 | 用于图片同步审核         |
| [PostImagesAudit](https://intl.cloud.tencent.com/document/product/436/48538) | 图片批量审核 | 用于图片批量审核         |
| [GetImageAudit](https://intl.cloud.tencent.com/document/product/436/48539) | 查询图片审核任务结果 | 用于查询图片审核任务结果         |
