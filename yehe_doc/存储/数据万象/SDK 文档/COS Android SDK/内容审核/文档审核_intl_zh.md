...
| API                                                          | 操作名         | 操作描述                         |
| ------------------------------------------------------------ | -------------- | -------------------------------- |
| [PostDocumentAudit](https://intl.cloud.tencent.com/document/product/436/48258) | 提交文档审核任务 | 用于提交文档审核任务         |
| [GetDocumentAudit](https://intl.cloud.tencent.com/document/product/436/48259) | 查询文档审核任务结果 | 用于查询文档审核任务结果         |
