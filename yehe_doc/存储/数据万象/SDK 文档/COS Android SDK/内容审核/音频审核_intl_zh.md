...
本文档提供关于音频审核接口的 API 概览以及 SDK 示例代码。

| API                                                          | 操作名         | 操作描述                         |
| ------------------------------------------------------------ | -------------- | -------------------------------- |
| [PostAudioAudit](https://intl.cloud.tencent.com/document/product/436/48262) | 提交音频审核任务 | 用于提交音频审核任务         |
| [GetAudioAudit](https://intl.cloud.tencent.com/document/product/436/48263) | 查询音频审核任务结果 | 用于查询音频审核任务结果         |
