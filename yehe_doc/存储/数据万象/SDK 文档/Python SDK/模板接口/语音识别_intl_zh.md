...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [创建语音识别模板](https://intl.cloud.tencent.com/document/product/436/50157) | 创建模板 | 用于创建一个新的模板 |
| 删除语音识别模板| 删除模板 | 删除一个模板|
| [查询语音识别模板](https://intl.cloud.tencent.com/document/product/436/50159) | 查询模板 | 查询模板列表 |
| [更新语音识别模板](https://intl.cloud.tencent.com/document/product/436/50160) | 修改模板 | 修改一个模板 |
