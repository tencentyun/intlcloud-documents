...
您可在了解完计费项介绍和 [产品定价](https://intl.cloud.tencent.com/document/product/436/6239) 后自行估算费用。
...
| 智能分层监控次数         | 智能分层存储                                                 | 智能分层存储类型数据的对象监控费用，用于监控数据的访问情况 | <li>按月结算<br><li>月累计监控次数不足1万次，按1万次计算<br><li>对象监控费用 = 每万个对象 / 10000 |
