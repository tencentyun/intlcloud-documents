...
<table>
   ...
   <tr>
      ...
      <td><ul  style="margin: 0;"><li>Pay-as-you-go: Public network downstream traffic (GB) * unit price per GB</li></ul></td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td><ul  style="margin: 0;"><li>Pay-as-you-go: CDN origin-pull traffic (GB) * unit price per GB</li></ul></td>
   </tr>
   <tr>
      ...
      <td><ul  style="margin: 0;"><li>Pay-as-you-go: Cross-region replication traffic (GB) * unit price per GB</li></ul></td>
   </tr>
   <tr>
      ...
      <td><ul  style="margin: 0;"><li>Pay-as-you-go: Global acceleration traffic (GB) * unit price per GB</li></ul></td>
   </tr> 
</table>
...
4. Cross-region replication traffic is generated when you replicate data from a bucket in one region to a bucket in another region by using APIs or the cross-region replication feature. The traffic fees will vary by source bucket region.
