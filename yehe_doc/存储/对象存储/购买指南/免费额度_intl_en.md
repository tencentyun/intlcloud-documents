...
<table>
   ...
   <tr>
       ...
       <td>Inventory feature fees, COS Select feature fees, batch operation fees, object tagging fees</td>
   </tr>
</table>
...
## Access and Query
You receive the benefits of COS Free Tier in the format of storage pack automatically after you sign up for a [Tencent Cloud account](https://intl.cloud.tencent.com/document/product/378/17985) and activate the COS service in the [console](https://console.cloud.tencent.com/cos5). 
