...
按照地域范围，免费额度资源包适用于**公有云地域**，地域划分可前往 [地域和访问域名](https://intl.cloud.tencent.com/document/product/436/6224) 进行了解。

按照可抵扣的 [计费项](https://intl.cloud.tencent.com/document/product/436/33776) 范围，COS 提供的免费额度资源包仅可抵扣**标准存储容量**，如下表所示。
...
<table>
   ...
   <tr>
      <td>低频存储容量</td>
      <td rowspan="8">否。<br>免费额度资源包不可抵扣<strong>非标准存储容量</strong>计费项。</br></td>
   </tr>
   <tr>
      <td>智能分层存储容量</td>
   </tr>
...
如您对免费额度或费用账单存在疑问，可参见 [计费计量](https://intl.cloud.tencent.com/document/product/436/10373) 文档进行查询或 [联系我们](https://www.tencentcloud.com/contact-us)。
