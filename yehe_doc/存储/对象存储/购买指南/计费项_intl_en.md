Billable items in COS include [storage usage fees](#jf1),  [request fees ](#jf2), [data retrieval fees](#jf3), [traffic fees](#jf4), and [management feature fees](#jf5). The following describes each billable item in detail. After learning about them and the [Product Pricing](https://intl.cloud.tencent.com/document/product/436/6239), you can estimate your fees on your own.




>COS offers 3 object storage classes for different access frequencies: STANDARD, STANDARD_IA, and ARCHIVE. For more information, please see [COS Storage Classes](https://intl.cloud.tencent.com/document/product/436/30925).
...
<table>
   ...
   <tr>
      <td>Storage usage</td>
      <td>STANDARD<br>STANDARD_IA<br>ARCHIVE
      <td>Storage usage refers to the actual storage space used by your data.<br>The fees are calculated based on the size of actually used storage capacity.</td>
      <td><li>Settled on a monthly basis<br><li>Storage usage fees = storage capacity unit price * monthly storage capacity used<br><li>Monthly storage capacity used = sum of "daily storage capacity used" in the month / number of days in the month<br><li>Daily storage capacity used = sum of "5-minute storage capacity used" / 288 (number of statistical points)</td>
   </tr>
</table>
...
<table>
   ...
   <tr>
      ...
      <td>STANDARD<br>STANDARD_IA<br>ARCHIVE</td>
...
<table>
   ...
   <tr>
      ...
      <td rowspan="7">STANDARD<br>STANDARD_IA<br>ARCHIVE</td>
   ...
   <tr>
      ...
      <td><li>Settled on a daily basis <br><li>Cross-region replication traffic fees = unit price per GB * daily accumulated cross-region replication traffic</td>
   </tr>
   <tr>
      ...
      <td><li>Settled on a daily basis <br><li>Global acceleration traffic fees = unit price per GB * daily accumulated global acceleration traffic</td>
   </tr> 
</table>
...
Management feature fees refer to the fees incurred by use of management features (such as inventory and select) after they are enabled.
...
<td>Fees incurred by scanning objects after the select feature is enabled</td>
