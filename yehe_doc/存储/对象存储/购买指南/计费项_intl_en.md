...
You can estimate the costs after learning about the billable items and [Product Pricing](https://intl.cloud.tencent.com/pricing/cos). Alternatively, you can use the [COS Price Calculator](https://buy.cloud.tencent.com/price/cos/calculator) to calculate the costs.
...
- Backend requests: include requests to delete STANDARD copies after lifecycle transition or expiration of STANDARD copies restored from ARCHIVED, read/write data for cross-region replication, and deliver inventory reports.
