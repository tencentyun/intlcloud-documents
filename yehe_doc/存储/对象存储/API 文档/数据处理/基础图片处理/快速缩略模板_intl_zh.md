## 功能描述
COS 通过数据万象 **imageView2** 接口提供常用图片处理模板。用户根据业务需求，只需在下载 URL 后面附加相应的参数，即可生成相应的缩略图。目前支持大小在20M以内、长宽小于9999像素的图片处理。
...
## 实际案例
假设选用模板样式1，限定缩略图的宽高最小值为400×600，绝对质量为85，则 URL 如下所示：
