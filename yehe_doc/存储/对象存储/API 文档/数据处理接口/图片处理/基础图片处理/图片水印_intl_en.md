...
COS implements Image Watermarking using the **watermark** API provided by Cloud Infinite (CI) and thus only images stored in CI-bound buckets can be processed. For the restrictions on Basic Image Processing (including watermarking), please see [Rules and Limits](https://intl.cloud.tencent.com/document/product/1045/33425).
