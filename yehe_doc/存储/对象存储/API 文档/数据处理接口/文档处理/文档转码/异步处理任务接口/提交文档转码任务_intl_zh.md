...
<table>
   ...
   <tr>
      <td>QueueId</td>
      <td>Request</td>
      <td>任务所在的队列 ID，开通预览服务后自动生成，请使用 <a href="https://intl.cloud.tencent.com/document/product/1045/47935">查询队列</a> 获取或前往 <a href="https://console.cloud.tencent.com/ci">万象控制台</a> 在存储桶中查询 </td>
      <td>String</td>
      <td>是</td>
   </tr>
</table>
