...
本接口用于提交一个网页审核任务。网页审核功能为异步任务方式，您可以通过提交网页审核任务审核您的网页文件，然后通过 [查询网页审核任务接口](https://intl.cloud.tencent.com/document/product/436/48283) 或 [网页审核回调](https://intl.cloud.tencent.com/document/product/436/48284) 查询审核结果。
