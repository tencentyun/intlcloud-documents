...
本接口用于提交一个音频审核任务。音频审核功能为异步任务方式，您可以通过提交音频审核任务审核您的音频文件，然后通过 [查询音频审核任务接口](https://intl.cloud.tencent.com/document/product/436/48263) 或 [音频审核回调](https://intl.cloud.tencent.com/document/product/436/48264) 查询审核结果。
...
- 支持设置回调地址 Callback 获取检测结果，或通过 [查询音频审核任务结果接口](https://intl.cloud.tencent.com/document/product/1045/48267) 主动轮询获取审核结果详情。
...
- 调用接口会产生音频审核费用 和 [COS 读请求费用](https://intl.cloud.tencent.com/document/product/436/40100)。
- 如果音频属于 COS 上的低频存储类型，调用审核会产生 [COS 低频数据取回费用](https://intl.cloud.tencent.com/document/product/436/40097)。
