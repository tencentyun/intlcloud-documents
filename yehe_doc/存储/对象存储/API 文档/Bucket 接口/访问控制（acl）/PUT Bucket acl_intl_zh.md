...
>- 支持对腾讯云 CAM 主账号、匿名用户、子用户授予权限，如需授予用户组权限请参见 [为用户组添加/解除策略](https://intl.cloud.tencent.com/document/product/598/32666)。有关 ACL 的详细说明，请参见 [ACL 概述](https://intl.cloud.tencent.com/document/product/436/30583)。
