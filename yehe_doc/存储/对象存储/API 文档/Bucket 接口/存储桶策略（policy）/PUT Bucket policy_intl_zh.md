...
#### 请求体
下面的示例表示给主账号100000000001下的子账号100000000011授权，以允许访问存储桶名为 examplebucket-1250000000 中的对象列表。关于访问策略中的元素介绍，请参见 [访问策略语言概述](https://intl.cloud.tencent.com/document/product/436/18023)，以及授权策略示例请参见 [COS API 授权策略使用指引](https://intl.cloud.tencent.com/document/product/436/30580)。
