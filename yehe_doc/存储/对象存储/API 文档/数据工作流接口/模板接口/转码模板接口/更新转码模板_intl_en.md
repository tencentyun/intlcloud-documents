...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | Same as `Request` in the transcoding template creation API `CreateMediaTemplate`. | Container | Yes   |
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | None     | Same as `Response` in the transcoding template creation API `CreateMediaTemplate`. | Container |
