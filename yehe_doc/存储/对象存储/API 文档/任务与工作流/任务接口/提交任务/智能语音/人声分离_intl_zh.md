...
| 节点名称（关键字） | 父节点                          | 描述                                                         | 类型      | 是否必选 |
| ------------------ | :------------------------------ | ------------------------------------------------------------ | --------- | -------- |
| AudioMode          | Request.Operation.VoiceSeparate | 同创建人声分离模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84500#Request" target="_blank">Request.AudioMode</a> | Container | 否       |
| AudioConfig        | Request.Operation.VoiceSeparate | 同创建人声分离模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84500#AudioConfig" target="_blank">Request.AudioConfig</a> | Container | 否       |
