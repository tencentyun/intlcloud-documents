...
| ------------------ | :----------------------------- | ------------------------------------------------------------ |
| ColorEnhance       | Request.Operation.VideoProcess | Same as `Request.ColorEnhance` in the video enhancement template creation API <a href="https://cloud.tencent.com/document/product/460/77097#ColorEnhance" target="_blank">CreateMediaTemplate</a>. |
| MsSharpen          | Request.Operation.VideoProcess | Same as `Request.MsSharpen` in the video enhancement template creation API <a href="https://cloud.tencent.com/document/product/460/77097#MsSharpen" target="_blank">CreateMediaTemplate</a>. |
