...
| CallBackMqConfig   | Request | 任务回调 TDMQ 配置，当 CallBackType 为 TDMQ 时必填。详情见 [CallBackMqConfig](https://intl.cloud.tencent.com/document/product/1045/49945#CallBackMqConfig)                | Container | 否 |
...
| 节点名称（关键字） | 父节点                          | 描述                                                         | 类型      | 是否必选 |
| ------------------ | :------------------------------ | ------------------------------------------------------------ | --------- | -------- |
| AudioMode          | Request.Operation.VoiceSeparate | 同创建人声分离模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49916" target="_blank">CreateMediaTemplate</a> 接口中的 Request.AudioMode | Container | 否       |
| AudioConfig        | Request.Operation.VoiceSeparate | 同创建人声分离模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49916" target="_blank">CreateMediaTemplate</a> 接口中的 Request.AudioConfig | Container | 否       |
