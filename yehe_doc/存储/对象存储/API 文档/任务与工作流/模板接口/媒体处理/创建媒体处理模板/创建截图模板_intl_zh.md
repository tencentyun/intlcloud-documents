...
| CIParam              | Request.Snapshot | 截图图片处理参数     | String    | 否       | 无                | <ul  style="margin: 0;"><li>参考 [图片处理](https://intl.cloud.tencent.com/document/product/1045/33713) </li><li>例如: imageMogr2/format/png</li></ul> |
