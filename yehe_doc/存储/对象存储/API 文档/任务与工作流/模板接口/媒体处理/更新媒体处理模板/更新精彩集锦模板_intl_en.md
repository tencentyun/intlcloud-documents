...
| :----------------- | :----- | :------------- | :-------- | -------- |
| Request            | None     | Same as the `Request` in the video montage template creation API. | Container | Yes   |
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | None     | Same as the `Response` in the video montage template creation API. | Container |
