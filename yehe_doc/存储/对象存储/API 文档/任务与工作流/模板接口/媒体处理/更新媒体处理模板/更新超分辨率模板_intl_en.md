...
| :----------------- | :----- | :-------------------------------------------------- | :-------- | -------- |
| Request            | None     | Same as the `Request` in the super resolution template creation API. | Container | Yes   |
...
| :----------------- | :----- | :----------------------------------------------------------- | :-------- |
| Response           | None     | Same as the `Response` in the super resolution template creation API. | Container |
