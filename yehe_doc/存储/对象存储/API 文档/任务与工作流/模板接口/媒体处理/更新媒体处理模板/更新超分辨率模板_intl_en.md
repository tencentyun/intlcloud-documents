...
This API is used to update a super resolution template.
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- | -------- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49910" target="_blank">Same as `Request` in the super resolution template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :----------------------------------------------------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49910" target="_blank">Same as `Response` in the super resolution template creation API.</a> | Container |
