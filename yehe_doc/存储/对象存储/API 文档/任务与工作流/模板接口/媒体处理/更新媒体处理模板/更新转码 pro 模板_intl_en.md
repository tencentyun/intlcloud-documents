...
| :----------------- | :----- | :---------------------------------------- | :-------- | ---- |
| Request            | None     | Same as the `Request` in the professional transcoding template creation API. | Container | Yes   |
...
| :----------------- | :----- | :----------------------------------------- | :-------- |
| Response           | None     | Same as the `Response` in the professional transcoding template creation API. | Container |
