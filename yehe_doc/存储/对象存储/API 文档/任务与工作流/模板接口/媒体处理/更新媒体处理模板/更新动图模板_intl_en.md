...
This API is used to update an animated image template.
...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49906" target="_blank">Same as `Request` in the animated image template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49906" target="_blank">Same as `Response` in the animated image template creation API.</a> | Container |
