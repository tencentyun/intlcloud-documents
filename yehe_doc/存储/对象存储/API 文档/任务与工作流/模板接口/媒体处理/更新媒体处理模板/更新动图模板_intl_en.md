...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | Same as the `Request` in the animated image template creation API. | Container | Yes   |
...
| :----------------- | :----- | :------------- | :-------- |
| Response           | None     | Same as the `Response` in the animated image template creation API. | Container |
