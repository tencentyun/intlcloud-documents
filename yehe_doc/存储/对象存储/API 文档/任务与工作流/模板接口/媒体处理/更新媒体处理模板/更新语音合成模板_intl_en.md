...
| :----------------- | :----- | :---------------------------------------- | :-------- | ---- |
| Request            | None     | Same as the `Request` in the text-to-speech template creation API. | Container | Yes   |
...
| :----------------- | :----- | :----------------------------------------- | :-------- |
| Response           | None     | Same as the `Response` in the text-to-speech template creation API. | Container |
