...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | Same as the `Request` in the screenshot template creation API. | Container | Yes   |
...
| :----------------- | :----- | :------------- | :-------- |
| Response           | None     | Same as the `Response` in the screenshot template creation API. | Container |
