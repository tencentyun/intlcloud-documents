...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | Same as the `Request` in the transcoding template creation API. | Container | Yes   |
...
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | None     | Same as the `Response` in the transcoding template creation API. | Container |
