...
| x-cos-storage-class | Object storage class. Enumerated values: `MAZ_STANDARD`, `MAZ_STANDARD_IA`, `STANDARD_IA`, `ARCHIVE` and `DEEP_ARCHIVE`. For more information, see [Storage Class](https://intl.cloud.tencent.com/document/product/436/30925) |  Enum   | No       |
