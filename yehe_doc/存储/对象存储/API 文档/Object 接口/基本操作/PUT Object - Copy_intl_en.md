...
| --- | --- | --- | --- |
| x-cos-copy-source | URL of the source object, where the object key needs to pass through URLEncode. The version of the source object can be specified by the versionId parameter, for example: <br>`sourcebucket-1250000001.cos.ap-shanghai.myqcloud.com/example-%E8%85%BE%E8%AE%AF%E4%BA%91.jpg`<br> or `sourcebucket-1250000001.cos.ap-shanghai.myqcloud.com/example-%E8%85%BE%E8%AE%AF%E4%BA%91.jpg?versionId=MTg0NDUxNzYzMDc0NDMzNDExOTc` | String | Yes |
