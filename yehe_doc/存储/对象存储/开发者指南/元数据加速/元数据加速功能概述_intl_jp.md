...
| オブジェクト権限     | サポートなし、デフォルトでバケット権限を継承     | サポートあり             |
| 同一都市内障害復旧     | サポートなし     | サポートあり             |
| バケット暗号化   | サポートなし                         | サポートあり             |
| オブジェクト暗号化   | サポートなし                         | サポートあり             |
| クロスドメインアクセスCORS | サポートなし                         | サポートあり             |
| リンク不正アクセス防止       | サポートなし                         | サポートあり             |
| バージョン管理     | サポートなし                         | サポートあり             |
| バケットコピー   | サポートなし                         | サポートあり             |
| 静的ウェブサイト     | サポートなし                         | サポートあり             |
| back-to-origin設定     | サポートなし                         | サポートあり             |
| ライフサイクル     | 一部サポートあり。標準タイプからアーカイブタイプへの移行のみサポート | サポートあり             |
| リスト機能     | サポートなし                         | サポートあり             |
| バケットタグ   | サポートなし                         | サポートあり             |
| COS Select    | サポートなし                         | サポートあり             |
| COS Batch     | サポートなし                         | サポートあり             |
| Cloud Infinite機能 | サポートなし                         | サポートあり             |

>? メタデータアクセラレーション機能は現在も引き続き拡充中のため、上の表の製品機能も次第にサポートされる予定です。
>
