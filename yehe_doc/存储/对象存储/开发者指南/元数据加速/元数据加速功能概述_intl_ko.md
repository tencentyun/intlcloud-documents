...
| 버킷 권한   | 지원                           | 지원             |
| 객체 권한     | 미지원. 기본적으로 버킷 권한 상속     | 지원             |
| 리전 내 재해 복구     | 미지원     | 지원             |
| 버킷 암호화   | 미지원                         | 지원             |
| 객체 암호화     | 미지원                         | 지원             |
| 교차 출처 리소스 공유 CORS | 미지원                         | 지원             |
| 링크 도용 방지       | 미지원                         | 지원             |
| 버전 관리     | 미지원                         | 지원             |
| 버킷 복사   | 미지원                         | 지원             |
| 정적 웹 사이트     | 미지원                         | 지원             |
| Origin-pull 설정     | 미지원                         | 지원             |
| 라이프사이클     | 일부 지원. 표준 유형에서 아카이브 유형으로의 전환만 지원 | 지원             |
| 리스트 기능     | 미지원                         | 지원             |
| 버킷 태그   | 미지원                         | 지원             |
| COS Select    | 미지원                         | 지원             |
| COS Batch     | 미지원                         | 지원             |
...
>? 메타데이터 가속 기능은 아직 개발 중이며 상기 표의 기능은 점진적으로 지원될 예정입니다.
>

## 과금 설명

현재 메타데이터 가속 기능은 베타 테스트 중으로, 상용화 요금은 과금되지 않습니다. 추후 과금 시 내부 메시지, 이메일, SMS 등으로 안내할 예정입니다. [내부 메시지](https://console.cloud.tencent.com/message) 또는 [과금 개요](https://cloud.tencent.com/document/product/436/16871)를 통해 최신 동향을 알아보실 수 있습니다.
