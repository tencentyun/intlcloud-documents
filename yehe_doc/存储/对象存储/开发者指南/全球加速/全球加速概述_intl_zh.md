...
> - 使用全球加速功能时，由于请求信息会通过腾讯云内网专线加速传输，因此需要进行收费。具体的价格详情可参见 [产品定价](https://intl.cloud.tencent.com/pricing/cos)。
...
使用全球加速域名上传数据或访问存储桶将会产生额外的加速计费，加速费用按**天**结算，相关计费项说明与定价可参见 [计费概述](https://intl.cloud.tencent.com/document/product/436/16871) 和 [产品定价](https://intl.cloud.tencent.com/pricing/cos)。以下展示使用加速域名和存储桶默认域名的费用对比：
