...
您可以使用对象存储控制台进行图片处理设置，详情请参见 [开启图片处理](https://intl.cloud.tencent.com/document/product/436/36569)。

#### 使用 REST API

您可以通过对象存储提供的 API 进行图片处理设置，详情请参见 [基础图片处理](https://intl.cloud.tencent.com/document/product/436/36365) API 文档。
