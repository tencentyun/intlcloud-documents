...
>?
>- 블라인드 워터마킹은 버킷 구성 페이지에서 활성화해야 하는 유료 서비스입니다. 각 계정에는 월 3,000개 이미지의 프리 티어가 제공되며 초과 사용량은 요금이 과금됩니다. 자세한 과금 안내는 CI [Billing and Pricing](https://intl.cloud.tencent.com/document/product/1045/33431)을 참고하십시오.
...
- CI는 각 계정에 월 3,000개의 이미지를 프리 티어로 제공하며 초과 사용량에 대해서는 요금이 과금됩니다. 미사용분은 다음 달로 이월되지 않습니다.
...
API를 사용하여 블라인드 워터마크를 추가하거나 추출할 수 있습니다. 자세한 내용은 [블라인드 워터마크](https://intl.cloud.tencent.com/document/product/1045/43029) API 문서를 참고하십시오.
