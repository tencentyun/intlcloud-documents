...
>?
>- ブラインドウォーターマークは有料サービスであり、使用する場合は、対応するバケットのページでボタンをオンにし、サービスをアクティブ化する必要があります。アカウントごとに3000回の無料利用枠があり、それを超えると課金され、料金はCloud Infiniteにより請求されます。詳細な課金説明については、Cloud Infinite[課金と価格](https://intl.cloud.tencent.com/document/product/1045/33431)をご参照ください。
