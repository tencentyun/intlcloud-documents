...
>? 图片压缩均为付费服务，由数据万象收取，具体费用请参见数据万象图片处理费用。
>
...
>? 使用 TPG 图片时，需确认**图片加载环境已支持 TPG 解码**，腾讯云数据万象提供集成 TPG 解码器的 [iOS](https://intl.cloud.tencent.com/document/product/1045/47707)、[Android](https://intl.cloud.tencent.com/document/product/1045/45575)、[Windows](https://main.qcloudimg.com/raw/851dd252378813d250eeca5ed55ffd36/TPG_win_SDK.zip) 终端 SDK，可帮助您快速接入和使用 TPG。
>
