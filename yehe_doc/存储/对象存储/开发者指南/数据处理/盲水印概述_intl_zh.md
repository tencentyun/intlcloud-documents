...
>?
>- 盲水印是付费服务，使用时需在相应存储桶配置页中通过开启按钮开通服务。每个账户拥有三千次免费额度，超出后进行计费，费用由数据万象收取，详细的计费说明请参见数据万象 [计费与定价](https://intl.cloud.tencent.com/document/product/1045/33431)。
>- 盲水印功能适用于所有公有云地域。
...
- 每个账户每月有3000张图片盲水印的免费体验额度，超出后将正常计费。未使用额度不会累积至下一月，详情请参见数据万象免费额度。
