...
| Bucket              | 执行清单任务的存储桶名称                                 |
| fileFormat       |  文件格式  |
| listObjectCount | 	列出的对象数量，费用按此项计费，详情请查看 [管理功能费用](https://intl.cloud.tencent.com/document/product/436/40098) 中的清单功能费用说明 |
...
#### 1. 创建 COS 角色
创建 COS 角色，具体接口信息请参见 [CreateRole](https://intl.cloud.tencent.com/document/product/598/33561)。
...
如果您需要在对象执行操作之前验证对象的状态，建议用 [HEAD Object](https://intl.cloud.tencent.com/document/product/436/7745) API 来检索对象元数据，或在对象存储控制台中检查对象属性。
