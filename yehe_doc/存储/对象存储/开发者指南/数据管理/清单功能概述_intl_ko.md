...
| Replicationstatus   | PENDING, COMPLETED, FAILED, REPLICA 중 하나로 설정합니다. 자세한 내용은 [복사 작용 설명](https://intl.cloud.tencent.com/document/product/436/19923)을 참고하십시오.|
| Tag | 객체 태그 |
...
#### 3. 인벤토리 기능 활성화
인터페이스 호출, 인벤토리 기능 활성화 및 구체적인 인터페이스 정보는 [PUT Bucket inventory](https://intl.cloud.tencent.com/document/product/436/30625)를 참고하십시오. 매니페스트 파일에 저장할 타깃 버킷과 소스 버킷은 같은 리전에 있어야 합니다.
