...
>!バケットタグは現時点では中国語のタグをサポートしていませんが、可能な限り速やかに対応する予定です。ご不明な点がありましたら、[チケットを提出](https://console.cloud.tencent.com/workorder/category)してお問い合わせください。
...
- バケット次元：バケットタグの数は1つのリソースにつき最大10個までです。
- タグ次元：
