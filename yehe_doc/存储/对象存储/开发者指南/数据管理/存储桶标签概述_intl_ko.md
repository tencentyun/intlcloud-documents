...
>!버킷 태그는 중국어 태그를 지원하지 않으며 빠른 시일 내에 지원할 예정입니다. 문의가 있을 경우 [티켓 제출](https://console.cloud.tencent.com/workorder/category)을 이용하십시오.
...
- 버킷의 경우: 리소스 하나당 서로 다른 버킷 태그 최대 10개까지 가능합니다.
- 태그의 경우: 
