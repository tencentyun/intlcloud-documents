...
표준IA 스토리지, 아카이브 및 딥 아카이브 유형별 객체 최소 크기 제한이 있습니다. 예를 들어 64KB보다 작은 객체가 표준IA 스토리지에 업로드되면 64KB로 계산됩니다. 비용 절감을 위해 라이프사이클은 64KB 미만 객체에 대해 스토리지 유형 전환 작업을 수행하지 않습니다. 
