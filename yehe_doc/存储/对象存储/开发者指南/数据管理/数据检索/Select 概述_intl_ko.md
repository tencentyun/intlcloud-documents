COS Select 기능은 구조화된 쿼리 명령(SQL)으로 COS에 저장된 객체를 선별하여 객체나 사용자가 필요한 데이터를 인덱스하기 쉽도록 합니다. COS Select 기능으로 객체 데이터를 선별하여 COS에 전송된 데이터 양을 줄이면 데이터 검색에 필요한 비용과 딜레이 현상을 줄일 수 있습니다.
...
요청을 통해 SQL 표현식을 COS에 전송할 수 있습니다. 현재 COS Select는 일부 SQL 표현식만 지원합니다. COS Select가 지원하는 SQL 표현식에 대한 자세한 정보는 [SQL 함수](https://intl.cloud.tencent.com/document/product/436/32474) 문서를 참조하십시오.
...
>SQL 절에 대한 세부 정보는 [Select 명령어](https://intl.cloud.tencent.com/document/product/436/32473)를 참조하십시오.

현재 COS Select가 지원하는 함수는 다음과 같습니다.
...
>SQL 함수에 대한 세부 정보는 [SQL 함수](https://intl.cloud.tencent.com/document/product/436/32474)를 참조하십시오.
...
> 오퍼레이터에 관한 자세한 정보는 [오퍼레이터](https://intl.cloud.tencent.com/document/product/436/32477)를 참조하십시오.
...
- API를 사용하려면 [SELECT Object Content](https://cloud.tencent.com/document/product/436/37641) API 문서를 참조하십시오.
- SDK를 사용하려면 [SDK 개요](https://intl.cloud.tencent.com/document/product/436/6474)에서 필요한 SDK 인터페이스를 선택하십시오.

## FAQ

조회할 때 오류가 생기면 COS Select는 오류 코드와 관련 오류 메시지를 반환합니다. 관련 오류 코드와 설명 리스트는 [특수 에러 코드](https://cloud.tencent.com/document/product/436/37641#errorcode)를 참조하십시오.                      
