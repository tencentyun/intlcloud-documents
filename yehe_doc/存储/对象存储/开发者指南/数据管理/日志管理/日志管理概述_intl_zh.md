...
| 24       | requester    | 访问者账号。<br>如果访问者为主账号，则账号格式为 `主账号 UIN:主账号 UIN`；<br>如果访问者为子账号，则账号格式为 `主账号 UIN:子账号 UIN`；<br>如果访问者为 [服务账号](https://intl.cloud.tencent.com/document/product/598/19421)，则账号格式为 `被授权的主账号 UIN:角色 ID`；<br>如果是匿名访问，则显示为 `-`             |    100000000001:100000000001          |
...
| 31       | vpcId    | VPC 请求 ID            | "0"(非VPC)/"12345"(VPC，为不为"0"的string)       |
