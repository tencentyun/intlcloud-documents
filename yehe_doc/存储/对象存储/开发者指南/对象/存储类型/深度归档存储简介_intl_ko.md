...
- **지원 리전**: 현재 베이징, 난징, 상하이, 광저우, 청두, 충칭 및 도쿄 리전만 지원되며, 기타 리전은 순차적으로 지원 예정입니다.
...
- **데이터 검색**: DEEP ARCHIVE 유형 파일은 일반 검색 모드와 대량 검색 모드를 지원합니다. 복구 시간은 일반 모드에서 12 - 24시간, 대량 모드에서 24 - 48시간입니다.
