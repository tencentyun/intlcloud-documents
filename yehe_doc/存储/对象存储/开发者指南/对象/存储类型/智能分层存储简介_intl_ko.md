...
현재 모든 COS SDK는 INTELLIGENT TIERING을 지원합니다. 이 스토리지 클래스를 사용하려면 파일을 업로드할 때 StorageClass를 INTELLIGENT_TIERING으로 설정하십시오. 자세한 내용은 [객체 업로드](https://www.tencentcloud.com/document/product/436/14107)를 참고하십시오.
...
>?
>- 스탠다드 스토리지 및 스탠다드IA 스토리지 용량 요금은 퍼블릭 클라우드 리전에 따라 가격이 상이하며, 구체적인 가격은 [가격 | Cloud Object Storage](https://buy.intl.cloud.tencent.com/price/cos?lang=en&pg=)를 참고하십시오.
