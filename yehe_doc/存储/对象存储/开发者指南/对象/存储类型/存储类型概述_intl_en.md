...
| Storage fees         | Consistent with the price of the storage class after object movement                  | Standard               | Low                           | Ultra-low                                                         | Ultra-low                                                         |
...
| Request fees         | Rather high. INTELLIGENT TIERING also charges object monitoring fees.     | Standard               | Rather high                         | Standard (data needs to be restored to STANDARD first)                                 | High (data needs to be restored to STANDARD first). To retrieve DEEP ARCHIVED data, request fees for retrieving the data will be incurred. |
