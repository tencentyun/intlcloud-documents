...
> - 了解项目请参见 CAM 的 [项目与标签](https://www.tencentcloud.com/document/product/598)，如需了解标签服务，请参见 [标签]((https://www.tencentcloud.com/document/product/651) 产品文档。
> - 了解标签的优势，请参见 [使用标签的优势](https://www.tencentcloud.com/document/product/598)。
> 
...
>?
> - 默认策略内容为授予子账号访问该项目标签下的所有资源。如果您只希望用户仅能对标签下的部分资源进行指定操作，您可以参见 [语法结构](https://intl.cloud.tencent.com/document/product/598/10604) 文档，修改策略语法中的 `action`（设置指定操作）和 `resource`（设定可操作资源）。
