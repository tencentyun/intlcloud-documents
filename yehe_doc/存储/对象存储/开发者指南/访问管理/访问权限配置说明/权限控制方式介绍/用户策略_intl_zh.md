...
CAM 提供了 [预设策略和自定义策略](https://intl.cloud.tencent.com/document/product/598/10601)。预设策略为 CAM 提供的系统预设策略，COS 相关策略见 [预设策略](#预设策略)；自定义策略支持用户自定义资源、操作等元素，更加灵活。下面说明如何新建一个自定义策略，为子账户授权：
