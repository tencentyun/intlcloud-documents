...
- **告警设置**：设置监控指标界限值。当监控数据触发告警条件时，云监控能及时发送告警信息至关心的群体中，详情请参见 [告警概述](https://intl.cloud.tencent.com/document/product/248/38910) 和 [设置监控告警](https://intl.cloud.tencent.com/document/product/436/39104)。
