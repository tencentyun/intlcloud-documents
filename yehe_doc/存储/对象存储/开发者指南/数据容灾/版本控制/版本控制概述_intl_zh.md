...
- 未启用版本控制状态下：上传、查询和删除对象等操作方式不变，详情请参见 [对象管理](https://intl.cloud.tencent.com/document/product/436/13321) 目录下的文档。
...
您可以通过以下过程，使用 versions 参数和 prefix 请求参数查询某对象的所有版本。有关 prefix 的更多信息，请参见 [GET Bucket Object versions](https://intl.cloud.tencent.com/document/product/436/31551) 文档。
查询某一对象的所有版本，请求示例如下：
