...
## 第一步：SDK 介绍
tencentcloud_cos_sdk_plugin 目前兼容支持 iOS、Android，是通过 Flutter Plugin 桥接原生 [Android](https://intl.cloud.tencent.com/document/product/436/12159) 和 [iOS](https://intl.cloud.tencent.com/document/product/436/11280) 的 COS SDK 实现。
...
| 参数名称   | 描述                                                         | 类型   | 默认值 | 支持平台 |
| ---------- | ------------------------------------------------------------ | ------ | ------ |------ |
| region | 存储桶地域 [地域和访问域名](https://intl.cloud.tencent.com/document/product/436/6224) | String | null | Android和iOS |
