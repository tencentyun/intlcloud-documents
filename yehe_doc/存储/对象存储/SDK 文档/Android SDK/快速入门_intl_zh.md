...
dependencies {
	...
    // 增加这行
    implementation 'com.tencent.qcloud:cosxml:5.6.+'
}
```
...
dependencies {
	...
    // 增加这行
    implementation 'com.tencent.qcloud:cosxml-ktx:5.6.+'
}
```

#### 精简版 SDK

bintray 仓库目前已经下线，精简版 sdk 暂时不可用，请优先使用标准版 sdk，后续将仓库迁移到 mavenCentral 后，再开放精简版 sdk 的使用。
