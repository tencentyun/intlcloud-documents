...
This API (PUT Bucket lifecycle) is used to set a lifecycle configuration on a bucket.

#### Request samples

Sample 1. Transition objects to Standard_IA storage class 30 days after an upload
...
Sample 2. Transition objects with the specified directory prefix `dir/` to ARCHIVE storage class 90 days after an upload
...
Sample 3. Remove the delete markers of expired files 180 days after an upload
...
Sample 4. Delete parts uploaded incompletely 30 days after an upload
...
| - - Days | Specifies the number of days it takes for the rule’s action to occur after the last modified date of the object. The valid value of this field is a non-negative integer, supporting up to 3,650 days. | Number | Yes |
| - - StorageClass | Indicates the storage class of transitioned object; enumerated values: `STANDARD`, `STANDARD_IA`, `ARCHIVE`. Default value: `STANDARD` | String | Yes |
| - NoncurrentVersionTransition | Specifies historical version object conversion attributes | ObjectArray | No |
| - - NoncurrentDays | Specifies the days before a historical version of the object is transitioned | Number | Yes |
...
| - - Days | Specifies the number of days it takes for the rule’s deletion action to occur after the last modified date of the object. It cannot be specified with `ExpiredObjectDeleteMarker` at the same time. | Number | Yes |
...
This API (GET Bucket lifecycle) is used to query the lifecycle management configuration on a bucket.
...
| - - - Days | Specifies the number of days it takes for the rule’s action to occur after the last modified date of the object. The valid value of this field is a non-negative integer, supporting up to 3,650 days. | Number |
...
| - - - NoncurrentDays | Specifies the number of days before a historical version of the object is transitioned | Number |
| - - - StorageClass | Indicates the storage class of transitioned object; enumerated values: `STANDARD`, `STANDARD_IA`, `ARCHIVE`. Default value: `STANDARD` | String |
...
| - - - Days | Specifies the number of days it takes for the rule’s deletion action to occur after the last modified date of the object. It cannot be specified with `ExpiredObjectDeleteMarker` at the same time. | Number |
