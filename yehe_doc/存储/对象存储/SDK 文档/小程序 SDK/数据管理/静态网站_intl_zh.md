...
| - - - HttpErrorCodeReturnedEquals   | 指定重定向错误码，只支持配置4XX返回码，优先级高于 ErrorDocument          | String      | 否   |
...
| - - - - HttpErrorCodeReturnedEquals   | 指定重定向错误码，只支持配置4XX 返回码，优先级高于 ErrorDocument          | String      | 
