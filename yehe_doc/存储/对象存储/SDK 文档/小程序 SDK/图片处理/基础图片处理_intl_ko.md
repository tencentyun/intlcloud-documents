...
```html
<view>
  <button type="primary" bindtap="button">업로드 시 이미지 처리 사용</button>
</view>
```
...
```html
<view>
  <button type="primary" bindtap="button">클라우드 데이터의 이미지 처리</button>
</view>
```
...
```html
<view>
  <button type="primary" bindtap="button">다운로드 시 이미지 처리 사용</button>
</view>
```
...
```html
<view>
  <button type="primary" bindtap="sign">이미지 처리 매개변수를 가진 URL 생성, 서명 포함</button>
  <button type="primary" bindtap="unsign">이미지 처리 매개변수를 가진 URL 생성, 서명 포함하지 않음</button>
</view>
```
