...
cos.getObjectUrl(
  ...
  function (err, data) {
    ...
    wx.request({
      url: data.Url, /* 预签名 url */
      method: 'PUT', /* PUT 和 getObjectUrl 填写的 Method 对应 */
      header: {},
      dataType: 'text',
      /* 可参考 demo 里的 putObject 方法获取 file https://github.com/tencentyun/cos-wx-sdk-v5/blob/master/demo/demo-sdk.js */
