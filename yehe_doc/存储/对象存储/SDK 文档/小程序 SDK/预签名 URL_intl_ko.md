...
POST Object 인터페이스를 통해서만 미니프로그램에 파일을 업로드할 수 있습니다. 여기서 가져온 사전 서명된 URL은 POST Object 인터페이스에 적합하지 않습니다. 직접 파일을 업로드해야 할 경우, [미니프로그램 다이렉트 업로드 사례](https://intl.cloud.tencent.com/document/product/436/30934) 가이드를 참조하십시오.
