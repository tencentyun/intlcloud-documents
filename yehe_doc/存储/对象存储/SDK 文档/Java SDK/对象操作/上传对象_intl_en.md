...
The advanced APIs encapsulate simple APIs via the TransferManager class to provide APIs for easier operations. Internally, a thread pool is used to concurrently receive and process requests from you, so you can choose to execute jobs asynchronously after submitting multiple jobs.
