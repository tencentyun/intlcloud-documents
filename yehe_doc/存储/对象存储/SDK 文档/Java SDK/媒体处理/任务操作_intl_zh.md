...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [CreateMediaJobs](https://intl.cloud.tencent.com/document/product/1045/43687) | 创建任务 | 创建一个媒体处理任务 |
| [CancelMediaJob](https://intl.cloud.tencent.com/document/product/1045/43686) | 删除任务 | 删除一个媒体处理任务，正在处理中的任务不可删除 |
| [DescribeMediaJob](https://intl.cloud.tencent.com/document/product/1045/43688) | 查询任务 | 查询一个任务 |
| [DescribeMediaJobs](https://intl.cloud.tencent.com/document/product/1045/43689) | 查询任务列表 | 查询队列中的任务列表 |
...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | ---- |
| Animation  | Request.Operation | 指定该任务的参数，同创建动图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43631) 接口中的 Request.Animation  | Container | 否   |
| Snapshot   | Request.Operation | 指定该任务的参数，同创建截图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43635) 接口中的 Request.Snapshot   | Container | 否   |
| Transcode  | Request.Operation | 指定该任务的参数，同创建转码模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43643) 接口中的 Request.Transcode   | Container | 否   |
| Watermark  | Request.Operation | 指定该任务的参数，同创建水印模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43639) 接口中的 Request.Watermark   | Container | 否   |
...
| 节点名称（关键字） | 父节点                      | 描述                                   | 类型      | 必选 |
| ------------------ | :-------------------------- | -------------------------------------- | --------- | ---- |
| Container          | Request.Operation.Animation | 同动图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43631) 接口中的 Request.Container    | Container | 否   |
| Video              | Request.Operation.Animation | 同动图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43631) 接口中的 Request.Video        | Container | 否   |
| TimeInterval       | Request.Operation.Animation | 同动图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/43631) 接口中的 Request.TimeInterval | Container | 否   |
