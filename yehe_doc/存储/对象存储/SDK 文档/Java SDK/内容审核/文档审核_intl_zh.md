...
| API                                                          | 操作描述                   |
| :----------------------------------------------------------- | :------------------------- |
|[提交文档审核任务](https://www.tencentcloud.com/document/product/1045/52121) | 用于提交一个文档审核任务   |
|[查询文档审核任务结果](https://intl.cloud.tencent.com/document/product/1045/52122)  | 用于查询指定的文档审核任务 |
