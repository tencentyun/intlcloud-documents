...
// 2. Set the region abbreviation for the bucket. For abbreviations of COS regions, please see https://cloud.tencent.com/document/product/436/6224
...
// 2. Set the region abbreviation for the bucket. For abbreviations of COS regions, please see https://cloud.tencent.com/document/product/436/6224
ClientConfig clientConfig = new ClientConfig(new Region("ap-beijing"));
// HTTPS is recommended, which requires the custom domain to have the relevant SSL certificate.
clientConfig.setHttpProtocol(HttpProtocol.https);
...
| Parameter | Description | Type |
| ------------------ | ---------------------------- | -------------- |
| endPointSuffix     | Set the domain suffix to use a global acceleration endpoint. | String         |
