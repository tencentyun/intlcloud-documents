...
> - 上传之后，您可以用同样的 Key 生成文件下载链接，具体使用方法请参见 [生成预签名链接](https://intl.cloud.tencent.com/document/product/436/38068)。但注意，如果您的文件是私有读权限，那么下载链接只有一定的有效期。
>
...
```
>?
> - 文件流上传特性从 5.4.24 版本开始支持，下载新版 SDK 前往 [Releases](https://github.com/tencentyun/qcloud-sdk-dotnet/releases) 或参见 [快速入门](https://intl.cloud.tencent.com/document/product/436/30594)。
