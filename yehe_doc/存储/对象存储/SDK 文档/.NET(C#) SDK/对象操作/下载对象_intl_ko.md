...
#### 예시 코드2: 다운로드 중단 지점부터 이어서 전송하기 설정

[//]: #	".cssg-snippet-transfer-download-resumable"

```cs
COSXMLDownloadTask downloadTask = new COSXMLDownloadTask(request);
 //중단 지점 다운로드 재개 활성화. 로컬로 다운로드 완료되지 않은 파일이 있을 때 파일을 끝까지 다운로드
 //로컬 파일의 기존 부분이 이번 다운로드의 내용과 일치하지 않아 다운로드가 실패할 수 있습니다. 파일을 삭제하고 다시 시도하십시오.
