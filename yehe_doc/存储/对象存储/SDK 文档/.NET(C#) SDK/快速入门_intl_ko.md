...
- Windows: .NET Core 2.0 이상의 버전 또는 .NET Framework 4.6.1 이상의 버전 설치. 
...
SDK에서 영구 키, 지속적으로 갱신되는 임시 키, 불변의 임시 키 3가지 방식을 제공합니다. 
...
`CosXmlConfig`, `QCloudCredentialProvider`를 사용하여 `CosXmlServer` 서비스류를 초기화 합니다. 서비스류는 프로그램에서 **단일 항목**으로 사용할 것을 권장합니다.
