...
| API           | 操作描述                 |
| ------------- |  ---------------------- |
| [提交截图任务](https://www.tencentcloud.com/document/product/436/49055) | 提交一个截图任务 |
...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| :----------------- | :---------------- | :----------------------------------------------------------- | :-------- | :------- |
| Snapshot           | Request.Operation | 指定该任务的参数，同创建截图模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/49909) 接口中的 Request.Snapshot | Container | 否       |
