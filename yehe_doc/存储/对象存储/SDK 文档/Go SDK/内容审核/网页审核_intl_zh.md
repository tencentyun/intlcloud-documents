...
| API           |  操作描述               |
| :--------------- | :------------------ |
| [创建任务](https://intl.cloud.tencent.com/document/product/436/48282) | 用于提交一个网页审核任务   |
| [查询任务](https://intl.cloud.tencent.com/document/product/436/48283) | 用于查询指定的网页审核任务 |
...
调用 PutWebpageAuditingJob 函数，会解析 API 返回的 xml 内容到 PutWebpageAuditingJobResult 结构，具体返回参数可查看 [提交网页审核任务](https://intl.cloud.tencent.com/document/product/436/48282) 文档。
...
调用 GetWebpageAuditingJob 函数，会解析 API 返回的 xml 内容到 GetWebpageAuditingJobResult 结构，具体返回参数可查看 [查询网页审核任务结果](https://intl.cloud.tencent.com/document/product/436/48283) 文档。
