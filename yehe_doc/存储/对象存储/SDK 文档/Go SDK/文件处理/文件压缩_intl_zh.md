...
| API                 | 操作描述            |
| ------------------- | ------------------- |
| [提交多文件打包压缩任务](https://intl.cloud.tencent.com/document/product/436/53995)   | 以提交任务的方式进行多文件打包压缩任务        |
| [查询多文件打包压缩结果](https://intl.cloud.tencent.com/document/product/436/53996)  | 主动查询指定的多文件打包压缩任务结果 |
