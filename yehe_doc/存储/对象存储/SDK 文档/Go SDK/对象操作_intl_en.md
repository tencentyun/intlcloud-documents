...
This API is used to upload an object up to 5 GB to a bucket. For larger files, please use [multipart upload](#Multipart-upload-operations) or [Advanced upload API](#Advanced-APIs-(recommended)). 
