...
CosResult 封装了请求出错时返回的错误码和对应错误信息，详情请参见 [错误码](https://intl.cloud.tencent.com/document/product/436/7730)。
...
- 对于 Response，所有方法的 Response 均有获取公共返回头部的成员函数。Response 的公共成员函数如下，具体字段含义请参见 [公共返回头部](https://intl.cloud.tencent.com/document/product/436/7729)，此处不再赘述。
