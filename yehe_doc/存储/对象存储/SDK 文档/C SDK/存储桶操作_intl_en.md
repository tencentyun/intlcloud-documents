...
| cos_acl | Allows user to customize permissions. <br>Valid values: COS_ACL_PRIVATE(0), COS_ACL_PUBLIC_READ(1), COS_ACL_PUBLIC_READ_WRITE(2) <br>Default value: COS_ACL_PRIVATE(0) | Enum   |
