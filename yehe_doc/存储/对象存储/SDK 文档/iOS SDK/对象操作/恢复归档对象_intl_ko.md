 ...
 * @FilePath: /qcloud-documents/product/스토리지와 CDN/객체 스토리지 4.0/SDK문서/iOS SDK/객체 작업/보관된 객체 복구.md
-->
## 소개

본 문서는 보관된 객체 복구 작업에 대한 API 개요 및 SDK 예시 코드를 제공합니다.
...
>?전체 예시는 [GitHub](https://github.com/tencentyun/cos-snippets/tree/master/iOS/Objc/Examples/cases/RestoreObject.m)를 참조하십시오.
...
>?전체 예시는 [GitHub](https://github.com/tencentyun/cos-snippets/tree/master/iOS/Swift/Examples/cases/RestoreObject.swift)를 참조하십시오.
