...
- Download the COS XML Node.js SDK source code from [GitHub](https://github.com/tencentyun/cos-nodejs-sdk-v5).
- Download the XML Node.js SDK from [GitHub](https://cos-sdk-archive-1253960454.file.myqcloud.com/cos-nodejs-sdk-v5/latest/cos-nodejs-sdk-v5.zip).
- Download the XML Node.js SDK demo from [GitHub](https://github.com/tencentyun/cos-nodejs-sdk-v5/tree/master/demo).
- For all the code samples, visit [GitHub](https://github.com/tencentyun/cos-snippets/tree/master/NodeJS).
...
Get the `SecretId` and `SecretKey` on the [Manage API Key](https://console.cloud.tencent.com/cam/capi) page in the CAM console.
...
Below are some common API samples. For more detailed initialization methods, see the demo at [GitHub](https://github.com/tencentyun/cos-nodejs-sdk-v5/blob/master/demo/demo.js).
...
| getAuthorization | Callback method for getting the signature. If there is no `SecretId` or `SecretKey`, this parameter will be required. | Function | No |
...
Below are some common API samples. For more detailed initialization methods, see the demo at [GitHub](https://github.com/tencentyun/cos-nodejs-sdk-v5/tree/master/demo/demo.js).
...
This API is suitable for uploading small files. For large files, use the multipart upload API. For more information, see [Object Operations](https://www.tencentcloud.com/document/product/436/43551).
