...
4. Configure the CORS rule. Put in `*` for AllowHeader. For ExposeHeaders, put in ETag, Content-Length, and other JS-required header fields. For more information, please see [Setting Cross-Origin Access](https://intl.cloud.tencent.com/document/product/436/13318).
...
| ChunkSize | Part size within the multipart upload measured in bytes. Default value: 1048576 (1 MB) | Number | No |
...
| ProgressInterval | Callback frequency of the upload progress callback method `onProgress` measured in milliseconds. Default value: 1000 | Number | No |
...
| - Region | Bucket region. For the enumerated values, please see [Bucket Region Information](https://intl.intl.cloud.tencent.com/document/product/436/6224) | String |
...
| - Key | An object key (object name) is the unique ID of an object in a bucket. For more information, please see [Object Overview > ObjectKey](https://intl.cloud.tencent.com/document/product/436/13324) | String |
...
The simple upload API can be used to upload small files. For large files, use the multipart upload API. For more information, please see [Actions on Objects](https://intl.cloud.tencent.com/document/product/436/30596).
