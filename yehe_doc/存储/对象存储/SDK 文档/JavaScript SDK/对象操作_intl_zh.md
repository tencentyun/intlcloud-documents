...
获取前缀为exampleobjec的未完成的 UploadId 列表，示例如下：
...
| - - Tier           | 恢复数据时，Tier 可以指定为 COS提供的三种恢复模式，分别为 Standard（标准模式，恢复任务在3 - 5小时内完成）、Expedited（极速模式，恢复任务在15分钟内可完成）以及 Bulk（批量模式，恢复任务在5 - 12小时内完成） | String | 是   |
