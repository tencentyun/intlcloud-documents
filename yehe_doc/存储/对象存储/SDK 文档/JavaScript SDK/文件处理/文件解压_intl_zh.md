...
| API                                                                            | 操作描述                           |
|--------------------------------------------------------------------------------| --------------------------------- |
| [提交文件解压任务](https://intl.cloud.tencent.com/document/product/436/53993) |  创建一个文件处理解压任务 |
| [查询文件解压结果](https://intl.cloud.tencent.com/document/product/436/53994) |  查询一个文件处理解压任务 |
...
详情请参见 [提交文件解压任务](https://intl.cloud.tencent.com/document/product/436/53993)。
...
详情请参见 [查询文件解压结果](https://intl.cloud.tencent.com/document/product/436/53994)。
