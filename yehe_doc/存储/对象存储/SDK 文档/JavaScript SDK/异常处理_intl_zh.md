...
| - error       | 请求报错信息                                                 | Object/String |
| - - Code      | 请求失败时 body 返回的 Error Code，详情请参见 [错误码](https://intl.cloud.tencent.com/document/product/436/7730) 文档 | String        |
| - - Message   | 请求失败时 body 返回的 Error Message，详情请参见 [错误码](https://intl.cloud.tencent.com/document/product/436/7730) 文档 | String        |
| - - RequestId | 服务器请求日志里的唯一 ID，可用于遇到问题 [联系我们](https://intl.cloud.tencent.com/contact-sales) 排查错误原因 | String        |
