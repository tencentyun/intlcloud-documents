...
### How do I get the file upload progress in the JavaScript SDK?
...
### Can I obtain the progress directly by using the `List Multipart Uploads` API of the JavaScript SDK?

Currently, the `List Multipart Uploads` API needs to use a callback function to return the progress. Therefore, you cannot obtain the progress directly.
