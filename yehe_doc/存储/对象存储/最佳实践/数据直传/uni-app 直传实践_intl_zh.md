...
>? 本文档内容基于 XML API 的 [PostObject 接口](https://intl.cloud.tencent.com/document/product/436/14690)。
>
...
3. 前端调用 [PostObject 接口](https://intl.cloud.tencent.com/document/product/436/14690)，直传文件到 COS。
...
3. 进入刚创建的存储桶详情页面，在**安全管理 > 跨域访问CORS设置**页面，单击**添加规则**。配置示例如下图，详情请参见 [设置跨域访问](https://intl.cloud.tencent.com/document/product/436/13318) 文档。
   ...
   export default {
      ...
      methods: {
         selectUpload() {
            ...
            // 接口文档：https://intl.cloud.tencent.com/document/product/436/14690#.E7.AD.BE.E5.90.8D.E4.BF.9D.E6.8A.A4
