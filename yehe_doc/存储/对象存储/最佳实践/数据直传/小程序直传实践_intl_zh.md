...
<span id="前期准备"></span>
## 前期条件
1. 登录  [对象存储控制台](https://console.cloud.tencent.com/cos5) ，创建存储桶，设置 BucketName（存储桶名称） 和 Region（地域名称），详情请参见 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309) 文档。
...
如有其他语言或自行实现可参考以下流程：
（1）向服务端获取临时密钥，服务端首先使用固定密钥 SecretId、SecretKey 向 STS 服务获取临时密钥，得到临时密钥 tmpSecretId、tmpSecretKey、sessionToken，详情请参见 [临时密钥生成及使用指引](https://intl.cloud.tencent.com/document/product/436/14048) 或 [cos-sts-sdk](https://github.com/tencentyun/qcloud-cos-sts-sdk) 。
...
以下代码同时举例了 [PUT Object ](https://intl.cloud.tencent.com/document/product/436/7749) 接口（推荐使用）和[POST Object ](https://intl.cloud.tencent.com/document/product/436/14690) 接口，操作指引如下：
...
如需使用小程序 SDK，请参见小程序 SDK [快速入门](https://intl.cloud.tencent.com/document/product/436/30609) 文档。
