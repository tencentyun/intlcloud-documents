...
这篇文章我们来介绍一下如何使用插件实现远程附件功能，将 WordPress 的媒体库附件存储在腾讯云 [对象存储 COS](https://intl.cloud.tencent.com/product/cos) 上。
...
- 可配合腾讯云 [内容分发网络 CDN](https://intl.cloud.tencent.com/product/cdn) 进一步提升用户查看图片附件的速度，优化网站访问速度。
