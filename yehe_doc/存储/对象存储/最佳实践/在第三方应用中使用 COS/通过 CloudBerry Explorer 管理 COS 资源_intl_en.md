...
In addition to the above features, CloudBerry Explorer also supports setting object ACLs, viewing object metadata, customizing headers, and getting object URLs.
