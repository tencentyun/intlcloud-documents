...
현재 점점 더 많은 고객들이 클라우드 백업을 선택하고 있으며, Oracle 백업 모듈은 COS와의 접목을 구현하였습니다. COS 기반의 저비용 데이터베이스 백업 및 복구를 최적화합니다.
...
```
 - **TAG20190507T163102**의 tag 값은 각 백업의 ID 번호와 동일합니다. list backup을 통해 획득하며, 이전에 복원된 제어 파일과 일치해야 합니다. 즉, 핸들이 " **ORACLE_1880733115_20190507_5_1007656283_1_1.conf**" 인 백업 파일.
