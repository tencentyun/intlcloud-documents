...
[临时密钥（临时访问凭证）](https://intl.cloud.tencent.com/document/product/598/35838) 是通过 CAM 云 API 提供的接口，获取到权限受限的密钥。
...
获取临时密钥，可以通过提供的 [COS STS SDK](https://github.com/tencentyun/qcloud-cos-sts-sdk) 方式获取，也可以直接请求 [STS 云 API](https://intl.cloud.tencent.com/document/product/598/35838) 的方式获取。
...
public class Demo {
    public static void main(String[] args) {
		...
		try {
		    ...
		    // 密钥的权限列表。简单上传、表单上传和分片上传需要以下的权限，其他权限列表请看 https://intl.cloud.tencent.com/document/product/436/30580
...
public class Demo {
    public static void main(String[] args) throws Exception {
        ...
        // 2 设置 bucket 区域,详情请参阅 COS 地域 https://intl.cloud.tencent.com/document/product/436/6224
