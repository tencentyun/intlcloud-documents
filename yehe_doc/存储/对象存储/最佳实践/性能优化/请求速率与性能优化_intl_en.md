...
If the access load remains as high as more than 30,000 requests per second under the same enumerated prefix, you can refer to the previous method to add a hash prefix after the enumerated value to implement multiple index partitions, so as to improve the read/write performance.
<pre>
