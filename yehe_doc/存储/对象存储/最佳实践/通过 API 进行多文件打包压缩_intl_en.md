...
1. Multi-File Zipping is implemented with Tencent Cloud Serverless Cloud Function (SCF). You need to log in to the COS console and create a **multi-file zipping** function.For the creation guide, please refer to [Multi-File Zipping](https://www.tencentcloud.com/document/product/436/41625).
