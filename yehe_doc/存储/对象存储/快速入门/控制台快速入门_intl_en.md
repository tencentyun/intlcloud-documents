...
If you have already done so, ignore this step.
...
Go to the COS Console and activate the COS service following the instructions. If you have already done so, ignore this step.
...
1. Click **Details** for `exampleobjext.txt` to enter the object attribute page.
2. Click **Download Objects** in **Basic Information** to download the object. Or, click **Copy Temporary Link**, paste the link into a browser, and press Enter to download the object.
...
To learn more about how to work with the COS console, such as setting bucket access permissions, hotlink protection, and logging, see [Console Guide](https://intl.cloud.tencent.com/document/product/ 436/11365).
