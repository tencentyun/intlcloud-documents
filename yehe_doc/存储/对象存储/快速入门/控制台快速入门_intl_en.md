...
1. Click **Details** under **Operation** for the object `exampleobjext.txt` and enter the object attribute page.
...
## Other Accesses
In addition to the console, the following accesses are also provided for you to get started with.
