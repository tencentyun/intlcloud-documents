...
1. The COS service is enabled for your Tencent Cloud account. If not, please go to the [COS Console] (https://console.cloud.tencent.com/cos5) and follow the instructions to activate it.
2. You login to COSBrowser using an API key. First, go to the [API Key] (https://console.cloud.tencent.com/cam/capi) management page to create one.


## Step 1. Download and install COSBrowser

The COSBrowser Windows version can run on Windows 7 32/64-bit or above, and Windows Server 2008 R2 64 or above. To download other versions, go to [COSBrowser Overview] (https://intl.cloud.tencent.com/document/product/436/11366).
...
Use your [API Key] (https://console.cloud.tencent.com/cam/capi) to login to COSBrowser.
...
Should you have any problems with this tool, you may contact us by [submitting a ticket](https://console.cloud.tencent.com/workorder/category).
