...
스토리지 유형은 COS에서 객체의 스토리지 레벨과 활성화 정도를 나타냅니다. COS는 인텔리전트 티어링 스토리지, 스탠다드 스토리지, 스탠다드IA 스토리지, 아카이브 스토리지, 딥 아카이브 스토리지의 다양한 객체의 스토리지 유형을 제공합니다. 스토리지 유형별로 각각 객체 액세스 빈도, 데이터 지속성, 데이터 가용성 및 액세스 딜레이 시간 등의 특성을 가집니다. 사용자는 시나리오에 따라 스토리지 유형을 선택해 데이터를 COS에 업로드할 수 있습니다.스토리지 유형에 대한 비교 설명은 [스토리지 유형 개요](https://intl.cloud.tencent.com/document/product/436/30925)를 참고하십시오.
>
