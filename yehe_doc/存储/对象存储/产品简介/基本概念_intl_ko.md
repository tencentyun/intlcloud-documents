...
관련 문서는 [버킷 개요](https://intl.cloud.tencent.com/document/product/436/13312)를 참조하십시오.
...
관련 문서는 [객체 개요](https://intl.cloud.tencent.com/document/product/436/13324)를 참조하십시오.
...
관련 문서는 [버킷 개요](https://intl.cloud.tencent.com/document/product/436/13312), [액세스 정책 언어 개요](https://intl.cloud.tencent.com/document/product/436/18023), [리소스 설명 방식](https://intl.cloud.tencent.com/document/product/598/10606)을 참조하십시오.
...
관련 문서는 [액세스 정책 언어 개요](https://intl.cloud.tencent.com/document/product/436/18023), [리소스 설명 방식](https://intl.cloud.tencent.com/document/product/598/10606)을 참조하십시오.
...
관련 문서는 [액세스 제어의 기본 개념](https://intl.cloud.tencent.com/document/product/436/30581), [ACL 개요](https://intl.cloud.tencent.com/document/product/436/30583)를 참조하십시오.
...
정책(policy)은 몇 개의 요소로 구성되며, 권한의 구체적인 정보를 설명하는 데 사용합니다. 자세한 내용은 [액세스 정책 언어 개요](https://intl.cloud.tencent.com/document/product/436/18023)를 참조하십시오.
...
### CDN Origin-pull 트래픽
데이터를 COS에서 Tencent Cloud CDN 엣지 노드로 전송할 때 발생하는 트래픽입니다.


### 기본 도메인
COS 원본 서버 도메인으로, 버킷 생성 시 시스템에서 버킷 이름 및 리전에 따라 자동으로 생성하며 기본 가속 도메인 지역과 구분되어야 합니다. 자세한 내용은 [도메인 관리 개요](https://intl.cloud.tencent.com/document/product/436/18424)를 참조하십시오.


### 기본 CDN 가속 도메인

CDN 가속 노드를 경유하여 가속되는 도메인으로, 시스템이 기본으로 생성하며 사용자가 활성화 또는 비활성화를 선택할 수 있습니다. 자세한 내용은 [도메인 관리 개요](https://intl.cloud.tencent.com/document/product/436/18424)를 참조하십시오.


### 사용자 정의 CDN 가속 도메인
버킷에 ICP비안을 통과한 사용자 정의 도메인을 Tencent Cloud 중국 내 CDN 가속 플랫폼으로 바인딩할 수 있으며, 사용자 정의 도메인을 통해 버킷에 있는 객체에 액세스합니다. 자세한 내용은 [도메인 관리 개요](https://intl.cloud.tencent.com/document/product/436/18424)를 참조하십시오.


### 사용자 정의 원본 서버 도메인
ICP비안을 통과한 사용자 정의 도메인을 현재 버킷에 바인딩할 수 있으며, 사용자 정의 도메인을 통해 버킷에 있는 객체에 액세스합니다. 자세한 내용은 [도메인 관리 개요](https://intl.cloud.tencent.com/document/product/436/18424)를 참조하십시오.


### 데이터 검색
표준IA 스토리지 및 CAS 유형은 콜드 데이터 스토리지 유형입니다. 표준IA 스토리지의 경우 해당 데이터 읽기 또는 다운로드 시 백그라운드에서 먼저 데이터를 검색한 후에 읽기 또는 다운로드할 수 있으며, CAS 데이터는 읽기 및 다운로드할 수 없고, 이 때의 데이터 검색을 데이터 동결 해제(즉, CAS 데이터를 표준 데이터로 복구하는 과정)라고 합니다.
...
관련 문서는 [다중 AZ 특성 개요](https://intl.cloud.tencent.com/document/product/436/35208)를 참조하십시오.
...
관련 문서는 [리전 및 액세스 도메인](https://intl.cloud.tencent.com/document/product/436/6224)을 참조하십시오.
