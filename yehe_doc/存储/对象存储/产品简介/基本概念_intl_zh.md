...
APPID 经常使用在存储桶名称上，完整的存储桶名称由用户自定义字符串和 APPID 组成，使用中划线“-”相连，例如 `examplebucket-1250000000`中的 1250000000 即为 APPID。
...
### 默认域名
即 COS 源站域名，是创建存储桶时，由系统根据存储桶名称和地域自动生成的，要与默认加速域名区分开。详情请参见 [域名管理概述](https://intl.cloud.tencent.com/document/product/436/18424)。
