     ...
     <tr>
        <td rowspan="4">버킷</td>
    			...
    			<td><ul style="margin: 0;"><li>버킷이 성공적으로 생성되면 이름과 리전을 수정할 수 없습니다. </li>
					...
					<li> 이름은 ‘-’로 시작하거나 끝날 수 없으며 영문 소문자 및 숫자[az, 0-9], 하이픈 ‘-’만 지원됩니다. 버킷 이름의 최대 글자 수는 <a href= "https://intl.cloud.tencent.com/document/product/436/6224">리전 약칭</a> 및 APPID 의 글자 수에 따라 달라집니다. 전체 요청 도메인 이름 글자 수는 최대 60자입니다. </li></ul></td>
     </tr>
    	 <tr>
    			<td> 버킷 수량</td>
