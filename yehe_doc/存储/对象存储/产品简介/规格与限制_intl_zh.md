     ...
     <tr>
        <td rowspan="4">存储桶</td>
    			...
    			<td><ul  style="margin: 0;"><li>存储桶一旦创建成功，名称和所处地域不能修改。</li>
					...
					<li> 名称不能以“-”开头或结尾，只支持英文小写字母和数字[a-z，0-9]、中划线“-”及其组合，存储桶名称的最大允许字符受到 <a href="https://intl.cloud.tencent.com/document/product/436/6224">地域简称</a> 和 APPID 的字符数影响，组成的完整请求域名字符数总计最多60个字符。</li></ul></td>
     </tr>
    	 <tr>
    			<td> 存储桶数量</td>
