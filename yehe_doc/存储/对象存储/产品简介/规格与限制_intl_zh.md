<table>
 ...
        <td>QPS</td>
    			<td>限制</td>
    			<td>中国大陆公有云地域默认每个存储桶独享30000QPS，金融云地域默认每个存储桶独享3000QPS。中国香港及海外地域默认每个存储桶独享3000QPS。如需更高 QPS，请参见 <a href="https://intl.cloud.tencent.com/document/product/436/13653">请求速率与性能优化</a> </td>
    </tr>
		    <tr>
        <td>带宽</td>
    			<td>限制</td>
        ...
        <td rowspan="4">存储类型</td>
    			<td nowrap="nowrap">标准存储（多 AZ）限制</td>
    			<td>计费限制：<br>存储时间无限制<br>存储单元不足128KB，按128KB计算<br>标准存储（多 AZ）计费详情，请参见 <a href="https://intl.cloud.tencent.com/document/product/436/6239">产品定价</a></td>
    </tr>
    	 <tr>
    			<td>标准存储限制</td>
    	 ...
    	 <tr>
        <td>低频存储限制</td>
    			<td>计费限制：<br>存储时间不足30天，按30天计算<br>存储单元不足64KB，按64KB计算<br>低频存储计费详情，请参见 <a href="https://intl.cloud.tencent.com/document/product/436/6239">产品定价</a></td>
    </tr>
    	 <tr>
        <td>归档存储限制</td>
    			<td>计费限制：<br>存储时间不足90天，按90天计算<br>存储单元不足64KB，按64KB计算<br>归档存储计费详情，请参见 <a href="https://intl.cloud.tencent.com/document/product/436/6239">产品定价</a></td>				
    </tr>
     <tr>
        <td rowspan="3">存储桶</td>
    			<td>限制</td>
    			<td>1. 存储桶一旦创建成功，名称和所处地域不能修改<br>2. 同一用户账号下所有存储桶名称唯一且不支持重命名<br>3. 名称只支持小写字母和数字[a-z，0-9]、中划线“-”及其组合，支持1 - 50个字符</td>
     </tr>
    	 <tr>
    			<td> 存储桶数量</td>
 ...
    			<td>规则数量</td>
    		...
    		<tr>
    			<td >存储类型转化</td>
    			<td >标准转低频：最小1天<br>标准/低频转归档：最小1天<br>注意：标准存储（多 AZ）暂不支持沉降为低频存储和归档存储类型 </td>
    		</tr>
    		 <tr>
    			<td >过期删除</td>
