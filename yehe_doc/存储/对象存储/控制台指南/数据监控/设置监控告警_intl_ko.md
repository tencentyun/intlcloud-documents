...
>
2. **생성**을 클릭하고 아래와 같이 새 알람 정책 설정을 시작합니다.
...
<table>
  ...
  <tr>
   ...
   <tr>
        <td >알람 공지 설정</td>
        <td>알람 공지</td>
        <td>시스템 사전 설정 공지 템플릿 및 사용자 정의 공지 템플릿을 선택할 수 있으며 알람 정책마다 최대 3개의 공지 템플릿을 바인딩할 수 있습니다. 상세 내용은 <a href="https://intl.cloud.tencent.com/document/product/248/38906">Alarm Notification Template</a>을 참고하십시오.</td>
    </tr>
		<tr>
      <td>고급 설정</td>
      <td >오토 스케일링</td>
...
3. 상기 정보를 설정한 후 **저장**을 클릭하여 COS 알람 정책을 성공적으로 생성합니다.
