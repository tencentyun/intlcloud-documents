...
<table>
  ...
  <tr>
   ...
   <tr>
        <td>アラート通知の設定</td>
        <td>アラート通知</td>
        <td>システム通知デフォルトテンプレートとユーザーカスタム通知テンプレートの選択がサポートされます。各アラートポリシーは、3つの通知テンプレートにのみバインドできます。</td>
    </tr>
		<tr>
      <td>高度な設定</td>
      <td>自動スケーリング</td>
