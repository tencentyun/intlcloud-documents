...
COS 콘솔은 COS에서 제공하는 가장 간단하면서도 쉽게 시작할 수 있는 작업 방식입니다. 코드 편집이나 프로그램을 실행할 필요 없이 직접 버킷 생성, 데이터 업로드와 공유 및 백업, 일괄 처리 등이 가능하며 풍부하고 다양한 기능을 가지고 있습니다. 해당 작업과 관련한 문서는 다음 표를 참조하십시오.
...
| 데이터 처리       | 이미지 처리:<br><li>[기본 이미지 처리](https://intl.cloud.tencent.com/document/product/436/36569) <br>함수 계산:<br><li>[파일 압축 해제 설정](https://intl.cloud.tencent.com/document/product/436/35663)<br><li>[CDN 캐시 퍼지 설정](https://intl.cloud.tencent.com/document/product/436/37273)<li>[CDB 백업 설정](https://intl.cloud.tencent.com/document/product/436/39629) |
|   애플리케이션 통합  |   <li>[Ckafka 메시지 백업](https://cloud.tencent.com/document/product/436/54233)<br><li>[로그 클리닝](https://cloud.tencent.com/document/product/436/54234)    |
