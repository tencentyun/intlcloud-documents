## Overview
You can create a bucket on the **Bucket List** page in the COS console. For more information about buckets, see [Bucket Overview](https://intl.cloud.tencent.com/document/product/436/13312).
...
![](https://qcloudimg.tencent-cloud.cn/raw/3cd1360bc4c2fe796ee2f2d97975727d.png)
   - **Region**: A COS region corresponding to the physical location where your business or users are distributed. This field cannot be modified once configured. For more information about regions, see [Regions and Access Endpoints](https://cloud.tencent.com/document/product/436/6224).
   - **Name**: A custom bucket name, which cannot be modified once configured. For more information, see [Naming Conventions](https://intl.cloud.tencent.com/document/product/436/13312#.E5.AD.98.E5.82.A8.E6.A1.B6.E5.91.BD.E5.90.8D.E8.A7.84.E8.8C.83).
   - **Access Permission**: Three access permissions are available for buckets by default: "Private Read/Write", "Public Read/Private Write", and "Public Read/Write". You can modify it if needed. For more information, see [Setting Access Permission](https://cloud.tencent.com/document/product/436/13315).
