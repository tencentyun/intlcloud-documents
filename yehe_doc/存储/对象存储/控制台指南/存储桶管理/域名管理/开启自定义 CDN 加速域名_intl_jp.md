...
ここでは、Cloud Object Storage（COS）コンソールにカスタムアクセラレーションドメイン名を追加し、CDNアクセラレーションを有効にすることについてのみご説明します。CDNコンソールからカスタムドメイン名を追加したい場合は、CDNの[ドメイン名へのアクセス](https://intl.cloud.tencent.com/document/product/228/5734)のドキュメントをご参照ください。 
