...
4. 登录 [CDN 控制台](https://console.cloud.tencent.com/cdn) ，选择【域名管理】> 对应域名的【管理】>【安全配置】，具体配置步骤请参见 [配置说明](https://intl.cloud.tencent.com/document/product/228/35237) 文档中的鉴权配置部分。
