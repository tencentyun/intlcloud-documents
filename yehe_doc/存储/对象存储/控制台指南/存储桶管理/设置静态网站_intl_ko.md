...
1. [COS 콘솔](https://console.cloud.tencent.com/cos5)에 로그인하여 왼쪽 [버킷 리스트] 메뉴바를 클릭한 후, 정적 웹 사이트 호스팅에 사용할 버킷을 클릭하여 버킷 상세 정보 인터페이스로 이동합니다.
2. 왼쪽의 [권한 관리]>[버킷 액세스 권한]을 클릭하고 공용 권한을 **공개 읽기 및 개인 쓰기**로 선택하고 저장합니다.
![](https://main.qcloudimg.com/raw/460f2cdd71d3a21a74911a52218e7670.png)
3. 왼쪽 [기본 설정]을 클릭하고 아래로 내려 **정적 웹 사이트** 설정 항목을 찾아 [편집]을 클릭한 후, [현재 상태] 버튼을 활성화하고 순서대로 정적 웹 사이트 설정 항목을 작성합니다.
