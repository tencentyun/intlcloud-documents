...
3. 왼쪽 사이드바에서 **권한 관리 > Policy 권한 설정**을 클릭하면 COS에서 **[그래픽 설정](#1)** 및 **[정책 구문](#2)**으로 버킷 정책을 추가하는 방법을 제공합니다. 버킷 정책을 추가하는 방법 중 하나를 선택할 수 있으며 작업 단계는 다음과 같습니다.
![](https://qcloudimg.tencent-cloud.cn/raw/c0cde183414d0a01ee1cd14d84483613.png)
구성 항목에 대한 자세한 설명은 [액세스 정책 언어 개요](https://intl.cloud.tencent.com/document/product/436/18023)를 참고하십시오.
...
**편집**을 클릭해 정의한 정책 구문을 입력합니다. COS는 다양한 시나리오의 정책 구문을 제공합니다. 자세한 내용은 [버킷 정책 예시](https://intl.cloud.tencent.com/document/product/436/45235)를 참고하십시오.
