...
![](https://qcloudimg.tencent-cloud.cn/raw/f8acbd14ecadbbdf0445f567f5853898.png)
	...
	- **サーバー側の暗号化**：現在、バケット暗号化方法として、SSE-COS暗号化（すなわち、COSホストキーを使用したサーバー側の暗号化）をサポートしています。サーバー側の暗号化については、[サーバー側の暗号化の概要](https://intl.cloud.tencent.com/document/product/436/18145)をご参照ください。
 3. 設定の確認
