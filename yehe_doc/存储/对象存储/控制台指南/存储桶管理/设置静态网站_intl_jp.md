...
COSコンソールから、静的ウェブサイトをホストするようにバケットを設定することで、バケットのアクセスドメイン名により静的ウェブサイトにアクセスできます。静的ウェブサイトについては、[静的ウェブサイトのホスト](https://intl.cloud.tencent.com/document/product/436/30958)をご参照ください。
...
1. [COSコンソール](https://console.cloud.tencent.com/cos5)にログインし、左側の【バケットリスト】メニューバーをクリックし、静的ウェブサイトのホストに使用したいバケットをクリックし、バケットの詳細インターフェースに進みます。
2. 左側の【権限管理】>【バケットのアクセス権限】をクリックし、パブリック権限バーで*パブリック読み取り/プライベート書き込み**を選択して保存します。
![](https://main.qcloudimg.com/raw/460f2cdd71d3a21a74911a52218e7670.png)
3. 左側の【基本設定】をクリックし、下から**静的ウェブサイト**の設定項目を見つけて【編集】をクリックし、【現在のステータス】のボタンを有効にしてから、静的ウェブサイトの設定項目を順番に入力します。
