...
5. 根据您的需求添加生命周期规则，配置项说明如下：
	...
	- **对象前缀**：对象键（或前缀）的相关信息，请参见对象概述中的 [对象键](https://intl.cloud.tencent.com/document/product/436/13324)。有关生命周期的配置规则说明，请参见 [规则描述](https://intl.cloud.tencent.com/document/product/436/17029) 文档。
