...
2. 左側ナビゲーションバーで**バケットリスト**をクリックし、バケットポリシーを追加したいバケットを選択し、バケットに進みます。
3. **権限管理**をクリックし、**Policy権限の設定**を見つけます。COSは、バケットポリシーを追加する方法として、**[グラフィック設定](#1)**と**[ポリシー構文](#2)**を提供しています。操作手順は、下記をご参照ください。バケットポリシーは、以下のいずれかの方法で追加することができます。設定項目の詳細については、[アクセスポリシーの言語概要](https://intl.cloud.tencent.com/document/product/436/18023)をご参照ください。
...
## グラフィック設定
グラフィック設定パネルで、**ポリシーの追加**をクリックし、ポップアップウィンドウでポリシーを設定します。ステップ1は**テンプレートの選択**、ステップ2は**ポリシーの設定**です。
...
![カスタムポリシー](https://qcloudimg.tencent-cloud.cn/raw/d7b01ebbfd480190b02e6af986ca4972.png)
...
### ポリシー構文
**編集**をクリックし、お客様が定義したポリシー構文を入力します。COSは、さまざまなシナリオに対応したポリシー構文を提供しています。詳細については、[バケットポリシーの例](https://intl.cloud.tencent.com/document/product/436/18031)をご参照ください。
![](https://qcloudimg.tencent-cloud.cn/raw/3b23df68378c76b37b3890021a126b98.png)
