## 소개
COS 콘솔에 로그인하여 버킷의 로그 관리 기능을 활성화할 수 있습니다. COS가 제공하는 로그 관리 기능으로 **버킷 작업**과 관련한 다양한 요청 로그를 기록할 수 있습니다. 로그 관리 기능을 통해 버킷을 보다 효율적으로 관리하고 사용할 수 있습니다. 로그 관리에 관한 자세한 내용은 [로그 관리 개요](https://intl.cloud.tencent.com/document/product/436/16920)를 참조하십시오.
...
## 작업 순서
1. [COS 콘솔](https://console.cloud.tencent.com/cos5)에 로그인한 뒤, 왼쪽 메뉴바에 있는 [버킷 리스트]로 이동하여 로그 관리 기능을 활성화할 원본 버킷을 클릭합니다.
![](https://main.qcloudimg.com/raw/2cb54182f933fe1dce75e2199a301bd0.png)
2. 왼쪽의 [로그 관리] > [로그 저장]을 클릭한 뒤 [편집]을 클릭하여 현재 상태를 '활성화'로 변경합니다.
