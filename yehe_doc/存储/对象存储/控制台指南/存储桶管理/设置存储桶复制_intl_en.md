...
3. Click the name of the desired source bucket to enter the bucket details page.
...
- **Status**: Switch this button off. cross-bucket replication will be disabled temporarily. Copied data will be retained in the destination bucket but no more incremental data will be copied from the source bucket while replication is paused. To re-enable cross-bucket replication, simply switch this button back on.
...
>!
> - When cross-bucket replication is disabled, cross-bucket replication operations in progress cannot proceed and will be aborted.
