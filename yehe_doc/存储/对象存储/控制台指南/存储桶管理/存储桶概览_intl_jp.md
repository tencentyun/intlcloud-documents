...
- クロスリージョンレプリケーション：クロスリージョンレプリケーション機能を有効にすると、ソースバケットの**インクリメンタルオブジェクト**を別のリージョン内のターゲットバケットに自動的かつ非同期にコピーすることができます。詳細については、 [バケットコピーの設定](https://intl.cloud.tencent.com/document/product/436/19235)をご参照ください。
