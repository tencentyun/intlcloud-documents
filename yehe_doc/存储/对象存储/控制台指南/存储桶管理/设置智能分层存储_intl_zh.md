...
了解智能分层存储详细介绍，请参见 [智能分层存储简介](https://intl.cloud.tencent.com/document/product/436/38305) 文档。

>!
>- 智能分层存储类型当前仅支持北京、上海、广州、重庆地域，重庆地域当前仅支持 API 操作。
...
6. 单击【下一步】设置对象属性，在存储类型配置项中选择**智能分层存储**，然后单击【上传】即可将对象上传为智能分层存储类型，对象存储 COS 将自动进行数据存储层转换。关于上传操作的其他配置项说明，请参见 [上传对象](https://intl.cloud.tencent.com/document/product/436/13321)。
