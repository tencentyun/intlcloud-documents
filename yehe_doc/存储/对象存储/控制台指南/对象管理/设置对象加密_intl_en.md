...
6. Select the target encryption method in the **Server-Side Encryption** column.
...
The following two encryption methods are currently supported:
 ...
 - SSE-KMS: It is server-side encryption with a key managed by Tencent Cloud Key Management System (KMS). You can use the default key or create a key. For more information about keys, please see [Creating a Key](https://intl.cloud.tencent.com/document/product/1030/31971). For more information about SSE-KMS, please see the **SSE-KMS Encryption** section in [Server-side Encryption Overview](https://intl.cloud.tencent.com/document/product/436/18145#sse-kms-.E5.8A.A0.E5.AF.86).
7. Click **Save**.
>!
