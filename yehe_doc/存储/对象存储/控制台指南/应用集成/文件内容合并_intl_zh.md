...
多文件合并是由腾讯云对象存储（Cloud Object Storage，COS）基于 [云函数（Serverless Cloud Function，SCF）](https://intl.cloud.tencent.com/document/product/583) 为用户提供的文件内容合并功能。文件内容合并能力可将 COS 上多个文件的二进制内容，按指定的顺序合并完整的内容，并生成新的文件。
...
- 已上线云函数的地域均已支持多文件合并，包括有广州、上海、北京、成都、香港、新加坡、孟买、多伦多、硅谷等，更多支持地域可查看 [云函数产品文档](https://intl.cloud.tencent.com/document/product/583)。
