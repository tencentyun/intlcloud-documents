...
>! Currently, COS can decompress only ZIP files, with each file they contain not larger than 5 GB.
...
> !If your file is to be uploaded using simple upload, multipart upload or cross-region replication, you are recommended to select **File upload** for Event Type.
