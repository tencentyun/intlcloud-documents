...
| 功能                                                         | 功能说明                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [创建/删除存储桶](https://intl.cloud.tencent.com/document/product/436/32565#createordelete) | 支持创建、删除存储桶                                         |
| [查看存储桶详情](https://intl.cloud.tencent.com/document/product/436/32565#viewbucket) | 支持查看存储桶基本信息                                       |
| [查看统计数据](https://intl.cloud.tencent.com/document/product/436/32565#count)           | 支持查看存储桶的当前存储量及对象总数                         |
...
| [文件重命名](https://intl.cloud.tencent.com/document/product/436/32565#rename) | 支持重命名存储桶中的文件                                     |
| [新建文件夹](https://intl.cloud.tencent.com/document/product/436/32565#newfolder) | 支持在存储桶中新建文件夹                                     |
...
| [查看历史版本/文件碎片](https://intl.cloud.tencent.com/document/product/436/32565#viewfiles) | <li>支持在已开启版本控制的存储桶中，查看文件的历史版本<br><li>支持查看存储桶内的文件碎片详情           |
...
| [设置上传计算 md5](https://intl.cloud.tencent.com/document/product/436/32565#sets) | 支持对上传至存储桶中的文件计算其 md5 并添加至自定义的 Headers |
...
| 操作名                                                       | 操作描述                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [快捷登录](https://intl.cloud.tencent.com/document/product/436/32566#dulu) | 支持微信快捷登录                                             |
...
| [文件预览](https://intl.cloud.tencent.com/document/product/436/32566#filepreview) | 支持预览存储桶中的媒体文件（图片、视频、音频）               |
...
| [查看存储桶详情](https://intl.cloud.tencent.com/document/product/436/32566#viewbucket) | 支持查看存储桶的基本信息和域名信息                             |
...
| [查看资源包详情](https://intl.cloud.tencent.com/document/product/436/32566#package)          | 支持查看您当前资源包的使用情况                          |
