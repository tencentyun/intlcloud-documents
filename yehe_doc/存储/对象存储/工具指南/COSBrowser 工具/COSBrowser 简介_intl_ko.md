...
| [버킷 세부 정보 조회](https://intl.cloud.tencent.com/document/product/436/32565#viewbucket) | 버킷 기본 정보 조회 지원                                       |
...
| [파일 세부 정보 조회](https://intl.cloud.tencent.com/document/product/436/32565#view) | 버킷에 있는 파일 기본 정보 조회 지원                               |
...
| [이전 버전/파일 조각 조회](https://intl.cloud.tencent.com/document/product/436/32565#viewfiles) | <li>버전 제어가 활성화된 버킷에서 파일의 이전 버전 조회 지원<br><li>버킷에 있는 파일 조각 세부 정보 조회 지원           |
...
| [멀티파트 전송 파트 수 설정](https://intl.cloud.tencent.com/document/product/436/32565#sets) | 파일 멀티파트 업로드 및 다운로드의 파트 수 설정 지원                           |
...
| [업로드 시 md5 컴퓨팅 설정](https://intl.cloud.tencent.com/document/product/436/32565#sets) | 버킷에 업로드하는 파일에 대해 md5 컴퓨팅을 진행하고 사용자 정의 Headers에 추가 지원 |
...
| [파일 세부 정보 조회](https://intl.cloud.tencent.com/document/product/436/32566#view) | 버킷에 있는 파일 기본 정보 조회 지원                               |
...
| [버킷 세부 정보 조회](https://intl.cloud.tencent.com/document/product/436/32566#viewbucket) | 버킷 기본 정보 및 도메인 정보 조회 지원                             |
...
| [리소스 패키지 세부 정보 조회](https://intl.cloud.tencent.com/document/product/436/32566#package)          | 현재 리소스 패키지의 사용 현황 조회 지원                          |
