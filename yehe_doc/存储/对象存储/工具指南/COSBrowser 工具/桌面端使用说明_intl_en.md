...
| Platform | System Requirement | Download Link |
| :------- | :---------------------------------------------------------- | :----------------------------------------------------------- |
...
| \- Read & write | Pulls the folder list and downloads files in the folder, upload files to the folder, and create folders using the access URL. |
| Valid time | In minutes, hours, or days <br>If you log in to the client using a key, the validity period can be 1 minute to 2 hours for the root account, and 1 minute to 1.5 days for sub-accounts.<br>If you log in to the client using a Tencent Cloud account, the longest validity period is 2 hours.<br>The default value is the longest validity period allowed for the current user.|
...
>!When the link is valid, users receiving the link and code can access the folder.
...
<table>
   ...
   <tr>
      ...
      <td nowrap="nowrap">1. Select <b>Settings</b> > <b>About</b>.<br>2. Click <b>Local Log</b> and the system will open the directory where the local log is stored.</td>
   </tr>
</table>
