...
>?当前版本号为 v0.12.0-beta，如需获取工具的最新版本、历史版本和更新日志，请前往 [release](https://github.com/tencentyun/coscli/releases) 进行查看。
...
| Bucket Endpoint | 格式为 `cos.<region>.myqcloud.com`，其中 region 为存储桶所在地域，详情请参见 [地域与访问域名](https://intl.cloud.tencent.com/document/product/436/6224)。 |
