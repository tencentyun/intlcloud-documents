...
1. [Windows 버전 COSCLI 다운로드](https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-windows.exe).
...
1. [Linux 버전 COSCLI 다운로드](https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-linux)를 클릭하거나 다음 명령어를 실행하여 COSCLI를 다운로드합니다.
```bash
