...
1. [Download COSCLI for Windows](https://github.com/tencentyun/coscli/releases/download/v0.11.0-beta/coscli-windows.exe).
...
1. [Download COSCLI for Linux](https://github.com/tencentyun/coscli/releases/download/v0.11.0-beta/coscli-linux) or run the following command to download COSCLI:
```bash
