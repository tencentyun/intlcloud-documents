...
- [macOS](https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-mac)
...
1. [Download COSCLI for Windows](https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-windows.exe).
...
```bash
wget https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-mac
```
2. Run the following command to rename the file:
```bash
mv coscli-mac coscli
```
3. Enter `./coscli --help` on the command line. If the following information is printed out, the installation is successful:
...
1. [Download COSCLI for Linux](https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-linux) or run the following command to download COSCLI:
```bash
wget https://github.com/tencentyun/coscli/releases/download/v0.91-beta/coscli-linux
```
2. Run the following command to rename the file:
```bash
...
chmod 755 coscli
```
3. Enter `./coscli --help` in the command line window. If the following information is printed out, the installation is successful:
...
| Bucket Name   | Bucket name, which composes the full name of a bucket together with `APP ID` in the format of `<BucketName-APPID>`. For more information, please see [Bucket Overview](https://intl.cloud.tencent.com/document/product/436/13312). |
| Bucket Region | Bucket region. For more information, please see [Regions and Access Endpoints](https://intl.cloud.tencent.com/document/product/436/6224). |
