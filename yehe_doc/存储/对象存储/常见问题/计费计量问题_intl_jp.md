...
COSの低頻度ストレージ容量単価値下げは、グローバルサイトの一部リージョンに適用され、ムンバイ、ソウル、バンコク、シリコンバレー、ジャカルタ、サンパウロリージョンが含まれます。公表価格は0.018米ドル/GB/月から0.015米ドル/GB/月に調整されます。今回の値下げは2022年7月1日から適用されます。
