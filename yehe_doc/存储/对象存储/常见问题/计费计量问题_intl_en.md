...
The reduction in the unit price of STANDARD_IA storage usage from 0.018 USD/GB/month to 0.015 USD/GB/month will apply to certain regions of Tencent Cloud International, including Mumbai, Seoul, Bangkok, Silicon Valley, Moscow, Jakarta, and Sao Paulo. The reduction will take effect on July 1, 2022.
...
If you have received a free tier and it has not expired, but your account still has overdue payments, possible causes are as follows:
...
### Will uploading a file to a COS bucket incur traffic fees?

No. The upstream traffic generated by file uploads is free of charge.

### Will accessing Tencent Cloud products in the same region incur traffic fees?
