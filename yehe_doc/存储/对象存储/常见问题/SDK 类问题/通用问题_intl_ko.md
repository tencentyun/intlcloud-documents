...
2. 설정한 만료 시간(experationDate)이 지났는지 확인하시기 바랍니다. 만료 시간이 경과한 경우 서명 만료 오류가 발생합니다. 만료 시간 변경 및 임시 키를 다시 생성하십시오.
...
COS의 디렉터리는 가상 디렉터리이며, 실제로는 /로 끝나는 객체입니다. 객체 업로드 인터페이스를 호출하여 /로 끝나는 객체 키를 생성하면 하나의 디렉터리가 생성됩니다. [미니프로그램 SDK에서 디렉터리 생성 예시](https://intl.cloud.tencent.com/document/product/436/32457)를 참고하십시오.
