...
1. Check that CORS rules are configured in the COS console. For operation details, please see [Setting Cross-Origin Access](https://intl.cloud.tencent.com/document/product/436/13318).
2. Check whether a CDN acceleration domain name is used. If yes, you need to configure CORS rules in the CDN console. For operation details, please see [HTTP Response Header](https://intl.cloud.tencent.com/document/product/228/35320).
...
CORS rules do not support IP addresses. They support only domain names. For more information, please see [Setting Cross-Origin Access](https://intl.cloud.tencent.com/document/product/436/13318).

### What should I do if a CORS error is reported when I use CDN to access files in COS after CDN has been configured for COS?
