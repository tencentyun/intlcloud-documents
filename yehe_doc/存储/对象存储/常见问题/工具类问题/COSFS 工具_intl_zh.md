...
确认以上配置正确，请打开机器 `/var/log/messages` 日志文件，找到 s3fs 相关的日志，日志可以帮助您定位问题原因。如果无法解决，请 [联系我们](https://intl.cloud.tencent.com/contact-sales)，协助您解决问题。
...
COSFS 不占用本地存储空间，为了兼容 df 等工具，COSFS 显示的 Size Used Available 都不是真实值。
