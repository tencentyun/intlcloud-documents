...
COSBrowser is a visual interface tool launched by Tencent Cloud to make it easier and simpler for you to view, transfer, manage, and interact with COS resources. Currently, it is available for desktop (Windows, macOS, Linux) and mobile clients (Android, iOS). For more information, see [COSBrowser Overview](https://intl.cloud.tencent.com/document/product/436/11366).
...
For detailed directions, see [User Guide for Desktop Version](https://intl.cloud.tencent.com/document/product/436/32565) or [User Guide for Mobile Version](https://intl.cloud.tencent.com/document/product/436/32566).
...
1. TencentCloud API **secretID** and **secretKey** : You can get them on the [API Key Management](https://console.cloud.tencent.com/cam/capi) page in the CAM console. After you log in successfully, the key will be saved in **Historical Key** for future use.
...
1. Make sure the sub-account has permission to access COS. For more information, see [Granting Sub-accounts Access to COS](https://intl.cloud.tencent.com/document/product/436/11714).
...
The DNS error indicates that the COS domain failed to be resolved in your local network. We recommend you change your local DNS server address to a public one such as `114.114.114.114` and try again or change the network environment for testing.
