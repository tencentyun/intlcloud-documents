...
### 언제 FTP Server에 masquerade_address를 설정해야 하나요?
...
### FTP Server 설정에서 파일의 최대 업로드 제한을 두는 이유가 무엇인가요?

COS의 멀티파트 업로드 수는 최대 10000개까지 가능하며, 각 멀티파트의 크기는 1MB~5G로 제한됩니다. 최대 업로드 제한을 두는 것은 업로드할 멀티파트의 크기를 합리적으로 계산하기 위해서입니다.
