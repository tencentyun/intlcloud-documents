...
1. Verify whether your console version is V4 or V5. If you're using version V4, [Contact Us]((https://intl.cloud.tencent.com/contact-sales)) to apply for upgrading to V5.
