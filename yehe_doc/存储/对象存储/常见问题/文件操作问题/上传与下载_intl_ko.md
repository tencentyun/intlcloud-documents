...
중국대륙 퍼블릭 클라우드의 단일 버킷 리전 기본 대역폭은 15Gbit/s이며, 기타 리전은 10Gbit/s입니다. 대역폭이 임계값에 도달하면 요청을 통해 트래픽 제어가 트리거 됩니다. 더 큰 대역폭을 원하시면 [고객센터](https://intl.cloud.tencent.com/contact-sales)에 문의하십시오. 

### 파일을 다운로드하지 않고 브라우저에서 미리보기하는 방법은 무엇입니까?

파일에 대한 올바른 Content-Type 헤더를 지정해야 하며 Content-Disposition의 매개변수는 attachment일 수 없습니다. 브라우저가 현재 파일의 형식을 지원하는 경우 브라우저는 파일을 직접 다운로드하는 대신 파일을 직접 엽니다.
...
Tencent Cloud CVM 내부 네트워크 DNS 서버 주소는 [CVM 인트라넷 서비스](https://intl.cloud.tencent.com/document/product/213/5225)를 참고하십시오. 
...
- API/SDK 방식: COS는 프로그래밍을 통해 API 또는 SDK 인터페이스를 여러 번 호출하는 방식으로 배치 작업을 지원합니다. 자세한 내용은 [Operation List](https://intl.cloud.tencent.com/document/product/436/10111) 와 [SDK 개요](https://intl.cloud.tencent.com/document/product/436/6474)를 참고하십시오.
- 툴 방식: [COSCMD 툴](https://intl.cloud.tencent.com/document/product/436/10976)과 [COSBrowser 툴](https://intl.cloud.tencent.com/document/product/436/11366)을 사용하여 배치 작업을 할 수 있습니다. 
