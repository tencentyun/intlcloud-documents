...
中国大陆公有云地域单个存储桶默认带宽：上行和下行共享15Gbit/s；其他地域：上行和下行共享10Gbit/s。如果带宽达到该阈值，请求会触发流控。更多限制说明，请参见 [规格与限制](https://intl.cloud.tencent.com/document/product/436/14518)。

### 如何使文件直接在浏览器中预览，而不是下载？

您需要为该文件指定正确的 Content-Type 头部，同时 Content-Disposition 的参数值不能为 attachment，当浏览器支持当前文件的格式时，浏览器会直接打开该文件，而不是直接下载。操作指引请参见 [自定义 Headers](https://intl.cloud.tencent.com/document/product/436/13361)。

### 如何使文件直接在浏览器中下载，而不是预览？

您可以通过 [对象存储控制台](https://console.cloud.tencent.com/cos5) 将对象自定义 Headers 中的 Content-Disposition 参数值设为 attachment。操作指引请参见 [自定义 Headers](https://intl.cloud.tencent.com/document/product/436/13361)。
...
更多内网与外网访问，连通性测试等信息，请参见 [内网与外网访问](https://intl.cloud.tencent.com/document/product/436/30613)。
...
- 控制台方式：操作步骤可参见 [上传对象](https://intl.cloud.tencent.com/document/product/436/13321)、[下载对象](https://intl.cloud.tencent.com/document/product/436/13322)。
- API/SDK 方式：COS 支持通过编程多次调用 API 或 SDK 接口的方式批量操作文件，详情可参见 [上传/下载对象](https://intl.cloud.tencent.com/document/product/436/10111) API 接口和 [SDK 概览](https://intl.cloud.tencent.com/document/product/436/6474)。
- 工具方式：可使用 [COSBrowser](https://intl.cloud.tencent.com/document/product/436/11366)、[COSCMD](https://intl.cloud.tencent.com/document/product/436/10976)、[COSCLI](https://intl.cloud.tencent.com/document/product/436/43249) 等工具实现批量操作。
