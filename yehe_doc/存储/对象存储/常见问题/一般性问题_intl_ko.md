...
COS는 비구조화 데이터의 분산형 스토리지 서비스입니다. 서비스 자체는 이미지 압축을 지원하지 않습니다. 이미지 압축 처리는 [CI](https://intl.cloud.tencent.com/products/ci)를 참고하십시오.

### COS는 썸네일 기능을 제공하나요?

COS는 비구조화 데이터의 분산형 스토리지 서비스입니다. 서비스 자체는 이미지 압축을 지원하지 않습니다. 썸네일 기능에 대해서는 [CI](https://intl.cloud.tencent.com/products/ci)를 참고하십시오.

### COS는 비디오 파일을 트랜스 코딩할 수 있나요?

COS는 비구조화 데이터의 분산형 스토리지 서비스입니다. 서비스 자체는 비디오 파일 트랜스 코딩을 지원하지 않습니다. 비디오 파일 트랜스 코딩은 [Media Processing Service](https://intl.cloud.tencent.com/document/product/1041)를 참고하십시오.
...
샤오밍은 Tencent Cloud COS 서비스를 이커머스 비즈니스에 사용했습니다. 비즈니스는 2018년 11월 1일부터 11월 30일까지 이루어졌으며 월 서비스 요금은 100CNY이고, 한 달간 사용 불가 상황이 두 차례 있었습니다. 사용 불가 상황 기록은 아래와 같습니다.
...
이 사례에서 서비스 가용성은 99.93%으로 가용성 표준 99.95%보다 낮고 99.9%보다 높습니다. 보상 기준에 따르면 Tencent Cloud COS 서비스는 사용자에게 월 서비스 요금의 20%인 20CNY를 보상해야 합니다.
