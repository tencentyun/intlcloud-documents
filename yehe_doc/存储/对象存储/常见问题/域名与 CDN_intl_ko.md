...
COS 자체에서는 CDN 캐시 자동 퍼지를 지원하지 않습니다. 그러나 SCF와 결합하여 CDN 캐시를 자동 퍼지할 수 있으며, 자세한 내용은 [SCF를 사용하여 CDN에 캐시된 COS 리소스 자동 퍼지](https://intl.cloud.tencent.com/document/product/436/30611) 문서를 참조하십시오.
