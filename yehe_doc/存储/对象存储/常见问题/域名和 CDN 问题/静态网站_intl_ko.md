### 어떻게 객체를 다운로드하지 않고 액세스할 때 바로 표시되게 할 수 있습니까?

[정적 웹사이트 설정](https://intl.cloud.tencent.com/document/product/436/14984)에서 설명한 대로 자신의 도메인 이름을 바인딩하고 정적 웹사이트 호스팅 기능을 활성화합니다. 아직 도메인 이름이 없다면 Tencent Cloud를 통해 [등록](https://dnspod.cloud.tencent.com/?from=qcloudHpHeaderDnspod&fromSource=qcloudHpHeaderDnspod)할 수 있습니다.
...
### 정적 웹 사이트 호스팅 기능을 활성화한 후에도 이미지가 표시되지 않으면 어떻게 해야 하나요?

1. COS 액세스 시 객체(이미지)가 바로 표시되도록 하려면 객체 헤더에 Content-Disposition:inline을 설정하는 대신 정적 웹사이트 호스팅 기능을 활성화해야 합니다. 
2. 브라우저 또는 CDN에서 캐시된 데이터를 확인합니다. curl 및 wget 명령을 사용하여 브라우저 캐싱을 피할 수 있습니다. 캐시된 CDN URL은 [CDN 콘솔](https://console.cloud.tencent.com/cdn)에서 퍼지할 수 있습니다.
...
캐시된 데이터에 대한 브라우저 또는 CDN을 확인하십시오. curl 및 wget 명령을 사용하여 브라우저 캐싱을 피할 수 있습니다. 캐시된 CDN URL은 [CDN 콘솔](https://console.cloud.tencent.com/cdn)에서 퍼지할 수 있습니다.
