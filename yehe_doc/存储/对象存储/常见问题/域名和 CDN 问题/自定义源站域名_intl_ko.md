...
사용자 정의 도메인 바인딩을 통해 구현할 수 있습니다. 자세한 내용은 [사용자 정의 원본 서버 도메인 활성화](https://intl.cloud.tencent.com/document/product/436/31507)를 참고하십시오.
...
COS 사용자 정의 도메인의 HTTPS 설정 기능이 업그레이드 중입니다. 현재 중국 내 퍼블릭 클라우드 리전, 싱가포르 리전에서 호스팅 인증서를 지원하고 있으며, 다른 해외 리전 지원을 계속 확대해 나갈 예정입니다. 아직 지원하지 않는 리전은 [사용자 정의 도메인 HTTPS 액세스 지원 설정](https://intl.cloud.tencent.com/document/product/436/11142) 문서를 참고해 도메인에 리버스 프록시를 설정하는 방식으로 구현할 수 있습니다.
...
사용자 정의 도메인을 사용해 COS에 액세스하는 경우 CDN을 활성화할 필요가 없습니다. [COS 콘솔](https://console.cloud.tencent.com/cos5)에 로그인하여 사용자 정의 원본 서버 도메인을 설정하면 됩니다. 자세한 작업 방법은 [사용자 정의 원본 서버 도메인 활성화](https://intl.cloud.tencent.com/document/product/436/31507) 문서를 참고하십시오.
