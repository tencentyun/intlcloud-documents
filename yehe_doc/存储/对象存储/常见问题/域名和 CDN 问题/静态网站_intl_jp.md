...
ユーザーの独自ドメイン名をバインドし（ドメイン名を購入する必要がある場合は、Tencent Cloudで[ドメイン名の登録](https://dnspod.cloud.tencent.com/?from=qcloudHpHeaderDnspod&fromSource=qcloudHpHeaderDnspod)を行うことができます）、静的ウェブサイト機能を有効にすれば可能です。詳細については、[静的ウェブサイトの設定](https://intl.cloud.tencent.com/document/product/436/14984)をご参照ください。
