...
### What’s the difference between COS default domain name, default CDN acceleration domain name, custom CDN acceleration domain name, and custom origin server domain name?
...
- **Default accelerated domain name**: a domain name passing through CDN acceleration nodes and is generated by the system. You can choose to enable/disable it.
