...
COS will not support default CDN acceleration domains for COS users registered after March 15, 2022.

#### Existing COS user

| Bucket | Support for Default CDN Acceleration Domain|
|---------|---------|
| New buckets | COS will not support default CDN acceleration domains for buckets created after March 15, 2022. |
| Existing buckets that have never used default CDN acceleration domains | COS will not support default CDN acceleration domains for buckets that have never used them before March 15, 2022. |
| Existing buckets that once used default CDN acceleration domains | Buckets that used default CDN acceleration domains before March 15, 2022 can continue to use them. |
| Existing buckets that are using default CDN acceleration domains | Buckets that are using default CDN acceleration domains can continue to use them after March 15, 2022. |


#### Viewing default CDN acceleration domains

Buckets that are using or once used default CDN acceleration domains can continue to use them after March 15, 2022. You can view the default CDN acceleration domains under your account via two methods.
...
>! Buckets whose default CDN acceleration domains are disabled as of March 15, 2022 can continue to use the domains. However, the CDN console does not keep records of deleted CDN acceleration domains. Therefore, buckets whose default CDN acceleration domains are deleted can no longer use them after March 15, 2022.
