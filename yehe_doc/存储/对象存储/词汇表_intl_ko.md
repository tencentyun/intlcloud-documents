...
### 기본 액세스 도메인
기본 액세스 도메인은 버킷명, COS 소재지 표시, 객체명으로 이루어져 있으며, 기본 액세스 도메인으로 COS의 유일한 대응 객체의 주소를 지정할 수 있습니다. Tencent Cloud는 사용자가 객체를 업로드하면 객체의 기본 액세스 도메인을 자동 생성합니다. 자세한 내용은 [도메인 관리](/document/product/436/13396)를 참조하십시오.
### CDN 가속 액세스 도메인
