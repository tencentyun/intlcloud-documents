...
- 已安装 Git。
- 已安装 Kubernetes 集群（version >= 1.14），并且支持 CSI 功能。为获得最佳实践，您可以直接在 [腾讯云容器服务（Tencent Kubernetes Engine，TKE）](https://intl.cloud.tencent.com/document/product/457/30635)部署。
...
您需要开通 COS，并完成存储桶的创建，创建指引可参见 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309)。
...
```
- 上传本地文件到 COS 上
您可以使用腾讯云 COS 团队提供的客户端 [COSCMD](https://intl.cloud.tencent.com/document/product/436/10976) 或者腾讯云 COS 团队提供的 [COS SDK](https://intl.cloud.tencent.com/document/product/436/6474)，按照使用说明将本地下载的文件上传到 COS 的存储桶上。
...
- Dataset：
 ...
 - options：在 options 需要指定存储桶的必要信息，具体可参考 [API 术语信息](https://intl.cloud.tencent.com/document/product/436/7751)。
...
以上通过一个简单的例子完成 GooseFS on Fluid 的入门体验和学习，并最后进行环境的清理，更多 Fluid GooseFSRuntime 的功能介绍可参见 [功能列表](https://intl.cloud.tencent.com/document/product/436/42233)。
