...
<table>
   ...
   <tr>
      ...
      <td nowrap>深度归档存储容量费用 = 深度归档存储容量单价 x 月深度归档存储容量</td>
      <td nowrap>月深度归档存储容量 = 当月“日深度归档存储容量”之和 / 当月天数<br>日深度归档存储容量 = 当日“每5分钟深度归档存储容量”之和 / 288（采样点数）
			</td>
   </tr>
   <tr>
      <td>低频存储取回量费用</td>
   ...
   <tr>
      ...
      <td nowrap>深度归档存储取回量费用 = 深度归档存储取回量单价 x 深度归档存储容量</td>
      <td nowrap>深度归档存储取回量 = 成功下载的深度归档存储文件大小
			</td>
   </tr>
   <tr>
      <td>带宽费用</td>
