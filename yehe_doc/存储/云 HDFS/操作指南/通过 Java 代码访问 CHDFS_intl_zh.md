...
- 确保已经部署了 CHDFS 的相关 JAR 包。详情请参见 [挂载 CHDFS](https://intl.cloud.tencent.com/document/product/1106/41965)。
...
```
2. 参考如下操作 hadoop 的代码进行修改，其中的配置项及其说明可参见 [挂载 CHDFS](https://intl.cloud.tencent.com/document/product/1106/41965)。
...
> - 对于 EMR 环境，如果您按照 [挂载 CHDFS](https://intl.cloud.tencent.com/document/product/1106/41965) 逐步操作，那么 Hadoop common 包通常在 `/usr/local/service/hadoop/share/hadoop/common/` 目录下，CHDFS 包通常在`/usr/local/service/hadoop/share/hadoop/common/lib/` 目录下。
> 
