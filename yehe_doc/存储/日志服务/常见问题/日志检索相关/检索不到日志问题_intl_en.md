...
To collect logs from other Tencent Cloud services including TKE and CLB, see [Collection for Tencent Cloud Services](https://intl.cloud.tencent.com/document/product/614/38200) to verify the configuration. If you have any question, please [submit a ticket](https://console.cloud.tencent.com/workorder/category).
