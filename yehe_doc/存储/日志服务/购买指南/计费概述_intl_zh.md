>!
> - 腾讯云日志服务（Cloud Log Service，CLS）已于2020年08月03日00:00:00正式商业化。CLS 商业化后将在每个地域提供一定量的**免费额度**，详情可见 [免费额度](https://intl.cloud.tencent.com/document/product/614/37889)。
...
#### 限制说明
1. 服务请求费用：用户使用 [LogListener](https://intl.cloud.tencent.com/document/product/614/31578)、[API](https://intl.cloud.tencent.com/document/product/614/42757) 或 SDK 调用日志服务接口的请求次数，统计包括上传下载、创建删除、检索分析等读写请求。
2. 服务请求数无论成功或失败均会统计。
