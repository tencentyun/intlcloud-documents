...
You can create logsets and log topics in different regions when using CLS. Regions refer to the geographical areas of physical IDCs. Networks are completely isolated between regions. You can select the nearest region based on your business scenario and target users' geographical locations to reduce log access latency and improve access speed.



#### Notes on Shenzhen and Shanghai Finance Zones
