...
For configuration details, see [Creating a log topic](https://intl.cloud.tencent.com/document/product/614/34239).
...
### Step 2. Define the LogConfig resource type[](id:crd)
...
### Step 3. Define the LogConfig object[](id:logconfig_def)
...
### Step 4. Create a LogConfig object [](id:logconfig_create)
