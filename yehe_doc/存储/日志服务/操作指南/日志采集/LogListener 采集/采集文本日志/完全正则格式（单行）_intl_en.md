...
3. In the pop-up dialog box, enter "test-whole" as the **Log Topic Name** and click **OK** as shown below:
...
1. On the **Collection Configuration** page, set the **Extraction Mode** to **Single-line - Full regular expression** and enter a sample log in the **Log Sample** text box as shown below:
