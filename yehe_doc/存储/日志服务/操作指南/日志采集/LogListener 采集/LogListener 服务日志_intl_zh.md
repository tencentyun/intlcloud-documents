...
| 索引         | 默认为采集到的所有日志数据开启全文索引和键值索引。支持修改索引配置，详情请查看 [配置索引](https://intl.cloud.tencent.com/document/product/614/39594)。 |
...
配置机器 IP/标识机器组仅在 LogListener 2.5.4 及以上版本支持采集监控服务日志，您可前往升级至 [最新版本](https://intl.cloud.tencent.com/document/product/614/17414)。
