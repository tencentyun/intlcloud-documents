...
This document describes how to view the context of a log in the original file via the CLS console.
...
- Log context search frees you from the hassles associated with device logins. On the log search page, you can quickly view the log context of any file/device.
...
- You have collected the logs with LogListener. For more information, please see [LogListener Installation Guide](https://intl.cloud.tencent.com/document/product/614/17414).
- You have enabled and configured index. For more information, please see [Configuring Index](https://intl.cloud.tencent.com/document/product/614/39594).
...
On this page, you can:
 - Scroll up/down to view the context.
    ...
    - Click **Show Later** to page down. Up to 20 later logs can be displayed at a time.
