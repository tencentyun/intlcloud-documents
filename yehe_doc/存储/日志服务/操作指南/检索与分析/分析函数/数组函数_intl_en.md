...
| ----------------- | ------------------------------------------------------------ |
| x                 | The parameter value is of the array type.                                          |
| lambda_expression | Lambda expression. For more information, please see [Lambda Function](https://intl.cloud.tencent.com/document/product/614/43564). |
...
Example 2. Return dates between 2017-10-23 and 2021-08-12 at an interval of 1 year.
...
Return a subset of the [1,2,4,5,6,7,7] array, starting from the third element and consisting of 2 elements.
