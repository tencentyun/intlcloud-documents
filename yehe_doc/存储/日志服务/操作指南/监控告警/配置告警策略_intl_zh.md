...
- keyname：表示对应的字段名称，例如 `$1.status>500` 表示编号为1的查询的 `status `字段大于500时触发告警，更多表达式语法参见 触发条件表达式语法。
...
通过关联通知模版，设置发送通知的方式及对象，支持短信、语音、电话、微信、企业微信、Webhook 等通知方式。详情参见 [新增通知模版](https://intl.cloud.tencent.com/document/product/614/39582)。
