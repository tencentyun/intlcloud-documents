...
For the authorizable resource types and related APIs supported by CLS, see Authorizable Resource Types. For how to configure custom access policies, see [Creating Custom Policy](https://intl.cloud.tencent.com/document/product/598/35596).
