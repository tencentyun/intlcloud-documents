...
日志服务可以将日志主题中的数据通过 CLS 日志触发器 投递至云函数进行处理，以满足日志加工/日志清洗等应用场景需求，如下：


| 函数处理场景                                               | 描述说明                                |
| ------------------------------------------------------------ | --------------------------------------- |
| [ ETL 日志加工](https://intl.cloud.tencent.com/document/product/614/38884) | 日志数据通过云函数进行日志清洗，日志加工，格式转换等操作  |
| [CLS 转储至 Ckafka](https://intl.cloud.tencent.com/document/product/614/38885) | 日志数据通过云函数进行日志清洗等操作并投递至 Ckafka  |
| [CLS 转储至 COS](https://intl.cloud.tencent.com/document/product/614/38886) | 日志数据通过云函数进行日志清洗等操作并投递至 COS   |
| [CLS 转储至 ES ](https://intl.cloud.tencent.com/document/product/614/38887) | 日志数据通过云函数投递至 ES   |
