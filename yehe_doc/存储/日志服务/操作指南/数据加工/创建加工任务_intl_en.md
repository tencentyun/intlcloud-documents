...
- Data masking for sensitive data such as users' ID numbers and phone numbers.
- Ship logs by category. For example, logs are categorized by log levels ERROR, WARNING, and INFO and then distributed to different log topics.
...
![](https://qcloudimg.tencent-cloud.cn/raw/1076f04e3090f71483e843f4d8a2e679.png)
 ...
 A target name can be the alias of a target log topic and can be used as an input parameter of the written DSL function. You can configure up to 10 target log topics.
5. Click **Next**.
