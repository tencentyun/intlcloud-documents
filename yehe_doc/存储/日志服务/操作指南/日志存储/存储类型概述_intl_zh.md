...
适用于访问频率较低且无实时检索需求的日志，如审计归档日志。离线存储提供分钟级的离线检索日志能力，满足用户对历史日志的回溯检索，归档存储等诉求，整体使用成本相比【实时存储】降低80%，详情请查看 [离线存储简介](https://intl.cloud.tencent.com/document/product/614/42004)。
