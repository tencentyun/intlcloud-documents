...
>! 目前日志低频存储仅支持北京、广州、上海、中国香港、南京、新加坡、硅谷、法兰克福地域。如果您日志主题所在地域暂未支持，可联系 [在线客服](https://intl.cloud.tencent.com/contact-sales) 申请。
> 
...
适用于访问频率较低且无统计分析需求的日志，如审计归档日志。低频存储提供全文检索日志的能力，满足用户对历史日志的回溯检索，归档存储等诉求，整体使用成本相比**标准存储**降低80%，详情请查看 [低频存储简介](https://intl.cloud.tencent.com/document/product/614/42004)。
