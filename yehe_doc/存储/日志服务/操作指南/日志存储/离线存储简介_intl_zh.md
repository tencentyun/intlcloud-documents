...
>!
> - 目前日志离线存储处于公测阶段，仅支持北京、广州、重庆地域。如果您日志主题所在地域暂未支持，可联系 [在线客服](https://intl.cloud.tencent.com/contact-sales) 申请。
...
1. 创建日志主题，并将“存储类型”选择为【离线存储】。详情请参考 [管理日志主题](https://intl.cloud.tencent.com/document/product/614/34239)。

2. 将日志采集至目标 topic 上，详情请参考 [采集方式](https://intl.cloud.tencent.com/document/product/614/12502)。
3. 进入目标日志主题检索页，输入检索语句，如 statsu：200，创建检索任务。
>? 检索语法与实时存储基本一致，区别请参考 [采集方式](https://intl.cloud.tencent.com/document/product/614/12502)。
>
...
原则上与实时存储 Lucene 语法保持一致，详情可见 [语法规则文档](https://intl.cloud.tencent.com/document/product/614/30439)。离线存储不支持以下语法：
