...
| 投递数据格式                                                 | 描述说明                                |
| ------------------------------------------------------------ | --------------------------------------- |
| [按分隔符格式投递](https://intl.cloud.tencent.com/document/product/614/31582) | 日志数据按照分隔符格式投递到 COS  |
| [按 JSON 格式投递](https://intl.cloud.tencent.com/document/product/614/31583) | 日志数据按照 JSON 格式投递到 COS |
| [按原文格式投递](https://intl.cloud.tencent.com/document/product/614/31584) | 日志数据按照原文格式投递到 COS   |

>!
>- 数据投递到 COS 之后，COS 侧将产生相应的存储费用，计费详情请参见 COS [计费概述](https://intl.cloud.tencent.com/document/product/436/16871)。
>- 若需要在投递 COS 前对日志进行清洗加工过滤，可参考使用 [通过云函数转储至 COS](https://intl.cloud.tencent.com/document/product/614/38886) 操作。
