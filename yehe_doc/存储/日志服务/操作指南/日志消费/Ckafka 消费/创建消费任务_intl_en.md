...
Tencent Cloud's Cloud Message Queue (CKafka) has been activated, and a Ckafka consumption instance and a message queue topic have been created in the same region as the log topic.
...
6. Click **Edit** on the right, enable **Ckafka Consumption**, and select a Ckafka instance for consumption and a corresponding message queue topic.
