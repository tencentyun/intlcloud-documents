...
>For details about how to create a Ckafka instance, see [Creating Instances](https://intl.cloud.tencent.com/document/product/597/32543).
...
6. Click **Edit** on the right. Toggle the switch to enable **Ckafka Consumption**, and select a Ckafka instance for consumption and a corresponding message queue.
