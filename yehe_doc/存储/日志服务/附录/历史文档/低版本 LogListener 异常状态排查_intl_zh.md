>本文档提供2.2.4以下版本的 LogListener 故障处理排查。最新版本处理排查，请参见 [机器组异常](https://intl.cloud.tencent.com/document/product/614/17424) 处理文档。
...
```
其中，`<region>` 为日志服务所在地域简称，具体地域信息请参见 [可用地域](https://intl.cloud.tencent.com/document/product/614/18940) 文档。
