...
已完成 [开发项目](https://intl.cloud.tencent.com/document/product/1040/38253)。
...
```
>?云函数组件支持了自定义别名的灰度发布，可以在任意两个函数版本间进行流量规则配置，详细说明请参考[Serverless 灰度发布](https://intl.cloud.tencent.com/document/product/1040/37698)。
