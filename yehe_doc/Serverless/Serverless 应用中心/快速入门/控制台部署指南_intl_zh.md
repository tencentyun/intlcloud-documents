...
3. 根据页面提示，填写应用基本信息。
 ...
 - 地域：与云函数支持地域相同，详情请参考 [地域列表](https://intl.cloud.tencent.com/document/api/583/17238)。
...
>?配置自定义域名时，请确保您的域名已在腾讯云备案并配置了 CNAME 解析，详细步骤参考 [自定义域名配置](https://intl.cloud.tencent.com/document/product/628/11791)。
