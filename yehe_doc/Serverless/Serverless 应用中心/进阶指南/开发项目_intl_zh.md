...
Serverless应用的灰度发布支持两种方式：**默认别名**与**自定义别名**。更多详情参考 [Serverless 灰度发布](https://cloud.tencent.com/document/product/1154/46330)。
...
## Serverless 命令
开发项目到上线过程中，需要用到一些Serverless 的相关命令。更多命令请查看 [Serverless 支持命令列表](https://intl.cloud.tencent.com/document/product/1040/36861)。
