...
- 前往访问管理控制台，创建云函数的运行角色，并授予该角色 COS、CFS 的读写权限，用于授权云函数访问相应服务。详情请参见 [创建函数运行角色](https://intl.cloud.tencent.com/document/product/583/38176)。
...
## 扩展能力
基于本文示例，您还可扩展自动化 CDN 刷新/预热的能力。例如，转码后的视频在回传 COS Bucket 时，可触发新函数执行 CDN 刷新/预热功能。详情请参见 [CDN 缓存刷新](https://intl.cloud.tencent.com/document/product/436/37273)。
