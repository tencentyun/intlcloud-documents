...
<td align="left">It represents the union of characters separated by commas; for example, 1, 2, 3 in the "Hour" field means 1:00, 2:00 and 3:00</td>
</tr>
<tr>
...
The scheduled purge/prefetch feature is free of charge. However, it will call SCF to create scheduled tasks, which may incur SCF fees if the free tier of SCF is exceeded. For more information, see [Free Tier](https://intl.cloud.tencent.com/document/product/583/12282).
