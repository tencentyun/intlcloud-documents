## 背景说明
云函数是腾讯云为企业和开发者们提供的无服务器执行环境，具体可参见 [云函数 SCF](https://intl.cloud.tencent.com/zh/product/scf)，下文简称 SCF。
...
关于触发器参数配置可以参考 [CKafka 触发器](https://intl.cloud.tencent.com/document/product/583/17530)。
