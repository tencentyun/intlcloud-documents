如果您已完成了 [步骤2：创建并测试 API 服务](https://intl.cloud.tencent.com/document/product/583/13199)，且测试结果符合预期，则接下来可以对外发布此服务并从浏览器发起请求来验证接口的工作情况。

## API 服务发布
1. 登录 [API网关控制台](https://console.cloud.tencent.com/apigateway)，选择左侧导航栏中的**服务**。
2. 在“服务”页中，选择 [步骤2](https://intl.cloud.tencent.com/document/product/583/13199) 中创建的 blogAPI 服务名称右侧的**发布**。
...
1. 在 blogAPI 服务中，进入**API文档/SDK**选项卡，复制“发布”环境的访问路径。例如 `service-kzeed206-1251762227.ap-guangzhou.apigateway.myqcloud.com/release`。
