...
Currently, all function logs are delivered to CLS. You can configure the function log delivery. For more information, please see [Log Delivery Configuration](https://cloud.tencent.com/document/product/583/52644).
You can query function execution logs on the log query page of SCF or CLS. For more information on the log query method, please see [Log Search Guide](https://cloud.tencent.com/document/product/583/52637).
...
Currently, the string content output by simple `print` or `logger` in the function code will be recorded in the `SCF_Message` field when it is delivered to CLS. For descriptions of CLS fields, please see [Log Delivery Configuration](https://cloud.tencent.com/document/product/583/52644#.E7.B4.A2.E5.BC.95.E9.85.8D.E7.BD.AE).
...
- You can also enable the key-value index in CLS and use `key1` and `key2` as keywords for search. For more information, please see [Configuring Index](https://cloud.tencent.com/document/product/614/50922).
