...
## 前提条件
已参考 [安装 Serverless Framework](https://intl.cloud.tencent.com/document/product/583/36263) 完成安装操作。
...
serverless deploy
```
2. 进行腾讯云授权登录和注册。如需配置持久的环境变量或密钥信息，请参见 [账号配置](https://intl.cloud.tencent.com/document/product/583/32743)。
