...
### 更多创建方式
您可根据实际需求，选择更多方式创建函数：
- 使用 Serverless Framework CLI 命令行工具，可参考 [使用 CLI 创建函数](https://intl.cloud.tencent.com/document/product/583/32743)，以及函数的调用和部署。
- 使用 VS Code ，可参考 [使用 VS Code 插件创建函数](https://intl.cloud.tencent.com/document/product/583/32744)，以及函数的调试和部署。
...
### Serverless Framekwork CLI 更新函数代码
在本地修改函数代码后，通过 Serverless Framekwork CLI 执行 `sls deploy` 命令，即可部署函数并完成代码更新。
>?Serverless Framework 的开发模式支持函数的同步更新，详情请参见 [开发模式与云端调试](https://intl.cloud.tencent.com/document/product/583/36268)。
