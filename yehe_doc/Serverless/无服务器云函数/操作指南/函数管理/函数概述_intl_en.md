...
- Function type: SCF supports two function types: `event` function and `web` function.
  - `Event` functions are triggered by events in a specified format, such as scheduled triggering events and COS triggering events. For more information on the event structure, please see [Trigger Overview](https://intl.cloud.tencent.com/document/product/583/9705).
  - `Web` functions focus on optimizing web services and can directly accept and process HTTP requests. For more information, please see [Function Overview](https://intl.cloud.tencent.com/document/product/583/40688).
...
- Log configuration: it delivers function invocation logs to the specified log topic. For more information, please see [Log Search Guide](https://intl.cloud.tencent.com/document/product/583/39777).
...
- [Execution configuration](https://intl.cloud.tencent.com/document/product/583/39466):
...
- [Copying function](https://cloud.tencent.com/document/product/583/33664): copies a function to the specified region, name, and configuration.
