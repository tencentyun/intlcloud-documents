...
>?云函数获取固定公网出口 IP 配置，请参考 [固定公网出口 IP](https://intl.cloud.tencent.com/document/product/583/38106)。

## 前提条件
- 已注册腾讯云账户。若未注册，请前往 [注册页面](https://intl.cloud.tencent.com/register)。
...
4. 您可根据实际需求，参考[网络配置](https://intl.cloud.tencent.com/zh/document/product/583/38377)相关文档进行配置。
