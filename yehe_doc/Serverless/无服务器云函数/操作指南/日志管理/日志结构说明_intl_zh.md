...
| SCF_StatusCode   | long     | 函数运行 [状态码](https://intl.cloud.tencent.com/document/product/583/35311)。 |
...
> - [获取函数运行日志](https://intl.cloud.tencent.com/document/product/583/18583) 接口暂不支持精简格式日志查询。
