 ...
 **Parameter information:**
 ...
 <table>
	...
	<td>secret_id</td> 	<td>No</td> 	<td><code>String</code></td>
		<td>SecretId of the user, which can be obtained from the function's environment variable by default <b>and is required for local invocation.</b></td>
	</tr>
	<tr>
	<td>secret_key</td> 	<td>No</td> 	<td><code>String</code></td>
		<td>SecretKey of the user, which can be obtained from the function's environment variable by default <b>and is required for local invocation.</b></td>
	</tr>
	<tr>
...
| secret_id | No | `String` | SecretId of the user, which can be obtained from the function's environment variable by default **and is required for local invocation**. |
| secret_key | No | `String` | SecretKey of te user, which can be obtained from the function's environment variable by default **and is required for local invocation**. |
...
|get_request_id |Returns RequestId information |
