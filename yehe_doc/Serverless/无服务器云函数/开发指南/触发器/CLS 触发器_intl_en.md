...
- **Async invocation**
a CLS trigger always invokes a function asynchronously, and the result is not returned to the invoker. For more information on invocation types, please see "Invocation Types" in [How It Works](https://intl.cloud.tencent.com/document/product/583/9694).
