...
1. 登录 [COS 控制台](https://console.cloud.tencent.com/cos5)，创建新的 **公有存储桶**（参考 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309)） ，用于存放上传的图像，注意地域的选择。
2. 在桶列表的【基础配置】中，为存储桶 [配置跨域访问 CORS](https://intl.cloud.tencent.com/document/product/436/13318)，具体配置如下：
