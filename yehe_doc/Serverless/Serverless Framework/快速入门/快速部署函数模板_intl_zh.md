...
>! 由于域名备案更新，目前 cli 部署流程无法通过扫码登录，您可以通过本地配置永久密钥，或者根据命令行提示，通过访问 URL 完成登录，详情见 [账号和权限配置](https://intl.cloud.tencent.com/document/product/1040/36793)。

## 操作场景
该任务指导您通过 Serverless Cloud Framework，在腾讯云上快速创建、配置和部署一个 SCF 云函数应用。

## 前提条件
- 已经 [安装 Serverless Cloud Framework 1.67.2](https://intl.cloud.tencent.com/document/product/1040/37034) 以上版本。
```
