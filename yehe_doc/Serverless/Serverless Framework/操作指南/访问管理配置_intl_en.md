...
Serverless Framework supports **resource-level authorization**. You can use policy syntax to grant sub-accounts permissions to manage individual resources. For more information, please see [Authorization Scheme Examples](#examples).
