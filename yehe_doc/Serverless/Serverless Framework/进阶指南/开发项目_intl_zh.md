## 前提条件
- 了解 [快速部署](https://intl.cloud.tencent.com/document/product/1040/36249)
- 了解 [Serverless 应用](https://intl.cloud.tencent.com/document/product/1040/38288)
- 了解 [账号和权限配置](https://intl.cloud.tencent.com/document/product/1040/36793)
...
## 权限管理
在开发项目中，需要对不同的人员进行权限分配和管理。例如对于开发人员，只允许其访问某个项目某个环境下的权限，可以参考 [账号和权限配置](https://intl.cloud.tencent.com/document/product/1040/36793)，授予子账号 Serverless Framework 特定资源的操作权限。
...
通过修改云函数别名为 $default（默认流量）的流量规则,对云函数两个不同的版本进行流量配置，一个为 $latest版本，一个为最后一次函数发布的版本。操作详情请参考 [灰度发布](https://intl.cloud.tencent.com/document/product/1040/37698)。



## Serverless 命令
开发项目到上线过程中，需要用到一些相关的Serverless相关命令。更多命令请查看 [Serverless 支持命令列表](https://intl.cloud.tencent.com/document/product/1040/36861)。
...
## 项目实践
参考 [开发上线 Serverless 应用](https://intl.cloud.tencent.com/document/product/1040/38253)。
