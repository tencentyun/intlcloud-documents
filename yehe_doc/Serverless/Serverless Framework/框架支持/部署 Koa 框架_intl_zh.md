...
- 已经 [安装 Serverless Framework 1.67.2](https://intl.cloud.tencent.com/document/product/1040/36249) 以上版本。
...
>?如果您的账号为**腾讯云子账号**，请首先联系主账号，参考 [账号和权限配置](https://intl.cloud.tencent.com/document/product/1040/36793) 进行授权。

## 操作步骤
>?以下步骤主要针对命令行部署操作，控制台部署请参考 [控制台部署指南](https://intl.cloud.tencent.com/document/product/1040/39132)。
