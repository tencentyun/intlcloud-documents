...
腾讯图片内容安全服务对购物平台的图片内容进行全场景覆盖式识别，智能审核商家/用户上传图片，高效识别并预警不合规图片，防止涉黄、涉暴、涉恐敏感类图像发布，降低人工审核成本和业务违规风险。

精细化的多级标签及高度客制化的自定义审核策略，保障各类合规商品正常交易的同时，及时甄别各场景下潜藏的不良和有害信息，维护平台业务的正常开展。

### 即时通讯

腾讯图片内容安全服务依托技术领先的识别模型，精准识别消息中潜藏的各类可能令人反感、不安全或不适宜的内容，及其各种变体形式，并及时返回审核结果。针对即时通讯的特殊场景能够有效防止恶意用户骚扰，阻断风险诈骗，提升用户体验。