...
```
2. 为 Web 服务绑定公网 IP。
  1. 在 [集群页面](https://console.cloud.tencent.com/tke2/cluster?rid=1)，创建公网 LB 类型 Service 绑定 Web 服务，详情请参见 [Service 基本功能](https://intl.cloud.tencent.com/document/product/457/36833)。
