...
-  为了更好地帮助您分析和查询日志，我们建议您 [扩容日志存储量](https://buy.cloud.tencent.com/cfw?type=modify&adtag=cfw.from.console.page.buy) 或使用 [日志投递](https://intl.cloud.tencent.com/document/product/1160/49862#.E6.97.A5.E5.BF.97.E6.8A.95.E9.80.92) 功能。
...
### 日志如何下载？[](id:question5)
-  您可通过日志投递功能将日志转投出来分析使用（前提是 购买腾讯云消息队列 Ckafka 实例）配置参考 [日志分析](https://intl.cloud.tencent.com/document/product/1160/49862)。
