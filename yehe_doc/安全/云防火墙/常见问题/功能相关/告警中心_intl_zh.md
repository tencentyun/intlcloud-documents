...
### 如何查看某IP的威胁画像？
 - 在安全事件告警中，您可以参考 [安全事件告警-事件详情](https://intl.cloud.tencent.com/document/product/1160/49816#keshihua) 中的查看威胁画像。
...
3. 若仍无法看到相应的事件，请 [联系我们](https://intl.cloud.tencent.com/contact-us) 以便进一步核实，感谢您的理解和支持。
