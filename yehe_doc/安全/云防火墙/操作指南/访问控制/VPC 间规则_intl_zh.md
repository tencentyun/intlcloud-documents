...
## 操作指南
1. 登录 [云防火墙控制台](https://console.cloud.tencent.com/cfw/ac/internet)，在左侧导航栏中，选择**访问控制** > **VPC 间规则**。
...
**字段说明**：
 ...
 - **VPC 间通配规则**：支持通配的 IP 地址段，详情可参见 [互联网边界规则](https://intl.cloud.tencent.com/document/product/1160/49844) 中的互联网边界通配规则。	
>!
...
8. 策略备份与回滚，单击右上角的**规则备份**，即可将现有的NAT边界规则进行备份；同时当规则发生了较大变化后，单击备份文件右侧的**回滚**，即可将规则进行复原。
 1. 单击右上角的**规则备份**，进入策略备份与回滚页面，单击**新增备份**，在下拉框中选择 **VPC 间规则组**并输入描述，单击**确定**完成规则备份。
...
- 如需在云防火墙控制台对 NAT 边界的入向与出向流量进行管控，请参见 [NAT 边界规则](https://intl.cloud.tencent.com/document/product/1160/49845)。
- 如需了解云防火墙的访问控制功能的特殊应用场景，请参见 [特殊应用场景](https://intl.cloud.tencent.com/document/product/1160/49850)。
- 如遇到 VPC 间规则相关问题，可参见 [VPC 间防火墙](https://intl.cloud.tencent.com/document/product/1160/49830) 文档。
