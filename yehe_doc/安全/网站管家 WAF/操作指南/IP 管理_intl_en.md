...
>!
>- If you select `ALL` for domain name, the added IP address or range will be blocked/allowed globally.
...
- #### **Example 3. Querying IP blocking status**
	...
	2. On the query page, you can query the information of IPs blocked by the custom policy, CAPTCHA, bot blocking, and CC protection modules. You can also export the query results and add individual IPs to the blocklist or allowlist.
