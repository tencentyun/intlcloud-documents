## Feature Overview
In bot details, you can view the access trends in normal requests and bot requests to your domain names, details of bot behaviors in unknown, public, and custom types, and details of bot sessions detected by WAF.
## Instructions
### Viewing overview
...
**Item description of the unknown bot list:**
	...
	- **Operation**: **Blacklist** and **View Details** are supported. Click an unknown bot to view its details, or click **Blacklist** in the "Operation" column on the right to add its IP to the blacklist in the **IP Management** > **[IP Blacklist/Whitelist](https://console.cloud.tencent.com/guanjia/ip/list)** module.
...
**Basic information item description:**
		...
		- **Operation Description**: on the right of the access source IP under the basic information configuration item, click **Blacklist/Whitelist** to add this IP to the **IP Management** > **[IP Blacklist/Whitelist](https://console.cloud.tencent.com/guanjia/ip/list)** module.
