...
1. Log in to the [WAF Console](https://console.cloud.tencent.com/guanjia), and click **Web Application Firewall** > **Defense settings** in the left sidebar. In the domain name list, select the domain name of the site you want to protect. In the **Operation** column on the right, click **Defense configuration** to enter the details page, and select **Custom Rule**>**Add a Rule**.
