...
4. After the modification, wait for the DNS record to take effect and WAF to start protecting the traffic accessing the website. If WAF detects that the protected domain name is properly resolved, "Normal Protection" will be displayed in the [WAF Console](https://console.cloud.tencent.com/guanjia/waf/config).
