...
>? To check whether the access to domain names added in CLB is normal for IPv4 domain name requests, see [Getting Started with CLB](https://intl.cloud.tencent.com/document/product/214/8975). 
