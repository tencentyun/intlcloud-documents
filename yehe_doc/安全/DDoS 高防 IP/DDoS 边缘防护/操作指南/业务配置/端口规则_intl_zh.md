 非网站业务（例如：端游、手游、App等）接入 DDoS 边缘防护时，需要在 DDoS 边缘防护的端口规则页面为业务添加转发规则，本文将介绍如何添加相关转发规则。

 ## 前提条件
已购买 [DDoS 边缘防护](https://intl.cloud.tencent.com/document/product/297/42172)。

## 操作步骤
1. 登录 [DDoS 边缘防护管理控制台](https://console.cloud.tencent.com/ddos/antiddos-edge/policy/ddos) ，在左侧导航中，单击【业务配置】,并单击端口业务接入下方的【立即接入】。
