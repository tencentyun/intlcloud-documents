...
3. Select a forwarding protocol and certificate, specify a domain name, and then click **Next: Set Forwarding Method**.
![](https://qcloudimg.tencent-cloud.cn/raw/3a3fd3db21e47b9b149a478879de9ada.png)
4. Select a forwarding method, specify a "real server IP+port" or a real sever domain name, and then click **Next: Modify DNS Resolution**.
