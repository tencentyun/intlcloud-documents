...
DDoS 高防 IP 服务支持会话保持，默认不开启。非网站业务可以通过控制台进行配置操作，请参考 [配置会话保持](https://intl.cloud.tencent.com/document/product/297/37223)。
### DDoS 高防 IP 服务是否支持健康检查？
非网站业务默认开启健康检查，建议使用默认值，如需要修改，请参考操作步骤 [配置健康检查](https://intl.cloud.tencent.com/document/product/297/37224)。
