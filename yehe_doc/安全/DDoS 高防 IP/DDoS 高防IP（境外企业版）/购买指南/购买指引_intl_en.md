...
5. Log in to the [Anti-DDoS console (Global Enterprise Edition)](https://console.cloud.tencent.com/ddos/ddos-basic) and select **Anti-DDoS Advanced** -> **Instance List** to enter the instance list page.
