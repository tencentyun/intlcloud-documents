...
## Directions
1. Log in to the [Anti-DDoS Advanced (Global Enterprise Edition) Console](https://console.cloud.tencent.com/ddos/antiddos-advanced/config/port) and click **Anti-DDoS Advanced (New)** -> **Configurations**->**DDoS Protection** on the left sidebar.
