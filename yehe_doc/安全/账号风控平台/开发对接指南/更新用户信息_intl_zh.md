## 接口描述
更新已登录用户的个人信息。调用此接口时，需携带登录成功时得到的具备 openid scope 的 Access Token。如果更新手机号或邮箱，则需先调用 [发送 OTP 验证码](https://www.tencentcloud.com/document/product/1148/51475) 接口向用户发送验证码。
