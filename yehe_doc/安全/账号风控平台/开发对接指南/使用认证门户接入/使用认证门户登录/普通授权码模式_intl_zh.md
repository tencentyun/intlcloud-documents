...
>?
>- 出于安全因素，OAuth 协议不推荐使用此模式，请优先选择使用[ PKCE 授权码模式](https://www.tencentcloud.com/document/product/1148/51469)。
...
```
>? 应用回调地址拿到 `code` 参数后，需要调用  [ 普通授权码模式获取 Token ](https://www.tencentcloud.com/document/product/1148/51482) 接口获取 Access Token 和 ID Token，完成登录。
