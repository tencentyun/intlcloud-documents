...
- 单击【[了解更多](https://intl.cloud.tencent.com/document/product/296/12236)】，可查看产品文档，了解更多功能特性及操作指南。
...
- 安全引擎防护将展示6个引擎图标，分别代表云查杀引擎、AI 引擎、虚拟机检测引擎、异常分析、威胁关联、攻击防御。若未开启专业版功能，6个图标均处于灰色状态。若有任意一台主机，开通专业版防护功能，则6个图标均处于点亮状态。
