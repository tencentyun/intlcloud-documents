...
您可以参考 [访问管理-主账号访问密钥管理](https://intl.cloud.tencent.com/document/product/598/34228) 和 [访问管理-子账号访问密钥管理](https://intl.cloud.tencent.com/document/product/598/32675) 文档，配置、管理 API 访问密钥。
...
2. 在用户列表页面，选择要授权的子用户/协作者，单击**授权**，弹出关联策略页面。
   ![](https://qcloudimg.tencent-cloud.cn/raw/717869e4a26a617cf1ba2caaa0933a9e.png)

3. 在关联策略页面，根据需求配置子用户/协作者内容安全产品的访问权限。

   >? 目前支持音、视、图、文内容安全服务各个产品的读写权限配置，可配置权限为：**全读写/只读**。

   ![](https://qcloudimg.tencent-cloud.cn/raw/3769d769e5eabddfb6bf97939c9c2f9b.png)
...
<table>
  <tr>
     <td colspan="1" width=150>产品名称</td>
     <td colspan="1" width=250>预设策略</td>
     <td colspan="1">权限说明</td>
  </tr>
  <tr>
     <td rowspan="2">文本内容安全</td>
     <td colspan="1">QcloudTMSFullAccess</td>
     <td colspan="1">全读写访问权限</td>
  </tr>
  <tr>
     <td colspan="1">QcloudTMSReadOnlyAccess</td>
     <td colspan="1">只读访问权限</td>
  </tr>
  <tr>
...
>? 上述预设策略可用于给子用户/协作者关联相应内容安全服务不同的访问权限，将预设策略按照 [访问管理-授权管理](https://intl.cloud.tencent.com/document/product/598/10602) 所述的步骤，分配给想要配置的用户/用户组，该用户/用户组即可根据策略授予的权限，访问或使用对应的内容安全服务。
...
- 关于如何创建自定义策略，敬请参考 [访问管理-创建自定义策略](https://intl.cloud.tencent.com/document/product/598/35596)。
- 关于如何为用户/用户组配置策略，敬请参考 [访问管理-授权管理](https://intl.cloud.tencent.com/document/product/598/10602) 。

## 步骤4： CAM 授权管理配置建议

访问管理功能需要有效的配置和持续的管理才能够最大化地发挥效能。关于 CAM 访问管理配置的相关安全建议，敬请参见 [访问管理-安全管理策略](https://intl.cloud.tencent.com/document/product/598/10592) 文档。