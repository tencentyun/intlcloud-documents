...
>? CLB WAF 不支持防信息防篡改功能，详细规格信息请参见 [计费概述](https://intl.cloud.tencent.com/document/product/627/47409)。

## 前提条件
您已经在 WAF（SaaS 版本）中 [添加防护域名](https://intl.cloud.tencent.com/document/product/627/35651)，且域名处于正常防护状态。
