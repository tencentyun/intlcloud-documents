...
## 背景信息
攻击 IP 惩罚指的是自动阻断在短时间内发起多次 Web 攻击（规则引擎触发）的客户端 IP，一段时间内阻止所有请求，阻断日志可以在 [攻击日志](https://intl.cloud.tencent.com/document/product/627/35649) 中查看。

## 前提条件
- 已 [购买 Web 应用防火墙套餐](https://intl.cloud.tencent.com/pricing/waf)。
- 完成防护域名添加，域名处于正常防护状态。操作详情请参见 [快速入门](https://intl.cloud.tencent.com/document/product/627/18635)。
