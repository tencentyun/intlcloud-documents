...
**字段说明**
 ...
 - **服务器配置：**协议和端口可按实际情况选择。更多端口添加请参见 [接入相关端口](https://intl.cloud.tencent.com/document/product/627/47411)。
   - 选择 **HTTP** 协议，输入端口。
...
5. 完成配置后，可在域名列表看到刚刚添加的域名。当前界面显示未配置 CNAME 记录，需要 [本地验证测试](https://intl.cloud.tencent.com/document/product/627/35652) 后，再 [修改 DNS 解析](https://intl.cloud.tencent.com/document/product/627/35653)。
...
- [步骤 4：设置安全组](https://intl.cloud.tencent.com/document/product/627/35654)
