...
## Quick Bypass[](id:Bypass)
Quick bypass refers to a feature that can quickly switch to pure forwarding. On the [domain name management page](https://console.cloud.tencent.com/guanjia/tea-domain), you can select the target domain name and click ![](https://qcloudimg.tencent-cloud.cn/raw/8e3d53c8f2d8c84c9318cc958c6d023d.png) to enable this feature and quickly allow all blocked traffic for a swift business recovery.
![](https://qcloudimg.tencent-cloud.cn/raw/e20aa8ee5a390f6cffa007914307a383.png)
