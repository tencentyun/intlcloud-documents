...
- 确保您已经创建 **云数据库 MySQL** 或 **TDSQL MySQL版** 实例。对于具体操作，请查阅 [创建 MySQL 实例](https://intl.cloud.tencent.com/document/product/236/37785)、[创建 TDSQL 实例](https://intl.cloud.tencent.com/document/product/1042/33336)。
