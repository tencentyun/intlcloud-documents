...
3. After service role authorization, click [KMS](https://buy.cloud.tencent.com/kms) in the instruction at the top of the page.
...
As the core resources of KMS, CMKs are protected by hardware security module certified by third parties. CMK contains metadata information such as key ID, creation date, description, and key status.
When you are using SSM to [Create Credential](https://intl.cloud.tencent.com/document/product/1078/38601), two types of encryption keys are provided. You can select one as needed.
...
- You can also go to the  [KMS Console](https://console.cloud.tencent.com/kms2) to create a key on your own and define the key policies and usage. KMS enables users to choose keys as needed. You can either **create keys in KMS** or **import external key** (BYOK). For more information, please see KMS [Creating a key](https://intl.cloud.tencent.com/document/product/1030/31971) and [Importing external key](https://intl.cloud.tencent.com/document/product/1030/32795). 
