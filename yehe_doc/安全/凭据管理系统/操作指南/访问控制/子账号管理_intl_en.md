...
## Directions
1. Create a sub-account. Log in to the Tencent Cloud [ CAM Console](https://console.cloud.tencent.com/cam/overview) as the root account. In the left sidebar, click **Users** -> **User List**. On the **User List** page, click **Create User** to create a sub-account.
![](https://main.qcloudimg.com/raw/6c2f5ac34a9cdf2ef3b7a3142d6d0b10.png)
2. Create an API key. You can click the name of the sub-account to go to the **User Details** page. Click **API Key** -> **Create Key** to create SecretId and SecretKey. You can use this API key to access SSM.
...
4. Add a policy. On the **Add Policy** page, click **Select policies from the policy list**, choose the appropriate SSM policy, and click **Next** > **OK**. In this way, you can grant permissions to the sub-account to access SSM.
