...
### Pay-as-you-go
SSM offers pay-as-you-go pricing. You will be billed based on the number of managed secrets and API calls in SSM. No minimum fee or setting fee is required. For more information, please see [Purchase Guide](https://intl.cloud.tencent.com/document/product/1078/38596).
