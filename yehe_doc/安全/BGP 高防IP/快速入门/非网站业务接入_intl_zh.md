...
## 前提条件
- 在添加转发规则前，您需要成功购买 [中国大陆 DDoS 高防 IP 实例](https://buy.cloud.tencent.com/dayu_buy#/antiddos-advanced) 或 [境外 DDoS 高防 IP 实例](https://buy.cloud.tencent.com/dayu_buy#/antiddos-advanced-intl)。
...
>若使用正确的方法仍验证失败，请登录 DDoS 高防 IP 控制台检查配置是否正确。排除配置错误和验证方法不正确后，若问题依然存在，请联系 [腾讯云技术支持](https://intl.cloud.tencent.com/support) 。
