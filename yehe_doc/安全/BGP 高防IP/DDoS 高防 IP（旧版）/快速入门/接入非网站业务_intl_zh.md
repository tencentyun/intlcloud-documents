...
## 前提条件
- 在添加转发规则前，您需要成功 [购买 DDoS 高防 IP 实例](https://intl.cloud.tencent.com/document/product/297/15483)。
...
### [配置转发规则](id:step1)
1. 登录 [DDoS 防护管理控制台](https://console.cloud.tencent.com/dayu/overview)，选择【DDoS 高防 IP】>【接入配置】。
...
![](https://main.qcloudimg.com/raw/849f37ac06a8c3bf9cc53f7e6bb1e154.png)
 ...
 >?DDoS 高防 IP 不支持使用1433、1434、3306、3389、36000以及56000端口，广州、北京地区的支持843端口。
 - 源站端口：用户业务站点的真实端口。
 - 回源方式：支持 IP 回源和域名回源。
 - 负载均衡方式：目前仅支持加权轮询。
 - 源站IP+权重或源站域名。根据【回源方式】填写源站 IP+权重或源站域名。最多支持20个 IP+权重或域名。
	...
	- 批量添加转发规则：
		1. 选择【批量导入】>【导入转发规则】。
![](https://main.qcloudimg.com/raw/f8f6868da48ccc8e2a03f7b1e7352f67.png)
		1. 在批量导入页面的规则输入框中，粘贴需要导入的规则。
![](https://main.qcloudimg.com/raw/442aaadb23bd04418cb1e3a4faa5175e.png)
>!
...
> ?若使用正确的方法仍验证失败，请登录  [DDoS 防护管理控制台](https://console.cloud.tencent.com/dayu/overview) 检查配置是否正确。排除配置错误和验证方法不正确后，若问题依然存在，请联系  [腾讯云技术支持](https://intl.cloud.tencent.com/zh/support) 。
