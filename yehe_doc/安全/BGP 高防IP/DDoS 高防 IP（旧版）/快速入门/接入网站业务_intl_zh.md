...
## 前提条件
- 在添加转发规则前，您需要成功 [购买 BGP 高防 IP 实例](https://intl.cloud.tencent.com/document/product/297/15483)。
...
1. 登录 [BGP 防护管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【BGP 高防 IP】>【接入配置】。
...
![](https://main.qcloudimg.com/raw/9da373538b5767afb4e0dbd4c3a02660.png)
参数说明：
 - 域名：填写需要配置防护的网站域名。
 - 协议：支持 HTTP 和 HTTPS，请根据实际业务需求勾选：
  ...
  - 根据【回源方式】填写源站 IP 或源站域名：
	...
	- 批量添加转发规则：
		1. 	选择【批量导入】>【导入转发规则】。
		![](https://main.qcloudimg.com/raw/d82dfbdcb192890eb815199b315dbd3c.png)
...
用户可以通过登录[ BGP 防护管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【BGP 高防 IP】>【资产列表】，找到目标 BGP 高防 IP 实例所在行，单击“ID/名称”，在弹出的“基础信息”页面中查看详细的高防 IP 回源地址段。
...
> ?若使用正确的方法仍验证失败，请登录  [BGP 防护管理控制台](https://console.cloud.tencent.com/dayu/overview) 检查配置是否正确。排除配置错误和验证方法不正确后，若问题依然存在，请联系  [腾讯云技术支持](https://intl.cloud.tencent.com/zh/support) 。


### [修改业务域名 DNS 解析](id:step4)
