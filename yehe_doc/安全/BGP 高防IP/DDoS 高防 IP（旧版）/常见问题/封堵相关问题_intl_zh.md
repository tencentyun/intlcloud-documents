...
### 紧急情况下，通过哪些途径可以提前解封？
- 升级保底容量后，可自动提前解封。
- 使用 DDoS 高防 IP 的用户每天将拥有三次自助解封机会，可在紧急情况下，进行 [自助解封](https://intl.cloud.tencent.com/document/product/297/34090)。
...
### 怎样预防被封堵？
[购买 DDoS 高防 IP](https://intl.cloud.tencent.com/document/product/297/15483) 时，可根据历史攻击流量数据，选择适当的防护峰值，尽可能地确保最大防护峰值大于攻击峰值。
