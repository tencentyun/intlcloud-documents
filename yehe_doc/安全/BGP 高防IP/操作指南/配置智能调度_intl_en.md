...
1. Log in to the [DNSPod Console](https://console.cloud.tencent.com/cns) and click **Domain Name Resolution List** on the left sidebar. On the domain name resolution list page, click **Resolve** on the row of the target domain name.
![](https://main.qcloudimg.com/raw/31e86278ecfc0dde46f345edebd531b6.png)
2. Select **Record Management** > **Add Record**, select CNAME as the record type, enter the CNAME address automatically generated by the intelligent scheduling system as the record value, and click **Save**.
