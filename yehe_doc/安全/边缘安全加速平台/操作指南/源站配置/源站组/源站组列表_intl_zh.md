## 功能简介
以源站组的方式管理业务源站。此处配置的源站组可于 [负载均衡](https://intl.cloud.tencent.com/document/product/1145/46193) 和 [四层代理](https://intl.cloud.tencent.com/document/product/1145/46194) 功能中按需引用。
...
- 若一个源站组被 [负载均衡](https://intl.cloud.tencent.com/document/product/1145/46193) 引用，则：
 - 若代理模式选择“仅 DNS”：源站地址不可配置端口；IP 和域名形式源站不可混填。
- 若一个源站组被 [四层代理](https://intl.cloud.tencent.com/document/product/1145/46194) 引用，则：
  - 所有源站地址必须配置端口。
