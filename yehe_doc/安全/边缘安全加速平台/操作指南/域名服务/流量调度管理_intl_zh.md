...
## 前提条件
您需要成功 [购买](https://intl.cloud.tencent.com/document/product/1145/45964) 边缘安全加速平台（EdgeOne）产品（企业版），且使用 CNAME 模式完成 [站点接入](https://intl.cloud.tencent.com/document/product/1145/45966)。
