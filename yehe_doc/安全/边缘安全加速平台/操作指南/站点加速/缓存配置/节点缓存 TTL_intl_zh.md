...
>- 若源站资源更新后，需要立刻更新节点的缓存，可使用 [清除缓存](https://intl.cloud.tencent.com/document/product/1145/46179) 功能主动清除节点未过期的旧缓存，保证后续请求可以获取到源站最新的资源。
...
>- 关闭“强制缓存”需前往 [规则引擎](https://intl.cloud.tencent.com/document/product/1145/46151) 自定义配置节点缓存 TTL 规则。为了保证缓存效果，建议您保持开启“强制缓存”。

3. 如需针对某个子域名或请求 URL等更细请求维度设置区别于站点全局的配置，请前往 [规则引擎](https://intl.cloud.tencent.com/document/product/1145/46151) 创建自定义规则。
