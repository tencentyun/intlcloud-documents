## Overview
Resources can be validated within the specified node cache TTL without requiring revalidation at the origin server, which boosts site speed and reduces response time.
