...
<td>Four signature calculation methods are supported. Select an appropriate one based on the access URL format. For more information, see <a href="#jqfs">Authentication Methods</a>.</td>
</tr>
<tr>
<td>Primary key</td>
