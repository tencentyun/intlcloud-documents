...
- 查询字符串，具体操作可参见 [查询字符串](https://intl.cloud.tencent.com/document/product/1145/46174)。
- HTTP 请求头，指定的 HTTP 请求头将被包含在 Cache Key 中，拼接在 URL 后方。只需输入 HTTP 请求头名称，例如：Accept-Language;User-Agent，Cache Key 里会自动包含头部对应的值。
- 忽略大小写，具体操作可参见 [ 忽略大小写](https://intl.cloud.tencent.com/document/product/1145/46181)。
