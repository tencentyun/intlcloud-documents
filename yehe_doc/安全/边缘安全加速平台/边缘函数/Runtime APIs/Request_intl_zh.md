...
>- 使用 FetchEvent 对象 [event.request](https://www.tencentcloud.com/document/product/1145/52690)，获得当前请求的 Request 对象。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="left">否</td>
      <td align="left">
        用于 <a href="https://www.tencentcloud.com/document/product/1145/52687">fetch</a> 请求下覆盖原有的域名解析, 支持指定域名或者 IP 地址。更多说明如下：
...
```
请求体，详情参见 [ReadableStream](https://www.tencentcloud.com/document/product/1145/52695)。
...
请求头部，详情参见 [Headers](https://www.tencentcloud.com/document/product/1145/52689)。
...
客户端请求 [event.request](https://www.tencentcloud.com/document/product/1145/52690) 对象包含 `eo` 属性，其信息如下：
...
>! 获取请求体方法，接收 `HTTP body` 最大字节数为 1M，超出大小会抛出 OverSize 异常。超出大小时推荐使用 [request.body](#body) 流式读取，详情参见 [ReadableStream](https://www.tencentcloud.com/document/product/1145/52695)。
...
获取 `request` 头部 cookie，并自动解析为 [Cookies](https://www.tencentcloud.com/document/product/1145/52685) 对象。
...
- [示例函数：基于请求区域重定向](https://www.tencentcloud.com/document/product/1145/52709)
