...
获取 request 关联的缓存 [Response](https://www.tencentcloud.com/document/product/1145/52691)。返回一个 Promise 对象。如果缓存存在，则包含 Response 对象，反之包含 undefined。
...
<table>
	...
	<tbody>
        ...
        <li>
          ...
          <div style="padding-left: 20px;padding-bottom: 6px">
            当参数 <code>request</code> 类型为 string 时，将被作为 URL 构造 <a href="https://www.tencentcloud.com/document/product/1145/52690">Request</a> 对象。
          </div>
        </li>
			</td>
		</tr>
