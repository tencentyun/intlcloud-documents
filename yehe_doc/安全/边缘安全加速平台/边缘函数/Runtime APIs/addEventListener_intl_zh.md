注册事件监听器，用于触发边缘函数脚本的执行。当前仅支持 `fetch` 请求事件，通过注册 `fetch` 事件监听器，生成 HTTP 请求事件 [FetchEvent](https://www.tencentcloud.com/document/product/1145/52688) ，进而实现对 HTTP 请求的处理。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>事件监听器。用于处理事件回调。</p>
        <li>注册 <code>fetch</code> 请求事件生成 <a href="https://www.tencentcloud.com/document/product/1145/52688">FetchEvent</a> 类的事件监听器。</li>
      </td>
    </tr>
  </tbody>
</table>
...
- [示例函数：返回 JSON](https://www.tencentcloud.com/document/product/1145/52703)
