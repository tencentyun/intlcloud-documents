...
![](https://qcloudimg.tencent-cloud.cn/raw/9398c5aa0fcd1476649706c4ee4ef834.png)
...
>- 如果没有设置具体的阈值，高防包将不会触发清洗动作，即 CC 防护为关闭状态。当存在 CC 攻击时，控制台所配置的防护等级、精准防护、CC 频率限制相关策略也不会生效，详细说明请参见 [CC 防护开关及清洗阈值](https://intl.cloud.tencent.com/document/product/1029/36135)。

![](https://qcloudimg.tencent-cloud.cn/raw/0628a361dc7e534b41b2470dc3dbb0e0.png)

## 步骤2：设置 CC 防护等级
1. 在 CC 防护开关和清洗阈值卡片中，单击**设置**，进入 CC 防护开关和清洗阈值规则列表。
![](https://qcloudimg.tencent-cloud.cn/raw/9e74bc29e1c9394bea7a1c9180d79534.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/da022e727fef5d815a8458a2d9241c5e.png)
3. 单击**保存**，添加规则。
...
![](https://qcloudimg.tencent-cloud.cn/raw/f4e31078c60c42052ed8b4da3bfd4358.png)
2. 在精准防护规则列表中，单击**新建**，创建精准防护规则，填写相关字段，填写完成后，单击**确定**即可。详细配置说明，请参见 [精准防护](https://intl.cloud.tencent.com/document/product/1029/36136)。
>!
>- 如果同一条策略中，存在多个 HTTP 字段时，需所有条件都满足才能匹配到此条策略。
>- DDoS 高防包暂不支持 HTTPS 业务的精准防护配置，[DDoS 高防 IP](https://intl.cloud.tencent.com/document/product/297/37218) 可支持 HTTPS 业务的精准防护配置。

![](https://qcloudimg.tencent-cloud.cn/raw/d0f7a8a1a9e78e665facd64ccebb4c74.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/798a57ea2245bf9ecad9848f36fc544a.png)
2. 在CC 频率限制列表中，可以新建防护等级，或对已创建的防护等级进行编辑。
>? 防护等级为 DDoS 高防开启 CC 防护且遭受攻击触发清洗动作时，对流量检测的严格程度，分为五种等级：宽松、攻击紧急、适中、严格、自定义，可根据攻击情况进行选择，详细说明请参见 [CC 防护开关及清洗阈值](https://intl.cloud.tencent.com/document/product/1029/36135)。
3. 单击**新建**，创建频率控制规则，填写相关字段，单击**确定**即可。详细配置说明，请参见 [频率控制](https://intl.cloud.tencent.com/document/product/1029/36137)。
...
![](https://qcloudimg.tencent-cloud.cn/raw/8410fd04c5668db96ac5f889c357da95.png)
