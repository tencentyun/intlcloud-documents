...
## 解决思路
- DDoS基础防护：默认情况下，封堵2小时后自动解封。在紧急情况下，可申请DDoS 应急防护。
...
5. [](id:step5)不同 DDoS 防护产品的用户，对应建议如下：
 - 如果是 DDoS 基础防护用户，建议用户购买 [高防包](https://buy.cloud.tencent.com/antiddos#/native)（支持防护地域：广州、上海和北京），[首次绑定设备](https://intl.cloud.tencent.com/document/product/1029/36116) 可进行解封。 
