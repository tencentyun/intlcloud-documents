...
不支持。DDoS 高防包仅对腾讯云内的公网 IP 提供 DDoS 防护支持。如需云外的防护，请 [购买 DDoS 高防 IP](https://intl.cloud.tencent.com/document/product/297/15483)。
...
### DDoS 高防包支持域名的防护吗？
不支持。若有域名防护以及应用层的防护需求，请 [购买 DDoS 高防 IP](https://intl.cloud.tencent.com/document/product/297/15483)。
...
- 防护对象：
 ...
 -  DDoS 高防 IP 面向云外用户，为非腾讯云的业务 IP/域名提供防护。
- 接入：
