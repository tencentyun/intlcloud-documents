...
Anti-DDoS Pro adopts a pay-as-you-go model. If you want to end the service, you need to submit a ticket to terminate your instances. Otherwise, charges are still be incurred.
