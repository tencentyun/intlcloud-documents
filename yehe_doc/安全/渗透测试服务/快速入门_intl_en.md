...
After making the purchase online, go to the [PTS console](https://console.cloud.tencent.com/mss/penetration), click **Create pen-test**, enter relevant parameters, and click **Submit**.
...
After the regression tests are performed, the service will be automatically terminated, but you can still view the results of previous tests in the [PTS console](https://console.cloud.tencent.com/mss/penetration). If you have any questions about penetration or regression test reports, contact us for assistance.
