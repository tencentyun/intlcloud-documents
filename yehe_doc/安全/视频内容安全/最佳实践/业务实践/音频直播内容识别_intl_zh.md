...
>?
>- 请在调用前确保目前账号**至少拥有音频内容安全服务的访问权限**，有关权限配置的相关信息，敬请参阅 [CAM 授权指引](https://intl.cloud.tencent.com/document/product/1140/44981) 文档。
...
## 步骤2： 配置自定义库（可选）
自定义库用于配置个性化的识别内容库，如无需配置自定义库，则可略过此步骤。
