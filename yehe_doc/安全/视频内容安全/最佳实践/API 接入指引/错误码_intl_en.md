...
| AuthFailure.UnauthorizedOperation | The request is not authorized. For more information, see the authentication description in the [CAM documentation](https://intl.cloud.tencent.com/document/product/1140/44981). |
