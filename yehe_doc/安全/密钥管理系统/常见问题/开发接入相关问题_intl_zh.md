...
创建用户主密钥有三种方式，分别是通过 [**密钥管理系统控制台**](https://intl.cloud.tencent.com/document/product/1030/31971)、[**腾讯云命令行工具 TCCLI**](https://intl.cloud.tencent.com/document/product/1030/32783) 及 [**API 接口请求**](https://intl.cloud.tencent.com/document/product/1030/32199) 。
...
支持轮换。可以通过 [**密钥管理系统控制台**](https://intl.cloud.tencent.com/document/product/1030/32779)、[**命令行工具**](https://intl.cloud.tencent.com/document/product/1030/32787) 或 [**API 接口**](https://intl.cloud.tencent.com/document/product/1030/32191) 三种方式进行开启操作。
>!不支持轮换的用户主密钥：
> - 非对称的用户主密钥 CMK 
> - 使用外部密钥材料的用户主密钥 CMK 
> 
...
>!通过 API 接口方式创建用户主密钥，建议在创建之前先查询当前地区支持的 [**加密方式**](https://intl.cloud.tencent.com/document/product/1030/35177)，从而确保创建的正确性。
