...
>?密钥管理系统 KMS 提供了对称加解密方案，详细请参见 [**对称加解密**](https://intl.cloud.tencent.com/document/product/1030/31975) 。

### 非对称加解密

非对称加解密需要两个密钥：公开密钥和私有密钥。公钥和私钥是一对密钥，信息传送者使用公钥对数据进行加密，信息接受者只有用对应的私钥才能解密。另一方面，信息传送者可使用私钥对机密信息进行签名，信息接受者使用对应的公钥对接收的数据进行验签。
>?密钥管理系统 KMS 也提供了非对称加解密方案，详情请参见 [**非对称加解密**](https://intl.cloud.tencent.com/document/product/1030/35541) 。
...
BYOK（Bring Your Own Key）是指用户可以自行导入密钥材料至用户主密钥中，详情请参见 [**外部密钥导入**](https://intl.cloud.tencent.com/document/product/1030/32795) 。
