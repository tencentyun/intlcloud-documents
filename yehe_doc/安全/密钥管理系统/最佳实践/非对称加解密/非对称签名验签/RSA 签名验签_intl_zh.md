...
## 操作步骤
### 步骤1：创建非对称签名密钥
>!在 KMS 中调用 [创建主密钥](https://intl.cloud.tencent.com/document/product/1030/32199) 接口创建用户主密钥时，必须传入正确的密钥用途 KeyUsage= ASYMMETRIC_SIGN_VERIFY_RSA_2048，这样才可以使用签名功能。
>
- **请求**：
```
...
调用 KMS 的 [签名](https://intl.cloud.tencent.com/document/product/1030/39509) 接口计算信息的签名。
