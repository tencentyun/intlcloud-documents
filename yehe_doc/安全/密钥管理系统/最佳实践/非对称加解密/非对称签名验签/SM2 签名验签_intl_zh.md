...
### 步骤1：创建非对称签名密钥
>!在密钥管理系统（KMS）中调用 [创建主密钥](https://intl.cloud.tencent.com/document/product/1030/32199) 接口创建用户主密钥时，在 KMS 中创建密钥的时候，必须传入正确的密钥用途 KeyUsage= ASYMMETRIC_SIGN_VERIFY_SM2，才可以使用签名的功能。
>
...
调用 KMS 的 [签名](https://intl.cloud.tencent.com/document/product/1030/39509) API 接口计算信息的签名。
