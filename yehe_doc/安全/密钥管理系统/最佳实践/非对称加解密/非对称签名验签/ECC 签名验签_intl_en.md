...
>!To use the signature feature, the correct key purpose `ASYMMETRIC_SIGN_VERIFY_ECC` is required when calling the KMS [CreateKey](https://intl.cloud.tencent.com/document/product/1030/32199) API to create a CMK.
>
- **Request**:
```
