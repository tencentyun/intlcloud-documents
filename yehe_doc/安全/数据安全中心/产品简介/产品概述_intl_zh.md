数据安全中心是集敏感数据发现与分类分级、数据地图、异常数据访问分析于一体的数据安全运营平台。
数据安全中心帮助企业自动梳理数据资产，对企业云上数据进行分类分级和安全风险评估，并协同腾讯云各安全能力，形成闭合的数据安全防护网，帮助企业最大化提升安全效益。
...
### 数据分类分级
根据国家、行业或企业的数据分类分级标准，帮助企业进行数据分类分级，为数据安全防护提供基础。
