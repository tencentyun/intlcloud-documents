...
| 计费参数      | 计费模式  | 付费方式 | 付费说明                                                       |
| ------------ | ------------ | -------- | ------------------------------------------------------------ |
| 防护 IP 数 | 包年包月 | 预付费   | 选择需要使用 DDoS 高防包实例防护的所有业务 IP 的数量，默认是1个，可选规格：1 - 100。 |
| 防护次数 | 包年包月 | 预付费   | 建议以历史平均遭受过的攻击次数为参考，选择的防护次数略高于历史平均次数。</br>若防护次数使用完，则受防护的业务 IP 将恢复到腾讯云赠送的免费基础防护能力。|
...
例如，购买3个月“防护 IP 数1个+防护次数10次”的高防包资源，在资源有效期内享有10次免费全力防护。


## 产品价格

新版 DDoS 高防包默认支持保护单个地域下的业务 IP，如果您需要保护多个地域下的 IP，则需要开通多个实例，若线上售卖的规格不满足您的业务需求，可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 联系我们定制。
