Cloud Access Management (CAM) is a user and permission management system provided by Tencent Cloud for the refined management of access to TMS and its specific APIs. Currently, TMS supports **service-level authorization** and console operations. For more information, see [CAM-Enabled Products](https://intl.cloud.tencent.com/document/product/598/10588).

>? You can skip this section if you don't need to manage access to TMS resources for sub-accounts. This will not affect your understanding and use of the other sections of the document.
