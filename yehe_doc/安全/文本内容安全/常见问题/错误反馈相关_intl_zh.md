...
子用户没有权限调用服务，需要主账号为子账号授权 CAM 策略：QcloudTMSFullAccess。详细操作请参见 [通过策略关联用户](https://intl.cloud.tencent.com/document/product/598/10602)。
...
- 使用自定义词库需要配置一个自定义的策略，并将这个词库配置到策略中，才会生效，生效时间预计5-10分钟左右。详细操作请参见 [自定义策略配置](https://intl.cloud.tencent.com/document/product/1121/43753#step4)。
