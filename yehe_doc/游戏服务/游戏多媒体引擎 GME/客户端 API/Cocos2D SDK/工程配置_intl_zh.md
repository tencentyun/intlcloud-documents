...
## Cocos Creator 接入
如果是使用 Cocos Creator 接入，请参考 [游戏多媒体引擎（腾讯云）快速入门](https://docs.cocos.com/creator/manual/zh/cocos-service/gme.html)。
## SDK 准备
...
### Windows 平台
需要到 [下载指引](https://intl.cloud.tencent.com/document/product/607/18521) 中下载 Windows SDK 后导入到工程中。
