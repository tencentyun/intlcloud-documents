...
- 您可以请参考 [Demo 使用文档](https://intl.cloud.tencent.com/document/product/607/36419)。
- 如果是 Unity Demo，请参考 [Unity Demo 使用文档](https://intl.cloud.tencent.com/document/product/607/38333)。
...
第三方播放器伴奏功能属于高级接口，需要 [提交工单](https://console.cloud.tencent.com/workorder/category)，并提供 tmg_adv_win.h 头文件。
