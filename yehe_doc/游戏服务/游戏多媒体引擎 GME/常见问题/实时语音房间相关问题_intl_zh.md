...
腾讯云 SDK提供的房间内通话可以满足以上场景，具体模式属于用户产品需求，在客户 App 层处理更加灵活，例如产品层下发协议让用户上麦。
...
3. 请查看控制台是否欠费。
4. 检查开发者测试设备是在开发者内网环境还是外网环境，如果是内网环境，请参考 [如何应对公司防火墙限制](https://intl.cloud.tencent.com/document/product/607/35232)。
...
2. 检查开发者测试设备是在开发者内网环境还是外网环境，如果是内网环境，请参考 [如何应对公司防火墙限制](https://intl.cloud.tencent.com/document/product/607/35232)。
3. 根据下面网络问题排查方法进行排查。
...
确认有无开启3D音效接口EnableSpatializer，然后确认有无更新自身坐标：[UpdateSelfPosition和UpdateAudioRecvRange](https://intl.cloud.tencent.com/document/product/607/18218)。
