...
您需要准备一个后端服务来处理来自客户端的玩家请求，并通过此客户端服务器调用 GPM 的 [StartMatching](https://chttps://intl.cloud.tencent.com/document/product/1072/39904) 接口，向 GPM 请求匹配服务。一次成功的 [StartMatching](https://intl.cloud.tencent.com/document/product/1072/39904) 调用，将会生成一个唯一的匹配票据，您需要追踪这个匹配票据的状态，来完成您的匹配流程。
