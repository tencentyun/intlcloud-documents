游戏多媒体引擎（Game Multimedia Engine, GME）提供一站式语音解决方案。针对游戏场景，提供实时语音、语音消息、语音转文本等服务，覆盖 FPS、MOBA、MMORPG、休闲对战、棋牌、线上桌游等多种游戏玩法类型；支持移动游戏、端游、主机游戏、网页游戏跨平台互通。
...
<li >支持 360 度 3D 语音、范围语音、小队语音、10w 人超大语音房间</li>
<li >支持实时语音伴奏与变声</li>
</ul ></td>
<td><ul style="margin:0;">
<li >对战开黑</li>
...
<tr>
<td>语音转文本</td>
<td >可将录音文件、流式语音消息转成文本，最多支持 125 种语言即说即转。</td>
<td><ul style="margin:0;">
<li >频道聊天</li>
<li >你画我猜</li>
</ul ></td> 
...
<tr>
<td>语音标签</td>
<td >基于AI模型对输入的音频数据进行分析，为音频打上年龄、性别、音色等标签。</td>
<td><ul style="margin:0;">
<li >玩法分级</li>
<li >未成年保护</li>
<li >用户特征分析</li>
