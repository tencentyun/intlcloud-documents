...
通过 [下载指引](https://www.tencentcloud.com/document/product/607/18521) 下载 Unreal Sample Project。由于 UE5 和 UE4 的 Demo 配置不同，需要下载相对应引擎版本的 Sample Project。
...
3D 音效的接入可以参考 [3D 音效文档](https://www.tencentcloud.com/document/product/607/18218)。在工程中，首先初始化 3D 音效功能，相关代码在 ExperientialDemoViewController.cpp 中。
