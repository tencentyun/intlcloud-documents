...
>! 
>- 使用GME服务端录制功能，录制过程将在GME产生录制服务费用。GME国际站录制服务将从2023年4月1日起正式计费，详细计费信息将提前公示在[GME购买指南](https://www.tencentcloud.com/document/product/607/50009)；
>- 录制后的文件将存储在您的腾讯云账号下的<b>对象存储(COS)</b>服务中，将会根据您的存储量、存储时长、访问频次等具体使用方式产生<b>对象存储(COS)</b>账单。详细计费信息请参考[COS计费说明](https://www.tencentcloud.com/zh/document/product/436/16871)。
