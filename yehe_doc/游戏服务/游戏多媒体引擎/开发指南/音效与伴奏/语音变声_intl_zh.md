...
- **已开通语音转文本服务**：可参见 [服务开通指引](https://intl.cloud.tencent.com/document/product/607/10782)。
...
- **已接入 GME SDK 库文件libgmesoundtouch**：需要保证工程库文件中带有 libgmesoundtouch，具体参见 [库文件对应功能](https://intl.cloud.tencent.com/document/product/607/32363)。
