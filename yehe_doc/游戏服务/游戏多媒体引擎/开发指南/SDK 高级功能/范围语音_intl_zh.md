...
具体玩家声音可达情况请参见 [附录](https://intl.cloud.tencent.com/document/product/607/17972#.E9.99.84.E5.BD.95)。
</dx-alert>
...
### 示例场景
例如：一个大逃杀类型的游戏，每4个人为一个队伍，则这4个人需要设置一个小队号 TeamID，每100人为一个对局房间，则25个小队都进去一个语音房间。在对局中，如果某玩家想和10米范围内的陌生人沟通，则将语音距离范围设置为10，将语音模式设置为 RANGE_AUDIO_MODE_WORLD，同时打开麦克风及扬声器。如果他只想和小队成员沟通，则只需要将语音模式设置为  RANGE_AUDIO_MODE_TEAM。
...
- 如果需要同时使用 3D 音效效果，此接口中的参数 axisForward、axisRight 及 axisUp 需要按照下文 [3D 语音部分](https://intl.cloud.tencent.com/document/product/607/17972#.E5.90.8C.E6.97.B6.E4.BD.BF.E7.94.A8-3d-.E9.9F.B3.E6.95.88) 进行设置。
