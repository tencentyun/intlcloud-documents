...
- **ReleaseAudioFoucus**
  释放音频焦点。
- 如果开启，退房之后将会释放音频焦点，系统恢复后台其他音频相关应用。例如音乐。
...
语言参数参考 [语言参数列表](https://intl.cloud.tencent.com/document/product/607/30260)。

#### 接口回调

| 参数       | 类型                            | 含义                                                         |
| ---------- | ------------------------------- | ------------------------------------------------------------ |
| code       | int                             | 错误码，0代表成功，其他返回请参考 [错误码](https://intl.cloud.tencent.com/document/product/607/33223) 进行解决 |
