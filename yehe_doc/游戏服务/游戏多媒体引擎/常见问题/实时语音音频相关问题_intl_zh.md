...
不同的应用场景有不同的音频类型，具体请参见 [音质选择文档](https://intl.cloud.tencent.com/document/product/607/18522)。
...
进房成功后使用 EnableAudioCaptureDevice，然后打开伴奏，再通过 EnableAudioSend 控制上行下行就不会关闭伴奏，可以参考[实时语音伴奏流程图](https://intl.cloud.tencent.com/document/product/607/31504)。
...
实时语音范围语音接入请参考 [范围语音文档](https://intl.cloud.tencent.com/document/product/607/17972)。实现范围语音功能后，同小队语音无距离衰减，全局语音有距离衰减，衰减系数参考文档。
...
实时语音 3D 音效接入请参考 [3D 音效文档](https://intl.cloud.tencent.com/document/product/607/18218)。
