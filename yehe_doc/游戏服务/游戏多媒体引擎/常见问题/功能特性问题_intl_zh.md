...
### 有哪些游戏使用了GME？
具体请参考 [GME 官网介绍页 - 客户案例](https://www.tencentcloud.com/products/gme) 模块。
...
详情请参见Windows 平台播放器伴奏功能进行调用。第三方播放器伴奏功能属于高级接口，需进行 [在线咨询](https://intl.cloud.tencent.com/contact-sales) 联系专业工作人员进行处理。并提供 `tmg_adv_win.h` 头文件与专业的开发人员进行对接。
