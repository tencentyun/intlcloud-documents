...
| speechLanguage    | const char* | 识别成指定文字的语言参数，参数请参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) |
| translateLanguage | const char* | 翻译成指定文字的语言参数，参数请参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260)|
...
如果出现 4098 错误码，请参考 [常见问题文档](https://intl.cloud.tencent.com/document/product/607/39716) 进行解决。
...
| speechLanguage    | const char* | 识别出指定文字的语言参数，参数参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) |
| translatelanguage | const char* | 翻译成指定文字的语言参数，参数参考 [言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260)|
