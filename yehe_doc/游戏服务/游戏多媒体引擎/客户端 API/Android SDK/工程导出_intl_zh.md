...
<dx-fold-block title="导出可执行文件过程中、或者导出可执行文件后出现的工程问题">
 [1. 导出到 Android 手机使用的时候，点击 App 会提示不支持该设备，如何解决？](https://intl.cloud.tencent.com/document/product/607/39522)
 [2. 集成 GME SDK 并导出 Apk 后，启动程序发生黑屏现象，如何解决？](https://intl.cloud.tencent.com/document/product/607/39522)
</dx-fold-block>
