...
| AV_ERR_SDK_NOT_FULL_UPDATE=7015 | The SDK file is not complete. Delete the file and import again. |
...
| Parameter    | Type   | Description                                                                                                                    |
| --------- | :--: | ------------------------------------------------------------ |
| isEnabled | bool | `true`: Enable; `false`: Disable. |
...
| Parameter    | Type   | Description                                                                                                                    |
| --------- | :--: | ------------------------------------------------------------ |
| isEnabled | bool | `false`: Disable the speaker; `true`: Enable the speaker. |
...
| Parameter    | Type   | Description                                                                                                                    |
| -------- | :----------: | ----------------------------------------------------- |
| roomtype | ITMGRoomType | The target room type. For details about room audio types, see `EnterRoom` . |
