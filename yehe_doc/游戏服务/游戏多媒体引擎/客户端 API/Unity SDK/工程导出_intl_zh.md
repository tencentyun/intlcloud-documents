...
业务层可根据所需的功能对动态库进行删减，根据动态库列表来决定示例代码中导入的 framework 列表。动态库功能具体参见 [动态库目录](https://intl.cloud.tencent.com/document/product/607/32363)。
...
### 5. 导出问题
导出问题请参见 [Unity-WebGL平台导出问题](https://intl.cloud.tencent.com/document/product/607/39522) 进行解决。
