...
| speechLanguage    | String | 识别成指定文字的语言参数，参数请参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) |
| translateLanguage | String | 翻译成指定文字的语言参数，参数请参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) |
...
| speechLanguage    | String | 识别出指定文字的语言参数，参数参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) |
| translatelanguage | String | 翻译成指定文字的语言参数，参数参考 [语言参数参考列表](https://intl.cloud.tencent.com/document/product/607/30260) 中的翻译语言参数 |
