为方便 Unreal Engine 开发者调试和接入腾讯云游戏多媒体引擎产品 API，这里向您介绍适用于 Unreal Engine 实时语音功能的开发接入技术文档。
...
未初始化前，SDK 处于未初始化阶段，**需要通过接口 Init 初始化 SDK**，才可以使用实时语音服务、语音消息及转文本服务。
...
详情请参见 [Demo](https://intl.cloud.tencent.com/document/product/607/18521)  中的 UEDemoLevelScriptActor.cpp 文件。
