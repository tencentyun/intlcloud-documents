This document describes how to access and debug the GME APIs for Unreal Engine.
...
Event callbacks can be triggered by periodically calling the `Poll` in `Tick`.
