...
初始化程序需要填入 [游戏多媒体引擎控制台](https://console.cloud.tencent.com/gamegme) 服务管理中的 AppID 以及权限密钥。申请 GME 服务，详情请参见 [接入指引](https://intl.cloud.tencent.com/document/product/607/10782)。**AppID 对应控制台的 AppID，Key 对应控制台的权限密钥。**
