目前游戏多媒体引擎 GME 提供提供实时语音、语音消息、语音转文本等服务，各项服务的价格信息如下。
...
从2022年7月1日起，语音消息服务与语音转文本服务将分开计费。语音消息提供DAU计费模式，语音转文本提供时长计费模式，支持全语种转文本，费用为 USD 0.006/15 秒（ 每个请求的时长均以 15 秒为增量向上取整到最近的数字）。
</dx-alert>
...
<table>
   <tr>
      <td>价格模型</td>
      <td>USD/每 100 万个字符</td>
   </tr>
   <tr>
      <td  rowspan="1">按字符数计费</td>
      <td> 20 </td>
   </tr>
   </tr>
</table>
