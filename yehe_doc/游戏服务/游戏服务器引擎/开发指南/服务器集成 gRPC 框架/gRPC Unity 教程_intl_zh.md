...
Unity Editor 将取出文件并自动添加到项目中，您即可在代码中使用 gRPC 和 Protobuf，如果 Unity Editor 提示错误，详情可参见 [常见问题](https://intl.cloud.tencent.com/document/product/1055/39059)。
...
获取 GSE SDK Protobuf 文件 `GameServerGrpcSdkService.proto` 和 `GseGrpcSdkService.proto`，详情可参见 [proto 文件](https://intl.cloud.tencent.com/document/product/1055/37419)。
<span id="test2"></span>
