...
<dx-alert infotype="explain" title="">
我们提供定义服务的 [proto 文件](https://intl.cloud.tencent.com/document/product/1055/37419)，请您直接下载使用，无需自己生成。
</dx-alert>
...
```
5. 当 Client 调用 [JoinGameServerSession](https://intl.cloud.tencent.com/document/product/1055/39130) 接口玩家加入后，Game Server 调用 AcceptPlayerSession 接口验证玩家合法性，如果连接被接受，则将 PlayerSession 状态设置为“活跃”。如果 Client 调用 JoinGameServerSession 接口在60秒内未收到响应，则将 PlayerSession 状态更改为“超时”，然后重新调用 JoinGameServerSession。
```
