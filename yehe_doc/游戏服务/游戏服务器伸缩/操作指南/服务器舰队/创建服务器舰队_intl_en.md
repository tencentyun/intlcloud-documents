...
1. Log in to the [GSE console](https://console.cloud.tencent.com/gse/asset) and click **Fleet** in the left sidebar to enter the server fleet page.
2. Select the service region at the top-left corner and click **Create**.
...
![](https://main.qcloudimg.com/raw/c47bfd7a581fa7152edfaec6c4ebd3c7.png)
  ...
  - Resource Type: select **Asset Package** from the drop-down list.
...
- **Image**
  ...
  - Name: enter the server fleet name. We recommend you use a meaningful fleet name, so that it can be easily identified in the list.
  Resource Type: select **Image** from the drop-down list.
  - Image Name: select a valid image from the drop-down list or create one first. For more information, see [Creating an Image](https://intl.cloud.tencent.com/document/product/1055/39061).
  - Description: enter the server fleet description, which is optional and used to help identify the fleet.
