...
## 定义服务
 ...
 >?我们提供定义服务的 proto 文件，请您在 [proto文件](https://intl.cloud.tencent.com/document/product/1055/37419) 里下载使用，无需自己生成。
## 生成 gRPC 代码
...
zip -r csharpdemo.zip * 
 ```
打包好的 csharpdemo.zip 即 GSE 需要的 [生成包](https://intl.cloud.tencent.com/document/product/1055/36674)，启动路径填写 csharpdemo，无启动参数。
