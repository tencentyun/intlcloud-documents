...
1. 初始化，调用 InitSDK。具体操作请参见 [初始化 SDK](https://intl.cloud.tencent.com/document/product/1055/36688)。  
...
2. 进程启动准备就绪，调用 ProcessReady，务必实现3个回调函数。具体操作请参见 [进程准备就绪](https://intl.cloud.tencent.com/document/product/1055/36689)。 
 - onStartGameSession  
 - onProcessTerminate  
 - onHealthCheck  
...
3. 客户端连接时，通过 AcceptPlayerSession 检查该连接是否预留位置。具体操作请参见 [接受玩家会话](https://intl.cloud.tencent.com/document/product/1055/36691)。  
...
```
4. 玩家退出游戏服务器会话 RemovePlayerSession。具体操作请参见 [移除玩家会话](https://intl.cloud.tencent.com/document/product/1055/36692)。
...
```
5. 游戏服务器会话结束 TerminateGameSession。具体操作请参见 [结束游戏服务器会话](https://intl.cloud.tencent.com/document/product/1055/36695)。  
...
```
6. 进程结束 ProcessEnding。具体操作请参见 [结束进程](https://intl.cloud.tencent.com/document/product/1055/36696)。   
