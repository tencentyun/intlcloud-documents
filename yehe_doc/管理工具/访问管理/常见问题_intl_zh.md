...
###  子账号密码如何重置？
子用户修改密码请参阅 [为子用户重置登录密码](https://intl.cloud.tencent.com/document/product/598/32656)，协作者修改密码请参阅 [修改账号密码](https://intl.cloud.tencent.com/document/product/378/14623)。
