## 操作场景
子账号包括子用户、协作者和消息接收人，不同类型用户的区别如下（详细说明请参考  [用户类型](https://intl.cloud.tencent.com/document/product/598/32633)）：
...
## 前提条件
- 若选择创建协作者，请先 [注册腾讯云账号](https://intl.cloud.tencent.com/document/product/378/17985)。
- 若使用管理员用户创建子账号，请先 [创建管理员用户](https://intl.cloud.tencent.com/document/product/598/38247)，再阅读下文操作步骤。
