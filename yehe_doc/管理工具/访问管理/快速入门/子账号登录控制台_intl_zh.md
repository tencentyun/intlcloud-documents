...
## 前提条件
已创建子账号。
- 子用户登录：已 [创建子用户](https://intl.cloud.tencent.com/document/product/598/40985)
- 协作者登录：已 [创建协作者](https://intl.cloud.tencent.com/document/product/598/32639)

## 登录步骤
您可以点击以下页签，查看对应登录方式的说明。
<dx-tabs>
::: 子用户登录
1. 进入 [腾讯云账号登录](https://intl.cloud.tencent.com/login) 页面，选择子用户登录。
...
:::
::: 协作者登录
1. 进入 [腾讯云账号登录](https://intl.cloud.tencent.com/login) 页面进行账号登录，请使用您主账号身份关联的登录方式进行登录。
