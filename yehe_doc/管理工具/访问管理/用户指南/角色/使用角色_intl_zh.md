...
<dx-tabs>
::: 通过控制台使用角色
1. 公司 A 创建角色（参考 [创建角色](https://intl.cloud.tencent.com/document/product/598/19381)）。
选择【腾讯云账户】作为角色载体创建一个角色，如 DevOpsRole，将角色载体设置为公司 B 的企业账号 “67890”，并为 DevOpsRole 角色附加上可操作公司 A 广州地域所有云服务器资源的权限。

2. 公司 A 为公司 B 子账号授权（参考 [为子账号赋予扮演角色策略](https://intl.cloud.tencent.com/document/product/598/19422)）。
