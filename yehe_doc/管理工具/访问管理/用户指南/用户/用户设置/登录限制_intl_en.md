...
5. Set temporary access request. This specifies whether sub-accounts are allowed to apply for temporary access when logging in to the console.[](id:tep)
...
6. Click **Apply Now**.[](id:step6)

![](https://main.qcloudimg.com/raw/76e5586eaee067e83c4fb76c31e39640.png)

#### Applying for temporary access from restricted IP
When a sub-account login hits the login IP restriction conditions, if [temporary access request](#tep) is allowed, the sub-account can apply for temporary access, and after the approver approves the request, they will get a two-hour access to the console.
...
3. The approver set in [Login Restrictions](#tep) will be able to approve or reject this request at the review link as shown below:
