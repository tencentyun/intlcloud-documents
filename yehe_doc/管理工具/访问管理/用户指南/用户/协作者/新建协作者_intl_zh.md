...
>?协作者和子用户都属于子账号，相关定义和权限说明请参考 [用户类型](https://intl.cloud.tencent.com/document/product/598/32633)。

## 前提条件
- 已 [创建管理员用户](https://intl.cloud.tencent.com/document/product/598/40985)。
- 已有可以作为协作者的腾讯云账号（若没有，请先 [注册腾讯云账号](https://intl.cloud.tencent.com/document/product/378/17985)）。
...
如果您想了解新创建的协作者账号如何登录腾讯云，请参阅 [子账号登录控制台-协作者登录](https://intl.cloud.tencent.com/document/product/598/38248)。
