## Overview
This document describes how to view collaborator information, such as user groups, message subscriptions, login protection, operation protection, MFA device status, and console access status, and how to search for collaborators by using keywords such as username, account ID, `SecretId`, mobile number, email, and remarks.
## Prerequisites
...
You can search for collaborators by using keywords such as username, account ID, `SecretId`, mobile phone, email, or remarks.
