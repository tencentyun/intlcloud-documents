...
- 主账号可以将 QcloudCamSummaryAccess 策略授权给需要的子账号，允许子账号查看控制台概览页的所有信息。授权方法请参考 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。
...
### 安全分析报告
安全分析报告模块提供了【下载报告】按钮，您可以单击该按钮获取当前主子账号的安全状态，以及基于 [最佳实践](https://intl.cloud.tencent.com/document/product/598/10592) 我们发现的风险点以及推荐方案。单次报告生成有效缓存期为4小时。
