...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ListCmqEnableRegion。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| EnableRegions | Array of [CmqRegionInfo](https://intl.cloud.tencent.com/document/api/1021/34209#CmqRegionInfo) | 云审计支持的cmq的可用区|
