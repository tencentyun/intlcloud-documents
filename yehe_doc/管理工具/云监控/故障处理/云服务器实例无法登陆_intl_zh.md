...
可请参考 [重置实例密码](https://intl.cloud.tencent.com/document/product/213/16566) 重置实例密码。
...
2. 参考 [云服务器带宽使用率过高](https://intl.cloud.tencent.com/document/product/248/36207)，查看实例的带宽使用情况和处理故障。
...
1. 通过 VNC 方式登录实例。
 - [使用 VNC 登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/32496)
 - [使用 VNC 登录 Linux 实例](https://intl.cloud.tencent.com/document/product/213/32494)
2. 参考 [云服务器 CPU 或内存占用过高](https://intl.cloud.tencent.com/document/product/248/36204)，在 “任务管理器” 中定位高负载的进程。

>导致云服务器 实例无法登录的故障原因有很多，其它原因需请参考云服务器 [无法登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/10339)  或 [无法登录 Linux 实例](https://intl.cloud.tencent.com/document/product/213/32500) 文档进行排查。
