...
>若业务量变大导致磁盘空间占满或文件无法删除，建议参考 [扩容云硬盘](https://intl.cloud.tencent.com/document/product/213/32377)进行扩容。 
...
2. Linux 操作系统根目录一般分区比较小，如果有定时性的小文件产生而又未及时清理，则很容易造成 inodes 占满。若 inodes 资源使用达到100%，需参考一下步骤解决此类问题。
i. 执行以下命令，查看文件最多的目录
  ```plaintext
