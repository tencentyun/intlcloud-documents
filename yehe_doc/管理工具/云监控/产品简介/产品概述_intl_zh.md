...
云监控为用户提供了统一监控 [云服务器](https://intl.cloud.tencent.com/product/cvm)、云数据库 等所有云产品的平台。您可以通过使用云监控全面了解云产品资源使用率、应用程序性能和云产品运行状况，云监控还支持多指标监控、自定义告警、跨地域和跨项目实例分组、自定义监控可视化 Dashboard 等功能。帮助您及时掌控及处理云产品出现的突发情况，从而增加您系统的稳定性，提升运维效率，减少运维成本。

云监控服务主要用于采集并获取腾讯云产品各种途径的监控指标数据，通过可视化图表展示，帮助您了解云产品运行状况和性能。并可根据您设置的告警规则，通过消息推送的方式帮助您第一时间了解业务异常。让您无需额外开发，即可全面掌控云产品资源使用、运行情况。您可以前往 [云监控控制台](https://console.cloud.tencent.com/monitor/overview)、[云监控 API](https://intl.cloud.tencent.com/document/product/248/33873) 或 [腾讯云 CLI](https://intl.cloud.tencent.com/document/product/1013) 了解云监控，获取相关监控数据。
...
- 云数据库
	...
	- [游戏数据库 TcaplusDB](https://intl.cloud.tencent.com/document/product/1016)
	- [数据订阅](https://intl.cloud.tencent.com/document/product/571/8774)
