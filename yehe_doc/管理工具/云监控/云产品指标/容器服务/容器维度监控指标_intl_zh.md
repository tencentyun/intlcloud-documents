...
| Instances.N.Dimensions.2.Value | namespace   | 具体的空间名称，请使用 [Kunbernetes API](https://kubernetes.io/zh/docs/concepts/overview/kubernetes-api/) 查询具体的 namespace | 输入命名空间具体名称，例如：default           |
...
| Instances.N.Dimensions.4.Value | containerId | 具体的实例名称，查询 服务实例列表接口 中返回的 containerId（容器 ID）字段。注意：容器 ID 只取开头12位即可 | 输入实例具体名称，例如：01c5509d2b39          |
