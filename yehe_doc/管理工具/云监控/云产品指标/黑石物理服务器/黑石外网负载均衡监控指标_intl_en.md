...
> - You can query the monitoring metrics of BM public network CLB from multiple dimensions. For more information, see [Input Parameters](#.E5.85.A5.E5.8F.82.E8.AF.B4.E6.98.8E).
...
To query the monitoring data of the BM public network CLB instance, set the input parameters as follows:

BM public network CLB allows you to obtain the monitoring data at the following four levels:
