...
| Instances.N.Dimensions.0.Value | instanceId | CPM instance ID | Enter a specific instance ID, such as cpm-test, which can be obtained by calling DescribeDevices. |

## Input Parameters

To query the monitoring data of the CPM instance, set the input parameters as follows:
