...
> - You can query the monitoring metrics of a BM private network CLB instance in multiple dimensions. For more information, see [Input Parameters](#.E5.85.A5.E5.8F.82.E8.AF.B4.E6.98.8E).
...
| Instances.N.Dimensions.1.Value | protocol | Protocol | Enter a specific protocol value, such as tcp. Options: tcp, udp, http, and https |
