...
| ---------------------------------- | -------------------------- | -------------------------------------------------------- | ------------------------------------ | ------- | ----------- | ------------------ |
| Status | Cluster health | Latest status of the ES cluster in the statistical period | Valid cluster health states: 0: green, 1: yellow, 2: red | - | uInstanceId | 60 secs and 300 secs |
...
| IndexDocs | Total number of documents | Average number of total documents in the ES cluster in the statistical period | Total number of documents in the ES cluster | Count | uInstanceId | 60 secs and 300 secs |
