...
| Instances.N.Dimensions.1.Value | vpcId            | 负载均衡所在私有网络的具体 ID | 输入私有网络具体 ID，例如：1111。需输入数值型 vpcId ，可参考 [根据证书ID查询负载均衡](https://intl.cloud.tencent.com/document/product/214/33800) 文档获取 NumericalvpcId |
