...
| 指标英文名    | 指标中文名         | 单位    | 统计周期     |
| ------------- | ------------------ | ------- | ------------ |
| AccOuttraffic | 外网出流量         | MB      | 10、60、300、3600 |
| ClbHttp3xx    | CLB 返回的3xx状态码 | 个/分钟 | 60、300、3600      |
| ClbHttp404    | CLB 返回的404状态码 | 个/分钟 | 60、300、3600      |
| ClbHttp4xx    | CLB 返回的4xx状态码 | 个/分钟 | 60、300、3600      |
| ClbHttp502    | CLB 返回的502状态码 | 个/分钟 | 60、300、3600      |
| ClbHttp5xx    | CLB 返回的5xx状态码 | 个/分钟 | 60、300、3600      |
| ConNum        | 当前连接数         | 个      | 60、300、3600      |
| Http2xx       | 2xx状态码         | 个/分钟 | 60、300、3600      |
| Http3xx       | 3xx状态码         | 个/分钟 | 60、300、3600      |
| Http404       | 404状态码          | 个/分钟 | 60、300、3600      |
| Http4xx       | 4xx状态码          | 个/分钟 | 60、300、3600      |
| Http502       | 502状态码          | 个/分钟 | 60、300、3600      |
| Http5xx       | 5xx状态码          | 个/分钟 | 60、300、3600      |
| InactiveConn  | 非活跃连接数       | 个      | 60、300、3600      |
| InPkg         | 公网入包量         | 个/秒   | 10、60、300、3600  |
| InTraffic     | 公网入带宽         | Mbps    | 10、60、300、3600  |
| NewConn       | 新建连接数         | 个/秒   | 60、300、3600      |
| OutPkg        | 公网出包量         | 个/秒   | 10、60、300、3600  |
| OutTraffic    | 公网出带宽         | Mbps    | 10、60、300、3600  |
| ReqAvg        | 平均请求时间       | 毫秒    | 60、300、3600      |
| ReqMax        | 最大请求时间       | 毫秒    | 60、300、3600      |
| RspAvg        | 平均响应时间       | 毫秒    | 60、300、3600      |
| RspMax        | 最大响应时间       | 毫秒    | 60、300、3600      |
| RspTimeout    | 响应超时个数       | 个/分钟 | 60、300、3600      |
| SuccReq       | 每分钟成功请求数   | 个/分钟 | 60、300、3600      |
| TotalReq      | 每秒请求数         | 个      | 60、300、3600      |
