...
| 指标英文名          | 指标中文名          | 单位    | 统计周期       |
| ------------------- | ------------------- | ------- | -------------- |
| ClbHttp3xx          | CLB 返回的3xx状态码 | 个/分钟 | 60、300、3600、86400 |
| ClbHttp404          | CLB 返回的404状态码 | 个/分钟 | 60、300、3600、86400 |
| ClbHttp4xx          | CLB 返回的4xx状态码 | 个/分钟 | 60、300、3600、86400 |
| ClbHttp502          | CLB 返回的502状态码 | 个/分钟 | 60、300、3600、86400 |
| ClbHttp5xx          | CLB 返回的5xx状态码 | 个/分钟 | 60、300、3600、86400 |
| ConNum              | 活跃连接数          | 个      | 60、300、3600、86400 |
| HttpCode2XX         | 2xx状态码          | 个/分钟 | 60、300、3600、86400 |
| HttpCode3XX         | 3xx状态码          | 个/分钟 | 60、300、3600、86400 |
...
| ResponseTimeAverage | 平均响应时间        | 毫秒    | 60、300、3600、86400 |
| ResponseTimeMax     | 最大响应时间        | 毫秒    | 60、300、3600、86400 |
