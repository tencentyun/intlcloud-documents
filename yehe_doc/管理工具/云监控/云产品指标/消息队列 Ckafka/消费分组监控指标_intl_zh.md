...
| ------------------------ | ------------------- | ------------------------------------------- | ---- | ----------------------------------------------------- |
| CgroupMaxOffset          | 当前分区最大 offset | 消费分组对应 partition 的最大 offset        | 条   | consumerGroup,instanceId,topicId, partition,topicName |
| CtopicMsgOffset          | 当前消费 offset     | 消费分组对应 partition 当前消费 offset      | 条   | consumerGroup,instanceId,topicId, partition,topicName |
| CtopicUnconsumeMsgCount  | 未消费的消息条数    | 消费分组对应 partition 未被消费消息条数     | 条   | consumerGroup,instanceId,topicId, partition,topicName |
| CtopicUnconsumeMsgOffset | 未消费消息 offset    | 消费分组对应 partition 未被消费的消息总大小 | MB   | consumerGroup,instanceId,topicId, partition,topicName |
