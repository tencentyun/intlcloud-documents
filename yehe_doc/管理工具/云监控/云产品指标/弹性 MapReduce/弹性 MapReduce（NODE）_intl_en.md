...
| NodeCpuNice          | CPU utilization_nice    | %       | Percentage of CPU utilization under nice priority       | id4nodecpu, <br/>host4nodecpu |
...
| NodeCpuSystem        | CPU utilization_system  | %       | CPU utilization in kernel state              | id4nodecpu, <br/>host4nodecpu |
| NodeCpuUser          | CPU utilization_user    | %       | CPU utilization in user state              | id4nodecpu, <br/>host4nodecpu |
...
| NodeCpuCountCpuCount | Number of cores\_cpu_count    | -      | Number of CPU cores                       | id4nodecpu, <br/>host4nodecpu |
...
| NodeMemCached                      | Memory usage_Cached              | GB   | Total memory size used by file cache           | host4nodememory, <br/>id4nodememory |
| NodeMemSwapcached                  | Memory usage_SwapCached          | GB   | Total swap memory size by anonymous page writes       | host4nodememory, <br/>id4nodememory |
...
| NodeMemDirty                       | Memory usage_Dirty               | GB   | Total memory size to write to disk         | host4nodememory, <br/>id4nodememory |
| NodeMemWriteback                   | Memory usage_Writeback           | GB   | Total memory size being written back to disk       | host4nodememory, <br/>id4nodememory |
...
| NodeMemPercen<br>tAvailablePercent | Percentage of used memory\_available\_percent | %    | Percentage of available memory size out of total memory         | host4nodememory, <br/>id4nodememory |
| NodeMemPercent<br>UsedPercent      | Percentage of used memory\_used\_percent      | %    | Percentage of used memory size out of total memory       | host4nodememory, <br/>id4nodememory |
...
| NodeNetworkTcpListen<br>ExtListenoverflows    | TCPLISTEN<br>Exceptions_ListenOverflows        | Occurrences/s     | Number of occurrences where the upper limit of the Accept queue is exceeded after the last step of three-way handshake is completed          | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpAbort<br>Tcpabortontimeout      | TCP connection exception Abort_TCPAbort<br>OnTimeout  | Connections/s     | Number of connection closed because the attempts of retransmissions of various timers (RTO/PTO/keepalive) exceed the upper limit | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcpAbort<br>Tcpabortondata         | TCP connection exception Abort_TCPAbort<br>OnData     | Sockets/s     | Number of sockets closed due to unknown data received                          | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpAbort<br>Tcpabortonlinger       | TCP connection exception Abort_TCPAbort<br>OnLinger   | Connections/s     | Number of connections suspended in lingering state after being closed                           | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcpAbort<br>Tcpabortfailed         | TCP connection exception Abort_TCPAbortFailed         | Connections/s     | Number of failed attempts to close connection                                       | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpPacketRate<br>Retranssegsrate   | TCP retransmission rate<br/>_RetransSegsRate           | %        | Retransmission rate at TCP layer                                                 | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpTimeWaitTw                      | TCPTIME-WAIT_TW                           | Sockets/s     | Number of sockets ending TIME_WAIT state after normal timeout              | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>TimeWaitTwkilled            | TCPTIME-WAIT_TWKilled                     | Sockets/s     | Number of sockets ending TIME_WAIT state through tcp_tw_recycle mechanism    | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcpTime<br>WaitTwrecycled          | TCPTIME-WAIT_TWRecycled                   | Sockets/s     | Number of sockets ending TIME_WAIT state through tcp_tw_reuse mechanism      | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpRtoStat<br>Tcpspuriousrtos      | TCPRTO_TCPSpur<br/>iousRTOs               | Timeouts/s     | Number of spurious timeouts detected through F-RTO mechanism                            | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcpRetrans<br>Tcpslowstartretrans  | TCP retransmissions<br/>_TCPSlowStart<br>Retrans     | Retransmissions/s     | Number of SKB retransmissions with successful slow start                                      | host4nodenetwork, <br/>id4nodenetwork |
...
| NodeNetworkTcp<br>SocketTcpInuse              | TCP sockets<br/>\_TCP_inuse                | -       | Number of TCP sockets in use (listening)                          | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>SocketTcpOrphan             | TCP sockets<br/>\_TCP_orphan                | -       | Number of TCP connections waiting to be closed                                        | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetwork<br>TcpSocketTcpTw                 | TCP sockets<br/>\_TCP_tw                   | -       | Number of TCP sockets to be destroyed                                       | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>SocketSocketsUsed           | TCP sockets<br/>\_sockets_used             | -       | Number of users using TCP sockets                                       | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>SocketTcpAlloc              | TCP sockets<br/>\_TCP_alloc                | -       | Number of TCP sockets allocated (established, sk_buff obtained)          | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateEstablished  | TCP connection status<br/>_ESTABLISHED             | -       | Number of TCP connections in Established state                              | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateSynSent      | TCP connection status<br/>_SYN-SENT                | -       | Number of TCP connections in SYN-SENT state                                 | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateSynRecv      | TCP connection status<br/>\_SYN-RECV               | -       | Number of TCP connections in SYN-RECV state                                 | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateClose        | TCP connection status<br/>\_CLOSE                  | -       | Number of TCP connections in CLOSE state                                    | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateCloseWait    | TCP connection status<br/>\_CLOSE-WAIT             | -       | Number of TCP connections in CLOSE-WAIT state                               | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateListen       | TCP connection status<br/>\_LISTEN                 | -       | Number of TCP connections in LISTEN state                                   | host4nodenetwork, <br/>id4nodenetwork |
| NodeNetworkTcp<br>ConnectionStateClosing      | TCP connection status<br/>\_CLOSING                | -       | Number of TCP connections in CLOSING state                                 | host4nodenetwork, <br/>id4nodenetwork |

### Server - Filehandle 

| Parameter | Metric Name | Unit | Description | Dimension |
| --------------------- | ------------------ | ---- | ------------------ | ------------------------------------------- |
| NodeFdFilefdAllocated | File handles_allocated | -   | Number of allocated file handles | host4nodefilehandle, <br>id4nodefilehandle  |
| NodeFdFilefdMaximum   | File handles_maximum   | -   | Maximum number of file handles   | host4nodefilehandle, <br/>id4nodefilehandle |
...
| NodeSwitchesContext<br>SwitchesTotal | System context switch\_context_switches_total | Switches/s    | Number of system context switches | host4nodeprocess, <br/>id4nodeprocess |
...
| ------------------------------ | ------------------- | ----------------------------- | -------------------------------------------- |
| Instances.N.Dimensions.0.Name  | id4nodecpu          | Dimension name of EMR instance ID        | String-type dimension name, such as id4nodecpu         |
| Instances.N.Dimensions.0.Value | id4nodecpu          | Specific EMR instance ID               | Specific instance ID, such as emr-abcdef88          |
| Instances.N.Dimensions.1.Name  | host4nodecpu        | Dimension name of node IP in EMR instance  | String-type dimension name, such as host4nodecpu        |
| Instances.N.Dimensions.1.Name  | host4nodecpu        | Specific node IP in EMR instance         | Specific node IP, such as 1.1.1.1              |
| Instances.N.Dimensions.0.Name  | id4nodememory       | Dimension name of EMR instance ID       | String-type dimension name, such as id4nodememory      |
| Instances.N.Dimensions.0.Value | id4nodememory       | Specific EMR instance ID              | Specific instance ID, such as emr-abcdef88         |
| Instances.N.Dimensions.1.Name  | host4nodememory     | Dimension name of node IP in EMR instance | String-type dimension name, such as host4nodememory     |
| Instances.N.Dimensions.1.Name  | host4nodememory     | Specific node IP in EMR instance        | Specific node IP, such as 1.1.1.1             |
| Instances.N.Dimensions.0.Name  | id4nodenetwork      | Dimension name of EMR instance ID       | String-type dimension name, such as id4nodenetwork    |
| Instances.N.Dimensions.0.Value | id4nodenetwork      | Specific EMR instance ID              | Specific instance ID, such as emr-abcdef88          |
| Instances.N.Dimensions.1.Name  | host4nodenetwork    | Dimension name of node IP in EMR instance  | String-type dimension name, such as host4nodenetwork    |
| Instances.N.Dimensions.1.Name  | host4nodenetwork    | Specific node IP in EMR instance         | Specific node IP, such as 1.1.1.1             |
| Instances.N.Dimensions.0.Name  | id4nodefilehandle   | Dimension name of EMR instance ID        | String-type dimension name, such as id4nodefilehandle  |
| Instances.N.Dimensions.0.Value | id4nodefilehandle   | Specific EMR instance ID               | Specific instance ID, such as emr-abcdef88         |
| Instances.N.Dimensions.1.Name  | host4nodefilehandle | Dimension name of node IP in EMR instance  | String-type dimension name, such as host4nodefilehandle |
| Instances.N.Dimensions.1.Name  | host4nodefilehandle | Specific node IP in EMR instance         | Specific node IP, such as 1.1.1.1             |
| Instances.N.Dimensions.0.Name  | id4nodeprocess      | Dimension name of EMR instance ID        | String-type dimension name, such as id4nodeprocess    |
| Instances.N.Dimensions.0.Value | id4nodeprocess      | Specific EMR instance ID               | Specific instance ID, such as emr-abcdef88         |
| Instances.N.Dimensions.1.Name  | host4nodeprocess    | Dimension name of node IP in EMR instance  | String-type dimension name, such as host4nodeprocess    |
| Instances.N.Dimensions.1.Name  | host4nodeprocess    | Specific node IP in EMR instance         | Specific node IP, such as 1.1.1.1             |

## Input Parameter Description

EMR (Node) supports querying monitoring data based on the following five combinations of dimensions. The values for input parameters are as follows: 
