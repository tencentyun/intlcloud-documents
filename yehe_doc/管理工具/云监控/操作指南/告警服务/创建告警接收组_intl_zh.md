...
5. 单击【新增接收组】，系统将打开新页面至访问管理控制台的用户组模块。新建用户组详细步骤请参见 [用户组管理](https://intl.cloud.tencent.com/document/product/598/10599) 文档。新建用户详细步骤请参见 [自定义创建子用户](https://intl.cloud.tencent.com/document/product/598/13674) 文档。
...
目前的告警接收方式支持邮件、短信和微信。您可在 [访问管理控制台](https://console.cloud.tencent.com/cam) 修改用户的手机、邮箱和微信信息，以决定用户可以使用哪种方式接收到告警信息，修改用户信息，您可参见 [自定义创建子用户](https://intl.cloud.tencent.com/document/product/598/13674) 文档。
告警策略启用微信接收告警。
