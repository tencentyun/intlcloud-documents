...
2. 在图表下方编辑指标信息和图表右侧定义图表名，编辑完后单击右上角的【保存】即可。详情请参见新建图表相关文档  [步骤1：新建指标](https://intl.cloud.tencent.com/document/product/248/38477)。
...
> ?如需了解更多 Dashboard 设置，请参见 [Dashboard](https://intl.cloud.tencent.com/document/product/248/38461) 操作指南。
