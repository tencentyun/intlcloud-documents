...
- Size: The size of a source file cannot be larger than 20 MB, its width and height cannot exceed 30000 pixels, and the total number of pixels cannot exceed 100 million. The width and height of the destination image cannot exceed 9999 pixels. For a source animated image, Width x Height x Number of frames cannot exceed 100 million pixels.
