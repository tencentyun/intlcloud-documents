...
To use Image Advanced Compression, you need to enable it on the bucket configuration page first. Once it is enabled, you can call the [Image Advanced Compression APIs](https://cloud.tencent.com/document/product/460/43680) to compress images in the bucket into TPG/HEIF upon the download.
...
3.  Click **Image Processing**, select the **Image Advanced Compression** tab, and find the **Image Advanced Compression** area. Then, click **Edit**, set **Status** to **Enabled**, and click **Save**.
