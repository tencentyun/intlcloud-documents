...
## 开启内网访问后无法访问
您可以直接在容器服务控制台上 [开启内网访问](https://intl.cloud.tencent.com/document/product/457/30639)。如果开启内网访问之后仍出现无法访问的情况，建议您对应集群类型进行如下检查：
...
## 开启公网访问后无法访问
您可以直接在容器服务控制台上 [开启公网访问](https://intl.cloud.tencent.com/document/product/457/30639)。如果开启公网访问之后仍出现无法访问的情况，建议您对应集群类型进行如下检查：
...
- 参考查看节点安全组配置检查集群中 Master 节点的安全组是否正确放通30000 - 32768端口区间。
- 检查集群中 Master 节点的安全组是否正确放通 Master 节点所在的 VPC 网段或 VPC 子网网段。
