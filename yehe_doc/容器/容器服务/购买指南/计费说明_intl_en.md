...
>! TKE is a Kubernetes-based declarative service. If you have created IaaS resources such as CLB and CBS in TKE and no longer need to use them, please delete the corresponding service resources in the TKE Console. If you only delete the service resources in the specific service Console, TKE will recreate them and fees will continue to be incurred. For example, if you have created CLB resources in TKE, and have deleted the CLB instance in the CLB Console, TKE will recreate the CLB instance based on the declarative API.
