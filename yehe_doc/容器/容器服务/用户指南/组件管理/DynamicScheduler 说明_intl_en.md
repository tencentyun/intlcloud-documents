...
#### Aggregation rule configuration[](id:Prometheus1)
...
2. Create a cloud native monitoring RPOM instance under the same VPC as the target cluster, and associate it with the user cluster, as shown in the figure below:
...
4. Set the Prometheus aggregation rules. The rule content is the same as the aggregation rules configured in [Self-built Prometheus monitoring services](#rules), as shown in the figure below.
