...
2. 单击需要创建 Deployment 的集群 ID，进入待创建 Deployment 的集群管理页面。
...
![更新YAML](https://main.qcloudimg.com/raw/93c576f09ad8817abb794385f68b38ad.png)

#### 更新 Pod 配置

1. 在集群管理页面，单击需要更新 Pod 配置的 Deployment 的集群 ID，进入待更新 Pod 配置的 Deployment 的集群管理页面。
2. 在需要更新 Pod 配置的 Deployment 行中，单击【更新Pod配置】。
...
3. 在需要调整 Pod 数量的 Deployment 行中，单击【更新Pod数量】，进入更新 Pod 数量页面。
