...
**使用示例：**
使用方式详情见 [Service Local 模式](https://intl.cloud.tencent.com/document/product/457/36836#service-local-.E6.A8.A1.E5.BC.8F)。
...
指定标签设置负载均衡后端绑定的节点。
**使用示例：**
使用方式详情见 [指定接入层后端](https://intl.cloud.tencent.com/document/product/457/36836#.E6.8C.87.E5.AE.9A.E6.8E.A5.E5.85.A5.E5.B1.82.E5.90.8E.E7.AB.AF)。
