...
### Full RegEx
Full RegEx is often used to process structured logs. It parses a full log by extracting multiple key-value pairs based on a regex. For more information, see [Full RegEx](https://intl.cloud.tencent.com/document/product/614/32283).
Assume that the raw data of a log is as follows:
```
