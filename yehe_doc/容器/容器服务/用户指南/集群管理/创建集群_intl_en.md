...
<dx-alert infotype="explain">In the self-deployed mode, you can refer to the Worker configuration for the configuration settings of the Masters model. At least three Master models should be deployed. Cross-AZ deployment is supported.
</dx-alert>

:::
::: Existing\snodes [](id:UseExistingCVMCreateCluster)
