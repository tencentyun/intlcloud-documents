...
Main parameters are described as follows:
	...
	- **Subnet of CFS**: set the subnet range that can be used by CFS in the current availability zone based on your needs.
...
>- No PersistVolume is specified. For more information, see [Viewing the rules for binding PVs and PVCs](https://intl.cloud.tencent.com/document/product/457/37770).
