...
| Tencent Cloud Object Storage (COS) | COS is a distributed storage service provided by Tencent Cloud for massive file storage. You can use COS to upload, download, and manage files in different formats. | Create  PVs and PVCs, and then mount static volumes to workloads. For more information, see [Using COS](https://intl.cloud.tencent.com/document/product/457/36160). |
