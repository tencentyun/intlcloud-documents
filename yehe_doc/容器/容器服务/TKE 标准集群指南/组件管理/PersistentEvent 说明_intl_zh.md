...
该组件目前已不再维护，若需要使用事件存储能力，请参考 [事件存储](https://intl.cloud.tencent.com/document/product/457/30686) 文档。
</dx-alert>
...
主要参数信息如下：
 - **存储端选择**：您可以选择将事件存储到【[Elasticsearch](https://intl.cloud.tencent.com/document/product/845/16478)】或【[日志服务 CLS](https://intl.cloud.tencent.com/document/product/614/11254)】。
 - **参数详情**：
