...
```
3. [配置 TCR 私有 Helm 仓库](https://intl.cloud.tencent.com/document/product/1051/35493)。
...
1. 通过 TKE 控制台或 API [获取可用公网或内网访问的 Kubeconfig](https://intl.cloud.tencent.com/document/product/457/30639)。
2. 连接目标集群可参考以下两种方式：
