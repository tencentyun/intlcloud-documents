...
### 采集日志步骤
1. 为目标集群 [安装 Nginx-ingress](https://intl.cloud.tencent.com/document/product/457/38981) 组件。
...
如果需要自定义日志采集规则和索引，请参考 [NginxIngress 自定义日志](https://intl.cloud.tencent.com/document/product/457/49396)。
