...
>- 通过 [容器服务控制台](https://console.cloud.tencent.com/tke2) 设置容器运行命令和参数的示例请参考 [Command 和 Args](https://intl.cloud.tencent.com/document/product/457/9883#command-.E5.92.8C-args)。 
