...
## 前提条件
- 如需使用边缘容器服务，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请。
...
## 后续操作
请前往 [节点管理](https://intl.cloud.tencent.com/document/product/457/35386)，向已创建的边缘集群中添加节点。
