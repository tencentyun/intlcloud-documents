...
如果当平台发现当前工作负载的 Request 设置过于不合理时，会出现红色感叹号的提示，提醒用户需要手动调整 Request

对于配置很不合理的 Request，当鼠标悬浮到红色感叹号的提示图标上后，可以单击查看推荐的 Request，以及比较现有 Request 和推荐 Request 之间的差距：
...
在开启 Request 智能推荐后，支持用户后台通过 Kubectl 参看工作负载 Request 智能推荐值，配置 Kubectl 可以请参见 [连接集群](https://intl.cloud.tencent.com/document/product/457/30639)。
