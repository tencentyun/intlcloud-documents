...
更多关于 Velero 介绍，请参见 [Velero](https://velero.io/) 官网文档。本文将介绍如何使用腾讯云 [对象存储 COS](https://intl.cloud.tencent.com/document/product/436) 作为 Velero 后端存储实现集群备份和还原。
...
- 已创建 v1.10 或以上版本的 Kubernetes 集群，集群可正常使用 DNS 和 互联网服务，详情请参见 [创建集群](https://intl.cloud.tencent.com/document/product/457/30637)。
...
1. 在 [对象存储控制台](https://console.cloud.tencent.com/cos5) 为 Velero 创建一个对象存储桶用于存储备份，详情请参见 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309)。
2. 为存储桶 [设置访问权限](https://intl.cloud.tencent.com/document/product/436/13315)。对象存储 COS 支持设置两种权限类型：
