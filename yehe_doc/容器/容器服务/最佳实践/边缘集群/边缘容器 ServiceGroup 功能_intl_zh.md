...
目前，已有 [常规方案](#step1) 应对上述问题，但是仍有痛点无法解决。为此，[边缘容器服务](https://intl.cloud.tencent.com/document/product/457/35390)（简称 TKE Edge）提供 ServiceGroup 特性，只需两个 yaml 文件即可轻松实现上百地域的服务部署，且无需进行应用适配或改造。
