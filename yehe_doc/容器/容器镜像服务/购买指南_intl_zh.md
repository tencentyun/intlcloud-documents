## 购买说明
腾讯云容器镜像服务 TCR 企业版已正式启动商业化售卖，新建或使用已有的实例将产生费用，目前仅支持后付费购买。您可前往 [容器镜像服务控制台](https://console.cloud.tencent.com/tcr) 创建企业版实例并开始使用。在使用过程中，将同时使用腾讯云对象存储产品 COS，并根据您的实际使用情况产生相应费用。
...
<span id="price"></span>
## 企业版定价
当前企业版服务仅支持后付费模式，按小时进行计费，购买折扣信息请关注购买页最新报价或咨询销售人员。
<table>
<tbody>
<tr>
<th colspan="2">地域</th><th>基础版（美元/小时）</th><th>标准版（美元/小时）</th><th>高级版（美元/小时）</th>
</tr>
<tr><td rowspan="2">中国地域</td><td>广州、上海、南京、北京、成都、重庆</td><td>0.14</td><td>0.28</td><td>0.54</td></tr>
...
按月使用参考价格
>! 仅用于换算参考，实际以按量计费账单累计金额为准，且非预付费功能上线后实际价格。
<table>
<tbody>
<tr>
