...
<tr><td>Added support for querying audit logs.</td><td>The reading/writing operation records of resources such as instances, namespaces, and image repositories in TCR Enterprise Edition have been connected to Tencent CloudAudit. You can go to the **Event History** in CloudAudit console to view the related operation records.</td><td>-</td></tr>
</table>
