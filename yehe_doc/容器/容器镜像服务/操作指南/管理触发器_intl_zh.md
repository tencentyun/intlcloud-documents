...
- 已成功 [购买 TCR 企业版实例](https://intl.cloud.tencent.com/document/product/1051/35486)。
...
![](https://main.qcloudimg.com/raw/70e694eb396edf97d548fd300307bb81.png)
 ...
 - **触发规则**：
    ...
    - **仓库名称**：触发器生效的仓库名称，支持对镜像仓库及 Helm Chart 仓库进行 [正则匹配](#RE)。
    - **版本Tag**：触发器生效的 Tag，支持 [正则匹配](#RE)。如需所有版本均可触发，可不填写。
