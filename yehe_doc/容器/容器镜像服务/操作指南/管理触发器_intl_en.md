...
![](https://main.qcloudimg.com/raw/70e694eb396edf97d548fd300307bb81.png)
 ...
 - **Trigger Rule**:
    ...
    - **Namespace**: the namespace for which the trigger takes effect. If the list is empty, first [create namespaces](https://intl.cloud.tencent.com/document/product/1051/35487) in the instance.
...
- **Modify Rule Status**: <img src="https://main.qcloudimg.com/raw/d31873587cb976e1429768b2dc2b0e16.png" style="margin:-6px 0px"> indicates that the rule is enabled, and <img src="https://main.qcloudimg.com/raw/5ba06490364505efc4d698e3adb1064e.png" style="margin:-6px 0px"> indicates that the rule is disabled. A newly created trigger rule is enabled by default, and you can change its status as needed.
