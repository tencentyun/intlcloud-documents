...
![](https://main.qcloudimg.com/raw/6de531925e0b97e02961059d703279c8.png)
 ...
 - **Sync source**:
    ...
    - **Repository Name**: synchronized repository. You can use a regular expression to filter repositories. If this parameter is not specified, all repositories in the namespace are selected by default.
