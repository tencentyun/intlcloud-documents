...
- 已在云上容器集群所在地域或邻近地域成功 [创建企业版实例](https://intl.cloud.tencent.com/document/product/1051/35486)。
- 如果使用子账号进行操作，请参考 [企业版授权方案示例](https://intl.cloud.tencent.com/document/product/1051/37248) 提前为子账号授予对应实例的容器镜像，Helm Chart 推送权限，建议授予配置同步的子账号以容器镜像服务全读写权限。
...
>!同步操作无法在企业版实例侧自动创建命名空间，请参考 [创建命名空间](https://intl.cloud.tencent.com/document/product/1051/35487) 创建对应的命名空间。	
>
