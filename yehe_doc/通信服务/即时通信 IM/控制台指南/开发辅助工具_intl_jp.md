...
2. 左側ナビゲーションバーで**補助ツールの開発**>**オフラインプッシュチェック**を選択します。
3. **オフラインプッシュ問題特定ツール**エリアで、UserIDを入力します。
4. **デバイス情報の取得**をクリックし、このUserIDがこれまでに報告した証明書ID、デバイスTokenなどの情報を表示します。
...
1. [IMコンソール](https://console.cloud.tencent.com/im)にログインし、対象のアプリケーションカードをクリックします。
2. 左側ナビゲーションバーで**補助ツールの開発**>**UserSigツール**を選択します。
