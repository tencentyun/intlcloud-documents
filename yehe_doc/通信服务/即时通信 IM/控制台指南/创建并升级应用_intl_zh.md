...
## 升级应用
>?应用使用套餐包从体验版升级至专业版或旗舰版，不支持退回至体验版。当应用出现欠费、退费导致停服后，如需继续使用原应用，您可以 [续费]专业版或旗舰版套餐包。如果您想重新使用体验版，请 [创建新的应用](https://intl.cloud.tencent.com/document/product/1047/34577)。


1. 单击目标应用卡片区域的**升级**，进入即时通信 IM 套餐包购买页。
2. 根据实际需求设置以下参数：
  <table>
     <tr>
         <th>参数项</th>  
