...
<td> SDK 5.0.106 release (Android & iOS simplified edition)</td>
...
<td> SDK 5.0.102 release (Android & iOS simplified edition)</td>
<td><ul style="margin:0">
    <li>Released the Android & iOS simplified edition SDK.</li>
    <li>Compared with the standard edition SDK, the simplified edition SDK removed the friend and conversation capabilities and optimized some service logic to ensure higher execution efficiency and a smaller installation package size.</li>
</ul></td>
<td> 2020-09-04 </td>
