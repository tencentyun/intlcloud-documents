...
体验版最多只能创建100个帐号，如如您需要在正式环境中使用，您需要为每一个SDKAppID分别配置套餐包。另外，体验版中的帐号支持删除，您可以调用 [帐号删除接口](https://intl.cloud.tencent.com/document/product/1047/34955) 删除不再使用的帐号，**删除后该用户的数据将无法恢复**，请谨慎处理。
