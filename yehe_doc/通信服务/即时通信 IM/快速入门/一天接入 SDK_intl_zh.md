...
- 如果您想直接使用 SDK 的接口实现完全自定义界面，请参见 [常规集成 SDK（无 UI 库）](https://intl.cloud.tencent.com/document/product/1047/34306)。
...
## 步骤4：集成视频通话（可选）
即时通信 IM 服务可以快速集成 [实时音视频 TRTC 服务](https://intl.cloud.tencent.com/document/product/647/35076)，用于实现 IM 应用中的用户视频通话、群聊视频会议等业务。目前仅 iOS 端支持该功能。
