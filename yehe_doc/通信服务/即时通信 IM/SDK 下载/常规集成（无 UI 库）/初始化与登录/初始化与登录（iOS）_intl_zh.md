## 初始化
类 [V2TIMManager](http://doc.qcloudtrtc.com/im/interfaceV2TIMManager.html) 是 IM SDK 主核心类也是 IM SDK 的入口类，负责 IM SDK 的初始化、登录、消息收发，建群退群等功能。调用 [initSDK](http://doc.qcloudtrtc.com/im/interfaceV2TIMManager.html#a8035eed3a7c9b3b1c229196ac7bc5da6) 接口即可完成初始化：
...
### SDKConfig
参数 `V2TIMSDKConfig` 用于对 SDK 进行初始化配置，其中较常用的是对日志级别的设置，即 [logLevel](http://doc.qcloudtrtc.com/im/interfaceV2TIMSDKConfig.html) 参数，日志级别如下表所示：
...
### 事件监听器
[V2TIMSDKListener](http://doc.qcloudtrtc.com/im/protocolV2TIMSDKListener-p.html) 提供了网络状态以及用户信息变更的监听：
...
## 登出
登出比较简单，使用 [logout()](http://doc.qcloudtrtc.com/im/interfaceV2TIMManager.html#a20b495d7f7a231ea33507ca4a79f811f) 函数即可。
