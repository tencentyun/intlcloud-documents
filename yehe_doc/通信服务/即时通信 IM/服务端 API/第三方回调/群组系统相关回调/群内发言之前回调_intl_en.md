...
The user is allowed to send group messages, and the content of the sent message is not modified.
...
The user is not allowed to send group messages. In this case, the message is not sent, but a success message will be returned to the caller to pretend that the message has been sent.
