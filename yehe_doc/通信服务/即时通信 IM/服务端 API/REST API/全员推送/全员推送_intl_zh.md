...
| MsgBody | Object |必填 | 消息内容，具体格式请参考MsgBody 消息内容说明（一条消息可包括多种消息元素，所以 MsgBody 为 Array 类型）  |
...
| MsgContent | Object |必填 | 对于每种 MsgType，用不同的 MsgContent 格式，具体可参考 [TIMMsgElement 对象](https://intl.cloud.tencent.com/document/product/1047/33527) 的定义   |
