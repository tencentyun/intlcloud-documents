## 功能说明
管理员给用户设置属性。每次最多只能给100个用户设置属性。使用前请先 [设置应用属性名称](https://intl.cloud.tencent.com/document/product/1047/37167) 。
...
### 请求 URL 示例
```
https://console.tim.qq.com/v4/all_member_push/im_set_attr?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 请求参数说明
...
## 接口调试工具
通过 [REST API 在线调试](https://29294-22989-29805-29810.cdn-go.cn/api-test.html#v4/all_member_push/im_set_attr) 工具调试本接口。
