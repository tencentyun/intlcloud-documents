...
### 请求 URL 示例
```
https://console.tim.qq.com/v4/all_member_push/im_get_attr_name?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
...
## 接口调试工具
通过 [REST API 在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/all_member_push/im_get_attr_name) 工具调试本接口。
