...
| MsgBody | Object | Required | The message body. For more information on the message format, see [Message Formats](https://intl.cloud.tencent.com/document/product/1047/33527). Note that `MsgBody` is an array that can contain multiple message elements. |
