## 功能说明
获取用户属性（必须以管理员帐号调用）；每次最多只能获取100个用户的属性。使用前请先 [设置应用属性名称](https://intl.cloud.tencent.com/document/product/1047/37167) 。
...
## 接口调试工具
通过 [REST API 在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/all_member_push/im_get_attr) 工具调试本接口。
