...
| -10001 | D2 过期。D2 是根据 UserSig 生成的内部票据，D2 的有效期小于或等于 UserSig 的有效期。<br>请重新调用 TIMManager.getInstance().login 登录接口生成新的 D2。                                      |
...
| 90043           | JSON 格式请求包中 OfflinePushInfo 不符合消息格式描述，请参考 [OfflinePushInfo 对象](https://intl.cloud.tencent.com/document/product/1047/33527#.E7.A6.BB.E7.BA.BF.E6.8E.A8.E9.80.81-offlinepushinfo-.E8.AF.B4.E6.98.8E) 的定义。|
...
| 10036  | 音视频聊天室创建数量超过了限制，请参考 付费说明 购买后付费套餐“IM音视频聊天室”。 |
| 10037  | 单个用户可创建和加入的群组数量超过了限制，请参考 付费说明 购买或升级后付费套餐“单人可创建与加入群组数”。|
| 10038  | 群成员数量超过限制，请参考 付费说明 购买或升级后付费套餐“扩展群人数上限”。 |
