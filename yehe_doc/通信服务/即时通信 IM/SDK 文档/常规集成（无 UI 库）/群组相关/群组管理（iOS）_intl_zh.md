...
### 获取已加入的群组
调用 [getJoinedGroupList](https://im.sdk.qcloud.com/doc/zh-cn/categoryV2TIMManager_07Group_08.html#ae12e170ad585eaa8fb9f080bdc3bf8b8) 可以获取已加入的好友工作群（Work）、陌生人社交群（Public）、临时会议群（Meeting）列表，但直播群（AVChatRoom）不包含在此列表中。
