...
[sendMessage](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#sendMessage) 接口增加发送选项，支持发送在线消息（即不存离线和漫游，AVChatRoom 和 BChatRoom 不允许使用）和配置 [离线推送](https://intl.cloud.tencent.com/document/product/1047/33525)。
...
**新增**
群组消息支持设置 [消息优先级](https://intl.cloud.tencent.com/document/product/1047/33526)，[枚举值](https://web.sdk.qcloud.com/im/doc/zh-cn/module-TYPES.html#.MSG_PRIORITY_HIGH)，[使用示例](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#createTextMessage)。
...
### 2.3.2 @2019.12.18
**变更**
[getUserProfile](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#getUserProfile) 和 [updateMyProfile](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#updateMyProfile) 支持 [自定义资料字段](https://intl.cloud.tencent.com/document/product/1047/33520)。
...
### 2.2.0 @2019.11.21
**新增**
- 小程序支持创建发送视频消息 [createVideoMessage](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#createVideoMessage)，视频消息全平台互通（需升级使用最新版本的 [TUIKit 以及 SDK](https://intl.cloud.tencent.com/document/product/1047/33996)）。
...
### 2.1.1 @2019.10.18
**新增**
小程序支持 [发送音频消息](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#createAudioMessage)，音频消息全平台互通（需升级使用最新版本的 [TUIKit 以及 SDK](https://intl.cloud.tencent.com/document/product/1047/33996)）。
