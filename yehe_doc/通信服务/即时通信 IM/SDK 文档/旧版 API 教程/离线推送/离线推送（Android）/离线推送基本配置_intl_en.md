...
<table> 
   ...
   <tr> 
     ...
     <td>The mobile phone needs to install Google Play Services and be used outside the Chinese mainland.</td> 
   </tr> 
   <tr> 
...
/**
 * Obtaining whether push is allowed for the current message
 * @return Whether push is allowed: true: allowed. false: not allowed.
 */
public boolean isEnabled()
 ...
 *
 * @param sound Path of the audio file. If it is set to {@see IOSSettings#NO_SOUND_NO_VIBRATION}, it indicates no alert sound and no vibration.
 */
