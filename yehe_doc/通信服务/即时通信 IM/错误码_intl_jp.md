...
| 8507   | グループメンバー数の制限超過。グループ作成とメンバー招待の時に、指定したメンバー数が制限を超えています。最大グループメンバー数は次のとおりです。プライベートグループは200人、パブリックグループは2000人、チャットルームは6000人、AVチャットルームおよびオンラインメンバーに同時発信する大規模グループは無制限です。 |
