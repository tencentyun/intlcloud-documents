...
| 8002   | メッセージKEYエラー、内部エラー。ネットワークリクエストパケットのKEYがレスポンスパケットと一致しません。 |
...
| -10004 | 下りパケットを処理する時に A2が検証に通過していないか、またはセキュリティ対策に抵触したことが判明しました。<br>TIMManager.getInstance().login ログインインターフェースを改めて呼び出し、新しいA2を生成してください。               |
...
| 40605  | 標準設定のプロファイルフィールドのValueエラー。詳細については、[標準プロファイルフィールド](https://intl.cloud.tencent.com/document/product/1047/33520)をご参照ください。   |
...
| 10036  | AVチャットルームの作成数が制限を超えています。 [料金説明](https://intl.cloud.tencent.com/document/product/1047/34350) をご参照のうえご購入ください。 |
| 10037  | 1人のユーザーが作成および参加できるグループ数の制限を超えています。[料金説明](https://intl.cloud.tencent.com/document/product/1047/34350) をご参照のうえご購入ください。 |
| 10038  | グループメンバーの制限数を超えています。[料金説明](https://intl.cloud.tencent.com/document/product/1047/34350) をご参照のうえご購入ください。 |
