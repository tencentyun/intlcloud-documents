...
- If your domain is hosted in Tencent Cloud, please log in to the [DNSPod console](https://console.cloud.tencent.com/cns) to configure the domain. If your domain is hosted in another domain service provider, please configure it according to the checklist.
...
## Step 2. Conduct organization verification[](id:Step2)
...
## Step 4. Configure sender domains[](id:Step4)
1. Log in to the [SES console](https://console.cloud.tencent.com/ses) and click **Sender Domain**.
   
2. Enter the **Sender Domain** page and click **Create**.
...
## Step 5. Configure sender addresses[](id:Step5)
...
>!Your sender address should be a full email address suffixed with a **verified** sender domain. For example, <code>test@example.qcluodmail.com</code>.
>

4. Click **Submit** to complete the sender address configuration.

## Step 6. Configure templates[](id:Step6)
