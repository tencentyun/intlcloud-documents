...
|Python | [Python SDK 文档](https://intl.cloud.tencent.com/document/product/382/37259)   | [Python SDK](https://github.com/TencentCloud/tencentcloud-sdk-python)|
...
|C# | [C# SDK 文档](https://intl.cloud.tencent.com/document/product/382/37260)  | [C# SDK](https://github.com/TencentCloud/tencentcloud-sdk-dotnet)|
|Go | [Go SDK 文档](https://intl.cloud.tencent.com/document/product/382/37261)  | [Go SDK](https://github.com/TencentCloud/tencentcloud-sdk-go)|

>!
- 本章节短信 SDK 均为最新 SDK 3.0，后续短信相关新增功能都会在此章节更新。我们强烈推荐您使用最新的 SDK 3.0 以及配套的 API 3.0 接口。
- 现有2.0版本的 API 和 SDK 功能依然保持，未来可能停止维护。
- 现有3.0的2019-07-11版本的 API 和 SDK 功能依然保持，未来可能停止维护。
