...
企业认证用户可以登录 [短信控制台](https://console.cloud.tencent.com/smsv2) 设置或修改相应的频率限制策略，具体操作请参见 [设置发送频率限制](https://intl.cloud.tencent.com/document/product/382/35469#.E8.AE.BE.E7.BD.AE.E5.8F.91.E9.80.81.E9.A2.91.E7.8E.87.E9.99.90.E5.88.B6)。
...
- 单 IP 请求次数限制。
- 限制单个号码发送次数，可 [设置发送频率限制](https://intl.cloud.tencent.com/document/product/382/35469#.E8.AE.BE.E7.BD.AE.E5.8F.91.E9.80.81.E9.A2.91.E7.8E.87.E9.99.90.E5.88.B6) ，并 [配置告警联系人](https://intl.cloud.tencent.com/document/product/382/32356)。
- [设置发送超量提醒](https://intl.cloud.tencent.com/document/product/382/35469#.E8.AE.BE.E7.BD.AE.E5.8F.91.E9.80.81.E8.B6.85.E9.87.8F.E6.8F.90.E9.86.92)。
...
- 发送国内短信前，您必须先 创建签名和 创建正文模板，并审核通过。
- 发送国际/港澳台短信前，您必须先 创建正文模板 并审核通过。如需携带签名则还应 创建签名 并审核通过，否则无需创建签名。
...
### 如何创建和查看应用（SDK AppID）？
SDK AppID 用于标识应用，每个短信应用拥有唯一的 SDK AppID，添加应用后由系统自动生成。
您可以登录 [短信控制台](https://console.cloud.tencent.com/smsv2) ，选择【应用管理】>【应用列表】，单击目标应用名称进入应用详情页查看已有应用的 SDK AppID。

### 测试、告警手机号如何开通频率限制白名单？
如需开通测试手机号无频率限制，可咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。
...
### 发送国际/港澳台短信是否有数量限制？
单个腾讯云账户的国际/港澳台短信每日发送量限额为1000条，如需调整，请咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。
