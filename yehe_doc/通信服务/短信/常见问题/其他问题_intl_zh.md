...
如仍然无法解决，请咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。
...
6. 如果仍旧无法解决，请咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。
...
7. 如果仍旧无法解决，请咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。
...
### 发送短信报错，自己排查不出来该怎么办？
您可以咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)。

### 短信发送失败，记录提示含有敏感词，但是申请时已通过审核，是什么情况？
敏感词库是由运营商反馈的，可以联系 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773) 并提供发送失败的手机号码，人工客服将与运营商沟通确认能否解除。
...
不可以，不支持发送金融贷款类短信。若发现恶意提交发送，官方会进行封号处理。
...
### 发送营销短信需要什么条件？
完成企业认证的账号才可以发送营销短信，且只支持会员营销类短信发送。


### 发送营销类短信和通知类短信有哪些区别呢？
营销短信和普通短信是根据内容文案属性决定的，更多详情请参见 [常用概念](https://intl.cloud.tencent.com/document/product/382/13299) 。
...
### 国家（或地区）码分别是多少？
国家（或地区）码详情请参阅 [国际/港澳台短信日结后付费价格表](https://intl.cloud.tencent.com/document/product/382/8414#.E6.97.A5.E7.BB.93.E5.90.8E.E4.BB.98.E8.B4.B9)。
