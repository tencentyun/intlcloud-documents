...
Log in to the [SMS Console](https://console.cloud.tencent.com/smsv2) and select **Statistical Analysis** > **Mainland China SMS** (or **Global SMS**) > **Message Records** to view the **Sending Status** and **Remarks** for the mobile number.
...
If the **Sending Status** is "successful", but an error code is displayed in **Remarks**, please troubleshoot the issue based on the specific error code.
...
If the issue persists, please consult [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773).
...
1. Run the `dig yun.tim.qq.com` command to check whether a private network DNS is used, and if so, select a nearby Tencent Cloud SMS IP from the same carrier to configure the host and check whether the issue is fixed.
...
- Unsubscribed user list. After an user replies "T", "N", "TD", "Unsubscribe", "QX", or "0000" (case-insensitive) to unsubscribe, the system will put the user's mobile number on the blacklist after receipt of the reply. When an SMS message is sent again, "Failed to send" will be returned, with remarks "1015 The mobile number is blacklisted", and the user will be unable to receive the message.
 You can log in to the [SMS Console](https://console.cloud.tencent.com/smsv2), select **General Management** > **Unsubscribed User Management**, and submit an application for cancellation of the unsubscription, which will take effect upon approval.
...
6. If the issue persists, please consult [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773).
...
7. If the issue persists, please consult [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773).
...
You can consult [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773).
...
The vocabulary of sensitive words is provided by the carrier. You can contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773) and provide the mobile number to which the message fails to be sent. A customer service agent will communicate with the carrier to fix the issue.
...
### Can I send bulk SMS?
Yes, you can send an SMS message to up to 200 mobile numbers at a time by calling the [SendSms](https://intl.cloud.tencent.com/document/product/382/34859) API or up to 100,000 mobile numbers through the console.
...
### What are the country (or region) codes?
For country (or region) code details, please see [Global SMS Pricing](https://intl.cloud.tencent.com/document/product/382/8414#.E6.97.A5.E7.BB.93.E5.90.8E.E4.BB.98.E8.B4.B9).
