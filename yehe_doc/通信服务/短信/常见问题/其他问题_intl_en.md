...
3. Check whether the value of the `type` parameter in the request packet is the same as the type of the content template applied for (0 indicates regular SMS, while 1 indicates marketing SMS).
