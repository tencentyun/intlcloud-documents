...
## 授权粒度
访问管理的核心功能可以表达为：**允许或禁止某账号对某些资源进行某些操作**。SMS 访问管理支持 [资源级授权](https://intl.cloud.tencent.com/document/product/598/10588#.E7.AE.80.E4.BB.8B)，资源的粒度是 SMS 应用，操作的粒度是 [云 API](https://cloud.tencent.com/product/api)，包括服务端 API 以及访问 SMS 控制台时可能会用到的 API。详细说明请参见 [可授权的资源及操作](https://cloud.tencent.com/document/product/382/46985)。
