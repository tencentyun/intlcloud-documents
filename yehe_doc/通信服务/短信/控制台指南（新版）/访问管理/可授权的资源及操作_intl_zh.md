...
## 支持资源级授权的 API
短信不支持对服务端 API 进行资源级授权，本小节列出的所有控制台 API 操作均支持资源级授权。[授权策略语法](https://intl.cloud.tencent.com/document/product/382/38456#.E6.8E.88.E6.9D.83.E7.AD.96.E7.95.A5.E8.AF.AD.E6.B3.95) 中对这些 API 操作的资源语法描述均相同，具体为：
...
>!针对不支持资源级权限的 API，您仍然可以通过 [自定义策略](https://intl.cloud.tencent.com/document/product/382/38456) 向用户授予使用该操作的权限，但是策略语句的资源元素必须指定为`*`。
