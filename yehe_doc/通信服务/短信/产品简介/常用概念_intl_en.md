...
## General SMS
General SMS messages divide into verification code SMS and notification SMS:
...
Sample 2:
```
Rebate wave 2 coming soon! Up to 30% off for hairstyle products! Flash sale will start on 9:00, February 17. Tap xxx. Reply T to unsubscribe.
```
