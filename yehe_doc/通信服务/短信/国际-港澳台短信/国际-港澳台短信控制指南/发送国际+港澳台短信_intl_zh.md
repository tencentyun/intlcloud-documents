...
4. 根据实际需求设置以下参数：
 ...
 - 发送对象：单击【模板下载】，填写表格中的客户手机号和短信自定义内容信息，单击【选择文件】上传表格，最大支持上传30MB大小的表格文件。
   >?单个腾讯云账户每日发送国际/港澳台短信限额1000条，且同一次发送的所有客户手机号归属地都必须为境外地区。
   >
4. 单击【下一步】。
...
您可以通过以下方式查看短信发送结果：
- 在发送记录页面，单击目标任务所在行的【详情】查看当前任务的详细记录和回执分析。
- 单击目标应用名称进入应用详情页，选择【国际/港澳台短信】>【统计分析】，查看当前应用下所有国际/港澳台短信的数据记录以及相关分析。

## 相关文档
您也可以通过 API 发送短信，具体操作请参见 [API 文档](https://intl.cloud.tencent.com/document/product/382/34689#.E7.9F.AD.E4.BF.A1-api) 。
