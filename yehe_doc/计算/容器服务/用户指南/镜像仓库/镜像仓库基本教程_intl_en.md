...
>
>- Namespace names are unique in the located region. If the namespace name you want to use is already in use by another user, try an available name.
>- Select a region from the list above **My Images**.
>
