...
3. On the "Select the Model" page, select **GPU Model** as the instance "Family" and select "GPU Compute GN2" as the "Model", as shown in the following figure:
...
3. On the "Select Nodes" page, select an existing GPU node and click **Next**, as shown in the following figure:
...
5. Specify information such as the workload name and namespace as instructed. Then, set "GPU Limit".
