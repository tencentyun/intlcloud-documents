...
>
>- The directions in this document is based on an existing cluster with nodes. For more information, refer to [Creating Clusters](https://intl.cloud.tencent.com/document/product/457/11741).
>- Make sure the peering connection is successfully created and the CVM instances can communicate with one another. If there is an issue, go to the console and check if the **route table**, **CVM security groups**, and **subnet ACL** are configured properly.
...
The following is the cluster management page of a cluster named A.
...
- **Cross-region peering**: [submit a ticket](https://console.cloud.tencent.com/workorder/category/?level1_id=6&level2_id=350&source=undefined&data_title=%E5%AE%B9%E5%99%A8%E6%9C%8D%E5%8A%A1TKE&step=1) to after creating the peering connection.

Refer to [Operating Remote Terminal](https://intl.cloud.tencent.com/document/product/457/9120) on how to log in to a container, and verify the peering connection as instructed below:
