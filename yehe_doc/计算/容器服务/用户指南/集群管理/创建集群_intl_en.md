...
- To use the custom image feature, please apply by [submitting a ticket](https://console.qcloud.com/workorder/category?level1_id=6&level2_id=350&source=0&data_title=%E5%AE%B9%E5%99%aA8%E6%9C%8D%E5%8A%A1TKE&level3_id=718&radio_title=%E5%AE%B9%E5%99%A8%E9%9B%86%E7%BE%A4%E7%9B%B8%E5%85%B3%E9%97%AE%E9%A2%98&queue=97&scene_code=16798&step=2).
>
>- If you need to use the custom image feature, create custom images based on the basic image provided by TKE.
>- Currently, custom images can only be created using basic images with the same OS. For example, you can use the CentOS basic image to create a CentOS custom image.
>
...
3. The template-based creation feature provides you with multiple templates for creating managed clusters, self-deployed clusters, and elastic clusters. You can choose a template based on your actual requirements.
 ...
 - **Self-deployed cluster**: if you create a self-deployed Kubernetes  cluster, you need to purchase and manage the master and worker nodes of the cluster. You will hold all the management and operation permissions of the cluster.
...
3. On the **Create a cluster** page, set the basic information of the cluster.
...
In the **Select the model** step, you can choose **Existing nodes** or **Add**. 
 - **Existing nodes**: [Create a cluster using an existing CVM](#UseExistingCVMCreateCluster).
