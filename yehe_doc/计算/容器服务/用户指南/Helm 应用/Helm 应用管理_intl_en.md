...
5. Click **Finish** to finish the creation.
...
3. In the "Update a Helm Application" window, enter "Chart_url" again and configure the custom parameters as needed, as shown in the following figure:
...
3. In the window that appears, click **OK**, as shown in the following figure:
