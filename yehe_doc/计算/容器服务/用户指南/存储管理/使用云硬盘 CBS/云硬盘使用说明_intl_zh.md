...
详细操作步骤请参见 [StorageClass 管理云硬盘模版](https://intl.cloud.tencent.com/document/product/457/36158)。
...
3. 创建工作负载时，选择 PVC。
详细操作步骤请参见 [PV 和 PVC 管理云硬盘](https://intl.cloud.tencent.com/document/product/457/36159)。
