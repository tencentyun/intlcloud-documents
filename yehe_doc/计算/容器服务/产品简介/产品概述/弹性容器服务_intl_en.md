...
## Use Cases
#### Microservices
Runing microservices with EKS can free users from ops of computing nodes. A service can be automatically scaled based on the actual load and use the necessary amount of resources to run applications, which reduces resource costs.
...
- Network:
 - To create and manage your private network, including to create a VPC instance and a subnet, establish a peering connection, use the NAT Gateway, configure a route table, or configure a security policy, please refer to [VPC documentation](https://intl.cloud.tencent.com/product/vpc).
