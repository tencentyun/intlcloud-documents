...
![](https://main.qcloudimg.com/raw/aa2446d6cf8e17def9c353afc36fa42b.png)
 ...
 - **Worker Configuration**: here, **Node Source** is set to **New Node** as an example. The settings under the component the same as above by default. You can change them based on actual needs.
...
### Creating a service
After a cluster is created, you can create a service. The following steps describe how to create a service. A service is a microservice comprised of multiple containers with the same configuration and the rules used to access these containers.
...
### Viewing resources
In the above procedure, you have created a cluster and a service. The following steps describe how to view resources that have been successfully created.
#### Viewing clusters
...
2. Enter the default “Deployment” management page. The features in the left menu bar are as follows:
 ...
 - **Node Management**: a node is a CVM registered with the cluster. You can create a node, add an existing node, and create scaling rules here.
