裸金属云服务器兼具云服务器的灵活弹性和物理机高稳定、强劲的计算性能，能与腾讯云全产品（如网络、数据库等）无缝融合，在大数据、高性能计算、云游戏等领域都有广泛应用。裸金属云服务器可以在极短时间为您构建云端独享的高性能、安全隔离的物理服务器集群，是极致性能追求者的最佳选择。
...
- 在一个区域中可以启动的实例总数存在限制，有关限制的更多信息，请参阅 [实例购买限制](https://intl.cloud.tencent.com/document/product/213/2664)。
...
- 全文中的网络收发包为纯网络转发测试场景下数据，测试方法可参考 [网络性能测试](https://intl.cloud.tencent.com/document/product/213/11460)。业务场景下的性能数据，务必实测之后再预估容量。
...
- **CPU**：2.7GHz Intel® Xeon® Ice Lake 处理器，睿频3.4GHz
- **内存**：搭配八通道 DDR4 内存。
- **存储**：支持 [云硬盘](https://intl.cloud.tencent.com/document/product/362/31636) 作为系统盘和数据盘，可按需 [扩容](https://intl.cloud.tencent.com/document/product/362/31600)。
- **网络**：支持100Gbps内网带宽，具备超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。支持弹性网卡挂载。
...
- **内存**：搭配八通道 DDR4 内存。
- **存储**：支持 [云硬盘](https://intl.cloud.tencent.com/document/product/362/31636) 作为系统盘和数据盘，可按需 [扩容](https://intl.cloud.tencent.com/document/product/362/31600)。
- **网络**：支持40Gbps内网带宽，具备超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。支持弹性网卡挂载。
- 推荐搭配 TencentOS Server 操作系统，以发挥出实例的最优应用表现。
...
- **网络**：支持25Gbps内网带宽，具备超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。
...
- **内存**：搭配六通道 DDR4 内存。
- **存储**：配备 2 × 480 GB SATA SSD (RAID1) 本地系统盘及 2 × 3840 GB NVMe SSD 高性能本地存储。
- **网络**：支持25Gbps内网带宽，超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置载。
...
- **存储**：配备 4 × 3840 GB NVMe SSD 高性能本地存储。支持 [云硬盘](https://intl.cloud.tencent.com/document/product/362/31636) 作为系统盘和数据盘，可按需 [扩容](https://intl.cloud.tencent.com/document/product/362/31600)。
- **网络**：支持40Gbps内网带宽，具备超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。支持弹性网卡挂载。
- 推荐搭配 TencentOS Server 操作系统，以发挥出实例的最优应用表现。
...
- **CPU**：2.6GHz AMD EPYC™ ROME 处理器，睿频3.3GHz。
- **内存**：八通道 DDR4 内存，计算性能稳定。
- **存储**：配备 12 × 16000 GB SATA HDD 及 1 × 3840 GB NVMe SSD 海量本地存储。支持 [云硬盘](https://intl.cloud.tencent.com/document/product/362/31636) 作为系统盘和数据盘，可按需 [扩容](https://intl.cloud.tencent.com/document/product/362/31600)。
- **网络**：支持40Gbps内网带宽，具备超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。支持弹性网卡挂载。
- 推荐搭配 TencentOS Server 操作系统，以发挥出实例的最优应用表现。
...
- **网络**：支持25Gbps内网带宽，超高网络收发包能力。[公网网络](https://intl.cloud.tencent.com/document/product/213/10578) 可按需配置。
...
<dx-alert infotype="notice" title="">
  - NVIDIA 系列 GPU 实例用作通用计算，需要安装 Tesla Driver + CUDA，安装方法参考 [安装 NVIDIA Tesla 驱动指引](https://intl.cloud.tencent.com/document/product/560/8048) 和 [安装 CUDA 驱动指引](https://intl.cloud.tencent.com/document/product/560/8064)。
  - NVIDIA 系列 GPU 实例如用作 3D 图形渲染任务（高性能图形处理，视频编解码等），则需安装 GRID Driver 和配置 License Server。
</dx-alert>
