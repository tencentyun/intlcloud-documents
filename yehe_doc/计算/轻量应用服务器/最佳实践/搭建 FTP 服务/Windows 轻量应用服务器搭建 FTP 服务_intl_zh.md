...
## 操作步骤
### 步骤1：登录轻量应用服务器
您可以 [使用 VNC 方式登录 Windows 实例](https://intl.cloud.tencent.com/document/product/1103/46399)。也可以根据实际操作习惯，[使用远程桌面连接登录 Windows 实例](https://intl.cloud.tencent.com/document/product/1103/46400)。
...
如何放通对应端口，请参见 [添加防火墙规则](https://intl.cloud.tencent.com/document/product/1103/41393#.E6.B7.BB.E5.8A.A0.E9.98.B2.E7.81.AB.E5.A2.99.E8.A7.84.E5.88.99)。
2. （可选）参考微软官方文档配置 FTP 站点的防火墙支持，使 FTP 服务器能够接受来自防火墙的被动连接。
