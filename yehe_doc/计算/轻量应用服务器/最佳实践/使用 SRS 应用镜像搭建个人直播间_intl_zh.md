...
其中，“镜像”选择为**应用镜像** > **SRS音视频服务器 4.2**，其他参数可参考 [购买方式](https://intl.cloud.tencent.com/document/product/1103/41404) 进行选择。
<dx-alert infotype="explain" title="">
- 若您想使用已创建的实例搭建直播间，则可使用 SRS 应用镜像 [重装系统](https://intl.cloud.tencent.com/document/product/1103/41560)。
