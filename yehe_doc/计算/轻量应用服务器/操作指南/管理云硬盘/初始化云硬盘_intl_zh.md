...
## 前提条件
已 [挂载云硬盘](https://intl.cloud.tencent.com/document/product/1103/46568) 至轻量应用服务器。
...
1. 登录轻量应用服务器，详情请参见 [使用 WebShell 方式登录 Linux 实例](https://intl.cloud.tencent.com/document/product/1103/41523)。
2. 执行以下命令，查看磁盘名称。
```
sudo fdisk -l
```
