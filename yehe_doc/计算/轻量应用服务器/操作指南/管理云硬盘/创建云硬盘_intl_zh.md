...
轻量应用服务器所使用的云硬盘与 [云硬盘](https://intl.cloud.tencent.com/document/product/362/2345) 相比，同类型云硬盘无差异，且性能处于同一水准。
</dx-alert>
...
<tr>
<td>云硬盘类型</td><td>支持高性能云硬盘及 SSD 云硬盘两种类型。更多信息请参见 <a href="https://intl.cloud.tencent.com/document/product/362/31636">云硬盘类型简介</a>。</td>
</tr>
<tr>
<td>容量</td>
...
## 后续操作
请参考 [挂载云硬盘](https://intl.cloud.tencent.com/document/product/1103/46568) 将云硬盘挂载至同一可用区内的轻量应用服务器，作为数据盘使用。
