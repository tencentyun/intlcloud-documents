...
- 不同地域之间云产品可以通过 [公网 IP](https://intl.cloud.tencent.com/document/product/213/5224) 进行 Internet 访问。处于私有网络中的云产品也可以通过腾讯云提供的 [对等连接](https://intl.cloud.tencent.com/document/product/553) 经由腾讯云高速互联网络通信，以获得比 Internet 访问更稳定高速的互联。
...
<table>
	...
	<tr>
	<td> <a href="https://intl.cloud.tencent.com/document/product/213/4941">自定义镜像</a> </td>
	  <td>img-xxxxxxxx</td>
	  <td>单地域多可用区可用</td>
