...
- 创建一个自定义镜像的子机时，需要 [创建自定义镜像](https://intl.cloud.tencent.com/document/product/213/4942) 或者 [导入镜像](https://intl.cloud.tencent.com/document/product/213/4945)。
...
![创建云主机入口](https://main.qcloudimg.com/raw/9113542c2cab5258892c73c4be64a701.png)
...
主要参数信息如下：
 - **镜像提供方**：根据不同来源，腾讯云提供公共镜像、自定义镜像、共享镜像。更多关于镜像类型的介绍，请参考 [镜像类型介绍](https://intl.cloud.tencent.com/document/product/213/4941)。
 - **操作系统**：根据实际需求进行选择。
 - **系统版本**：根据实际需求进行选择。
...
子机支持的存储类型有：本地硬盘/本地 SSD 硬盘、云硬盘、高性能云硬盘、SSD 云硬盘。更多关于云硬盘的介绍，请参考 [云硬盘分类](https://intl.cloud.tencent.com/document/product/362/31636)。
 - **网络类型**
...
### 使用 API 创建子机
使用 RunInstances 接口可以在指定专用宿主机上创建子机，具体用法详见 [创建实例 API ](https://intl.cloud.tencent.com/document/product/213/33237)。
