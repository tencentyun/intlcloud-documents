...
## 前提条件
已注册腾讯云账户。若未注册腾讯云账户，可前往 [注册页面](https://intl.cloud.tencent.com/register)。
...
```
您可使用以下示例代码，参考 [作业配置简介](https://intl.cloud.tencent.com/document/product/599/10523) 并补充其中**待替换**信息，将其中的 ImageId 替换为您的自定义镜像 ID。
```
