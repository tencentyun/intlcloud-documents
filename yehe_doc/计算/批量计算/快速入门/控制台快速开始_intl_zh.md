...
### 准备
准备好 [对象存储](https://intl.cloud.tencent.com/document/product/436) 存储桶。如果您尚未创建存储桶，请参照 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309) 完成创建。
...
3. 配置程序信息。
  * 执行方式：Local
  * Stdout 日志：格式参考 [COS、CFS路径填写](https://intl.cloud.tencent.com/document/product/599/13996)
