### 使用批量计算服务需要收费吗？
批量计算服务本身完全免费，作业执行过程中创建的云服务器依照对应的云服务器按量计费模式收费，具体可以查看 [收费方式>>](https://intl.cloud.tencent.com/document/product/599/10447)。
...
除了 FPGA、 GPU 以及网络增强型实例和部分处于内测的实例类型，其他均可使用，每个可用区支持的实例列表请参照 [实例规格](https://intl.cloud.tencent.com/document/product/213/11518)。
