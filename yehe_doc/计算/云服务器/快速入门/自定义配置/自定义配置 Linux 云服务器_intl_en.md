...
To create a CVM with quick configuration, refer to [Custom Configuration for Linux CVM](https://intl.cloud.tencent.com/document/product/213/2936).
...
<tr><td>Image</td><td>Yes</td><td>Tencent Cloud provides public images, custom images, shared images and marketplaces. Select an appropriate type by referring to <a href="https://intl.cloud.tencent.com/document/product/213/4941">Image Types</a>.</br>For users who just started using Tencent Cloud, we recommend public images.</td></tr>
<tr><td><a href="https://intl.cloud.tencent.com/document/product/362/2353">System Disk</a></td><td>Required</td><td>Used to install the operating system. Its capacity is 50 GB by default.</br>Available disk types vary by regions. Select as instructed by the page.</br>For more information about CBS, see <a href="https://intl.cloud.tencent.com/document/product/362/2353">CBS Types</a>.</td></tr>
<tr><td><a href="https://intl.cloud.tencent.com/document/product/362/2353">Data Disk</a></td><td>Optional</td><td>Used to scale up the storage capacity of the CVM to ensure high efficiency and reliability. CBS data disks are not added by default.</br>For more information about CBS, see <a href="https://intl.cloud.tencent.com/document/product/362/2353">CBS Types</a>.</td></tr>
...
<tr><td>Public Gateway</td><td>Optional</td><td>A network interface between the VPC and the Internet. It can forward the requests of CVMs that are within different subnets of the VPC and have no public IP addresses. Please note that Tencent Cloud no longer supports selecting public network gateway configuration on the CVM purchase page after December 6, 2019. If you need it, see <a href="https://intl.cloud.tencent.com/document/product/213/34835">Public Gateway</a> to configure by yourself.</td></tr> 
...
<tr><td>Security Group</td><td>Required</td><td>Used to configure the network access policies for one or more CVMs.</br><b>Ensure that login port 22 is open.</b>For more information, see <a href="https://intl.cloud.tencent.com/document/product/213/12452">Security Group</a>.</td></tr>
...
<tr><td>Login Methods</td><td>Required</td><td>The method for logging into the CVM. Please select base on your actual needs.<ul><li><b>Custom Password</b>: customize the password for logging into the instance.</li><li><b>SSH Key Pair</b>: associate the instance with a secure shell (SSH) key to ensure secure login.</br>If no key is available or existing keys are inapplicable, click **Create Now** to create a key. For more information about SSH keys, see <a href="http://cloud.tencent.com/doc/product/213/SSH%E5%AF%86%E9%92%A5">SSH Key</a>.</li><li><b>Random Password</b>: An auto-generated password will be sent via <a href="https://console.cloud.tencent.com/message">Internal Messages</a>.</li></ul></td></tr>
...
- For a disk whose capacity is less than 2 TB:
 [Initializing a Cloud Disk (Linux)](https://intl.cloud.tencent.com/document/product/362/6734)
- For a disk whose capacity is greater than or equal to 2 TB:
 [Initializing a Cloud Disk (Linux)](https://intl.cloud.tencent.com/document/product/362/6735)
