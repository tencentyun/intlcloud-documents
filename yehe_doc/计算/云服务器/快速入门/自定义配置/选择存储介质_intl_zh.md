在配置实例时，您可以选择本地盘或者云硬盘作为您的系统盘或者数据盘。在选择存储介质前，请了解 [本地盘](https://intl.cloud.tencent.com/document/product/213/5798) 和 [云硬盘](https://intl.cloud.tencent.com/document/product/213/4953) 两者的特点以及适用场景的区别。
> 
