...
| Live streaming | <ul style="margin: 0;"><li>**Standard network enhanced** instance</li><li>**Computing network enhanced** instance</li></ul> | Comes with a 25 GB ENI that is 2.5 times faster than that of regular ten-gigabit data centers, providing an increased bandwidth and reduced latency. |
