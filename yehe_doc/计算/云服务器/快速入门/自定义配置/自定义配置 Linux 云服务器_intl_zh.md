...
若您需要通过快速配置进行创建云服务器，可参考 [快速配置 Linux 云服务器](https://intl.cloud.tencent.com/document/product/213/2936) 文档进行配置。

## 注册及认证

在使用云服务器之前，您需要完成以下准备工作：
1. 注册腾讯云账号，并完成实名认证。
新用户需在腾讯云官网进行 [注册](https://intl.cloud.tencent.com/register)，具体操作可参考 [注册腾讯云](https://cloud.tencent.com/doc/product/378/9603)。
...
- 磁盘容量小于2TB时：
 [初始化云硬盘（Linux）](https://intl.cloud.tencent.com/document/product/362/6734)
- 磁盘容量大于等于2TB时：
 [初始化云硬盘（Linux）](https://intl.cloud.tencent.com/document/product/362/6735)
