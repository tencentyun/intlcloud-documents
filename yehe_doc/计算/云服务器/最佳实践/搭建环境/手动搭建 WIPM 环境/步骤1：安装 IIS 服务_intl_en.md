...
This document introduces how to add and install IIS roles on a CVM instance with Windows Server 2012 R2 or Windows Server 2008.
...
10. On the **Select role services** page, check **CGI** and click **Next**, as shown below:
![](https://main.qcloudimg.com/raw/c571820b1a4290d9b04abbc65cf81fd9.png)
11. Confirm installation selections and click **Install**. Wait for the installation process to complete.
![](https://main.qcloudimg.com/raw/1e51aed773aad8eac28f88c401a1814e.png)
12. After the installation completes, open a browser on CVM and visit `http://localhost/` to verify if IIS has been successfully installed.
...
3. Select **Role** in the left sidebar, and click **Add Roles** in the right panel, as shown below:
...
5. On the “Select server roles” page, check **Web Server (IIS)** , and click **Next** twice, as shown below:
![](https://main.qcloudimg.com/raw/7a41185e562a62ca586b6b677381b3a1.png)
6. On the **Select role services** page, check **CGI** and click **Next**, as shown below:
![](https://main.qcloudimg.com/raw/7e7a96b106292e87d44807369db66842.png)
7. Confirm installation selections and click **Install**. Wait for the installation process to complete.
![](https://main.qcloudimg.com/raw/877b71930f11d9d2a6fecf946f0bebfe.png)
8. After the installation completes, open a browser on CVM and visit `http://localhost/` to verify if IIS has been successfully installed.
If the following page appears, it indicates that IIS has been successfully installed.
