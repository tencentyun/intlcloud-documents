...
8. Check ** FTP Service** and **FTP Extensibility**, and click **Next**, as shown below:
...
2. In the **Internet Information Service (IIS) Manager** pop-up window, expand your server in the left sidebar, right-click **Sites**, and select **Add FTP Site**, as shown below:
...
1. In the “Server Manager” window, select **Tools** -> **Internet Information Services (IIS) Manager** in the top-right navigation bar.
2. In the “Internet Information Services (IIS) Manager” pop-up window, select the server in the left sidebar and double-click **Server Certificates** on the right panel, as shown below:
...
4. In the “Create Self-Signed Certificate” pop-up window, enter a certificate name and the storage type, as shown below:
