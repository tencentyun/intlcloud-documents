...
### 步骤3：创建 FTP 用户名及密码<span id="user"></span>
...
### 步骤6：设置安全组及防火墙
1. 完成 FTP 站点搭建后，请放通添加 FTP 站点时绑定端口的入站规则，例如21端口的入站规则。详情请参见 [添加安全组规则](https://intl.cloud.tencent.com/document/product/213/34272)。
