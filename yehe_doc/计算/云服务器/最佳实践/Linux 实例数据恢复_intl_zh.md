...
腾讯云还提供了 [创建快照](https://intl.cloud.tencent.com/document/product/362/5755)、[创建自定义镜像](https://intl.cloud.tencent.com/document/product/213/4942) 及 [对象存储](https://intl.cloud.tencent.com/document/product/436/6222) 等存储数据的方式，建议您定期进行数据备份，以提高数据安全性。
...
## 操作步骤
>!在执行操作步骤前，请参考 [创建快照](https://intl.cloud.tencent.com/document/product/362/5755) 及 [创建自定义镜像](https://intl.cloud.tencent.com/document/product/213/4942) 进行数据备份，以确保出现问题时可恢复至初始状态。
>
...
1. 参考 [在分区上构建文件系统](https://intl.cloud.tencent.com/document/product/362/31597) 对数据盘进行初始化及分区，并执行以下命令，检查现有磁盘及可用分区。
```
fdisk -l
```
返回结果如下图所示：
