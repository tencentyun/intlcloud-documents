...
### Arrears policy
When your account balance falls below zero, you can continue to use CVM instances for the next 2 hours. We will also continue to bill you for this usage. After 2 hours, if your account balance remains negative, your CVM instances will shut down automatically and billing will stop.
