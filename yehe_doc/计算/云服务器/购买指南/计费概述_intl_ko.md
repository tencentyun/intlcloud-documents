...
4. 공식 홈페이지의 가격은 상황에 따라 적절히 변경될 수 있습니다. 장기적으로 유효한 데이터가 아니므로 구체적인 가격은 공식 홈페이지를 참고하시기를 바랍니다.
...
3. 공식 홈페이지의 가격은 상황에 따라 적절히 변경될 수 있습니다. 장기적으로 유효한 데이터가 아니므로 구체적인 가격은 공식 홈페이지를 참고하시기를 바랍니다.
...
요금 계산은 아래와 같습니다.
메모리 사양 요금 + 스토리지 용량 요금 = 2 × 816위안/월 + (500GB + 200GB) × 0.72위안/GB/월 × 1개월 = 2136위안
...
백업 용량 부과 요금(시간당) = 200GB (초과한 백업 용량은 실제 시나리오에 따라 지속 변동될 수 있음) × 0.0008위안/GB/시간
