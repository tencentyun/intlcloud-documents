...
请参考 [关机实例操作指南](https://intl.cloud.tencent.com/document/product/213/4929)。

### 如何重启实例？

请参考 [重启实例操作指南](https://intl.cloud.tencent.com/document/product/213/4928)。
...
请参考 [销毁实例操作指南](https://intl.cloud.tencent.com/document/product/213/4930)。
