...
### CVM 인스턴스 구매 후 도메인 ICP비안은 어떻게 하나요?
ICP비안을 하려는 CVM 인스턴스가 구매 조건을 충족해야 하고, 각 인스턴스별로 ICP비안 서비스 번호를 신청할 수 있는 수량이 한정적입니다. 세부 정보는 [클라우드 서비스 ICP비안](https://intl.cloud.tencent.com/document/product/1022/34608)을 참조 바랍니다.
