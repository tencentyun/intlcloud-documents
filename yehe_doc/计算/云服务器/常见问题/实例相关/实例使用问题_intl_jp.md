...
[CVMコンソール](https://console.cloud.tencent.com/cvm/index)にログインして、CVMページで使用中のCVMを確認できます。
...
詳細については、[インスタンスの終了](https://intl.cloud.tencent.com/document/product/213/4930)をご参照ください。
...
### Linuxインスタンスはビジュアルインターフェースをサポートしていますか。
はい。 Linuxインスタンスでビジュアルインターフェースを構築する必要がある場合、操作の詳細については、[Ubuntuビジュアルインターフェイスの構築](https://intl.cloud.tencent.com/document/product/213/37500)をご参照ください。


### CVMインスタンスを購入した後のドメイン名のICP登録方法はなんですか。
詳細については、クラウドサービスのICP登録をご参照ください。
...
- [TencentDB for MySQL](https://intl.cloud.tencent.com/product/cdb)を別途購入できます。

### CVMインスタンス上にデータベースを構築できますか。
できます。必要に応じてデータベースソフトウェアをインストールし、環境を構成することができます。また、[TencentDB for MySQL](https://intl.cloud.tencent.com/product/cdb)を個別に購入することもできます。
