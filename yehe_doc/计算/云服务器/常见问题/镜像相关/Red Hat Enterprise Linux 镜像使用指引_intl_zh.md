...
### 已有的镜像版本或者机型不符合需求怎么办？
您可以通过工单系统等腾讯云官方入口 [联系我们](https://console.tencentcloud.com/workorder/category)。

### Red Hat Enterprise Linux 商业镜像如何计费？
请参见：[ 镜像计费说明](https://www.tencentcloud.com/document/product/213/55134)。
...
### 预留实例模式下，Red Hat Enterprise Linux镜像如何计费？
请您查看文档[镜像计费说明——Red Hat Enterprise Linux镜像计费说明](https://www.tencentcloud.com/document/product/213/55134)。
...
可以，您可以通过 [导入镜像](https://intl.cloud.tencent.com/document/product/213/4945) 功能导入您的自定义镜像，通过该自定义镜像创建实例，将不会产生商业镜像授权费用。
