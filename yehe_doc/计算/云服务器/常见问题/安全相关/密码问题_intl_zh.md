...
- 通过【[**自定义配置**](https://buy.cloud.tencent.com/cvm?tab=custom)】的方式进行购买云服务器，根据登录方式的不同，获取初始密码的方式如下：
<table>
...
若您在站内信中未收到初始密码相关信息，请确认您当前登录的账号是否为主账号。若不是，请切换至主账号，再进行查看。
...
Linux 云服务器，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 反馈。
