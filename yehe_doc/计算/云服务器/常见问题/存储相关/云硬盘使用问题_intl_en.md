...
### What are the differences among HDD cloud disk, Premium Cloud Storage, SDD, Enhanced SSD, and Tremendous SSD?

- **HDD cloud disk**: Tencent Cloud HDD cloud disk is an earlier generation cloud disk. It is suitable for use cases with low I/O load and infrequent access.
...
- **Enhanced SSD**: Enhanced SSD is based on Tencent Cloud’s latest storage engine and NVMe SSD storage media. It employs a three-copy distributed mechanism to provide high-performance storage with low latency, high random IOPS, high throughput I/O, and data security up to 99.9999999%, making it suitable for I/O-intensive applications with high requirements for latency, such as medium databases and NoSQL.
- **Tremendous SSD**: Tremendous SSD is based on Tencent Cloud’s latest storage engine, the latest Intel storage hardware and the latest network infrastructure. It employs a three-copy distributed mechanism to provide high-performance storage with ultra low latency, high random IOPS, high throughput I/O, and data security up to 99.9999999%. Tremendous SSD is suitable for I/O-intensive applications with high requirements for latency, such as large databases, NoSQL, KV, ES, and AI recommendation.

>?
>- Pricing of these cloud disk types varies with region. You can select the cloud disk that best suits your application requirements and budget. For pricing details, see [Price Overview](https://intl.cloud.tencent.com/document/product/362/2413).
...
When attaching a cloud disk, you can decide if it should be released with the instance automatically. This can be configured via the [CBS console](https://console.cloud.tencent.com/cvm/cbs/index) or [`ModifyDiskAttributes`](https://intl.cloud.tencent.com/document/product/362/15659) API.
