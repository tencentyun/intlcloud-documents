...
For more information about different types of cloud disks, see [Cloud Disk Types](https://intl.cloud.tencent.com/document/product/362/31636).
...
When mounting a cloud disk, you can decided if it should be released with the instance automatically. This can be configured via the [CBS Console] (https://console.cloud.tencent.com/cvm/cbs/index) or [ModifyDiskAttributes](https://intl.cloud.tencent.com/document/product/362/15659) API.
