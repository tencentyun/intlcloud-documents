...
CVM 인스턴스에 로그인하여 CVM 인스턴스 내부에서 CBS의 사용 현황과 남은 여유 공간을 확인할 수 있습니다. 혹은 CVM 콘솔을 통해 CBS의 사용 현황도 조회할 수 있습니다. 구체적인 조작 순서는 다음과 같습니다 :
...
3. 아래 이미지와 같이 인스턴스 상세 페이지에서 [모니터링] 탭을 선택하면 해당 인스턴스의 CBS 사용 현황을 조회할 수 있습니다.
![CVM 리스트 화면](https://main.qcloudimg.com/raw/25270ae80b513d497527a0e9f2af1bac.png)
