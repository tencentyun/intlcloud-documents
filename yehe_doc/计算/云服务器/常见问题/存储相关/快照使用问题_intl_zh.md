...
- 修改定期快照策略的保留时间属性为长期保留。当云硬盘的自动快照达到上限后，创建时间最早的自动快照会被自动删除。详细步骤请参见 [定期快照](https://intl.cloud.tencent.com/document/product/362/35238)。有关快照配额请参见 [使用限制](https://intl.cloud.tencent.com/document/product/362/32406)。
