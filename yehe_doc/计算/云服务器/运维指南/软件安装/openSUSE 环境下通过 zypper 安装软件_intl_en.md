Make sure that you have followed the steps in [Installing Software via YAST in SUSE Environment](https://intl.cloud.tencent.com/document/product/213/2047) install the necessary software.
