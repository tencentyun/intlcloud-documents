...
## Notes
1. SPP Notification Service in **Windows Server 2008** is used for activation. Make sure it runs properly, as shown in the following figure:
...
Tencent Cloud encapsulates a script for activating Windows servers, which simplifies automatic activation. To use the activation script, do as follows:
