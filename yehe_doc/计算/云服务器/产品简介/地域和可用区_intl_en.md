       ...
       <tr>
		...
		<tr>
		  	<td >Southeast Asia (Bangkok)<br>ap-bangkok </td>
				 <td >Bangkok Zone 1 (Nodes in Bangkok can cover Southeast Asia Pacific)<br>ap-bangkok-1</td>
		<tr>
...
<table>
	...
	<tr>
	<td> <a href="https://intl.cloud.tencent.com/document/product/213/4941?from_cn_redirect=1">Custom Images</a> </td>
	  <td>img-xxxxxxxx</td>
	  <td>Regional</td>
	...
	<tr>
	<td> <a href="https://intl.cloud.tencent.com/document/product/213/12452?from_cn_redirect=1">Security Groups</a> </td>
	  <td>sg-xxxxxxxx</td>
	  <td>Regional</td>
