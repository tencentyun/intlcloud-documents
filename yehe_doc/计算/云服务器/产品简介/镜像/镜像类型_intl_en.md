Tencent Cloud provides three types of images, namely public images, custom images, and shared images. You can select an image based on the following attributes:
