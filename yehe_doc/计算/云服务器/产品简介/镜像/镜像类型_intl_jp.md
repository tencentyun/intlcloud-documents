...
異なるソースに応じて、Tencent Cloudにはパブリックイメージ、カスタムイメージ、共有イメージという、イメージタイプが用意されています。
...
カスタムイメージの特徴：
 ...
 - **機能のサポート：**ユーザーによる自由な作成、コピー、共有および廃棄をサポートしています。
...
## 共有イメージ
**共有イメージ**は、他のTencent Cloudユーザーがイメージ共有機能を使用することにより、カスタムイメージを現在のユーザーと共有するものです。
共有されるイメージは、共有されたユーザーの元のイメージと同じリージョンで表示されます。

共有イメージの特徴
 - **ユースケース：**他のユーザーがCVMを素早く作成するために役立ちます。
 - **機能サポート：**共有イメージはCVMの作成にのみ使用され、名前の変更、コピー、共有等の他の操作を実行することはできません。
