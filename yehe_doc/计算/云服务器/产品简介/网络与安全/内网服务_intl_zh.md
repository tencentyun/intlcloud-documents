内网服务即局域网（LAN）服务，云服务之间经由内部链路互相访问。腾讯云上的云产品可以经由 [Internet 访问](https://intl.cloud.tencent.com/document/product/213/5224)，也可经由腾讯云内网互相访问。腾讯云机房均由底层万兆/千兆互联，提供带宽高、时延低的内网通信服务，且同地域下内网通信完全免费，帮助您灵活构建网络架构。
## 内网 IP 地址
### 概述
内网 IP 地址是无法通过 Internet 访问的 IP 地址，是腾讯云内网服务的实现形式。每个实例都具有分配内网 IP 的默认网络接口（即 eth0 ），内网 IP 地址可由腾讯云自动分配也可由用户自定义（仅在 [私有网络](https://intl.cloud.tencent.com/document/product/215/535) 环境下）。
...
### 地址分配
每个云服务器实例在启动时都会被分配一个默认的内网 IP 地址。针对不同的 [网络环境](https://intl.cloud.tencent.com/document/product/213/5227)，内网 IP 也有所不同：
...
<tr><td rowspan="14">基础网络</td><td rowspan="4">广州</td><td>广州一区：<br>10.112.65.31<br>10.112.65.32</td></tr>
...
- [获取实例内网 IP 地址和设置 DNS](https://intl.cloud.tencent.com/document/product/213/17941)
- [修改实例内网 IP 地址](https://intl.cloud.tencent.com/document/product/213/16561)
