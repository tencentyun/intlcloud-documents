...
[Linux CVM 사용자 정의 설정](/doc/product/213/10517#.E8.AE.BE.E7.BD.AE.E4.BF.A1.E6.81.AF) 시, CVM 암호화 로그인 방식으로 SSH 키를 선택할 수 있습니다.
...
- SSH 키 로그인 인증은 더욱 안전하고 신뢰할 수 있으며, 무차별 대입 공격을 막을 수 있습니다.
...
- CVM 보안 강화를 위해 인스턴스에 보안키를 바인딩한 뒤에는 비밀번호 로그인 방식의 사용이 제한됩니다.


## 사용 시나리오
- 키와 관련하여 생성, 바인딩/바인딩 해제, 삭제 등의 작업은 [SSH 키 관리](https://intl.cloud.tencent.com/document/product/213/16691)를 참조하십시오.
- SSH 키로 CVM 인스턴스에 원격 로그인하는 방법은 다음의 설명을 참조하십시오.
