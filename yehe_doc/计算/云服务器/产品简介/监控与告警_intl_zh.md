**监控与告警**是保证云服务器高可靠性、高可用性和高性能的重要部分。本文档概述为云服务器提供的监控与告警功能，更多详细内容可参见 [云监控产品文档](https://intl.cloud.tencent.com/document/product/248)。
...
更多内容请见 [云监控的基本功能](https://intl.cloud.tencent.com/document/product/248/32799#basic-features)。
...
- **告警设置：**可设置监控指标界限值，当到达条件时，及时发送告警信息至关心的群体中。详情参考 [创建告警策略](https://intl.cloud.tencent.com/document/product/248/38908)。
- **Dashboard 设置：**可针对监控指标设置 Dashbaord， 通过 Dashboard 动态分析指标异常原因。也可以实时观察指标变化情况，及时进行资源扩容。详情参考 [新建 Dashboard](https://intl.cloud.tencent.com/document/product/248/38468)。
