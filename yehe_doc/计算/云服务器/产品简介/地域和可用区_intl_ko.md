...
다음 리스트 혹은 API 인터페이스 [리전 리스트 조회](https://intl.cloud.tencent.com/document/product/213/15708)를 통해 전체 리전 리스트를 조회할 수 있습니다.

### 관련 특징

- 리전별로 네트워크는 완전히 격리됩니다. 리전 간 클라우드 서비스는 **기본적으로 개인 네트워크를 통해 접속이 불가능합니다**.
- 리전 간 클라우드 서비스는 [공용 IP](https://intl.cloud.tencent.com/document/product/213/5224)를 통해 Internet에 액세스하는 방식으로 통신합니다. 각기 다른 VPC의 클라우드 서비스는 더욱 빠르고 안정적인 [Cloud Connect Network](https://intl.cloud.tencent.com/document/product/1003)를 통해 통신합니다.
-[Cloud Load Balancer](https://intl.cloud.tencent.com/document/product/214)는 기본적으로 동일 리전의 트래픽 전달 및 소재 리전의 CVM 바인딩을 지원합니다. [크로스 리전 바인딩](https://intl.cloud.tencent.com/document/product/214/38441) 기능을 활성화 하면, CLB의 리전 간 CVM 바인딩을 지원합니다.
...
API 인터페이스 [가용존 리스트 조회](https://intl.cloud.tencent.com/document/product/213/35071)를 통해 전체 가용존 리스트를 조회할 수 있습니다.
...
<table class="table-striped">
	...
	<tr>
		...
		<tr>
			...
			<td>싱가포르1존(싱가포르 노드의 커버리지: 동남아시아 지역)<br>ap-singapore-1</td>
		</tr>
		<tr>
			<td>싱가포르2존(싱가포르 노드의 커버리지: 동남아시아 지역)<br>ap-singapore-2</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>자카르타 1존(자카르타 노드의 커버리지: 아시아 태평양 동남부 지역)<br>ap-jakarta-1</td>
		</tr>
		<tr>
			<td rowspan="2">아시아 태평양 동북부(서울)<br>ap-seoul</td>
			<td>서울1존(서울 노드의 커버리지: 동북아시아 지역)<br>ap-seoul-1</td>
		</tr>
		<tr>
			<td>서울2존(서울 노드의 커버리지: 동북아시아 지역)<br>ap-seoul-2</td>
		</tr>
		<tr>
			<td rowspan="2">아시아 태평양 동북부(도쿄)<br>ap-tokyo</td>
			<td>도쿄1존(도쿄 노드 가용존 커버리지: 동북아시아 지역)<br>ap-tokyo-1</td>
		</tr>
		<tr>
			<td>도쿄2존(도쿄 노드 가용존 커버리지: 동북아시아 지역)<br>ap-tokyo-2</td>
		</tr>
       <tr>
       ...
       <tr>
		...
		<tr>
			...
			<td >방콕1존(방콕 노드 사용자 커버리지: 동남 아시아 지역)<br>ap-bangkok-1</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>실리콘 밸리 1존(실리콘 밸리 노드의 커버리지: 미국 서부 지역)<br>na-siliconvalley-1</td>
		</tr>
    <tr>
			<td>실리콘 밸리 2존(실리콘 밸리 노드의 커버리지: 미국 서부 지역)<br>na-siliconvalley-2</td>
		</tr>
		<tr>
...
<table>
	...
	<tr>
	<td> <a href="https://intl.cloud.tencent.com/document/product/213/4941#custom-images">사용자 정의 이미지</a> </td>
	  <td>img-xxxxxxxx</td>
...
5. (옵션)기존 인스턴스가 [종량제](https://intl.cloud.tencent.com/document/product/213/2180)이었을 경우, 기존 인스턴스를 삭제할 수 있습니다. 자세한 내용은 [인스턴스 폐기](https://intl.cloud.tencent.com/document/product/213/4930)를 참고하시기 바랍니다.

### 이미지를 다른 리전에 복사합니다.

사용자의 인스턴스 실행, 조회 등 작업은 리전 속성을 구분합니다. 사용자가 실행하려는 인스턴스 이미지가 로컬에 존재하지 않을 경우, 이미지를 로컬에 복사해야 합니다. 자세한 내용은 [이미지 복사](http://intl.cloud.tencent.com/document/product/213/4943)를 참고하시기 바랍니다.
