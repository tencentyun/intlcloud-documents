...
Tencent Cloud CVM instances allow you to customize all resources, including CPU, memory, disk, and network, security. It also allows the easy adjustment of the resources to cope with any change in demand.

## Concepts

Before using CVM, you should be familiar with the following concepts:
- **Instance**: virtualized cloud computing resources such as CPU, OS, network, disks, and other basic components.
- **Instance Type**: CVM instance specifications with different CPU, RAM, storage, and networking configurations. For more information, refer to [Instance Types](https://intl.cloud.tencent.com/document/product/213/11518).
...
- **Elastic Public IP (EIP)**: static public network IP addresses designed especially for dynamic networks. EIPs are easy to troubleshoot.
...
## Quick Start Guides for Purchasing and Configuring CVM Instances

If you are a normal user and purchasing CVM instances for the first time, we recommend the following to get you started:
...
If you have specific needs our standard CVM specifications cannot meet, use the following guides to learn how to obtain custom configurations:
...
For pricing information on CVM instances and other resources, refer to [Pricing](https://buy.cloud.tencent.com/price/cvm/overview?lang=en).
