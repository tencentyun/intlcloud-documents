...
服务器迁移目前包含离线迁移和在线迁移，其中离线迁移包括以下两种：
...
- 目前腾讯云的服务器迁移支持的镜像格式有：qcow2、vhd、vmdk、raw。建议使用压缩的镜像格式，可以节省传输和迁移的时间。
...
- 准备需要迁入的云服务器或云硬盘。
 - [前往购买云服务器](https://buy.intl.cloud.tencent.com/cvm?tab=custom&step=1&devPayMode=spotpaid&regionId=8&templateCreateMode=createLt)
...
<dx-tabs>
::: 离线实例迁移[](id:cvmStep)
1. 登录云服务器控制台，单击左侧导航中的 **[服务器迁移](https://console.cloud.tencent.com/cvm/csm/index?rid=4)** 。
...
5. 单击**完成**，即可成功建立迁移任务。
迁移过程中您可退出或关闭 “[服务器迁移](https://console.cloud.tencent.com/cvm/csm/index?rid=4)” 页面，并可随时返回该页面查看迁移任务进度。 
