...
## 3. Mencadangkan Data
- Server sumber: Anda dapat menggunakan fitur snapshot VMWare atau menggunakan metode lain untuk mencadangkan data.
...
<table>
	...
	<tr><th>Server sumber Linux</th><td><ol style="margin: 0;"><li>Periksa dan instal Virtio. Untuk informasi selengkapnya, lihat <a href="https://intl.cloud.tencent.com/document/product/213/9929">Memeriksa Driver Virtio di Linux</a>.</li><li>Periksa apakah rsync dan grub2-install (atau grub-install) diinstal.</li><li>Periksa apakah SELinux diaktifkan. Nonaktifkan jika statusnya diaktifkan.</li><li>Pastikan waktu sistem saat ini sudah benar, karena Tencent Cloud API akan menggunakan stempel waktu UNIX untuk memeriksa token yang dihasilkan setelah menerima permintaan migrasi.</li><li>Pastikan bahwa layanan DHCP diaktifkan. Aktifkan jika statusnya nonaktif.</li></ol></td></tr>
</table>
