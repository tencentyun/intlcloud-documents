## Overview
This document introduces how to directly change the subnet of a CVM instance in VPC via the console.
...
and enter the primary ENI management page, as shown below:
...
6. Select a new subnet in the **Change Subnet** page. Enter a new IP, and click **OK**, as shown below:
