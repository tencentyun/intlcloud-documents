This document describes how to recover a Cloud Virtual Machine (CVM) instance from the recycle bin. For more information, see [Arrears](https://intl.cloud.tencent.com/document/product/213/2181). 

## Recycle Bin
Tencent Cloud recycle bin provides a CVM instance repossession mechanism as follows:
- **Pay-as-you-go instances**: the pay-as-you-go instance will enter the recycle bin after it is terminated by the user or at the scheduled time. If the account is in arrears, the pay-as-you-go instance will not enter the recycle bin. It will be released after the account has been in arrears for 2 hours and 15 days.
