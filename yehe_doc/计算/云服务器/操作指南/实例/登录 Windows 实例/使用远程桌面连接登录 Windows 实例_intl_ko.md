...
## 전제 조건
 ...
 - 비밀번호를 잊으신 경우, [인스턴스 비밀번호 리셋](https://intl.cloud.tencent.com/document/product/213/16566)하세요.
 - CVM 인스턴스가 이미 공인 IP를 구매했고, 해당 인스턴스가 CVM 인스턴스의 3389번 포트가 활성화한 상태여야 합니다(빠른 설정을 통해 구매한 CVM 인스턴스는 기본으로 활성화되어 있습니다).
...
[공인 IP 주소 가져오기](https://intl.cloud.tencent.com/document/product/213/17940)를 참조하여 서버의 공인 IP를 가져올 수 있습니다.
