...
- **云 API**：[RunInstance 接口](https://intl.cloud.tencent.com/document/product/213/33237) 已增加竞价实例相关参数。
...
### 云 API
RunInstance 接口内的 [InstanceMarketOptionsRequest](https://intl.cloud.tencent.com/document/api/213/15753#InstanceMarketOptionsRequest) 参数可指定使用竞价实例模式和配置相关信息。
