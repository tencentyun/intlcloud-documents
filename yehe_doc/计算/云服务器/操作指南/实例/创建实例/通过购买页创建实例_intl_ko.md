...
- [Tencent Cloud 계정 생성](https://intl.cloud.tencent.com/document/product/378/17985) 후 [실명 인증](https://intl.cloud.tencent.com/document/product/378/3629)을 완료해야 합니다.
...
1. [Tencent Cloud 공식 사이트](https://cloud.tencent.com)에 로그인하고 [제품]>[기본]>[컴퓨팅]>[CVM](https://intl.cloud.tencent.com/product/cvm)을 선택한 뒤, [구매하기]를 클릭하여 CVM 구매 페이지로 이동합니다.
 - **[사용자 정의 구성](https://buy.cloud.tencent.com/cvm?tab=custom): **사용자의 요구에 맞게 CVM 인스턴스를 선택하여 구매할 수 있으므로, 특정 시나리오에 사용하기 적합합니다.
...
<tr><td>공용 네트워크 대역폭</td><td>필수</td><td>독립된 공인 IP가 무료로 할당됩니다.</br>Tencent Cloud은 다음의 두 가지 네트워크 과금 방식을 제공하므로, 실제 필요에 따라 0Mbps보다 큰 값을 설정하시기 바랍니다.<ul><li><b>대역폭 과금</b>: 고정 대역폭을 선택하여, 해당 대역폭을 초과할 시 패킷 손실이 있으며, 네트워크 변동이 적은 시나리오에 적합합니다.</li><li><b>트래픽 과금</b>: 실제 트래픽 사용량에 따라 과금됩니다. 대역폭 피크 값을 제한하여 예기치 않은 트래픽으로 인한 비용을 방지할 수 있으며, 순간 대역폭이 해당 값을 초과할 시 패킷이 손실이 있으며, 네트워크 변동이 큰 시나리오에 적합합니다.</li></ul><b>주의 사항</b>: 무료로 할당된 공인 IP 주소는 인스턴스와의 바인딩을 해제할 수 없습니다. 해당 IP 주소와의 바인딩 해제를 원하실 경우, 공인 IP를 EIP로 변경하여 바인딩을 해제하실 수 있습니다. EIP에 대한 더 자세한 설명은 <a href="https://intl.cloud.tencent.com/document/product/213/5733">EIP</a>를 참조 바랍니다.</td></tr>
<tr><td>공용 게이트웨이</td><td>선택</td><td>Linux 관련 이미지에만 사용됩니다.</br>공용 게이트웨이란 VPC와 공용 네트워크의 인터페이스로, VPC의 다른 서브넷에서 공인 IP가 없는 CVM 요청을 포워딩할 수 있습니다.</br><b>주의 사항: </b>2019년 12월 6일부터 Tencent Cloud는 CVM 구매 페이지에서의 공용 게이트웨이 구성 선택을 지원하지 않습니다. 필요한 경우 <a href="https://intl.cloud.tencent.com/document/product/213/34835">공용 게이트웨이 구성</a>을 참조하여 직접 구성하실 수 있습니다.</td></tr> 
...
<tr><td>보안 그룹</td><td>필수</td><td><ul><li>사용 가능한 보안 그룹이 없을 경우 [보안 그룹 생성]을 선택하실 수 있습니다.</li><li>사용 가능한 보안 그룹이 있을 경우 [기존 보안 그룹]을 선택하실 수 있습니다.</li></ul>보안 그룹에 대한 더 자세한 설명은 <a href="https://intl.cloud.tencent.com/document/product/213/12452">보안 그룹</a>을 참조 바랍니다.</td></tr>
