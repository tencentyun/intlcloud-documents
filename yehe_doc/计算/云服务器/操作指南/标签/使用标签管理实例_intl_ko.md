...
2. 인스턴스 관리 페이지에서 태그를 편집할 인스턴스를 선택하고 [더욱 많은]>[인스턴스 설정]>[태그 편집]을 클릭합니다.
2. 팝업된 "클라우드 리소스 1개를 선택하였습니다" 창에서 태그를 설정합니다. 
...
태그 키로 인스턴스를 필터링하려면 다음 절차를 따르세요.

1. 검색창에서 [태그 키]를 선택합니다.
2. [태그 키:] 뒤에 태그 키를 입력하고 <img src="https://main.qcloudimg.com/raw/3cca38f08eaa87087cdd1b81eaf08a0a.png" style="margin: 0;">을 클릭하여 검색합니다. 
여러 개의 태그 키를 통해 동시에 필터링할 수 있습니다. 예를 들어, 검색창에 `태그 키：key1|key2`라고 입력하면 태그 키: `key1` 또는 `key2`로 바인딩되어 있는 인스턴스를 필터링할 수 있습니다.
