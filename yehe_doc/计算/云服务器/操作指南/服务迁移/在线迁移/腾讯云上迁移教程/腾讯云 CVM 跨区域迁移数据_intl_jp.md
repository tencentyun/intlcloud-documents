リージョン間のデータマイグレーションでは、Tencent CloudのあるリージョンのあるアベイラビリティゾーンにあるCVMのデータを、別のリージョンのアベイラビリティゾーンにあるターゲットCVMにマイグレーションします。または、Tencent Cloudの同じリージョン内の異なるアベイラビリティゾーンにあるCVM間でデータマイグレーションを実行することもできます。
