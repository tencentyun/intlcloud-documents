リージョン間のデータ移行は、Tencent CloudのあるリージョンのあるアベイラビリティゾーンにあるCVMのデータを、別のリージョンのアベイラビリティゾーンにあるターゲットCVMに移行します。または、Tencent Cloudの同じリージョン内の異なるアベイラビリティゾーンにあるCVM間でデータ移行を実行することもできます。
...
## 3. データのバックアップ
- [スナップショットの作成](https://intl.cloud.tencent.com/document/product/362/5755) などの方法でデータをバックアップできます。
