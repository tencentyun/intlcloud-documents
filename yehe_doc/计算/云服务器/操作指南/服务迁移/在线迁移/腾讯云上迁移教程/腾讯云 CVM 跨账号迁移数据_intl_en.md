The online migration tool supports migrating Tencent Cloud CVM data across accounts. You can use the cross-account data migration to move data between CVMs under two different accounts.
...
5. Run the tool.
Take cross-account migration in [private network mode: scenario 1](https://intl.cloud.tencent.com/document/product/213/35640) as an example:  
