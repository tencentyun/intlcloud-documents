...
```
For example, you are using the [private network mode: scenario 2](https://intl.cloud.tencent.com/document/product/213/35640) for migration. If the following appears on the console, the migration is successful.
