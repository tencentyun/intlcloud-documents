...
## 前提条件
現在、リザーブドインスタンスはベータ版ユーザーにのみ提供されています。リザーブドインスタンスページにアクセスし、利用資格を申請してください。
