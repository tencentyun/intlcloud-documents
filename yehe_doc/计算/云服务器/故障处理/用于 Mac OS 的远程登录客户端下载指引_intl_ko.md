...
- 테스트 버전 원격 로그인 클라이언트
Microsoft는 Mac을 위한 테스트 버전 클라이언트를 제공하고 있으며, 사용자는 [Microsoft Remote Desktop for Mac](https://rink.hockeyapp.net/apps/5e0c144289a51fca2d3bfa39ce7f2b06/)으로 이동하여 다운받을 수 있습니다. 해당 테스트 버전 클라이언트는 Microsoft에서 유지 및 점검하므로, 해당 버전의 클라이언트(Microsoft는 2017년에 공식 홈페이지에서 제공하던 다운로드 링크를 삭제하고, 자회사인 HockeyApp의 페이지를 통해 Beta 버전을 배포하고 있습니다)를 우선 사용할 것을 권장합니다.
>! 중국대륙 지역의 사용자는 네트워크 상황으로 인해 액세스할 수 없거나 액세스가 느릴 수 있습니다.
>
- [Mac App Store](https://itunes.apple.com/us/app/microsoft-remote-desktop/id715768417)에 이동하여 Microsoft 원격 데스크톱 클라이언트를 다운로드합니다.
