...
ここでのインターネットドメイン名解決サービスは、特に再帰的な解決サービスを指します。詳細については [『電気通信業務分類ディレクトリ（2015年版）』：B26-1  インターネットドメイン名解決サービス](http://www.miit.gov.cn/n1146285/n1146352/n3054355/n3057709/n3057714/c4564270/content.html)をご参照ください。
