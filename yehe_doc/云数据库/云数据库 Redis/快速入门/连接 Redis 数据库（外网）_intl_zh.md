...
4. 在访问端通过外网地址（本示例即26.xx.xx.2:10001）连接内网 Redis 实例，连接命令与内网连接命令一致，命令请参见 [连接实例](https://intl.cloud.tencent.com/document/product/239/9897#.E8.BF.9E.E6.8E.A5.E5.AE.9E.E4.BE.8B)。
