...
## Audit Operations
### Enabling SQL audit
1. Log in to the [TDSQL-C console](https://console.cloud.tencent.com/dls/cynosdb/instance), select **Database Audit** on the left sidebar, select the corresponding region at the top, and click the **Audit Log** tab.
2. On the **Audit Log** tab, enable the SQL audit service.
...
## SQL Audit Fields
The following fields are supported in TDSQL-C audit logs. You can click the following icon on the **Audit Log** tab in the [TDSQL-C console](https://console.cloud.tencent.com/dls/cynosdb/instance) to get and view the complete SQL audit logs.
