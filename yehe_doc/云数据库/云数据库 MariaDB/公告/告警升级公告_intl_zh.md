## 背景
云数据库 MariaDB 于2021年04月01日起，对主机以及组件服务监控项进行了升级，对旧的告警策略类型进行了替换，覆盖了数百监控项指标和告警指标，您可以在云监控 [MariaDB](https://intl.cloud.tencent.com/document/product/248/40015) 策略类型下配置告警策略。
...
2. 配置新告警策略。
  ...
  2. 在新建告警策略页面，“策略类型”选择【MariaDB】，根据步骤1下载的策略进行告警配置，配置方法可参考 [配置告警](https://intl.cloud.tencent.com/document/product/248/38916)。
