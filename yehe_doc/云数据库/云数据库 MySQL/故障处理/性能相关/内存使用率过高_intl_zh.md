...
## 处理步骤
1. 优化慢 SQL，减少 session 级的私有内存使用量。可以通过 DBbrian [对慢 SQL 进行分析](https://intl.cloud.tencent.com/document/product/1035/36038)。
2. 减少无效的长连接，在不影响业务的情况下，降低程序侧的连接池配置或者降低程序侧的并发度。可以通过 DBbrian [查看当前会话信息](https://intl.cloud.tencent.com/document/product/1035/36037)。
