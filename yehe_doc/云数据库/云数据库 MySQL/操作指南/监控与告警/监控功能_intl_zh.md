...
>?
>- 您也可以通过云监控 API 中的 [拉取指标监控数据](https://intl.cloud.tencent.com/document/product/248/39306)、[云数据库 MySQL 监控指标](https://intl.cloud.tencent.com/zh/document/product/248/11006)  来获取实例的监控指标。
...
>?更多云数据库监控指标的使用方法，请参见云监控 API 中的 [云数据库 MySQL 接口](https://intl.cloud.tencent.com/zh/document/product/248/11006)。
