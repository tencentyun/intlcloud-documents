...
## SQL Window
Log in to [DMC](https://bj-dmc.cloud.tencent.com/v2/qcloudLogin/login), select **SQL Window** on the navigation bar at the top, or click **SQL Operation** on the **Operation** menu on the left sidebar to access the SQL window, where you can perform the following operations:
