...
## 新建库表
1. 登录 [DMC 控制台](https://dms.cloud.tencent.com/#/login)，在导航栏选择【新建】>【新建库】>【新建数据库】或【新建】>【新建表】。
...
## SQL 窗口
登录 [DMC 控制台](https://dms.cloud.tencent.com/#/login)，单击顶部导航中的【SQL 窗口】，或者左侧栏表格“操作”菜单中的【SQL 操作】进入SQL 窗口页面。SQL 窗口支持如下功能：
- SQL 命令执行及结果查看
- SQL 格式优化
- 查看 SQL 命令执行计划
- 常用 SQL 保存
...
## 数据管理
登录 [DMC 控制台](https://dms.cloud.tencent.com/#/login)，在导航栏选择【数据管理】>【数据导入】或【数据导出】，可对数据库进行数据导入导出操作。
