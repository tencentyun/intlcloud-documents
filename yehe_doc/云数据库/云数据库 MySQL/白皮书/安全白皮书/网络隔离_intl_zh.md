云数据库 MySQL 支持使用私有网络来实现更高程度的网络隔离控制，搭配使用 [安全组](https://intl.cloud.tencent.com/document/product/236/14470) 和 [私有网络](https://intl.cloud.tencent.com/document/product/236/8468) 将极大提升访问 MySQL 实例的安全性。
