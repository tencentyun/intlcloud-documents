...
>?本教程中使用到的云数据库实例和云服务器实例处于同一地域下，如果您的云数据库实例和云服务器实例不处于同一地域下，请参见 [外网访问](https://intl.cloud.tencent.com/document/product/236/3130)。

### 初始化云数据库实例
云数据库的购买和初始化请参见 [购买方式](https://intl.cloud.tencent.com/document/product/236/5160) 和 [初始化 MySQL 数据库](http://intl.cloud.tencent.com/document/product/236/3128)。

### 登录云服务器实例
云服务器的购买和访问请参见 [快速入门 Linux 云服务器](http://intl.cloud.tencent.com/document/product/213/2936)，本教程中使用的是 CentOS 系统。
