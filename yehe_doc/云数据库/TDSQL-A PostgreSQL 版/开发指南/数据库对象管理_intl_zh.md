...
TDSQL-A PostgreSQL版 包括了相当多的内建数据类型，可以适用于很多应用。用户也可以定义他们自己的数据类型。大部分内建数据类型有着显而易见的名称和语义，详细解释参见 [数据类型](https://intl.cloud.tencent.com/document/product/1099/40796)。
