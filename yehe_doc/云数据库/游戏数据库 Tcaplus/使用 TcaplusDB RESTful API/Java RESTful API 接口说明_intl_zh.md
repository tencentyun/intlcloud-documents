...
- 通过 [SDK 下载](https://intl.cloud.tencent.com/document/product/1016/30285) Java RESTful API SDK 安装包。
...
## 使用步骤
上传整个 SDK 包`tcaplusdb-restapi-java-sdk-1.0-assembly.zip` 到 CVM 目录，请参见 [如何将本地文件拷贝到云服务器](https://intl.cloud.tencent.com/document/product/213/34821)，解压后目录名`tcaplusdb-restapi-java-sdk-1.0`。
