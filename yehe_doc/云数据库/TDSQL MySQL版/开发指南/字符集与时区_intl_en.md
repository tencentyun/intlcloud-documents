...
**TDSQL supports all character sets and character sequences of MySQL on the backend storage. The following examples are just for illustration and do not mean that the ones supported by TDSQL are different from those supported by MySQL.**
```
...
>TDSQL does not support setting parameters on the command line. Instead, you need to set them in the console.
