...
1. 通过 [云数据库 MySQL 控制台](https://console.cloud.tencent.com/cdb) 下载备份文件，详细操作请参见 [下载备份文件](https://intl.cloud.tencent.com/document/product/236/31910)。
...
更多字符集编码问题，请参考 [使用限制](https://intl.cloud.tencent.com/document/product/236/7259) ，字符集说明。
