## 前期准备 
在开始创建数据作业前，您需先完成数据访问策略配置，以保证数据作业能安全的访问您的数据。配置步骤请参见 [配置数据访问策略](https://intl.cloud.tencent.com/document/product/1155/49494)。
...
| CAM Role arn	| 在作业配置中配置的数据访问策略，指定了数据作业可访问的数据范围。详细配置说明参见 [配置数据访问策略](https://intl.cloud.tencent.com/document/product/1155/49494)|
