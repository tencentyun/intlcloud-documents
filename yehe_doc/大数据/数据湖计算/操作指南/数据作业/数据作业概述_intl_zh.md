...
## 使用准备
在开始使用数据作业前，为了保证您的数据安全，您需要先创建数据访问策略，详细配置说明请参见 [配置数据访问策略](https://intl.cloud.tencent.com/document/product/1155/49494)。
同时，我们支持使用 Ckafka 作为数据源进行数据作业配置。后续我们也将持续丰富数据源支持，为您提供更全面的数据作业使用场景。

## 计费模式
数据作业将根据使用数据引擎进行计费，目前支持按量计费和包年包月两种模式。详情可参见 [数据引擎说明](https://intl.cloud.tencent.com/document/product/1155/48681)。
...
2. 单击**创建数据作业**按钮，即可创建新的数据作业，详细步骤请参见 [创建数据作业](https://intl.cloud.tencent.com/document/product/1155/49495)。
3. 在列表内可以查看数据作业当前任务的状态，同时支持管理数据作业，详细步骤请参见 [管理数据作业](https://intl.cloud.tencent.com/document/product/1155/49496)。
