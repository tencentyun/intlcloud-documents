数据湖计算 DLC 的独享数据引擎目前支持按量计费及包年包月两种付费模式，详细价格参见：[计费概述](https://intl.cloud.tencent.com/document/product/1155/48652)。
...
- 标签：支持对购买资源进行标签分类及分账，详细可参见：[为独享引擎资源关联标签](https://intl.cloud.tencent.com/document/product/1155/48685) 文档。
