...
### 操作步骤
1. 登录 [标签控制台](https://console.cloud.tencent.com/tag) 创建标签，具体操作参考 [创建标签并绑定资源](https://intl.cloud.tencent.com/document/product/651/41575)。
...
3. 设置分账标签。前往 [费用中心](https://console.cloud.tencent.com/expense/overview) 设置设置分账标签，详见 [分账标签](https://intl.cloud.tencent.com/document/product/555/32276)。
