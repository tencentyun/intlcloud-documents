...
## 使用前准备
- 获取 EMR Hive 地址。
- 使用具备创建数据目录权限的账号，详细权限请参见 [DLC 权限概述](https://intl.cloud.tencent.com/document/product/1155/48665)。
...
>
![]()
4. 选择运行集群，目前仅支持选择Presto的独享数据引擎，如无对应引擎可至数据引擎页进行数据引擎创建。购买流程请参见 [购买独享数据引擎](https://intl.cloud.tencent.com/document/product/1155/48682)。
