...
若您是首次登录的子账号，除了必要的 CAM 授权，还需要请任意 DLC 管理员或主账号管理员在 DLC 控制台左侧**权限管理**菜单，为您授予必要的 DLC 权限（详细权限说明参见 [DLC 权限概述](https://intl.cloud.tencent.com/document/product/1155/48665)：
...
详细权限授予步骤参见 [子账号权限管理](https://intl.cloud.tencent.com/document/product/1155/48667)。
...
>
![]()
	- step3: 如果没有分区可以跳过此步骤，合理的分区可以帮助提升分析性能。详细分区信息可参见 [查询分区表](https://intl.cloud.tencent.com/document/product/1155/48671)。
![]()
