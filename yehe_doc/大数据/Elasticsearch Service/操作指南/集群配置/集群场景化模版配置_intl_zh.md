...
## 使用须知
选择场景化索引模板前请注意：
- 腾讯云 ES 集群内已有为大部分场景优化的 [默认索引模板](https://intl.cloud.tencent.com/document/product/845/32607)，模板名为`default@template`，您可以在 Kibana 界面的【Dev Tools】中通过命令`GET _template/default@template`查看这个模板。
