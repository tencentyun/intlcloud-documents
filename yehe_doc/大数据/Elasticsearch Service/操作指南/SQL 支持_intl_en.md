...
For more information on the API of the native SQL parser and how to use it, please see [SQL REST API](https://www.elastic.co/guide/en/elasticsearch/reference/6.4/sql-rest.html).
...
For more information on the API of the SQL plugin and how to use it, please see [here](https://github.com/NLPchina/elasticsearch-sql/blob/master/README.md).

### SQL JDBC Access
Access to ES clusters through JDBC is supported in the Platinum Edition of ES 6.4.3 and above. You need to download the JDBC driver first [here](https://www.elastic.co/downloads/jdbc-client) or by adding the following dependencies in Maven:
