...
![](https://qcloudimg.tencent-cloud.cn/raw/59a6f3b25cd981029e7b8302c310a569.png)
...
<th width=15%>Task</th>
<th width=15%>ES (OpenJDK + CMS-GC)</th>
<th width=15%>ES (Kona JDK + G1-GC)</th>
<th width=20%>Difference Value (Kona JDK - OpenJDK)</th>
<th width=5%>Unit</th>
<th width=5%>Comparison</th>
</tr>
</thead>
<tbody>
<tr>
...
<td >Write throughput and time</td>
...
<td >Default query with all documents having a score of 1 (match_all)</td>
<td >Min Throughput</td>
<td >default</td>
<td >49.66239789</td>
<td >49.88425331</td>
...
<td >Aggregation query without cache</td>
<td >error rate</td>
<td >phrase</td>
<td >0</td>
<td >0</td>
...
<td >Aggregation query with cache</td>
<td >Min Throughput</td>
...
<td >Script query (using expression script)</td>
<td >Min Throughput</td>
<td >expression</td>
<td >1.500956979</td>
<td >1.501441158</td>
...
<td >Script query (using painless static script without dynamically getting field values)</td>
<td >Min Throughput</td>
...
<td >Script query (using painless static script with dynamically getting field values)</td>
<td >Min Throughput</td>
...
<td >Geographic range query (based on Gaussian decay function)</td>
<td >Min Throughput</td>
...
<td >Geographic range query (based on Gaussian decay function with dynamically getting field values through script)</td>
<td >Min Throughput</td>
...
<td >Custom scoring function query (defining function based on field value)</td>
<td >Min Throughput</td>
...
<td >Custom scoring function query (dynamically getting field values through script to calculate scores)</td>
<td >Min Throughput</td>
...
<td >Large filtered terms query</td>
<td >Min Throughput</td>
...
<td >Large prohibited terms query</td>
<td >Min Throughput</td>
...
<td >search_after query with sorting in ascending order</td>
<td >Min Throughput</td>
...
<td >Query with sorting high base fields in descending order (quickly getting topK based on DistanceFeatureQuery)</td>
<td >Min Throughput</td>
...
<td >search_after query with sorting high base fields in descending order</td>
<td >Min Throughput</td>
...
<td >Query with sorting high base fields in ascending order (quickly getting topK based on DistanceFeatureQuery)</td>
<td >Min Throughput</td>
...
<td >search_after query with sorting high base fields in ascending order</td>
<td >Min Throughput</td>
