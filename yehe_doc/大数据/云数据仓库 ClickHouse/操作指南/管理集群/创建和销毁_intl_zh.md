## 新建集群
在 [云数据仓库 ClickHouse 介绍页](https://intl.cloud.tencent.com/product/cdwch)，单击**立即购买**。或登录 [云数据仓库 ClickHouse 控制台](https://console.cloud.tencent.com/cdwch)，单击**新建集群**。进入购买页，根据页面提示，进行配置并购买。详情可参考 [快速入门](https://intl.cloud.tencent.com/document/product/1129/44393)。
