...
4. 通过控制台新建成功的字典表会默认添加到云数据仓库的全局库 **cdwch_{instanceId}_dictionary_database**中。
...
2. 可在当前页面查看已有的外部字典列表
![](https://qcloudimg.tencent-cloud.cn/raw/e88604b2a27856eb5b084ab0e3c814bc.png)3. 可以单击左上角**新增字典**创建新的外部字典，根据提示填写字典的各项信息，单击**确认**提交外部字典创建申请。
<table>
<thead>
<tr>
<th width=15%>参数项</th>
