...
### 集群监控
登录 [云数据仓库 控制台](https://console.cloud.tencent.com/cdwch) 在**集群列表**中选中对应的集群，单击集群 **ID/名称**进入集群详情页，单击**集群监控**查看集群的各项性能指标。
...
3. 配置结束单击**完成**即提交告警策略，具体云监控的告警策略可参考 [云监控-新建告警策略](https://intl.cloud.tencent.com/document/product/248/38916)。
