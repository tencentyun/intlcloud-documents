...
## Airflow 默认安装
1. 购买 [云服务器](https://buy.intl.cloud.tencent.com/cvm)。
>!本文以 CentOS 8.0 为例。
...
1. 购买 [云数据库 MySQL](https://buy.intl.cloud.tencent.com/cdb?regionId=1&zoneId=100004&engineVersion=5.7&cdbType=Z3&memory=8000&cpu=4&volume=200&protectMode=0&netType=2&securityGroupId=sg-i0td4ogd&vpcId=1426914&subnetId=995385&goodsNum=1)
>!必须是高可用版或者金融版，基础版由于不支持 explicit_defaults_for_timestamp 参数，因此无法作为 Airflow 的存储。
2. 修改参数
在控制台修改参数 explicit_defaults_for_timestamp 为 ON。
3. 创建 DB 及用户
