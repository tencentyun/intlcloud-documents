...
```
4. 通过外表导入，详细可以参考 [使用外表](https://intl.cloud.tencent.com/document/product/1138/45032) 查看外表导入的方法。
5. 通过插件从 TencentDB 中导入，详细可以参考 [导入外部数据](https://intl.cloud.tencent.com/document/product/1138/45035)。
...
按照 [访问数据仓库](https://intl.cloud.tencent.com/document/product/1138/45128) 方法访问数据库后，即可进行数据查询操作。示例如下：
