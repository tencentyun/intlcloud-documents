...
```
详细信息可以参考 EMR 文档 [基于对象存储 COS 的数据仓库](https://intl.cloud.tencent.com/document/product/1026/31151)。
4. 将本地数据导入 COS
```
...
FORMAT 'csv';
```
详细内容可以参见 [使用外表高速导入或导出 COS 数据](https://intl.cloud.tencent.com/document/product/1138/45032)。
