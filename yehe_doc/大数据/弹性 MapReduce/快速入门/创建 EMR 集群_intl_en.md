...
**High Availability**: High availability is enabled by default. The deployed number of different types of nodes varies by cluster type and use case under HA or non-HA mode. For more information, see [Cluster Types](https://intl.cloud.tencent.com/document/product/1026/31094).
...
**Hive Metadatabase**: When you choose to deploy the Hive component, there are two storage options for Hive metadata: you can store the metadata in a MetaDB instance separately purchased for the cluster (default option) or associate the metadata with EMR-MetaDB or a self-built MySQL database. In the latter case, metadata will be stored in the associated database and will not be deleted when the cluster is terminated.
...
- **Cluster management**: [Setting Tag](https://intl.cloud.tencent.com/document/product/1026/34532), [Bootstrap Action](https://intl.cloud.tencent.com/document/product/1026/34521), and [Cluster Termination](https://intl.cloud.tencent.com/document/product/1026/31106)
