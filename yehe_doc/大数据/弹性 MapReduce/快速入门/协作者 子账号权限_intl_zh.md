可在控制台中对各协作者/子账号进行权限授权，授权方法请参见 [访问管理](https://intl.cloud.tencent.com/document/product/598/10602)。
...
| QcloudEMRFullAccess（全读写访问权限）| 扩容<br>缩容<br>创建新集群<br>销毁集群<br>更改密码 |
