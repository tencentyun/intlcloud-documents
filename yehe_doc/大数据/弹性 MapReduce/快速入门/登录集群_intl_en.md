...
2. Launch the PuTTY client, enter the following in the PuTTY Configuration window, and click **Open** to create a session as shown below:
 ...
 - **Port**: The port number of the CVM instance, which has to be 22. Please make sure that the port 22 in the CVM instance is opened. For more information, please see [Security Group](https://intl.cloud.tencent.com/document/product/213/12452) and [Network ACL](https://intl.cloud.tencent.com/document/product/215/5132).
