...
| QcloudCamRoleFullAccess   | 用户与权限（CAM）角色全读写访问权限      | 否      | 用于自定义服务角色，对产品间数据访问进行细粒度权限控制，详见 [自定义服务角色](https://intl.cloud.tencent.com/document/product/1026/39661) |
...
3. 主账号和子用户以及协作者，授权 QcloudAccessForEMRRole 和 QcloudAccessForEMRRoleInApplicationDataAccess 策略，同步骤2即可。
...
### 自定义服务角色
EMR 主账号或具有 QcloudCamRoleFullAccess 权限的协作者以及子用户，可以精准控制 COS 存储桶权限以及其他云资源权限，详见 [自定义服务角色](https://intl.cloud.tencent.com/document/product/1026/39661)。
