...
**资源级和接口级授权**：您可以通过策略语法给子账号单个资源的管理的权限，详细请参考[授权粒度方案](https://intl.cloud.tencent.com/document/product/1026/44862)。

**按标签授权**：您可以通过给资源标记标签，实现给子账号对应的标签下资源的管理权详细请参考[授权粒度方案](https://intl.cloud.tencent.com/document/product/1026/44862)。
