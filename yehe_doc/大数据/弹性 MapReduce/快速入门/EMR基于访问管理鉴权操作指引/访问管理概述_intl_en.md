...
**Resource-level and API-level authorization**: You can use policy syntax to grant sub-accounts permissions to manage individual resources. For more information, see [Authentication Granularity Scheme](intl.cloud.tencent.com/document/product/1026/44862).

**Authorization by tag**: You can tag resources and grant sub-accounts permissions to manage resources with particular tags. For more information, see [Authentication Granularity Scheme](https://intl.cloud.tencent.com/document/product/1026/44862).
