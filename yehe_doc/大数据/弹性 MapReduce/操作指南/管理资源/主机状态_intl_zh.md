## 功能介绍
主机状态页面展示了当前集群所有主机监控概览和所有节点列表，并支持查看所有主机热点图；用户可以在日常使用中，可以在 EMR 控制台管理主机的状态及指标信息。
## 操作步骤
1.	登录 [EMR 控制台](https://console.cloud.tencent.com/emr)，在【集群列表】中选择对应的集群点击【详情】进入集群详情页。
2.	选择【集群资源】>【主机状态】可查看集群中所有主机监控信息。
