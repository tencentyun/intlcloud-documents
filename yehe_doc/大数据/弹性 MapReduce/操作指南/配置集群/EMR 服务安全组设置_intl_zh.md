...
## 使用限制与规则
有关安全组的使用限制及配额，可参见 [使用限制总览](https://intl.cloud.tencent.com/document/product/213/15379) 中的安全组相关限制。
...
更多安全组的介绍请参见 [安全组](https://intl.cloud.tencent.com/document/product/213/12452)。
