...
3.	Taking HDFS NameNode active/standby switch as an example, in **Cluster Service**, select **HDFS** > **Operation** > **NN Active/Standby Switch** to perform the active/standby switch operation.
