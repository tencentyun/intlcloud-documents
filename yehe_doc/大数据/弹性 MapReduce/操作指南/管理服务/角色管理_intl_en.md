## Feature Overview
Role management provides OPS and operation features at the service role level. You can restart, pause, and maintain cluster service roles at the server level. Role status can be monitored to help you stay on top of the real-time status of role processes.
### Glossary
...
3. The **Service Status** column displays whether the current service is **running** or **paused**, and the **Maintenance Status** column displays whether the current service is under maintenance.
![](https://main.qcloudimg.com/raw/82e8bdb02d8e74295daa21a892f8937f.png)
