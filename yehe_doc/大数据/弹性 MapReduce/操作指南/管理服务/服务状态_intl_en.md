...
4. **Service Overview** intuitively displays the metrics and their statistical rules of service components in the corresponding time period. The system displays a maximum of 6 metrics by default. You can click "Set Metric" on the right to customize the displayed metrics.
