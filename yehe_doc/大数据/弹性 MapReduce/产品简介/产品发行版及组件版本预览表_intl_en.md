...
| Component Name| EMR v2.7.0| EMR v2.6.0| EMR v2.5.1| EMR v2.5.0| EMR v2.4.0| EMR v2.3.0| EMR v2.2.0| 
| :------------------------- |  :---------- | :---------- | :---------- | :---------- | :---------- | :---------- | :---------- | 
| Release Date	| July 2022 | July 2021	| April 2021| 	September 2020	| August 2020| 	May 2020| 	March 2020| 
| HDFS (required)	| 2.8.5| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5| 
| YARN (required)	| 2.8.5| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5	| 2.8.5| 
| ZooKeeper (required)	| 3.6.3| 3.6.1	| 3.6.1	| 3.6.1	| 3.6.1	| 3.5.5	| 3.5.5| 
| OpenLDAP (required)	|2.4.44| 2.4.44	| -	| -	| -| 	-| 	-| 
| Knox (required)	|1.6.1| 1.2.0	| 1.2.0	| 1.2.0	| 1.2.0| 	1.2.0	| 1.2.0| 
| Tez	|0.10.1| 0.9.2	| 0.9.2| 	0.9.2	| 0.9.2| 	0.9.2	| 0.9.2| 
| Hive	| 2.3.9|2.3.7| 	2.3.7| 	2.3.7	| 2.3.7	| 2.3.5| 	2.3.5| 
| Spark	|3.2.1| 3.0.2	| 3.0.0	| 3.0.0	| 3.0.0	| 2.4.3	| 2.4.3| 
| Livy	|0.8.0| 0.8.0	| 0.7.0	| 0.7.0| 	0.7.0	| 0.7.0	| 0.7.0| 
| Kyuubi	| 1.4.1|1.4.1|1.4.1| 	-| 	-| 	-	| -| 	-| 
| Kylin	|4.0.1| 2.5.2	| 2.5.2	| 2.5.2| 	2.5.2	| 2.5.2	| 2.5.2| 
| Presto	| -	| -| -	| -| 	-| 	0.228| 	0.228| 
| Trino (PrestoSQL)	|385| 332	| 332| 	332| 	332| 	-| 	-| 
| Kudu	|1.15.0| 1.12.0	| 1.12.0| 	1.12.0	| 1.12.0	| -| 	-| 
| Impala	|3.4.0| 3.4.0	| 2.10.0| 	2.10.0	| 2.10.0| 	2.10.0| 	2.10.0| 
| Storm	| 1.2.3|1.2.3	| 1.2.3	| 1.2.3| 	1.2.3	| 1.2.3	| 1.2.3| 
| Flink	| 1.14.3|1.12.1	| 1.10.0	| 1.10.0	| 1.10.0	| 1.9.2	| 1.9.2| 
| HBase	| 2.4.5|1.4.9	| 1.4.9	| 1.4.9| 	1.4.9	| 1.4.9	| 1.4.9| 
| Phoenix (integrated in HBase) | 5.1.2|	4.14.0	| 4.13.0	| 4.13.0| 	4.13.0| 	4.13.0	| 4.13.0| 
| Alluxio	| 2.8.0|2.5.0| 	2.5.0	| 2.3.0| 	1.8.1	| 1.8.1	| 1.8.1| 
| Iceberg	| 0.13.0|0.11.0	| -	| -| 	-| 	-| 	-| 
| Hudi	|0.11.0| 0.7.0| 	-	| -	| -	| 0.5.1| 	0.5.1| 
| Hue	|4.10.0| 4.6.0	| 4.6.0| 	4.6.0| 	4.6.0	| 4.6.0	| 4.6.0| 
| Oozie	| 5.2.1|5.1.0	| 5.1.0	| 5.1.0| 	5.1.0	| 5.1.0| 	5.1.0| 
| Zeppelin	| 0.10.1|0.9.1| 	0.8.2| 	0.8.2| 	0.8.2	| 0.8.2| 	0.8.2| 
| Superset	| 1.4.1|0.35.2	| 0.35.2| 	0.35.2	| 0.35.2| 	0.35.2	| 0.35.2| 
| TensorFlow Spark	| 1.4.4|1.4.4	| 1.4.4	| 1.4.4	| 1.4.4	| 1.4.4	| -| 
| Jupyter (installed with TensorFlow)	|4.6.3| 4.6.3	| 4.6.3	| 4.6.3| 	4.6.3| 	4.6.3	| -| 
| Sqoop	| 1.4.7|1.4.7	| 1.4.7| 	1.4.7| 	1.4.7	| 1.4.7	| 1.4.7| 
| Flume	| 1.9.0|1.9.0	| 1.9.0| 	1.9.0	| 1.9.0	| 1.9.0| 	1.9.0| 
| Ranger| 	2.1.0|1.2.0| 	1.2.0| 	1.2.0| 	1.2.0	| 1.2.0	| 1.2.0| 
| Kerberos (selectable only during creation)	| 1.15.0|1.15.0	| 1.15.0	| 1.15.0| 	1.15.0	| 1.15.0	| 1.15.0| 
...
| Component	| EMR v3.4.0| EMR v3.3.0	| EMR v3.2.1	| EMR v3.2.0	| EMR v3.1.0	| EMR v3.0.0| 
| :------------------------- | :---------- | :---------- | :---------- | :---------- | :---------- | :---------- |
| Release Date	| April 2022 | September 2021	| July 2021	| April 2021	| December 2020	| November 2019| 
| HDFS (required)	| 3.2.2	|3.2.2	| 3.2.2	| 3.2.2| 	3.1.2	| 3.1.2| 
| YARN (required)	| 3.2.2	|3.2.2	| 3.2.2	| 3.2.2	| 3.1.2	| 3.1.2| 
| ZooKeeper (required)	| 3.6.3	| 3.6.1	| 3.6.1	| 3.6.1	| 3.6.1	| 3.4.9| 
| OpenLDAP (required)	| 2.4.44	| 2.4.44	| 2.4.44| 	-| 	-| 	-| 
| Knox (required) | 	1.6.1 | 1.2.0	| 1.2.0	| 1.2.0	| 1.2.0	| 1.2.0| 
...
| Kylin	| 4.0.1	|4.0.1	|	-| 	-| 	-| 	-| 
| Presto	| -| -	| -	| -	| -	| 0.222| 
| Trino (PrestoSQL) | 372 	(renamed Trino) | 350	| 350	| 350	| 332| 	-| 
...
| Phoenix (integrated in HBase)	| 5.1.2	|5.1.2	| 5.0.0	| 5.0.0	| 5.0.0	| -| 
...
| Kerberos (selectable only during creation)	| 1.15.1	| 1.15.1	| 1.51.1	| 1.51.1| 	1.15.1	| 1.15.1| 
| Ganglia	| 3.7.2|3.7.2| 	-| 	-| 	-| 	-| 
