...
| Component Name | EMR v1.3.1 | EMR v2.0.1 | EMR v2.1.0 | EMR v2.2.0 | EMR v2.3.0 | EMR v2.4.0 |EMR v2.5.0 | EMR v2.5.1 |
| ---------------------- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| Release date   | -           | -           | May 2019     | March 2020     | May 2020     | August 2020     | September 2020 | April 2021 |
| Hadoop (required component)       | 2.7.3       | 2.7.3       | 2.8.4       | 2.8.5       | 2.8.5       | 2.8.5       | 2.8.5       | 2.8.5       |
| Spark_Hadoop           | 2.72.0.2    | 2.72.2.1    | 2.82.3.2    | 2.82.4.3    | 2.82.4.3    | 2.83.0.0    | 2.83.0.0    | -           |
| Spark                  | -           | -           | -           | -           | -           | -           | -           | 3.0.0       |
| Hive                   | 2.1.1       | 2.3.2       | 2.3.3       | 2.3.5       | 2.3.5       | 2.3.7       | 2.3.7       | 2.3.7       |
| Tez                    | 0.8.5       | 0.8.5       | 0.8.5       | 0.9.2       | 0.9.2       | 0.9.2       | 0.9.2       | 0.9.2       |
| Presto                 | 0.161       | 0.188       | 0.215       | 0.228       | 0.228       | -           | -           | -           |
| PrestoSQL              | -           | -           | -           | -           | -           | 332         | 332         | 332         |
| Storm                  | 1.1.0       | 1.1.0       | 1.1.0       | 1.2.3       | 1.2.3       | 1.2.3       | 1.2.3       | 1.2.3       |
| Flink                  | 1.2.0       | 1.2.0       | 1.4.2       | 1.9.2       | 1.9.2       | 1.10.0      | 1.10.0      | 1.10.0      |
| HBase                  | 1.2.4       | 1.3.1       | 1.3.1       | 1.4.9       | 1.4.9       | 1.4.9       | 1.4.9       | 1.4.9       |
| Phoenix (integrated in HBase) | 4.8.1       | 4.11.0      | 4.13.0      | 4.13.0      | 4.13.0      | 4.13.0      | 4.13.0      | 4.13.0      |
| Ganglia                | 3.7.2       | 3.7.2       | 3.7.2       | 3.7.2       | 3.7.2       | 3.7.2       | 3.7.2       | 3.7.2       |
| Hue                    | 3.12.0      | 3.12.0      | 4.4.0       | 4.6.0       | 4.6.0       | 4.6.0       | 4.6.0       | 4.6.0       |
| Sqoop                  | 1.4.6       | 1.4.6       | 1.4.7       | 1.4.7       | 1.4.7       | 1.4.7       | 1.4.7       | 1.4.7       |
| Ooize                  | 4.3.1       | 4.3.1       | 4.3.1       | 5.1.0       | 5.1.0       | 5.1.0       | 5.1.0       | 5.1.0       |
| Ranger                 | -           | 0.7.1       | 0.7.1       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       |
| ZooKeeper (required component)  | 3.4.9       | 3.4.9       | 3.4.9       | 3.5.5       | 3.5.5       | 3.6.1       | 3.6.1       | 3.6.1       |
| Flume                  | -           | -           | 1.8.0       | 1.9.0       | 1.9.0       | 1.9.0       | 1.9.0       | 1.9.0       |
| Impala                 | -           | -           | -           | 2.10.0      | 2.10.0      | 2.10.0      | 2.10.0      | 2.10.0      |
| Kylin                  | -           | -           | -           | 2.5.2       | 2.5.2       | 2.5.2       | 2.5.2       | 2.5.2       |
| Zeppelin               | -           | -           | -           | 0.8.2       | 0.8.2       | 0.8.2       | 0.8.2       | 0.8.2       |
| Alluxio                | -           | -           | 1.8.1       | 1.8.1       | 1.8.1       | 1.8.1       | 2.3.0       | 2.5.0       |
| Knox (required component)       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       | 1.2.0       |
| Kerberos               | -           | -           | 1.15.0      | 1.15.0      | 1.15.0      | 1.15.0      | 1.15.0      | 1.15.0      |
| Hudi                   | -           | -           | -           | 0.5.1       | 0.5.1       | -           | -           | -           |
| Superset               | -           | -           | -           | 0.35.2      | 0.35.2      | 0.35.2      | 0.35.2      | 0.35.2      |
| Livy                   | -           | -           | -           | 0.7.0       | 0.7.0       | 0.7.0       | 0.7.0       | 0.7.0       |
| TensorFlowSpark        | -           | -           | -           | -           | 1.4.4       | 1.4.4       | 1.4.4       | 1.4.4       |
| Jupyter                | -           | -           | -           | -           | 4.6.3       | 4.6.3       | 4.6.3       | 4.6.3       |
| Kudu                   | -           | -           | -           | -           | -           | 1.12.0      | 1.12.0      | 1.12.0      |


**Hadoop v3.X Standard supports the component versions listed in the following table:**

| Component Name | EMR v3.0.0 | EMR v3.1.0 | EMR v3.2.0 |
| --------------------- | ----------- | ----------- | ----------- |
| Release date  | November 2019 | December 2020 | April 2021 |
| Hadoop (required component)          | 3.1.2       | -           | -           |
| HDFS (required component)            | -           | 3.1.2       | 3.2.2       |
| YARN (required component)            | -           | 3.1.2       | 3.2.2       |
| Spark\_Hadoop         | 3.12.4.3    | -           | -           |
| Spark                 | -           | 2.4.3       | 3.0.2       |
...
| Impala                | 2.10.0      | 3.4.0       | 3.4.0       |
| Alluxio               | 1.8.1       | 2.3.0       | 2.5.0       |
| Knox (required component)      | 1.2.0       | 1.2.0       | 1.2.0       |
| Kudu                  | -           | 1.13.0      | 1.13.0      |
...
| Hadoop (required component)    | 2.8.5         |
| Druid (required component)     | 0.17.0        |
| ZooKeeper (required component) | 3.5.5         |
| Knox (required component)      | 1.2.0         |
| Superset              | 0.35.2        |
| Ganglia               | 3.7.2         |
...
| ClickHouse (required component) | 19.16.12.49        | 20.3.10.75         |
| ZooKeeper (required component)  | 3.4.9              | 3.4.9              |
| Superset               | -                  | 0.35.2             |

**Kafka clusters support the component versions listed in the following table:**

| Component Name  | Kafka v1.0.0 |
| ------------------------ | ------------- |
| Release date                 | May 2021       |
| Kafka (required component)        | 1.1.1         |
| KafkaManager (required component) | 2.0.0.2       |
| Knox (required component)         | 1.2.0         |
| ZooKeeper (required component)    | 3.6.1         |

**Doris clusters support the component versions listed in the following table:**

| Component Name          | Doris v1.0.0 |
| ----------------- | ------------- |
| Release date  | May 2021      |
| Doris (required component) | 0.13.0        |
| Knox (required component)  | 1.2.0         |
...
| Component Name | EMR TianQiong v1.0.0 |
| --------------------- | -------------------- |
