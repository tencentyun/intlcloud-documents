...
- 开源组件
	- 集成 Apache 社区 Hadoop、Hive、Spark、Hbase、Presto、Flink、Alluxio、Iceberg 等几十种丰富、前沿的开源大数据组件（详见 [产品发行版及组件版本预览表](https://intl.cloud.tencent.com/document/product/1026/46456)）。
