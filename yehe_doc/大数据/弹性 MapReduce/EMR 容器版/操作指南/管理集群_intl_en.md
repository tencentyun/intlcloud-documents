...
2. **Cluster Info** records the detailed information of the EMR cluster. You can view the basic information, role information, and configuration file of the cluster on the **Cluster Info** page.
	- The basic information section displays the basic information of the cluster, such as the **Region Info**, **Namespace**, **Component Version**, **Container/Cluster Type**, **Container Network**, **COS**, **Bucket Name**, **Custom Service Role**, **Resource Usage**, and **WebUI URL**.
	- The role information section displays the process information of the Spark cluster.
	- The configuration file section displays the configuration file information of the cluster.
