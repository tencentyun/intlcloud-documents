...
[Get the migration tool](https://github.com/tencentyun/hdfs_to_cos_tools). For more migration tools, please see [Tool Overview](https://intl.cloud.tencent.com/document/product/436/6242).
