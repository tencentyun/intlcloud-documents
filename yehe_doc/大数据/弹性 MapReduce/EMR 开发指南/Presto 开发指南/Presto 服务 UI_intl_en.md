...
EMR integrates the native web UI of Presto, which you can see in the EMR Console. Log in to the [EMR Console](https://console.cloud.tencent.com/emr), click a cluster instance ID to enter the instance management page. Click **Cluster Service** on the left sidebar to view the entry to the **WebUI Address** page and then click the entry to Presto. The username for login is `root`, and the password is the one set when the cluster was created as shown below:
