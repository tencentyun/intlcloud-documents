...
## 用户权限管理
1. 添加用户。
	1. 登录 [EMR 控制台](https://console.cloud.tencent.com/emr)，使用 [用户管理](https://intl.cloud.tencent.com/document/product/1026/43326) 功能添加新用户。
	2. 如果您的集群部署了 Ranger，添加新用户后，需要手动触发 ranger-ugsync-site.xml 的配置下发，重启 EnableUnixAuth 服务进行用户同步，具体操作步骤可参考 [用户管理](https://intl.cloud.tencent.com/document/product/1026/43326)。然后进入 Ranger WebUI 设置新用户访问权限。
