...
安全组是边缘实例的虚拟防火墙，每台边缘实例必须至少关联一个安全组。在您创建边缘实例时，如果您还未创建过安全组，腾讯云提供了“**放通全部端口**”和“**放通22，80，443，3389端口和ICMP协议**”两种模版为您创建一个安全组。详情请参见 [安全组概述](https://intl.cloud.tencent.com/document/product/1119/43431)。
...
<tr><td>自定义</td><td>安全组创建成功后，按需自行添加安全组规则。具体操作请参见 <a href="https://intl.cloud.tencent.com/document/product/1119/43440" target="_blank">添加安全组规则</a>。</td><td>-</td></tr>
</tbody></table>
   - **名称**：自定义设置安全组名称。
