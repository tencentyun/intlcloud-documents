## Description
The account feature and tag deletion feature in this document are available for SDK v1.2.3.0 and later. For versions earlier than v1.2.3.0, see [API Documentation](https://intl.cloud.tencent.com/document/product/1024/30715).
...
> - The account can be email, QQ account number, mobile number, username, etc. For valid values, please see [Account Type Value Table](https://cloud.tencent.com/document/product/548/56434).
...
- context: `Context` object.
- phoneNumber: mobile number in E.164 format `[+][country code or area code][subscriber number]`, for example, +8613711112222.
