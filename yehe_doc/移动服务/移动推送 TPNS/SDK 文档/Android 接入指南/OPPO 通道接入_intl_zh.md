...
> - OPPO 通道对应用的每日推送量有额度限制，详情请参见 [厂商通道限额说明](https://intl.cloud.tencent.com/document/product/1024/35829)，超过限制部分将走 TPNS 通道进行补推发送。
...
推送服务 debug 模式下，过滤关键字 “OtherPush”，查看相关返回码日志（例如 `[OtherPushOppoImpl] OppoPush Register failed, code=14, msg=INVALID_APP_KEY`），并前往 [厂商通道注册失败排查指南](https://intl.cloud.tencent.com/document/product/1024/37006) 查找对应原因，获取解决办法。
