...
```
#### 通知下发角标设置
通知栏推送下发的角标可通过管理台推送页面或 REST API  实现，请一定先在管理台华为通道开启及参数配置处填写桌面图标对应的应用入口 Activity 类，如“com.test.badge.MainActivity”，否则角标设置将不生效，如图所示：
...
|---------|---------|---------|---------|---------|---------|
|  badge_type | int | android| 否 |-1 | 通知角标，当前仅对华为设备生效：<br><li>-2：自动增加1<br><li>-1：不变 |
