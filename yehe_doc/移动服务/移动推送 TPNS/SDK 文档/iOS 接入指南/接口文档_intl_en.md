...
The account, tag, and user attribute features in this document are applicable to **SDK v1.2.9.0 and above**. For **SDK v1.2.7.2** and below, please see [API Documentation](https://intl.cloud.tencent.com/document/product/1024/30727).
...
> !The notification bar has the event click feature, which is only supported in iOS 8.0 or later. For versions earlier than iOS 8.0, this method will return null.
