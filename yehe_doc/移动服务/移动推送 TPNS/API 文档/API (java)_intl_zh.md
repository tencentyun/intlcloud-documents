...
请检查应用 AccessID 与 SecretKey 是否匹配，domainUrl 与产品 [服务接入点](https://intl.cloud.tencent.com/document/product/1024/38517) 是否匹配。

#### 接口返回错误码1008007，参数校验失败如何解决？
请参考 [推送示例](https://intl.cloud.tencent.com/document/product/1024/33764#ios-.E5.8D.95.E8.AE.BE.E5.A4.87.E6.8E.A8.E9.80.81.E8.AF.B7.E6.B1.82.E6.B6.88.E6.81.AF)，检查参数填写是否缺失或字段类型填写有误。
