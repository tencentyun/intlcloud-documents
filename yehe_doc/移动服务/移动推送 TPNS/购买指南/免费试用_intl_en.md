Starting from July 1, 2020, applications created in the [TPNS console](https://console.cloud.tencent.com/tpns) are eligible for a free TPNS trial, which allows you to try out the service.
