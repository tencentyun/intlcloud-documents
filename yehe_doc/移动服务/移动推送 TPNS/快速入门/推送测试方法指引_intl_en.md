...
| Remarks | Vendor channels only support clicking to open an app or custom item (intent), while the TPNS channel supports all click actions <br>For more information on iOS push redirect, please see [Client Redirect Based on Message Content](https://intl.cloud.tencent.com/document/product/1024/32623) |
