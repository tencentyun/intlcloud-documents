...
### Querying tags bound to devices
 To query specific preset and custom tags by device token, go to the TPNS console and select **Message Management** > **Troubleshooting Tools**.
