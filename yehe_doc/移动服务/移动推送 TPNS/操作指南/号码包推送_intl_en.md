...
> !The abovementioned **accounts** must be bound with a TPNS token. For detailed directions, please see [Binding account (Android)](https://intl.cloud.tencent.com/document/product/1024/30715) or [Binding account (iOS)](https://intl.cloud.tencent.com/document/product/1024/30727).
...
>- Account package format and size: `.zip\.txt\.csv` file within 100 MB.
