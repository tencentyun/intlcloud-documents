...
The following are system rules of certain vendors:
	- Native Android: 5 notifications of the same application will be collapsed into a group. The number on the right of the collapsed notifications indicates the total number of unread messages. Up to 8 notifications will be displayed when expanded.
