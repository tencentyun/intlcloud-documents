...
> !上述**账号**必须与 TPNS Token 绑定，操作步骤可参考 [账号绑定（Android）](https://intl.cloud.tencent.com/document/product/1024/30715)或 [账号绑定（iOS）接口](https://intl.cloud.tencent.com/zh/document/product/1024/30727#.E8.AE.BE.E7.BD.AE.E8.B4.A6.E5.8F.B7)。
...
参考 [号码包上传接口](https://intl.cloud.tencent.com/document/product/1024/33765) 文档，上传您的号码包文件，调用成功后会返回 `upload_id`，例如11231。

#### 步骤2：调用推送接口

在您调用 [推送接口](https://intl.cloud.tencent.com/document/product/1024/33764) 时，将 `audience_type`（推送目标）设置为 `package_account_push`（号码包推送），并补充 [步骤1](#.E6.AD.A5.E9.AA.A41.EF.BC.9A.E8.B0.83.E7.94.A8.E4.B8.8A.E4.BC.A0.E5.8F.B7.E7.A0.81.E5.8C.85.E6.8E.A5.E5.8F.A3) 中获取的`upload_id`，例如11231，并且可通过设置 `account_push_type` 字段来决定推送给「**最近**」或「**所有**」绑定该账号的设备。
