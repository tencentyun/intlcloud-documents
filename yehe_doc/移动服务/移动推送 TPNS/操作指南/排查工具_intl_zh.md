...
2. 运营人员通过用户账号推送消息，推送状态显示“推送失败”，在排查工具中输入用户账号查询 Token，发现该应用下，此账号没有关联的设备 Token，可联系开发人员排查是否调用了 [账号绑定（Android）](https://intl.cloud.tencent.com/document/product/1024/30715)或账号绑定（iOS）接口。
