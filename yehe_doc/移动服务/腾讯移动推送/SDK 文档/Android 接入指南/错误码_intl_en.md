...
| 1008016 | The parameter is in an incorrect datetime format |
...
| 1008025 | Failed to create an application. The application already exists under the product |
...
| 10110008 | The queried token has not been associated with an account |
