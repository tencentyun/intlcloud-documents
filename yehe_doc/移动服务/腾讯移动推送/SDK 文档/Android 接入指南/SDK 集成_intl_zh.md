...
>!如果您是从 [信鸽平台](https://xg.qq.com) 迁移至移动推送 TPNS 平台，请务必使用 Android 迁移指南 调整集成配置。
...
将 SDK 导入到工程的步骤为：
1. 创建或打开 Android 工程。
2. 将移动推送TPNS  SDK 目录下的 libs 目录所有 .jar 文件拷贝到工程的 libs（或 lib）目录下。
...
<application>
    ...
    <receiver
        ...
        <intent-filter android:priority="0x7fffffff">
            ...
            <!-- 【可选】 一些常用的系统广播，增强 移动推送 TPNS service的复活机会，请根据需要选择。当然，您也可以添加App自定义的一些广播让启动service -->
