...
![](https://main.qcloudimg.com/raw/584b1b697c21832d864a75c541da7fde.jpg)
 3. Configure `Bundle ID` and other information. Click **Continue**.
...
9. Repeat the step 1-8 to generate and download the `Production SSL Certificate`.
>? Actually, this certificate is a `Sandbox` and `Production` merged certificate that applies to both the development and the production environments.
