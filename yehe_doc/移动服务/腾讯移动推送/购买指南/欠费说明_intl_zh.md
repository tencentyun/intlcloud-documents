...
- 当您的移动推送 TPNS 预付费套餐包过期超过7天（不含到期当天），或您的腾讯云账户在出账后欠费超过7天（含账单推送当天），系统将会进行停服处理。如您需要续费，请 [提交工单](https://intl.cloud.tencent.com/login?s_url=https%3A%2F%2Fconsole.cloud.tencent.com%2Fworkorder%2Fcategory) 进行续费恢复操作。
...
## 按量计费（后付费）模式
按量计费是移动推送 TPNS 服务的弹性计费模式，您可以随时开通或销毁服务。该模式按照每天的日联网设备数进行计费，当日结算并扣费，适用于日联网设备波动较大的场景，价格相对较高。
