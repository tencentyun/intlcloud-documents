...
| send_time            | String  | None    | No  | Current system time                         | Push time in the next 90 days:<li>The format is yyyy-MM-DD HH:MM:SS</li><li>If it is earlier than the current server time, push starts immediately.</li><li>This field is supported only for full push and tag push.</li> |
...
| Field Name | Type | Required | Description |
| ------------- | ------- | -------- | ------------------------------------------------------------ |
| startDate     | String  |Yes       | Loop interval start date in YYYY-MM-DD format, such as 2019-07-01. You can choose a time within the next 90 days.               |
| endDate       | String  | Yes       | Loop interval end date in YYYY-MM-DD format, such as 2019-07-07. You can choose a time within the next 90 days.             |
