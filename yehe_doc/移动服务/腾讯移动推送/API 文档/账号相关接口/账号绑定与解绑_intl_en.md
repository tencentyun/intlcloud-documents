...
| -------------- | ------- | ---- | ---------------------------------------- |
| operator_type | int | Yes | Operation type. Value range: [1,5] as detailed below: <li>1: bind token to an account. </li><li>2: bind token to an account in an overwriting manner. </li><li>3: unbind token from multiple accounts. </li><li>4: unbind token from all accounts. </li><li>5: unbind account from all tokens.</li> |
