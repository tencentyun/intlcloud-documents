...
<table>
 <tr>
         <th>标签类型</th>
            <th>场景</th>
						<th>tpns内置tag_type</th>
						  <th>限制</th>
							 <th>示例</th>
 </tr>
         <tr><!--<td>1.1</td>-->
            <td>自定义标签</td>
            <td>客户自定义，如会议ID，班级ID，用户喜好（篮球，数码产品等）等</td>
						<td>xg_user_define</td>
						  <td><li>最多可以有10000个自定义 tag（如需提高该限制，请与我们客服联系）
<li>每个设备 token 最多可绑定100个自定义 tag（如需提高该限制，请与我们客服联系)
...
<td> love_basketball, love_shopping,male 等</td>
        ...
        <tr>
            ...
            <td rowspan="12">tpns 系统预设，无限制</td>
						<td>1.0.1,1.0.2等</td>
        </tr>
        <tr><!--<td>2.1</td>-->
            <td>省份</td>
...
**方式二：通过终端 SDK 进行标签设置**
iOS SDK 进行标签的设置,具体参见文档：[自定义标签设置](https://intl.cloud.tencent.com/document/product/1024/30727)
Android SDK 进行标签的设置,具体参见文档：[自定义标签设置](https://intl.cloud.tencent.com/document/product/1024/30715)
