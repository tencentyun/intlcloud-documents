...
If your application has multiple package names, when you need to deliver messages to channel-specific package names through vendor-specific channels, you need to apply for a vendor key for each channel-specific package name and configure it on the configuration management page in the [console](https://console.cloud.tencent.com/tpns).
