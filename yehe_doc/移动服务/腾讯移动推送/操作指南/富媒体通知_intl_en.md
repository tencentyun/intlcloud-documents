...
| -------- | ----------------- | ------------------------------------------------------------ |
| Huawei     | Thumbnail            | <li>Only HTTPS URLs are supported <li>Format requirements: <br>1. `PNG`, `JPG`, or `JPEG` format <br>2. 120x120 px in dimensions <br>3. Below 200 KB in size |
