...
>- 若您不知道如何获取设备 Token，可参考 SDK 集成文档中的 [获取Token交互建议（Android）](https://intl.cloud.tencent.com/document/product/1024/30713)或 [获取 Token 交互建议（iOS）](https://intl.cloud.tencent.com/document/product/1024/30726)。
...
答：
	...
	- 检查 APP 包名是否和配置管理中填写的包名一致，如果包名不一致检查是否开启了 [多包名推送功能](https://intl.cloud.tencent.com/document/product/1024/35393)。
