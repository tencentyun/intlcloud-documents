## 访问管理概述
如果您在腾讯云中使用到了腾讯移动推送（Tencent Push Notification Service，TPNS）服务，这些服务由不同的人管理，但都共享您的云账号密钥，将存在以下问题：
- 您的密钥由多人共享，泄密风险高。
...
当您使用 CAM 的时候，可以将策略与一个用户或一组用户关联起来，策略能够授权或者拒绝用户使用指定资源完成指定任务。有关 CAM 策略的更多相关基本信息，请参照访问管理 - [语法逻辑](https://intl.cloud.tencent.com/document/product/598/10603)。有关 CAM 策略的更多相关使用信息，请参照 [策略](https://intl.cloud.tencent.com/document/product/598/10601)。
...
##  创建策略并授权
我们为您预设了两种系统级策略，方便快速进行授权，您可以进入控制台 - 访问管理 - [策略管理](https://console.cloud.tencent.com/cam/policy) ，单击【新建自定义策略】，选择按策略语法创建。
