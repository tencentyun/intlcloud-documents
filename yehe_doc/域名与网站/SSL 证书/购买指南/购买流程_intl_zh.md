...
购买证书完成后，需在 [SSL 证书管理控制台](https://console.cloud.tencent.com/ssl) 中提交审核材料进行证书申请，CA 机构审核通过后将签发证书。详情请查看 [其他品牌 DV 与 EV 型证书材料提交流程](https://intl.cloud.tencent.com/document/product/1007/30160)。
- **域名型（DV）SSL 证书：**
