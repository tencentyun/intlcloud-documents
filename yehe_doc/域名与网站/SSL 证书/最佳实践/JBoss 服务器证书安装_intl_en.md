...
>- Before installing the SSL certificate, enable port 443 on the JBoss server to ensure that HTTPS can be enabled after certificate installation. To check whether port 443 is enabled, see How Do I Check Whether Port 443 Is Enabled?
