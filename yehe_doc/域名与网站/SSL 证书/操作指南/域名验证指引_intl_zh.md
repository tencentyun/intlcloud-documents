...
<tr>
<td>自动 DNS 验证</td>
<td>须使用腾讯云 DNS 解析的域名，<br><strong>如使用腾讯云 DNS 解析，推荐使用此种方式。</strong></td>
...
##  排查审核未通过原因
当您选择的手动 DNS 验证方式没有通过审核时，若需要查看具体未通过原因，请您参考 [自动诊断结果查看指引](https://intl.cloud.tencent.com/document/product/1007/30169)。
