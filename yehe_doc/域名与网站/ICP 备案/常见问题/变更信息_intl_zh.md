...
企业主体不支持变更为个人主体。
个人主体可变更为企业主体，请您根据 [各省管局要求](https://intl.cloud.tencent.com/document/product/1022/31671) 执行。
...
### 域名和服务器都在个人账号，如何变更为企业账号？
个人账号变更为企业账号请参考 变更个人实名信息。
...
各省市管局对接入备案有不同规则，请参考 [各省管局要求](https://intl.cloud.tencent.com/document/product/1022/31671)。 
...
### 增加域名解析的服务器，需重新备案或变更备案吗？（一个 IP 可以对应多个域名，反之不可以，不理解这个问题）
不需要。如果您的域名已经在腾讯云备案成功，且原先备案的服务器没有变动，后续增加了腾讯云的其他服务器用于该域名的解析，此种情况下不需要重新备案或变更备案。


### 变更备案可以添加新的域名吗？
不可以。变更网站信息时，不能修改或新增域名（除不能修改网站域名外，其他信息可以修改，例如联系方式、电子邮箱等）。
如果您的主体和域名已经在腾讯云备案成功，现在有新的域名需要备案在同一个主体下，您可以进行新增网站备案。

### 变更备案和新增备案能否同时进行？（这里新增备案应该改成新增网站好一点，新增备案有歧义）
不能。不同的备案类型不能同时进行操作，若您需要修改备案信息，请先提交变更备案申请，等待管局审核通过后再提交新增备案的申请。
