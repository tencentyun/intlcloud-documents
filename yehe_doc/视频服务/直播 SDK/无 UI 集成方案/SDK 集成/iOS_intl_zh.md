...
本文主要介绍如何快速地将腾讯云视立方·直播 LiteAVSDK（iOS）集成到您的项目中，按照如下步骤进行配置，就可以完成 SDK 的集成工作。下面以全功能的 [全功能版 SDK](https://www.tencentcloud.com/document/product/1071/38150) 为例：
...
[](id:manual)
### 手动集成
1. 下载 [LiveAVSDK](https://www.tencentcloud.com/document/product/1071/38150) ，下载完成后进行解压。
...
## 给 SDK 配置 License 授权
1. 单击 [License 申请](https://console.tencentcloud.com/live/license) 获取测试用 License，您会获得两个字符串：一个字符串是 licenseURL，另一个字符串是解密 key。
