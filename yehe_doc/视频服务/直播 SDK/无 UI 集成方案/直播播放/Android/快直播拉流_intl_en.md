...
1. Download and install [Video Cloud Toolkit](https://www.tencentcloud.com/document/product/1071/38147), log in, and go to **MLVB > Push (Camera)**.
...
### Playback
1. Download and install [Video Cloud Toolkit](https://www.tencentcloud.com/document/product/1071/38147), log in, and go to **Live Broadcast > LEB Player**.
...
## Integration
In the new version of the MLVB SDK, you can use [V2TXLivePlayer](https://www.tencentcloud.com/document/product/1071/41273) for LEB and `V2TXLivePusher` for publishing. LEB supports WebRTC protocols and uses the standard extension method. All URLs in LEB start with `webrtc://`.

[](id:RegistrationService)[](id:step1)
### Step 1. Download the SDK

Download LiteAV_All or Professional at [SDK Download](https://www.tencentcloud.com/document/product/1071/38150).
...
In live streaming, URLs are needed for both publishing and playback. For instructions on how to get URLs for LEB, please see [Live Event Broadcasting (LEB) > Get Playback URL](https://www.tencentcloud.com/document/product/267/41030#step4).
...
>? To publish streams, please see [Publishing from Camera](https://www.tencentcloud.com/document/product/1071/38158) or [Publishing from Screen](https://www.tencentcloud.com/document/product/1071/41879).
