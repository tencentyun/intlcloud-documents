...
1. 下载 [视频云工具包](https://www.tencentcloud.com/document/product/1071/38147)，安装登录后，进入**推流演示（摄像头推流）**中。
2. 允许相关权限申请，单击**自动生成推流地址**，即开始推流了。
3. 成功推流之后，点击右上角的二维码图标，可以获取播放地址，其中**快直播**就是用于快直播的播放地址。
4. 成功开始推流后，可单击右下侧的菜单按钮，进行美颜、BGM、切换摄像头等设置操作。 

### 播放体验
1. 下载 [视频云工具包](https://www.tencentcloud.com/document/product/1071/38147)，安装登录后，进入**快直播播放**中。
...
## 接入工程
新版本的直播 SDK，可以使用 [V2TXLivePlayer](https://www.tencentcloud.com/document/product/1071/41273)  来播放快直播的流，同时也提供了 `V2TXLivePusher` 来推流。快直播直播协议支持 WebRTC 标准协议，使用标准的扩展方式，其 URL 均以 `webrtc://` 字符开始。

[](id:RegistrationService)[](id:step1)
### 1. 下载 SDK

可以在 [SDK 下载](https://www.tencentcloud.com/document/product/1071/38150) 页面选择全功能版下载。
...
2. 在您的 App 调用 SDK 相关功能之前（建议在`- [AppDelegate application:didFinishLaunchingWithOptions:]`中）进行如下设置：
<dx-codeblock>
::: iOS objectivec
...
[](id:step3)
### 3. 获取播放 URL
在直播场景中，不论是推流还是拉流都离不开对应的 URL。请参见 [快直播快速入门](https://www.tencentcloud.com/document/product/267/41030#step4) 获取快直播的播放 URL。
...
>? 如果需要推流，具体操作请参见 [摄像头推流](https://www.tencentcloud.com/document/product/1071/38157) 或者 [录屏推流](https://www.tencentcloud.com/document/product/1071/41878)。
