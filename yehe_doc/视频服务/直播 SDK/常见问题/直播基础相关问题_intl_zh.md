...
已有 v1 和 v2 接口对应表，具体请参见 [直播 SDK V1 升级到 V2 API 接口对比说明](https://docs.qq.com/sheet/DRkJUckpGdkNTUmt2?tab=BB08J2)。

[](id:Que10)
### 关于直播 SDK 隐私合规方面会采集哪些信息（如获取 mac 地址，imei 等）？
直播 SDK 隐私合规符合应用市场要求，具体请参见 [隐私协议](https://intl.cloud.tencent.com/document/product/1071/38543)。
