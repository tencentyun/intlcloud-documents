...
For the error information returned for failure to turn the camera or mic on or record the screen, please see [getUserMedia exceptions](https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia).
