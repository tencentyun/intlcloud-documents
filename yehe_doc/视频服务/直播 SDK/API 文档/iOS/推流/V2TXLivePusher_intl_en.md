...
| Parameter | Type | Description |
|-----|-----|-----|
| observer | V2TXLivePusherObserver | Target object for the publisher’s callbacks. For more information, please see [V2TXLivePusherObserver](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLivePusherObserver__ios.html). |
...
| Parameter | Type | Description |
| ---- | ----  | ----  |
| param | [V2TXLiveVideoEncoderParam](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLiveDef__ios.html#interfaceV2TXLiveVideoEncoderParam) | Video encoding parameters |
...
This API is used to get the audio effect management object [TXAudioEffectManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXAudioEffectManager__ios.html).
...
This API is used to get the device management object [TXDeviceManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXDeviceManager__ios.html).
