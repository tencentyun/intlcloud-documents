...
You can use `V2TXLivePusherObserver` to receive notifications about [V2TXLivePusher](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLivePusher__android.html), including publisher connection status, first audio/video frame, statistics, and warning and error messages.
