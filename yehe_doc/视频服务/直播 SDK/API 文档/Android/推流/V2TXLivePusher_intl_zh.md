...
设置推流器回调。通过设置回调，可以监听 [V2TXLivePusher](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLivePusher__android.html) 推流器的一些回调事件，包括推流器状态、音量回调、统计数据、警告和错误信息等。
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| observer | V2TXLivePusherObserver | 推流器的回调目标对象，更多信息请参见 [V2TXLivePusherObserver](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLivePusherObserver__android.html)。 |
...
| 参数  | 类型     | 含义           |
| ---- | ---- | ---- |
| param | [V2TXLiveVideoEncoderParam](https://liteav.sdk.qcloud.com/doc/api/en/group__V2TXLiveDef__android.html#classcom_1_1tencent_1_1live2_1_1V2TXLiveDef_1_1V2TXLiveVideoEncoderParam) | 视频编码参数。 |
...
获取音效管理对象 [TXAudioEffectManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXAudioEffectManager__android.html)。
通过音效管理，您可以使用以下功能：
...
获取设备管理对象 [TXDeviceManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXDeviceManager__android.html)。
通过设备管理，您可以使用以下功能：
