...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| observer | V2TXLivePlayerObserver | 播放器的回调目标对象，详情请参见 [V2TXLivePlayerObserver](https://www.tencentcloud.com/document/product/1071/41277)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| enable | BOOL | 是否开启自定义渲染。默认值：false。 |
