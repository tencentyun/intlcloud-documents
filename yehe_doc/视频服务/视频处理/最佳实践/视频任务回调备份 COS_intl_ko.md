...
3. 아래 매개변수 정보를 다음 이미지와 같이 설정합니다.
	...
	- **실행 환경**: 정보 덤프 템플릿은 현재 Python 2.7만 지원합니다.
	- **생성 방식**: 템플릿 함수를 선택합니다.
...
### 2단계: MPS 트리거 설정
1. [SCF 콘솔](https://console.cloud.tencent.com/scf) 페이지의 왼쪽 메뉴에서 [함수 서비스](https://console.cloud.tencent.com/scf/list)를 선택하고 해당하는 함수 이름을 클릭하면 해당 함수의 상세 페이지로 이동합니다.
...
### 3단계: 함수 테스트 기능
1. [MPS 콘솔](https://intl.cloud.tencent.com/login)에서 MPS 비디오 처리 워크플로를 실행합니다.
