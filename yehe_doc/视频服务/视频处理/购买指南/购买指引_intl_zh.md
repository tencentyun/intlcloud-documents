## 注册腾讯云
使用视频处理服务前，您需要 [注册腾讯云](https://intl.cloud.tencent.com/document/product/378/17985) 账号。
...
## 视频处理服务计费
视频处理目前支持的计费方式有**日结（后付费）**和**月结（后付费）**，详细请参见 [计费方式](https://intl.cloud.tencent.com/document/product/1041/33478)。
