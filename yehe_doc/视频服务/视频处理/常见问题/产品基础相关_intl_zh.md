...
[](id:f2)
### 支持哪些截图类型？
视频处理MPS截图类型包含时间点截图（单张截图）、采样截图（多张截图)、雪碧图截图。更多详情请参见 [截图模板](https://intl.cloud.tencent.com/document/product/1041/33486)。
...
[](id:f11)
### 是否支持将视频里的语音转成文字？
视频处理MPS视频内容识别对视频执行内容识别后，执行结果将给出识别到的视频语音中的文字。
