...
[](id:que3)
### 如何创建视频内容分析模板？
视频处理 MPS 提供了 [预置视频内容分析模板](https://intl.cloud.tencent.com/document/product/1041/33476)。另外，还可以调用 [服务端 API](https://intl.cloud.tencent.com/document/product/1041/37470) 创建和管理自定义视频内容分析模板。
...
[](id:que7)
### 获取的任务列表如何排序？
视频处理获取的任务列表按**创建时间**排序，具体请参见 [获取任务列表](https://intl.cloud.tencent.com/document/product/1041/33643)。
...
设置工作流需要选择 bucket，上传到指定 Bucket 和目录下的视频将自动触发视频处理，具体请参见 [工作流管理](https://intl.cloud.tencent.com/document/product/1041/33485)。
