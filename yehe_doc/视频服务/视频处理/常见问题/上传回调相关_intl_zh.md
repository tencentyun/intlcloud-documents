...
- **云函数：**
视频处理服务在云函数 SCF 中配置了模板供用户使用。 您需要提前开通SCF服务,创建SCF函数并配置触发器，详情请参见 [视频任务回调通知](https://intl.cloud.tencent.com/document/product/1041/40337)最佳实践。
- **HTTP 推送：**
视频处理服务支持 HTTP 推送回调到指定 URL。您需要在调用接口时，[任务的事件通知配置-TaskNotifyConfig](https://intl.cloud.tencent.com/document/product/1041/33690) 的 NotifyType 参数指定为 URL，并在 NotifyUrl 参数中填写 HTTP 回调地址。

[](id:q4)
### 使用回调是否收费？
- 消息队列 CMQ 相关使用及费用信息请参见 [CMQ 费用说明](https://intl.cloud.tencent.com/document/product/406/38676)。
- 云函数 SCF 相关使用及费用信息请参见 [SCF 费用说明](https://intl.cloud.tencent.com/document/product/583/17299)。
- HTTP 推送方式现阶段免费。
...
- **控制台上传**：登录 [COS控制台](https://console.cloud.tencent.com/cos5)，将本地视频 [上传](https://intl.cloud.tencent.com/document/product/436/13321) 到对象存储 COS Bucket，适用于少量视频的场景。
...
[](id:q6)
### 如何配置上传视频自动转码？
创建任务流选择对应转码模板，并启用该工作流即可 ，控制台设置参数说明，具体请参见 [设置工作流](https://intl.cloud.tencent.com/document/product/1041/33492)。
