...
<td>支持进行如下选择：<ul style="margin:0">
	<li>单击【转码模板】：选择您已在 <a href="https://intl.cloud.tencent.com/document/product/266/14059">模板设置</a> 中创建的转码模板，可勾选多个转码模板。</li>
	<li>单击【常用模板】：自动选择您已设定好的常用转码模板，可通过单击操作栏的删除按钮进行删减。</li>
</td>
<td rowspan="2">支持进行如下选择：<ul style="margin:0">
	<li>单击【不用水印】。</li>
	<li>单击【默认水印】：自动选择您已设定好的默认水印模板。</li>
	<li>单击【选择水印】：选择已在 <a href="https://intl.cloud.tencent.com/document/product/266/14059#.E6.B0.B4.E5.8D.B0.E6.A8.A1.E6.9D.BF">模板设置</a> 中创建的水印模板。</li>
</td>
<td rowspan="2">单击勾选，选择是否使用首帧做封面。</td>
</tr><tr>
<td>转自适应码流</td>
<td>单击下拉框，选择您已在 <a href="https://intl.cloud.tencent.com/document/product/266/14059#.E8.87.AA.E9.80.82.E5.BA.94.E7.A0.81.E6.B5.81.E6.A8.A1.E6.9D.BF">模板设置</a> 中创建好的转自适应码流模板。</td>
</tr>
</tbody></table>
...
3. 根据 [视频转码模板配置说明](https://intl.cloud.tencent.com/document/product/266/14059) 填写配置信息，单击【创建】即可。

![](https://main.qcloudimg.com/raw/f2f716b669669bf447887f891de9bb71.png)

>?
>- 创建好的模板可在模板列表里展示，可以设置为常用模板，并能对模板进行查看、编辑和删除等管理操作。
>- 更多模板配置相关说明，请参见 [云点播-转码模板](https://intl.cloud.tencent.com/document/product/266/14059)。
