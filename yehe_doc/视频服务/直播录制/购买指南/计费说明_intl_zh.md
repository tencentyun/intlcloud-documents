...
- 云直播的计费方式，详情请参见 [云直播价格总览](https://intl.cloud.tencent.com/zh/document/product/267/2819)。
- 云点播的计费方式，详情请参见 [云点播价格总览](https://intl.cloud.tencent.com/document/product/266/2838)。
...
| 计费类型     | 价格  | 结算周期 | 适用产品 |
| :----------- | :--------------- | :--------------- |  :--------------- |
| 录制路数峰值 | 5.2941 美元/路/月               | 月结后付费 | 云直播 |
...
- 06月直播录制费用 = 5.2941（美元/路/月）× 0.6 × 10路 = 31.7646 美元。
