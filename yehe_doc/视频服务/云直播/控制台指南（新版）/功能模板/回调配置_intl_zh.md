本文档介绍如何通过 [云直播控制台](https://console.cloud.tencent.com/live) 创建回调配置。创建成功后，还需到对应的推流域名下关联 [回调配置](https://intl.cloud.tencent.com/document/product/267/31065)，关联成功后约5分钟 - 10分钟生效。用户也可以通过 API 对直播频道创建回调模板，详细请参见 [创建回调模板](https://cloud.tencent.com/document/api/267/32637)。
