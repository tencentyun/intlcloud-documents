This document describes how to get started with LVB. Before trying out LVB, we recommend you read the [Pricing Overview](https://intl.cloud.tencent.com/document/product/267/2819) of LVB to get familiar with the **billable items** and **prices** and avoid confusions.
...
>?
>- LVB provides a test domain name `xxxx.livepush.myqcloud.com` by default. You can use it for push testing, but we recommend you not use it as the push domain name for your real business.
...
>- For more information on LVB domain names, please see [Basic LVB Features](https://intl.cloud.tencent.com/document/product/267/7968).
...
1. Select **LVB Toolbox** > **[Address Generator](https://console.cloud.tencent.com/live/addrgenerator/addrgenerator)**.
...
2. Select **LVB Toolbox** > **[Address Generator](https://console.cloud.tencent.com/live/addrgenerator/addrgenerator)** to get a playback address and configure as follows:
...
3. You can use the following methods to test whether a live stream can be played back normally based on your business scenario:
   1. For stream test on PCs, we recommend you use tools such as [VLC](https://intl.cloud.tencent.com/document/product/267/32483). For more information, please see [LVB Playback](https://intl.cloud.tencent.com/document/product/267/31559).
   2. For stream test on web, we recommend you use TCPlayerLite in the Player SDK. For more information, please see [LVB Playback](https://intl.cloud.tencent.com/document/product/267/31559).
   4. For stream test on mobile devices, we recommend you download and install Tencent Video Cloud Demo, open it, select **MLVB** > **LVB Pull*, enter the playback address into the address box manually or by scanning the QR code, and tap **Play** in the bottom-left corner to start watching.

>? If you need to push/play back a stream in an app, you can integrate the [MLVB SDK](https://intl.cloud.tencent.com/zh/product/mlvb) to use the LVB service. If you encounter any problem during the trial, please see [FAQs](https://intl.cloud.tencent.com/zh/document/product/267/7968).

## Relevant Operations
- To enable **LVB recording**, create a recording template and bind it to a domain name. For more information, please see [Recording Configuration](https://intl.cloud.tencent.com/document/product/267/34223).
- To enable **LVB transcoding**, create a transcoding template and bind it to a domain name. For more information, please see [Transcoding Configuration](https://intl.cloud.tencent.com/document/product/267/31071).
- To enable **LVB watermark**, create a watermark template and bind it to a domain name. For more information, please see [Watermark Configuration](https://intl.cloud.tencent.com/document/product/267/31073).
- To enable **LVB screencapture and porn detection**, create a screencapture and porn detection template and bind it to a domain name. For more information, please see [Screencapture and Porn Detection Configuration](https://intl.cloud.tencent.com/document/product/267/31072).
...
- [How do I splice and generate multiple LVB URLs?](https://intl.cloud.tencent.com/zh/document/product/267/38393)
