LVB supports the watermark feature. It adds watermarks to the live streaming screen to protect video content from theft. This document describes how to create, modify, bind, unbind, and delete a watermark template in the console.
**You can create a watermark template in the following ways:**
- Create a watermark template in the LVB console. For more information, please see [Creating Watermark Template](#Watermark).
