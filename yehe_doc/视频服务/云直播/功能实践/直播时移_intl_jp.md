...
1. [VODコンソール](https://console.cloud.tencent.com/vod/overview)に移動し、【今すぐアクティブにする】をクリックする。
...
2. 【ドメイン名の追加】をクリックし、ICP登録済みのVODドメイン名を入力します。具体的な操作については、 [配信再生設定](https://intl.cloud.tencent.com/document/product/266/35572)をご参照ください。
