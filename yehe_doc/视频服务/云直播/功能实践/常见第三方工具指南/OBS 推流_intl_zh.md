...
- 已 [开通云直播服务](https://console.cloud.tencent.com/live)，并准备已备案的域名，[添加为播放域名](https://intl.cloud.tencent.com/document/product/267/35970)（系统提供默认的推流域名可以使用，也可以添加自定义域名推流）
...
- PC 端：支持使用 [VLC 播放器](https://intl.cloud.tencent.com/document/product/267/32483) 进行拉流。
- 移动端：支持通过集成 [移动直播 ](https://intl.cloud.tencent.com/zh/document/product/1071) SDK 来实现播放。
...
其中， [快直播](https://intl.cloud.tencent.com/document/product/1071/41875) （Live Event Broadcasting，LEB）（超低延迟直播）是标准直播在超低延迟播放场景下的延伸，比传统直播协议延迟更低，为观众提供毫秒级的直播观看体验。 能够满足一些对延迟性能要求更高的特定场景需求，例如在线教育、体育赛事直播、在线答题等。
