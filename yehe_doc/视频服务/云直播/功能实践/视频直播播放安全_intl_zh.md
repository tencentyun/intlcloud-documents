...
- **实施方法**：同 Referer 鉴权，在直播控制台启用 Key 鉴权，填写密钥。这样生成的播放 URL 会带 txTime 和 txSecret ，通过后台通过 Key 解密 txSecret 来校验播放 URL 的合法性。具体原理和方法参见 [防盗链计算](https://intl.cloud.tencent.com/document/product/267/31560)。
