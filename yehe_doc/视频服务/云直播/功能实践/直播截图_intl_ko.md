...
- [LVB 콘솔]>[기능 템플릿]>[음란물 감지 화면 캡처 설정](https://console.cloud.tencent.com/live/config/jtjh)에서 설정할 수 있으며, 자세한 내용은 [라이브 방송 음란물 감지 화면 캡처](https://cloud.tencent.com/document/product/267/20386)를 참조하십시오.
