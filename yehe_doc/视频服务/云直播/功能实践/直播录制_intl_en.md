LVB recording is a service that stores the files generated by muxing original streams (without modifying information such as audio and video data and corresponding timestamps) on the VOD platform.
