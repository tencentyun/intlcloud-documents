...
关于播放防盗链 Key 的相关信息，请参见 [如何开启播放防盗链？](https://intl.cloud.tencent.com/document/product/267/35598) 
...
## 推流示例代码
 **云直播控制台** > [**域名管理**](https://console.cloud.tencent.com/live/domainmanage)，选中事先配置的推流域名,**管理 > 推流配置** 页面下半部分有 **推流地址示例代码**（PHP 和 Java 两个版本）演示如何生成防盗链地址。详情可参见 [推流配置](https://intl.cloud.tencent.com/document/product/267/31059)。
