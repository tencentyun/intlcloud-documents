...
- APIを介して [レコーディングタスク作成](https://intl.cloud.tencent.com/document/product/267/37309) を実行する際は、レコーディングのコールバックはユーザーのプッシュURLに含まれる [stream_param](#message) パラメータをリターンしません。その他のレコーディング方式ではリターンされます。
