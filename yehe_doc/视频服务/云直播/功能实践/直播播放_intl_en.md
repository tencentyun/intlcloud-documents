...
2. Log in to the [CSS console](https://console.cloud.tencent.com/live/livestat) to get a push address for live push. For detailed directions, please see [Live Push](https://intl.cloud.tencent.com/document/product/267/31558).
...
## Live Playback
You need to successfully perform [Live push](https://intl.cloud.tencent.com/document/product/267/31558) first before the stream can be watched at the playback address. You can use the following methods to test live streaming based on your business scenario:
...
1. Search for the "Tencent Video Cloud" Mini Program in WeChat and select **Live Playback**.
