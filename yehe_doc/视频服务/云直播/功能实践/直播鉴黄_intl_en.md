...
Call [DeleteLiveSnapshotRule](https://intl.cloud.tencent.com/document/product/267/30833) to delete the corresponding CSS screencapture rule under `DomainName`, `AppName`, and `StreamName` by template ID.

### 2. Delete or modify the porn detection-enabled screencapture template

Call [ModifyLiveSnapshotTemplate](https://intl.cloud.tencent.com/document/product/267/30828) to set the porn detection flag of the CSS screencapture template to 0.
