...
## 直播推流
### 接入方法
直播推流支持 SRT 协议，需使用**9000端口**进行推流。推流地址可以在云直播控制台的【[地址生成器](https://console.cloud.tencent.com/live/addrgenerator/addrgenerator)】中 [生成推流地址](https://intl.cloud.tencent.com/document/product/267/31084) 然后在按照以下规则拼接即可。
...
## 直播拉流
按照正常拉流播放流程操作即可，具体请参见 [直播播放](https://intl.cloud.tencent.com/document/product/267/31559)。
