CSS 서비스는 라이브 방송 혼합 스트림 기능을 제공하며, 설정한 혼합 스트림 레이아웃 동기화에 따라 각 입력 원본 혼합 스트림을 새로운 스트리밍으로 만들어 라이브 방송 인터랙션 효과를 구현합니다. 또한 CSS 라이브 방송 혼합 스트림 기능은 API 3.0 인터페이스와도 연결할 수 있습니다. 자세한 내용은 [라이브 방송 혼합 스트림 인터페이스](https://intl.cloud.tencent.com/document/product/267/35997)를 참고하십시오. 본 문서에서는 각 시나리오에서 라이브 방송 혼합 스트림을 구현하는 방법에 대해 예시와 함께 설명합니다.

## 주의 사항
- 클라우드 혼합 스트림 기능을 사용하면 표준 트랜스 코딩 요금이 추가로 발생합니다. 자세한 과금 설명은 [트랜스 코딩 요금](https://intl.cloud.tencent.com/document/product/267/39604)을 참고하십시오.
...
<thead><tr><th>템플릿10</th><th >템플릿30</th></tr></thead><tr>
...
<thead><tr><th >템플릿40</th><th>템플릿310</th></tr></thead><tr>
...
<thead><tr><th>템플릿390</th><th >템플릿410</th></tr></thead><tr>
...
<thead><tr><th>템플릿510</th><th>템플릿610</th></tr></thead>
...
## 혼합 스트림 생성
### 매개변수 설명
자세한 내용은 [라이브 방송 혼합 스트림](https://intl.cloud.tencent.com/document/product/267/35997)을 참고하십시오.
...
## 혼합 스트림 취소
### 매개변수 설명
자세한 내용은 [범용 혼합 스트림 취소](https://intl.cloud.tencent.com/document/product/267/35998)를 참고하십시오.
...
<td>기타</td>
<td>기타 오류입니다. <a href="https://intl.cloud.tencent.com/contact-us">고객 서비스</a>에 문의하여 기술 지원을 받으십시오.</td>
<td>-</td>
</tr>
</tbody></table>

## FAQ
- [혼합 스트림 과정에서 입력 스트림의 자동 크기 조정을 유지하고, 검은 띠를 없애려면 어떻게 해야 하나요?](https://intl.cloud.tencent.com/document/product/267/38255)
- [푸시 스트림 후 혼합 스트림 시 -505 에러 코드가 리턴되는 이유는 무엇인가요?](https://intl.cloud.tencent.com/document/product/267/38255)
- [혼합 스트림 신청 후 혼합 스트림을 취소하지 않을 경우 어떻게 되나요?](https://intl.cloud.tencent.com/document/product/267/38255)
- [혼합 스트림의 보조 호스트 화면이 예상 위치와 다른 이유는 무엇인가요?](https://intl.cloud.tencent.com/document/product/267/38255)

>? 클라우드 혼합 스트림 관련 자세한 문제는 [클라우드 혼합 스트림 관련](https://intl.cloud.tencent.com/document/product/267/38255)을 참고하십시오.
