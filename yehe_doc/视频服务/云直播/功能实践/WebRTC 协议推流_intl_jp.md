...
モバイル端末では、 [MLVB SDK](https://intl.cloud.tencent.com/zh/document/product/1071) を使用してプッシュを実行することをお勧めします。
...
### コールバックイベント通知
SDKは、現在、コールバックイベント通知を提供しています。Observerを設定することで、SDK内部のステータス情報とWebRTC関連のデータ統計について知ることができます。 詳細については、 [TXLivePusherObserver](https://intl.cloud.tencent.com/zh/document/product/1071/41272)をご参照ください。
<dx-codeblock>
::: javascript javascript
livePusher.setObserver({
	// プッシュ警告情報
