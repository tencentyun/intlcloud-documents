...
移动端建议使用 [移动直播 SDK](https://intl.cloud.tencent.com/zh/document/product/1071) 进行推流。
...
### 回调事件通知
SDK 目前提供了回调事件通知，可以通过设置 Observer 来了解 SDK 内部的状态信息和 WebRTC 相关的数据统计。具体内容请参见 [TXLivePusherObserver](https://intl.cloud.tencent.com/zh/document/product/1071/41272)。
<dx-codeblock>
::: javascript javascript
livePusher.setObserver({
	// 推流警告信息
