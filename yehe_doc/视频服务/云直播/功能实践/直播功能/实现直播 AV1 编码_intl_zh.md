...
- 已开通腾讯云直播服务，并添加 [推流&播放域名](https://intl.cloud.tencent.com/document/product/267/35970)。
...
- **自有播放器改造**
如果您的播放器不具备播放AV1格式视频的能力，可 [联系我们](https://intl.cloud.tencent.com/contact-us) 改造播放器。
