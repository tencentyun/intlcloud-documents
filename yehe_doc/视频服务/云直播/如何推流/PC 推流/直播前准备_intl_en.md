...
### Generate push URL
If the push URL is not ready yet, log in to Tencent Cloud [CSS console](https://console.cloud.tencent.com/live), select **Access Management** -> **Live Stream Code Access (Recommended)** -> **Push Generator** to generate a push URL and three playback URLs. The URL with a domain name of livepush.myqcloud.com is the push URL:
![](https://main.qcloudimg.com/raw/3ca98ea018817419a67d954bfc1d2897.png)

### Select the network for live streaming
#### Network options
...
#### Install XSplit
Optionally, download the XSplit installer package on XSplit official website and then install it with default settings. XSplit is a paid software. In case of a budget constraint, OBS (**Free**) is recommended. A dedicated XSplit installer package is available for live game streaming. For non-game live streaming, BroadCaster is recommended.
