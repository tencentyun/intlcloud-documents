...
If you want to generate a group of URLs for testing, you only need to open [**CSS Console** -> **CSS Code Access** -> **Push Generator**](https://console.cloud.tencent.com/live/livecodemanage), and click **Generate Push URL** button, to generate a push URL and three playback URLs with different playback protocols.
