...
If you want to generate a group of URLs for testing, you only need to open [**CSS console** -> **Live Stream Code Access** -> **Push Generator**](https://console.cloud.tencent.com/live/livecodemanage), and click **Generate Push URL** button, to generate a push URL and three playback URLs with different playback protocols.
...
- **CSS Code**
  It is also called room ID. Random numbers or user ID is recommended. BIZID prefix is required in a valid live stream code.
- **txTime**
...
- **Sample Code**
  Go to [**CSS Console** -> **CSS Code Access** -> **Push Generator**](https://console.cloud.tencent.com/live/livecodemanage). In the lower part of the page, the sample code (PHP and Java) is provided to show how to generate a hotlink protection URL.
...
Go to [**CSS console** -> **Live Stream Code Access** -> **Push Generator**](https://console.cloud.tencent.com/live/livecodemanage). In the lower part of the page, the sample code (PHP and Java) is provided to show how to generate a hotlink protection URL.
