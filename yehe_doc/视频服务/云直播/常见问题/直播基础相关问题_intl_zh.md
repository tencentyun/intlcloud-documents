...
### 常见的推流方式？
- **移动端 Android/iOS，使用摄像头**：使用第三方软件或 移动直播 SDK采集摄像头视频，并推送视频流至直播流推流地址。
- **台式机或笔记本，使用摄像头或桌面录屏**：使用第三方软件采集摄像头视频或桌面图像，将视频或桌面内容推流至直播流推流地址。第三方推流软件包括：[OBS（推荐）](https://intl.cloud.tencent.com/document/product/267/31569)、XSplit、FMLE 等。
...
3. 选择【推流配置】，下拉到底即可看到**【推流地址示例代码】**。您可通过切换标签按钮查看 PHP/Java 示例代码。
