...
You need to apply for an ICP filing for your domain name before submitting it to the console for management. The domain name can contain up to 29-bit characters and cannot contain uppercase letters.
