...
[](id:open)
#### 재생 링크 도용 방지 활성화
1. [도메인 관리](https://console.cloud.tencent.com/live/domainmanage)에 로그인합니다.
2. 재생 도메인을 선택하거나 속한 행의 **관리**를 클릭하여 도메인 상세 페이지로 이동합니다.
...
- [트랜스코딩 템플릿 생성](https://intl.cloud.tencent.com/document/product/267/30790)
