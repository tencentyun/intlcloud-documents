...
<span id="Que2"></span>
### 云直播播放域名有什么要求？	
控制台进行域名提交管理前，需对域名进行备案，域名的位数限制为45位，暂不支持大写的域名，请输入不超过45位的小写域名地址，详情请参见[域名管理](https://intl.cloud.tencent.com/document/product/267/35970)。
...
<span id="Que7"></span>
### 常见的推流方式？
- **移动端 Android/iOS，使用摄像头**：使用第三方软件或 [直播 SDK](https://intl.cloud.tencent.com/product/mlvb) 采集摄像头视频，并推送视频流至直播流推流地址。
...
[](id:Que16)
### 直播观看人数怎么查看？
建议通过调用云直播 API 3.0 的  [查询流的播放信息列表接口](https://intl.cloud.tencent.com/document/product/267/37297) 获取在线流观看人数。
