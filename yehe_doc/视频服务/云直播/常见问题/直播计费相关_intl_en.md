...
Value-added billing is for fees of live transcoding, recording, screencapturing, and porn detection. These four features are not enabled by default. If they are enabled and used, fees will incur. For information on unit prices, see [Feature Billing].
...
### How is live transcoding billed? How do I estimate the fees?
Live transcoding is billed on the basis of the actually used encoding method, transcoding resolution, and transcoding duration. As stream mixing and watermarking are processed by the transcoding module, transcoding fees will also incur. For more information, see [Transcoding Billing].
...
### Why is a transcoding bill generated even though I didn't use live transcoding?
Live transcoding includes real-time transcoding, cloud stream mixing, and watermarking. If you use the other two features, transcoding fees will also incur.
