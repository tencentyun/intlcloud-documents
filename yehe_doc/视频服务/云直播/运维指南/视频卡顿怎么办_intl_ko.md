...
- **4.2.2 합리적인 인코딩 설정**
권장하는 인코딩 설정은 다음과 같습니다. 이는 뷰티쇼에 적합하며 자세한 내용은 [어떻게 화질을 더 좋게 만들 수 있나요?](https://cloud.tencent.com/document/product/454/7955)를 참조하십시오. TXLivePush의 setVideoQuality 인터페이스에서 해당 설정을 할 수 있습니다.  
