...
>!
>- Bucket name 为 test，不含 `3508645126`。  
>- 以上信息均可按照业务实际需要配置。
...
或单击【授权管理】进入授权管理界面，勾选需授权的存储桶，打开【公共权限】和【用户权限】按钮添加用户。用户类型选择根账号，<b>并输入根账号 ID：`3508645126`</b>。单击【保存】并【确定】。
