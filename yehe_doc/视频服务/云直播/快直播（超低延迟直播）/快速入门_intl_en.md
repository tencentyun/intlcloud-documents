...
1. After push succeeds, select **[Stream Management](https://console.cloud.tencent.com/live/streammanage)** > **Live Streams**, view the status of the push address, and click **Test** to play back the stream online.
