...
### Porn Detection
Based on the screencapture feature, the system can recognize screenshots and call back results based on the screencapture and porn detection template bound to the push domain name. For more information, please see [Live Screencapturing & Porn Detection](https://intl.cloud.tencent.com/document/product/267/31072).
