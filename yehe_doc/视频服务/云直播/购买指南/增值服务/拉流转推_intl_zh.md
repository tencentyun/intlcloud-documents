...
`0.00032（美元/分钟）x100（分钟）=0.032（美元）`
...
2022年10月最多天数为31日，用户标准直播中国大陆（境内）计费方式为日结带宽。
则10月所产生的转推第三方费用为：
`（10Mbps + 80Mbps + 70Mbps + 75Mbps + 60Mbps）/31天 x 12.67（美元/Mbps/月）= 120.569美元`。
...
### 注意事项
使用拉流转推本地模式，除了会产生增值服务费用外，还可能会产生 [拉流转推服务费用](https://intl.cloud.tencent.com/document/product/267/41059)。
