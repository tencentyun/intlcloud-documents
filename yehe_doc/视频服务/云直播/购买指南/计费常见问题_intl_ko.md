...
- 기본적으로 다운스트림 재생 요금만 청구됩니다. 그러나 업스트림 트래픽에 대한 다운스트림 트래픽의 비율이 10:1 보다 작고 하루에 사용되는 최대 업스트림 대역폭이 100Mbps를 초과하는 경우에도 업스트림 사용량이 청구됩니다.
...
현재 CSS는 사용자가 유료 사용자인지 여부에 따라 콘텐츠에 대한 액세스 제어를 지원하지 않습니다. 하지만 비디오를 녹화하여 VOD로 저장하면 비디오를 암호화하여 재생 권한을 제어할 수 있습니다. 
