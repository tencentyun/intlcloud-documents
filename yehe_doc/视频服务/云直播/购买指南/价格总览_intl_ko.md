...
CSS 과금 항목에는 기본 서비스와 부가 가치 서비스가 포함됩니다. CSS와 다른 Tencent Cloud 서비스가 공동으로 제공하는 부가 가치 기능을 사용할 경우 연장된 서비스 요금이 발생합니다. 다음 이미지를 참고하십시오.

![](https://qcloudimg.tencent-cloud.cn/raw/7970d2961c95cd19a4e7568f3ea60467.png)


- [기본 서비스 요금](#base): LVB 또는 LEB 사용 시 라이브 스트리밍 리소스 소모로 인해 발생합니다. 트래픽 과금 방식 또는 최대 대역폭 과금 방식 간에 전환할 수 있습니다.
- [부가 서비스 요금](#appreciation): 라이브 방송 트랜스 코딩, 녹화, 화면 캡처, 음란물 감지, 타임 시프트, 릴레이 등 부가 기능 사용에 대한 요금으로, 해당 기능은 기본적으로 비활성화 되어있으며 활성화된 경우에만 비용이 과금됩니다.
- [확장 서비스 요금](#extensions): CSS와 다른 Tencent Cloud 서비스가 공동으로 제공하는 부가 가치 기능을 사용할 때 발생합니다. 각 Tencent Cloud 서비스는 해당 과금 규칙에 따라 과금됩니다.
...
<td>
<li><a href="https://intl.cloud.tencent.com/document/product/267/2818">일일 종량제</a></li>
<li/>후불-월 결산
</td>
</tr><tr>
<td>LVB 피크 대역폭</td>
...
<li/><a href="https://intl.cloud.tencent.com/document/product/267/2818">일일 종량제</a>
<li/>후불-월 결산
</td>
</tr><tr>
<td>LEB 트래픽<br>(기본)</td>
...
<td>
<li/><a href="https://intl.cloud.tencent.com/document/product/267/39969">일일 종량제</a>
<li/>후불-월 결산
</td>
</tr><tr>
<td>LEB 피크 대역폭</td>
...
<li/>발생하는 비용은 <b>트랜스 코딩 기간에 따라</b>, 출력 라이브 스트림 비디오 해상도 구간 단가에 따라 과금됩니다.
</ul></td>
<td>
  <li><a href="https://intl.cloud.tencent.com/document/product/267/39604">일일 종량제</a></li></ul>
	<li/>후불-월 결산
</td>
</tr><tr>
<td>초고속 코덱 트랜스 코딩</td>
...
<li/>발생하는 비용은 <b>트랜스 코딩 기간에 따라</b>, 출력 라이브 스트림 비디오 해상도의 과금 계층에 따라 과금됩니다.
</ul><td>
<li><a href="https://intl.cloud.tencent.com/document/product/267/39604">일일 종량제</a></li>
<li/>후불-월 결산
</td>
</tr><tr>
<td>오디오 트랜스 코딩</td>
...
<li/>요금은 <b>오디오 트랜스 코딩 기간에 따라 과금</b>됩니다.
<td>
<li><a href="https://intl.cloud.tencent.com/document/product/267/39604">일일 종량제</a></li>
<li/>후불-월 결산
</td>
...
<td><a href="https://intl.cloud.tencent.com/document/product/267/39605">월간 종량제</a></td>
</tr><tr>
<td colspan=2>라이브 스크린 캡쳐</td>
<td>
  <li>라이브 스크린 캡쳐 중 라이브 스트림의 스크린샷은 템플릿에 따라 예약된 시점에 캡처되어 COS에 저장됩니다.</li>
  <li>스크린 캡처로 인해 발생하는 서비스 비용은 <b>스크린샷 개수에 따라 과금되며</b>, 매월 1000개의 스크린샷은 무료입니다.</li>
</td>
<td><a href="https://intl.cloud.tencent.com/document/product/267/39606">월간 종량제</a></td>
</tr><tr>
  ...
  <td>화면 캡처 및 음란물 감지 기능에는 별도의 요금이 부과됩니다.
    ...
    <li>스크린 캡쳐로 발생하는 서비스 비용은 <b>스크린샷 개수에 따라 과금되며</b>, 매월 첫 1000개의 스크린샷은 무료입니다.</li>
</td>
...
<td>
<a href="https://intl.cloud.tencent.com/document/product/267/41059">월간 종량제</a>
</td>
</tr><tr>
<td colspan=2>라이브 타임 시프트</td>
<td>
라이브의 타임 시프트는 총 타임 시프트 시간에 따라 과금됩니다.
</td>
<td><a href="https://intl.cloud.tencent.com/zh/document/product/267/47534">일일 종량제</a>
</td>
</tr>
</table>
...
<td>스크린샷 저장</td>
<td>라이브 스크린 캡쳐 및 음란물 감지로 생성된 스크린샷 파일은 COS에 저장해야 하며 <strong>발생한 서비스 요금은 실제 저장 기간 및 데이터 볼륨에 따라 과금됩니다.</strong> COS 스토리지 요금은 별도로 과금됩니다.</td>
