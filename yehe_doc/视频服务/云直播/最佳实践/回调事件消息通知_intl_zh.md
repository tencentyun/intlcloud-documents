推流域名的 [回调关联配置](https://intl.cloud.tencent.com/document/product/267/31065) 成功后，当直播过程中域名关联模板事件被触发时，腾讯云将主动发送请求到客户服务器，客户服务器负责应答请求。验证通过后，您可被动获取到含直播事件回调信息的 JSON 数据包。
目前，直播事件触发消息通知支持如下事件：
...
>! 本文不涉及鉴黄事件通知回调，详情请看 [最佳实践-直播鉴黄](https://intl.cloud.tencent.com/document/product/267/31564)。


## 前提条件
-  已登录 [云直播控制台](https://console.cloud.tencent.com/live)，并成功添加 [推流域名](https://intl.cloud.tencent.com/document/product/267/35970)。 
- 已创建 [回调配置模板](https://intl.cloud.tencent.com/document/product/267/31074)，并与推流域名进行 [回调关联配置](https://intl.cloud.tencent.com/document/product/267/31065)。
...
事件消息通知配置主要有以下方式：
- [云直播 API 3.0](https://intl.cloud.tencent.com/document/product/267/30760)
- [云直播控制台](https://intl.cloud.tencent.com/document/product/267/31566)
