...
>- If you have already purchased a domain name but have not obtained an ICP filing for it, please apply through Tencent Cloud's [Domain Name ICP Filing](https://intl.cloud.tencent.com/product/icp) service. You can also do so at another domain name service provider.
>
