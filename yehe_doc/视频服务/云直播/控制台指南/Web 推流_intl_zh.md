...
>? web 推流的音频编码方式为 opus 编码，推荐使用快直播 WebRTC 地址进行播放。若使用标准直播的播放地址（RTMP/FLV/HLS），系统会自动转换为 aac 编码才能正常播放，从而会产生音频转码费用，详见 [计费文档](https://intl.cloud.tencent.com/document/product/267/39604)。
...
其中，播放地址由以下4部分组成：
![](https://main.qcloudimg.com/raw/9094e537a4ae7cecc7feb9c88fb83a55.png)支持 RTMP、FLV 、 HLS 和 UDP 协议，可以单击播放地址后的二维码，通过 [TCToolkit App](https://intl.cloud.tencent.com/document/product/1071/38147) 扫码查看播放地址：
