...
2. 【再生設定】>【再生アドレスジェネレーター】を選択して、以下の設定を行います。
	1. 有効期限を選択します（例：`2019-02-28 23:59:59）。
	...
	3. 【再生アドレスの発行】をクリックして完了です。
![](https://main.qcloudimg.com/raw/6118cad9cca141bcee5c54d8211a9567.png)
3. 再生ドメイン名の再生認証を有効にしていない場合は、【再生設定】>【再生アドレス】タグで、当該再生ドメイン名でのRTMP、FLV、HLSの3種類の再生アドレスが確認できます。再生アドレスの中のStreamName（ストリーム名称）を置き換えてプッシュアドレスをバインドすると、その後すぐに再生アドレス経由でライブストリーミングの画面を見ることができるようになります。
