...
-  テンプレートの関連付けに成功すると、指定されたプッシュドメイン名の下のプッシュアドレスのウォーターマーク機能が有効になります。
- 1つのドメイン名あたり、1つのウォーターマークテンプレートにのみバインドすることが可能です。関連付けた後、そのドメイン名の下のすべてのストリームは、このテンプレートに従ってウォーターマークが追加されます。
