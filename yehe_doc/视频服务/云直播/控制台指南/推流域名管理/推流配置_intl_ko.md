...
2. **푸시 설정**을 선택하고 > **푸시 주소 생성기**에서 다음 설정을 완료합니다.
   ...
   2. `liveteststream`과 같은 사용자 정의 StreamName을 입력합니다.
   3. **푸시 주소 생성**을 클릭하여 StreamName이 포함된 RTMP 푸시 URL을 생성합니다.
![](https://main.qcloudimg.com/raw/6f5ac8dcac2082aedca950c5341946ab.png)
3. 푸시 도메인에 대한 인증을 활성화하지 않은 경우 **푸시 URL** 섹션에서 RTMP 및 UDP URL을 찾을 수 있습니다. StreamName을 귀하의 스트림 이름으로 바꾸면 해당 재생 URL을 사용하여 스트림을 재생할 수 있습니다. 
...
>!
>- 인증을 활성화한 경우 URL의 실제 만료 시간은 txTime + Key의 유효 기간을 더한 값입니다.
