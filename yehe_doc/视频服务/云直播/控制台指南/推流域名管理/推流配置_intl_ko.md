...
3. 푸시 도메인의 재생 인증을 아직 활성화하지 않은 경우, **푸시 스트림 설정** > **푸시 스트림 주소 리졸브** 탭에서 해당 재생 도메인의 RTMP, SRT의 두 가지 재생 주소 주소를 확인할 수 있습니다. 푸시 스트림 주소 상의 StreamName(스트림 이름)을 변경하여 재생 주소와 연결하면 재생 주소로 라이브 방송 화면을 확인할 수 있습니다. 
