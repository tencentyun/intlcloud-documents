LVBプッシュ機能は、デフォルトでは無効になっています。このドキュメントでは、指定したプッシュドメイン名に関連付けられたレコーディングテンプレートのレコーディング機能を有効にする方法と、関連付け後にテンプレートのバインドを解除してテンプレートのドメイン名レコーディング機能を無効にする方法についてご説明します。
...
3. レコーディング設定テンプレートを選択し、【保存】をクリックすれば完了です。
