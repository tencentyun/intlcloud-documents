...
## Notes
- The origin server configuration will take effect in **30 to 60 minutes**.
...
2. Select **Advanced Configuration** and view **Origin Server Settings**.
...
>- After selecting FLV or RTMP as the forwarding protocol, you can select FLV or HLS as the playback protocol. **If you select FLV as the playback protocol, streams using RTMP protocol can also be played back.**
