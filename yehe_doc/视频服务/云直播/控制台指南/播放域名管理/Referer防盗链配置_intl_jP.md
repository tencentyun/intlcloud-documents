...
## 注意事項
- Referer情報はHTTPに含まれます。設定をオンにした後にRTMPは再生できず、高速CSSストリームはRefererの設定をチェックしません。Refererの設定が必要な場合は、FLVまたはHLSを使用して再生することをお勧めします。
- Refererホットリンク防止の設定をオン、オフ、または修正後は、約15分～20分経過すると有効となり、再度プッシュする必要はありません。

## 前提条件

- CSSサービスがアクティブで、[CSSコンソール](https://console.cloud.tencent.com/live/livestat)にログインしていること。
...
1.   【[Domain Management]】(https://console.cloud.tencent.com/live/domainmanage)を選択し、Refererホットリンク防止の設定の必要がある**再生ドメイン名**または右側の【管理】をクリックし、ドメイン名管理画面に進みます。
2.   【アクセス制御】>【Refererホットリンク防止の設定】にある、【編集】をクリックし、Refererホットリンク防止の設定画面に進みます。
 ![](https://main.qcloudimg.com/raw/32461edf0353c2c95925b74d80dc25b3.png)
3.   ![](https://main.qcloudimg.com/raw/c032c517e25867ff592f128424154688.png)ボタンをクリックし、Refererホットリンク防止の起動を選択し、以下の設定を行います。
...
<li>ルール内容がブランクの場合は、ブラックリスト/ホワイトリストがいずれも設定されていないことを表わします。</li>
</ul></td>
</tr></table>
...
[](id:change)
## Refererホットリンク防止の修正
1.   【[Domain Management](https://console.cloud.tencent.com/live/domainmanage)】を選択し、Refererホットリンク防止の設定を修正する必要がある**再生ドメイン名**または右側の【管理】をクリックし、ドメイン名管理画面に進みます。
2.   【アクセス制御】>【Refererホットリンク防止の設定】にある、【編集】をクリックし、Refererホットリンク防止の設定画面に進みます。
3.   実際のニーズに応じて[設定項目](#setmess) 情報を修正し、【保存】をクリックして修正を完了します。

![](https://main.qcloudimg.com/raw/a8c79376ed22b4e47f35e69411c6df10.png)

[](id:close)
## Refererホットリンク防止の停止
[Refererホットリンク防止の起動](#open)後、この機能を停止する必要がある場合、具体的な操作は以下の通りです。

1.   【[Domain Management](https://console.cloud.tencent.com/live/domainmanage)】を選択し、Refererホットリンク防止の設定を停止する必要がある**再生ドメイン名**または右側の【管理】をクリックし、ドメイン名管理画面に進みます。
2.   【アクセス制御】>【Refererホットリンク防止の設定】にある、【編集】をクリックし、Refererホットリンク防止の設定画面に進みます。
