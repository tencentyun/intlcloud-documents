...
- Referer 링크 도용 방지는 HTTP 요청 header의 Referer 정보를 통해 인증을 진행하고, 요청이 합법적인지 확인하여 라이브 방송 허용 여부를 제어합니다. 하지만 Refererer 위조를 통해 인증 우회 및 서비스 도용의 상황이 발생할 수 있으므로, 콘텐츠 보호를 위해 Referer에 과도히 의존하는 것은 권장되지 않습니다.
...
<td>링크 도용 방지 유형</td>
<td>Referer<b>블랙리스트</b> 또는 <b>화이트리스트</b>를 클릭하여 설정을 선택합니다.
<ul style="margin:0">
<li>블랙리스트와 화이트리스트는 상호 배타적이므로 동시에 적용할 수 없습니다. </li>
<li>Referer 화이트리스트가 설정되면 화이트리스트에 있는 사용자의 액세스가 허용되고 라이브 방송 콘텐츠를 요청할 수 있습니다. 반대로 화이트리스트에 없는 사용자의 액세스는 거부되며 라이브 방송 콘텐츠를 요청할 수 없습니다.</li>
<li>Referer 블랙리스트가 설정되면 블랙리스트에 있는 사용자의 액세스가 거부되고 라이브 방송 콘텐츠를 요청할 수 없습니다. 반대로 블랙리스트에 없는 사용자의 액세스는 허용되며 라이브 방송 콘텐츠를 요청할 수 있습니다.</li>
</ul></td>
</tr><tr>
<td>빈 Referer 허용</td>
<td><ul style="margin:0">
<li>허용을 선택하면 Referer 필드가 비어있거나 없는 HTTP 요청의 액세스가 허용되며, 브라우저를 통해 직접 라이브 방송 URL에 액세스할 수 있습니다. </li>
<li>거부를 선택하면 빈 Referer의 액세스가 거부됩니다. </li>
</ul></td>
</tr><tr>
<td>링크 도용 방지 규칙</td>
<td><ul style="margin:0">
<li>최대 <b>100</b>개의 규칙을 설정할 수 있으며, 줄 바꿈으로 구분합니다. </li>
