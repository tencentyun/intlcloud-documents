...
- [트랜스 코딩 템플릿](https://intl.cloud.tencent.com/document/product/267/31071) 또는 [어댑티브 비트 레이트 템플릿](www.tencentcloud.com/document/product/267/50271) 생성을 완료해야 합니다.
...
>? 템플릿을 삭제하려면 먼저 바인딩을 해제한 다음 **기능 설정** > [**라이브 방송 트랜스 코딩**](https://console.cloud.tencent.com/live/config/transcode)으로 이동하여 템플릿을 삭제해야 합니다. 자세한 내용은 [템플릿 삭제](https://intl.cloud.tencent.com/document/product/267/31071#delect)를 참고하십시오.
