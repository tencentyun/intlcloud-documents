...
- 已 [添加播放域名](https://intl.cloud.tencent.com/document/product/267/35970)。
...
#### 证书说明：
[CA](https://intl.cloud.tencent.com/document/product/1007/30192) 提供的证书包括 Apache、IIS、Nginx 以及 Tomcat。**云直播的加密服务使用 Nginx，故配置需选择 Nginx 文件中的内容**。 
...
## 常见问题
- [直播 HTTPS 配置要填写什么格式的证书？](https://intl.cloud.tencent.com/document/product/267/32478)
- [如何辨认证书是 PEM 格式还是 DER 格式？](https://intl.cloud.tencent.com/document/product/267/32478)
