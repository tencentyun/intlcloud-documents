...
- [再生ドメイン名の追加](https://intl.cloud.tencent.com/document/product/267/35970)が完了していること。


[](id:open)
## Refererホットリンク防止の起動

1. 【[ドメイン名管理](https://console.cloud.tencent.com/live/domainmanage)】を選択し、Refererホットリンク防止を設定したい**再生ドメイン名**または右側の【管理】をクリックしてドメイン名管理画面に入ります。
...
3.   ![](https://main.qcloudimg.com/raw/c032c517e25867ff592f128424154688.png)ボタンをクリックし、Refererホットリンク防止の起動を選択し、次の設定を行います。
...
[](id:change)
## Refererホットリンク防止の修正
1. 【[ドメイン名管理](https://console.cloud.tencent.com/live/domainmanage)】を選択し、Refererホットリンク防止設定を修正したい**再生ドメイン名**または右側の【管理】をクリックしてドメイン名管理画面に入ります。
2.   【アクセス制御】>【Refererホットリンク防止の設定】にある、【編集】をクリックし、Refererホットリンク防止の設定画面に進みます。
...
1. 【[ドメイン名管理](https://console.cloud.tencent.com/live/domainmanage)】を選択し、Refererホットリンク防止設定を停止したい**再生ドメイン名**または右側の【管理】をクリックしてドメイン名管理画面に入ります。
2.   【アクセス制御】>【Refererホットリンク防止の設定】にある、【編集】をクリックし、Refererホットリンク防止の設定画面に進みます。
