To help you quickly get started with the LVB Console, this document will introduce some frequently used LVB services categorized according to different user needs. LVB Console comes with four modules: Basic Services, Scenario-Specific Services, Data Center and LVB Toolkit.
...
Scenario-specific services are supporting services on LVB. In this module, you can use and manage services like transcoding, watermark, stream mixing, screencapturing, porn detection, event records and notification service.
