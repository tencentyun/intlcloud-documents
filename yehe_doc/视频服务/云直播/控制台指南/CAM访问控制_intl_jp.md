...
- 方法一：ユーザー/ユーザーグループページに移動し、ポリシーを追加したいユーザー/ユーザーグループを選択して、操作リスト内の【承認】/【関連付けられたポリシー】をクリックし、対応するCSSポリシーを選択し、【OK】をクリックすれば、正常に追加できます。
...
2. 各項目を入力し、【効果】項目内で【許可】を、【サービス】項目内で【CSS】を、【操作】項目内で【ドメイン名リストのクエリー】をそれぞれ選択し、【リソース】項目内に承認するドメイン名を入力します。構文は次のとおりです。
 ```
