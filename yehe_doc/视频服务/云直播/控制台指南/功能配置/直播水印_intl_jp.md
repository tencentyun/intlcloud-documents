...
- コンソールのウォーターマークテンプレート管理はドメイン名の次元となり、現在は関連付けインターフェース作成のルールを取り消すことはできません。ウォーターマーク管理インターフェース経由で指定ストリームを関連付けした場合は、[ウォーターマークルールの削除](https://intl.cloud.tencent.com/document/product/267/30823)を呼び出して関連付けを解除する必要があります。
...
1. 【機能設定】>[【CSSウォーターマーク】](https://console.cloud.tencent.com/live/config/watermark)に入ります。
2. 作成済みのウォーターマークテンプレートを選択し、右上方の【削除】をクリックします。
