...
- **표준 트랜스 코딩**과 비교할 때 **초고속 코덱 트랜스 코딩**은 낮은 비트 레이트에서 더 높은 비디오 품질을 제공합니다. 지능형 장면 인식, 동적 인코딩 및 CTU/라인/프레임 수준 비트 레이트 제어를 포함한 기술을 활용하는 초고속 코덱 트랜스 코딩을 통해 더 낮은 비트 레이트(평균 30% 더 낮음)에서 고화질 스트리밍 서비스를 제공할 수 있습니다. 게임, 쇼 및 기타 이벤트 스트리밍에 널리 사용됩니다.
