...
- API를 통한 녹화 템플릿 생성에 대한 자세한 방법 및 사례는 [녹화 템플릿 생성](https://intl.cloud.tencent.com/document/product/267/30845)을 참고하십시오.

## 주의 사항
- 녹화한 비디오 파일은 기본적으로 [VOD](https://console.cloud.tencent.com/vod/overview) 콘솔에 저장되며, 사전에 VOD 서비스를 활성화할 것을 권장합니다. 자세한 내용은 [VOD 시작하기](https://intl.cloud.tencent.com/document/product/266/8757)를 참고하십시오.
...
<table>
   ...
   <tbody><tr>
      ...
      <td>비디오 스토리지 정책</td> 
      <td><ul style=margin:0><li>비디오 녹화를 재생해야 할 경우, 스탠다드 스토리지로도 충분히 니즈를 충족할 수 있습니다. 기본 값은 스탠다드 스토리지입니다.</li><li>VOD에 녹화된 미디어 자산의 콜드 스토리지 작업을 지원하며, 녹화 파일에 잦은 액세스가 필요하지 않은 경우, 콜드 스토리지 기능으로 저빈도 액세스 장기 스토리지를 구현할 수 있습니다.</li></ul></td>
      </tr><tr>
...
>! 비디오 스토리지 정책 중:
>- **스탠다드 스토리지**를 선택하면 현재 선택한 애플리케이션에 콜드 스토리지 정책이 활성화되어 있으면 녹화 파일이 먼저 스탠다드 스토리지 파일을 생성한 다음 콜드 스토리지 정책에 따라 콜드 스토리지됩니다. [정책](https://console.cloud.tencent.com/vod/inactivation)을 클릭하여 조회할 수 있습니다.
>- **스탠다드IA 스토리지** 선택 시, 선택된 애플리케이션/카테고리의 콜드 스토리지 정책이 활성화됩니다. 녹화 파일은 스탠다드IA 스토리지 파일을 먼저 생성한 후 VOD 콜드 스토리지 정책 실행 여부를 판단합니다.
4. **저장**을 클릭합니다.
