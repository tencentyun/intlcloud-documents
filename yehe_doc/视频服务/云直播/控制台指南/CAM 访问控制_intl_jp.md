...
CAMを使用する場合は、ポリシーを1人のユーザーまたは1組のユーザーグループとバインドして、指定されたリソースを使用して指定されたタスクを完了することを許可または拒否できます。
...
- ユーザーグループ：同一機能のユーザーのために作成されたグループであり、ポリシーによってバインドされ、統一的な一括承認管理に役立てることができます。
...
- 方法1：ユーザー/ユーザーグループページに移動し、ポリシーを追加したいユーザー/ユーザーグループを選択して、操作リスト内の【承認】をクリックし、対応するCSSポリシーを選択し、【OK】をクリックすれば、正常に追加できます。
![](https://main.qcloudimg.com/raw/f09b5d456ba1fd554ad321ddcc67cbdc.png)

- 方法2：ポリシーページに移動し、追加したいポリシーを選択して、操作リスト内の【ユーザー/グループのバインド】を選択し、承認したいユーザーを選択して、【OK】をクリックすれば、正常に追加できます。
...
**例**：
【証明書の追加】インターフェースをサブユーザーに承認し、ドメイン名指定内でのみ使用したい場合は、以下の手順に従って設定します。
...
```
 ...
 - `${DomainName}`は承認が必要なドメイン名です。
 例：`qcs::live:ap-guangzhou::domain/cloud.tencent.com`、【ステートメントの追加】>【次のステップ】>【ポリシーの作成】をクリックすれば、このポリシーを作成できます。ポリシー作成後、上述の2つの方法でユーザー/ユーザーグループをバインドしてください。
