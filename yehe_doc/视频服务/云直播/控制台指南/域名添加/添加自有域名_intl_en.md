...
2. Click **Add Domain** to enter the domain name adding page and configure as follows:
	1. To add a **push domain name**, enter the domain name, select its type as **Push domain name**, and click **OK**.
	2. To add a **playback domain name**, enter the domain name, select its type as **Playback domain name**, select an acceleration region (**Mainland China** by default), and click **OK**.
