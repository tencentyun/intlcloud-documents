...
2. 已准备域名（使用中国大陆资源，需要完成域名备案）。
   若您的域名未完成备案，您可前往腾讯云的 网站备案 完成域名备案。
>!
>- 根据国家工信部规定，域名必须进行备案。备案时长需几个工作日，建议您提前进行备案，详情请参见 [域名备案和配置常见问题](https://intl.cloud.tencent.com/document/product/267/32478)。
...
>- 每个账户默认限制可管理100个域名，如果业务量级较大，可 [提交工单](https://selfservice.console.aliyun.com/ticket/createIndex) 申请增加域名数量上限。
