...
2. 已准备域名，并完成域名备案。
	- 若您的域名未完成备案，您可前往腾讯云的 [网站备案](https://intl.cloud.tencent.com/product/icp) 完成域名备案。
>
>- 根据国家工信部规定，域名必须进行备案。备案时长需几个工作日，建议您提前进行备案，详情请参见 [域名备案](https://intl.cloud.tencent.com/product/icp) 和 [域名备案和配置常见问题](https://intl.cloud.tencent.com/document/product/267/32478)。
