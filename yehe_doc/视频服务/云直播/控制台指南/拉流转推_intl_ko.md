...
- **2022년 11월 23일 00:00**부터 로컬 릴레이 모드 이용 시 추가 요금이 발생합니다. 자세한 내용은 부가 기능 요금에 대한 문서를 참고하십시오.
...
<td>작업 시간</td>
<td>기본 설정: <code>현재 시간</code>에서 <code>현재 시간 + 24시간</code>까지. 선택 가능한 작업 시간: 현재 시간부터 1년 이내의 임의의 시간 ~ 7일 이내.<br>현재 시간이 2021년 03월 24일 11:50:01이라고 가정하면 <ul style="margin:0"><li/>선택 가능한 시간은 2022년 3월 24일 11:50:01부터 2022년 03월 30일 11:50:01까지 입니다. <li/>종료 시간은 2022년 03월 30일 11:50:01을 초과할 수 없습니다. </ul></td>
</tr><tr>
<td>이벤트 콜백 알림</td>
...
>- 로컬 모드를 활성화하는 것 자체는 추가 요금이 발생하지 않으며, 로컬에 캐시된 MP4 파일을 릴레이할 때 해당 로컬 파일의 실제 릴레이 시간에 따라 부가 기능 요금이 계산됩니다.
...
>!URL 만료 시간이 작업 종료 시간 이후인지 확인하십시오. 작업이 시작된 후 destination을 변경하면 작업이 중지되고 재시작됩니다.
