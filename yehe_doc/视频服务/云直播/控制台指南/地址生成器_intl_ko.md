...
- 동시에 여러 라이브 방송 주소를 생성하려면 자체 스티칭 방식으로 생성하는 것을 권장합니다. 자세한 작업 방법은 [ 라이브 방송 URL 자체 스티칭 관련](https://intl.cloud.tencent.com/document/product/267/38393)문서를 참조하십시오.
...
- 라이브 방송 주소 QR코드는 [라이트 버전 Demo](https://intl.cloud.tencent.com/document/product/1071/38147)로 스캔하여 획득한 뒤 사용할 수 있습니다.
...
5. 주소 만료 시간을 선택합니다(예시: `2020-06-09 15:36:04`).
6. [주소 생성]을 클릭합니다.
![](https://main.qcloudimg.com/raw/bfe1214bbec05a521f1c0d5b95a20cee.png)

### 푸시 스트림 주소 설명
푸시 스트림은 RTMP 프로토콜을 지원하며, 주소 생성기 기능을 통해 접두사가 `rtmp://`인 푸시 스트림 주소를 생성할 수 있습니다.
![](https://main.qcloudimg.com/raw/21b09486ff99d77706661c20fe7db3f8.png)


<h2 id="play">재생 주소 생성</h2>
...
4. 스트림 이름 StreamName을 입력합니다. 예시: `liveteststream`.
5. 주소 만료 시간을 선택합니다(예시: `2020-06-09 15:36:04`).
6. 기존에 생성한 트랜스 코딩 템플릿을 참조할지 여부를 선택합니다.
6. [주소 생성]을 클릭합니다.

![](https://main.qcloudimg.com/raw/72b683a48c9f7992a763961b15334a4f.png)

### 재생 주소 설명
트랜스 코딩 템플릿을 사용하는 경우, 생성한 재생 주소는 트랜스 코딩 후의 라이브 방송 재생 주소가 됩니다. 그중 재생은 RTMP와 FLV, HLS, UDP 프로토콜을 지원합니다. 주소 생성기를 통해 접두사가 `rtmp://`, `http://`, `webrtc://`인 재생 주소를 생성할 수 있습니다.
