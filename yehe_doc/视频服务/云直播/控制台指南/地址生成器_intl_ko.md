...
- 동시에 여러 라이브 방송 주소를 생성하려면 자체 스티칭 방식으로 생성하는 것을 권장합니다. 자세한 작업 방법은 [라이브 스트리밍 URL 스플라이싱](https://intl.cloud.tencent.com/document/product/267/38393) 문서를 참고하십시오.
...
- 스트림 이름 접미사가 트랜스 코딩 템플릿 이름과 충돌하는 경우, 스트림 상태 오류가 발생할 수 있으니 스트림 이름을 변경하십시오.



##  전제 조건
[CSS 콘솔](https://console.cloud.tencent.com/live/livestat)에 로그인되어 있어야 하며 [푸시 스트리밍/재생 도메인](https://intl.cloud.tencent.com/document/product/267/35970)이 추가되어 있어야 합니다.
...
<td><li>이 매개변수는 <strong>재생 도메인</strong>을 도메인 유형으로 선택한 경우에만 유효합니다. <li><a href="https://intl.cloud.tencent.com/document/product/267/31071">트랜스코딩 템플릿</a>을 선택하면 CSS가 트랜스코딩된 스트림에 대한 재생 URL을 생성합니다. <li><a href="https://www.tencentcloud.com/document/product/267/50271">어댑티브 비트레이트 템플릿</a>을 선택하면 CSS가 어댑티브 비트레이트 URL을 생성합니다. 원본 스트림을 재생하려면 템플릿을 선택할 필요가 없습니다.</td>
</tr>
</tbody></table>
...
### 어댑티브 비트레이트 URL 형식
어댑티브 비트레이트 템플릿을 선택하면 CSS가 어댑티브 비트레이트 URL을 생성합니다. HLS 및 WebRTC가 지원되기 때문에 생성된 URL은 `http://` 및 `webrtc://`로 시작합니다.
