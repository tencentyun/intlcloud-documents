...
- **Live playback on apps**: support playback protocols including RTMP, HTTP-FLV, and HLS. You can integrate the MLVB SDK with LVB to quickly build live streaming apps. For details, please see [Playback](https://intl.cloud.tencent.com/document/product/1071/38567).
...
- **Live playback on web**: we recommend you use the player SDK [TCPlayerLite](https://intl.cloud.tencent.com/document/product/266/7836). You can insert the player code to browsers to play back live streams on such browsers.
