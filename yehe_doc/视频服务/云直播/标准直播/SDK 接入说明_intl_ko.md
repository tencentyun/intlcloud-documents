...
- **App 라이브 방송 푸시 스트림**:카메라 화면 수집 또는 휴대폰 인터페이스 수집을 지원하며, RTMP 프로토콜을 통해 CSS에 스트림을 빠르게 푸시할 수 있습니다. 자세한 내용은 [카메라 푸시 스트림](https://intl.cloud.tencent.com/document/product/1071/38157) 및 [화면 녹화 푸시 스트림](https://intl.cloud.tencent.com/document/product/1071/39888)을 참고하십시오.
- **App 라이브 방송 재생**:RTMP, FLV, HLS 등 형식의 재생 프로토콜을 지원하고 CSS와 연동하여 라이브 방송 APP를 빠르게 구축합니다. 자세한 내용은 [LVB 풀 스트림](https://intl.cloud.tencent.com/zh/document/product/1071/38567)을 참고하십시오.
...
- **Web 라이브 방송 재생**:플레이어 SDK의 [TCPlayerLite](https://intl.cloud.tencent.com/document/product/266/7836) 사용을 권장합니다. 플레이어 코드를 도입하면 웹브라우저에서 라이브 방송을 재생할 수 있습니다.
>? 현재 시중에 나와 있는 대부분의 모바일 브라우저는 HTTP-FLV 재생을 지원하지 않으므로 모바일 브라우저에서 HLS 프로토콜을 사용하여 재생하는 것을 권장합니다.
