...
[](id:step0)
## 준비 작업
1. [Tencent Cloud 계정](https://intl.cloud.tencent.com/register?s_url=https%3A%2F%2Fcloud.tencent.com%2Fproduct%2Flvb)을 등록하십시오.
...
>?  
>- CSS를 활성화하면 중국 본토 재생 트래픽 20GB가 무료로 제공됩니다.
...
[**외부 도메인**](https://intl.cloud.tencent.com/document/product/267/35970)을 추가할 수 있습니다.

1. 도메인 이름을 등록합니다. 중국 본토에서 도메인을 사용하려면 ICP 비안이 필요합니다.
...
- 모바일 장치에서 푸시하려면 TCToolkit App을 다운로드하여 설치하십시오. 설치 후 열어서 **라이브 푸시** > **라이브 푸시**를 선택하고 푸시 URL을 수동으로 입력하거나 QR 코드를 스캔한 후 **스트리밍 시작**을 누릅니다.

>? 
>
>- MLVB SDK를 App에 통합하여 푸시 기능을 구현할 수도 있습니다.
>- Web용 LEB 솔루션은 B-프레임 디코딩 및 재생을 지원하지 않습니다. 자세한 내용은 [B-프레임 정보](#b_frame)를 참고하시기 바랍니다.

[](id:step4)
## 4단계: 재생 주소 가져오기

1. 푸시 스트림 완료 후, [**스트림 관리**](https://console.cloud.tencent.com/live/streammanage)> **온라인 스트림**을 선택하여 푸시 스트림 주소 상태를 조회하고, **미리보기**를 클릭해 온라인에서 재생 및 시청합니다.
...
3. 서비스 시나리오에 따라 다음의 방식으로 라이브 방송 스트림이 정상적으로 재생되는지 테스트할 수 있습니다.
   - **Web 라이브 방송 스트림 테스트**: [TCPlayer Demo](https://tcplayer.vcube.tencent.com)를 사용하여 스트림을 재생합니다.
>?
...
>- 라이브 방송 트랜스 코딩 운영 가이드 및 트랜스 코딩 과금 관련 내용은 [라이브 방송 트랜스 코딩](https://intl.cloud.tencent.com/document/product/267/31071) 문서를 참고하십시오.
   ...
   - **모바일 장치**: TCToolkit을 다운로드하여 설치합니다. 설치 후 열어서 **LEB Player**로 이동한 후 재생 URL을 수동으로 입력하거나 QR 코드를 스캔하여 URL을 가져오고 재생 시작을 누릅니다.
>? App에서 스트림을 푸시/재생하려면 MLVB SDK를 앱에 통합하여 LEB 서비스를 보완할 수 있습니다. 문제가 발생하면 [FAQ](#que)를 참고하십시오.

## 5단계: LEB 제품 액세스
**모바일 장치용 LEB 솔루션**: 이 솔루션은 B 프레임 디코딩 및 AAC를 지원하며 MLVB SDK에 통합되었습니다.
