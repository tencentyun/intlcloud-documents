...
>- 直播转码操作指引及转码计费内容，请参见文档 [直播转码](https://intl.cloud.tencent.com/document/product/267/31071)。
   ...
   - **移动端直播流测试**：建议您下载安装TCToolkit App 打开选择 **快直播播放**，手动输入或扫描 **推流体验** 中得到的快直播播放地址，单击播放按钮播放观看。
>? 如需在 App 中进行推流，可以集成 移动直播 SDK 配合快直播服务使用。使用过程中如果您遇到问题，请参见 [常见问题](#que)。

## 步骤5：快直播产品接入
**移动端方案**：支持 B 帧解码、AAC 音频格式，目前已集成至移动直播 SDK。
