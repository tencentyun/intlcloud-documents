MLVB SDK 는 LVB 서비스를 휴대폰 라이브 방송 방향으로 확장하여 사용자에게 모바일 라이브 방송 푸시 스트림, 풀 스트림의 **빠른 통합 솔루션**을 제공합니다. 동시에 CSS, VOD, IM, COS 등과 같은 클라우드 서비스를 통합하는 ‘통합 솔루션’을 제공하여 뷰티 필터, AI 특수 효과, 마이크 연결 인터랙션 등 기능을 구현합니다.
