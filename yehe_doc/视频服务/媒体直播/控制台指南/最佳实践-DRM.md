# 如何在MediaLive中对接DRMtoday

## 步骤1：申请账户

1. 申请DRMtoday
   1. 进入[DRMtoday产品页面](https://castlabs.com/drmtoday/)申请开通DRMtoday；
      ![](https://main.qcloudimg.com/raw/b1fa760d75f68f27c4470bf52f81b800.png)
   2. 申请完成后可获取DRMtoday账户、密码及Dashboard网址。
2. 申请Fairplay证书
   1. 进入[Apple Fairplay官网](https://developer.apple.com/streaming/fps/)。
   2. 单击[Request FPS Deployment Package](https://idmsa.apple.com/IDMSWebAuth/signin.html?path=%2Fcontact%2Ffps%2F&appIdKey=891bd3417a7776362562d2197f89480a8547b108fd934911bcbea0110d07f757)填写并提交相关信息。
      ![](https://main.qcloudimg.com/raw/9592e1021494896689ad0d7135f26560.png)
   3. 获取FPS_Deployment_Package.zip文件。
   4. 参照FPS_Deployment_Package.zip解压后的文档，在本地创建受密码保护的私钥、以及CSR（证书签名请求）。
   5. 参照FPS_Deployment_Package.zip解压后的文档，上传CSR给Apple。页面会返回ASK，请妥善保存。
...
1. CAS认证
   ...
   1. CAS Login：向Login地址发送HTTP POST请求。
      示例：
...
参考MediaLive[用户使用手册](https://intl.cloud.tencent.com/document/product/1048/38374#5.-drm-.E8.AE.BE.E7.BD.AE)配置MediaLiveDRM密钥，其中：
...
根据MediaLive使用手册配置好播放地址后（如可[将直播流输出到MediaPackage的Channel中](https://intl.cloud.tencent.com/document/product/1048/38362)，通过MediaPackage的[Endpoint节点获取播放地址](https://intl.cloud.tencent.com/document/product/1063/37496#.E4.B8.89.E3.80.81-endpoint)），可使用[DRMtoday播放页面](https://players.castlabs.com/presto/6.1.2/#/player/config)测试：
