...
请参见 [Android 上传 SDK](https://intl.cloud.tencent.com/document/product/266/33925) 来接入短视频上传功能。
<span id="step1"></span>
### 1. 选择视频
...
```
 ...
 <td>videoId</td>
 <td >视频文件云存储 ID，您可以通过这个 ID 调用云点播 <a href = "https://intl.cloud.tencent.com/document/product/266/7788">服务端 API 接口</a>。</td>
 </tr>
 </tbody></table> 
- 通过 [错误码表](https://intl.cloud.tencent.com/document/product/1069/38042) 来确认短视频的发布结果。
<span id="step4"></span>
### 4. 播放视频

[第3步](#step3)发布视频成功后，会返回视频的 fileId、播放地址 URL 及封面 URL，然后在 [点播播放器](https://intl.cloud.tencent.com/document/product/1069/38027) 中传入 fileId 或 URL 进行视频播放。
