...
2. Import `SDK/LiteAVSDK_XXX.aar` and `Demo/player/libs/libsuperplayer.aar` into the project.
...
2. When the video is uploaded to the server, the corresponding `FileId` will be included in the notification ofupload confirmation.
