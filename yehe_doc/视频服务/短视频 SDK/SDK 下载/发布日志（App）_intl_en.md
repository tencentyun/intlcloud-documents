This document lists the updates of the UGSV SDK. To learn about the version history of the All-in-One SDK, see [Release Notes (App)](https://www.tencentcloud.com/document/product/266/50632).
>? The All-in-One SDK combines the capabilities of all Tencent Cloud media SDKs, including MLVB, UGSV, TRTC, and Player.
...
### Version 10.6 Released on August 31, 2022
#### Bug fixing
...
### Version 10.5 Released on August 11, 2022
#### Bug fixing
...
### Version 10.4 Released on July 21, 2022
...
### Version 10.3 Released on July 5, 2022
...
### Version 10.2 Released on June 22, 2022
...
- iOS & Android: added an API for the advanced beauty filter of face narrowing.
- iOS & Android: fixed occasional slow seeking for Superplayer.
- Android: fixed failure of Superplayer to play videos by file ID.
...
- iOS: fixed occasional instability of Superplayer.
...
- iOS: fixed Superplayer’s compatibility issue with iOS 14.
...
- Android: optimized the basic beauty filters, and added the “brighten” and “natural” filters.
...
- Android: added support for image-to-video conversion and offered image transition effects including wipe, push, zoom in, zoom out, rotate, and fade.
...
- iOS: added support for image-to-video conversion and offered image transition effects including wipe, push, zoom in, zoom out, rotate, and fade.
