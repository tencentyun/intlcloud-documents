...
If the Player component cannot meet your custom requirements and you have development experience, you can integrate the RT-Cube Player SDK as instructed in [Integration Guide](https://www.tencentcloud.com/document/product/266/47849) to customize the player UI and playback features.
...
## Content Summary
- [How to integrate the RT-Cube Player component for iOS](#step1)
...
This step describes how to integrate the Player component. We recommend you [integrate it through CocoaPods](#cocoapods) or [manually download the SDK](#manual) and then import it into your current project.
<dx-tabs>
...
If you have the required license, get the license URL and key in the [RT-Cube console](https://console.cloud.tencent.com/vcube).
If you don't have the required license, please [contact us](https://intl.cloud.tencent.com/contact-us) to get a license.
<br>After getting the license information, before calling relevant APIs of the SDK, initialize the license through the following API. We recommend you set the following in `- [AppDelegate application:didFinishLaunchingWithOptions:]`:
```objective-c
...
3. **Video playback:**
This step describes how to play back a video. The RT-Cube Player for iOS supports playback through [`FileId` in VOD](#fileid) or [URL](#url). We recommend you **integrate the `FileId`**  because it allows you to use more VOD capabilities.
<dx-tabs>
...
![](https://qcloudimg.tencent-cloud.cn/raw/5a2ed0df4a4ca817d1faf21052dbbc57.png)
>!
...
// If you enable hotlink protection, you need to enter a `psign` (player signature) for playback. For more information on the signature and how to generate it, see [Player Signature](https://intl.cloud.tencent.com/document/product/266/38099).
...
The Player component supports full screen playback, where it allows setting screen lock, volume and brightness control through gestures, on-screen commenting, screencapturing, and definition selection. This feature can be tried out in [**TCToolkit App**](#qrcode) > **Player** > **Player Component**, and you can enter the full screen playback mode by clicking the full screen icon.
...
```
:::
::: Enable screen locking[](id:screenlock)
...
The Player component supports customizing a video thumbnail, which is displayed before the callback is received for playing back the first video frame. This feature can be tried out in [**TCToolkit App**](#qrcode) > **Player** > **Player Component** > **Thumbnail Customization Demo**.
...
You can try out this feature in [**TCToolkit App**](#qrcode) > **Player** > **Player Component** > **Video List Loop Demo**.
...
![](https://qcloudimg.tencent-cloud.cn/raw/f225556c4ee38b8c67dd3a7e9d137b4e.png)
