...
该错误是编译器没有检测到 TXVideoInfo 类，建议检查 SDK（framework）是否正确，可依照 [文档步骤](https://intl.cloud.tencent.com/document/product/1069/38012) 重新导入工程。

[](id:que19)
### 调用视频合成报错“-1，Failed to enable encoder” 怎么办？
1. 请确认问题是否为必现问题，建议更换机型测试。
2. 可下载最新版的 Demo 中复现一下问题。若问题是必现的，请提供 完整的日志信息 并 [提工单](https://console.cloud.tencent.com/workorder/category) 解决。
