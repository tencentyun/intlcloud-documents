...
You need to create a `TXUGCJoiner` object for video splicing. Just like `TXUGCEditer`, the preview feature also requires the upper layer to provide the preview `UIView`:
