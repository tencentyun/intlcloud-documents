...
- **Log 文件的查看**
短视频 SDK 为了减少 log 的存储体积，对本地存储的 log 文件做了加密，并且限制了 log 数量的大小，所以要查看 log 的文本内容，需要使用 log [解压缩工具](http://dldir1.qq.com/hudongzhibo/log_tool/decode_mars_log_file.py)。
``` objc
...
您可以通过 [GitHub](https://github.com/tencentyun/UGSVSDK/tree/master/iOS) 或 [资源下载](https://intl.cloud.tencent.com/document/product/1069/37914) 中提供的 SDK 压缩包获取 UGCKit。UGCKit 位于压缩包 Demo/TXLiteAVDemo/UGC/UGCKit 目录下。
...
- [视频录制](https://intl.cloud.tencent.com/document/product/1069/38007)
- [视频编辑](https://intl.cloud.tencent.com/document/product/1069/38013)
- [视频拼接](https://intl.cloud.tencent.com/document/product/1069/38014)
- [视频上传](https://intl.cloud.tencent.com/document/product/1069/38016)
- [视频播放](https://intl.cloud.tencent.com/document/product/1069/38017)
- [动效变脸（企业版）](https://intl.cloud.tencent.com/document/product/1069/38030)
