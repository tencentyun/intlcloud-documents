...
### 步骤1：下载 App 源码
单击 [小视频源码](https://intl.cloud.tencent.com/document/product/1069/37914) 可以下载到小视频 App 的源代码。

### 步骤2：申请 SDK 用的 License
请参见 [申请 License](https://intl.cloud.tencent.com/document/product/1069/38041)。
...
```
  ...
  5.3 查看 [步骤4](#step3_4) 中云服务器的公网 IP，在浏览器中输入`http://IP` 查看服务是否启动成功。
