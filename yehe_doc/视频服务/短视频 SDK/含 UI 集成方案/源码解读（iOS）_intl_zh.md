...
小视频主要集成了 UGCKit 作为核心功能库。集成方式参考 [UGCKit](https://www.tencentcloud.com/document/product/1069/38012)（主要负责播放录制）。
小视频的美颜功能，分为基础美颜和腾讯特效。基础美颜主要集成 BeautySettingkit 实现，集成方式请参见 [类抖音特效](https://www.tencentcloud.com/document/product/1069/38028) 文档，相关代码都可以在 BeautySettingKit 目录下找到。腾讯特效主要集成xmagickit实现，实现方式请参见[短视频SDK集成腾讯特效](https://www.tencentcloud.com/document/product/1069/47916)文档，相关代码都可以在xmagickit目录下找到。
