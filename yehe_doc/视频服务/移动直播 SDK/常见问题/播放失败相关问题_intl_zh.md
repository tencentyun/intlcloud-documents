...
-  **RTMP SDK**
如果 RTMP SDK DEMO 本身播放没有问题，推荐您参考 RTMP SDK 的播放文档（[iOS](https://intl.cloud.tencent.com/document/product/1071/38159) 和 [Android](https://intl.cloud.tencent.com/document/product/1071/38160)）检查一下对接逻辑是否错误。
