...
[](id:step1)
### 步骤1：服务开通 
RTC 连麦互动直播需要在开始接入前，先开通腾讯云 [**实时音视频**](https://intl.cloud.tencent.com/product/trtc) 服务，具体步骤如下：

1. 您需要 [注册腾讯云](https://intl.cloud.tencent.com/document/product/378/17985) 账号，并完成 [实名认证](https://intl.cloud.tencent.com/document/product/378/3629)。
2. 登录实时音视频控制台，选择【[应用管理](https://console.cloud.tencent.com/trtc/app)】。
3.  单击【创建应用】，输入应用名称，例如 `V2Demo` ，单击【确定】。
![](https://main.qcloudimg.com/raw/cafe42baa149f50bdbb90b8814dd0c7d.png)
...
6. 在播放端，推荐使用CDN播放，所以需要在 [实时音视频控制台](https://console.cloud.tencent.com/trtc/app) 开启**旁路推流**功能。
  ![](https://main.qcloudimg.com/raw/50ee7786083b590e6b8887c11c77d08b.png)
...
>- 如果既想用到 V2 相关的接口，但是又不想维护一套单独的房间状态，可以尝试搭配 [腾讯云 IM SDK](https://intl.cloud.tencent.com/product/im)，快速实现相关逻辑。
