...
<table>
  ...
  <tr>
      ...
      <td>Videos can be shot at multiple ratios, including 16:9, 4:3, and 1:1.</td>
      <td style="text-align:center">✓</td>
  </tr>
   <tr>
      <td style="text-align:center">Definition</td>
      <td>SD, HD, FHD, Blu-ray, and other definitions are supported.</td>
      <td style="text-align:center">✓</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>The focal length can be adjusted during shooting.</td>
      <td style="text-align:center">✓</td>
   </tr>
   <tr>
      <td style="text-align:center">Focus mode</td>
      <td>Manual and automatic focusing are supported.</td>
      <td style="text-align:center">✓</td>
  </tr>
   <tr>
      <td style="text-align:center">Photo taking</td>
      <td>Photo taking is supported.</td>
      <td style="text-align:center">✓</td>
   </tr>
   <tr>
      <td style="text-align:center">Background music</td>
      <td>Before shooting, you can select a local MP3 file as the background music.</td>
      <td style="text-align:center">✓</td>
   </tr>
   <tr>
