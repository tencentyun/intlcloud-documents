...
- The Tencent Cloud Mobile Live Video Broadcasting (MLVB) basic edition license allows you to use the MLVB basic edition SDK on iOS and Android devices. The annual license fee is USD 699.If you want to buy it now, please [contact sales](https://intl.cloud.tencent.com/contact-sales).
