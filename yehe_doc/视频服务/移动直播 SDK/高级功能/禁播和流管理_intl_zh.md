...
## API 调用
腾讯云提供了直播相关的 API 接口，包括状态查询和状态管理等功能，供您的后台服务器调用，详情请参见 [云直播 API 概览](https://intl.cloud.tencent.com/document/product/267/30760) 文档。
...
|1201|internal/system error|内部系统错误，属于系统异常，建议通过 [工单](https://console.cloud.tencent.com/workorder/category) 反馈到服务商。|
...
>! 以上错误码针对本文 API 列表中的 API，不包括 [消息事件通知](https://intl.cloud.tencent.com/document/product/267/38080)。

## 消息通知
详情请参见腾讯云事件 [消息通知](https://intl.cloud.tencent.com/document/product/267/38080) 服务。 
