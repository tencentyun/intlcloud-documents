...
>!This document describes how to use ReplayKit2 in iOS 11 to publish screen recording streams. Some parts about the SDK also apply to other custom stream publishing scenarios. For detailed instructions, please see the sample code in the `ReplaykitUpload` file of the [demo](https://github.com/tencentyun/MLVBSDK/tree/master/iOS/Demo).
