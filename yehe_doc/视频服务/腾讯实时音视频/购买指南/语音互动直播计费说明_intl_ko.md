본 문서는 TRTC의 저 딜레이 라이브 방송 룸의 과금에 대한 설명입니다. TRTC 방의 오디오 스트림을 CSS 시스템에 릴레이하여 시청자들이 라이브 방송 CDN을 통해 시청하게 되면 추가 요금이 발생합니다. 자세한 내용은 [CDN 라이브 방송 시청 > 관련 요금](https://intl.cloud.tencent.com/document/product/647/35242)을 참조하십시오.
...
- 범용 패키지의 유효 기간은 구매 당일~다음 해 당월 말일까지입니다.
 예를 들면, 2020년 05월 01일 구매한 범용 패키지의 유효 기간은 2020년 05월 01일~2021년 05월 31일입니다.
