본 문서는 멀티미디어 품질, 딜레이, 원활성, 안정성 및 CPU, 메모리, 전력 소모, 발열 등 개발자가 중요하게 여기는 핵심 지표를 중심으로, **정상**, **약한 네트워크 환경** 및 **다양한 실시간 인터랙션 시나리오(1v1, 1vN 등)**에서 객관적인 테스트 및 분석으로 결론을 도출합니다.
...
<table>
<tr><th width="17%">품질 지표</th><th width="50%">설명</th><th>예시</th>
</tr><tr>
<td>Loss</td>
<td>네트워크 패킷 손실</td>
...
<td>RTT</td>
<td>딜레이</td>
<td>200 RTT, 즉 SDK 발송 패킷은 200ms 후 네트워크에서 발송</td>
</tr><tr>
<td>Jitter</td>
<td>지터</td>
