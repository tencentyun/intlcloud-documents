实时音视频控制台的**云端录制用量统计**，主要用于展示 TRTC [按录制时长](https://intl.cloud.tencent.com/document/product/647/38385) 计费的用量明细。若您使用的是云直播的 [按录制并发峰值路数](https://intl.cloud.tencent.com/document/product/267/39605) 计费，需前往 [云直播控制台](https://console.cloud.tencent.com/live/analysis/bill?tab=record) 进行查看。
