...
- All platforms: improved audio playback smoothness when users switch between anchor and audience.
...
**Quality improvement**
- macOS: the `startSystemAudioLoopback` API supported dual sound channels.
