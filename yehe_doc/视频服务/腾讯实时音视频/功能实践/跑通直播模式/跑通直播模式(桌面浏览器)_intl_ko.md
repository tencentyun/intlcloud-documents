본 문서에서는 시청자로서 라이브 룸에 입장해 마이크 연결 인터랙션을 시작하는 시나리오를 소개합니다. 호스트로서 라이브 방송을 진행하는 시나리오는 TRTC 통화 시나리오와 동일하게 [TRTC 통화](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-01-basic-video-call.html)를 참조하십시오.
...
[Client.join()](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#join)을 호출하여 멀티미디어 통화 룸에 입장합니다.
매개변수:
...
>?[Client.join()](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#join) 입장 전 `client.on('stream-added')` 이벤트를 등록하면 원격 사용자의 입장 공지를 놓치지 않을 수 있습니다.
>
```javascript
