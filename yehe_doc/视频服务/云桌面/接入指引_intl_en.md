This document describes how to create a CVD instance from scratch and access it in the simplest way.
## Process Overview
...
According to different job responsibilities and usage requirements, CVD users can be classified as follows:
