...
To grant the permissions, go to the [MPS console](https://console.cloud.tencent.com/mps), and click **Go to CAM** to enter the authorization page.
...
During media processing, you need to perform audio/video transcoding, watermarking, screencapturing, and other operations. You can control different operations by configuring different templates on the **Template Management** page in the console.
...
1. Log in to the [MPS console](https://console.cloud.tencent.com/mps) and go to the**Scheme** > **Scheme Management** page.
...
| Enable event notifications | No       | Event notifications are disabled by default. For more information on how to configure event notifications, see [Getting Started](https://intl.cloud.tencent.com/document/product/1041/33482#recall). To enable TDMQ-CMQ event notifications, go to the [TDMQ console](https://console.cloud.tencent.com/tdmq/cmq-queue?rid=1) to activate the service and create a model. After event notifications are enabled, the specified CMQ queue/topic will receive the event notifications of MPS. |
...
Currently, you can initiate a task by calling a task initiation API, uploading a video file to the COS directory bound to a scheme, or manually creating a task in **Task Management** > [**Create task**](https://console.cloud.tencent.com/mps/tasks/create).

- **Manual task creation:**
  1. Go to the [Task management](https://console.cloud.tencent.com/mps/tasks) page.
  2. Click [Create task](https://console.cloud.tencent.com/mps/tasks/create).
...
- **Automatic trigger for video uploaded to COS:**
  1. After the scheme is enabled, go to the [COS console](https://console.cloud.tencent.com/cos5) and click **Bucket List** on the left sidebar.
...
1. Go to the [Task Management](https://console.cloud.tencent.com/mps/tasks) page to view the list of all initiated tasks.
