...
>? You can view **preset** moderation templates in [Template Management > Moderation Templates](https://console.intl.cloud.tencent.com/mps/templates/audits) of the MPS console.
