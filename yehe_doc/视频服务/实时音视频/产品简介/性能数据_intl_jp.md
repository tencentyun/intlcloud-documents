...
<td>MOS値</td>
<td>通常、通信システムの音声品質を測定するための重要な指標として用いられます。客観的なMOS値は、Spirent Nomadデバイスを採用して<a href="#POLQA">POLQA</a>のスコアリングを行います。スコアが高いほど、音質が良いことを意味します</td>
</tr><tr>
<td>エンドツーエンドの遅延</td>
