...
| API | 描述 |
|-----|-----|
| [getDeviceManager](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/getDeviceManager.html) | 获取设备管理模块，接口详情见 [设备管理接口](https://comm.qq.com/trtc/flutter/cn/tx_device_manager/TXDeviceManager-class.html) 文档。 |
...
| API                                                          | 描述                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [getBeautyManager](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/getBeautyManager.html) | 获取美颜管理对象，接口详情见 [美颜管理](https://comm.qq.com/trtc/flutter/cn/tx_beauty_manager/TXBeautyManager-class.html) 文档。 |
...
| API                                                          | 描述                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [getAudioEffectManager](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/getAudioEffectManager.html) | 获取音效管理类 TXAudioEffectManager，用于管理 BGM，短音效和人声特效，接口详情见 [音效管理](https://comm.qq.com/trtc/flutter/cn/tx_audio_effect_manager/TXAudioEffectManager-class.html) 文档。 |
...
| API                                                          | 描述                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [onStartPublishing](https://comm.qq.com/trtc/flutter/cn/trtc_cloud_listener/TRTCCloudListener.html#onStartPublishing) | 开始向腾讯云的直播 CDN 推流的回调，对应于 [TRTCCloud](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/startPublishing.html) 中的 startPublishing() 接口。 |
| [onStopPublishing](https://comm.qq.com/trtc/flutter/cn/trtc_cloud_listener/TRTCCloudListener.html#onStopPublishing) | 停止向腾讯云的直播 CDN 推流的回调，对应于 [TRTCCloud](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/stopPublishing.html) 中的 stopPublishing() 接口。 |
...
| [onSetMixTranscodingConfig](https://comm.qq.com/trtc/flutter/cn/trtc_cloud_listener/TRTCCloudListener.html#onSetMixTranscodingConfig) | 设置云端的混流转码参数的回调，对应于 [TRTCCloud](https://comm.qq.com/trtc/flutter/cn/trtc_cloud/TRTCCloud/setMixTranscodingConfig.html) 中的 setMixTranscodingConfig() 接口。 |
