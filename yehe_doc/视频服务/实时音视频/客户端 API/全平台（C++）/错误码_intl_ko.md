...
|WARNING_CAMERA_NOT_AUTHORIZED|1112|사용자가 애플리케이션 카메라 액세스 권한 미부여|
...
|WARNING_RTMP_SERVER_BREAK_CONNECT|3004|라이브 스트리밍 오류. 서버에 의해 연결 끊김.|
|WARNING_RTMP_READ_WRITE_FAIL|3005|라이브 스트리밍 오류. RTMP 읽기/쓰기 실패. 연결이 해제됨.|
...
|WARNING_RTMP_NO_DATA|3008|라이브 스트리밍 오류. 30초 이상 데이터가 전송되지 않아 서버 연결 끊김.|
