...
|WARNING_CAMERA_NOT_AUTHORIZED|1112|User did not grant the application permission to access the camera.|
|WARNING_MICROPHONE_DEVICE_EMPTY|1201|No available mic found.|
|WARNING_SPEAKER_DEVICE_EMPTY|1202|No available speaker found.|
|WARNING_MICROPHONE_NOT_AUTHORIZED|1203|User did not grant the application permission to access the mic.|
|WARNING_MICROPHONE_DEVICE_ABNORMAL|1204|No audio capturing device available (for example, because the device is in use).|
|WARNING_SPEAKER_DEVICE_ABNORMAL|1205|No audio playback device available (for example, because the device is in use).|
...
|WARNING_IGNORE_UPSTREAM_FOR_AUDIENCE|6001|You are an audience member, and the request to send audio/video data is ignored.|
|WARNING_NET_BUSY|1101|Bad network connection: data upload blocked due to limited upstream bandwidth.|
|WARNING_RTMP_SERVER_RECONNECT|1102|Push error. The network is disconnected. Attempting to reconnect (max attempts: 3).|
|WARNING_LIVE_STREAM_SERVER_RECONNECT|2103|Pull error. The network is disconnected. Attempting to reconnect (max attempts: 3).|
...
|WARNING_RTMP_NO_DATA|3008|Live streaming error. Server disconnected because no data is sent for over 30 seconds.|
...
|WARNING_NO_STEAM_SOURCE_FAIL|3010|Live streaming error. Connection failed because there was no video in the stream address. This is an internal error code of the SDK and is not thrown.|
