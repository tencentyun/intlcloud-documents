...
| [startLocalPreview](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__cplusplus.html#aef6d61f571304066aaf839f7db00a17b) | ローカルカメラのプレビュー画面を有効化（デスクトップ） |
...
| [pauseScreenCapture](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__cplusplus.html#a0dcd89ed2e23706239db98b55dd806d4) | 画面共有を再開 |
...
| [setSubStreamEncoderParam](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__cplusplus.html#a542913f5081fb2479137a7416c970e2d) | 画面共有（サブストリーム）のビデオコーデックパラメータを設定（このインターフェースはデスクトップシステムのみをサポート） |
...
| API | 説明 |
|-----|-----|
| [startSpeedTest](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__cplusplus.html#af86b2903b95b6e74f02d701701ce3380) | ネットワークスピードテストを開始（ルーム入室前に使用）|
...
| [callExperimentalAPI](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__cplusplus.html#ab15fc0877664a8ac257ca4d6e7afc7b0) | 試験的インターフェースの呼び出し |
...
| [onSpeedTest](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudCallback__cplusplus.html#a455264cfcf2a7a3f022f3bce0659f9f7) | サーバースピードテストの結果のコールバック |
