...
|WARNING_RTMP_SERVER_RECONNECT|1102|Live streaming error. Network disconnected. Reconnecting (max. attempts: 3).|
|WARNING_LIVE_STREAM_SERVER_RECONNECT|2103|Live streaming error. Network disconnected. Reconnecting (max. attempts: 3).|
