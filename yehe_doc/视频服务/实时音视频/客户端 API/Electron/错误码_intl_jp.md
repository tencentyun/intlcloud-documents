...
| ERR_SERVER_INFO_PRIVILEGE_FLAG_ERROR | -100006 | パーミッションビットのチェックに失敗しました。privateMapKeyが正しいかどうか確認してください |
...
| ERR_SERVER_INFO_ECDH_GET_TINYID      | -100018 | userSigのチェックに失敗しました。userSigが正しいかどうか確認してください |
...
|ERR_SERVER_CENTER_CONN_ROOM_SIG_GROUPID|-102041|ルーム間マイク接続の署名ルーム番号が一致しません|
|ERR_SERVER_CENTER_CONN_ROOM_NOT_CONNED|-102042|ルーム間マイク接続の署名ユーザー名が一致しません|
