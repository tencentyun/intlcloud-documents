    ...
    <div class="scene-card-container">
        <div class="scene-card">
            ...
            <div style="float: left; width: 200px; margin-left: 30px; margin-top: 20px; ">
                ...
                <a
                    href="https://github.com/tencentyun/TRTCSDK/tree/master/Electron/TRTCScenesDemo/TRTCEducation">GitHubソースコード</a>
    ...
    <div class="scene-card-container">
        <div class="scene-card">
            ...
            <div style="float: left; width: 200px; margin-left: 30px; margin-top: 20px; ">
                ...
                <p style="color:#586376" ;>コンポーネント化されたUIによって、ミーティングシーンをローコードですばやく実現</p>
