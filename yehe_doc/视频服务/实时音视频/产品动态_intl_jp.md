...
<td> フル機能：<ul style="margin:0">
ビデオシーンにおける性能を最適化します。
</ul>
<br>Windows: <ul style="margin:0">
<li>「ヘヴィメタル」や「ロリ声」などの音響効果インターフェースを追加しました。詳細については<code>ITXAudioEffectManager.setVoiceChangerType</code>をご参照ください。</li>
<li>ローカルの画面が一時停止されている間に代替画像を設定してプッシュすること、すなわち代替画像のプッシュをサポートします。</li>
</ul>
</td>
<td>2022-04-21</td>
...
<br>Windows: <ul style="margin:0">
<li>Music音質での再生効果を最適化し、音質へのダメージを軽減します。</li>
<li>一部のプロ向けのサウンドカードの互換性問題を改善し、音質の向上に有効です。</li>
<li>サードパーティプロセスリミックスの最適化により、サードパーティプロセスリミックスでより多くのシーンに対応できます。</li>
</ul>
</td>
<td>2022-04-06</td>
<td><a href="https://intl.cloud.tencent.com/document/product/647/34615">SDKダウンロード</a></td>
...
<li>サードパーティライブラリのコンプライアンス改造を完了し、国内、海外のコンプライアンス要件を満たすようにしました。
<li>TRTC SDKのボリュームを最適し、データの詳細については<a href="https://intl.cloud.tencent.com/document/product/647/39426">リリースノート</a>をご参照ください。
<li>既知の問題を修正し、安定性を高めました。
</ul>
<br>Windows: <ul style="margin:0">
<li>Live V1からV2インターフェースにアップグレードされ、より安定したLiveコンポーネントを提供します。</li>
<li>ローエンドでのグラフィックカードの互換性を向上させました。</li>
</ul>
<br>iOS: <ul style="margin:0">
フィルライトの下で偶発的に現れるソラリゼーションの問題を修正しました。
</ul>
<br>Android: <ul style="margin:0">
美顔などの前処理プロセスを最適化し、ローエンドのキャプチャカードのラグ問題を修正しました。
</ul>
<br>Mac: <ul style="margin:0">
テクスチャのアップロードをサポートし、性能を高めました。
</ul>
</td>
<td>2022-03-24</td>
<td><a href="https://intl.cloud.tencent.com/document/product/647/34615">SDKダウンロード</a></td>
...
<br>Android: <ul style="margin:0">
アップストリームでカメラをオフにしてからオンにし、再生側でオフにする前の最後のフレームが表示されてから正常に表示されるという問題を修正しました。
</ul>
</td>
<td>2022-01-11</td>
<td><a href="https://intl.cloud.tencent.com/document/product/647/34615">SDKダウンロード</a></td>
...
このバージョンは国家プライバシーセキュリティ基準の規定に適合し、Tencent社内での複数製品に対して検証しました。
</ul>
<br>Mac: <ul style="margin:0">
...
<li>プッシュ側がバックグラウンドに戻ってビデオのアップロードを一時停止すると、再生側は<a href="https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudCallback__cplusplus.html#a091f1c94ff1e2bc39c36e9d34285e87a">onUserVideoAvailable(false)</a> の通知を速やかに受信できます。</li>
</ul><br>Mac: <ul style="margin:0">
...
<td>2020-07-01</td>
<td><a href="https://intl.cloud.tencent.com/document/product/647/38929">クラウドレコーディングの課金説明</a></td>
</tr>
</table>
