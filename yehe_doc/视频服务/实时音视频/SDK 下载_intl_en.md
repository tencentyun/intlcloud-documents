...
>- Since LiteAV SDKs all use the same core modules, symbol duplicate can occur if your project integrates more than two LiteAV SDKs. Using the professional edition of LiteAV SDK can avoid this problem.
>- Read [How to Downsize Installation Package](https://intl.cloud.tencent.com/document/product/647/35165) to learn how to reduce the storage footprint of the SDK.


<h2 id="Enterprise">Enterprise Edition</h2>

In addition to all the features of the professional edition, the enterprise edition includes a set of AI beauty special effect components such as eye enlarging, face slimming, beauty filter, and dynamic stickers.
...
>
>- For Windows and Mac, no SDK with AI beauty special effect components is available and only one unified edition is provided.
>- Read [How to Downsize Installation Package](https://intl.cloud.tencent.com/document/product/647/35165) to learn how to reduce the storage footprint of the SDK.
...
<table>
  <tr>
    ...
    <th width="100px" style="text-align:center">LiteAV_Smart</th>
    <th width="100px" style="text-align:center">LiteAV_UGC</th>
  ...
  <tr>
    <td rowspan='4' style="text-align:center">AI Beauty Special Effects</td>
