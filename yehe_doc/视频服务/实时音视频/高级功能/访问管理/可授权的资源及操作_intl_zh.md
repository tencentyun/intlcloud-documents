...
| [DescribeRealtimeNetwork](https://intl.cloud.tencent.com/document/product/647/36757) | 通话质量监控 | 查询实时网络状态       |
| [DescribeRealtimeQuality](https://intl.cloud.tencent.com/document/product/647/36756) | 通话质量监控 | 查询实时质量数据       |
| [DescribeRealtimeScale](https://intl.cloud.tencent.com/document/product/647/36755) | 通话质量监控 | 查询实时规模           |
...
>! 针对不支持资源级授权的 API 操作，您仍然可以通过 [自定义策略](https://intl.cloud.tencent.com/document/product/647/39551) 向用户授予使用该操作的权限，但是策略语句的资源元素必须指定为`*`。
