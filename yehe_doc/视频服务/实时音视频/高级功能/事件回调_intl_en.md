...
| USER_TYPE_APPLET | 2  | WeChat Mini Program |
...
|Room exit | <li/>1: voluntary exit <li/>2: timeout <li/>3: removed from the room <li/>4: cancelling of co-anchoring <li/>5: force killing|
