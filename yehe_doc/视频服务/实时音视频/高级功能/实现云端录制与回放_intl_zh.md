...
- **如何开启点播服务的子应用？**
  您可以根据文档 [“如何开启点播子应用”](https://intl.cloud.tencent.com/document/product/266/33987) 添加新的子应用，这一步需要您跳转到 [点播控制台](https://console.cloud.tencent.com/vod) 中进行操作。
