## 适用场景
在 [CDN 直播观看](https://intl.cloud.tencent.com/document/product/647/35242) 和 [云端录制回放](https://intl.cloud.tencent.com/document/product/647/35426) 等应用场景中，常需要将 TRTC 房间里的多路音视频流混合成一路，您可以使用腾讯云服务端的 MCU 的混流转码集群完成该项工作。
