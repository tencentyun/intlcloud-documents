...
- 方案一：使用服务端 REST API [StartMCUMixTranscode](https://intl.cloud.tencent.com/zh/document/product/647/37761) 和 [StopMCUMixTranscode](https://intl.cloud.tencent.com/zh/document/product/647/37760) 进行控制，该 REST API 还可以同时支持启动 CDN 观看和云端录制。
