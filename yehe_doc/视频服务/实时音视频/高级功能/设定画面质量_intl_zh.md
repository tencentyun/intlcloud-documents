...
在 TRTCCloud 中，您可以通过三个手段来调整画质：
- enterRoom 中的 TRTCAppScene 参数： 用来选择您的应用场景。
- setVideoEncoderParam：用来设置编码参数。
- setNetworkQosParam：用来设置网络调控策略。
本文主要介绍如何配置这些手段，使 TRTC SDK 的画质效果符合您的项目需要。
...
Web 端设定画面质量的详细操作，请参见 [设定指引](https://www.qcloudtrtc.com/trtc-web-sdk/docs/api/tutorial-04-advanced-set-video-profile.html) 。
