...
[](id:step1)
### 步骤1：完成前序步骤
请参考文档 [导入 SDK 到项目中](https://intl.cloud.tencent.com/document/product/647/35097) 完成 SDK 的导入。
...
[](id:step3)
### 步骤3：进入 TRTC 房间
参考文档 [进入房间](https://intl.cloud.tencent.com/document/product/647/48049) 让当前用户进入 TRTC 房间，只有在成功进入房间之后才能订阅其他用户的音视频流。
...
如果要让 denny 彻底“闭嘴”，就需要去影响 denny 的音频发布行为，我们会在下一篇文档 [发布音视频流](https://intl.cloud.tencent.com/document/product/647/48050) 中详细介绍。
