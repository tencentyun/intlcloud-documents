...
如果您希望调节美颜效果和画面质量，我们会在 [设定画面质量](https://intl.cloud.tencent.com/document/product/647/35153) 中进行详细介绍。
...
参考文档 [进入房间](https://intl.cloud.tencent.com/document/product/647/47645) 让当前用户进入 TRTC 房间。一旦进入房间后，SDK 便会开始向房间中的其他用户发布自己的音频流。
