...
[](id:step1)
### 步骤1：完成前序步骤
请参考文档 [导入 SDK 到项目中](https://intl.cloud.tencent.com/document/product/647/35097) 完成 SDK 的导入和配置。
...
[](id:step4)
### 步骤4：进入 TRTC 房间
参考文档 [进入房间](https://intl.cloud.tencent.com/document/product/647/48049) 让当前用户进入 TRTC 房间。一旦进入房间后，SDK 便会开始向房间中的其他用户发布自己的音频流。
