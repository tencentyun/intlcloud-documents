...
- **Demo 1: base-js**
개발 프레임워크: jQuery + 네이티브 JavaScript
TRTC Web 기본 Demo (jQuery 버전)는 기본 음성/영상 통화, 장치 선택 등 기타 TRTC Web SDK 기능을 통합하고 브라우저에서 직접 실행할 수 있습니다. 빠른 체험을 원하시면 [base-js 온라인 체험 주소](https://web.sdk.qcloud.com/trtc/webrtc/demo/latest/official-demo/index.html)로 이동하십시오.
- **Demo 2: quick-demo-js**
개발 프레임워크: 프레임워크 없음, 네이티브 JavaScript
TRTC Web 빠른 실행 Demo(네이티브 JavaScript 버전)는 기본 음성/영상 통화, 장치 선택 등 기타 TRTC Web SDK 기능을 통합한 것으로, 브라우저에서 직접 실행할 수 있습니다. 빠른 체험을 원하시면 [quick-demo-js 온라인 체험 주소](https://web.sdk.qcloud.com//trtc/webrtc/demo/quick-demo-js/index.html)로 이동하십시오.
- **Demo 3: quick-demo-vue2-js**
개발 프레임워크: Vue 2 + JavaScript
TRTC Web 빠른 실행 Demo(Vue2 버전)는 기본 음성/영상 통화, 장치 선택 등 기타 TRTC Web SDK 기능을 통합합니다. Node 환경을 설치해야 합니다. 빠른 체험을 원하시면 [quick-demo-vue2-js 온라인 체험 주소](https://web.sdk.qcloud.com/trtc/webrtc/demo/quick-demo-vue2-js/index.html)로 이동하십시오.
- **Demo 4: quick-demo-vue3-ts**
개발 프레임워크: Vue 3 + TypeScript
TRTC Web 빠른 실행 Demo(Vue3 버전)는 기본 음성/영상 통화, 장치 선택 등 기타 TRTC Web SDK 기능을 통합합니다. Node 환경을 설치해야 합니다. 빠른 체험을 원하시면 [quick-demo-vue3-ts 온라인 체험 주소](https://web.sdk.qcloud.com/trtc/webrtc/demo/quick-demo-vue3-ts/index.html)로 이동하십시오.

<dx-tabs>
::: Demo 1
디렉터리는 `TRTC_Web/base-js`입니다.
...
:::
::: Demo 2
디렉터리는 `TRTC_Web/quick-demo-js`입니다.
1. 다운로드한 소스 코드에서 'TRTC_Web/quick-demo-js/index.html' 파일을 브라우저로 찾아 엽니다.

<dx-alert infotype="explain">
<li>TRTC Web SDK가 지원하는 브라우저는 [TRTC Web SDK 지원 플랫폼](https://intl.cloud.tencent.com/document/product/647/41664)을 참고하십시오.</li>
...
:::
::: Demo 3
디렉터리는 `TRTC_Web/quick-demo-vue2-js`입니다.
1. 다운로드한 소스 코드에서 `TRTC_Web/quick-demo-vue2-js/` 디렉터리를 찾아 입력합니다.
2. Demo 로컬 실행
```shell
npm start
```
기본 브라우저는 `http://localhost:8080/` 주소를 자동으로 엽니다.

<dx-alert infotype="notice">
<li>포트 번호는 로컬에서 Demo를 실행한 후 실제 포트 번호를 기준으로 하며 기본값은 8080입니다.</li>
<li>TRTC Web SDK가 지원하는 브라우저는 [TRTC Web SDK 지원 플랫폼](https://intl.cloud.tencent.com/document/product/647/41664)을 참고하십시오.</li>
<li>TRTC Web SDK 도메인 프로토콜 제한 사항은 [TRTC Web SDK 도메인 프로토콜 제한](https://intl.cloud.tencent.com/document/product/647/41664)을 참고하십시오.</li>
<li>TRTC Web SDK 도메인 및 포트 얼로우리스트 설정은 [TRTC Web SDK 도메인 및 포트 얼로우리스트 설정](https://intl.cloud.tencent.com/document/product/647/35164#webrtc-.E9.9C.80.E8.A6.81.E9.85.8D.E7.BD.AE.E5.93.AA.E4.BA.9B.E7.AB.AF.E5.8F.A3.E6.88.96.E5.9F.9F.E5.90.8D.E4.B8.BA.E7.99.BD.E5.90.8D.E5.8D.95.EF.BC.9F)을 참고하십시오.</li></dx-alert>
...
:::
::: Demo 4
디렉터리는 `TRTC_Web/quick-demo-vue3-ts`입니다.
1. 다운로드한 소스 코드에서 `TRTC_Web/quick-demo-vue3-ts/` 디렉터리를 찾아 입력합니다.
2. Demo 로컬 실행
```shell
npm start
```
...
<ul style="margin:0"><li>이 문서에서 UserSig를 생성하는 데 사용되는 방법은 클라이언트 코드에서 SECRETKEY를 구성하는 것입니다. 이는 SECRETKEY를 디컴파일 및 크래킹에 취약하게 만듭니다. 키가 유출되면 공격자가 Tencent Cloud 트래픽을 도용할 수 있습니다. <strong>따라서 이 방법은 로컬에서 Demo 프로젝트를 실행하고 디버깅하는 데에만 적합합니다</strong>.</li><li>올바른 UserSig 배포 방법은 UserSig의 계산 코드를 서버에 통합하고 App 지향 API를 제공하는 것입니다. UserSig가 필요할 때 App은 동적 UserSig에 대한 요청을 비즈니스 서버에 보낼 수 있습니다. 자세한 내용은 <a href="https://intl.cloud.tencent.com/document/product/647/35166#Server">서버에서 UserSig 생성</a>을 참고하십시오.</li></ul>
</dx-alert>
...
3. **퀵 스타트** 탭을 선택하고 **2단계: UserSig 발급 키 획득**HMAC-SHA256**을 클릭합니다.
...
해당 오류는 TRTC Web SDK STUN 홀 펀칭 실패 시 발생합니다. [방화벽 제한 처리](https://www.tencentcloud.com/document/product/647/35164)에 따라 방화벽 설정을 확인해 주십시오.
...
해당 오류는 TRTC Web SDK MediaConnect 터널 구축 실패 시 발생합니다. [방화벽 제한 처리](https://www.tencentcloud.com/document/product/647/35164)에 따라 방화벽 설정을 확인해 주십시오.
