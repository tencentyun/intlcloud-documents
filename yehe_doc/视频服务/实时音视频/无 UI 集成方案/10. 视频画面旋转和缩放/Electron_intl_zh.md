...
## 自定义控制本地画面
可以通过调用 [setLocalRenderParams](https://web.sdk.qcloud.com/trtc/electron/doc/en-us/trtc_electron_sdk/TRTCCloud.html#setLocalRenderParams) 设置本地渲染参数。
```javascript
import TRTCCloud, { 
...
## 自定义控制远程画面画面
可以通过调用 [setRemoteRenderParams](https://web.sdk.qcloud.com/trtc/electron/doc/en-us/trtc_electron_sdk/TRTCCloud.html#setRemoteRenderParams) 设置远端渲染参数。
```javascript
import TRTCCloud, { 
  TRTCRenderParams, TRTCVideoRotation, TRTCVideoFillMode,
