...
>?CSDN의 [iOS 가로 세로 화면 회전 및 기본 적응 방법](https://blog.csdn.net/DreamcoffeeZS/article/details/79037207)에서는 iOS 플랫폼의 화면 방향에 대한 개발 경험을 자세히 소개하고 있습니다.
:::
::: Android 플랫폼
...
- iOS 플랫폼에서는 `TRTCVideoResolutionModeLandscape`로 지정해야 합니다.
- Android 플랫폼에서는 `TRTC_VIDEO_RESOLUTION_MODE_LANDSCAPE`로 지정해야 합니다.
