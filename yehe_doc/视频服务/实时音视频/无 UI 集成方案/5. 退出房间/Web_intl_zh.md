...
[](id:step1)
## 步骤1：完成前序步骤
可以参考文档 [进入房间](https://intl.cloud.tencent.com/document/product/647/48424)，创建 Client 并进入房间。
