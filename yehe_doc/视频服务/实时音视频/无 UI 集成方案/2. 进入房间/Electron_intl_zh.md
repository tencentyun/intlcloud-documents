...
[](id:step1)
### 步骤1：导入 SDK
请参考文档 [导入 SDK 到项目中](https://intl.cloud.tencent.com/document/product/647/35097) 完成 SDK 的导入工作。
...
| userSig | 进房鉴权票据 | 您可以使用 SDKAppID 和 userId 计算出 userSig，计算方法请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166) 。|字符串| eJyrVareCeYrSy1SslI... |
...
function onEnterRoom(result) {
  ...
  if (result > 0) {
    ...
    // 参见进房错误码 https://intl.cloud.tencent.com/document/product/647/35124
