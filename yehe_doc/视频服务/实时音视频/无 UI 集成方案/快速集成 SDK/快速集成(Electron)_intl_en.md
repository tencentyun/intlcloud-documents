...
If an error occurs when you integrate the TRTC Electron SDK, for example, if installation times out or the `trtc_electron_sdk.node` file fails to load after packaging, please [contact us](https://intl.cloud.tencent.com/contact-us) for help.
[](id:QQ)
## Technical Support
