...
### 수동 통합
1. [TRTC - SDK ](https://github.com/LiteAVSDK/TRTC_iOS/tree/main/SDK)를 다운로드한 후, 압축을 해제합니다.
...
4. 다운로드한 TRTC SDK Framework 및 필요한 종속 라이브러리 **VideoToolBox.framework**, **MetalKit.framework**, **SystemConfiguration.framework**, **ReplayKit.framework**, **libc++.tbd**, **Accelerate.framework**, **CoreMedia.framework**, **CoreTelephoney.framework**를 차례로 추가합니다.
 ![](https://qcloudimg.tencent-cloud.cn/raw/c3a1b11bce036f654b747c7937edb709.png)
5. **TRTC SDK  9.6 이상 버전**은 동적 라이브러리 종속성을 추가해야 합니다.
**General**을 클릭하여 **Frameworks,Libraries,and Embedded Content**를 선택하고, 하단의 ‘+’를 클릭하여 TXLiteAVSDK_TRTC.framework에 필요한 동적 라이브러리 **TXFFmpeg.xcframework**, **TXSoundTouch.xcframework**를 순서대로 추가한 후 **Embed & Sign**을 선택합니다.
