...
### 方案二：下载 SDK 并手动导入
1. 下载 [SDK](https://intl.cloud.tencent.com/document/product/647/34615) 并解压到本地。
...
>? 对于 Objective-C 接口的使用方式，请参见 [iOS&Mac API 概览](https://intl.cloud.tencent.com/document/product/647/35119)。
