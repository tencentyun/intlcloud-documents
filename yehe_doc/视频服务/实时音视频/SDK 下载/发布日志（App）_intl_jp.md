...
>?これより前のバージョンの更新履歴については[その他](https://intl.cloud.tencent.com/document/product/647/39426)をクリックしてください。
...
- Windows：スクリーン間で指定したエリアの画面共有をサポートします。
...
- API追加：pauseAudioEffect、resumeAudioEffectの音響効果は、制御の一時停止/回復の制御をサポートします。
...
- コールバックonRemoteUserEnterRoom / onRemoteUserLeaveRoomを追加しました。マイクオンになっていないキャスターの入退室通知をサポートします。
