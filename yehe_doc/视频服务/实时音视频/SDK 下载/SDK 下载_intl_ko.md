...
프로 버전은 [MLVB](https://intl.cloud.tencent.com/product/mlvb), [UGSV](https://intl.cloud.tencent.com/product/ugsv) 등 TRTC 를 포함한 다양한 멀티미디어 관련 핵심 기능이 통합되어 있습니다. 하위 레이어 모듈이 효율적으로 재사용되어 통합 프로 버전의 증분 용량이 개별 SDK 2개를 통합한 용량보다 작고, 부호 충돌(symbol duplicate) 문제를 방지할 수 있습니다.
...
엔터프라이즈 버전은 프로 버전의 모든 기능을 포함할 뿐 아니라 큰 눈, 갸름한 얼굴, 메이크업, 움직이는 스티커, 액세서리 등을 지원하는 AI 특수 효과 모듈이 통합되어 있습니다. 다운로드 후 압축 해제 비밀번호 및 라이선스가 있어야만 실행이 가능하며, 비밀번호 및 라이선스 관련 사항은 Tencent Cloud 영업 담당자에게 문의하여 주시기 바랍니다.
...
<table>
  <tr>
    ...
    <th width="100px" style="text-align:center"><a href="https://intl.cloud.tencent.com/document/product/647/34615">플레이어 버전</a><br>LiteAV_Player</th>
