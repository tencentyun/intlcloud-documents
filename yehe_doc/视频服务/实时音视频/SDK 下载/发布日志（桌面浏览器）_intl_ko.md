...
> - 버전 업데이트에 대한 주의 사항은 [업데이트 가이드](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-00-info-update-guideline.html)를 참조하십시오.
...
- 클라우드 혼합 스트림에서 프리셋 레이아웃 모드 지원. 자세한 내용은 [Client.startMixTranscode](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#startMixTranscode) 인터페이스를 참조하십시오.
- 음량 콜백 지원. 자세한 내용은 [Client.enableAudioVolumeEvaluation](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#enableAudioVolumeEvaluation) 인터페이스를 참조하십시오.
...
- 자동 재생 제한 시 처리 로직 최적화. 자세한 내용은 [자동 재생 제한 처리 제안](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-21-advanced-auto-play-policy.html)을 참조하십시오.
- 디바이스 연결/해제 자동 복구 실패 시 처리 로직 최적화. 자세한 내용은 [DEVICE_AUTO_RECOVER_FAILED](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/module-ErrorCode.html#.DEVICE_AUTO_RECOVER_FAILED)를 참조하십시오.
...
- 오디오만 구독 시 간혹 오디오가 재생되지 않는 문제 수정
...
- 방 입장 인터페이스 roomId 매개변수 검증 로직 최적화. 자세한 내용은 [인터페이스 문서](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#join) 및 [업데이트 가이드](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-00-info-update-guideline.html)를 참조하십시오.
...
폐기된 인터페이스 삭제: setDefaultMuteRemoteStreams. [client.unsubscribe](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#unsubscribe) 인터페이스로 대체하여 사용하십시오.
...
- 모든 플랫폼에서 문자열 방 번호 지원. 자세한 내용은 [TRTC.createClient의 useStringRoomId 매개변수](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/TRTC.html#.createClient)를 참조하십시오.
- 자동 구독 비활성화 지원. 자세한 내용은 [TRTC.createClient의 autoSubscribe 매개변수](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/TRTC.html#.createClient)를 참조하십시오.
...
- 미디어 디바이스 변경 시(예시: 인터페이스 완화, 디바이스 연결/해제 등)의 자동 복구 채택 로직 최적화
...
- Safari 화면 공유 지원. 자세한 내용은 [화면 공유 사용 튜토리얼](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-16-basic-screencast.html)을 참조하십시오.
...
- 디바이스 전환 시 MediaStream을 릴리스하는 경우 디바이스 점유율 문제 해결
