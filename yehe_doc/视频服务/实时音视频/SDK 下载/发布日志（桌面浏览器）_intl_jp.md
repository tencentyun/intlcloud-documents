...
廃止済みのインターフェースsetDefaultMuteRemoteStreamsを削除しました。代わりに[client.unsubscribe](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/Client.html#unsubscribe)インターフェースを使用してください。
