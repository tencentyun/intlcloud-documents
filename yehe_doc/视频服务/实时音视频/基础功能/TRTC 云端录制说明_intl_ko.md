...
단일 스트림 녹화 멀티미디어 파일을 MP4 파일로 병합하는 데 사용되는 [단일 스트림 멀티미디어 파일 병합 스크립트](https://trtc-partner-sg-1253488539.cos.ap-singapore.myqcloud.com/media-file-toolkit.zip)를 제공합니다.
