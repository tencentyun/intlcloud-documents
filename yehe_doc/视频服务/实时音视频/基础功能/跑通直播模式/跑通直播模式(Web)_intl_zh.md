...
## 示例
您可以单击 [Demo](https://web.sdk.qcloud.com/trtc/webrtc/demo/api-sample/basic-live.html) 前往体验音视频功能，也可以登录 [GitHub](https://github.com/LiteAVSDK/TRTC_Web/tree/main/base-react-next/src/pages/basic-live) 获取本文档相关的示例代码。
