## ユースケース
TRTCは、4種類の異なる入室モードをサポートしています。このうち、ビデオ通話（VideoCall）および音声通話（AudioCall）を総称して通話モードといい、ビデオインタラクティブストリーミング（Live）およびボイスインタラクティブストリーミング（VoiceChatRoom）を総称して [ライブストリーミングモード](https://intl.cloud.tencent.com/document/product/647/35107)といいます。
