## 적용 시나리오
TRTC는 4가지 입장 모드를 지원합니다. 그 중 영상 통화(VideoCall)와 음성 통화(AudioCall)는 통화 모드라고 부르고, 비디오 ILVB(Live)와 음성 ILVB(VoiceChatRoom)는 [라이브 방송 모드](https://intl.cloud.tencent.com/document/product/647/35107)라고 부릅니다.
...
## 예시 코드
[Github](https://github.com/LiteAVSDK/TRTC_iOS/tree/main/TRTC-API-Example-OC)에 로그인하여 본 문서와 관련된 예시 코드를 확인할 수 있습니다.
...
>! App에서 여러 개의 멀티미디어 SDK가 동시에 통합되었을 경우, `onExitRoom` 콜백을 받은 후 다른 멀티미디어 SDK를 재실행하십시오. 그렇지 않으면 하드웨어 점유율 문제가 나타날 수 있습니다.
