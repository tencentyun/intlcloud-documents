...
- `userId`：用户 ID
- `userSig`：用户签名，计算方式请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)
...
4. 远端流通过监听事件[Client.on('stream-added')](https://web.sdk.qcloud.com/trtc/webrtc/doc/en/module-ClientEvent.html#.STREAM_ADDED)获取，收到该事件后，通过 [Client.subscribe()](https://web.sdk.qcloud.com/trtc/webrtc/doc/en/Client.html#subscribe) 订阅远端音视频流。
>?
>- 请在 [Client.join()](https://web.sdk.qcloud.com/trtc/webrtc/doc/en/Client.html#join) 进房前注册 [Client.on('stream-added')](https://web.sdk.qcloud.com/trtc/webrtc/doc/en/module-ClientEvent.html#.STREAM_ADDED) 事件以确保您不会错过远端用户进房通知。
