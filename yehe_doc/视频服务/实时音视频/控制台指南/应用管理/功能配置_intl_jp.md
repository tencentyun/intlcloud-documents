...
- Relayed Pushを [CDN relayed live streaming](https://intl.cloud.tencent.com/document/product/647/35242) に使用する場合、LVBではrelayed live streamingによる下りトラフィック/帯域幅に基づき、関連費用が課金されます。詳細は、[LVB購入ガイド課金説明](https://intl.cloud.tencent.com/zh/document/product/267/2818) の説明をご参照ください。
...
2. 【Relayed Push設定】の中で、【Relayed Pushを有効】の右側のボタンをクリックします。
...
- レコーディングしたビデオファイルを再生またはダウンロードしたい場合、VODサービスのトラフィック（ビデオアクセラレーション）費用が発生し、下りアクセラレーションのトラフィックに応じて課金されます。詳しい課金規則は、[VOD購入ガイド課金方式従量課金（日次決済後払い）](https://intl.cloud.tencent.com/document/product/266/14666) をご参照ください。
