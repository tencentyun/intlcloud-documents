...
1. 进入实时音视频控制台，选择左侧栏的【应用管理】>【UserSig生成】，查看[签名(UserSig)生成工具](https://console.tencentcloud.com/trtc/app)模块。
...
1. 进入实时音视频控制台，选择左侧栏的【应用管理】>【UserSig校验】，查看[签名(UserSig)校验工具](https://console.tencentcloud.com/trtc/app)模块。
