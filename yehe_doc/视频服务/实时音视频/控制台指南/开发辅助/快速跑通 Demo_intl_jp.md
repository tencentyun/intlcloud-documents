...
## 前提条件
TRTCサービスをアクティブにして、 [TRTCコンソール](https://console.cloud.tencent.com/trtc)に入ります。

## 操作手順
[](id:step1)
### 手順1：アプリケーションの作成
1. TRTCコンソールのログインは、【開発支援】>【[Demoのクイック実行](https://console.cloud.tencent.com/trtc/quickstart)】を選択します。
2．例えば、`TestTRTC`などのアプリケーション名を入力して、【作成】をクリックします。
...
3. 貼り付け完了後、【貼り付けました。次のステップ】をクリックすれば、作成が完了します。
...
コンパイル完了後、【コンソール概要に戻る】をクリックすればOKです。
