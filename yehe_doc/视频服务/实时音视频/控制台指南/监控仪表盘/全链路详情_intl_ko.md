...
[](id:resolution)
#### 해결
비디오 및 화면 공유의 해상도는 중계된 라이브 스트리밍 및 녹화된 스트림의 재생을 분석하는 데 주로 사용되는 추가 정보입니다. 해상도 변동은 [CDN](https://intl.cloud.tencent.com/product/cdn)을 통해 중계된 라이브 스트림을 시청하거나 녹화된 비디오를 재생하는 청중, 특히 Web 사용자가 랙 또는 픽셀화된 비디오와 같은 플레이어 호환성 문제를 경험할 수 있음을 나타냅니다.
