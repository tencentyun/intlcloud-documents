...
| 参与用户数         | 进入过房间的累计用户数。                                     |
| 操作               | 可单击 **[查看通话详情](https://intl.cloud.tencent.com/document/product/647/39070)** 进入通话详情页面，查看详细图表。  |
...
- 若您需进入指定房间后并了解详细的通话数据，请参见 [通话详情](https://intl.cloud.tencent.com/document/product/647/39070)。
