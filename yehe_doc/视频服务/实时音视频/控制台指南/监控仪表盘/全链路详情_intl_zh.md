...
正常情况下，视频和音频的码率是上下波动范围 ±10% 以内的曲线。若出**现码率突降，或是 &gt;30% 以上的波动情况，则表示当前网络出现阻塞或抖动**。
...
#### 分辨率
视频和屏幕分享的分辨率作为辅助信息，主要用在旁路直播及录制文件回放的判断。若视频的分辨率存在变化，则通过 [CDN](https://intl.cloud.tencent.com/product/cdn) 观看旁路直播的的观众，或者是观看视频回放的观众，可能会存在一些播放器兼容问题如画面卡住、花屏等，尤其是 Web 端用户。
