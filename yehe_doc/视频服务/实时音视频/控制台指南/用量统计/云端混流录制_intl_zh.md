实时音视频控制台的**云端混流转码用量统计**，主要用于展示 TRTC 提供的 [MCU 云端混流转码](https://intl.cloud.tencent.com/document/product/647/38929) 产生的用量明细，若您使用的是云直播的提供的 [云端混流功能](https://intl.cloud.tencent.com/document/product/267/37665) 计费，请前往 [云直播控制台](https://console.cloud.tencent.com/live/analysis/bill?tab=record) 进行查看。

## 注意事项
用量统计非实时刷新，每5分钟统计一次，数据展示可能会有5分钟 - 20分钟延迟。

## 操作步骤
1. 进入**实时音视频控制台**，选择左侧栏的**用量统计** > **云端混流转码**。
