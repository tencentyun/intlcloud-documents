...
可以**购买独立**直播 License、短视频 License 或视频播放 License（**自绑定包名起计算，授权有效期为 1 年后到期次日 00:00:00 止**）。
...
- 每个腾讯云账号可分别**免费申请 1 次**直播 License 、短视频 License、视频播放 License 进行测试体验产品功能，提供 28 天有效期。
