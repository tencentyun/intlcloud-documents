...
5. **TRTC SDK  9.5.11234 이상 버전**은 동적 라이브러리 종속성을 추가해야 합니다.
**General**을 클릭하여 **Frameworks,Libraries,and Embedded Content**를 선택하고, 하단의 ‘+’를 클릭하여 TXLiteAVSDK_TRTC.framework에 필요한 동적 라이브러리 **BoringSSL.xcframework**, **FFmpeg.xcframework**, **SoundTouch.xcframework**를 순서대로 추가한 후 **Embed & Sign**을 선택합니다.
