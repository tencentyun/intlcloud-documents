...
Android Studio를 사용해 통합이 필요한 SDK 프로그램(본 문서는 [TRTCSimpleDemo](https://github.com/tencentyun/TRTCSDK/tree/master/Android/TRTCScenesDemo)를 예시로 함)을 연 후, 간단한 세 단계를 걸쳐 app/build.gradle 파일을 수정하면 SDK 통합이 완료됩니다.
