...
- IM 应用针对文本消息，提供基础版本的安全打击能力，如果希望使用自定义不雅词功能，可以单击【升级】或在[【购买页】](https://buy.cloud.tencent.com)购买 [安全打击 - 专业版服务](https://intl.cloud.tencent.com/document/product/1047/34350)。
...
>1. 在【应用管理】>【功能配置】中 [开启自动旁路推流](https://intl.cloud.tencent.com/zh/document/product/647/39080#open_bypass)。开启旁路推流功能后，TRTC 房间里的每一路画面都配备一路对应的播放地址。
2. 在 [腾讯云直播控制台](https://console.cloud.tencent.com/live/) 配置播放域名并完成 CNAME 配置，详细操作请参见 [实现 CDN 直播观看](https://intl.cloud.tencent.com/document/product/647/35242) 文档。
>:::
::: 基于IM
...
同时，提供详细的接入方案和 [在线 Demo](https://trtc.qcloud.com/tweblive/index.html#/) 供您体验。目前 TWebLive 在主流的桌面浏览器上也有较好的支持。
