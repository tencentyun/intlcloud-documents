...
>! 
>- ブラウザで、[WebRTC 能力テスト](https://trtc-1252463788.file.myqcloud.com/web/demo/official-demo/index.html) の画面を開き、WebRTCが完全にサポートされているかチェックすることができます（例：公式アカウント等のブラウザ環境）。
