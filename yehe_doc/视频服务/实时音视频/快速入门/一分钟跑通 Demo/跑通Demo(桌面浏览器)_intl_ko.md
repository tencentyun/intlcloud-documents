...
>! 
>- 브라우저에서 [WebRTC 능력 테스트](https://trtc-1252463788.cos.ap-guangzhou.myqcloud.com/web/demo/env-detect/index.html) 페이지를 열어 WebRTC를 완벽하게 지원하는지 테스트할 수 있습니다(예: 공식 계정 등 브라우저 환경).
