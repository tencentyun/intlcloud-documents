...
- [Tencent Cloudアカウントの登録](https://intl.cloud.tencent.com/document/product/378/17985)および [実名認証](https://intl.cloud.tencent.com/document/product/378/3629)を完了していること。実名認証を行っていないユーザーは、中国国内のTRTCのインスタンスを購入できません。
...
2.[【アプリケーション管理】](https://console.cloud.tencent.com/trtc/app)に進み、【アプリケーションの作成】をクリックして、 `testtrtc`など、アプリケーション名を入力し、【OK】をクリックします。
<span id="step2"></span>
### 手順2：SDKAppIDとキーの取得
...
2.【クイックマスター】タブをクリックし、【ステップ2 UserSigを発行するためのキーを取得】タブを表示し、【キーのコピー】をクリックします。
![](https://main.qcloudimg.com/raw/99f03c367c43416bd7c7e8c6d6ff5002.png)

>! キー情報を適切に保管して、漏えいしないようにしてください。
<span id="step3"></span>
### 手順3： Demoソースコードのダウンロードおよび設定
...
2.`TWebLive/dist/debug/GenerateTestUserSig.js`ファイルを開き、関連パラメータを設定します。
 -SDKAPPID：[手順2](#step2)で取得した実際のアプリケーション `SDKAppID`に設定してください。
...
|   Android   |       モバイル版 UC ブラウザ       |         -          |    サポートなし    |    サポートなし    |
