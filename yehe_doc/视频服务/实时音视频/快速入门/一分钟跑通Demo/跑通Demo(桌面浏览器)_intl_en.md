This document describes how to quickly run the TRTC SDK for Desktop Browser.
...
- The TRTC SDK for Desktop Browser uses the following ports for data transfer, which should be added to the whitelist of the firewall. After configuring these ports, please use the [official demo](https://trtc-1252463788.file.myqcloud.com/web/demo/official-demo/index.html) to check whether the ports work.
 - TCP port: 8687
...
1. Mouse over the corresponding card, click **[GitHub](https://github.com/tencentyun/TRTCSDK/tree/master/Web)** to enter GitHub (or click **[ZIP](http://liteavsdk-1252463788.cosgz.myqcloud.com/H5_latest.zip?_ga=1.195966252.185644906.1567570704)**), and download the relevant SDK and supporting demo source code.
