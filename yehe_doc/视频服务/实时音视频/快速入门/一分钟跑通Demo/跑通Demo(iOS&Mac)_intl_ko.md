...
1. 커서를 상응하는 카드로 이동한 후 SDK 및 관련 Demo 소스 코드를 다운로드합니다.
 - **iOS: **[Github](https://github.com/tencentyun/TRTCSDK/tree/master/iOS)를 클릭하여 Github(또는 [ZIP](http://liteavsdk-1252463788.cosgz.myqcloud.com/TXLiteAVSDK_TRTC_iOS_latest.zip?_ga=1.195966252.185644906.1567570704) 클릭)로 이동합니다.
  ![](https://main.qcloudimg.com/raw/716b5af9207ad2b11835dec4e2d15da0.png)
 - **Mac: **[Github](https://github.com/tencentyun/TRTCSDK/tree/master/Mac)를 클릭하여 Github(또는 [ZIP](http://liteavsdk-1252463788.cosgz.myqcloud.com/TXLiteAVSDK_TRTC_Mac_latest.tar.bz2?_ga=1.195966252.185644906.1567570704) 클릭)로 이동합니다.
...
2. `GenerateTestUserSig.h` 파일을 찾아 열어줍니다
 <table><tr>
...
### 4단계: 컴파일 실행
1. 터미널 창에서 소스 코드의 TRTCSimpleDemo > Podfile 파일이 있는 디렉터리로 들어갑니다.
2. `pod install` 명령어를 실행해 TRTC SDK를 설치하거나 `pod update` 명령어를 실행해 로컬 라이브러리 버전을 업데이트 합니다.
3. XCode(11.0 버전 이상)를 사용해 오픈 소스 디렉터리에 있는 TXLiteAVDemo.xcworkspace 프로그램을 열어 Demo 프로그램을 컴파일링 및 실행하면 됩니다.
...
### 2. 2대의 모바일에서 동시에 Demo를 실행할 경우 서로의 화면이 보이지 않는 이유는 무엇입니까?
