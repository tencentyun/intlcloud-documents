...
[](id:que11)
### 携帯電話がロックされている状態、Appがバックグラウンドにある場合、またはAppがオフの場合に、音声ビデオ通話を行うにはどうすればいいですか。
...
入室できます。[SDKAppID](https://console.cloud.tencent.com/trtc/app)とルーム番号が一致し、異なるユーザーIDを使用してください。
