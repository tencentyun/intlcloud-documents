...
[](id:que3)
### Can I enter a room created on Mini Program through a mobile client?
...
You can use [onRemoteUserLeaveRoom](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDelegate__ios.html#afa7d16e1e4c66d938fc2bc69f3e34c28) to listen for the room exit event. With this API, a callback is triggered only if all users leave the room under the `VideoCall` mode or an anchor leaves the room under the `Live` mode. 
