...
4. 录制任务完成后，云直播会将文件写入到云点播，并通过 [录制回调事件通知](https://intl.cloud.tencent.com/document/product/267/31566)。
...
<span id="que37"></span>
###  是否可以至少两个人进入房间，才开始录音？
可以。若您需获取录制混流后的音频数据，您可在 [启动云端混流](https://intl.cloud.tencent.com/document/product/647/34618#.E5.90.AF.E5.8A.A8.E6.B7.B7.E6.B5.81) 后，制定输出流 ID，并调用直播接口 [创建录制任务](https://intl.cloud.tencent.com/document/product/267/37309)。
