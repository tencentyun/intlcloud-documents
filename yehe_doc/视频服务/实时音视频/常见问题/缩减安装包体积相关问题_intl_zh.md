...
TRTC 各个版本 SDK 的体积增量不同，详情请参见 [SDK 下载](https://intl.cloud.tencent.com/document/product/647/34615)。
...
[](id:step1)
 ...
 2. 上传 [步骤1](#step1) 中下载到的 so 文件，上传到您的服务器（或腾讯云 [COS](https://intl.cloud.tencent.com/product/cos) 对象存储服务）上，并记录下载地址，例如 `http://xxx.com/so_files.zip`。
