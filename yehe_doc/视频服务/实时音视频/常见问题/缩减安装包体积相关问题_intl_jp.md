...
[](id:step1)
 ...
 1.  [Github](https://github.com/LiteAVSDK/TRTC_Android/tree/main/SDK) フォルダ下で、`LiteAVSDK_TRTC_x.x.xxx.zip` に似た名前がついた圧縮パッケージを見つけることができます。それを解凍して指定アーキテクチャのsoファイルを見つけます。
