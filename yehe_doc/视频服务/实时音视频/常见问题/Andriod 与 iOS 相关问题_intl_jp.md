...
- メディア音量は、携帯電話の音楽シーン向けに設計された音量タイプです。音質は通話音量タイプよりも優れています。音量ボタンを押して、音量をゼロに調節できます。メディア音量タイプを使用する場合、エコーキャンセル（AEC）機能を有効にすると、SDKは内蔵された音響処理アルゴリズムを起動して、音声の2次処理を行います。メディア音量モードでは、Bluetoothヘッドセットは内蔵マイクを使用して集音することはできず、携帯電話のマイクでしか集音できません。
...
- **Android端末**：Version 7.2以降のバージョンで携帯電話のスクリーンキャプチャをサポートしています。具体的な実践方法は[リアルタイム画面共有（Android）](https://intl.cloud.tencent.com/document/product/647/37337)をご参照ください。
- **iOS端末**：Version 7.2以降のバージョンでアプリ内のスクリーンキャプチャをサポートしています。Version 7.6以降のバージョンでは携帯電話のスクリーンキャプチャおよびアプリ内のスクリーンキャプチャをサポートしています。具体的な実践方法は[リアルタイム画面共有（iOS）](https://intl.cloud.tencent.com/document/product/647/37338)をご参照ください。
...
サポートしています。サードパーティライブラリの統合をサポートするフローにそのまま従ってSDKを統合すればOKです。また、[Demoクイックスタート(iOS&Mac)](https://intl.cloud.tencent.com/document/product/647/35086)も参照することができます。
...
[](id:que12)
### AndroidとWeb端末との相互運用性をサポートしていますか。
...
[](id:que14)
### 多人数ビデオミーティング中に、モバイル端末とWeb端末から同じルームに入室できますか。
