...
- 방의 개별 사용자가 90초 동안 연결이 끊어진 경우, 서버에서 사용자를 퇴장시킵니다. 방의 모든 사용자가 90초 동안 연결이 끊어지면 서버에서 현재 방을 자동 삭제합니다.
...
릴레이 라이브 방송을 활성화하고자 할 경우, 중국 당국의 규정에 따라 ICP비안이 있어야 재생 도메인을 사용할 수 있습니다. 자세한 내용은 [CDN 라이브 방송 시청](https://intl.cloud.tencent.com/document/product/647/35242)을 참고하십시오.
...
화면 공유 인터페이스에 대한 자세한 내용은 [Windows(C++) API](https://intl.cloud.tencent.com/document/product/647/35131) 또는 [Windows(C#) API](https://intl.cloud.tencent.com/document/product/647/35136)를 참고하십시오. 그 외 [Electron 인터페이스](https://intl.cloud.tencent.com/document/product/647/35141)를 사용할 수도 있습니다.
...
- 라이브 방송 모드에서는 한 방에 10만 명 이상이 관객 자격으로 접속하여 시청할 수 있으며, 최대 50명까지 호스트 자격으로 카메라 또는 마이크를 활성화할 수 있습니다.
...
지원합니다. 자세한 내용은 [CDN 라이브 방송 시청](https://intl.cloud.tencent.com/document/product/647/35242)을 참고하십시오.
...
[](id:que67)
### TRTC란 무엇인가요?
TRTC는 Tencent Cloud 서비스를 통해 Tencent가 다년간 네트워크와 멀티미디어 기술 분야에서 쌓아온 성과를 바탕으로 한 그룹 멀티미디어 통화 및 저딜레이 ILVB 시나리오를 공개하고, 개발자들이 저비용, 저딜레이, 고품질을 특징으로 한 멀티미디어 인터랙션 솔루션을 빠르게 구축할 수 있도록 돕습니다. 자세한 설명은 [제품 개요](https://intl.cloud.tencent.com/document/product/647/35078)를 참고하십시오.
