...
- autoGainControl: 자동 게인 제어. 자세한 내용은 [미디어 추적 제한](https://developer.mozilla.org/en-US/docs/Web/API/MediaTrackConstraints)을 참고하십시오.
...
자세한 내용은 [Stream.getVideoFrame()](https://web.sdk.qcloud.com/trtc/webrtc/doc/en/Stream.html#getVideoFrame) 인터페이스를 참고하십시오.
...
[](id:013)
### iframe에서 TRTC Web SDK를 사용할 때 Permission denied 오류가 보고됩니다.

iframe에서 WebRTC를 사용하려면 iframe 태그에 속성을 추가하여 관련 권한을 활성화해야 하며, 구체적인 참고는 다음과 같습니다.
마이크, 카메라, 화면 공유 권한:
```javascript
