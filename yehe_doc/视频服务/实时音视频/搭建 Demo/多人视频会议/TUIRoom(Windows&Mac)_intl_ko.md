...
| [OnCallingRollStarted](#oncallingrollstarted)                | 호스트는 지명을 시작하고 참석자는 콜백을 받습니다.   |
...
| 매개변수   | 유형 | 의미                                               |
| ------ | ---- | -------------------------------------------------- |
| reason | int  | 중지 사유. 0: 사용자가 중지, 1: 다른 애플리케이션에 의해 점유되어 중지됨. |
