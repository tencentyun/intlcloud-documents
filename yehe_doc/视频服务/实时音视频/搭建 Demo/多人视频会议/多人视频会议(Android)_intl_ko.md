...
빠른 그룹 화상 회의 기능이 필요한 경우, Tencent Cloud에서 제공하는 App을 기반으로 설정을 적절히 수정하거나, TRTCMeeting 컴포넌트를 사용해 사용자 정의 UI 인터페이스를 구현할 수 있습니다.
...
[](id:model.step1)
### 1단계: SDK 통합
그룹 화상 회의 컴포넌트 TRTCMeeting은 TRTC SDK와 IM SDK에 종속되어 있습니다. 다음 단계에 따라 해당 두 SDK를 프로젝트에 통합할 수 있습니다.
