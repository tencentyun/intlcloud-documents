...
|userID|string|必填参数，用户 ID，可以由您的帐号体系指定。建议结合业务实际账号体系自行设置。|
|userSig|string|必填参数，身份签名（相当于登录密码），由 userID 计算得出，具体计算方法请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。|
...
## 技术咨询
了解更多详情您可以[联系我们](https://intl.cloud.tencent.com/contact-us)或发送邮件至colleenyu@tencent.com。

## 参考文档

- [SDK API 手册](https://web.sdk.qcloud.com/trtc/electron/doc/zh-cn/trtc_electron_sdk/index.html)
- [SDK 更新日志](https://intl.cloud.tencent.com/document/product/647/38702)
...
- [Electron 常见问题](https://intl.cloud.tencent.com/document/product/647/43093)
