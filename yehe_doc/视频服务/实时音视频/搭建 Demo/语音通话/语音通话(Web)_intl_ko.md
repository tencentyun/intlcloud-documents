...
- Part 2: TRTCCalling 컴포넌트를 사용한 음성 통화 기능의 빠른 구축 방법 소개.
...
[](id:step2)
### 2단계: Demo 다운로드
1. 실제 비즈니스 니즈에 따라 Demo 소스 코드를 다운로드하거나 또는 [TUICalling](https://github.com/tencentyun/TUICalling)에서 Demo 소스 코드를 다운로드합니다.
...
trtcCalling.call({
  userID,  //사용자 ID
  type: 1, //통화 유형, 0-알 수 없음, 1-음성 통화, 2-영상 통화
