...
Currently, the desktop version of Chrome offers better support for the features of the TRTC SDK for web; therefore, Chrome is recommended for the demo. for more information, see [Environment Requirements](https://intl.cloud.tencent.com/document/product/647/38928#.E7.8E.AF.E5.A2.83.E8.A6.81.E6.B1.82).
...
| extension            | String | Passthrough content of an offline notification (optional), **which is only for TRTCCalling v1.0.2 or above and TSignaling v0.9.0 or above** |
