...
- TRTCCallingは以下のポートに依存してデータ送信を行っていますので、これらをファイアウォール・ホワイトリストに追加してください。設定が完了したら、[公式サイト Demo](https://web.sdk.qcloud.com/component/trtccalling/demo/web/latest/index.html)にアクセスして体験していただけば、設定が有効かどうかをチェックすることができます。
  - TCPポート：8687
...
3. useridを入力し、**ログイン**をクリックして、**音声通話**を選択します。
