...
- IM 애플리케이션은 텍스트 메시지에 대해 기본 버전의 콘텐츠 필터링 기능을 제공합니다. 사용자 정의 유해 단어 필터링 기능을 사용하려면 **업그레이드**를 클릭하십시오.
...
1. 클라우드 녹화를 활성화하려면 [클라우드 녹화 및 재생 구현](https://intl.cloud.tencent.com/document/product/647/35426)을 참고하십시오.
...
| ------- | ------- | ------- | ------- | ------- | ------- |
| Mac OS | 데스크톱 Safari 브라우저 | 11+ | 지원 | 지원 | 지원(Safari13+ 버전 필요)  |
| Mac OS  | 데스크톱 Chrome 브라우저 |  56+ | 지원 | 지원| 지원(Chrome72+ 버전 필요) |
| Mac OS   | 데스크톱 Firefox 브라우저 | 56+ | 지원 | 지원 | 지원(Firefox66+ 버전 필요) |
| Mac OS   | 데스크톱 Edge 브라우저 | 80+ | 지원 | 지원 | 지원 |
| Mac OS   | 데스크톱 WeChat 내장 웹 페이지 | - | 지원      | 미지원    | 미지원 |
| Mac OS   | 데스크톱 WeChat Work 내장 웹 페이지 | - | 지원 | 미지원    | 미지원 |
| Windows  | 데스크톱 Chrome 브라우저 | 56+ | 지원 | 지원| 지원(Chrome72+ 버전 필요) |
| Windows  | 데스크톱 QQ 브라우저(고속 커널) | 10.4+ | 지원 | 지원 | 미지원 |
| Windows  | 데스크톱 Firefox 브라우저 | 56+ | 지원 | 지원 | 지원(Firefox66+ 버전 필요) |
| Windows  | 데스크톱 Edge 브라우저 | 80+ | 지원 | 지원 | 지원 |
| Windows  | 데스크톱 WeChat 내장 웹 페이지 | - | 지원 | 미지원 | 미지원 |
| Windows  | 데스크톱 WeChat Work 내장 웹 페이지 | - | 지원 | 미지원 | 미지원 |
