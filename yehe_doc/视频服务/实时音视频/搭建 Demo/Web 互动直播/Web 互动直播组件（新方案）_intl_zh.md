...
- 即时通信 IM 应用针对文本消息，提供基础版本的 安全打击 能力，如果希望使用自定义不雅词功能，可以单击 **升级** 或在 [购买页](https://buy.cloud.tencent.com/avc?position=1400399435) 购买 **安全打击-高级版** 服务。
...
### Web 端如何实现云端录制?
1. 开启 云端录制，请参见 [实现云端录制与回放](https://intl.cloud.tencent.com/document/product/647/35426)。
