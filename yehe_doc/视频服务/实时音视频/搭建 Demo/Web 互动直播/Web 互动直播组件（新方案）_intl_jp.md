...
- Instant Messaging（IM）アプリケーションは、テキストメッセージを対象に、ベーシック版のセキュリティ対策機能を提供しています。カスタマイズした不適切な単語機能を使用したい場合は、**アップグレード**をクリックしてください。
...
1. クラウドレコーディングを有効にするには、[クラウドレコーディングと再生の実現](https://intl.cloud.tencent.com/document/product/647/35426)をご参照ください 。
