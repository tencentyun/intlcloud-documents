...
TUIRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人音视频房间(iOS)](https://intl.cloud.tencent.com/document/product/647/37284)。
- TRTC SDK：使用 [TRTC SDK](https://intl.cloud.tencent.com/document/product/647) 作为低延时音视频房间组件。
- IM SDK：使用 [IM SDK](https://intl.cloud.tencent.com/document/product/1047) 实现聊天室的功能（**IM SDK 使用 iOS 版本**）。
...
| API | 描述 |
|-----|-----|
| [getBeautyManager](#getbeautymanager) | 获取美颜管理对象 [TXBeautyManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXBeautyManager__ios.html)。|
...
获取 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37284) 单例对象。
```objectivec
...
[TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37284) 事件回调，您可以通过 TUIRoomCoreDelegate 获得 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37284) 的各种状态通知。
...
>? 详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__ios.html#a92330045ce479f3b5e5c6b366731c7ff)
...
获取美颜管理对象 [TXBeautyManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXBeautyManager__ios.html)。
```objectivec
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| quality | TRTCAudioQuality | 音频质量，详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__ios.html#a2cdffa1529fcaec866404f4f9b92ec53) |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| resolution | TRTCVideoResolution | 视频分辨率，详细请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__ios.html#gaa58db9156c82d75257499cb5e0cdf0e5)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| bitrate | int | 码率，SDK 会按照目标码率进行编码，只有在网络不佳的情况下才会主动降低视频码率。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__ios.html#a21a93f89a608f4642ecc9d81ef25a454)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| params | TRTCAudioRecordingParams | 录音参数，详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__ios.html#a21a93f89a608f4642ecc9d81ef25a454#classcom_1_1tencent_1_1trtc_1_1TRTCCloudDef_1_1TRTCAudioRecordingParams) |
...
>? 详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDelegate__ios.html#a723002319845fbfc03db501aa9da6c28)。
