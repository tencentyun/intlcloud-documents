...
TRTCMeeting 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人音视频房间（Flutter）](https://intl.cloud.tencent.com/document/product/647/41945)。
...
获取 [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/41945) 单例对象。
```dart
...
销毁 [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/41945) 单例对象。
```dart
...
设置事件监听，您可以通过 TRTCMeetingDelegate 获得 [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/41945) 的各种状态通知。
```dart
...
| userSig | String | 腾讯云设计的一种安全保护签名，获取方式请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。|
...
|-----|-----|-----|
| userId | String | 指定成员的 ID。|
| streamType | int | 要观看的视频流类型。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#a9a2aaa1d287b6a2169088c5ecbd25f19)。 |
...
| userId | String | 指定成员的 ID。|
| streamType | int | 要观看的视频流类型。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#a9a2aaa1d287b6a2169088c5ecbd25f19)。|
| fillMode | int | 图像渲染模式，填充（默认值）或适应模式。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#ae697c0f66077568d33d0996064776b50)。|
| rotation | int | 图像顺时针旋转角度。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#ab3d380890a5e0b7b6a29bc5d0e58f8e8)。|
| mirrorType | int | 镜像模式。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#ae5d847e0006bf2cd689b1116721109ca)。|
...
>? 详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#classcom_1_1tencent_1_1trtc_1_1TRTCCloudDef_1_1TRTCVideoEncParam)。
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| quality | int | 音频质量。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#a4451651bf7fc810efc4400964c3c0408)。|
