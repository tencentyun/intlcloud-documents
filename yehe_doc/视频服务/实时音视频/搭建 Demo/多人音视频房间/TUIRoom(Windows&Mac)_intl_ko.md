...
| [OnRemoteUserScreenAvailable](#onremoteuserscreenavailable) | 원격 사용자 화면 공유 활성화 여부 콜백.   |
| [OnRemoteUserAudioAvailable](#onremoteuseraudioavailable)    | 원격 사용자의 마이크 활성화 여부 콜백.   |
...
[TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 싱글톤 객체 가져오기.
```C++
...
[TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 이벤트 콜백. TUIRoomCoreCallback을 통해 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 에서 다양한 상태 알림을 받을 수 있습니다.
