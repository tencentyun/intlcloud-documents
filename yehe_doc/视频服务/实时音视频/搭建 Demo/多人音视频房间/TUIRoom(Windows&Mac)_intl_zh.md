...
TUIRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人音视频房间(Windows&Mac)](https://intl.cloud.tencent.com/document/product/647/44071)。
- TRTC SDK：使用 [TRTC SDK](https://intl.cloud.tencent.com/document/product/647) 作为低延时视频会议组件。
- IM SDK：使用 [IM SDK](https://intl.cloud.tencent.com/document/product/1047) 实现聊天室的功能（**IM SDK 使用 C++ 版本**）。
...
获取 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 单例对象。
```C++
...
[TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 事件回调，您可以通过 TUIRoomCoreCallback 获得 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/44071) 的各种状态通知。
...
| user_sig | string | 腾讯云设计的一种安全保护签名，获取方式请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。 |
