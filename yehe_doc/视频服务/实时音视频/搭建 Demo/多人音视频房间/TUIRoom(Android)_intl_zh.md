...
2. TUIRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人音视频房间(Android)](https://intl.cloud.tencent.com/document/product/647/37283)。

- TRTC SDK：使用 [TRTC SDK](https://intl.cloud.tencent.com/document/product/647) 作为低延时音视频房间组件。
- IM SDK：使用 [IM SDK](https://intl.cloud.tencent.com/document/product/1047) 实现聊天室的功能（**IM SDK 使用 Android 版本**）。
...
| API | 描述 |
|-----|-----|
| [getBeautyManager](#getbeautymanager) | 获取美颜管理对象 [TXBeautyManager。](https://liteav.sdk.qcloud.com/doc/api/en/group__TXBeautyManager__android.html#classcom_1_1tencent_1_1liteav_1_1beauty_1_1TXBeautyManager) |
...
获取 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37283) 单例对象。
```java
...
[TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37283) 事件回调，您可以通过 TUIRoomCoreListener 获得 [TUIRoomCore](https://intl.cloud.tencent.com/document/product/647/37283) 的各种状态通知。
...
>? 详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__android.html#aa6671fc587513dad7df580556e43be58)。
...
获取美颜管理对象 [TXBeautyManager](https://liteav.sdk.qcloud.com/doc/api/en/group__TXBeautyManager__android.html#classcom_1_1tencent_1_1liteav_1_1beauty_1_1TXBeautyManager)。
```java
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| quality | int | 音频质量，详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloud__android.html#a955cccaddccb0c993351c656067bee55)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| resolution | int | 视频分辨率，详细请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#aa3b72c532f3ffdf64c6aacab26be5f87)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| bitrate | int | 码率，SDK 会按照目标码率进行编码，只有在网络不佳的情况下才会主动降低视频码率。详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html)。 |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| trtcAudioRecordingParams | TRTCCloudDef.TRTCAudioRecordingParams | 录音参数，详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudDef__android.html#classcom_1_1tencent_1_1trtc_1_1TRTCCloudDef_1_1TRTCAudioRecordingParams)。 |
...
>? 详情请参见 [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/en/group__TRTCCloudListener__android.html#aba07d4191391dadef900422521f34e5b)
