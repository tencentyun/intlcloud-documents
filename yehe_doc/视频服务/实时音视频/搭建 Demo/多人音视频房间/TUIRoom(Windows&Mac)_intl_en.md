...
| [LeaveRoom](#leaveroom)                   | Exits a room (called by participant or anchor). |
...
| [OnRemoteUserAudioAvailable](#onremoteuseraudioavailable)    | Whether a remote user enabled mic.   |
