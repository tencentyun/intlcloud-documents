...
`TRTCVoiceRoom` is an open-source class depending on two closed-source Tencent Cloud SDKs. For the specific implementation process, see [Audio Chat Room (Android)](https://intl.cloud.tencent.com/document/product/647/37286).
