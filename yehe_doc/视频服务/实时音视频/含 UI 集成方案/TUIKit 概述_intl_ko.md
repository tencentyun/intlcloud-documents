...
│   ├── TUIChous       // Tencent Cloud의 저작권 보호 음원 라이브러리와 함께 사용 시 더 많은 기능을 지원하는 혁신적인 코러스용 오디오/비디오 컴포넌트;
│   ├── TUIKaroke      // Tencent Cloud의 저작권 보호 음원 라이브러리와 함께 사용 시 더 많은 기능을 지원하는 온라인 KTV 등 새로운 플레이를 위한 혁신적인 오디오/비디오 컴포넌트;
├── TUWidget
│   ├── TUIBeauty      // 뷰티 필터 위젯
