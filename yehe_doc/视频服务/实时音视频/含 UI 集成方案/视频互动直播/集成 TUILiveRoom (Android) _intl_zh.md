...
[](id:model.step4)
### 步骤四：实现视频互动直播间
1. **主播端开播 [TRTCLiveRoom#createRoom](https://intl.cloud.tencent.com/document/product/647/37333)**
<dx-codeblock>
::: java java
// 1.主播设置昵称和头像
...
2. **观众端观看 [TRTCLiveRoom#enterRoom](https://intl.cloud.tencent.com/document/product/647/37333)**
```java
...
3. **观众与主播连麦 [TRTCLiveRoom#requestJoinAnchor](https://intl.cloud.tencent.com/document/product/647/37333)**
<dx-codeblock>
::: java java
// 1.观众端发起连麦请求
...
4. **主播与主播 PK [TRTCLiveRoom#requestRoomPK](https://intl.cloud.tencent.com/document/product/647/37333)**
<dx-codeblock>
::: java java
// 主播 A:
// 主播 A 创建12345的房间
...
5. **实现文字聊天  [TRTCLiveRoom#sendRoomTextMsg](https://intl.cloud.tencent.com/document/product/647/37333)**
<dx-codeblock>
::: java java
// 发送端：发送文本消息
...
6. **实现弹幕消息 [TRTCLiveRoom#sendRoomCustomMsg](https://intl.cloud.tencent.com/document/product/647/37333)**
<dx-codeblock>
::: java java
