...
2. [시청자] 시청자가 라이브 룸 1개를 선택하고 `enterRoom()`을 호출하여 해당 방으로 입장합니다.
...
5. [호스트 A] `onRoomPKAccepted` 또는 `onRoomPKRejected` 콜백을 수신합니다.
...
배경 음악 음향 효과 관리 객체 [TXAudioEffectManager](https://pub.dev/documentation/tencent_trtc_cloud/latest/tx_audio_effect_manager/TXAudioEffectManager-class.html)를 가져옵니다.
