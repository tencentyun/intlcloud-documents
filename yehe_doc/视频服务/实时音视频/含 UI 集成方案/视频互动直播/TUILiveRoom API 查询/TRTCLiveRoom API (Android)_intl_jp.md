...
[TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/36061) イベントコールバック。 TRTCLiveRoomDelegate を介して[TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/36061)の各種ステータス通知を受け取ることができます。
```java
