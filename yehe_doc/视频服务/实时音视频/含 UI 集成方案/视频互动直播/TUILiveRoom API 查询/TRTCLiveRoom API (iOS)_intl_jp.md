...
| API                                             | 説明                                                         |
| ----------------------------------------------- | ------------------------------------------------------------ |
| [getAudioEffectManager](#getaudioeffectmanager) | BGMサウンドエフェクト管理オブジェクト[TXAudioEffectManager](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TXAudioEffectManager__ios.html#interfaceTXAudioEffectManager)を取得します。 |
...
| API  | 説明|
| ----------------------------------- | ---------------------- |
| [onRequestRoomPK](#onrequestroompk)  | ルーム間PKのリクエストの通知を受信します。 |
...
/// -userSig: Tencent Cloudによって設計されたセキュリティ保護署名です。取得方法については、 [UserSigの計算と使用方法](https://intl.cloud.tencent.com/document/product/647/35166)をご参照ください。
