...
TUILiveRoom 是一个开源的音视频 UI 组件，通过在项目中集成 TUILiveRoom 组件，您只需要编写几行代码就可以为您的 App 添加“视频互动直播”等场景。TUILiveRoom 同时支持 [Android](https://intl.cloud.tencent.com/document/product/647/36061)、[Flutter](https://intl.cloud.tencent.com/document/product/647/41944)等平台，基本功能如下图所示：
...
### 步骤四：实现视频互动直播间
1. **主播端开播 [TRTCLiveRoom#createRoom](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
// 1.主播设置昵称和头像
...
```
2. **观众端观看 [TRTCLiveRoom#enterRoom](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
...
```
3. **观众与主播连麦 [TRTCLiveRoom#requestJoinAnchor](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
// 观众端：
  // 1.观众端发起连麦请求
...
```
4. **主播与主播 PK [TRTCLiveRoom#requestRoomPK](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
// 主播 A:
// 主播 A 创建12345的房间
...
```
5. **实现文字聊天  [TRTCLiveRoom#sendRoomTextMsg](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
// 发送端：发送文本消息
...
```
6. **实现弹幕消息 [TRTCLiveRoom#sendRoomCustomMsg](https://intl.cloud.tencent.com/document/product/647/37332)**
```Swift
