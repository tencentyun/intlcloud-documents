...
- 如果您想把我们的功能直接嵌入到您的项目中，请阅读 [快速接入 TUICallKit](https://www.tencentcloud.com/document/product/647/50993)。
- 如果您想要修改 UI 界面，请阅读 [TUICallKit 界面定制指引](https://www.tencentcloud.com/document/product/647/50997)。
...
| --- | --- | --- | --- |
| 切换通话类型 | trtcCalling.switchToAudioCall() | tuiCallEngine.[switchCallMediaType()](https://www.tencentcloud.com/document/product/647/51016#switchcallmediatype) | 名称变更，通过参数选择切换类型 |
| 获取麦克风设备列表 | trtcCalling.getMicrophones() | [tuiCallEngine.getDeviceList()](https://www.tencentcloud.com/document/product/647/51016#getdevicelist) | 接口合并，通过参数选择设备类型 |
| 获取摄像头设备列表 | trtcCalling.getCameras() | [tuiCallEngine.getDeviceList()](https://www.tencentcloud.com/document/product/647/51016#getdevicelist) | 接口合并，通过参数选择设备类型 |
| 关闭/打开麦克风 | trtcCalling.setMicMute() | [tuiCallEngine.closeMicrophone()](https://www.tencentcloud.com/document/product/647/51016#closemicrophone) | 接口拆分|
| 关闭/打开麦克风 | trtcCalling.setMicMute() |  [tuiCallEngine.openMicrophone()](https://www.tencentcloud.com/document/product/647/51016#openmicrophone)  |  接口拆分|
| 设置用户昵称和头像 | 无 | [tuiCallEngine.setSelfInfo()](https://www.tencentcloud.com/document/product/647/51016#setselfinfo) | 设置用户昵称和头像 |
| 开启/关闭 AI 降噪 | 无 | [tuiCallEngine.enableAIVoice()](https://www.tencentcloud.com/document/product/647/51016#c9ace016-0cfa-441e-a7c7-7fd1c8c55a51) | 4.12.1 版本以后支持，具体使用详情请参阅使用 AI 降噪 |


### 6. 补充说明

- 由于 TUICallKit 需要搭配 IM 音视频通话能力套餐，您还可能遇到"The package you purchased does not support this ability."，可以单击 IM 控制台，进入对应 SDKAppID 应用的 基本配置 页面，并在页面的右下角找到 开通腾讯实时音视频服务 功能区，单击 免费体验 即可开通 TUICallKit 的 60天免费试用服务。如果需要正式应用上线，可以单击 前往加购 即可进入购买页面。
