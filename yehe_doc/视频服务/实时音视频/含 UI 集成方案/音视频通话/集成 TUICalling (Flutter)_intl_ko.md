빠른 영상 통화 기능이 필요한 경우, Tencent Cloud가 제공하는 Demo를 기반으로 설정을 적합하게 수정하거나 TRTCCalling 컴포넌트를 사용해 사용자 정의 UI 인터페이스를 구현할 수 있습니다.

>?TUICalling 컴포넌트는 Tencent Cloud의 두 가지 기본 PaaS 서비스, 즉 [Tencent Real-Time Communication](https://intl.cloud.tencent.com/document/product/647/35078) 및 [Instant Messaging](https://intl.cloud.tencent.com/document/product/1047/35448)을 사용합니다. TRTC를 활성화하면 IM과 IM SDK 평가판(100 DAU만 지원)이 자동으로 활성화됩니다. IM의 과금 내역은 [요금 안내](https://intl.cloud.tencent.com/document/product/1047/34350)를 참고하십시오.

## Demo UI 인터페이스 사용

### 1단계: 애플리케이션 생성

1. TRTC 콘솔에서 **개발 지원** > **[Demo 빠른 실행](https://console.cloud.tencent.com/trtc/quickstart)**을 클릭합니다.
2. 'TestVideoCall'과 같은 애플리케이션 이름을 입력하고 **생성**을 클릭합니다.
...
[](id:model.step1)
### 1단계: SDK 통합
멀티미디어 통화 컴포넌트 TRTCCalling는 [TRTC SDK](https://pub.dev/packages/tencent_trtc_cloud)와 [IM SDK](https://pub.dev/packages/tencent_im_sdk_plugin)에 종속되며, `pubspec.yaml` 설정을 통해 자동으로 다운로드 및 업데이트할 수 있습니다.
...
<td>userSig</td>
<td>Tencent Cloud가 설계한 일종의 보안 서명입니다. 계산 방법은 <a href="https://intl.cloud.tencent.com/document/product/647/35166">UserSig 계산 및 사용 방법</a>을 참고하십시오.</td>
</tr></table>
<dx-codeblock>
:::  java 
// 초기화
