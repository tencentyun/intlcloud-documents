...
TUICallKit API 是音视频通话组件的**含 UI 接口**，使用 TUICallKit API，您可以通过简单接口快速实现一个类微信的音视频通话场景，更详细的接入步骤，详见：[快速接入TUICallKit](https://www.tencentcloud.com/document/product/647/50993)
...
| userSig | String | 是 | 腾讯云设计的一种安全保护签名，获取方式请参考 如何计算 [UserSig](https://intl.cloud.tencent.com/document/product/647/35166) |
