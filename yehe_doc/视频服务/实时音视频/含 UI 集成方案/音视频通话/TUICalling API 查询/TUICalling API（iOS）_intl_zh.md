TUICalling 是基于腾讯云实时音视频（TRTC）和即时通信 IM 服务组合而成的，支持1v1和多人视频通话。TUICalling 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [实时视频通话（iOS）](https://intl.cloud.tencent.com/document/product/647/36065)。
...
| API                                                          | 描述                      |
| :----------------------------------------------------------- | :------------------------ |
| [sharedInstance](https://intl.cloud.tencent.com/document/product/647/43139) | 组件单例。                |
| [call](https://intl.cloud.tencent.com/document/product/647/43139) | C2C 邀请通话。            |
| [setCallingListener](https://intl.cloud.tencent.com/document/product/647/43139) | 设置监听器。              |
| [setCallingBell](https://intl.cloud.tencent.com/document/product/647/43139) | 设置铃声（建议在30s以内） |
| [enableMuteMode](https://intl.cloud.tencent.com/document/product/647/43139) | 开启静音模式              |
| [enableCustomViewRoute](https://intl.cloud.tencent.com/document/product/647/43139) | 开启自定义视图            |
...
| API                                                          | 描述                             |
| :----------------------------------------------------------- | :------------------------------- |
| [shouldShowOnCallView](https://intl.cloud.tencent.com/document/product/647/43139) | 被叫时请求拉起接听页面           |
| [onCallStart](https://intl.cloud.tencent.com/document/product/647/43139) | 呼叫开始回调。主叫、被叫均会触发 |
| [onCallEnd](https://intl.cloud.tencent.com/document/product/647/43139) | 通话回调。主叫、被叫均会触发     |
| [onCallEvent](https://intl.cloud.tencent.com/document/product/647/43139) | 通话事件回调                     |
