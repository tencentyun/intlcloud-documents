...
TRTCKaraokeRoom은 오픈 소스 Class로, Tencent Cloud의 두 가지 클로즈드 소스 SDK에 종속됩니다. 자세한 구현 방법은 [Karaoke(iOS)](https://cloud.tencent.com/document/product/647/59402)를 참고하십시오.
