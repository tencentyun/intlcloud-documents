...
### 步骤三：初始化并登录 
相关接口详情请参见 [TUIKaraoke](https://intl.cloud.tencent.com/document/product/647/41943)。
...
```
2. **听众进入房间 [TUIKaraoke.enterRoom](https://intl.cloud.tencent.com/document/product/647/41943)**
```java
...
```
3. **听众主动上麦 [TUIKaraoke.enterSeat](https://intl.cloud.tencent.com/document/product/647/41943)**
```java
// 1.听众调用上麦
int seatIndex = 1;
...
>? 其他关于麦位管理的相关操作，您可参考 [TUIKaraoke接口文档](https://intl.cloud.tencent.com/document/product/647/41943) 按需实现，或者可以参考我们的 [TUIKaraoke示例工程](https://github.com/tencentyun/TUIKaraoke/)。

4. **实现音乐播放并体验 KTV 场景**
您可以根据自己的业务获取音乐 ID 和 URL链接播放歌曲，接口详情请参见 [TUIKaraoke 音乐播放接口](https://intl.cloud.tencent.com/document/product/647/41943#.E9.9F.B3.E4.B9.90.E6.92.AD.E6.94.BE.E6.8E.A5.E5.8F.A32)。
```java
//播放音乐
...
相关接口详情请参见 [TRTCKaraokeRoom.sendRoomTextMsg](https://intl.cloud.tencent.com/document/product/647/41943#sendroomtextmsg)。
```java
// 发送端：发送文本消息
