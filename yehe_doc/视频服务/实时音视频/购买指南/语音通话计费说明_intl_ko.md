...
TRTC에서는 [방](https://intl.cloud.tencent.com/document/product/647/37714) 안의 사용자로 인해 발생한 모든 **음성 시간**을 음성 통화 서비스 사용량으로 통계합니다.
...
## 과금 예시
>!본 문서의 과금 예시는 정가 기준이며, [범용 패키지 구매](https://buy.cloud.tencent.com/trtc)를 통해 비용을 절약할 수 있습니다.
