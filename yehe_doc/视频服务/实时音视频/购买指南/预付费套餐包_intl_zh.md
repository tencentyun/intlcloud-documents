...
您可以通过购买预付费套餐包（加链接）来获得更优惠的分钟数。

TRTC 为您提供音视频通用套餐包，可按照**1:2:4:15**分别抵扣语音、标清 SD、高清 HD 和全高清FHD 时长，例如1分钟高清 HD 视频时长扣除4分钟通用套餐包时长。
...
>- 目前使用TRTC预付费服务需要进行白名单审核，请[联系我们](https://intl.cloud.tencent.com/contact-us)进行开通。
>- 如果您的月均分钟数超过3M分钟，并希望获得进一步的支持与报价服务，请[联系销售](https://intl.cloud.tencent.com/contact-us)。
