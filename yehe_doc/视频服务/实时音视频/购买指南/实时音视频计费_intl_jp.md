...
TRTCはオーディオビデオ一般パ[ッケージ](https://intl.cloud.tencent.com/document/product/647/42736）を提供します。**1:2:4:15**の割合で、それぞれ音声、SD、HD、FHDの時間を差し引きます。例えば、HDビデオ時間1分間の場合、一般パッケージから4分間が差し引かれます。
...
>-   TRTC前払いサービスをご利用の場合、当面はホワイトリストの審査を受けていただく必要があります。アクティブ化するには、当社[までお問い合わせください](https://intl.cloud.tencent.com/contact-us)。
>-   お客様の月間平均分数が300万分を超え、さらにサポートや見積もりサービスをご希望の場合は、[営業担当者](https://intl.cloud.tencent.com/contact-us)までお問い合わせください。
...
お客様のシナリオが、ビデオ通話やインタラクティブライブストリーミングのほか、他のTRTC製品やサービス（[Cloud MixTranscodingなど](https://intl.cloud.tencent.com/document/product/647/38929)）に関連する場合、追加料金が必要になります。 詳細については、各TRTC製品またはサービスの料金説明をご参照ください。
