...
TRTCはオーディオビデオ一般パッケージ（リンクを追加）を提供します。**1:2:4:15**の割合で、それぞれ音声、SD、HD、FHDの時間を差し引きます。例えば、HDビデオ時間1分間の場合、一般パッケージから4分間が差し引かれます。
...
>-   TRTC前払いサービスをご利用の場合、当面はホワイトリストの審査を受けていただく必要があります。アクティブ化するには、当社[ここにリンクを追加]までお問い合わせください。
>-   お客様の月間平均分数が300万分を超え、さらにサポートや見積もりサービスをご希望の場合は、営業担当者[ここにリンクを追加]までお問い合わせください。
