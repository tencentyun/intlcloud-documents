...
TRTC 为您提供音视频通用套餐包（加链接），可按照**1:2:4:15**分别抵扣语音、标清 SD、高清 HD 和全高清 FHD 时长，例如 1 分钟高清 HD 视频时长扣除 4 分钟通用套餐包时长。
...
>-   目前使用 TRTC 预付费服务需要进行白名单审核，请联系我们[这里要加链接]进行开通。
>-   如果您的月均分钟数超过 3M 分钟，并希望获得进一步的支持与报价服务，请联系销售[这里要加链接]。
...
在你的场景中，如果除视频通话、互动直播外还涉及其他 TRTC 产品或服务，如云端混流转码等，则需要额外收费。详见各 TRTC 产品或服务的计费说明。
