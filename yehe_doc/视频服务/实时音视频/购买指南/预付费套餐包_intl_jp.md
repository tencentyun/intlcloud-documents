...
>- 現在、TRTC前払いサービスをご利用する場合、ホワイトリストの審査を受けていただく必要があります。アクティブ化するには、当社[ここにリンクを追加](https://intl.cloud.tencent.com/contact-us)までお問い合わせください。
>- お客様の月間平均分数が300万分を超え、さらにサポートや見積もりサービスをご希望の場合は、営業担当者[リンクを追加](https://intl.cloud.tencent.com/contact-us)までお問い合わせください。
