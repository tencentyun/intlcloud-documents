...
The relayed live streaming feature is disabled by default. For feature overview and instructions, please see [CDN-based Relayed Live Streaming](https://intl.cloud.tencent.com/document/product/647/34617).

| Value-added Item | Billed Product | Billing Details |
| :----------- | :--------- | :----------------------------------------------------------- |
| CDN-based relayed live streaming | LVB| It can be billed by **traffic** or **bandwidth**. You can choose an appropriate billing mode based on your actual needs. The bill-by-traffic mode is used by default. |

## On-cloud Recording Fees

The on-cloud recording feature is disabled by default. For feature overview and instructions, please see [On-cloud Recording](https://intl.cloud.tencent.com/document/product/647/35152).

| Value-added Item | Billed Product | Billing Details |
| :------------------------- | :--------- | :----------------------------------------------------------- |
| LVB recording | LVB | It is billed by the **peak number of concurrent LVB recording channels in the current month**.|
...
| Value-added Item | Billed Product | Billing Details |
| :------- | :------------------------------------------------------- | :---------------------------------------- |
| LVB screencapturing | [LVB](https://intl.cloud.tencent.com/document/product/267) | It is billed by the **number of screenshots**.|
| Intelligent porn information detection | [LVB](https://intl.cloud.tencent.com/document/product/267) | It is billed by the **number of images for porn information detection**. |