...
The price of interactive live audio streaming is listed below:
...
Your audio duration is deducted **1:1** from a general prepaid package, meaning that for 1 minute of audio duration used, 1 minute will be deducted from your package.
...
You can use the [TRTC Price Calculator](https://buy.intl.cloud.tencent.com/pricing/trtc) to estimate your usage of interactive live audio streaming and the cost.
