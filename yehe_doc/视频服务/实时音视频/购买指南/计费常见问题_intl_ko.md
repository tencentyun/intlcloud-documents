...
- 장기 할인: TRTC 월간 소비 금액이 3,000USD를 초과하는 경우 [문의하기](https://intl.cloud.tencent.com/contact-us)를 통해 계약 체결 후 장기적 할인을 받을 수 있습니다.
...
글로벌 포털은 서비스 사용 전에 얼로우리스트 심사를 진행해야 합니다. [티켓 제출](https://console.cloud.tencent.com/workorder/category)을 통해 도움을 요청할 수 있습니다.
