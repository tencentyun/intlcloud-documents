...
- 서버 API: 더 높은 수준의 요구 사항이 있는 경우 [서버 API](https://intl.cloud.tencent.com/document/product/647/42971)를 통해서도 과금 사용량 데이터를 조회할 수 있습니다. 조회 기간이 1일 이하인 경우, 5분 단위 데이터가 반환되며, 조회 기간이 1일을 초과하는 경우 일별 통계 데이터가 반환됩니다(초 단위 표시).
