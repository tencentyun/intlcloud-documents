...
- 服务端 API：如果您有更高阶的需求，还可以通过[服务端API](https://intl.cloud.tencent.com/document/product/647/42971)获取详细的计费用量数据。查询时间小于等于1天时，返回每5分钟粒度的数据；查询时间大于1天时，返回按天汇总的数据。单位精确到秒。
