...
>例えば、setVideoEncodrParam()を介して、キャスターのビットレート（videoBitrate）を1500kbpsに、解像度を720Pに設定します。キャスターがマイクを視聴者に1時間接続し、マイク接続期間中に [マルチ画面合成](#mixCDN)をオンにした場合、発生するトランスコード料金は、`0.0057米ドル/分 × 60分 = 0.342米ドル`となります。
