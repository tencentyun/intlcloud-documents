...
- 반대로, SimpleDemo를 실행하는 데 문제가 발생하면 Electron 다운로드 및 설치에 문제가 발생할 수 있습니다. 이 경우, Electron 공식 홈페이지의 [설치 가이드](https://www.electronjs.org/docs/tutorial/installation)를 참고하십시오.
...
2. [startLocalPreview()](https://web.sdk.qcloud.com/trtc/electron/doc/zh-cn/trtc_electron_sdk/TRTCCloud.html#startLocalPreview)를 호출하여 카메라 수집를 활성화하고 수집된 비디오를 인코딩 및 발송합니다.
