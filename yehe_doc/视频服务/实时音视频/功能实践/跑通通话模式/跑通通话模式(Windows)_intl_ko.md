## 문서 가이드
본 문서에서는 TRTC SDK를 기반으로 간단한 영상 통화 기능 구현을 소개합니다. 가장 많이 사용되는 몇 가지 인터페이스만 소개하고 있으며, 더 많은 인터페이스 함수에 대한 자세한 내용은 [API 문서](https://intl.cloud.tencent.com/document/product/647/35119)를 참조하십시오.
...
- **SDKAppID**
  Tencent Cloud TRTC [콘솔](https://console.cloud.tencent.com/rav)에 입장합니다. 아직 애플리케이션이 없는 경우 생성하면 SDKAppID를 확인할 수 있습니다.
