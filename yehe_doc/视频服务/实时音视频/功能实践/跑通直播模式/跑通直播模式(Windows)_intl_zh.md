## 文档导读
本文主要介绍如何基于 TRTC SDK 实现一个既支持视频连麦，又支持上万人高并发观看的在线直播功能。本文仅罗列最常用的几个接口，如果您希望了解更多的接口函数，请参见 [API 文档](https://intl.cloud.tencent.com/document/product/647/35119)。
...
- **userSig**
  基于 SDKAppID 和 userId 可以计算出 userSig，计算方法请参见 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。
