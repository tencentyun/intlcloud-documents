...
- **多路画面的混合**
  ...
  - [客户端 SDK API 混流方案](#recordSDKAPI)：可以直接在客户端发起混流，目前支持 iOS、Android、Windows、Mac、Web 等平台，暂不支持微信小程序。
...
>? 更多回调字段说明，请参见 [云直播-录制事件通知](https://intl.cloud.tencent.com/document/product/267/38082)。
