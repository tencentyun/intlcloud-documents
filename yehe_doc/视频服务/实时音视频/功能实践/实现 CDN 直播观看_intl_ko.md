...
>예를 들어, setVideoEncodrParam()을 통해 호스트의 비트레이트(videoBitrate)를 1500kbps, 해상도를 720P로 설정합니다. 호스트 1명과 시청자의 마이크 연결 시간이 1시간이고 해당 마이크 연결 시간 동안 [다중 채널 화면 믹싱](#mixCDN)을 활성화 하는 경우, ‘0.0057USD/분 × 60분 = 0.342USD’의 트랜스 코딩 비용이 발생합니다.
