...
| sourceId | HWND| Capturing source ID. <li>If the capturing source type is windows, this field indicates a window handle.</li><li>if it is screens, this field indicates a screen ID.</li> |
