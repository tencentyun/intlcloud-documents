...
- **솔루션1: 일반 플로팅 창 팝업**
“VooV Meeting”과 비슷한 미니 플로팅 창을 팝업해야 합니다. 예시 코드 [FloatingView.java](https://github.com/tencentyun/TRTCSDK/blob/master/Android/TRTCSimpleDemo/screen/src/main/java/com/tencent/liteav/screen/FloatingView.java)의 구현을 참조하십시오.
