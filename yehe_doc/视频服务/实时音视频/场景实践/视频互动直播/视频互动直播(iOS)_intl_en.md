...
>This feature uses two basic PaaS services, namely, [TRTC](https://intl.cloud.tencent.com/document/product/647/35078) and [IM](https://cloud.tencent.com/document/product/269). When TRTC is activated, IM will be activated automatically.
...
Copy all files in the `iOS/TRTCScenesDemo/TRTCScenesDemo/TRTCLiveRoomDemo/model` directory to your project.
