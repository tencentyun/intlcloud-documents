...
TRTCLiveRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [视频连麦直播（Flutter）](https://intl.cloud.tencent.com/document/product/647/41944)。
...
获取 [TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/41944) 单例对象。
...
销毁 [TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/41944) 单例对象。
...
[TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/41944) 事件回调，您可以通过 TRTCLiveRoomDelegate 获得 [TRTCLiveRoom](https://intl.cloud.tencent.com/document/product/647/41944) 的各种状态通知。
