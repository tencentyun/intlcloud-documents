...
>?해당 기능은 Tencent Cloud의 [TRTC](https://intl.cloud.tencent.com/document/product/647/35078)와 [IM](https://cloud.tencent.com/document/product/269) 두 가지 서비스 기반의 PAAS 서비스를 이용합니다. TRTC가 활성화되면 IM 서비스도 동시에 활성화됩니다. IM은 부가 서비스이며, 자세한 과금 규정은 [IM 요금 안내](https://intl.cloud.tencent.com/document/product/1047/34350)를 참고하십시오.
...
>?두 SDK 제품의 최신 버전 넘버는 [TRTC](https://github.com/tencentyun/TRTCSDK)와 [IM](https://github.com/tencentyun/TIMSDK)의 GitHub 메인 페이지에서 획득할 수 있습니다.
- **방법2: 로컬을 통한 종속**
