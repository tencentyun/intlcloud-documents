...
TRTCVoiceRoom은 오픈 소스 Class로, Tencent Cloud의 두 가지 클로즈드 소스 SDK에 종속됩니다. 자세한 구현 방법은 [음성 채팅방(iOS)](https://intl.cloud.tencent.com/document/product/647/37287)을 참조하십시오.
...
```Objective-C
/**
* TRTCVoiceRoom 단일 항목 객체 획득
*
* - returns: TRTCVoiceRoom 인스턴스
* - note: {@link TRTCVoiceRoom#destroySharedInstance()}를 호출하여 단일 항목 객체를 폐기할 수 있습니다.
*/
...
[TRTCVoiceRoom](https://intl.cloud.tencent.com/document/product/647/37287) 단일 항목 객체를 폐기합니다.

>?인스턴스 폐기 후에는 외부에 캐시된 TRTCVoiceRoom 인스턴스를 다시 사용할 수 없으며, 다시 [sharedInstance](#sharedInstance)를 호출해 새로운 인스턴스를 획득해야 합니다.

```Objective-C
/**
* TRTCVoiceRoom 단일 항목 객체 폐기
*
