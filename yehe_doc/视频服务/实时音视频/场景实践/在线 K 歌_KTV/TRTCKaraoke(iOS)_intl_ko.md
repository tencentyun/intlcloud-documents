...
- 방 주인은 노래 신청 관리 및 마이크가 켜진 호스트의 마이크 강제 끄기가 가능합니다.
...
TRTCKaraokeRoom은 오픈 소스 Class로, Tencent Cloud의 두 가지 클로즈드 소스 SDK에 종속됩니다. 자세한 구현 방법은 [Karaoke(iOS)](https://intl.cloud.tencent.com/document/product/647/41940)를 참고하십시오.
...
[TRTCKaraokeRoom](https://intl.cloud.tencent.com/document/product/647/41940) 싱글톤을 폐기합니다.
...
3. 방 입장 후 모듈의 `onRoomInfoChange` 방 속성 변경 이벤트 알림을 수신합니다. 이때 UI에 방 이름 표시, 마이크를 켤 때 방 주인에게 동의 요청 필요 여부 기록 등 방의 속성을 기록할 수 있으며 그에 해당하는 변경이 가능합니다.
