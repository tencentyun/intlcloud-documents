...
TRTCKaraokeRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [Karaoke（Android）](https://intl.cloud.tencent.com/document/product/647/41941)。
...
获取 [TRTCKaraokeRoom](https://intl.cloud.tencent.com/document/product/647/41941) 单例对象。
...
销毁 [TRTCKaraokeRoom](https://intl.cloud.tencent.com/document/product/647/41941) 单例对象。
...
[TRTCKaraokeRoom](https://intl.cloud.tencent.com/document/product/647/41941) 事件回调，您可以通过 TRTCKaraokeRoomDelegate 获得 [TRTCKaraokeRoom](https://intl.cloud.tencent.com/document/product/647/41941) 的各种状态通知。
