...
TRTCChatSalon 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [语音沙龙（iOS）](https://intl.cloud.tencent.com/document/product/647/39804)。
...
| 参数     | 类型              | 含义           |
| -------- | ----------------- | -------------- |
| userInfo | ChatSalonUserInfo | 进房观众信息。 |
...
| 参数     | 类型              | 含义           |
| -------- | ----------------- | -------------- |
| userInfo | ChatSalonUserInfo | 退房观众信息。 |
