...
`TRTCChatSalon` is an open-source class depending on two closed-source Tencent Cloud SDKs. For the specific implementation process, please see [Chat Salon (Android)](https://intl.cloud.tencent.com/document/product/647/53537).
...
This API is used to get a [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/53537) singleton object.
...
This API is used to terminate a [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/53537) singleton object.
...
### setDelegate
This API is used to get the event callback of [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/53537). You can use `TRTCChatSalonDelegate` to get different status notifications of [TRTCChatSalon](https://cloud.tencent.com/document/product/647/53537).
...
2. After successfully creating the room, the user calls `enterSeat` to become a speaker.
...
2. The users select a chat salon and calls `enterRoom` with the room ID passed in to enter the room.
3. After entering the room, the user receives an `onRoomInfoChange` notification about the room attribute change from the component. The room attributes can be recorded, and corresponding changes can be made. The attributes include the room name displayed on the UI and whether room owner’s consent is required for listeners to speak.
