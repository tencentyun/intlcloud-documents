...
TRTCChatSalon 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [语音沙龙（Android）](https://intl.cloud.tencent.com/document/product/647/53537)。
...
获取 [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/53537) 单例对象。
