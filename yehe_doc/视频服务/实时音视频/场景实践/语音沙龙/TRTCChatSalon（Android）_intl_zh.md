...
TRTCChatSalon 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [语音沙龙（Android）](https://intl.cloud.tencent.com/document/product/647/39804)。

- TRTC SDK：使用 [TRTC SDK](https://intl.cloud.tencent.com/zh/document/product/647) 作为低延时语音聊天组件。
- IM SDK：使用 [IM SDK](https://intl.cloud.tencent.com/zh/document/product/1047) 的 AVChatroom 实现聊天室的功能，同时，通过 IM 的属性接口来存储麦位表等房间信息，邀请信令可以用于上麦申请/抱麦申请。
...
获取 [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/39804) 单例对象。
...
销毁 [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/39804) 单例对象。
...
### setDelegate
[TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/39804) 事件回调，您可以通过 TRTCChatSalonDelegate 获得 [TRTCChatSalon](https://intl.cloud.tencent.com/document/product/647/39804) 的各种状态通知。
...
| userSig  | String         | 腾讯云设计的一种安全保护签名，获取方式请参考 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。 |
