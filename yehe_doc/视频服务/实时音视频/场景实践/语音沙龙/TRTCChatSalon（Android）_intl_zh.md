...
TRTCChatSalon 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [语音沙龙（Android）](https://intl.cloud.tencent.com/zh/document/product/647/39804)。
...
获取 [TRTCChatSalon](https://intl.cloud.tencent.com/zh/document/product/647/39804) 单例对象。
