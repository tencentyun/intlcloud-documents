...
|[groupCall({userIDList, type, groupID})](#groupCall)|群组邀请通话（请先 [创建 IM 群组](https://intl.cloud.tencent.com/document/product/1047/34330)）。|
...
|userSig|String| 是 |身份签名（即相当于登录密码），由 userID 计算得出，具体计算方法请参见 [如何计算 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。|
...
在调用该接口前需要使用 IM [创建群组](https://intl.cloud.tencent.com/document/product/1047/34330)，并将 groupID 作为参数传入。
