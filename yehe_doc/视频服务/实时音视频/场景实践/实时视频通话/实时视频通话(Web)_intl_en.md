...
![](https://main.qcloudimg.com/raw/99c0bf40a7b6267c5c398336a97f3335.png)
...
```
- **Displaying the remote video image**
```javascript
trtcCalling.startRemoteView({
  userID, // Remote user ID
  videoViewDomID // The user's data will be rendered into this DOM ID node
})
```
- **Displaying the local preview image**
```javascript
