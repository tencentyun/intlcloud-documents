...
<tr>
<td>SDKAppID</td>
<td>You can view the `SDKAppID` of your application in the <a href="https://intl.cloud.tencent.com/login">TRTC console</a>.</td>
</tr><tr>
<td>userId</td>
...
The offline call answering feature is expected to be supported in mid-June.
