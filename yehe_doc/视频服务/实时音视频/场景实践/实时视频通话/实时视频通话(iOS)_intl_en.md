...
2. Call `TUILogin.`init`(sdkAppID)` to initialize login.
...
1. Apply for an Apple push certificate. For detailed directions, please see [Obtaining Apple Push Notification Service Certificates](https://intl.cloud.tencent.com/zh/document/product/1047/34346).
