...
TRTCChorusRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [Chorus（Android）](https://intl.cloud.tencent.com/document/product/647/42689)。
...
获取 [TRTCChorusRoom](https://intl.cloud.tencent.com/document/product/647/41941) 单例对象。
...
销毁 [TRTCChorusRoom](https://intl.cloud.tencent.com/document/product/647/41941) 单例对象。
...
[TRTCChorusRoom](https://intl.cloud.tencent.com/document/product/647/41941) 事件回调，您可以通过 TRTCChorusRoomDelegate 获得 [TRTCChorusRoom](https://intl.cloud.tencent.com/document/product/647/41941) 的各种状态通知。
