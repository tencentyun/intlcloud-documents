...
TRTCChorusRoom 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [Chorus（iOS）](https://intl.cloud.tencent.com/document/product/647/42688)。
...
获取 [TRTCChorus](https://intl.cloud.tencent.com/document/product/647/41940) 单例对象。
...
销毁 [TRTCChorus](https://intl.cloud.tencent.com/document/product/647/41940) 单例对象。
...
[TRTCChorus](https://intl.cloud.tencent.com/document/product/647/41940) 事件回调，您可以通过 TRTCChorusDelegate 获得 [TRTCChorus](https://intl.cloud.tencent.com/document/product/647/41940) 的各种状态通知。
