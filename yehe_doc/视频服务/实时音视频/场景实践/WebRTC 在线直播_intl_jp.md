...
[**TWebLive**](https://trtc.qcloud.com/tweblive/index.html#/)はTencent CloudがTRTC、IM、CDNなどのサービスに基づいて構築したWeb端末ライブストリーミングコンポーネントです。簡単なコードで、以下のようなプッシュストリーム、プルストリーム、チャットルームの機能を実装することができます。
