...
To quickly implement audio calls, you can modify and adapt the Tencent Cloud TRTC Demo, or use the Tencent Cloud `TRTCAudioCall` component which allows you to customize UI.
