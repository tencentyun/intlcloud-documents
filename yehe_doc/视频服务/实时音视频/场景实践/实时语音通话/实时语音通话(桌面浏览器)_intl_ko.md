본 문서에서는 브라우저에서 음성 통화를 실행하는 솔루션을 소개하며, 다음과 같이 두 장으로 나뉘어 있습니다.
- 1. 서비스 활성화 및 Tencent Cloud에서 제공하는 시연 Demo 실행 소개
- 2. TRTCCalling 모듈을 사용한 음성 통화 기능의 빠른 구축 방법 소개
...
1. [Tencent Cloud 가입](https://intl.cloud.tencent.com/document/product/378/17985)된 계정이 있고 [실명 인증](https://intl.cloud.tencent.com/document/product/378/3629)이 완료되어야 합니다. 실명 인증을 하지 않은 사용자는 중국대륙 실시간 음성 통화 인스턴스를 구매할 수 없습니다.
