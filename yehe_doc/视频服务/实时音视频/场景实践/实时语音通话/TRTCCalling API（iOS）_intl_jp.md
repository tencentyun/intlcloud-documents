...
| [onCallingCancel](#oncallingcancel)   | 現在の通話がキャンセルされた時のコールバック。 |
...
```Objective-C
/// ユーザーがオーディオアップストリームを開始したかどうかのコールバック。 | is user audio available callback
/// - Parameters:
///   - uid: ユーザーID | userID
...
/// - Parameter volume: 話し手の音量、数値範囲：0 - 100
