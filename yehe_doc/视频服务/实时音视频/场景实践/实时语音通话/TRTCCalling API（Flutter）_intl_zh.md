TRTCCalling 是基于腾讯云实时音视频（TRTC）和即时通信 IM 服务组合而成的，支持1v1音视频通话。TRTCCalling 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [实时语音通话（Flutter）](https://intl.cloud.tencent.com/document/product/647/41692)。
...
[TRTCCalling](https://intl.cloud.tencent.com/document/product/647/36066) 事件回调，您可以通过 TRTCCallingDelegate 获得 [TRTCCalling](https://intl.cloud.tencent.com/document/product/647/36066) 的各种状态通知。
