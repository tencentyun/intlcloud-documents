TRTCCalling은 Tencent Cloud TRTC와 IM 서비스를 결합한 것으로, 일대일 멀티미디어 통화를 지원합니다. TRTCCalling은 오픈 소스 Class로 Tencent Cloud의 2개의 클로즈드 소스 SDK에 종속됩니다. 자세한 구현 방법은 [실시간 음성 통화(Flutter)](https://intl.cloud.tencent.com/zh/document/product/647)를 참조하십시오.
