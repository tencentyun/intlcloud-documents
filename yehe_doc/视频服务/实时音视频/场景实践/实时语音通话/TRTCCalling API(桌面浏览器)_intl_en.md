...
| ---------------- | ------- | ------------------------------------------------------------- |
| userID | String | User ID |
| isVideoAvailable | Boolean | <li/>true: a remote user enabled the camera. <li/> false: a remote user disabled the camera. |
...
| ---------------- | ------- | -------------------------------------------------------------- |
| userID | String | User ID |
| isAudioAvailable | Boolean | <li/>true: a remote user enabled the mic. <li/> false: a remote user disabled mic. |
