빠른 음성 통화 기능이 필요한 경우, Tencent Cloud가 제공하는 Demo를 기반으로 설정을 적절하게 수정하거나 TRTCCalling 모듈을 사용해 사용자 정의 UI 인터페이스를 구현할 수 있습니다.
...
[](id:model.step1)
### 1단계: SDK 통합
멀티미디어 통화 모듈 TRTCCalling는 [TRTC SDK](https://pub.dev/packages/tencent_trtc_cloud)와 [IM SDK](https://intl.cloud.tencent.com/zh/document/product/1047)에 종속되며, `pubspec.yaml` 설정을 통해 자동으로 다운로드 및 업데이트할 수 있습니다.
