...
TRTCMeeting 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人视频会议(iOS)](https://intl.cloud.tencent.com/document/product/647/37284)。
...
获取 [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/37284) 单例对象。
...
[TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/37284) 事件回调，您可以通过 TRTCMeetingDelegate 获得 [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/37284) 的各种状态通知。
...
| userId   | NSString            | 当前用户的 ID，字符串类型，只允许包含英文字母（a-z 和 A-Z）、数字（0-9）、连词符（-）和下划线（_）。 建议结合业务实际账号体系自行设置。|
| userSig  | NSString            | 腾讯云设计的一种安全保护签名，获取方式请参考 [如何计算及使用 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。 |
