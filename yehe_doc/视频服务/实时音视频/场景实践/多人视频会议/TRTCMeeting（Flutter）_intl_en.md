...
`TRTCMeeting` is an open-source class depending on two closed-source Tencent Cloud SDKs. For the specific implementation process, please see [Video Conferencing (Flutter)](https://intl.cloud.tencent.com/document/product/647/41945).
...
| [stopRemoteView](#stopremoteview) | Stops playing back the remote video image of specified member. |
...
| [setSpeaker](#setspeaker) | Turns the speaker or receiver on. |
...
| [pauseScreenCapture](#pausescreencapture) | Pauses screen capturing. |
| [resumeScreenCapture](#resumescreencapture) | Resumes screen capturing. |
...
| API | Description |
|-----|-----|
| [sendRoomTextMsg](#sendroomtextmsg) | Broadcasts text message in meeting. This API is generally used for chat. |
...
| API | Description |
|-----|-----|
| [onEnterRoom](#onenterroom) | You joined the meeting. |
...
| API | Description |
|-----|-----|
| [onUserAudioAvailable](#onuseraudioavailable) | A member turned on/off the mic. |
| [onUserVideoAvailable](#onuservideoavailable) | A member turned on/off the camera. |
...
This API is used to terminate a [TRTCMeeting](https://intl.cloud.tencent.com/document/product/647/41945) singleton object.
```dart
...
|-----|-----|-----|
| userId | String | Specified member ID |
| streamType | int | Type of the video stream to watch. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#a9a2aaa1d287b6a2169088c5ecbd25f19). |
...
| userId | String | Specified member ID |
| streamType | int | Type of the video stream to watch. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#a9a2aaa1d287b6a2169088c5ecbd25f19). |
| fillMode | int | Video image rendering mode: fill (default value) or fit. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#ae697c0f66077568d33d0996064776b50). |
| rotation | int | Clockwise video image rotation angle. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#ab3d380890a5e0b7b6a29bc5d0e58f8e8). |
| mirrorType | int | Mirroring mode. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#ae5d847e0006bf2cd689b1116721109ca). |
...
>? For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#classcom_1_1tencent_1_1trtc_1_1TRTCCloudDef_1_1TRTCVideoEncParam).
...
| Parameter | Type | Description |
|-----|-----|-----|
| quality | int | Audio quality. For more information, please see [TRTC SDK](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__android.html#a4451651bf7fc810efc4400964c3c0408). |
