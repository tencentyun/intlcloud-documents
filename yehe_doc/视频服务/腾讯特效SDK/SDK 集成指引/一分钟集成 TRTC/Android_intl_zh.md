...
1. 下载集成了腾讯特效 TE 的 [TRTC Demo](https://intl.cloud.tencent.com/document/product/1143/45374) 工程。本 Demo 基于腾讯特效 SDK S1-04 套餐构建。
...
1. **授权：**
```java
  //鉴权注意事项及错误码详情，请参考 https://intl.cloud.tencent.com/document/product/1143/45385#step-1.-authenticate
