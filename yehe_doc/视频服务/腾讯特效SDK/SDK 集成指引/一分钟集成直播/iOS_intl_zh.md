...
1. 下载并解压 [Demo 包](https://intl.cloud.tencent.com/document/product/1143/45374)。
...
1. 首先在工程 AppDelegate 的 didFinishLaunchingWithOptions 中添加如下鉴权代码，其中 LicenseURL，LicenseKey 为腾讯云官网申请到授权信息：
```
