...
- **Camera or screencapturing tool on desktops/laptops**: use third-party software to capture camera video or screen and push the video or screen content to the push address. Third-party push applications include [OBS (recommended)](https://cloud.tencent.com/document/product/267/32726), XSplit, FMLE, etc.
...
If you want to replay highlights, you can use the time shifting feature which only supports the HLS protocol. For more information on time shifting and how to activate it, please see [Best Practice - LVB Time Shifting](https://cloud.tencent.com/document/product/267/32742).
