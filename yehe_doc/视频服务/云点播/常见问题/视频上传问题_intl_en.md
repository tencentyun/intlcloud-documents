...
### How long does it take before an uploaded video can be watched?
...
- The application server needs to distribute a signature for upload from client. For the method of generating a signature, please see [Simple Video Upload](https://intl.cloud.tencent.com/document/product/266/33924).
