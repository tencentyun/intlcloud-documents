## 작업 시나리오
오디오/비디오 심사 페이지에는 미디어 자산에서 시작하고 태스크 플로우에서 설정한 심사 작업의 결과를 포함한 오디오/비디오 심사 결과가 표시됩니다.
...
![](https://qcloudimg.tencent-cloud.cn/raw/aefccb09bebcd2aa3e79b0c8f58e94c5.png)
	...
	- 기간별 조회: 오늘, 어제, 최근 7일 동안의 오디오/비디오 심사 결과 및 최근 7일 이내의 모든 기간에 대한 오디오/비디오 심사 결과를 비디오 심사 목록에서 조회할 수 있습니다.
...
>?오디오/비디오 심사 결과를 얻으려면 미디어 자산에서 [오디오/비디오 심사](https://intl.cloud.tencent.com/document/product/266/33892)를 시작해야 합니다.
...
![](https://qcloudimg.tencent-cloud.cn/raw/fcf31a23f67809fbec7ded67a01f7be9.png)
	...
	- 심사 결과 확인:
		...
		- **재심사**를 클릭하여 다른 심사 템플릿을 선택하고 심사 작업을 다시 시작하거나 또는 ‘오디오/비디오 심사’ 페이지의 대상 비디오 파일 행에서 **재심사**를 클릭합니다.
	- 심사 내용: VOD 비디오 심사 결과는 **MP4 형식의 비디오 미리보기**만 지원합니다. 심사 결과 내역은 태그 형태로 표시되며, 특정 심사 템플릿을 기반으로 심사 결과 및 세그먼트 신뢰도를 표시하여 [신뢰도 임계값 조정](https://intl.cloud.tencent.com/document/product/266/14059)을 용이하게 합니다.
