...
4. 왼쪽 사이드바에서 **비디오 처리** > **템플릿 설정**을 선택합니다. 콘솔의 사전 설정 템플릿에는 **비디오 트랜스 코딩 템플릿**, **TESHD 템플릿**, **오디오 트랜스 코딩 템플릿**, **리먹싱 템플릿**, **어댑티브 비트 레이트 스트리밍 템플릿**, **워터마크 템플릿**, **스크린샷 템플릿**, **애니메이션 이미지 템플릿** 및 **비디오 심사 템플릿**이 포함됩니다. 비디오 처리 설정을 위한 워크플로 설정에 각 템플릿을 추가할 수 있습니다.
