...
4. 选择左侧导航栏的**视频处理设置**>**模板设置**。模板设置内置的模板分别为**视频转码模板**、**极速高清模板**、**音频转码模板**、**转封装模板**、**转自适应码流模板**、**水印模板**、**截图模板**、**转动图模板**及**智能识别模板**，每种模板都可以添加至任务流设置中，用于视频处理设置。
...
#### 预置参数模板列表
详细的参数请参见[预置参数模板列表-预置转码模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-transcoding-templates)。
...
创建好的模板可在模板列表里展示，可以设置为常用模板，并能对模板进行查看、编辑和删除等管理操作。
>?您可参见 [预置参数模板列表 - 极速高清转码](https://intl.cloud.tencent.com/document/product/266/33932#preset-teshd-templates)。
...
#### 预置参数模板列表
详细的参数请参见 [预置参数模板列表 - 音频转码模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-transcoding-templates)。
...
>?
>- 创建模板时，至少需要添加1条子流信息。
>- 您可参见 [预置参数模板列表 - 自适应码流模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-adaptive-bitrate-streaming-templates)。
...
### 时间点截图
在截图类型中选择时间点截图，**采样的时间点需在截图任务配置中指定，模板设置中仅进行截图类型的配置**，时间点的截图任务配置请参见 [任务配置说明](https://intl.cloud.tencent.com/document/product/266/14058#custom-task-flow)。
...
#### 预置参数模板列表
详细的参数请参见 [预置参数模板列表 - 时间点截图模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-animated-image-generating-templates)。
...
#### 预置参数模板列表
详细的参数请参见 [预置参数模板列表 - 采样截图模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-time-point-screenshot-templates)。
...
#### 预置参数模板列表
详细的参数请参见 [预置参数模板列表 - 雪碧图模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-sampled-screenshot-templates)。

## 转动图模板
您可根据业务需要创建转动图模板，按照指定时间段截取所需要的转动图。**转动图的时间段需在任务流的转动图任务配置中指定，模板设置中仅进行转动图类型设置**，转动图任务配置请参见 [任务配置说明](https://intl.cloud.tencent.com/document/product/266/14058#custom-task-flow)。
...
#### 预置参数模板列表
详细的参数请参见 [预置参数模板列表 - 转动图模板](https://intl.cloud.tencent.com/document/product/266/33932#preset-remuxing-templates)。
