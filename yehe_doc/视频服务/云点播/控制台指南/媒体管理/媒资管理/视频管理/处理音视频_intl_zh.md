...
4. 勾选一个或多个目标音视频文件，单击列表上方的**视频处理**，弹出“视频处理”配置框，根据下表配置视频处理参数，单击**确定**，开始执行视频处理任务。
...
<table>
	 ...
	 <tr>      
         <td>音视频审核</td>   
	     <td>当处理类型选择<b>音视频审核</b>时，此参数为<b>“审核模板”：</b>选择一个现有的审核模板</td>   
	     <td align="middle">-</td>   
	     <td align="middle">-</td>
     </tr> 
		  <tr>      
...
>?模板及任务流相关设置，请参见 [音视频处理设置](https://intl.cloud.tencent.com/document/product/266/14059)。
