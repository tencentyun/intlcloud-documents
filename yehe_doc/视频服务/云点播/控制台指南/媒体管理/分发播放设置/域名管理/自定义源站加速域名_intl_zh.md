...
4. 域名解析，针对已添加的自定义加速域名，您需要在该域名指定的 DNS 服务商配置 CNAME，用户才能通过域名访问到您的视频媒体，具体操作请参见 [点播加速域名-域名解析](https://www.tencentcloud.com/document/product/266/42076#.E8.A7.A3.E6.9E.90.E5.9F.9F.E5.90.8D)。
