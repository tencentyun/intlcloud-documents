...
>?您需要在媒资管理中发起 [音视频审核](https://intl.cloud.tencent.com/document/product/266/33892)，才可以看到音视频审核结果。
...
![](https://qcloudimg.tencent-cloud.cn/raw/fcf31a23f67809fbec7ded67a01f7be9.png)
	...
	- 审核详情：视频经云点播审核后得到的审核结果，**仅支持 MP4 格式的视频预览**，其余格式的视频暂不支持内部播放器预览。审核结果的详细信息以标签的形式展示，会根据具体的审核模板展示审核结果以及该片段的置信度，便于用户 [调节置信度阈值](https://intl.cloud.tencent.com/document/product/266/14059)。
