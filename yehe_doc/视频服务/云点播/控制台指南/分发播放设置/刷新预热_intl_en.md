...
>- `URL` is the audio/video URL in VOD. `URL` is specific to a audio/video media file. Therefore, when you purge or prefetch an `URL`, only the corresponding file will take effect.
