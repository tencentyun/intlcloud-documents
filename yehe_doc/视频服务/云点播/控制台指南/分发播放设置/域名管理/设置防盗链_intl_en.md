...
2. Click **Set** in the row of the target domain name to enter the configuration page.
3. Click **Access Control**, and then toggle **Referer Hotlink Protection** on or off.	If you enable it, configure as follows:
 - Allow Empty Referer: select it or leave it unselected.
 - Referer Type: select **Blocklist** or **Allowlist** and enter the desired domain name in the text box below.
...
3. Click **Access Control**, and then toggle **Key Hotlink Protection** on or off.	If you enable it, configure as follows:
   Click **Generate** and the system will automatically generate a hotlink protection key.
4. Click **Confirm** to save the configuration.
