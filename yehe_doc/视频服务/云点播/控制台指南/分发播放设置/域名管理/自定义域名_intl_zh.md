...
2. 单击【添加域名】，在弹出的对话框中输入已成功 [备案]的域名，单击【确定】。
...
>?下面以使用腾讯云解析作为 DNS 服务商为例，添加 CNAME 记录，不同的 DNS 服务商操作略有不同，更多操作请参见 [配置 CNAME](https://intl.cloud.tencent.com/document/product/266/42076) 。
