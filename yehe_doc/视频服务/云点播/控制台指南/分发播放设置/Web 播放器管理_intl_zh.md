...
>- 如果所选择的播放器与视频文件存在关联，则无法删除播放器，需要在 [媒资管理](https://console.cloud.tencent.com/vod/media) 中修改已关联的播放器解除关联，即可删除，相关文档请参见 [Web 播放器代码生成步骤](https://intl.cloud.tencent.com/document/product/266/33896?lang=en&pg=#web-player-code-generation)。
