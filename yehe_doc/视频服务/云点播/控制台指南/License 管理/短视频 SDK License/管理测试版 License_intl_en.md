A UGSV SDK license is used to activate the use rights of the UGSV SDK. You can apply for, renew, and view a trial license in the console. For more information on UGSV SDK features, see [UGSV](https://intl.cloud.tencent.com/document/product/1069/37914).
...
1. Log in to the [VOD console](https://console.cloud.tencent.com/vod/license) as an admin and select **[UGSV SDK License](https://console.cloud.tencent.com/vod/license/video)** on the left sidebar.
