...
사용 통계는 대역폭/트래픽 통계, 업로드 가속 통계, 저장 통계, 데이터 검색 통계, 트랜스코딩 통계 및 영상 조정 통계의 통계 데이터를 제공하며 기본적으로 ‘대역폭/트래픽 통계’ 페이지로 이동합니다.
...
## 비디오 조정 통계
- 비디오 조정 통계의 세부 정보가 그래픽으로 표시되어 비디오 조정 횟수 및 시간 추이를 기록합니다. 오늘, 어제, 지난 7일, 지난 30일 및 30일 이내 임의의 기간에 대한 통계를 쿼리할 수 있습니다.
-  데이터 개요 지표는 **조정 횟수(회)** 및 **조정 시간(분)**입니다.
