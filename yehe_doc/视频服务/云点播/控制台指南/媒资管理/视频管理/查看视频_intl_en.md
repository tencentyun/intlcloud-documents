...
2. Move to the row of the target video file in the video list. A **Quick View** button will appear below the video ID. Click it and the window of video file information will appear on the right.
