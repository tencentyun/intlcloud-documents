...
## 超级播放器预览
>!超级播放器仅支持对转自适应码流的视频进行预览。若您想快速生成符合超级播放器要求的视频，请参见 [使用超级播放器播放 - 接入指引](https://intl.cloud.tencent.com/document/product/266/38098#.E5.88.9D.E7.BA.A7.E6.AD.A5.E9.AA.A4)。
