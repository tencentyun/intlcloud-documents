[VOD 콘솔](https://console.cloud.tencent.com/vod/overview)에서 대역폭/트래픽 통계, 스토리지 통계, 데이터 검색 통계, 트랜스코딩 통계 및 비디오 심사 통계가 제공되는 **데이터 센터**>**사용량 통계**를 선택합니다. ‘대역폭/트래픽 통계’ 탭이 기본적으로 표시됩니다.
