在 [云点播控制台](https://console.cloud.tencent.com/vod/overview) 选择【数据中心】>【用量统计】，提供**带宽/流量统计**、**存储统计**、**转码统计**、**视频智能识别统计的统计数据，默认进入“带宽/流量统计”页面。
...
- 若查询次数为1天，则展示20分钟粒度的统计数据，查询次数为多日则展示统计数据趋势。
- 存储统计数据存在半小时左右的延时。
...
- 图形化展示视频智能识别情况统计详情数据，记录了用户使用视频智能识别时长的趋势。云点播提供今天、昨天、近7天、近30天以及30天内任意时间段的数据查询。
- 数据概览指标为**智能识别次数（次）**和**智能识别时长（分钟）**。
