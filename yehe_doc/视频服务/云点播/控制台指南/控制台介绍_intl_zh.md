...
<td><ul style = "margin-bottom: 0px;"><li>可查看当前账户计费方式及计费带宽等计费情况。</li><li>可查看存储空间、转码时长、使用流量、使用带宽、数据取回及周趋势信息。</li></ul></td>
</tr>
<tr>
...
<td><ul style= "margin: 0"><li>可获取视频加速播放链接。</li><li>可以对视频链接设置鉴权和访问控制。</li></ul></td>
</tr>
<tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/7836">播放器 SDK</a></td>
<td><ul style= "margin: 0"><li>支持多种端（iOS、Web、Android）多版本播放器。</li><li>对于已使用第三方播放器的场景，提供播放器插件。</li><li>提供自动切换清晰度，首屏秒开，手势控制等多种功能。</li><li>支持多种编码方式的视频播放。</li></ul></td>
</tr>
</table>
...
<tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/33897">媒体审核</a></td>
...
## 配置服务
配置服务提供了云点播的自定义配置服务，包括域名管理、上传存储设置、回调设置、播放器配置等。如有相关需求可在本模块进行相关配置。
<table>
<tr><th width="17%">功能名称</th><th>功能描述</th></tr>
<tr>
<td ><a href = "https://intl.cloud.tencent.com/document/product/266/35572">域名管理</a></td>
...
<tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/14055">回调设置</a></td>
<td>可对事件通知的方式、具体事件及通知接收地址进行设置。</td>
</tr>
<tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/38261">超级播放器配置</a></td>
<td>可对播放器指定的自适应码流、雪碧图和清晰度名称等进行配置。</td>
</tr>
</table>
...
<tr><th width="17%">功能名称</th><th>功能描述</th></tr>
<tr>
<td ><a href = "https://intl.cloud.tencent.com/document/product/266/30421">用量统计</a></td>
<td>可查看带宽/流量、存储空间、转码和媒体审核。</td>
</tr><tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/30422">数据分析</a></td>
<td><ul style= "margin: 0"><li>可查看提供独立IP访问总数、请求总数等访问情况数据。</li><li>可查看文件播放情况、播放次数TOP100视频等播放情况数据。</li></ul></td>
</tr>
<tr>
<td><a href = "https://intl.cloud.tencent.com/document/product/266/7983">日志下载</a></td>
