[VODコンソール](https://console.cloud.tencent.com/vod/overview)に進み、左側ナビゲーションバーの【ビデオ処理設定】>【テンプレート設定】を選択します。テンプレート設定に内蔵のテンプレートはそれぞれ**ビデオトランスコードテンプレート**、**TESHDテンプレート**、**オーディオトランスコードテンプレート**、**コンテナ生成テンプレート**、**ABS生成テンプレート**、**画像処理テンプレート**、**ウォーターマークテンプレート**、**スクリーンキャプチャテンプレート**、**アニメーション画像生成テンプレート**、**スマート認識テンプレート**です。各テンプレートはタスクフロー設定に追加でき、ビデオ処理設定に使用できます。
...
+ ビデオパラメータ：
	+ コーデック方式：H.264、H.265、AOMedia Video1
...
+ **基本情報**
	+ テンプレート名：中国語、英語、数字、スペース、アンダーバー(_)、ハイフン(-)、ピリオド(.)の7種類の形式のみサポートし、64文字を超える長さは対応しません。
	+ パッケージ化形式：HLS、MPEG-DASH
	+ 暗号化タイプ：暗号化プランまたはSimpleAESを使用しなければ、MPEG-DASHはSimpleAESをサポートしません。
	+ 低解像度から高解像度を有効にする：有効または無効
+ **サブストリーム情報**
	+ ビデオコーデック：H.264、H.265
	+ ビデオビットレート：128kbps～35000kbps
	+ ビデオ解像度：ビデオの長辺、短辺は128px - 4096pxに制限
	+ ビデオフレームレート：1～100fps
	+ オーディオコーデック：AAC、MP3
...
+ テンプレート名：中国語、英語、数字、スペース、アンダーバー(_)、ハイフン(-)、ピリオド(.)の7種類の形式のみサポートし、64文字を超える長さは対応しません。
+ ウォーターマークのタイプ：画像ウォーターマーク、テキストウォーターマーク、SVGウォーターマーク
+ ウォーターマークのフォント：Simkaiは中国語と英語をサポートでき、arialは英語のみサポート
+ フォント：10、11、12、14、16、18、20、22、24、26、28、36、48、72をサポート
+ フォントの色：対応する色の選択をサポート
+ 透明度：透明度の値は1～100
...
- 画像形式：JPG。
- 画像サイズ：128px～4096px
- 塗りつぶし方式：黒で補填、引き伸ばし、白で補填、ガウシアンぼかしをサポート
...
## スマート認識テンプレート
業務のニーズに応じて、新しいビデオスマート認識テンプレートを作成し、カスタム設定を行うことができます。【審査テンプレートの作成】をクリックしてテンプレートのカスタム設定に進みます。
...
>?コンソールで[スマート認識 - プリセットのパラメータテンプレート](https://intl.cloud.tencent.com/document/product/266/33932#video-ai)を確認することができます。
