...
除了上述不支持资源级授权的 API 列表，其它所有展示在 [API 概览](https://intl.cloud.tencent.com/document/product/266/34110) 中的接口都支持资源级授权。策略语法中对这些接口的资源描述形式均相同，具体为：`qcs::vod::uin/$uin:subAppId/$subAppId`。
