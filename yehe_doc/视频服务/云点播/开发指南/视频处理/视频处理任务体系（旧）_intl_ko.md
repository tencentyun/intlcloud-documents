...
- 사전 설정 매개변수 템플릿: 일반적인 비디오 처리 매개변수 세트와 마찬가지로 VOD는 사전 설정 매개변수 템플릿 배치를 제공합니다. 자세한 내용은 [사전 설정 매개변수 템플릿 목록](https://www.tencentcloud.com/document/product/266/52735)을 참고하십시오.
