...
一般的な操作の組み合わせを対象に、VODでは、[プリセットのビデオコンテンツ認識テンプレート](https://intl.cloud.tencent.com/document/product/266/33932)を提供しています。その他、 [サーバーAPI](https://intl.cloud.tencent.com/zh/document/product/266/37583) を呼び出してカスタマイズしたビデオコンテンツ認識テンプレートを作成し、管理することができます。-->
