...
编辑后生成的新视频封装格式是 MP4。发起编辑时，可以指定是否对生成的新视频执行 [任务流](https://intl.cloud.tencent.com/document/product/266/33931)。
...
发起任务后，您可以通过异步等待 [结果通知](https://intl.cloud.tencent.com/document/product/266/33931) 或同步进行 [任务查询](https://intl.cloud.tencent.com/document/product/266/33931) 的方式获取编辑的执行结果。下面是发起视频编辑任务后，普通回调方式下结果通知的示例（省略了值为 null 的字段）：
