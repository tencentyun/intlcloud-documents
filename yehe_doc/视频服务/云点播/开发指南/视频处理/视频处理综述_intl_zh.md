...
<table>
    ...
    <tr>
        ...
        <td>
				<li>剪辑：从视频中截取一段，生成一个新视频。</li><li>拼接：将多个视频拼接，生成一个新视频。</li>
        </td>
    </tr>
        <td>
            视频合成
...
- 借助腾讯云强大的 AI，对视频进行智能审核、分析和识别。
- 集成商业级 DRM，对视频进行高级别的加密。

发起视频处理后，处理结果不能立即输出（即无法同步地获取结果），所以视频处理都是以离线任务的方式进行的。关于如何发起视频处理任务并获取任务结果，请参见 [视频处理任务体系](https://intl.cloud.tencent.com/document/product/266/33931)。
