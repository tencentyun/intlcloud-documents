...
* 播放器 SDK 支持的功能，请参见 [功能说明](https://intl.cloud.tencent.com/document/product/266/42965)，集成方式请参见 [SDK 下载](https://intl.cloud.tencent.com/document/product/266/43035)。
* 为了帮助您快速接入点播的播放器，我们为您提供了播放器 SDK [接入指引](https://intl.cloud.tencent.com/document/product/266/38098)，以示例的方式为您讲解接入步骤。
* 对于视频加密播放场景，云点播分别在 [视频加密综述](https://intl.cloud.tencent.com/document/product/266/38131) 和 [视频加密接入指引](https://intl.cloud.tencent.com/document/product/266/38294) 中详细介绍了视频加密的原理和接入方式。
