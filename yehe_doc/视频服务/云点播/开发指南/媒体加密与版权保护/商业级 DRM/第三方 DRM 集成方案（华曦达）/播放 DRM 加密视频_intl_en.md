...
See [Submitting FairPlay Certificate Information to SDMC](https://intl.cloud.tencent.com/document/product/266/49665).

### Configuring the SDMC UID and key information

See [Configuring the SDMC UID and Key Information](https://intl.cloud.tencent.com/document/product/266/49666).
...
2. Toggle on **Key Hotlink Protection**. In the pop-up window, click **Generate** to generate a random key (suppose it is `testtest`). Copy the key and click **Confirm**. You will use the key later to generate player signatures.
