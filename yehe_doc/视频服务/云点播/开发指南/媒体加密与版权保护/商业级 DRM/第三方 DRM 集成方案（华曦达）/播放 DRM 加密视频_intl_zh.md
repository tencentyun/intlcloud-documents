...
请参考 [如何在华曦达控制台提交 FairPlay 证书信息](https://intl.cloud.tencent.com/document/product/266/49665)。

### 设置华曦达用户密钥信息

请参考 [设置华曦达用户密钥信息](https://intl.cloud.tencent.com/document/product/266/49666)。
