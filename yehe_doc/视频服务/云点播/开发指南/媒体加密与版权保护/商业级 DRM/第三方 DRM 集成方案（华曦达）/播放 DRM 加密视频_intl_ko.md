...
[FairPlay 인증서 신청 및 인증서 정보 제출](https://intl.cloud.tencent.com/document/product/266/46643)을 참고하십시오.

### FairPlay 인증서 정보 제출

[Submitting FairPlay Certificate Information to SDMC](https://intl.cloud.tencent.com/document/product/266/49665)를 참고하십시오.

### SDMC UID 및 키 정보 구성

[Configuring SDMC UID and Key Information](https://intl.cloud.tencent.com/document/product/266/49666)을 참고하십시오.
...
2. [랜덤 Key 생성]을 클릭하고 [Key 링크 도용 방지]를 켭니다. 팝업 창에서 생성을 클릭하여 임의 키(`testtest`)를 생성합니다. Player 서명을 생성하는 데 필요한 Key를 복사하고 [확인]을 클릭하여 구성을 저장합니다.
...
Player 서명은 재생 정보를 가져오는 데 사용됩니다. 생성 방법은 [Player 서명](https://intl.cloud.tencent.com/document/product/266/38099)을 참고하십시오. Player 서명의 PayLoad는 다음과 같습니다.
...
var player = TCPlayer('player-container-id', {
    ...
    fileID: '387702299667618135', // 재생할 동영상의 파일 ID (필수)
...
### iOS
iOS에서 `FileId를 통해` 방식으로 DRM으로 암호화된 동영상을 재생하려면 [통합 가이드](https://intl.cloud.tencent.com/document/product/266/49669#.E6.AD.A5.E9.AA.A45.EF.BC.9A.E5.90.AF.E5.8A.A8.E6.92.AD.E6.94.BE)를 참고하십시오.
...
>? 질문이 있으시면 [티켓 제출](https://console.cloud.tencent.com/workorder/category) 하시기 바랍니다.