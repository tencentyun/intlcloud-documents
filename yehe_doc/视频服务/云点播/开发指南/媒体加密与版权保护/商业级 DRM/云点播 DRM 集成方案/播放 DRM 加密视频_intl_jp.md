...
[FairPlay証明書情報の申請方法](https://www.tencentcloud.com/document/product/266/46643)をご参照ください。

### FairPlay証明書情報の提出

[VODコンソールでのFairPlay証明書情報の提出方法](https://intl.cloud.tencent.com/document/product/266/49668)をご参照ください。
...
[アクセスガイド](https://intl.cloud.tencent.com/document/product/266/49670#.E6.AD.A5.E9.AA.A45.EF.BC.9A.E5.90.AF.E5.8A.A8.E6.92.AD.E6.94.BE)の`FileId方式`の使用方法を参照して、DRMで暗号化されたビデオを再生してください。
...
> ? DRMまたは華曦達への接続プロセスのどのような問題に対しても、[お問い合わせ](https://console.cloud.tencent.com/workorder/category)にチケットを提出することができます。全工程において解決を支援します。
