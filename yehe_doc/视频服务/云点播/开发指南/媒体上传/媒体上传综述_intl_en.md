...
When using the `PullUpload` server API, you can specify the URL of the media file to be uploaded, and the VOD backend will pull the file offline. This method is suitable for migration of a large number of files or automated file migration.
