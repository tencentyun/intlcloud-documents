...
>- **子应用**、**视频文件分类**、**任务流**等信息都包含在上传签名中，更多相关信息请参见 [签名参数说明](https://www.tencentcloud.com/document/product/266/33922)。
...
`xxx_upload` 与 `xxx_progress` 的回调值请参见 [分块上传/复制任务操作]( https://www.tencentcloud.com/document/product/436/43552)。
