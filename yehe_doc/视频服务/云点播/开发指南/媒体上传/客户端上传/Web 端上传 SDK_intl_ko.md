...
>- 업로드 서명에는 **서브 애플리케이션 ID**, **비디오 파일 카테고리**, **태스크 플로우** 등의 정보가 포함됩니다. 자세한 내용은 [서명 매개변수에 대한 설명](https://www.tencentcloud.com/document/product/266/33922)을 참고하십시오.
...
`xxx_upload` 및 `xxx_progress`의 반환 값에 대한 자세한 내용은 [Object Operations](https://www.tencentcloud.com/document/product/436/43552)를 참고하십시오.
