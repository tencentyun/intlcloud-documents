...
## イベントの説明
Appにイベント通知が設定され、かつビデオの合成が完了した場合、Appバックエンドは「通常のコールバック」または「信頼できるコールバック」によって、そのイベント通知を取得することができます。イベント通知の内容は、[ReduceMediaBitrateTask構造](https://intl.cloud.tencent.com/document/product/266/34187#ReduceMediaBitrateTask)です。
