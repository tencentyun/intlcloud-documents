使用超级播放器播放点播视频时，视频**画面内容**是 [转自适应码流](https://intl.cloud.tencent.com/document/product/266/33942) 的输出，**缩略图**预览是 [雪碧图](https://intl.cloud.tencent.com/document/product/266/33940) 的输出。
