...
- 支持在视频 URL 中指定观看者 ID，配合 [溯源水印](https://intl.cloud.tencent.com/document/product/266/47920) 使用。
...
>?开启 Key 防盗链请参见 [设置防盗链](https://intl.cloud.tencent.com/document/product/266/14060)。
...
| 参数名 | 必选 | 说明                                                         |
| ------ | ---- | ------------------------------------------------------------ |
| `KEY`    | 是   | 开启 Key 防盗链时填写的密钥。必须由大小写字母（a - Z）或者数字（0 - 9）组成，长度在8 - 20个字符之间。建议在控制台中单击【生成KEY】生成，具体操作步骤请参见 [设置防盗链](https://intl.cloud.tencent.com/document/product/266/14060)。 |
...
| `uid` | 否   | 播放者的 ID，以十六进制表示，共8位。该参数用于 [溯源水印](https://intl.cloud.tencent.com/document/product/266/47920) 使用场景|
