...
func main() {
        ...
        psignExpire := currentTime + 3600 // Set the expiration time as needed, such as in 1h
        urlTimeExpire := strconv.FormatInt(psignExpire, 16) // Set the expiration time to a hexadecimal string as needed, such as in 1h
...
public class Program
{
        public static void Main()
        {
                ...
                var psignExpire = currentTime + 3600; // Set the expiration time as needed, such as in 1h
                var urlTimeExpire = psignExpire.ToString("X4"); // Set the expiration time to a hexadecimal value as needed, such as in 1h
...
$currentTime = time();
$psignExpire = $currentTime + 3600; // Set the expiration time as needed, such as in 1h
$urlTimeExpire = dechex($psignExpire); // Set the expiration time to a hexadecimal string as needed, such as in 1h
$key = "24FEQmTzro4V5u3D5epW";
...
var psignExpire = currentTime + 3600 // Set the expiration time as needed, such as in 1h
var urlTimeExpire = psignExpire.toString(16) // Set the expiration time to a hexadecimal string as needed, such as in 1h
var key = '24FEQmTzro4V5u3D5epW'
