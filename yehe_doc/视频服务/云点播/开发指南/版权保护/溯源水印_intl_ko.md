유료 비디오 플랫폼이 직면한 가장 큰 문제 중 하나는 비디오의 무단 다운로드 및 공유입니다. 이는 저작권자의 이익을 심각하게 손상시킵니다.
무단 비디오 녹화는 비디오 불법 복제의 가장 일반적인 형태입니다. 도용자는 화면 녹화 소프트웨어를 사용하여 비디오를 녹화하거나 물리적 카메라를 사용하여 화면을 직접 녹화하는데, 이를 방지하기 어렵습니다.
무단 비디오 녹화를 억제하는 효과적인 방법은 불법 복제를 추적하고 저작권이 있는 콘텐츠를 보호하고, 불법 복제를 방지하며, 보상 요구 수단을 사용하는 것입니다.
VOD의 디지털 워터마크는 낮은 비용으로 높은 보안 수준을 보장하며, 무단으로 녹화된 영상을 쉽게 추적할 수 있도록 도와줍니다.
...
콘솔에서 또는 API를 통해 이미지 워터마크 템플릿을 생성합니다(워터마크는 이미지 상단에 있어야 합니다).
...
* VOD의 [Superplayer](https://intl.cloud.tencent.com/document/product/266/33977) 또는 [Superplayer Adapter](https://intl.cloud.tencent.com/document/product/266/42095)를 사용하는 경우 비즈니스 서버는 각 재생 요청에 대해 [Superplayer 서명](https://intl.cloud.tencent.com/document/product/266/38099)을 할당해야 합니다. [서명 매개변수](https://intl.cloud.tencent.com/document/product/266/38099#.E7.AD.BE.E5.90.8D.E5.8F.82.E6.95.B0)에 뷰어 uid를 uid로 입력해야 합니다.
* VOD 플레이어를 사용하지 않는 경우 [Key 링크 도용 방지](https://intl.cloud.tencent.com/document/product/266/33986) 규칙에 따라 URL의 QueryString에 뷰어 uid를 추가해야 합니다.
...
2. **워터마크 유형**으로 이미지 워터마크를 선택합니다. 워터마크 이미지를 업로드한 후 **생성**을 클릭합니다(워터마크는 동영상 이미지 상단에 있어야 함).
