...
本文介绍在使用 DRM 功能过程中，如何向苹果公司申请 FairPlay 证书，并将以下证书信息提交到腾讯云点播：
...
4. 点击页面中的` Choose File `按钮，选择在上一步中创建的`certreq`文件，并点击` Continue `按钮。
...
8. 点击 `Download`  按钮下载 FPS 证书（`fairplay.cer`）
