...
云点播提供存储管理、转码处理、视频加速 CDN 以及对内容智能识别的功能，适用于有 4K 转码、HDR、H.265、超分辨率、内容迁移以及内容智能识别等需求的场景。

## 短视频应用

云点播提供视频存储、智能识别、转码、自适应码流、水印、封面、加密及视频分发等功能，适用于短视频场景，即客户端把拍摄并进行裁剪、混音、特效、字幕、贴纸等处理后的视频进行上传。更多详情请参见 [短视频 SDK](https://intl.cloud.tencent.com/zh/product/ugsv)。
## 直播转点播
