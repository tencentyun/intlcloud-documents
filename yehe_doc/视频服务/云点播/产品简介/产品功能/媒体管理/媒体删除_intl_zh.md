...
## 使用方式
媒体删除控制台操作请参见：
- [删除音视频](https://intl.cloud.tencent.com/document/product/266/33891)。
- [删除图片](https://intl.cloud.tencent.com/document/product/266/37901)。

媒体删除相关服务端 API 请参见：
- [申请上传](https://intl.cloud.tencent.com/document/product/266/34120)，输入参数 `ExpireTime` 指定上传文件在云点播的过期时间。
- [修改媒体文件属性](https://intl.cloud.tencent.com/document/product/266/37570)，输入参数 `ExpireTime` 可修改媒体文件的过期时间。
- [删除媒体](https://intl.cloud.tencent.com/document/product/266/37571)。
