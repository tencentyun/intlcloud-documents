...
## 使用方式
极速高清属于云点播转码功能的一种，使用方式上与普通转码一致，只是转码模板需要选择 [极速高清模板](https://intl.cloud.tencent.com/document/product/266/14059) ，而非普通的 [视频转码模板](https://intl.cloud.tencent.com/document/product/266/14059)。
相关使用文档请参见转码相关的文档：
- 最佳实践 [如何对视频进行转码](https://intl.cloud.tencent.com/document/product/266/37546)。
- 开发指南 [转码](https://intl.cloud.tencent.com/document/product/266/33938)。
