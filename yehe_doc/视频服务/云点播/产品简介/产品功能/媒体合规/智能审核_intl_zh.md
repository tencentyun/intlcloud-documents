## 简介
智能审核可帮助用户有效识别图片、音视频中的违禁内容，检测对象涵盖了画面图像、画面中的文本、语音文本以及声音内容，检测场景包括涉黄、涉暴和娇喘。基于前沿的语音、文本、声音、图片识别算法，云点播智能审核持续对海量的违规数据进行训练建模，识别的准确率和召回率均达到业界领先水准，全面有效保障用户的媒体内容安全。
...
## 使用方式
请参见：
- 最佳实践 [如何对媒体进行内容审核](https://intl.cloud.tencent.com/document/product/266/37547)。
- 开发指南 [音视频内容审核](https://intl.cloud.tencent.com/document/product/266/33944)。
