...
<td>安全性が高く、高コストであり、ロバスト性が低く、視覚効果が良くありません。<li>安全性：ウォーターマークは画面にエンコードされているため、セキュリティレベルが高いです</li>
<li>コスト：視聴者ごとに独自のウォーターマークを付ける必要がある場合は多くのトランスコードレプリカが必要となるため、コストが非常に高くなります</li>
<li>ロバスト性：ウォーターマークは固定の位置にあり、トリミングや遮蔽が容易に行えます </li>
<li>視覚効果：ウォーターマークがビデオ上にあるため、視覚に影響します</li>
</td>
</tr>
<tr>
<td>再生側フローティングウォーターマーク</td>
<td>プレーヤーでの再生の際にビデオレイヤー上に表示されるウォーターマーク</td>
<td>安全性が低く、低コストであり、ロバスト性が低く、視覚効果が良くありません。<li>安全性：ウォーターマークは上層のレイヤーにあるため、元のビデオストリームが攻撃者に盗用されるおそれがあり、セキュリティレベルが低いです</li>
<li>コスト：再生側で実装するため、低コストです</li>
<li>ロバスト性：ウォーターマークは固定の位置にあり、遮蔽が容易です</li>
<li>視覚効果：ウォーターマークがビデオ上にあるため、視覚に影響します</li>
</td>
</tr>
<tr>
...
<td>安全性が高く、低コストであり、ロバスト性が高く、視覚効果が良好です。<li>安全性：ウォーターマークは画面にエンコードされているため、セキュリティレベルが高いです</li>
<li>コスト：2回分のトランスコードとストレージコストのみで済むため、比較的低コストです</li>
<li>ロバスト性：リサンプリング、圧縮、ジッター、トリミング、ズーム、回転、フィルタリングなどの、さまざまな攻撃に耐えることができます</li>
<li>視覚効果：ウォーターマークのエンコード後も画質に影響はなく、肉眼で感知されません</li>
</td>
</tr>
</tbody>
</table>
