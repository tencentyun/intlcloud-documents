...
* 关于 HLS 私有加密，使用方式参考 [链接](https://intl.cloud.tencent.com/document/product/266/46780)。
* 关于商业级 DRM，使用方式参考 [链接](https://intl.cloud.tencent.com/document/product/266/46658)。
