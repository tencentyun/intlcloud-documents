...
* 关于普通图文水印，使用方式参考 [链接](https://intl.cloud.tencent.com/document/product/266/33939)。
* 关于播放端浮动水印，使用方式参考 [链接](https://intl.cloud.tencent.com/document/product/266/33976)。
* 关于溯源 AB 水印，使用方式参考 [链接](https://intl.cloud.tencent.com/document/product/266/47920)。
