...
1. 클라우드 VOD 서버 API 문서>**미디어 자산 관리 관련 인터페이스**>[**ModifyMediaInfo**](https://intl.cloud.tencent.com/document/product/266/37570)으로 이동하여 디버깅을 클릭하고 클라우드 API 콘솔로 이동하여 디버깅 진행합니다.
