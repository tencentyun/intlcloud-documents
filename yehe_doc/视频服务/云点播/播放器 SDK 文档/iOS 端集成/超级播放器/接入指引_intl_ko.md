...
## 내용 요약
- [iOS용 Tencent Cloud RT-Cube Superplayer를 통합하는 방법](#step1)
- [플레이어 생성 및 사용 방법](#step3)

## 통합 준비
[](id:step1)
### 1단계: 프로젝트 다운로드
iOS용 Tencent Cloud RT-Cube Superplayer는 [SuperPlayer_iOS](https://github.com/LiteAVSDK/Player_iOS)에서 다운로드할 수 있습니다.
...
1. SDK + Demo 패키지를 다운로드하십시오. iOS용 Tencent Cloud RT-Cube Superplayer는 [SuperPlayer_iOS](https://github.com/LiteAVSDK/Player_iOS)에서 다운로드할 수 있습니다.
...
이제 iOS용 Tencent Cloud RT-Cube Superplayer의 플레이어 생성, 비디오 재생 및 재생 종료 기능 통합이 완료되었습니다.
...
3. Demo를 성공적으로 실행한 후 **플레이어** > **Superplayer**로 이동하여 플레이어 기능을 사용해 보십시오.
