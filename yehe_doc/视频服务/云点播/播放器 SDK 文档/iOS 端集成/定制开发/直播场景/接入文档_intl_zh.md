...
- 视频的上传和发布由 TXUGCPublish 负责，具体使用方法可以参考 [短视频 - 文件发布](https://intl.cloud.tencent.com/document/product/1069/38016)。
...
- **播放地址需要带防盗链**
播放 URL 不能用普通的 CDN URL， 必须要带防盗链签名，防盗链签名的计算方法见 [txTime&txSecret](https://intl.cloud.tencent.com/document/product/267/31560)。
...
- **Obs 的延时是不达标的**
推流端如果是 [TXLivePusher](https://intl.cloud.tencent.com/document/product/1071/38157)，请使用 [setVideoQuality](https://intl.cloud.tencent.com/document/product/1071/38157) 将`quality`设置为 MAIN_PUBLISHER 或者 VIDEO_CHAT。Obs 的推流端积压比较严重，是无法达到低延时效果的。
