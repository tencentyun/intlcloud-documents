## 準備作業
1. [VOD](https://intl.cloud.tencent.com/product/vod)関連サービスを有効にします。未登録のユーザーはアカウントを登録し、[無料試用](https://cloud.tencent.com/login)できます。
...
[_txVodPlayer setStartTime:startTimeInMS];  // 再生開始時間を設定します
[_txVodPlayer startPlay:url];
```
