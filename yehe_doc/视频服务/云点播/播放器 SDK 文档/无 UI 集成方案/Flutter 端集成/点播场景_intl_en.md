...
- **Supported protocols**
  ...
  ![](![img](https://qcloudimg.tencent-cloud.cn/raw/5143d2e31ddbdcb77294fa72b045abb2.jpeg)
...
Download and integrate the SDK ZIP file as instructed in [Integration Guide](https://www.tencentcloud.com/document/product/266/51192).
...
### Step 3. Create a controller[](id:step2)

```dart
TXVodPlayerController _controller = TXVodPlayerController();
```

### Step 4. Configure event listening[](id:step3)
...
### Step 6. Initialize the player[](id:step5)
...
### Step 7. Start the playback[](id:step6)
<dx-tabs>
::: Through the URL
...
### Step 8. Stop the playback[](id:step7)
...
### 12. Enabling smooth bitrate switching
...
Before calling `statPlay`, you can call `setConfig` to configure the player parameters, such as player connection timeout period, progress callback interval, and maximum number of cached files. `TXVodPlayConfig` allows you to configure detailed parameters. For more information, see [Basic Configuration API](https://www.tencentcloud.com/document/product/266/49591). Below is the configuration sample code:
