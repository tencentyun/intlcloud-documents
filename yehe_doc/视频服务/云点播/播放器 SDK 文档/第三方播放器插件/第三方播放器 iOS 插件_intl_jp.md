サードパーティプレーヤーのiOSプラグインはサードパーティプレーヤーまたは自社開発プレーヤーを使用して開発されたクラウドPaaSリソースに接続を希望する顧客向けにVODのためのプレーヤープラグインを提供します。カスタムプレーヤー機能を必要とするユーザーにおいて一般的に使用されます。


## SDKのダウンロード
サードパーティプレーヤー のiOSプラグインとDemoプロジェクトについては、 [TXCPlayerAdapterSDK_iOS](https://mediacloud-76607.gzc.vod.tencent-cloud.com/TXCPlayerAdapter/Release/1.2.0/TXCPlayerAdapterSDK_1.2.0_iOS.zip)をご参照ください。 
