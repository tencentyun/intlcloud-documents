...
阅读之前，请先确保已经学习超级播放器指引的 [阶段1：用超级播放器播放视频](https://intl.cloud.tencent.com/document/product/266/38098) 篇部分，了解云点播 fileid 的概念。
...
<dx-tabs>
::: Web 端
用户需要集成视立方超级播放器请参见 [集成指引](https://intl.cloud.tencent.com/document/product/266/33976)，引入播放器 SDK 文件之后，可以**媒资管理**提取上传媒资的 appId 和 fileId 进行播放。
...
:::
::: iOS 端
用户需要集成视立方超级播放器请参见 [集成指引](https://intl.cloud.tencent.com/document/product/266/33976)，集成完后，可以**媒资管理**提取上传媒资的 appId 和 fileId 进行播放。
...
:::
::: Android 端
集成视立方超级播放器请参考[集成指引](https://intl.cloud.tencent.com/document/product/266/33975) ，集成完后，可以**媒资管理**提取上传媒资的 appId 和 fileId 进行播放。
