...
본 문서에서는 다음을 포함하여 Superplayer가 재생하는 비디오의 콘텐츠와 스타일을 사용자 정의하는 방법을 설명합니다.
...
<td>서브스트림1</td>
<td>512kbps</td>
<td> 비디오 긴 면: 공란, 비디오 짧은 면: 480px</td>
<td>24fps</td>
<td>48kbps</td>
<td>듀얼 사운드 채널</td>
</tr>
...
<td>서브스트림2</td>
<td>512kbps</td>
<td> 비디오 긴 면: 공란, 비디오 짧은 면: 720px</td>
<td>24fps</td>
<td>48kbps</td>
<td>듀얼 사운드 채널</td>
</tr>
...
<td>서브스트림3</td>
<td>1024kbps</td>
<td> 비디오 긴 면: 공란, 비디오 짧은 면: 1080px</td>
<td>24fps</td>
<td>48kbps</td>
<td>듀얼 사운드 채널</td>
</tr>
...
3. [생성]을 클릭합니다. 3개의 서브스트림을 포함하는 어댑티브 비트 레이트 스트리밍 템플릿이 생성되고 템플릿 ID는 1145464가 됩니다.
 ...
 * [기본 정보] 탭에서 생성된 썸네일 및 출력 어댑티브 비트스트림(템플릿 ID: 1145464)을 볼 수 있습니다.
 * [스크린샷 정보] 탭에서 생성된 이미지 스프라이트(템플릿 ID: 113272)를 볼 수 있습니다.

## 4단계: Superplayer 구성 생성

사용자 정의 어댑티브 비트스트림 및 이미지 스프라이트를 재생하려면 사용자 정의 플레이어 구성을 사용해야 합니다.

1. VOD 콘솔에 로그인하고 [배포 및 재생 설정]>[[Superplayer 구성]](https://console.cloud.tencent.com/vod/distribute-play/super-player)을 선택하고 [생성]을 클릭합니다.
2. Superplayer 구성 페이지에서 [어댑티브 비트 레이트 스트리밍 템플릿 추가]와 [이미지 스프라이트 템플릿을 추가]를 클릭합니다.
 * [템플릿 이름]: MyTestCfg.
 * ‘어댑티브 비트 레이트 스트리밍 템플릿/ID’에 대해 MyTestTemplate(1145464)을 선택합니다.
 * ‘스크린샷 템플릿’으로 MyTestTemplate을 선택합니다.
<img src="https://main.qcloudimg.com/raw/2459be6bd365e9a5143146d88d44a43c.png" width="400" />
3. [확인]을 클릭하여 Superplayer 구성 MyTestCfg를 생성합니다.

##   5단계: 비디오 재생 미리보기

이전 단계에서 비디오를 처리했습니다. 이제 Web, iOS 및 Android용 Superplayer를 사용하여 비디오 재생을 빠르게 미리 볼 수 있습니다.

1. [[비디오 관리]](https://console.cloud.tencent.com/vod/media)에서 ‘업로드됨’ 탭을 선택하고 이전 단계에서 업로드 및 처리된 비디오를 찾은 다음 ‘작업’ 열에서 [관리]를 클릭하고 ‘Superplayer 미리보기’ 탭을 선택합니다.
...
링크 도용 방지가 활성화된 후 Superplayer는 비디오를 재생하기 위해 유효 기간 내에 서명이 필요합니다. 서명 툴을 사용하여 아래와 같이 서명을 빠르게 생성할 수 있습니다.
 ...
 * [Superplayer 구성]: 사용자 정의 Superplayer 구성 이름(여기서는 MyTestCfg)입니다.
