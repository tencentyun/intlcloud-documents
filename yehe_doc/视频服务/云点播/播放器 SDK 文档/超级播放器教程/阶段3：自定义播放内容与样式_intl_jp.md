...
1. VODコンソールにログインし、【ビデオ処理設定】>[【タスクフロー設定】](https://console.cloud.tencent.com/vod/video-process/taskflow)と選択して、【タスクフローの作成】：【タスクフローのの名称】をクリックして、MyTestProcedureを記入します。
 * 【タスクタイプの設定】：【アダプティブビットレートストリーミング】、【スクリーンショット】と【カバーのトリミング】にチェックを入れ、【アダプティブビットレートストリーミングタスクの設定】のオプションカードで、【アダプティブビットレートストリーミングテンプレートの追加】をクリックし、「アダプティブビットレートストリーミングテンプレート/ID」欄で、**手順1**で作成したアダプティブビットレートストリームのカスタマイズテンプレートMyTestTemplate（「アダプティブビットレートストリーミングテンプレート/ID」欄で、**手順1**で作成したアダプティブビットレートストリームのカスタマイズテンプレートMyTestTemplate(126866)を選択します。）を選択します。
 ...
 * 【再生に使用するスプライトイメージ】のオプションカードの「スクリーンキャプチャテンプレート」欄は、MyTestTemplateを選択します。
...
防犯リンクを有効にした後、ビデオを再生できるようにするためには、Super playerで有効期間内の署名を使用する必要があります。以下、署名ツールを使用して素早く署名を生成する方法を紹介します。
 ...
 * 【リンク期限切れ時間】：Keyリンク不正アクセス防止の期限切れ時間。6時間後の16進数Unix 時間：5ee09b44を入力します。
