...
4. In the **Transcoding Template** configuration item, click the drop-down list on the left to select **Select Transcoding Template**, and then click the drop-down list on the right to select **MP4-SD(20)** and **MP4-HD(30)** (multiple transcoding templates can be selected).
