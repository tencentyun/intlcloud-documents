...
## Prerequisites
 ...
 - You have added a **playback domain name**. For more information, please see [Adding Domain Names](https://cloud.tencent.com/document/product/267/20381).
...
- **AppName**: application name which is `live` by default. If you want to customize it, please [submit a ticket](https://console.cloud.tencent.com/workorder/category) for assistance.
