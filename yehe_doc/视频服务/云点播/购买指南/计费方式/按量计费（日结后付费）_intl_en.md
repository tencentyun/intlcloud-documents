...
Billable items:
- **Video storage**: the storage space taken up by the source video files uploaded to Tencent Cloud VOD and transcoded video files generated. This service is charged based on the storage space used and storage period.
