...
## 前提条件
- [注册](https://intl.cloud.tencent.com/register) 并 [登录](https://intl.cloud.tencent.com/login) 腾讯云账号，并且完成账号实名认证，未进行实名认证的用户无法购买中国大陆的直播时移实例。
...
- 目前时移功能内测暂不单独计费，但开启时移功能需要使用直播录制功能，会产生 [直播录制费用](https://intl.cloud.tencent.com/document/product/267/39605)、[点播存储费用和视频播放费用](https://intl.cloud.tencent.com/document/product/266/2838)。
...
2. 将录制模板关联到所需配置的推流域名，具体操作请参见 [录制配置](https://intl.cloud.tencent.com/document/product/267/34224)。
