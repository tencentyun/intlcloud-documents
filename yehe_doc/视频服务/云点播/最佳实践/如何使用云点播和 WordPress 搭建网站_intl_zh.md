...
除此之外，点播还提供访问控制、媒体处理和智能审核等能力，详情请参见云点播的 [功能概述](https://intl.cloud.tencent.com/document/product/266/49084)。

### 云点播的 WordPress 插件

云点播提供了 [WordPress 插件](https://wordpress.org/plugins/tencentcloud-vod/)，您只需安装该插件，并通过简单的配置关联您的 [云点播子应用](https://intl.cloud.tencent.com/document/product/266/33987)，即可将 WordPress 上的媒体文件托管到云点播上，并在您的网站中通过点播提供的 CDN 地址访问您的文件。该插件目前具有以下功能：
...
点播子应用可帮助您实现资源隔离，例如您可将不同站点的媒体文件划分到不同的子应用下，单独管理。创建方法详见 [开通子应用](https://intl.cloud.tencent.com/document/product/266/33987#.E5.BC.80.E9.80.9A.E5.AD.90.E5.BA.94.E7.94.A8)。

### 2. 搭建 WordPress 网站
您可以根据实际情况选择一种方案来搭建 WordPress 网站：
<dx-tabs>
::: 方案一（推荐）
使用腾讯云轻量应用服务器或云服务器的 WordPress 应用镜像快速建站。
:::
::: 方案二
...
![在线安装](https://qcloudimg.tencent-cloud.cn/raw/1dea0a047d5df7dc67eedb907dbaf586.png)
:::
::: 方式二
...
![手动安装](https://qcloudimg.tencent-cloud.cn/raw/3e16ee19f1dcf3a5734e67e293e72f2f.png)
:::
</dx-tabs>
...
单击 WordPress 左侧导航栏 腾讯云设置 > [云点播](https://intl.cloud.tencent.com/document/product/266/33897)，可对点播插件进行配置。
...
| 是否开启转自适应码流 | 开启后，会在上传时对视频进行转自适应码流。详情见点播 [自适应码流](https://intl.cloud.tencent.com/document/product/266/49258)。 |
