...
After logging in to the VOD console, a user (e.g., appid: `125xxx655`) will see the following two domain names in **[Domain Management](https://console.cloud.tencent.com/vod/distribute-play/domain)**:
