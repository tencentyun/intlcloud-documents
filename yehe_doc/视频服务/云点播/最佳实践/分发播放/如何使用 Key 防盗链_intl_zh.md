...
### Demo 功能介绍
本 Demo 向开发者展示云点播（VOD）[Key 防盗链](https://intl.cloud.tencent.com/document/product/266/33986)  机制的使用方法，包括在控制台启用 Key 防盗链、搭建一个防盗链签名派发服务、以及使用防盗链签名播放视频。
...
2. 调用`parse_conf_file()`，从`config.json`文件中读取配置信息。配置项说明如下（详细参数请参见 [Key 防盗链签名参数](https://intl.cloud.tencent.com/document/product/266/33986#.E9.98.B2.E7.9B.97.E9.93.BE-url-.E7.94.9F.E6.88.90.E6.96.B9.E5.BC.8F)）：
<table>
<thead>
<tr>
<th>字段</th>
...
```
4. 调用`generate_sign()`计算防盗链签名，详细算法请参见 [Key 防盗链签名](https://intl.cloud.tencent.com/document/product/266/33986#.E9.98.B2.E7.9B.97.E9.93.BE-url-.E7.94.9F.E6.88.90.E6.96.B9.E5.BC.8F)。
...
```
6. 返回签名。返回的数据格式及含义请参见 [云函数集成响应](https://intl.cloud.tencent.com/document/product/583/12513)。
```
       return {
