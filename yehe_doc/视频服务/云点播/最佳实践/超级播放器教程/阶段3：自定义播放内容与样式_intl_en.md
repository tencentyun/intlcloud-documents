...
1. Log in to the VOD Console, select **Video Processing Settings** > **[Task Flow Settings](https://console.cloud.tencent.com/vod/video-process/taskflow)**, and click **Create Task Flow**:
