## SDK 接入
SDK 的下载、接入、鉴权、跑通 Demo 请参见 [独立集成腾讯特效](https://intl.cloud.tencent.com/document/product/1143/45385)。
...
```
Avatar 素材与普通的动效素材的加载方式是类似的，loadAvatar 接口与 SDK 的 updateProperty 接口是等价的，因此请参考 [updateProperty 接口说明和 Demo 代码](https://intl.cloud.tencent.com/document/product/1143/45399)。
