...
2. 参考 [独立集成腾讯特效](https://intl.cloud.tencent.com/document/product/1143/45385) 文档完成集成。
...
1. **设置 License**，请参见 [鉴权](https://intl.cloud.tencent.com/document/product/1143/45385#.E6.AD.A5.E9.AA.A4.E4.B8.80.EF.BC.9A.E9.89.B4.E6.9D.83) 。
...
>? 完整的示例代码请参考 [美颜特效 SDK demo 工程](https://intl.cloud.tencent.com/document/product/1143/45374)。
