由于 Avatar 是腾讯特效的部分功能，所以需要先集成腾讯美颜特效 SDK，再加载 Avatar 素材即可。若未接入腾讯美颜特效 SDK，可参考 [ 独立集成腾讯特效 >](https://intl.cloud.tencent.com/document/product/1143/45384) 进行了解与集成。
...
>? 接口说明请参见 [Avatar SDK 说明](https://www.tencentcloud.com/document/product/1143/51287)。
