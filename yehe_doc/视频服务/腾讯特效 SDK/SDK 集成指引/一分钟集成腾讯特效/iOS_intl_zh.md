...
5. **添加美颜资源到实际项目工程中**
下载并解压对应套餐的 [SDK 和美颜资源](https://www.tencentcloud.com/document/product/1143/45377)，将 **resources** 文件夹下的除 **LightCore.bundle**、**Light3DPlugin.bundle**、**LightBodyPlugin.bundle**、**LightHandPlugin.bundle**、**LightSegmentPlugin.bundle** 以外的**其它 bundle 资源**添加到实际工程中。
6. 将 Bundle Identifier 修改成与申请的测试授权一致。
:::
::: 下载 SDK 并手动导入
1. 下载并解压 [SDK 和美颜资源](https://www.tencentcloud.com/document/product/1143/45377)，frameworks 文件夹里面是sdk、resources 文件夹里面是美颜的bundle资源。
...
我们建议您复用 Demo 的下载逻辑，当然，也可以使用您已有的下载服务。动态下载的详细指引，请参见 [SDK 包体瘦身（iOS）](https://www.tencentcloud.com/document/product/1143/48644)。
:::
</dx-tabs>
