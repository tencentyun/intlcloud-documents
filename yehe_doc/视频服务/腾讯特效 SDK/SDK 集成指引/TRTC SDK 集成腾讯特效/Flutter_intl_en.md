...
1. [Download](https://intl.cloud.tencent.com/document/product/1143/45377) the corresponding SDK for the package you purchased.
...
Add your resource file to the corresponding folder as described in step 1. For example, to add a 2D animated effect, do the following:
	1. Put the resource in `android/xmagic/src.mian/assets/MotionRes/2dMotionRes` of your project.
...
For example, to delete lipstick effects, delete the code below from `getBeautyData` of `BeautyPropertyProducerAndroid` and `BeautyPropertyProducerIOS`.
