[](id:step1)
## 步骤一：解压 Demo 工程
1. 下载集成了腾讯特效 TE 的 [UGSV Demo](https://intl.cloud.tencent.com/document/product/1143/45374) 工程。本 Demo 基于腾讯特效 SDK S1-04 套餐构建。
...
```
替换为您购买的 [套餐依赖包](https://intl.cloud.tencent.com/document/product/1143/45385)。
   - 如果您的套餐包含动效和滤镜功能，那么需要在腾讯特效 [SDK 下载页面](https://intl.cloud.tencent.com/document/product/1143/45377) 下载对应的资源，将动效和滤镜素材放置在 `xmagickit module` 下的如下目录：
	- 动效：`../assets/MotionRes`
	- 滤镜：`../assets/lut`
...
1. **授权：**
```java
 //鉴权注意事项及错误码详情，请参考 https://intl.cloud.tencent.com/document/product/1143/45385#.E6.AD.A5.E9.AA.A4.E4.B8.80.EF.BC.9A.E9.89.B4.E6.9D.83
