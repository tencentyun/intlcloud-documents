...
我们建议您复用 Demo 的下载逻辑，当然，也可以使用您已有的下载服务。动态下载的详细指引，请参见 [SDK 包体瘦身（Android）](https://www.tencentcloud.com/document/product/1143/47831)。
:::
</dx-tabs>
...
- **返回**
 错误码含义请参见 [API 文档](https://intl.cloud.tencent.com/document/product/1143/45399)。
