...
購入したパッケージに応じて[SDKのダウンロード](https://intl.cloud.tencent.com/document/product/1143/45377)を行い、ファイルをご自身のプロジェクトに追加します。
<dx-tabs>
::: Android
...
- **美顔リソースの追加**：
	1. ステップ1の方法に従ってリソースファイルを対応するリソースフォルダ内に追加します。例えば、2D動的エフェクトのリソースを追加したい場合は、リソースをプロジェクトの`android/xmagic/src.mian/assets/MotionRes/2dMotionRes`ディレクトリ下に置く必要があります。
