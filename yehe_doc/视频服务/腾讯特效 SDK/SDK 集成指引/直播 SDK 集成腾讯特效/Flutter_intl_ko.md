...
구매한 패키지에 해당하는 SDK를 [다운로드](https://intl.cloud.tencent.com/document/product/1143/45377)하고 자신의 프로젝트에 리소스 파일을 추가합니다.
<dx-tabs>
::: Android
...
```
**[문서](https://intl.cloud.tencent.com/document/product/1143/45385)에서 다양한 패키지의 maven 주소를 찾을 수 있습니다.**
2. app에서 src/main/assets 폴더를 찾습니다(이 폴더가 없으면 새로 생성). MotionRes 폴더가 있는지 확인합니다. `../src/main/assets`에 복사합니다.
...
- **뷰티 필터 리소스 추가**:
	1. 1단계에서 설명한 대로 해당 폴더에 리소스 파일을 추가합니다. 예를 들어 2D 애니메이션 효과를 추가하려면 프로젝트의 `android/xmagic/src.mian/assets/MotionRes/2dMotionRes`에 리소스를 넣어야 합니다.
...
- **뷰티 필터 리소스 삭제**:
귀하의 License는 패널에서 삭제할 수 있는 일부 뷰티 필터 또는 신체 보정 효과를 지원하지 않을 수 있습니다. 예를 들어 립스틱 효과를 삭제하려면 다음을 수행합니다.
