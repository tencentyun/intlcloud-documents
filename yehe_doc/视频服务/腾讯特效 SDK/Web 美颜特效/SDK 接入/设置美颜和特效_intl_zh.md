SDK 内置提供**美颜**、**滤镜**、**特效**几类效果，均支持 Web 端；其中滤镜和特效需要先获取到素材列表再通过素材的 EffectId 在 SDK 中设置。
...
## 特效
您可以直接在 SDK 中设置您在 [控制台](https://console.cloud.tencent.com/vcube/creator) 上制作的特效，也可以使用我们提供的内置效果。
