**The Tencent Effect SDK offers various beauty filters and effects. You can apply for a trial license (valid for 28 days) for free to try out the SDK.**

[](id:test)
## Trial Licenses for Mobile Applications
...
The Tencent Effect package offered for trial is the full-featured [package S1 - 04](https://intl.cloud.tencent.com/document/product/1143/45376). You can also choose specific features of the Tencent Effect SDK to try. Note that package S1 - 04 includes X1-01 keying, but does not offer other keying features.

>! **You need to pass our review before you are issued a Tencent Effect license**. A trial license becomes valid the moment you pass our review. If you renew the trial license after the first 14 days, the new expiration time of the license will be 14 days from the time of renewal.
...
2. Select the capabilities to try (**Advanced S1 - 04**, **Capability X1-01**, and **Capability X1-02**). Enter your **company name**, select your **industry**, upload your company’s **business license**, and then click **Create**. 
<img src="https://qcloudimg.tencent-cloud.cn/raw/7ee87ffbd3015d1ed31176bc48133595.png" style="zoom:67%;" />
:::
</dx-tabs>
