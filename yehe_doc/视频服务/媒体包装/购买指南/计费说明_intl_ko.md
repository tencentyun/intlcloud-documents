...
<tbody>
	...
	<tr>
		<td>패키징</td>
		<td>StreamPackage를 사용하여 라이브 스트림을 패키징하면 패키징된 스트림의 트래픽량을 기반으로 하는 패키징 요금이 발생합니다.</td>
		<td>후불-일 결산</td>
	</tr>	
</tbody>
</table>
...
#### 과금 예시
2022년 12월 01일에 StreamPackage의 싱가포르 서비스를 사용하여 1.8T의 라이브 스트림을 제공했다고 가정할 때, 아웃바운드 트래픽 요금은 다음과 같습니다.
...
#### 과금 예시
2022년 12월 01일에 StreamPackage의 싱가포르 서비스를 사용하여 1.8T의 라이브 스트림을 수신했다고 가정할 때, 인바운드 트래픽 요금은 다음과 같습니다.
