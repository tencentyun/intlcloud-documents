阅读本文之前，希望您已经了解应用云渲染的 [基本概念](https://intl.cloud.tencent.com/document/product/1158/49600)。

## 前提条件
在购买应用云渲染并发前，您需要完成以下工作：
1. 注册 [腾讯云账号](https://intl.cloud.tencent.com/register?s_url=https%3A%2F%2Fcloud.tencent.com%2F)。
2. 提交 [应用云渲染接入申请](https://intl.cloud.tencent.com/apply/p/ombzi6237bn)。
