## 云渲染技术说明
云渲染服务指您的应用客户端（UE、Unity等应用）运行在云端机器上，用户通过视频流的方式访问云上应用。在阅读快速入门前希望您已经了解云渲染的 [基本技术概念](https://intl.cloud.tencent.com/document/product/1158/49611)。
...
### 步骤1：注册腾讯云账号
若您未注册腾讯云账号，请前往 [注册腾讯云账号](https://intl.cloud.tencent.com/register?s_url=https%3A%2F%2Fcloud.tencent.com%2F)。

[](id:step2)
### 步骤2：申请应用云渲染服务
[申请应用云渲染服务](https://intl.cloud.tencent.com/apply/p/ombzi6237bn) 后，即可进入控制台。

[](id:step3)
### 步骤3：控制台操作
在控制台中，建议您按照 [上传应用](https://intl.cloud.tencent.com/document/product/1158/49618)、[新建项目](https://intl.cloud.tencent.com/document/product/1158/49622)、[购买并发](https://intl.cloud.tencent.com/document/product/1158/49625) 的顺序操作，最终您将得到一个关联某款应用，并且分配有可用并发的项目，项目 ID 是您调度云渲染服务的唯一 ID。

[](id:step4)
### 步骤4：接入云渲染 PaaS
应用云渲染 PaaS 提供 [云 API](https://intl.cloud.tencent.com/document/product/1158/49958) 和各终端SDK（[JS SDK](https://intl.cloud.tencent.com/document/product/1158/49627)、[Android SDK](https://intl.cloud.tencent.com/document/product/1158/49628)、[iOS SDK](https://intl.cloud.tencent.com/document/product/1158/49629)），所以需要进行后台以及前端开发两部分工作
...
您的后台服务调用云渲染 API [CreateSession(ClientSession)](https://intl.cloud.tencent.com/document/product/1158/49968) ，获取成功回调中的 ServerSession 返回给客户端。
4. **启动云渲染服务**：
