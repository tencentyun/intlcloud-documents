...
3. The business backend calls the [ApplyConcurrent()](https://intl.cloud.tencent.com/document/product/1158/49969) API through the TencentCloud API to apply to reserve a concurrency. If there are no available concurrencies or an error is returned, go back to [step 2](#step2) to send a request again.
