You can download the detailed logs of user access to your connected domain name for the last 40 days for analysis, which are recorded hourly.
...
The corresponding fields (from left to right) and their description in a log are as shown below:
...
At present, ECDN outside China are in beta. If you have enabled it, you can submit a ticket to apply for the log service.
