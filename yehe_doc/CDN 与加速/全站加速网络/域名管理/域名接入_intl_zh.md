...
>
>- 新增的中国境内/全球加速域名必须通过 [工信部域名备案](http://beian.miit.gov.cn/) 或接入 [腾讯云网站备案](https://intl.cloud.tencent.com/product/icp?from=qcloudProductBa)，且未已接入腾讯云 CDN 或 腾讯云 ECDN，已接入 CDN 的域名需下线删除后，才能添加到 ECDN 平台。
...
###  4. 缓存配置
针对域名内的动静态内容进行缓存配置，可默认使用推荐配置，或单击【编辑缓存规则】在此基础上自主编辑。
