Tencent Cloud ECDN integrates static edge cache and dynamic origin-pull route optimization. Through Tencent's global nodes, ECDN can solve the slow response, packet loss, service instability caused by cross-border and cross-ISP data transfer.
To configure ECDN, you must sign up for a Tencent Cloud account, activate ECDN, add a domain name, and configure CNAME. The steps are detailed in this document.
...
ECDN caches the static resources on the origin server to the cache node by acceleration domain name, and quickly pulls the dynamic content from the origin server through intelligent routing optimization, protocol optimization and other dynamic acceleration technologies to achieve resource access acceleration. For more information, please see <a href="https://intl.cloud.tencent.com/document/product/570/10361" hotrep="document.guide.3149.linkdomain">Domain Name Connection</a>
