...
>!
>1. 현재 중국 내(홍콩, 마카오, 대만 제외)에서만 지원됩니다. 자체 인증서가 설정되지 않았고, [이미지 최적화](https://cloud.tencent.com/document/product/228/43121) 기능이 비활성화된 도메인에 대해 버전 관리를 활성화할 수 있습니다.
>2. 각 환경에서 한 번에 하나의 버전만 배포할 수 있도록 지원합니다.
>3. URL 퍼지 기능은 생성 환경과 시뮬레이션 환경에 동시 적용됩니다. 디렉터리 퍼지 및 URL 프리패치 기능은 생성 환경에만 적용됩니다. 퍼지와 프리패치 기능 소개는 [퍼지와 프리패치](https://intl.cloud.tencent.com/document/product/228/6299)를 참고하십시오.
>4. [대역폭 상한 설정](https://intl.cloud.tencent.com/document/product/228/7541) 등 데이터/사용량 모니터링 기능은 현재 생성 환경에서만 적용됩니다.
