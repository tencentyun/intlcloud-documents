...
| Disabling Chinese mainland access port as needed   | Supports disabling the access ports 80, 8080, and 443 as needed.        | August 13, 2020 | [Chinese Mainland Access Port Configuration](https://intl.cloud.tencent.com/document/product/228/39879) |
...
| Update | Description | Release Date | Documentation |
| ----------------------------- | --------------------------------------------- | ---------- | ------------------------------------------------------------ |
| Global CDN <br>The cache purge feature is merged | The cache purge feature in the Chinese mainland and overseas CDN console has been merged. | November 14, 2019 | [Purge Cache](https://intl.cloud.tencent.com/document/product/228/6299) |
