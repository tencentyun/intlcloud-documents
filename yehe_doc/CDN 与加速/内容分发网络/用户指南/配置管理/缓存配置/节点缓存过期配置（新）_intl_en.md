...
When adding an acceleration domain name, default node cache validity rules are added based on different acceleration business types, you can modify them as needed.
...
>! If there is any legacy node cache validity configuration (i.e., the basic mode), it will be upgraded comprehensively once submitted as the advanced mode and can no longer be restored to the basic mode.
### Modifying Rules
