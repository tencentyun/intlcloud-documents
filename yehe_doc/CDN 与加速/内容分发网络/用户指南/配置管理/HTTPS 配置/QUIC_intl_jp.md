...
Tencent Cloud CDNは、QUICベータ版テストをすでに有効化しています。[申請書を提出](https://intl.cloud.tencent.com/apply/p/g0lwu71z0i7)してテスト運用を申請することが可能です。申請をすでにご提出いただいている場合は、15営業日でお客様の申請を審査いたします。
...
QUICアクセスは付加価値サービスに属します。現在Tencent Cloud CDNではベータ版テストを無償で提供していますので，料金はかかりません。
