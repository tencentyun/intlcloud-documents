...
> ! 中国境内与中国境外加速服务分开独立计费，价格存在差异，具体计费策略 [单击查看](https://intl.cloud.tencent.com/document/product/228/2949)。
...
> - 若您的域名无法看到【修改】按钮，表示域名存在特殊配置，您可以 [联系我们](https://intl.cloud.tencent.com/contact-sales) 进行咨询。
...
>- 部分平台正在升级中或若域名存在特殊配置，暂不支持开启 IPv6 访问。
