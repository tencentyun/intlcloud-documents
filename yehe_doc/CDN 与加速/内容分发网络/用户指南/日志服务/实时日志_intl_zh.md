...
>目前 CDN 实时日志服务处在内测中，您可以 提交申请表申请试用。如果您已经提交申请，我们将在七个工作日内对您的申请进行审核。
...
+ 检索：支持全文检索、健值检索和模糊关键字检索。详细内容见 [检索语法](https://intl.cloud.tencent.com/document/product/614/30439)。
