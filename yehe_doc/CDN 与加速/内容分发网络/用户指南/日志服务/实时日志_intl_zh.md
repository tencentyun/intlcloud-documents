...
>? 目前 CDN 实时日志服务处在内测中，您需要先 [开通日志服务（Cloud Log Service）](https://console.cloud.tencent.com/cls)，再 [提交 CDN 实时日志申请表](https://intl.cloud.tencent.com/apply/p/f4gs2k0au1i) 申请试用。如果您已经提交申请，我们将在七个工作日内对您的申请进行审核。
## 适用场景
实时查看 / 分析用户访问情况。
