...
CDN offers two billing modes: bill by bandwidth and bill by traffic (default). Both modes are postpaid daily. During postpaid daily settlement, payment for total consumption generated between 00:00:00–23:59:59 on the current day will be deducted before 18:00 the next day. For more information on how to choose an appropriate billing mode, please see [Billing Instruction](https://intl.cloud.tencent.com/document/product/228/2949).
...
- If consumption has already occurred, you will be charged with the bill by bandwidth mode on the following day. You will be charged with the bill by traffic mode on the third day when calculating the consumption on the second day, unless you switch the billing mode again.
