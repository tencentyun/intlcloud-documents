예약 퍼지와 프리패치는 Tencent Cloud SCF를 통해 정해진 시간에 트리거할 퍼지/프리패치 작업을 설정합니다. 예약 퍼지와 프리패치 작업은 일일 퍼지/프리패치 할당액에 포함되며, 실행한 당일에 할당액을 초과하는 경우 작업이 실패할 수 있습니다.
...
예약 퍼지와 프리패치 기능은 무료지만, SCF 예약된 작업 생성을 호출하여 SCF 무료 체험 한도를 초과하면 SCF 요금이 발생할 수 있습니다. 자세한 내용은 [SCF 무료 한도](https://intl.cloud.tencent.com/document/product/583/12282)를 참조하십시오.
