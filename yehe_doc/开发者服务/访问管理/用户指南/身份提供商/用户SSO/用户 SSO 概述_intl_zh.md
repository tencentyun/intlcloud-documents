...
1. 将企业 IdP 配置到腾讯云。
	...
	- 具体配置操作：请参见 [腾讯云 SP 进行 SAML 配置](https://intl.cloud.tencent.com/document/product/598/42366)。
 
2. 在企业 IdP 中配置腾讯云为可信 SP 并进行 SAML 断言属性的配置。
	- 操作目的：为了建立企业 IdP 对腾讯云的信任。
	- 具体配置操作：请参见 [企业 IdP 进行 SAML 配置](https://intl.cloud.tencent.com/document/product/598/42367)。
 
3. 企业登录到 [CAM 控制台](https://console.cloud.tencent.com/cam) 或通过 API 调用创建与企业 IdP 中名称完全匹配的 CAM 子用户。
	- 操作目的：为了使用子用户进行后续登录操作。
	- 具体配置操作：请参见 [新建子用户](https://intl.cloud.tencent.com/document/product/598/13674)。
