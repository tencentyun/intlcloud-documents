...
## 前提条件
已安装 TCCLI，详情请参见 [安装 TCCLI](https://www.tencentcloud.com/document/product/1013/33464)。
...
- **region**： 云产品地域，请前往对应云产品的 [API 文档](https://www.tencentcloud.com/document/api/213) 获取可用的 region。例如云服务器的 [地域列表](https://www.tencentcloud.com/document/product/213/31574)。
...
## 其他配置
- TCCLI 支持通过 CAM 角色的方式进行认证，您可以参考 [角色概述](https://intl.cloud.tencent.com/document/product/598/19420) 查看相关信息。
```bash
...
该方式仅支持在已绑定角色的实例上使用，具体方式请参见 [管理实例角色](https://intl.cloud.tencent.com/document/product/213/45917)。
</dx-alert>
