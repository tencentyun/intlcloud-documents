...
```
<dx-alert infotype="explain" title="">
- `--cli-unfold-argument` 命令可通过 Tab 键进行补全，详情请参见 [使用命令行自动补全功能](https://www.tencentcloud.com/document/product/1013/52423)。
...
```
<dx-alert infotype="explain" title="">
- `--generate-cli-skeleton` 命令可通过 Tab 键进行补全，详情请参见  [使用命令行自动补全功能](https://www.tencentcloud.com/document/product/1013/52423)。
...
```
<dx-alert infotype="explain" title="">
- `--cli-input-json` 命令可通过 Tab 键进行补全，详情请参见 [使用命令行自动补全功能](https://www.tencentcloud.com/document/product/1013/52423)。
