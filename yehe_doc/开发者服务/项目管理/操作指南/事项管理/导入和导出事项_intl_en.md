...
![](https://qcloudimg.tencent-cloud.cn/raw/ee634a7e1f2b9122299955c7a755b292.png)

## Import Issues[](#import)

1. Select **Import Requirements** in the menu in the upper-right corner of the issue list page.
![](https://qcloudimg.tencent-cloud.cn/raw/cd9d56687b70374987637be084f99c4f.png)
2. Click **Download Template** and fill in the information as required as shown below.
![](https://qcloudimg.tencent-cloud.cn/raw/8a38fa620bd8fe0c045640255d25f731.pngg)
...
>!Issue fields are used to describe the current status, due date, assignee, priority, and other information of this issue. If required fields are preset in the project, this rule is ignored during the issue import; if default values are preset for the fields in the project, they are auto-filled during the issue import. For more information, see [Custom Issue Fields](https://intl.cloud.tencent.com/document/product/1133/44767).
4. Check the import result.
After the import is complete, you will be notified by a prompt message on the import page or system notification. If the import fails, download the error log as instructed, and import again after changes.
![](https://qcloudimg.tencent-cloud.cn/raw/ae8f326d9b56bc56ede49c85afcf7a64.png)
![](https://qcloudimg.tencent-cloud.cn/raw/b6226efd2612e2f0ae656c3e16b4ba40.png)
...
>
![](https://qcloudimg.tencent-cloud.cn/raw/83d56201d4f3a624b19c0754e57644bc.png)
2. After export, click **Download File** and check the export result.
![](https://qcloudimg.tencent-cloud.cn/raw/ed4f5d6e6ff1460a4bb23e22699da208.png)
