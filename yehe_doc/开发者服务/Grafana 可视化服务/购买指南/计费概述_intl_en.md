...
## Billing mode
TCMG provides the following billing mode:

| Billing Mode | Payment Mode | Billing Formula |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Monthly subscription | In the [prepaid billing](https://intl.cloud.tencent.com/document/product/555/42701) mode, you need to pay fees when creating an instance. | Total fees = instance price * purchase duration (months). For instance pricing, see [Monthly Subscription](https://intl.cloud.tencent.com/document/product/1124/49506). |
