...
>?在完成代码仓库初始化后，您可以使用 Git 命令来与本地仓库进行联动。详情请参见 [Git 常用命令](https://intl.cloud.tencent.com/document/product/1132/44728)。

### 创建 SVN 仓库[](id:svn)

CODING 支持创建 SVN 仓库。有关如何创建与使用 SVN 仓库，请参见 [SVN 仓库使用](https://intl.cloud.tencent.com/document/product/1132/44707)。
...
您可以将已有的 Git 仓库快速迁移至 CODING DevOps 平台。详情请参见 [导入或关联外部仓库](https://intl.cloud.tencent.com/document/product/1132/44699)。
