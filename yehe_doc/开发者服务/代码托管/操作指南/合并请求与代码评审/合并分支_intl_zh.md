...
在采用多分支开发工作流时，建议开发组长将主分支设置为 [保护分支](https://intl.cloud.tencent.com/document/product/1132/44715)，开发者创建临时开发分支，完成后向主分支发起合并请求。通过持续集成和代码评审后，开发者将开发分支合并至主分支。
...
>?通过 [设置合并请求](https://intl.cloud.tencent.com/document/product/1132/44718) 可指定合并请求的默认目标分支。
>
...
>? 如果合并请求的目标分支为 [保护分支](https://intl.cloud.tencent.com/document/product/1132/44715)，默认会自动添加分支管理员为评审者。如需更改设置，参见 [保护分支规则](https://intl.cloud.tencent.com/document/product/1132/44715)。
>
![](https://qcloudimg.tencent-cloud.cn/raw/38ba72a6c3d11fc3a12345c79bd6f948.png)
评审者在完成 [合并请求评审](https://intl.cloud.tencent.com/document/product/1132/44720) 之后，将会在该合并请求详情页面显示评审结果。
...
仅 [保护分支](https://intl.cloud.tencent.com/document/product/1132/44715) 支持开启状态检查。勾选之后，要求状态检查（CI 任务）全部运行通过后才允许合并。
...
>?如需了解如何修改默认分支与设置保护分支，参见 [设置默认分支](https://intl.cloud.tencent.com/document/product/1132/44714) 或 [设置保护分支](https://intl.cloud.tencent.com/document/product/1132/44715)。
...
>?通过 [设置合并请求](https://intl.cloud.tencent.com/document/product/1132/44718) 可实现合并请求默认删除源分支及默认以 Fast-Forward 模式合并。
