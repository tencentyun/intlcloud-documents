...
[](id:que4)
### Push 提示其他错误怎么办？
请参见代码托管 [快速入门](https://intl.cloud.tencent.com/document/product/1132/44685)，并确保您执行了正确的操作，如果仍然报错请发送邮件到我们的支持邮箱：<strong>support@coding.net</strong>，并提供我们以下信息，以便工程师为您解决问题：
- Git 报错信息。
- 执行 git --version 的结果。
...
- 若缺少 CODING_QCSRole 角色，需主账号登录 CODING DevOps 控制台，单击团队空间链接按照页面提示完成授权。
