...
持续集成在现代软件研发流程中，扮演了十分重要的角色。平时的工程中，总有一部分工作是相对机械化，易出错的（例如打包、部署），把这部分工作交给机器来做，我们仅需要轻轻地点一下鼠标，起身泡杯咖啡，让持续集成构建计划进行自动化的单元测试、代码检查、编译构建、契约测试，甚至自动部署，能够极大降低了开发人员的工作负担，减少了许多不必要的重复劳动，持续提升代码质量和开发效率。
