...
>?配额管理目前为白名单功能，如需使用请 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 申请开通。

## 前提条件
已完成标签的创建（参考 [创建标签](https://intl.cloud.tencent.com/document/product/651/41684)）。
