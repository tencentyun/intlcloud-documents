...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: StopLogging. |
...
|---------|---------|---------|
| IsSuccess | Integer | Whether disabling is successful. |
| RequestId | String | Unique ID of request. Each request returns a unique ID. The `RequestId` is required to troubleshoot issues. |

## 4. Samples

### Sample 1. Disabling a tracking set

This example shows you how to disable a tracking set.

#### Input sample code

```
https://cloudaudit.tencentcloudapi.com/?Action=StopLogging
&AuditName=xxxxx
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cloudaudit&Version=2019-03-19&Action=StopLogging)
