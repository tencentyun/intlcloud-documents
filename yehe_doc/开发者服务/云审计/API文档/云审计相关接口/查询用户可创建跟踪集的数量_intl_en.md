...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: InquireAuditCredit. |
...
|---------|---------|---------|
| AuditAmount | Integer | Number of tracking sets that can be created |
| RequestId | String | Unique ID of request. Each request returns a unique ID. The `RequestId` is required to troubleshoot issues. |

## 4. Samples

### Sample 1. Querying the maximum number of tracking sets that can be created

This example shows you how to query the maximum number of tracking sets that can be created.

#### Input sample code

```
https://cloudaudit.tencentcloudapi.com/?Action=InquireAuditCredit
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cloudaudit&Version=2019-03-19&Action=InquireAuditCredit)
