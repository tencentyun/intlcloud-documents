...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ListCosEnableRegion. |
...
|---------|---------|---------|
| EnableRegions | Array of [CosRegionInfo](https://intl.cloud.tencent.com/document/api/1021/34209#CosRegionInfo) | CloudAudit-enabled COS AZs |
| RequestId | String | Unique ID of request. Each request returns a unique ID. The `RequestId` is required to troubleshoot issues. |

## 4. Samples

### Sample 1. Querying CloudAudit-enabled COS AZs

This example shows you how to query CloudAudit-enabled COS AZs.
