...
Apdex quantifies the application performance in terms of response time based on sampled data for a period of time in the range of 0–1, indicating where the application performance falls in the user satisfaction range.
