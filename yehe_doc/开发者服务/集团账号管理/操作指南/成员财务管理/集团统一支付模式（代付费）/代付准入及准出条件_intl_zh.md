...
<table>
  ...
  <th><b>条件</b></th>
   ...
   <tr>
    ...
    <td>账号方面的校验：<br/>1、成员账号必须和集团账号是<b>同一个企业实名认证的主体</b>，均为国内站；<br/>2、代理商或代客不可以选择财务代付模式；<br/>3、经销商或子客不可以选项财务代付模式；</td>
   </tr>
   <tr>  
	...
	<tr>
	<td>优惠继承校验</td>
	<td><b>如果成员账号或代付账号本身已有优惠继承，则代付失败。</b>成员账号A 选择B 作为代付者，如果B 已经继承了C的优惠，或者A继承了D的优惠，均代付失败。</td>
	</tr>
	<tr>
</table>
