...
- 创建 [腾讯云容器服务—托管版集群](https://intl.cloud.tencent.com/document/product/457/30637)：在腾讯云容器服务中创建 Kubernetes 集群。
...
如果本地之前未配置过 Docker 镜像环境，可以参考 [镜像仓库基本教程](https://intl.cloud.tencent.com/document/product/457/9117) 进行配置，如果已经配置可以直接执行下一步。
