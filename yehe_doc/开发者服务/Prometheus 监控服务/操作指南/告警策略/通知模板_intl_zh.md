...
>?详情可参见 [访问权限](https://intl.cloud.tencent.com/document/product/248/36744) 进行子账号授权。
...
2. 单击**新建**，在“新建通知模板”填写信息。
	...
	- 通知类型：
	 ...
	 - 告警恢复：告警恢复时发送通知。
	- 用户通知：
	 - 接收对象：可选接收组或接收人，如需创建告警接收组请参考 [创建告警接收组](https://intl.cloud.tencent.com/zh/document/product/248)。
 	...
 	- 接口回调：填写公网可访问到的url作为回调接口地址，云监控将及时把告警信息推送到该地址，当 HTTP 返回 200为验证成功。告警回调字段说明请参考 [告警回调说明](https://intl.cloud.tencent.com/zh/document/product/248/38919)。
