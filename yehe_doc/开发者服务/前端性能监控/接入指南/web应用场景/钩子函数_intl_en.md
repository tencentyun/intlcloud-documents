...
In the above sample code, if the error content contains the <code>An error that doesn't need to be reported</code> keywords, it won't be reported to the RUM backend.
...
6. `payload`: complete resource request information provided to you (this field won't be reported to the Aegis backend and can be manipulated by you)  
