...
| 日志查询   | 包括历史日志、页面访问日志、自定义事件日志和离线日志查询。    | 
...
| 自定义事件 | 自定义上报，需参见 [接入指南](https://www.tencentcloud.com/document/product/1131/44517) 选择接入应用方式，进入**实例方法**说明文档 > 使用 **reportTime** 或 **time、timeEnd** 方式自定义埋点上报数据。 |              
| 自定义测速 | 自定义上报，参见 [接入指南](https://www.tencentcloud.com/document/product/1131/44517) 选择接入应用方式，进入**实例方法**说明文档 > 使用 **reportEvent** 方式自定义上报事件。 |       
...
- 单击上方的图例可取消或展示对应的数据。-![](https://qcloudimg.tencent-cloud.cn/raw/777c49ca905a01d5a5a451a5b79de832.png)
...
| Ext1 视图、Ext2 视图、Ext3 视图 | 自定义视图，由您自定义上报时传入参数。详情请参见 [接入指南](https://www.tencentcloud.com/document/product/1131/44517)。 |
