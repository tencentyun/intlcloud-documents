...
1. 下载监控组件。分腾讯云内网和外网]下载监控组件，建议您使用腾讯云内网下载。
   #### 腾讯云内网下载
...
```
 ...
 > !使用内网下载监控组件前，请 [登录 Linux 实例](https://intl.cloud.tencent.com/document/product/213/5436)  执行命令，并且确保云服务器为 [内网 DNS](https://intl.cloud.tencent.com/document/product/213/5225)，否则将无法解析监控组件的下载地址。
...
>?如需卸载监控组件请参考 [卸载云服务器监控组件](https://intl.cloud.tencent.com/document/product/248/39810)。
...
> !使用内网下载监控组件时，请 [登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/5435) 在内网浏览器中打开下载地址 ，并确保您的云服务器为 [内网 DNS](https://intl.cloud.tencent.com/document/product/213/5225)，否则将无法解析监控组件的下载地址。
...
>?如需卸载监控组件请参考  [卸载、重启云服务器监控组件](https://intl.cloud.tencent.com/document/product/248/39810)。

## 常见问题

- 在用户遇到无法下载 Agent 或其它使用方面问题，可参考 [云服务器监控组件相关](https://intl.cloud.tencent.com/document/product/248/2259) 常见问题文档进行相应的处理。
- 若无法登录云服务器实例，请参见 [云服务器实例无法登录](https://intl.cloud.tencent.com/document/product/248/36206) 寻求解决措施。
