...
<td>总和</td>
<td>按流量计费模式通过“外网出流量”指标进行计费，您可以通过该图表查看某段时间内云服务流量总和，计算相关费用。如下图 0.41MB 为当前时间段所使用的总流量，您可以根据 <a href = "https://intl.cloud.tencent.com/document/product/213/39743">按流量计费规则</a> 计算当前时间段所产生的带宽费用。</td>
</tr>
<tr>
<td>总趋势</td>
