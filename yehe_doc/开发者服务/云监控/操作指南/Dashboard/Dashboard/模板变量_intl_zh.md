...
4. 创建模板变量后可作为 Dashboard 和监控图表的快速选择器。
   - 在 Dashboard 使用：在 Dashboard 管理页中即可使用模板变量对 Dashboard 展示数据进行筛选。
     ![](https://main.qcloudimg.com/raw/646cb06d678dba84157f03898dc5ccac.png)
   - 在监控图表中使用：在图表编辑页，快速选择标签进行分组聚合展示实例数据。
     ![](https://main.qcloudimg.com/raw/e2ed36bbdb33d403dd9b6156dba68b60.png)
> ?如需编辑监控图表，请参见 [编辑指标]( https://intl.cloud.tencent.com/document/product/248/38477#.E7.BC.96.E8.BE.91.E6.8C.87.E6.A0.87 ) 。
