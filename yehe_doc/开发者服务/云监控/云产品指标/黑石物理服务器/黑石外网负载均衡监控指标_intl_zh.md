...
| Instances.N.Dimensions.1.Value | protoco          | 具体协议值                                | 输入协议值具体名称，例如：tcp                                |
...
| Instances.N.Dimensions.5.Value | vpcId            | 具体的负载均衡实例所属的私有网络整型 ID   | 输入负载均衡实例所属私有网络的具体整型 ID，例如：1，可通过 [查询私有网络列表](https://intl.cloud.tencent.com/document/product/215/15778) 返回的字段 vpcId 获得 |

## 入参说明

查询黑石外网负载均衡监控数据，入参取值如下：
