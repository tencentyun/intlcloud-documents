...
云服务器内网 DNS 配置错误会导致无法正常下载 Agent 和监控组件无法上报数据，腾讯云云服务器的内网 DNS 配置可参见 [内网服务](https://intl.cloud.tencent.com/document/product/213/5225) 文档。
...
请根据 [云服务器无监控数据](https://intl.cloud.tencent.com/document/product/248/36208) 指引进行处理。
