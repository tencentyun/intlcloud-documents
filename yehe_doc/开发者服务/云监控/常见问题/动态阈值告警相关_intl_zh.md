...
### 用户可配置动态阈值策略上限只能20个吗？
用户免费体验的告警策略数量上限为20，每个策略下创建的告警对象数量(或维度组合数)默认上限为20。体验使用后需要更多动态阈值监控额度，可以[提交工单](https://console.cloud.tencent.com/workorder/category)手进行购买调整。

### 动态阈值有哪些官方介绍资料？
**操作文档**
[《动态阈值简介》](https://intl.cloud.tencent.com/document/product/248/39021)
[《使用动态阈值》](https://intl.cloud.tencent.com/document/product/248/39022)
**最佳实践文档**
[《告警设置之动态阈值最佳实践》](https://intl.cloud.tencent.com/document/product/248/39443)
