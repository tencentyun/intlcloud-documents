...
该文档仅适用于 [DescribeStatisticData](https://intl.cloud.tencent.com/document/product/248/39481) 接口，下列所有指标必入参 `tke_cluster_instance_id` 和 `workload_name`  维度，选填维度中必须选一项入参。
