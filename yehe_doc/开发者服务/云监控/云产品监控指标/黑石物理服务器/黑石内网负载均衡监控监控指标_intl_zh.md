...
| Instances.N.Dimensions.5.Value | vpcId            | 负载均衡实例所属的私有网络具体整型 ID     | 输入负载均衡实例所属私有网络的具体整型 ID，例如：1，可通过 [查询私有网络列表](https://intl.cloud.tencent.com/document/product/215/15778) 返回的字段 vpcId 获得 |
