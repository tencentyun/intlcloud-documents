...
| API | 操作名 | 操作描述 |
|---------|---------|---------|
| [DescribeBaseMetrics](https://intl.cloud.tencent.com/document/product/248/33882) | 查询监控基础指标详情接口 | 查询对应的名字空间下面的监控指标类型 |
| [GetMonitorData](https://intl.cloud.tencent.com/document/product/248/33881) | 拉取指标监控数据 | 对象维度描述和监控指标获取相应的监控数据 |
...
通过 Demo 演示，为您介绍如何使用 [GetMonitorData](https://intl.cloud.tencent.com/document/product/248/33881) 接口查询 CVM 的 CPU 利用率。
...
4. 将 [准备好的云产品信息](#step2)，填入对应的【输入参数】配置项文本框。
 ...
 - **Dimensions.N-Value**：填入对应的 InstanceId 值（云服务器实例 ID），可通过云服务器 [查询实例列表接口](https://intl.cloud.tencent.com/document/product/213/33258) 获取实例对应的 ID，例如 ins—12345678。
