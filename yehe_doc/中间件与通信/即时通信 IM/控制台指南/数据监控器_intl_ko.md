...
IM 콘솔은 데이터 통계 및 분석 기능을 제공합니다.[IM 콘솔](https://console.cloud.tencent.com/im)에 로그인하여 대상 애플리케이션 카드를 클릭한 후 왼쪽 사이드바의 **통계 분석**을 선택하면 애플리케이션의 사용자 규모, 메시지 활성도, 그룹 규모, 실시간 모니터링 등 관련 데이터를 볼 수 있습니다.
...
1. 왼쪽 사이드바에서 **데이터 모니터링**>**실시간 모니터링**을 선택합니다.
