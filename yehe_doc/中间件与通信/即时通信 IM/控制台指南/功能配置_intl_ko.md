...
울티메이트 버전에서 멀티 플랫폼 로그인을 선택할 경우 Web의 동시 온라인 수는 최대 10개이며, Android, iPhone, iPad, Windows, Mac 플랫폼의 경우 동시 온라인 디바이스 수는 최대 3개입니다.
</dx-alert>
...
>?이 기능은 **울티메이트 버전 사용자만 사용할 수 있습니다**, 울티메이트 버전으로 업그레이드 후 사용하십시오. 기능의 정상적인 사용을 위해 **단말 SDK**를 **v5.8.0 이상**으로 업데이트하십시오.
