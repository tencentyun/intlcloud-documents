...
이 모듈은 인스턴트 메시징("**기능**")을 사용하는 경우 적용됩니다. 이 모듈은 https://intl.cloud.tencent.com/document/product/301/17347 에 있는 데이터 개인 정보 보호 및 보안 계약(“**DPSA**”)에 통합되어 있습니다. 이 모듈에서 사용되었지만 정의되지 않은 용어는 DPSA에 정의된 의미를 갖습니다. DPSA와 이 모듈 간에 충돌이 발생할 경우, 이 모듈은 상충하는 범위까지만 적용됩니다.
