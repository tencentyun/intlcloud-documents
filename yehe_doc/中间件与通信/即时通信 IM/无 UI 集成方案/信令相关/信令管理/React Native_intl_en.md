...
1. The teacher calls the [inviteInGroup](https://comm.qq.com/im/doc/RN/en/Api/V2TIMSignalingManager/invite.htmlInGroup) API to invite students to "raise hands", specifying the "hand raising" operation in the custom field `data`. The students receive the [onReceiveNewInvitation](https://comm.qq.com/im/doc/RN/en/Callback/OnReceiveNewInvitation.html) callback.
...
4. The teacher invites one of the students raising their hand to speak and calls the [inviteInGroup](https://comm.qq.com/im/doc/RN/en/Api/V2TIMSignalingManager/invite.htmlInGroup) API. Here, the custom field `data` is specified as "speaking". The students receive the [onReceiveNewInvitation](https://comm.qq.com/im/doc/RN/en/Callback/OnReceiveNewInvitation.html) callback.
