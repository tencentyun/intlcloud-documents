## Message Class
In the Tencent Cloud IM SDK, the message class is `Message` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.types.Message.html)), which will be frequently used for message sending and receiving.
