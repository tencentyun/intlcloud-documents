...
2. 调用 `createTargetedGroupMessage` ([TS](https://comm.qq.com/im/doc/RN/en/Api/V2TIMMessageManager/createTargetedGroupMessage.html)) 接口根据原始消息对象创建定向消息对象 `V2TimMessage`，并指定消息接收成员列表。
