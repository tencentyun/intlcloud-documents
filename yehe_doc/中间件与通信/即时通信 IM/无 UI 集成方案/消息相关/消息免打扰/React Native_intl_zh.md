...
通过调用 `setC2CReceiveMessageOpt`([Details](https://comm.qq.com/im/doc/RN/en/Api/V2TIMMessageManager/setC2CReceiveMessageOpt.html)) 接口，设置单聊的消息接收选项。
...
通过调用 `getC2CReceiveMessageOpt`([Details](https://comm.qq.com/im/doc/RN/en/Api/V2TIMMessageManager/getC2CReceiveMessageOpt.html)) 接口，获取单聊的消息接收选项。
...
通过调用 `setGroupReceiveMessageOpt`([Details](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/setGroupReceiveMessageOpt.html)) 接口，设置群聊的消息接收选项。
...
通过调用 `getGroupsInfo`([Details](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/setGroupReceiveMessageOpt.html)) 接口，获得群资料 `V2TIMGroupInfo` 对象列表，对象的 recvOpt 字段表示群组的消息接收选项。
