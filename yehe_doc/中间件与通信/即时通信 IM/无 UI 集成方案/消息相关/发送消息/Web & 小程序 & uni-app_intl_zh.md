...
创建可以附带 @ 提醒功能的文本消息的接口，此接口返回一个消息实例，可以在需要发送文本消息时调用 [发送消息](https://web.sdk.qcloud.com/im/doc/en//SDK.html#sendMessage) 接口发送消息实例。
...
创建音频消息实例的接口，此接口返回一个消息实例，可以在需要发送音频消息时调用 [发送消息](https://web.sdk.qcloud.com/im/doc/en//SDK.html#sendMessage) 接口发送消息。 
...
>!
>- v2.6.0起支持在 Web 环境使用。
>- v2.17.0起 SDK 支持视频封面 [snapshotUrl](https://web.sdk.qcloud.com/im/doc/en/Message.html#.VideoPayload)，需要使用 [tim-upload-plugin](https://www.npmjs.com/package/tim-upload-plugin) 作为上传插件。
...
创建自定义消息实例的接口，此接口返回一个消息实例，可以在需要发送自定义消息时调用 [发送消息](https://web.sdk.qcloud.com/im/doc/en//SDK.html#sendMessage) 接口发送消息实例。当 SDK 提供的能力不能满足您的需求时，可以使用自定义消息进行个性化定制。
...
创建地理位置消息的接口，此接口返回一个消息实例，可以在需要发送地理位置消息时调用 [发送消息](https://web.sdk.qcloud.com/im/doc/en//SDK.html#sendMessage) 接口发送消息。
...
创建合并消息的接口，此接口返回一个消息实例，可以在需要发送合并消息时调用 [发送消息](https://web.sdk.qcloud.com/im/doc/en//SDK.html#sendMessage) 接口发送消息。
...
如果您需要转发单条消息，可以先通过 [createForwardMessage](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createForwardMessage) 接口创建一条和原消息内容完全一样的转发消息，再调用 [sendMessage](https://web.sdk.qcloud.com/im/doc/en/SDK.html#sendMessage) 接口把转发消息发送出去。
...
- [创建 @ 消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createTextAtMessage)
...
- [创建表情消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createFaceMessage)
- [创建文件消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createFileMessage)
- [创建地理位置消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createLocationMessage)
- [创建合并消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createMergerMessage)
- [创建转发消息](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createForwardMessage)
