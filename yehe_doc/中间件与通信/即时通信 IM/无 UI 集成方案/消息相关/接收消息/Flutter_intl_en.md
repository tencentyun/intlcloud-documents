...
#### Removing a listener
To stop receiving messages, the receiver can call `removeAdvancedMsgListener` ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Api/V2TIMMessageManager/removeAdvancedMsgListener.html)) to remove the advanced message listener.
...
2. Listen for the `onRecvNewMessage` callback ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Callback/OnRecvNewMessageCallback.html)) to receive text messages.
...
1. Call `addAdvancedMsgListener` to set the event listener.
2. Listen for the `onRecvNewMessage` callback ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Callback/OnRecvNewMessageCallback.html)) to receive custom messages.
3. To stop receiving messages, call `removeAdvancedMsgListener` to remove the listener. This step is optional and can be performed as needed.
...
2. Listen for the `onRecvNewMessage` callback ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Callback/OnRecvNewMessageCallback.html)) to receive the `V2TimMessage` message.
...
The SDK provides a passthrough channel only for emoji messages. For message content fields, see the definition of `faceElem` ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Class/Message/V2TimFaceElem.html)). Here, `index` and `data` can be customized.
...
There are many types of group tip messages. For more information, see the definition of `V2TIMGroupTipsType` ([Details](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Class/Group/V2TimGroupTipsElem.html)).
