...
您可以调用 `MsgClearHistoryMessage` ([Details](https://comm.qq.com/im/doc/unity/en/api/MessageApi/MsgClearHistoryMessage.html)) 清空单聊消息。
...
您可以调用 `MsgClearHistoryMessage` ([Details](https://comm.qq.com/im/doc/unity/en/api/MessageApi/MsgClearHistoryMessage.html)) 清空群聊消息。
