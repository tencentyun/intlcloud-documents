...
您可以调用 `MsgClearHistoryMessage` ([c#](https://comm.qq.com/im/doc/unity/en/api/MessageApi/MsgClearHistoryMessage.html)) 清空单聊消息。
...
您可以调用 `MsgClearHistoryMessage` ([c#](https://comm.qq.com/im/doc/unity/en/api/MessageApi/MsgClearHistoryMessage.html)) 清空群聊消息。
