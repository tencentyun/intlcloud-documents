...
>! v2.19.1 起支持，该接口仅适用于获取支持话题的社群，需 [购买旗舰版](hhttps://www.tencentcloud.com/document/product/1047/34577) 并在 [**控制台**](https://console.cloud.tencent.com/im/qun-setting ) > **功能配置** > **群组配置** > **群功能配置** > **社群** 打开开关后方可使用。
...
>!
>- v2.19.1 起支持，该接口仅适用于支持话题的社群，需 [购买旗舰版](hhttps://www.tencentcloud.com/document/product/1047/34577) 在 [**控制台**](https://console.cloud.tencent.com/im/qun-setting ) > **功能配置** > **群组配置** > **群功能配置** > **社群** 页面，完成开通社群后，再打开开通话题开关，方可使用。
>- 该接口使用前必须先调用 [createGroup](https://web.sdk.qcloud.com/im/doc/en/SDK.html#createGroup) 创建支持话题的社群。
...
>! v2.19.1 起支持，该接口仅适用于支持话题的社群，需 [购买旗舰版](hhttps://www.tencentcloud.com/document/product/1047/34577) 并 [申请开通](https://intl.cloud.tencent.com/document/product/1047/44322) 后方可使用。
