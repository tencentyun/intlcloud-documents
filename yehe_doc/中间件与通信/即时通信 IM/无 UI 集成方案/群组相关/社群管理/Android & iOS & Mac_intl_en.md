...
- The community and topic management APIs are in the `V2TIMGroupManager(Android)` / `V2TIMManager(Group)(iOS and macOS)` core class.
- The topic message APIs are in the `V2TIMMessageManager(Android)` / `V2TIMManager(Message)(iOS and macOS)` core class.

> ? This feature is supported by v6.2.2363 or later. To use it, you need to [purchase the Ultimate edition](https://www.tencentcloud.com/document/product/1047/34577#.E5.8D.87.E7.BA.A7.E5.BA.94.E7.94.A8), go to the [**console**](https://console.cloud.tencent.com/im/qun-setting), select **Group feature configuration**, and enable the **Community** feature.
...
1. Create the `V2TIMGroupInfo` object ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupInfo.html) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/interfaceV2TIMGroupInfo.html)) and set `groupType` to `Community` and `isSupportTopic` to `true`/`YES`.
2. Call the `createGroup` API ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a121d53137a38d0fc0bc8a8e0a9c55647) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Group_08.html#a59824434b6096180b94d8152183dcd2c)) to create a community.
...
V2TIMManager.getGroupManager().createGroup(v2TIMGroupInfo, null, new V2TIMValueCallback<String>() {
  ...
  public void onSuccess(String groupID) {
    // Created the community successfully
  }

  @Override
  public void onError(int code, String desc) {
  	// Failed to create the community
  }
});
```
:::
...
V2TIMManager.getGroupManager().getJoinedCommunityList(new V2TIMValueCallback<List<V2TIMGroupInfo>>() {
  ...
  public void onSuccess(List<V2TIMGroupInfo> v2TIMGroupInfos) {
  	// Obtained the community list successfully
  }
  @Override
  public void onError(int code, String desc) {
  	// Failed to obtain the community list
  }
});
...
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48466#joinGroup">Joins a community group</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48466#quitGroup">Leaves a community</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48466#dismiss">Disbands a community group</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48185#getGroupInfo">Gets the community profile</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48185#setGroupInfo">Modifies the community profile</a></td>
...
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48181#getGroupMemberList">Gets the list of community members</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48178#getGroupMembersInfo">Gets the profiles of the community members</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48178#setGroupMemberInfo">Modifies the profile of a community member</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48181#kick">Removes a member from the community</a></td>
...
1. Create the `V2TIMTopicInfo` object ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMTopicInfo.html) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/interfaceV2TIMTopicInfo.html)).
2. Call the `createTopicInCommunity` API ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a52eed1b07ad64a3aa3d3561d8cd147f0) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Group_08.html#a8cc04d04254867787060cf1cae0fc5b8)) to create a topic.
...
V2TIMManager.getGroupManager().createTopicInCommunity(groupID, topicInfo, new V2TIMValueCallback<String>() {
  ...
  public void onSuccess(String topicID) {
  	// Created the topic successfully
  }
...
### Deleting a topic
Call the `deleteTopicFromCommunity` API ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a77c4502346e800e43c22a0f15138d699) / [iOS & Mac](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Group_08.html#a31b726136637a58b5bb246eaac41187c)) to delete a topic.
...
1. Create the `V2TIMTopicInfo` object ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMTopicInfo.html) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/interfaceV2TIMTopicInfo.html)) and set the fields to be modified.
2. Call the `setTopicInfo` API ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#acaff2edad6eb208478be9ab06d30035d) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Group_08.html#a237e2fa6e16e55143c516c5428a23936)) to modify the information of a topic.
...
V2TIMManager.getGroupManager().setTopicInfo(topicInfo, new V2TIMCallback() {
  ...
  public void onSuccess() {
  	// Modified the topic information successfully
  }
...
For how to modify other information of a topic, see [Muting Member](https://intl.cloud.tencent.com/document/product/1047/48181#mute) and [Changing Topic Message Receiving Option](https://intl.cloud.tencent.com/document/product/1047/48185#setGroupReceiveMessageOpt).
	
### Getting the topic list[](id:getTopicList)
Call the `getTopicInfoList` API ([Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a5d2b18a76cff650cb9bb2abf2ef07306) / [iOS and macOS](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Group_08.html#af93ad10e0e2b21d6ae3c8ec45021b159)) to get the topic list.
- If `topicIDList` is empty, the list of all topics in the community will be obtained.
...
V2TIMManager.getGroupManager().getTopicInfoList(groupID, topicIDList, new V2TIMValueCallback<List<V2TIMTopicInfoResult>>() {
  ...
  public void onSuccess(List<V2TIMTopicInfoResult> v2TIMTopicInfoResults) {
		// Obtained the topic list successfully
  }
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/47994">Sends a message</a></td>
<td>sendMessage (<a href="https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMMessageManager.html#a28e01403acd422e53e999f21ec064795">Android</a> / <a href="https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Message_08.html#a681947465d6ab718da40f7f983740a21">iOS and macOS)</a> </td>
<td>Set `groupID` to the topic ID.</td>
</tr>
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/47995">Receives a message</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48320#markMessageAsRead">Marks a conversation as read</a></td>
...
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/47998">Gets historical messages</a></td>
<td>getGroupHistoryMessageList (<a href="https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMMessageManager.html#a671e8737fcea0c05dc661c753e5b3597">Android</a> / <a href="https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Message_08.html#a9e242ba327377fe74b83e8d5572d39a0">iOS and macOS)</a></td>
<td>Set `groupID` to the topic ID.</td>
</tr>
<tr>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/48016">Recalls a message</a></td>
<td>revokeMessage (<a href="https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMMessageManager.html#ad0dfce6be749165cd90a9ff67a1308b1">Android</a> / <a href="https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Message_08.html#a2ef856a792923811e9d16ed7a101336a">iOS and macOS)</a></td>
<td>Set `groupID` to the topic ID.</td>
</tr>
</table>
