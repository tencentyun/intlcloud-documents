...
群主可以调用 [transferGroupOwner](https://comm.qq.com/im/doc/RN/en/Api/V2TIMGroupManager/transferGroupOwner.html) 把群主转让给其他群成员。

群主转让后，全员会收到 [onGroupInfoChanged](https://comm.qq.com/im/doc/RN/en/Callback/OnGroupInfoChanged.html) 回调，其中 `V2TIMGroupChangeInfo` 的 type 为 `V2TIMGroupChangeInfo.V2TIM_GROUP_INFO_CHANGE_TYPE_OWNER`，value 值为新群主的 UserID。
