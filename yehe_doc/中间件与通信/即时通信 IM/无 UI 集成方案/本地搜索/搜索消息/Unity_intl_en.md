...
The message search parameter class is `MessageSearchParam` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.types.MessageSearchParam.html)). When searching for messages, the SDK will execute different search logics based on the object settings.

The `MessageSearchParam` parameters are as described below:

| Parameter | Definition | Description |
| --- | --- | --- |
| msg_search_param_keyword_array | It can contain up to five keywords. When the message sender and the message type are not specified, the keyword list must be set; in other cases, it can be left empty. |
...
The message search result class is `MessageSearchResult` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.types.MessageSearchResult.html)). The parameters are as described below:
...
Here, `msg_search_result_item_array` is a list that contains the `MessageSearchResultItem` objects ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.types.MessageSearchResultItem.html)). The parameters are as described below:
...
|msg_search_result_item_conv_type| Conversation type |`TIMConvType` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.enums.TIMConvType.html))|


## Searching for the Messages in All the Conversations
When a user enters a keyword in the search box to search for messages, you can call `MsgSearchLocalMessages` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_MsgSearchLocalMessages_com_tencent_imsdk_unity_types_MessageSearchParam_com_tencent_imsdk_unity_callback_ValueCallback_com_tencent_imsdk_unity_types_MessageSearchResult__)) to search for local messages of the IM SDK.
