...
您可以调用 `ConvGetConvInfo`([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_ConvGetConvInfo_System_Collections_Generic_List_com_tencent_imsdk_unity_types_ConvParam__com_tencent_imsdk_unity_callback_ValueCallback_System_Collections_Generic_List_com_tencent_imsdk_unity_types_ConvInfo___)) 获取单个、多个会话的信息。
