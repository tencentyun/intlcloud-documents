...
### 标记会话
您可以调用 `markConversation` ([dart](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Api/V2TIMConversationManager/markConversation.html)) 接口标记或者取消标记会话。
...
### 监听会话标记变更通知
会话被标记或者取消标记后，会话 `V2TimConversation` 的 `markList` ([dart](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Class/Message/V2TimConversation.html#marklist)) 字段会发生变更，您可以调用 `addConversationListener` ([dart](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Api/V2TIMConversationManager/addConversationListener.html)) 接口监听会话变更通知。
...
### 拉取指定标记会话
您可以调用 `getConversationListByFilter` ([dart](https://comm.qq.com/im/doc/flutter/en/SDKAPI/Api/V2TIMConversationManager/getConversationListByFilter.html)) 接口拉取指定标记会话。
