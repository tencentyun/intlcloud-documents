...
## Conversation Class
The conversation class is `ConvInfo` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.types.ConvInfo.html)), which defines the following content:
...
| conv_last_msg | Last message in the conversation | For detailed directions, see [ConvGetConvInfo(List<ConvParam>, ValueCallback<String>)](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_ConvGetConvInfo_System_Collections_Generic_List_com_tencent_imsdk_unity_types_ConvParam__com_tencent_imsdk_unity_callback_ValueCallback_System_Collections_Generic_List_com_tencent_imsdk_unity_types_ConvInfo___).|
...
| conv_draft | Draft information | The draft information can be set by calling the `ConvSetDraft` API. For more information, see [ConvSetDraft(String, TIMConvType, DraftParam)](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_ConvSetDraft_System_String_com_tencent_imsdk_unity_enums_TIMConvType_com_tencent_imsdk_unity_types_DraftParam_). |
| conv_is_has_draft | Whether there is a conversation draft | |
| conv_is_pinned | Whether to pin the conversation to the top | For detailed directions, see [Class TencentIMSDK](https://comm.qq.com/im/sdk/unity_plus/_site_en/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_ConvPinConversation_System_String_com_tencent_imsdk_unity_enums_TIMConvType_System_Boolean_com_tencent_imsdk_unity_callback_NullValueCallback_). |
