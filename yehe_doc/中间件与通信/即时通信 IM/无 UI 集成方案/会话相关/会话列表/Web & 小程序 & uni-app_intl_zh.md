...
会话列表功能主要分为获取会话列表、处理会话列表更新。接入侧监听 [TIM.EVENT.CONVERSATION_LIST_UPDATED](https://web.sdk.qcloud.com/im/doc/en/module-EVENT.html#.CONVERSATION_LIST_UPDATED) 处理会话列表数据并渲染。
