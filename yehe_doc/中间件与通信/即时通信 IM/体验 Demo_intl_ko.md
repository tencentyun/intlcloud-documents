...
<h3 style="padding: 10px; padding-left: 20px; font-size:20px; padding-bottom: 10px; background-color: #edf1f5"> 각 네이티브 개발 Demo </h3>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;"><img style="width:100px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/078fbb462abd2253e4732487cad8a66d.png" /></p>
                    <a href="https://intl.cloud.tencent.com/document/product/1047/45914">시작하기</a>
                </div>
                </div>
</div>
<div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;"><img style="width:100px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/b1ea5318e1cfce38e4ef6249de7a4106.png" /></p>
                                <a href="https://intl.cloud.tencent.com/document/product/1047/45913">시작하기</a>
                </div>
                            </div>
</div>
<div class="card-container">
    ...
    box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;"  onclick="window.open('https://web.sdk.qcloud.com/component/experience-center/index.html#/login?scene=chatkit')" /></p>
                 <a href="https://www.tencentcloud.com/document/product/1047/45912">시작하기</a>
                </div>
            </div>
                </div>
        </div>
        ...
        <div class="card-container">
            <div class="card">
                            <img src="https://qcloudimg.tencent-cloud.cn/raw/af07e321883032c9796848d189a80f5e.png" data-nonescope="true">
                                <a href="https://cloud.tencent.com/document/product/269/68376">시작하기</a>
            </div>
        </div>

<div style="background: #f5f7fa">
<h3 style="padding: 10px; padding-left: 20px; font-size:20px; padding-bottom: 10px; background-color: #edf1f5">Flutter Demo: <span style="color: #006eff">하나의 코드 세트로 모든 플랫폼에서 실행<span></h3>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;"><img style="width:100px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/3c79e8bb16dd0eeab35e894a690e0444.png" /></p>
                                <a href="https://intl.cloud.tencent.com/document/product/1047/45907">시작하기</a>
            </div>
</div>
...
<div class="card-container">
    ...
    box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;" /><br><br><input type="button" value="Mac OS" style="height: 30px;width: 100px;margin-top: -10px;min-width: 24px;background-color: grey;color: #fff; line-height: 30px;text-align: center;display: inline-block;cursor: not-allowed; border: 1px solid grey; outline: 0 none;box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;" /></p>
                                <p style="margin-top: 20px">곧 출시될 예정입니다. 많은 관심 부탁드립니다!</p>
            </div>
</div>
        ...
        <div class="card-container">
            <div class="card">
                            ...
                            <div style="width: 100px; height: 100px;margin: auto;">
                                <p class="titlename"><input type="button" value="Windows 버전" style="height: 30px;width: 100px;min-width: 24px;background-color: #006eff;
    color: #fff;border: 1px solid #006eff;line-height: 30px;text-align: center;display: inline-block;cursor: pointer;outline: 0 none;
    box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;"  onclick="window.open('https://comm.qq.com/im_demo_download/index.html#/pc-windows')" /><br><br><input type="button" value="Mac OS 버전" style="height: 30px;width: 100px;margin-top: -10px;min-width: 24px;background-color: #006eff;color: #fff;border: 1px solid #006eff;line-height: 30px;text-align: center;display: inline-block;cursor: pointer;outline: 0 none;box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;" onclick="window.open('https://comm.qq.com/im_demo_download/index.html#/pc')" /></p>
                            </div>
                <p style="color:#586376;"></p>
                                <a href="https://intl.cloud.tencent.com/document/product/1047/45910">시작하기</a>
            </div>
        </div>
</div>
</div>
        ...
        <div class="card-container">
            <div class="card">
                            ...
                            <div style="width: 120px; height: 100px;margin: auto;">
                                <p class="titlename" style="width: 120px;"><input type="button" value="Web 라이브 스트리밍 인터랙션 푸시 스트림" style="height: 30px;width: 120px;min-width: 24px;background-color: #006eff;color: #fff;border: 1px solid #006eff;line-height: 30px;text-align: center;display: inline-block;cursor: pointer;outline: 0 none;
    box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;"  onclick="window.open('https://web.sdk.qcloud.com/component/tuiliveroom/tuipusher/pusher.html')" /><br><br><input type="button" value="Web 라이브 스트리밍 인터랙션 풀 스트림" style="height: 30px;width: 120px;margin-top:-10px;min-width: 24px;background-color: #006eff;color: #fff;border: 1px solid #006eff;line-height: 30px;text-align: center;display: inline-block;cursor: pointer;outline: 0 none;box-sizing: border-box;text-decoration: none;font-size: 12px;vertical-align: middle;white-space: nowrap;border-radius: 15px;" onclick="window.open('https://web.sdk.qcloud.com/component/tuiliveroom/tuiplayer/player.html')" /></p>
                            </div>
                <p style="color:#586376;"></p>
                                <a href="https://intl.cloud.tencent.com/document/product/1047/38175">시작하기</a>
            </div>
        </div>
</div>
</div>
