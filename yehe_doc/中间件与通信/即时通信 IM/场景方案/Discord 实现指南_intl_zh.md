...
本篇教程以腾讯云 IM 为基础展开，因此，需要在 [腾讯云 IM 控制台](https://console.cloud.tencent.com/im) 进行应用创建。
...
- SDKAppID：腾讯云 IM 会给每个应用分配一个 SDKAppID，在控制台创建应用后再应用详情页查看，开发者可以在初始化腾讯云IM客户端 SDK 和计算用户登录票据时使用。详情可参考无 UISDK [初始化](https://intl.cloud.tencent.com/document/product/1047/47968) 以及 [登录](https://intl.cloud.tencent.com/document/product/1047/47971) 文档。
- 密钥：在腾讯云 IM 控制台应用详情页可查看当前应用密钥，在计算用户登录 SDK 票据时会用到
- 用户账号：登录腾讯云 IM 用户必须在腾讯云 IM 的账号体系中，当用户使用客户端 SDK [登录](https://intl.cloud.tencent.com/document/product/1047/47971)成功时，腾讯云 IM 后台会自动创建 IM 用户。同时，可以使用腾讯云 IM 提供的服务端 API 将用户[导入到 IM 的用户体系](https://intl.cloud.tencent.com/document/product/1047/34953)中。
- 群组：到目前为止，IM根据不同场景的需要，提供了 [5种类型的群](https://intl.cloud.tencent.com/document/product/1047/33529)，用户在群里发言，群成员均可收到消息。
...
Discord 的功能主要分为服务器、频道、以及子区，服务器与服务器之间是内容上的区别，如王者荣耀服务器，和平精英服务器等，在服务器内可以创建不同类型的频道，如文字频道，语音频道、公示频道等。用户的交流实际是在各个频道中进行的。当用户对交流的某一个内容有更多的想法时，可以选择对该内容创建子区来进行更多的交流。Discord 的核心玩法就如分析的这样，接下来本教程会逐一分析如何通过腾讯云 IM 来实现相关的功能。

>?**如涉及到代码演示，本教程以 Android 端（Java SDK）为例进行展示，其他版本的SDK接口调用可参考文档 [无 UI 集成方案](https://intl.cloud.tencent.com/document/product/1047/34306) 部分。**
...
虽然 IM 提供了五种不同类型的群，但从 Discord 的服务器特性来看，只有 [社群（Community）](https://intl.cloud.tencent.com/document/product/1047/33529) 符合服务器的特性，腾讯云 IM 社群创建后可以随意进出，最多支持10w人，支持历史消息存储，用户搜索群 ID 发起加群申请后，无需管理员审批即可进群。

可通过腾讯云 IM 提供的 createGroup 接口进行服务器（群）创建，需要注意的是，创建的群类型为Community、[setSupportTopic](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupInfo.html#af97a85fc91302dbbdf0f6c0a0a022ccd) 需要设置为 true，这样才可在服务器中创建频道。演示代码如下：
...
在返回的 [V2TIMGroupInfo](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupInfo.html) 列表，代表的是服务器的基本信息。但是在基本信息中，并没有服务器的未读数以及自定义状态等相关信息。因此想要实现 Discord 一样的效果需要借助 IM 提供的其他 API 来实现，服务器列表的未读数，在后面的小节中讲到。
...
设置群自定义字段的 [服务端 API](https://intl.cloud.tencent.com/document/product/1047/34962) 以及 [客户端 SDK](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#ad4ceef92975fa00c4a5dddc8f7e1edcf)。
...
对于服务器的自定义状态功能，可以通过设置服务器会话的自定义数据来实现，对应 API 为 [setConversationCustomData](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMConversationManager.html#ac11ca7227145e3f359f6a3473ed600a5)。
...
当服务器会话的相关数据发生改变时，客户端需要试试更新 UI 的展示，对于监听服务器会话的改变，IM 提供了对应的事件监听函数 [addConversationListener](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMConversationManager.html#a806534684e5d4d01b94126cd1397fee4)，当以下信息修改时，会触发该回调函数。
...
在服务器内，可创建多个频道。在该服务器下创建了四个频道，并且将四个频道放到了两个分类中。 
...
3. 根据服务器属性，[在服务端创建话题](https://intl.cloud.tencent.com/document/product/1047/49471)。
...
可以通过 [createTopicInCommunity](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a52eed1b07ad64a3aa3d3561d8cd147f0) 来实现相关的功能。
...
创建频道时，可以通过调用 [V2TIMTopicInfo](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMTopicInfo.html) 的成员方法来设置频道的信息，频道分类以及频道类型，可以通过 [setCustomString](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMTopicInfo.html#aad0cc8249c21c5ccae385fdfb8ba32ea)，进行设置。 
...
可通过 [getHistoryMessageList](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMMessageManager.html#a97fe2d6a7bab8f45b758f84df48c0b12) 来获取频道的历史消息记录。
...
频道内消息未读数和服务器消息未读数不同，服务器未读数在会话信息中，而频道的未读数在频道的基本信息中，切通过腾讯云 IM 的群组回调 [onTopicInfoChanged](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupListener.html#a29285e4e127337e299bd2b695a1afdeb) 来实时获取未读数。
...
私有频道获取群成员列表也是调用 [getGroupMemberList](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a69fc0831aacaa0585c1855f4c91320be)，传入私有频道的群 ID 即可。
...
1. 查询 [服务器中成员](https://intl.cloud.tencent.com/document/product/1047/34948)。
2. [创建群并设置群成员](https://intl.cloud.tencent.com/document/product/1047/34895)。
3. [邀请用户进群](https://intl.cloud.tencent.com/document/product/1047/34921)。

服务端回调为 [进群后回调](https://intl.cloud.tencent.com/document/product/1047/34372)。
...
使用群自定义消息需要现在 [腾讯云 IM 控制台](https://console.cloud.tencent.com/im/qun-setting) 进行配置。
...
设置成功后群成员可收到 [onMemberInfoChanged](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupListener.html#a4ac777faad07e32408ae7ef5e2e3fc86) 事件，同时，未在线的用户也可以在通过群资料获取到标注的消息内容：
...
- 通过 [setSelfStatus](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#a7520045679f1493c890f2b3b5eee7b84) 来设置自己的自定义在线状态，用户的自己的在线\离线状态是 IM 设置的，开发者不能更改。
- 通过 [getUserStatus](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#a2428c7f87859dd85bed1730ad8d3b92a) 来获取好友的在线状态。
- 通过 [onUserStatusChanged](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMSDKListener.html#a94251d1971d7b6692b3278ed0d42b73e) 来监听好友的在线状态改变。
...
- 获取个人资料 [getUsersInfo](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#a7ca8c0f71a9875021fc35dfcaff68d1e)。
- 设置个人资料 [setSelfInfo](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#af004ab2f1d1458de354883f1995b678a)。
...
- 搜索消息 [searchLocalMessages](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMMessageManager.html#a9364c8a0c6a0899b17c0a479b8ca848a)。
- 搜索群组 [searchGroups](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a94a72082b7e2682942f35196a7e28023)。
- 搜索群成员 [searchGroupMembers](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a493fb73258019961f3ca8934ff625b0a)。
- 搜索好友 [searchFriends](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMFriendshipManager.html#a3e657c9ec5d68a4c423a64d71f5f9c6e)。

详细的使用 API 可参考官文档 [搜索部分](https://intl.cloud.tencent.com/document/product/1047/48134)。

#### 离线推送功能

在用户离线时，腾讯云 IM 的在线消息触达不到用户，这是便需要终端设备厂商提供的离线推送能力，腾讯云 IM 接入离线推送也十分方便，详情可参见 [离线推送](https://intl.cloud.tencent.com/document/product/1047/39156)。
