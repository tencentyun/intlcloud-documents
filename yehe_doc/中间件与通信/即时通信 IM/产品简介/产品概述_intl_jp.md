...
### データストレージサイト：
中国サイトが提供する中国データストレージサイト以外にも、IMは国内の海外進出企業や海外企業に東南アジア（シンガポール）、東北アジア（韓国ソウル）およびヨーロッパ（ドイツフランクフルト）のデータストレージサイトを選択肢として提供しています。海外データストレージサイトをデプロイする必要がある場合は、[IMグローバルサイトコンソール](https://intl.cloud.tencent.com/login?s_url=https%3A%2F%2Fconsole.intl.cloud.tencent.com%2Fim%3Ffrom%3D15210)にアクセスしてください。
### シングルチャット
