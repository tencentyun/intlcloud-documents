...
<table>
	...
	<tr>
        ...
        <tr>
            ...
            <td>친구 및 친구 그룹</td>
            <td><ul style="margin:0;"><li>친구 인원: 최대 3000명</li><li>승인 대기 중인 친구 요청: 최대 100개</li><li>친구 그룹: 최대 32개</li><li>친구 그룹 이름 길이: 최대 30바이트</li><li>친구 설명 길이: 최대 96바이트</li><li>WebIM SDK는 친구 관계망을 지원하지 않음</li></ul></td>
        </tr>
        <tr>
            <td>블랙리스트</td>
