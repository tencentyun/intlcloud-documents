...
|Flutter|Flutter2 & dart2.12以降のバージョン|サポートあり|-|-|
...
>?コミュニティ(Community)機能は、SDK 5.8.1668拡張版以降のバージョン、Web SDK2.17.0以降のバージョンをサポートします。使用するにはフラッグシップ版パッケージを購入して[アクティブ化の申請](https://intl.cloud.tencent.com/document/product/1047/44322)を行ってください。
...
<table>
   <tr>
      ...
      <th width="0px" style="text-align:center">フレンドワークグループ(Work)</td>
