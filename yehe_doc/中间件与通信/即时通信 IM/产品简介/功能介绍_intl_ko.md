...
|Unity|2020.2.7f1c1 및 그 이후 버전|지원|-|-|
|Flutter|Flutter 2 & dart 2.12 및 그 이후 버전|지원|-|지원|
|Electron|지원|지원|-|-|
...
>?현재 사용 중인 중국 포털은 중국 내 데이터 저장만 지원합니다(서비스는 전 세계적으로 사용 가능). 인도, 싱가포르, 한국, 독일 등 해외 데이터 스토리지 리전을 배치하려면 [IM 글로벌 포털 콘솔](https://intl.cloud.tencent.com/login?s_url=https%3A%2F%2Fconsole.intl.cloud.tencent.com%2Fim%3Ffrom%3D15211)로 이동하십시오.
### 계정 기능
...
>- 커뮤니티(Community) 기능은 단말 SDK 5.8.1668 인핸스드 버전 이상, Web SDK 2.17.0 이상에서만 지원되며, [플래그십 에디션](https://www.tencentcloud.com/document/product/1047/34577) 구매 및 [활성화 신청](https://intl.cloud.tencent.com/document/product/1047/44322) 후 사용 가능합니다.
...
<table>
   ...
   <tr>
    ...
    <td>App 관리자</td><td><li>그룹 관리자</li><li>그룹 소유자</li><li>App 관리자</li>
</td>
   </tr>
	   <tr>
     <td>구성원 리스트</td>
...
<tr>
<td>그룹 프로필 변경 알림</td>
<td>기본 설정: 그룹 이름, 그룹 공지, 그룹 소개, 그룹 프로필 사진, 그룹 소유자 변경 알림 활성화, 로밍 저장, 그룹 음소거 변경 알림은 비활성화, <a href="https://console.cloud.tencent.com/im/qun-setting">콘솔</a> 설정 지원</td>
<td>기본 설정: 그룹 이름, 그룹 공지, 그룹 소개, 그룹 프로필 사진, 그룹 소유자 변경 알림 활성화, 로밍 저장, 그룹 음소거 변경 알림은 비활성화, <a href="https://console.cloud.tencent.com/im/qun-setting">콘솔</a> 설정 지원</td>
<td>기본 설정: 그룹 이름, 그룹 공지, 그룹 소개, 그룹 프로필 사진, 그룹 소유자 변경 알림 활성화, 로밍 저장, 그룹 음소거 변경 알림은 비활성화, <a href="https://console.cloud.tencent.com/im/qun-setting">콘솔</a> 설정 지원</td>
<td>기본 설정: 그룹 이름, 그룹 공지, 그룹 소개, 그룹 프로필 사진, 그룹 소유자 변경 알림 활성화, 로밍 저장하지 않음, 그룹 음소거 변경 알림 비활성화</td>
<td>기본 설정: 그룹 이름, 그룹 공지, 그룹 소개, 그룹 프로필 사진, 그룹 소유자 변경 알림 활성화, 로밍 저장, 그룹 음소거 변경 알림은 비활성화, <a href="https://console.cloud.tencent.com/im/qun-setting">콘솔</a> 설정 지원</td>
</tr>
<tr>
