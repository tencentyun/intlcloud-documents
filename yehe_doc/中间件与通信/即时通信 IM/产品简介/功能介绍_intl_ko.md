...
|Flutter|Flutter 2 & dart 2.12 및 그 이후 버전|지원|-|-|
|Electron|지원|지원|-|-|
...
>?커뮤니티(Community) 기능은 터미널 SDK 5.8.1668 인핸스드 버전 이상, Web SDK 2.17.0 이상에서만 지원되며, 플래그십 에디션 패키지를 구매하고 [활성화 신청](https://intl.cloud.tencent.com/document/product/1047/44322) 후 사용 가능합니다.
