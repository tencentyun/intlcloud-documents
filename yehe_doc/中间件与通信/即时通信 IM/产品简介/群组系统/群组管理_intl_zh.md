即时通信 IM 根据常见使用场景，默认配置了以下群组形态：好友工作群（Work）、陌生人社交群（Public）、临时会议群（Meeting）、直播群（AVChatRoom）和社群（Community），详细请参阅 [群组类型介绍](https://intl.cloud.tencent.com/document/product/1047/33529)。
