...
| Delete a group | This operation deletes a group that has been created on the app. When the group is deleted, all group members receive a system message stating that the group has been deleted. | The app admin can call the RESTful API to delete any group. The permission to delete a group on an app varies depending on the member role:<br>For a public group (Public), meeting group (Meeting), audio-video group (AVChatRoom), or community group (Community), only the group owner can delete the group.<br>For a work group (Work), no one in the group can delete the group. |
