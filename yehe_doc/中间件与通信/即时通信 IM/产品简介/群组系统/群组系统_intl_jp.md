## グループシステムの紹介
グループシステムは、多人数チャットをサポートするインスタントメッセージシステムで、基本機能は次のとおりです。
...
>- コミュニティ（Community）機能は、SDK5.8.1668拡張版以上のバージョンでのみサポートされており、使用するにはフラッグシップ版パッケージを購入して[アクティブ化の申請](https://intl.cloud.tencent.com/document/product/1047/37275) を行う必要があります。
...
|グループ基本プロファイルの修正権限|一般参加者|グループ管理者 <br>グループマスター<br>App管理者|グループマスター<br>App管理者|App管理者|グループマスター<br>App管理者|
...
|グループ参加前メッセージレコード確認のサポートの有無|サポートなし|サポートなし|サポートあり|サポートなし|サポートあり|
|メッセージ履歴保存のサポートの有無|サポートあり|サポートあり|サポートあり|サポートなし|サポートあり|
|参加者変更通知のサポートの有無|サポートあり|サポートあり|サポートなし|サポートあり|サポートあり|
...
|ゲストの身分（ログイン不要）でのユーザーのグループメッセージ受信のサポートの有無|サポートなし|サポートなし|サポートなし|サポートあり|サポートなし|
...
>!グループ回収機能を有効にする必要がある場合、[チケットテンプレート](https://intl.cloud.tencent.com/document/product/1047/37275#.E8.87.AA.E5.8A.A8.E5.9B.9E.E6.94.B6.E7.BE.A4.E7.BB.84) でチケットを提出して申請できます。設定すると、グループタイプによって非アクティブグループをクリアできます（グループが非アクティブであるということは、グループ内でコメントがなく、参加者の変更もないことを指します）。
