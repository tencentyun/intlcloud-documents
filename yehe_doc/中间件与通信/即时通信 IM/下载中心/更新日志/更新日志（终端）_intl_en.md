...
- Added the feature of displaying 20 historical messages from before a user joins an audio-video group (AVChatRoom). This feature is available only for the Ultimate edition.
...
- Supported communities of up to 100,000 members. This feature is available only for the Ultimate edition.
