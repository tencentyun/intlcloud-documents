...
- 新增 [会话标记](https://intl.cloud.tencent.com/document/product/1047/48853) 支持
- 新增 [会话分组](https://intl.cloud.tencent.com/document/product/1047/48854) 支持
- 新增会话自定义字段支持
- 新增 [拉取会话高级接口](https://intl.cloud.tencent.com/document/product/1047/48326)
- 支持接收直播群广播消息
- 支持加群选项变更的通知下发
- 支持群消息接收选项变更的多端同步
- 优化长连接选路逻辑，支持策略轮转
...
- [新增在线状态查询、上下线通知及自定义状态](https://intl.cloud.tencent.com/document/product/1047/49562)
...
## 6.1.2155 @2022.03.18 - 增强版

### SDK

- Android 离线推送支持设置声音提示
- 移动端 SDK 提供设置网络代理的接口
- C/C++ 平台补齐离线推送接口
- 支持登录后自动同步群内信令消息
...
### TUIKit
- 完成 TUIKit Demo 个保法改造，满足合规要求
- 修复收到离线推送通知后，点击通知栏提示无法拉起音视频通话的问题
- 修复 App 退至后台后收到离线推送通知，直接启动 App 无法拉起音视频通话的问题
...
- cos 文件上传下载并发数支持后台配置
- 双栈网络可以配置优先使用 IPV6
- 加入 AVChatRoom 直播群时，支持返回进群前 20 条消息；需开通旗舰版
...
- 新增一键清空所有会话未读消息的能力
- 新增 Community 社群的支持，社群最多支持 10万人；需开通旗舰版
...
- 增加删除会话漫游消息的接口
- 修复部分 Android 手机长连接连网收不到网络状态变化通知的问题
...
- 修复部分 Android 手机长连接初始连网成功后会出现一次断网重连的问题
...
**iOS/Android**
- 新增 [群直播](https://intl.cloud.tencent.com/document/product/1047/50062) 功能，连麦、送礼、美颜、变声等功能一应俱全
- 新增 [直播大厅](https://intl.cloud.tencent.com/document/product/1047/50062)，支持连麦、PK、点赞、送礼、美颜、弹幕、好友关注等
- 优化语音视频信令识别问题
...
详情请参见官网文档 [离线推送](https://intl.cloud.tencent.com/document/product/1047/34336) 文档。
