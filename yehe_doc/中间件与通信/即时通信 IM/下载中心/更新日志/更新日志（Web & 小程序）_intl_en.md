...
- Adds [sendMessageReadReceipt](https://web.sdk.qcloud.com/im/doc/en/SDK.html#sendMessageReadReceipt) for sending group message read receipts.
- Adds [getMessageReadReceiptList](https://web.sdk.qcloud.com/im/doc/en/SDK.html#getMessageReadReceiptList) for pulling the list of group message read receipts.
- Adds [getGroupMessageReadMemberList](https://web.sdk.qcloud.com/im/doc/en/SDK.html#getGroupMessageReadMemberList) for pulling the list of members who have (or have not) read a group message.
- Adds [findMessage](https://web.sdk.qcloud.com/im/doc/en/SDK.html#findMessage) for querying local messages in a conversation by messageID.
- Improves the update experience of unread message count after messages are recalled, which is consistent with that of NativeIM.
...
- Supports [Group System](https://intl.cloud.tencent.com/document/product/1047/33529).
...
Login failures occurred when Windows WeChat accessed mini programs and uni-app packaged Android apps (some devices).
...
- Increased the stability of persistent connections.
