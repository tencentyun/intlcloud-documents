...
IM SDK 및 Demo의 최신 소스 코드를 다운로드할 수 있습니다.
[](id:web)
...
<div style="position: relative; box-sizing: border-box;  padding-bottom: 10px; margin-bottom: 10px; overflow:hidden; display: flex;">
  <div class="card-container">
      <div class="card">
        ...
        <a style="margin-left: 10px;" href="https://www.tencentcloud.com/document/product/1047/34309">통합 가이드</a>
  ...
  <div class="card-container">
    <div class="card">
      ...
      <p class="titlename">uni-app(App) SDK</p>
      <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
      <div style="margin-top: 13px;" >
...
<div style="position: relative; box-sizing: border-box;  padding-bottom: 10px; margin-bottom: 10px; overflow:hidden;">
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
                    <div style="margin-top: 13px;" >
                                <a  href="https://github.com/tencentyun/TIMSDK/tree/master/Android/IMSDK">Github 다운로드</a>
                                <a style="margin-left: 10px;" href="https://gitee.com/cloudtencent/TIMSDK/tree/master/Android/IMSDK">Gitee 다운로드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34306">통합 가이드</a>
                                <a style="margin-left: 10px" href="https://intl.cloud.tencent.com/document/product/1047/34282">업데이트 로그</a>
                    </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
                    <div style="margin-top: 13px;" >
                        <a  href="https://github.com/tencentyun/TIMSDK/tree/master/iOS/IMSDK">Github 다운로드</a>
                        <a style="margin-left: 10px;" href="https://gitee.com/cloudtencent/TIMSDK/tree/master/iOS/IMSDK">Gitee 다운로드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34307">통합 가이드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34282">업데이트 로그</a>
                    </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
                    <div style="margin-top: 13px; " >
                        <a  href="https://github.com/tencentyun/TIMSDK/tree/master/Mac/IMSDK">Github 다운로드</a>
                        <a style="margin-left: 10px;" href="https://gitee.com/cloudtencent/TIMSDK/tree/master/Mac/IMSDK">Gitee 다운로드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34308">통합 가이드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34282">업데이트 로그</a>
                    </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
                    <div style="margin-top: 13px;" >
                      <a  href="https://github.com/tencentyun/TIMSDK/tree/master/Windows/IMSDK">Github 다운로드</a>
                        <a style="margin-left: 10px;" href="https://gitee.com/cloudtencent/TIMSDK/tree/master/Windows/IMSDK">Gitee 다운로드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34310">통합 가이드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/34282">업데이트 로그</a>
                    </div>
            </div>
        </div>
...
<h3 style="margin-top: 15px;"> 프레임워크 SDK </h3>
...
<div style="position: relative; box-sizing: border-box;  padding-bottom: 10px; margin-bottom: 10px; overflow:hidden;">
        ...
        <div class="card-container">
            <div class="card">
                                <img src="https://main.qcloudimg.com/raw/98394fa5d669de7fb7a187565d138cdb.svg" data-nonescope="true">
                                <p class="titlename"> IM UIKit （Web）</p>
                <p style="color:#586376;">모든 IM 기능과 그룹의 라이브 스트림 공동 앵커 기능 포함</p>
                    <div style="margin-top: 13px;" >
                    <a  href="https://github.com/TencentCloud/chat-uikit-vue">Github 다운로드</a>
                    <a style="margin-left: 10px;" href="https://www.npmjs.com/package/@tencentcloud/chat-uikit-vue">npm 다운로드</a>
                                <a style="margin-left: 10px;" href="https://www.tencentcloud.com/document/product/1047/45912">통합 가이드</a>
                    </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                                <img src="https://qcloudimg.tencent-cloud.cn/raw/af07e321883032c9796848d189a80f5e.png" data-nonescope="true">
                                <p class="titlename"> IM UIKit </p>
                <p style="color:#586376;">IM의 주요 기능과 온라인 고객 서비스 시나리오를 위한 기능 포함</p>
                    <div style="margin-top: 13px;" >
                    <a href="https://github.com/TencentCloud/chat-uikit-wechat">Github 다운로드</a>
                     <a style="margin-left: 10px;" href="https://www.npmjs.com/package/@tencentcloud/chat-uikit-wechat">npm 다운로드</a>
        ...
        <div class="card-container">
            <div class="card">
                                <img src="https://main.qcloudimg.com/raw/98394fa5d669de7fb7a187565d138cdb.svg" data-nonescope="true">
                                <p class="titlename"> IM UIKit （uni-app）</p>
                <p style="color:#586376;">IM의 주요 기능과 온라인 고객 서비스 시나리오를 위한 기능 포함</p>
                    <div style="margin-top: 13px; " >
                    <a href="https://github.com/TencentCloud/chat-uikit-uniapp">Github 다운로드</a>
                    <a style="margin-left: 10px;" href="https://www.npmjs.com/package/@tencentcloud/chat-uikit-uniapp">npm 다운로드</a>
                                <a style="margin-left: 10px;" href="">통합 가이드</a>
                    </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">IM 주요 기능 포함. iOS/Android/Web 지원</p>
                     <div style="margin-top: 13px; " >
                    <a href="https://github.com/TencentCloud/tc-chat-demo-flutter">Github 다운로드</a>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <p style="color:#586376;">IM의 모든 기능과 음성/영상 통화 및 화상 회의 기능 포함</p>
                     <div style="margin-top: 13px;" >
                        <a href="https://github.com/TencentCloud/tc-chat-demo-electron">Github 다운로드</a>
                                <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/45910">통합 가이드</a>
                     </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                            <img src="https://main.qcloudimg.com/raw/98394fa5d669de7fb7a187565d138cdb.svg" data-nonescope="true">
                                <p class="titlename">인터랙티브 라이브 스트리밍 Demo (Web)</p>
            <p style="color:#586376;">라이브 스트리밍 시작 및 좋아요 표시와 같은 인터랙티브 기능 포함</p>
                <div style="margin-top: 13px;" >
                <a  href="https://github.com/tencentyun/TUILiveRoom/tree/main/Web">Github 다운로드</a>
                        <a style="margin-left: 10px;" href="https://intl.cloud.tencent.com/document/product/1047/38175">통합 가이드</a>
                </div>
            </div>
        </div>
    </div>
...
<div>
<h2 style="margin-top: 36px;"> 패키지 크기 </h2>


<table>
    <tr>
      <th width="100px" style="text-align:center">네이티브 SDK</th>
      <th width="100px" style="text-align:center">기본 버전</th>
      <th width="100px" style="text-align:center">인핸스드 버전</th>
    </tr>
      <tr>
