...
>?푸시 기능을 사용하려면 푸시 관련 권한도 추가해야 하며, 자세한 내용은 [Flutter 벤더 메시지 푸시 플러그 인 통합 가이드](https://www.tencentcloud.com/document/product/1047/46306)를 참고하십시오.
...
- [음성/영상 통화 플러그인](https://www.tencentcloud.com/document/product/1047/50023): 일대일 및 그룹 음성/영상 통화를 지원합니다.
- [지리적 위치 메시지 플러그인](https://www.tencentcloud.com/document/product/1047/48564): 위치 선택, 위치 전송, 위치 메시지 파싱 및 표시 기능을 제공합니다.
- [사용자 정의 이모티콘 플러그인](https://www.tencentcloud.com/document/product/1047/50023): TUIKit 0.1.5 이상은 이모티콘 패키지를 제공하지 않으며, 이 플러그인을 사용하여 이모티콘 기능을 빠르게 통합할 수 있습니다. 이 플러그인은 Emoji Unicode 인코딩 및 사용자 지정 이미지 이모티콘을 지원합니다. 통합 코드는 [Demo](https://github.com/TencentCloud/tc-chat-demo-flutter/blob/main/lib/src/pages/app.dart)를 참고하십시오.

>?좋은 아이디어나 제안이 있으시면 언제든지 [고객센터](https://cloud.tencent.com/online-service?from=doc_269&source=PRESALE)로 연락주십시오.
