腾讯云即时通信 IM 正式推出基于 Web IM SDK 在 HBuilderX 中编译 Android、iOS 的应用，可实现一套代码多端打包。
...
## 常见问题
[](id:Q1)
### 1. uni-app  同时支持 Android，iOS，IM SDK 如何选择？
...
>- 请将 IM SDK 升级到 [2.15.0](https://intl.cloud.tencent.com/document/product/1047/34281)，该版本支持了 iOS 语音播放。
...
### 3. uni-app  打包 iOS 语音消息无法播放怎么办？
  请将 IM SDK 升级到 [2.15.0](https://intl.cloud.tencent.com/document/product/1047/34281)，该版本支持了 iOS 语音消息播放。
...
## 技术咨询
了解更多详情您可[联系我们](https://intl.cloud.tencent.com/zh/contact-us)。
...
- [快速集成 uni-app TUIKit 源码](https://intl.cloud.tencent.com/document/product/1047/43893)
