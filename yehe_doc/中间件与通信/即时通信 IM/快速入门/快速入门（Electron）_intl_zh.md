...
在开始接入前，您可以体验我们的 [DEMO](https://intl.cloud.tencent.com/document/product/1047/34279) ，快速了解腾讯云 IM Electron SDK。
...
| 继承方式  | 适用场景                                                                                                                                                                |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 使用 DEMO | IM Demo包含完整的聊天功能，代码已开源，如果您需要实现聊天类似场景，可以使用 Demo进行二次开发。可立即体验 [Demo](https://intl.cloud.tencent.com/document/product/1047/34279)。 |
...
>? 该账户仅限开发测试使用，应用上线前，正确的`UserSig` 签发方式是将`UserSig`的计算代码集成到您的服务端，并提供面向 APP的接口。在需要 `UserSig`时由您的 APP 向业务服务器发起请求获取动态 `UserSig`。更多详情请参见 [服务端生成 UserSig](https://intl.cloud.tencent.com/document/product/1047/34385)。
