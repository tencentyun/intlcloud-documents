...
| 集成方式  | 适用场景 |
|---------|---------|
| [使用 DEMO 修改](#part3) | IM Demo 是一个完整的聊天 App，代码已开源，如果您需要实现聊天类似场景，可以使用 Demo 进行二次开发。 可立即 [体验 Demo](https://intl.cloud.tencent.com/document/product/1047/34279)。 |
...
TUIKit 是基于腾讯云 IM SDK 的一款 UI 组件库，它提供了一些通用的 UI 组件，例如会话列表、聊天界面和联系人列表等，开发者可根据实际业务需求通过该组件库快速地搭建自定义 IM 应用。参见 [TUIKit 图文介绍](https://intl.cloud.tencent.com/document/product/1047/50059)。

本部分为快速使用 TUIKit 介绍，详细入门指引可参见 [TUIKit 集成基础功能](https://intl.cloud.tencent.com/document/product/1047/50054)。
...
>?如您需要用到推送能力，还需要添加推送相关权限，详情可查看 [Flutter 厂商消息推送插件集成指南](https://www.tencentcloud.com/document/product/1047/46306)。
...
3. 为方便您获取API报错及建议提醒用户的提示语，此处建议挂载一个 onTUIKitCallbackListener 监听，[详见此部分](https://intl.cloud.tencent.com/document/product/1047/50054#onTUIKitCallbackListener)。
...
final CoreServicesImpl _coreInstance = TIMUIKitCore.getInstance();
 ...
 void initState() {
   _coreInstance.init(
     ...
     onTUIKitCallbackListener:  (TIMCallback callbackValue){}, // [建议配置，详见此部分](https://intl.cloud.tencent.com/document/product/1047/50054#onTUIKitCallbackListener)
...
- [本地搜索](https://intl.cloud.tencent.com/document/product/1047/50036)：`TIMUIKitSearch` 全局搜索组件，支持全局搜索联系人/群组/聊天记录，也支持使用 `TIMUIKitSearchMsgDetail` 在特定会话中搜索聊天记录。两种模式取决于是否传入 `conversation`。

UI 组件全貌可参见 [本图文概览](https://intl.cloud.tencent.com/document/product/1047/50059) 或 [详细文档](https://comm.qq.com/im/doc/flutter/uikit-sdk-api/)。
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/46264)
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/47966)
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/47969)
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/47992)
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/48324)
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/47997)
...
您可以继续完成 [群组](https://intl.cloud.tencent.com/document/product/1047/48169)，[用户资料](https://intl.cloud.tencent.com/document/product/1047/48160)，[关系链](https://intl.cloud.tencent.com/document/product/1047/48157)，[离线推送](https://www.tencentcloud.com/document/product/1047/46306)，[本地搜索](https://intl.cloud.tencent.com/document/product/1047/48135) 等相关功能开发。
...
- TUIKit 的场景码，用于界面弹窗提示，通过 [onTUIKitCallbackListener 监听](https://intl.cloud.tencent.com/document/product/1047/50054#callback) 获得。全部场景码清单，请查看 [该文档](https://intl.cloud.tencent.com/document/product/1047/50054#infoCode)。
