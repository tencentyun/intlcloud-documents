...
|   | 适用场景 |
|---------|---------|
| [使用DEMO](#part3) | IM Demo 是一个完整的聊天 App，代码已开源，如果您需要实现聊天类似场景，可以使用 Demo 进行二次开发。 可立即 [体验 Demo](https://intl.cloud.tencent.com/document/product/1047/34279)。 |
...
TUIKit 是基于腾讯云 IM SDK 的一款 UI 组件库，它提供了一些通用的 UI 组件，例如会话列表、聊天界面和联系人列表等，开发者可根据实际业务需求通过该组件库快速地搭建自定义 IM 应用。参见 [TUIKit 详细介绍](https://intl.cloud.tencent.com/document/product/1047/46576)。
...
详细UI插件指南可参见 [本文档](https://intl.cloud.tencent.com/document/product/1047/46297) 或 [插件 README](https://pub.dev/packages/tim_ui_kit)。
...
[本节详细文档](https://intl.cloud.tencent.com/document/product/1047/48321)
...
### 支持哪些平台？
- 目前 [IM SDK(tencent_im_sdk_plugin)](https://intl.cloud.tencent.com/document/product/1047/46264) 支持 iOS 、Android 和 Web 三个平台，此外 Windows 和 Mac 版正在开发中，敬请期待。
- [TUIKit](https://intl.cloud.tencent.com/document/product/1047/46576) 及 [配套完整版交互 Demo](https://github.com/TencentCloud/TIMSDK/tree/master/Flutter/Demo/im-flutter-uikit) 支持 iOS 及 Android 两个移动平台。
