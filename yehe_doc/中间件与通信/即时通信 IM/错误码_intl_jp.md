...
| 60020  | Premier Editionパッケージの有効期限が切れて、停止されています。[IM購入ページ](https://intl.cloud.tencent.com/document/product/1047/36021)にログインして、パッケージを再購入してください。購入後、5分間で有効になります。|
...
| 72000  | 現在のアプリケーションは体験版であり、1日のアクティブユーザー（DAU）の数が無料利用枠を超えています。この制限を解除するには、アプリケーションをプロフェッショナル版またはフラッグシップ版にアップグレードしてください。具体的な操作方法については、[購入ガイドライン](https://intl.cloud.tencent.com/document/product/1047/36021)をご参照ください。      |
