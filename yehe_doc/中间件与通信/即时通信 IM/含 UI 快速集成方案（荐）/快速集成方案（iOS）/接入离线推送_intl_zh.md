...
集成 TUIOfflinePush 组件之前，需要先向 Apple [申请 APNs 推送证书](https://intl.cloud.tencent.com/document/product/1047/39157)，然后 [上传推送证书到 IM 控制台](https://intl.cloud.tencent.com/document/product/1047/39157) 。之后按照如下步骤操作即可快速接入 IM 离线推送。
