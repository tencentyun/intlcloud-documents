...
## 集成 SDK
1. 下载 SDK 及配套的 [SDK 源码](https://github.com/tencentyun/IMUnrealEngine)。
...
:::
::: Android\s端
开发调试：详见 [Android 快速入门](https://docs.unrealengine.com/4.27/en/SharingAndReleasing/Mobile/Android/GettingStarted/)。
打包项目：详见 [打包 Android 项目](https://docs.unrealengine.com/4.27/en/SharingAndReleasing/Mobile/Android/PackagingAndroidProject/)。
:::
</dx-tabs>
