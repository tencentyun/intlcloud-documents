...
Call the `setC2CReceiveMessageOpt` API ([dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/setC2CReceiveMessageOpt.html)) to set the message receiving option for a one-to-one chat.
...
Call the `getC2CReceiveMessageOpt` API ([dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/getC2CReceiveMessageOpt.html)) to get the message receiving option for a one-to-one chat.
...
Call the `setGroupReceiveMessageOpt` API ([dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/setGroupReceiveMessageOpt.html)) to set the message receiving option for a group chat.
...
Call the `getGroupsInfo` API ([dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/setGroupReceiveMessageOpt.html)) to get the `V2TIMGroupInfo` group profile object list. Here, the `recvOpt` field indicates the message receiving option for the group chat.
