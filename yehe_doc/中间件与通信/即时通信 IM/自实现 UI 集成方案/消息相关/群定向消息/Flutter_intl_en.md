...
2. Call the `createTargetedGroupMessage` API ([dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/im_flutter_plugin_platform_interface/ImFlutterPlatform/createTargetedGroupMessage.html)) to create a targeted message object `V2TimMessage` based on the original message object and specify the list of group members to receive the message.
