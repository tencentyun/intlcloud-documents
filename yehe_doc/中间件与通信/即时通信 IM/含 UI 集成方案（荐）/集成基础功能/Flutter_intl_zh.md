...
- [TIMUIKitSearch](https://intl.cloud.tencent.com/document/product/1047/50036) 本地搜索
...
UI组件全貌可参见 [本全览文档](https://intl.cloud.tencent.com/document/product/1047/46297) 或 [详细文档](https://comm.qq.com/im/doc/flutter/uikit-sdk-api/)。
...
### 支持哪些平台？
- [IM SDK(tencent_im_sdk_plugin)](https://intl.cloud.tencent.com/document/product/1047/46264) 支持 iOS 、Android 和 Web 三个平台。（从 tencent_im_sdk_plugin 4.1.1+2 版本起支持WEB）
- [TUIKit](https://intl.cloud.tencent.com/document/product/1047/46576) 及 [配套完整版交互 Demo](https://github.com/TencentCloud/TIMSDK/tree/master/Flutter/Demo/im-flutter-uikit) 支持 iOS 、Android 和 Web 三个平台。（从 tim_ui_kit 0.1.4 版本起支持WEB）
...
欢迎查看 [直播间搭建指南](https://intl.cloud.tencent.com/document/product/1047/49589#.E7.BE.A4.E7.B1.BB.E5.9E.8B.E9.80.89.E6.8B.A9)，基于腾讯云 IM/TRTC/腾讯云直播，搭建一套完整的直播间系统。

### 错误码如何查询？

- IM SDK 的 API 层面错误码，请查看 [错误码](https://intl.cloud.tencent.com/document/product/1047/34348)。
