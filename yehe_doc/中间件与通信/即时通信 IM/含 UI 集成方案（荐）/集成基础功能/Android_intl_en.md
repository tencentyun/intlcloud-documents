...
<table style="text-align:center;vertical-align:middle;width: 800px">
  ...
  <tr>
	...
	- When an **offline** user receives a call invitation, offline push is required if the app call UI needs to be woken up. For the implementation of offline push, see the next step.
...
## FAQs
1. What should I do when I receive the message "Manifest merger failed : Attribute application@allowBackup value=(true) from AndroidManifest.xml"?
...
2. What should I do when I receive the message "NDK at /Users/***/Library/Android/sdk/ndk-bundle did not have a source.properties file"?
...
3. What should I do when I receive the message "Cannot fit requested classes in a single dex file"?
