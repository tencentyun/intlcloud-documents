- ﻿TUIKit supports modular integration starting from version 5.7.1435. You can integrate modules for integration according to your needs.
  ...
  > 1. If you want to learn more, you can [download and run TUIKitDemo source code](https://github.com/TencentCloud/TIMSDK/tree/master/iOS), where you can find samples of frequently used features.
