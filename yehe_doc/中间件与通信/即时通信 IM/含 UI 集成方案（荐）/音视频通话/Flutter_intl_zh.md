...
- [TRTC SDK](https://intl.cloud.tencent.com/document/product/647/39169)：使用 TRTC SDK 作为低延时音视频通话组件。
- [IM SDK](https://intl.cloud.tencent.com/document/product/1047/40124)：使用 IM SDK 发送和处理信令消息。
音视频通话界面如下图所示：
