...
## 常见问题
1、如何搜索自定义消息
您需要使用接口 [createCustomMessage:desc:extension](https://im.sdk.qcloud.com/doc/en/categoryV2TIMManager_07Message_08.html#a4395ae33520dcf53da3190d56931852d) 来创建并发送自定义消息，把需要搜索的文本放到 `desc` 参数中。
