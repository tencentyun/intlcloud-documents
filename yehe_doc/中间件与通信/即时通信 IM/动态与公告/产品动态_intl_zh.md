...
<tr>
    <td> SDK 7.0.3754 增强版本发布</td>
    <td><ul style="margin:0">
    <li> 所有消息类型都可支持 @ 群成员 </li>
    <li> 支持按照会话的 filter 获取未读总数 </li>
    <li> 普通群和直播群支持群计数器 meta counter </li>
    <li> 支持文本消息翻译 </li> 
    <li> 社群支持群自定义属性 </li>     
    <li> 离线推送支持华为的 category 和小米的 channel ID 设置 </li>
    <li> 更多更新内容请参见 <a href="https://intl.cloud.tencent.com/document/product/1047/34282">更新日志</a></li>    
        </ul></td>
    <td> 2023-01-06 </td>
...
<tr>
    <td> 本地审核功能上线</td>
    <td>本地审核功能，全称“客户端本地文本审核”，通过在客户端本地完成敏感词的拦截或者替换，实现过滤敏感词的效果。可用于拦截/替换在发送文本消息、修改昵称/备注/群公告等操作中产生的、不希望被发送的文本敏感词。</td>
    <td> 2022-12-07 </td>
    <td> <a href="https://www.tencentcloud.com/document/product/1047/52497">内容审核</a></td>
</tr> 
</table>
...
<tr><th width="20%">动态名称</th>  <th width="44%">动态描述</th><th width="15%">发布时间</th><th width="21%">相关文档</th>
    ...
    <tr>
    <td> SDK 6.9.3557 增强版本发布</td>
    <td><ul style="margin:0">
    <li> 修复 Android 从消息中获取 V2TIMOfflinePushInfo 内容偶现的崩溃问题 </li>
    <li> 修复 Android 增强版 pro 偶现的崩溃 </li>
    <li> 完善 C 接口 TIMConvGetConvList 返回的 json 数据内容 </li>
    <li> 发布全新的简约版主题，更加符合国际化 App 的风格 </li>    
        </ul></td>
    <td> 2022-11-29 </td>
    <td> <a href="https://intl.cloud.tencent.com/document/product/1047/33996">终端 SDK 下载</a></td>
</tr>
    <tr>
    <td> SDK 6.8.3374 增强版本发布</td>
    <td><ul style="margin:0">
    <li> 支持客户端本地文本审核 </li>
    <li> 发布 Swift 版本 SDK </li>
    <li> 支持普通群的群属性功能 </li>
    <li> 优化普通群有人进出后，群成员人数的更新逻辑 </li>     
    <li> 修复单独设置好友自定义字段不会下发通知的问题 </li>
...
<tr>
    <td> SDK 6.7.3184 增强版本发布</td>
    <td><ul style="margin:0">
    <li> 支持消息扩展 </li>
    <li> 支持信令编辑 </li>
    <li> iOS 离线推送支持 VoIP </li>
    <li> Android 离线推送支持荣耀手机 </li> 
    <li> 接入层增加备份域名 </li>     
    <li> 修复特殊网络环境下，无法执行登录、登出回调的问题 </li>
    <li> 更多更新内容请参考 <a href="https://intl.cloud.tencent.com/document/product/1047/34282">更新日志</a></li>    
        </ul></td>
    <td> 2022-09-29 </td>
    <td> <a href="https://intl.cloud.tencent.com/document/product/1047/33996">终端 SDK 下载</a></td>
...
<tr>
    ...
    <td>
        ...
        更多更新内容请参见 <a href="https://intl.cloud.tencent.com/document/product/1047/34282">更新日志</a>。
    </td>
    <td> 2020-11-05 </td>
    <td> <a href="https://intl.cloud.tencent.com/document/product/1047/33996">SDK 下载</a></td>
</tr>
...
更多更新内容请参考 <a href="https://intl.cloud.tencent.com/document/product/1047/34282">更新日志</a>。</td>
<td> 2020-09-18 </td>
<td> <a href="https://intl.cloud.tencent.com/document/product/1047/33996">SDK 下载</a></td>
</tr><tr>
...
<td> 2020-09-04 </td>
<td> <a href="https://intl.cloud.tencent.com/document/product/1047/33996">SDK 下载 </td>
</tr>
</table>
...
<td>2019-11-04</td>
<td><a href="https://intl.cloud.tencent.com/document/product/1047/34350">价格说明</a></td>
</tr> </table>
...
<td>2019-10-22</td>
<td><ul style="margin:0;">
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34577">创建并升级应用</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34540">基本配置</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34419">功能配置</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34578">群组管理</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34520">回调配置</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34579">统计分析</a></li>
    <li><a href="https://intl.cloud.tencent.com/document/product/1047/34580">开发辅助工具</a></li></ul></td>
</tr><tr>
