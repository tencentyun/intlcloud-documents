...
**示例二、返回一个文本消息的 JSON 示例。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)、[TextElem](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例三、返回一个群通知消息的 JSON 示例。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)、[GroupReportElem](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例四、返回一个群提示消息的 JSON 示例。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)、[GroupTipsElem](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
| 参数            | 类型              | 含义                                                         |
| --------------- | ----------------- | ------------------------------------------------------------ |
| conv_event      | enum TIMConvEvent | 会话事件类型，请参考 [TIMConvEvent](https://intl.cloud.tencent.com/document/product/1047/34551) |
...
| 参数      | 类型                  | 含义                                                         |
| --------- | --------------------- | ------------------------------------------------------------ |
| status    | enum TIMNetworkStatus | 网络状态，请参考 [TIMNetworkStatus](https://intl.cloud.tencent.com/document/product/1047/34551) |
...
| 参数      | 类型             | 含义                                                         |
| --------- | ---------------- | ------------------------------------------------------------ |
| level     | enum TIMLogLevel | 日志级别，请参考 [TIMLogLevel](https://intl.cloud.tencent.com/document/product/1047/34551) |
...
**示例一、接口 [TIMSetConfig](https://intl.cloud.tencent.com/document/product/1047/34388) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [SetConfig](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例二、接口 [TIMConvCreate](https://intl.cloud.tencent.com/document/product/1047/34557) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [ConvInfo](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例三、接口 [TIMConvGetConvList](https://intl.cloud.tencent.com/document/product/1047/34557) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [ConvInfo](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例四、接口 [TIMMsgSendNewMsg](https://intl.cloud.tencent.com/document/product/1047/34391) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例五、接口 [TIMMsgFindByMsgLocatorList](https://intl.cloud.tencent.com/document/product/1047/34391) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例六、接口 [TIMMsgGetMsgList](https://intl.cloud.tencent.com/document/product/1047/34391) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [Message](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例七、接口 [TIMMsgDownloadElemToPath](https://intl.cloud.tencent.com/document/product/1047/34391) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [MsgDownloadElemResult](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例八、接口 [TIMMsgBatchSend](https://intl.cloud.tencent.com/document/product/1047/34391) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [MsgBatchSendResult](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例九、接口 [TIMGroupCreate](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [CreateGroupResult](https://intl.cloud.tencent.com/document/product/1047/34551)。**
...
**示例十、接口 [TIMGroupInviteMember](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GroupInviteMemberResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十一、接口 [TIMGroupDeleteMember](https://intl.cloud.tencent.com/document/product/1047/34393member) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GroupDeleteMemberResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十二、接口 [TIMGroupGetJoinedGroupList](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GroupBaseInfo](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十三、接口 [TIMGroupGetGroupInfoList](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GetGroupInfoResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十四、接口 [TIMGroupGetMemberInfoList](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GroupGetMemberInfoListResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十五、接口 [TIMGroupGetPendencyList](https://intl.cloud.tencent.com/document/product/1047/34393) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [GroupPendencyResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十六、接口 [TIMProfileGetUserProfileList](https://intl.cloud.tencent.com/document/product/1047/34558) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [UserProfile](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十七、接口 [TIMFriendshipGetFriendProfileList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendProfile](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十八、接口 [TIMFriendshipAddFriend](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例十九、接口 [TIMFriendshipDeleteFriend](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十、接口 [TIMFriendshipHandleFriendAddRequest](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十一、接口 [TIMFriendshipGetPendencyList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [PendencyPage](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十二、接口 [TIMFriendshipDeletePendency](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十三、接口 [TIMFriendshipCheckFriendType](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendshipCheckFriendTypeResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十四、接口 [TIMFriendshipCreateFriendGroup](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十五、接口 [TIMFriendshipGetFriendGroupList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendGroupInfo](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十六、接口 [TIMFriendshipModifyFriendGroup](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十七、接口 [TIMFriendshipAddToBlackList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十八、接口 [TIMFriendshipGetBlackList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendProfile](https://intl.cloud.tencent.com/document/product/1047/34551)**
...
**示例二十九、接口 [TIMFriendshipDeleteFromBlackList](https://intl.cloud.tencent.com/document/product/1047/34559) 的回调 TIMCommCallback 参数 json_params 的 JSON。JSON Key 请参考 [FriendResult](https://intl.cloud.tencent.com/document/product/1047/34551)**
