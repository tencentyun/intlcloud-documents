...
>?发送方发送消息，接收方调用接口 [TIMMsgReportReaded](https://intl.cloud.tencent.com/document/product/1047/34391) 上报该消息已读，发送方 IM SDK 会通过此接口设置的回调抛出。
...
>?用户票据，可能会存在过期的情况，如果用户票据过期，此接口设置的回调会调用。[TIMLogin](https://intl.cloud.tencent.com/document/product/1047/34390) 也将会返回70001错误码。开发者可根据错误码或者票据过期回调进行票据更换。
