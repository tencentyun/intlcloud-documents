...
|-----|-----|-----|
| cb | TIMCommCallback | Callback function for indicating whether the friend list is obtained. For more information about the callback function definition, see [TIMCommCallback](https://intl.cloud.tencent.com/document/product/1047/34550). |
...
This API is used to search for friends.
