...
| Conversation | [Conversation](https://web.sdk.qcloud.com/im/doc/en/Conversation.html) has two values:<li> C2C (client to client): A one-to-one conversation between only two users.</li><li> GROUP: A group conversation among group members.</li> |
...
| API | Description |
| --- | --- |
| [getJoinedCommunityList](https://web.sdk.qcloud.com/im/doc/en/SDK.html#getJoinedCommunityList) | Gets the list of joined topic-enabled communities. |
...
| [updateTopicProfile](https://web.sdk.qcloud.com/im/doc/en/SDK.html#updateTopicProfile) | Updates the topic profile. |
