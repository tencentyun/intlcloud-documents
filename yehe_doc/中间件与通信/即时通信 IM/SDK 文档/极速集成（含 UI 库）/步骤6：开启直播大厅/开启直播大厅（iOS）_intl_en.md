...
Room lists can vary, and we do not provide an example of how to build a room list at the backend. You can see [`TUILiveRoomManager`](https://github.com/tencentyun/TIMSDK/blob/master/iOS/Demo/TUIKitDemo/Scenes/Data/TUILiveRoomManager.m) in the demo to implement the logic by which the client reports the room list.
