`TUIKit`组件在`5.0.10`以上版本开始支持直播大厅功能，并且支持 iOS 和 Android 平台的互通 ，直播大厅的实现需要额外集成`TUIKitLive`组件，请参考 [步骤2：配置工程文件](#step2) 。
...
初始化`TUIKit`需要传入 [步骤1](#Step1) 生成的 SDKAppID，并调用 `login` 登录，其中 UserSig 生成的具体操作请参见 [如何计算 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。
...
>!  更多关于 TRTC 旁路直播的介绍，可以查看 [实现 CDN 直播观看](https://intl.cloud.tencent.com/document/product/647/35242) 和  [云端混流服务](https://intl.cloud.tencent.com/document/product/647/34618)。
