...
- 要启用回调，必须配置 URL，本条回调协议和群组资料变动之后回调协议的控制台开关为同一个，配置方法详见 [第三方回调配置](https://intl.cloud.tencent.com/document/product/1047/34520) 文档。
...
- REST API：[修改话题资料](https://intl.cloud.tencent.com/document/product/1047/49468)
