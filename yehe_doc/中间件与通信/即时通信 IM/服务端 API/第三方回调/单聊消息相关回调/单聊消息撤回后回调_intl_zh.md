...
- App 用户通过客户端撤回单聊消息。
- App 管理员通过 REST API [admin_msgwithdraw 接口](https://intl.cloud.tencent.com/document/product/1047/35015) 撤回单聊消息。
...
- REST API：[撤回单聊消息](https://intl.cloud.tencent.com/document/product/1047/35015)