- ## 功能说明
  ...
  - App 管理员通过 REST API [admin_set_msg_read 接口](https://intl.cloud.tencent.com/document/product/1047/38996) 设置单聊消息已读。
  ...
  **示例：**
  ...
  - REST API：[设置单聊消息已读](https://intl.cloud.tencent.com/document/product/1047/38996)
