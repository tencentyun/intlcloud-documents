...
1. 登录即时通信 IM [控制台](https://console.cloud.tencent.com/im)。
 >?如果您还没有应用，请先 [创建应用](https://intl.cloud.tencent.com/document/product/1047/34553)，然后执行 [步骤2](#step2)。
[](id:step2)
...
| Objective-C | iOS | [GenerateTestUserSig.h](https://github.com/tencentyun/TIMSDK/blob/master/iOS/Demo/TUIKitDemo/Debug/GenerateTestUserSig.h) | 
...
| Javascript | 小程序 | [GenerateTestUserSig.js](https://github.com/tencentyun/TIMSDK/blob/master/MiniProgram/Demo/static/utils/GenerateTestUserSig.js) | 
...
|  userbuf | 即时通信 IM 中均默认使用不带 UserBuf 的接口，即该参数默认填写为`null`。<br>实时音视频的部分使用场景中可能需要使用带 UserBuf 的接口，例如进房时，具体介绍请参见 [进房权限保护](https://intl.cloud.tencent.com/document/product/647/35157)。 |
