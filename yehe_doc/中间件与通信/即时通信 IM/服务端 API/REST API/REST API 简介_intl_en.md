...
| xxxxxx  |   Exclusive domain name | The country/region where your SDKAppID is located.<li>China:  `console.time.qq.com `<li>Singapore:  `adminapisgp.im.qcloud.com `<li>Seoul: `adminapikr.im.qcloud.com`<li>Frankfurt: `adminapiger.im.qcloud.com` |
