...
>!此接口仅支持获取中国大陆地区的所有 IM 接入方式的 IP 地址或 IP 网段信息。（如需获取国外 IP 或者指定接入方式 IP，您可 [联系我们](https://intl.cloud.tencent.com/document/product/1047/41676) 申请开通该功能，申请后我们将对您的需求进行评估，需求评估合理后您方可使用该功能）。
