...
| v4/group_open_http_svc/get_group_muted_account  | 请求接口                             |
...
|TopicId|String|选填|话题的 ID，若具有此选项表示需要获取的是话题中被禁言的群成员列表，仅支持话题的社群适用此选项|
...
通过 [REST API 在线调试工具](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/group_open_http_svc/get_group_muted_account) 调试本接口。
