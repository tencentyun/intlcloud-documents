...
>? Audio-video group member unbanning is supported by SDK Enhanced edition v6.6 or later and web SDK v2.22.0 or later. To use it, you need to [purchase the Ultimate edition](https://www.tencentcloud.com/document/product/1047/34577), go to the [**console**](https://console.cloud.tencent.com/im/qun-setting), choose **Feature configuration** > **Group configuration** > ** Group feature configuration**, and disable **Audio-video group member banning**.
