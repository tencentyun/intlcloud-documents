...
- This API does not check whether the senders and the recipients are friends or blocklisted by either party or whether the senders are muted.
...
|90004 |The MsgSeq field in the JSON request packet is invalid. |
