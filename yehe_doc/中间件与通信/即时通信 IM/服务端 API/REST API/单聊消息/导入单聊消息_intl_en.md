...
|---------|---------|----|---------|
| SyncFromOldSystem | Integer | Yes | Valid values: `2` and `5`. <br/>`2`: Imports historical messages, marks them as read and does not push them to the client.<br/>`5`: Imports real-time messages, marks them as unread and pushes them to the client.|
