...
>! 该功能仅对旗舰版客户开放，需 [购买旗舰版](https://www.tencentcloud.com/document/product/1047/34577) 并在 [**控制台**](https://console.cloud.tencent.com/im/qun-setting)>**登录与消息**>**群消息已读回执** 打开开关后方可使用。
