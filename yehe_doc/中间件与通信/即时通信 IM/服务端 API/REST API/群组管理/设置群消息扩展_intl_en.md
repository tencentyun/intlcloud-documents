## Feature Overview
App admins and group members can configure message extension for ordinary group messages. Message extension is a set of custom key-value pairs.
...
Configure message extension for the group message with message sequence number 158 
```
{
...
Delete message extension for the group message with message sequence number 158
```
{
    "GroupId": "@TGS#1YMVAB3IZ",
    "MsgSeq": 158,
...
Clear all message extension for the group message with message sequence number 158
```
{
    "GroupId": "@TGS#1YMVAB3IZ",
    "MsgSeq": 158,
...
| MsgSeq | Integer | Yes | Sequence number of the group message to be configured |
| OperateType | Integer | Yes | `1`: Setting key-value pairs for a message extension; `2`: Deleting certain key-value pairs for a message extension; `3`: Clearing all key-value pairs for a message extension |
...
| 23002 | The group message does not support message extension. |
