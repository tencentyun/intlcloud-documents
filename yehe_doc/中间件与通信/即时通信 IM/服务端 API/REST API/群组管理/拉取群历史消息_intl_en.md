...
| IsFinished | Integer | Whether all the requested messages are returned.<li>`1`: All the requested messages are returned.</li><li>`0`: Not all requested messages are returned because the messages are too long or the number of messages is greater than 20.</li><li>`2`: The requested messages are too long or the number of messages is greater than 20 and all the messages have expired.</li> |
