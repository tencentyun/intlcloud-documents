...
| DeleteType  |  String | 选填  | 删除模式，默认删除单向好友，详情可参见 [删除好友](https://intl.cloud.tencent.com/document/product/1047/33521)  |
...
## 接口调试工具
通过 [REST API 在线调试工具](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/sns/friend_delete_all) 调试本接口。
