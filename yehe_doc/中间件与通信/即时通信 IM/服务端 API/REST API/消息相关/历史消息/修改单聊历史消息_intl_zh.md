...
- 待修改的单聊消息的 MsgKey 可通过以下方式获取：
	- 开启 [发单聊消息之前回调](https://intl.cloud.tencent.com/document/product/1047/34364) 或 [发单聊消息之后回调](https://intl.cloud.tencent.com/document/product/1047/34365)，通过该回调接口记录每条单聊消息的 MsgKey 。
	- 通过 [查询单聊消息](https://intl.cloud.tencent.com/document/product/1047/35478) 查询出待修改的单聊消息的 MsgKey 。
	- 通过 REST API [单发单聊消息](https://intl.cloud.tencent.com/document/product/1047/34919) 和 [批量发单聊消息](https://intl.cloud.tencent.com/document/product/1047/34920) 接口发出的单聊消息，回包里会返回消息的 MsgKey 。
...
| MsgBody | Array |选填| 消息内容，具体格式请参考 [消息格式描述](https://intl.cloud.tencent.com/document/product/1047/33527)（注意，一条消息可包括多种消息元素，MsgBody 为 Array 类型）  |
