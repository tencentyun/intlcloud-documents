...
| 计费模式            | 提供**包年包月**计费模式，具体价格见 [购买页](https://buy.tencentcloud.com/tdmq?protocol=RocketMQ&rid=1&clusterType=profession) | 提供**按量计费**模式，具体价格见 [购买页](https://buy.tencentcloud.com/tdmq?protocol=RocketMQ&rid=1&clusterType=profession) |
