...
<dx-alert infotype="notice" title="">
 1. Currently, only `2.2.5-RocketMQ-RC1` and `2.2.5.RocketMQ.RC2` support **namespace** configuration. If you use other versions, you need to concatenate topic and group names.
    The format is as follows:
			- Cluster ID|namespace name%topic name: rocketmq-pngrpmxxxxxx|stream%topic
			- Cluster ID|namespace name%group name: rocketmq-pngrpmxxxxxx|stream%group
...
<td align="left">Topic name, which can be copied under the <strong>Topic</strong> tab on the cluster details page in the console.</td>
</tr>
<tr>
