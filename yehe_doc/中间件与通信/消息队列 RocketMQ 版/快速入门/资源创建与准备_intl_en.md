...
1. Log in to the [TDMQ console](https://console.cloud.tencent.com/tdmq/rocket-cluster), enter the **Cluster** page, and select the target region.
2. Click **Create Cluster** and enter the cluster name and description to create a cluster.
...
2. Select the namespace created in [step 3](#step3) and click **Create** to create a topic.
