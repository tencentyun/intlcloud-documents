...
1. 在集群中创建 [命名空间](https://intl.cloud.tencent.com/document/product/1113/43123)，并获取接入地址，得到服务端的连接信息。
2. 在集群中创建 [角色](https://intl.cloud.tencent.com/document/product/1113/43126) 并授予该命名空间的生产消费权限。
3. 在命名空间中创建 [Topic](https://intl.cloud.tencent.com/document/product/1113/43124)。
4. 按照 [SDK 文档](https://www.tencentcloud.com/document/product/1113/45953) 的提示编写 Demo，配置上连接信息，进行消息的生产和消费。
