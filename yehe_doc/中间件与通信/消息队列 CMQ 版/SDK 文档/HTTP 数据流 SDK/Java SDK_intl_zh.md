...
## 队列模型
### 操作步骤
1. 在控制台创建符合需求的队列服务，参见 [创建队列服务](https://intl.cloud.tencent.com/document/product/1111/42994)。
2. 引入 CMQ 客户端相关依赖。
<dx-codeblock>
:::  xml
<!-- cmq sdk -->
...
<tr>
<td>queueName </td>
<td>队列名称，在 <a href = "https://console.intl.cloud.tencent.com/tdmq">TDMQ CMQ 版控制台</a> 的<b>队列服务</b>列表页面获取。</td>
</tr>
</table> 
4. 消费消息。
<dx-codeblock>
...
### 操作步骤
1. 在控制台创建资源。
   1. 在控制台创建主题，参见 [主题管理](https://intl.cloud.tencent.com/document/product/1111/43000)。
   2. 给主题创建一个订阅者，参见 [订阅管理](https://intl.cloud.tencent.com/document/product/1111/43001)。
2. 引入 CMQ 客户端相关依赖。
<dx-codeblock>
:::  xml
<!-- cmq sdk -->
