## 操作场景
本文主要介绍消息队列 CMQ 版控制流接口列表和 SDK 使用方式。数据流（收发消息相关）接口请参见 [HTTP 数据流 API 概述](https://intl.cloud.tencent.com/document/product/1111/46396)。
...
#### 1. 登录 [云 API 控制台](https://console.intl.cloud.tencent.com/api/explorer)。
