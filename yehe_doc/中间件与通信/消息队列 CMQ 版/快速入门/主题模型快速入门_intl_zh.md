...
- 消息过滤类型：
  - 标签：CMQ提供生产、订阅的消息标签匹配能力，可用于消息过滤。详细规则参见 [标签键匹配功能说明](https://intl.cloud.tencent.com/document/product/1111/43003)。
...
<tr>
<td>topicName </td>
<td>主题订阅名称，在 <a href = "https://console.intl.cloud.tencent.com/tdmq">TDMQ CMQ 版控制台</a> 的<b>主题订阅</b>列表页面获取。</td>
</tr>
</table>
4.  发送 TAG 类型消息。
<dx-codeblock>
