...
- Authorization Header的组成可参考 [密钥对认证](https://intl.cloud.tencent.com/document/product/628/11819)，多种语言生成签名的样例可参考 [多种语言生成签名](https://intl.cloud.tencent.com/document/product/628/35255)。
