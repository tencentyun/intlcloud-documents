...
- Authorization Header的组成可参见 [密钥对认证](https://intl.cloud.tencent.com/document/product/628/11819)，多种语言生成签名的样例可参见 [多种语言生成签名](https://intl.cloud.tencent.com/document/product/628/40460)。
