...
1. 在 [API 网关控制台](https://console.cloud.tencent.com/apigateway/index?rid=1)，创建一个 API，选择鉴权类型为“免鉴权”（参考 [创建 API 概述](https://intl.cloud.tencent.com/document/product/628/11795)）。
