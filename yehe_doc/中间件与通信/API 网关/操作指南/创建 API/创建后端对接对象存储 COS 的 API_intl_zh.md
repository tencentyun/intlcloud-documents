...
## 前提条件
- 已完成 API 网关 [服务创建](https://intl.cloud.tencent.com/document/product/628/11787)。
- 已完成对象存储 COS [存储桶创建](https://intl.cloud.tencent.com/document/product/436/13309) 和 [对象上传](https://intl.cloud.tencent.com/document/product/436/13321)。
