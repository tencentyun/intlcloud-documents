...
该任务指导您通过云原生网关快速将部署在 [云服务器 CVM](https://intl.cloud.tencent.com/products/cvm) 内的服务对第三方开放出来。

## 前提条件

- 准备一台 [云服务器 CVM](https://console.cloud.tencent.com/cvm/instance)（参考 [创建实例](https://intl.cloud.tencent.com/document/product/213/36302)），部署在 VPC 内作为后端服务，以下简称为“后端 CVM”。
- 已创建类型为 Kong 的云原生网关（参考 [创建云原生网关](https://intl.cloud.tencent.com/document/product/628/47414)），创建的云原生网关必须和后端 CVM 处于同一地域和同一 VPC 下。
