...
>?关于实例类型的选择，请参见 [实例选择指南](https://intl.cloud.tencent.com/document/product/628/40305)。
>
...
- 您可以参见 [API 网关插件使用文档](https://intl.cloud.tencent.com/document/product/628/40213)，为后端对接 TEM 的 API 网关 API 绑定插件，以享受 API 网关提供的高级功能。
