**为使用腾讯云 API 网关服务（以下简称“本服务”），您应当阅读并遵守《API 网关服务等级协议》（以下简称“本协议”），以及《[腾讯云服务协议](https://intl.cloud.tencent.com/document/product/301/9248)》。本协议包含本服务的术语和定义、服务可用性、赔偿方案、免责条款等相关内容。请您务必审慎阅读、充分理解各条款内容，限制、免责条款或者其他涉及您重大权益的条款可能会以加粗、加下划线等形式提示您重点注意**。
