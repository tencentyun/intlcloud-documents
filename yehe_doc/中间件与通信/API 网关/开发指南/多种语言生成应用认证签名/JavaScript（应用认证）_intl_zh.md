...
1. 在 [API 网关控制台](https://console.cloud.tencent.com/apigateway/index?rid=1)，创建一个 API，选择鉴权类型为“应用认证”（参考 [创建 API 概述](https://intl.cloud.tencent.com/document/product/628/11795)）。
...
- 应用生命周期管理，以及 API 向应用授权、应用绑定 API 等操作请您参考 [应用管理](https://intl.cloud.tencent.com/document/product/628/40306)。
- 应用生成签名过程请您参考 [应用认证方式](https://intl.cloud.tencent.com/document/product/628/40304)。
