...
1. 在 [API 网关控制台](https://console.cloud.tencent.com/apigateway/index?rid=1)，创建一个 API，选择鉴权类型为“应用认证”（参见 [创建 API 概述](https://intl.cloud.tencent.com/document/product/628/11795)）。
2. 将 API 所在服务发布至发布环境（参见 [服务发布与下线](https://intl.cloud.tencent.com/document/product/628/11809)）。
...
- 应用生命周期管理，以及 API 向应用授权、应用绑定 API 等操作请您参见 [应用管理](https://intl.cloud.tencent.com/document/product/628/40306)。
- 应用生成签名过程请您参见 [应用认证方式](https://intl.cloud.tencent.com/document/product/628/40304)。
...
更多相关详情可下载参见 [项目示例](https://bruceppeng-1300555551.cos.ap-nanjing.myqcloud.com/%E5%9B%BD%E5%AF%86hmac_sm3%E7%AE%97%E6%B3%95.zip)。
<dx-codeblock>
:::  go
package main
