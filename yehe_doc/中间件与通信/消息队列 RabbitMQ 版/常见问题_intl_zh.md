...
您可以参考 [快速入门](https://intl.cloud.tencent.com/document/product/1112/43069) 和 [操作指南](https://intl.cloud.tencent.com/document/product/1112/43072) 文档，快速上手并使用 TDMQ RabbitMQ 版。

### TDMQ RabbitMQ 版有哪些应用场景？
TDMQ RabbitMQ 版 。详细说明请参考 [应用场景](https://intl.cloud.tencent.com/document/product/1112/43062) 文档。

### 如何申请使用 TDMQ RabbitMQ 版？
TDMQ RabbitMQ 版目前为内测阶段，您可以填写内测申请 开通使用。
