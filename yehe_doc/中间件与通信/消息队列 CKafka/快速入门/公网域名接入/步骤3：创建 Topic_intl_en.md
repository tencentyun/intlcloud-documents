...
2. On the **Instance List** page, click the **ID/Name** of the instance created in [Step 1. Create an Instance](https://intl.cloud.tencent.com/document/product/597/40044) to enter the instance details page.
