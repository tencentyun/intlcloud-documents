...
> !
>- Deleting a topic will also delete the messages stored in the topic. Proceed with caution.
...
| retention.bytes                | The message retention size of the instance | 1 MB–1024GB    | Message retention size at the topic level. If both the message retention time and message retention size are configured for a topic, message retention will be subject to the first threshold it reaches. |
