...
通用转储模板适用于 Elasticsearch、PostgreSQL、MySQL 等通用转储场景。通过 [Ckafka触发器](https://intl.cloud.tencent.com/document/product/583/17530) 触发将消息转储至各个场景。通用模板默认将不开启 Ckafka 触发器，选择通用模板需跳转云函数或本地使用  [SCF 通用模板](https://github.com/tencentyun/scf-demo-repo/tree/master/Python2.7-CkafkaTriggerTemplate) 进行代码编辑，请创建完成后在消息转储列表跳转到云函数控制台修改相关代码并开启 Ckafka 触发器。
 ...
 ## 场景实践
 [消息转储至对象存储（COS）](https://intl.cloud.tencent.com/document/product/597/36186)
 [消息转储至 Elasticsearch](https://intl.cloud.tencent.com/document/product/597/36187)
 [消息转储至云数据库MySQL（CDB）](https://intl.cloud.tencent.com/document/product/597/36394)
