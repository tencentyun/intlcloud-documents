...
| 路由类型 | VPC 网络                                                     | 公网域名接入                                                 |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 接入方式 | <li>PLAINTEXT</li><li>SASL_PLAINTEXT</li><li>SASL_SSL（仅专业版实例支持）</li><li>SASL_SCRAM（仅 2.4.1 版本实例支持，存量实例需要 <a href = "https://console.intl.cloud.tencent.com/workorder/category">提交工单</a> 申请）</li> | <li>SASL_PLAINTEXT</li><li>SASL_SSL（仅专业版实例支持）</li> |
