...
参见 [创建HTTP上报接入点 ](https://intl.cloud.tencent.com/document/product/597/46807)在 Datahub 控制台创建一个 HTTP 接入点，获取到标识上报 EndPoint 的DatahubId。
...
数据发送成功后，可以在消息查询页面，查看数据是否发送成功，详情参见 [消息查询](https://intl.cloud.tencent.com/document/product/597/39719)。
