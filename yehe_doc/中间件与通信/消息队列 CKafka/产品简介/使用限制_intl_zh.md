...
<table>
    ...
    <tr>
        <td>Topic 总数量</td>
        <td>根据产品规格不同固定上限，详情可参见 <a href='https://intl.cloud.tencent.com/document/product/597/11745'>计费概述</a>。</td>
    </tr>
    <tr>
        <td>Partition 数量</td>
        <td>
    ...
    <tr>
        ...
        <td>
          ...
          <li>专业版实例级别 Consumer group 数量建议不超过200个，支持 <a href='https://intl.cloud.tencent.com/contact-sales'>联系我们</a>
            申请升级。</li>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <li>标准版客户端实例最大连接数量为5000，专业版客户端实例最大连接数量为10000，实例连接超过该最大值会导致客户端无法创建新的连接，如评估该最大值在实际业务中不合理可以 <a
                    href='https://intl.cloud.tencent.com/contact-sales'>联系我们</a> 申请扩大。
            </li>
        </td>
    </tr>
    <tr>
...
- 我们会尽量保证如下两种情况：
  1. 单实例每月生产低耗时占比，和 [该实例的 SLA ](https://intl.cloud.tencent.com/document/product/597/41815) 保持一致。
  2. 单实例每月消费低耗时占比，和 [该实例的 SLA ](https://intl.cloud.tencent.com/document/product/597/41815) 保持一致。
- 比例计算公式如下：
