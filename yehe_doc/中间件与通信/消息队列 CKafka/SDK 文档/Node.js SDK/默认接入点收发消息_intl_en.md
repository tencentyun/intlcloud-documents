...
This document describes how to access the default access point of CKafka to receive/send messages with the SDK for Node.js in a VPC.
...
| topic_name | Topic name, which can be obtained on the **Topic Management** page in the CKafka console. |
