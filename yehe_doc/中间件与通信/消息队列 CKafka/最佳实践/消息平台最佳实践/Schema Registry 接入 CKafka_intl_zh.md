...
- 已 [创建实例](https://intl.cloud.tencent.com/document/product/597/39718)。
...
运行一段时间后，在 [CKafka 控制台](https://console.intl.cloud.tencent.com/ckafka) 的**topic管理**页面，选择对应的 Topic ，单击**更多** > **消息查询**，查看刚刚发送的消息。
...
在 [CKafka 控制台](https://console.intl.cloud.tencent.com/ckafka) 的**Consumer Group**页面，选择 schema消费组名称，在主题名称输入 Topic 名称，单击**查询详情**，查看消费详情。
