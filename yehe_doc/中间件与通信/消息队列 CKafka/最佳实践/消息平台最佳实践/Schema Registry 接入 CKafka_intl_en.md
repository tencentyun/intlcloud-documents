...
4. After running the script for a while, go to the [CKafka console](https://console.intl.cloud.tencent.com/ckafka), select the **Topic Management** tab on the instance details page, select the topic, and click **More** > **Message Query** to view the message just sent.
...
On the **Consumer Group** tab page in the [CKafka console](https://console.intl.cloud.tencent.com/ckafka), select the consumer group named `schema`, enter the topic name, and click **View Consumer Details** to view the consumption details.
