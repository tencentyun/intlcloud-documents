...
>?输入参数校验要求总体与 [发信接口](https://intl.cloud.tencent.com/document/product/1084/39408) 保持一致：包含收件人邮箱数量，邮件正文大小，附件格式，附件大小等限制。

## 返回参数
SMTP 接口无返回参数，仅支持返回 err 信息。若返回 nil，则标识调用接口成功，但实际发信不一定成功，获取邮件的发送状态可参见 [获取邮件发送的状态](https://intl.cloud.tencent.com/document/product/1084/39502)。
...
### 其他业务报错
您可参见 [发送邮件](https://intl.cloud.tencent.com/document/product/1084/39408) 中错误码描述。
