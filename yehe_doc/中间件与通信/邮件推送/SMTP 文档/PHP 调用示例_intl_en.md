...
1. We recommend you use the PHPMailer package:
 ...
 - If your project is an old one and does not use composer, you need to manually import [PHPMailer](https://github.com/PHPMailer/PHPMailer).
2. For the service address and port, see [SMTP Service Address](https://intl.cloud.tencent.com/document/product/1084/44457).
