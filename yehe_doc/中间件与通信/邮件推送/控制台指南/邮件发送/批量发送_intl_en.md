## Overview
This document describes how to batch send emails in the console. Batch sending is suitable for large-scale emailing scenarios and supports configuring different variables for different recipients. Recipients can see only themselves in the "To" field of the email.
...
>?The number and names of variables in the recipient group selected on the sending task page must be the same as those in the selected template.
...
>?
>
>- The **Batch** feature in the console is suitable for batch sending marketing or notification emails. To send trigger-based emails (such as authentication and transactional emails), we recommend you call the `SendEmail` API.
>- The automatic warm-up feature is built in batch sending. For more information, see [Getting Started > What is warm-up?](https://intl.cloud.tencent.com/document/product/1084/42368).
