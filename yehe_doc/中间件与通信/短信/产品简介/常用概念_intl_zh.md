...
## 短信签名
短信签名是位于短信正文前【】中的署名，用于标识公司或业务，例如【腾讯科技】。申请时企业用户需要上传资质证明，个人用户需要上传个人身份证明。短信签名需要审核通过后才可使用。短信签名审核标准请参阅 [签名审核标准](https://intl.cloud.tencent.com/document/product/382/40658)。
**签名示例：**
...
短信模板申请前需要先申请短信签名，短信模板需要审核通过后才可使用。短信模版审核标准请参见 [正文模板审核标准](https://intl.cloud.tencent.com/document/product/382/40659)。
**短信模版示例：**
