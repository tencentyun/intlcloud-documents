...
1. On the
   ...
   - Status/Reason: status of the signature, including **pending review**, **rejected**, and **approved**. If the signature status is **rejected**, you can click **View Failure Reason and Modify** to view the detailed reason or suggestion.
