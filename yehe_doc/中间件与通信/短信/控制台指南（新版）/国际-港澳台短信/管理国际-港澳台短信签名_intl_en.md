...
2. Select **Global SMS** > **Signatures** on the left sidebar and click **Create Signature**.
...
1. On the [Signatures](https://console.cloud.tencent.com/smsv2/csms-sign) page, you can view the signature information.
