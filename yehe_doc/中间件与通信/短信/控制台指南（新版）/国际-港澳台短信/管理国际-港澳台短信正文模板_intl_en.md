...
2. Select **Global SMS** > **Body Templates** on the left sidebar and click **Create Body Template**.
...
1. On the [Body Templates](https://console.cloud.tencent.com/smsv2/isms-template) page, you can view the body template information.
 ...
 - Application Time: the time when the body template was created.
...
1. On the [Body Templates](https://console.cloud.tencent.com/smsv2/isms-template) page, click **Delete** on the line of the target body template.
