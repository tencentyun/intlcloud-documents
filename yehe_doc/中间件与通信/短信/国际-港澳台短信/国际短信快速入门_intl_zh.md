本文以企业认证用户创建一个名为“TEST”的应用，并使用该应用向境外手机用户发送`[Tencent Cloud]Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`为例，帮助您了解如何快速使用国际/港澳台短信服务。更多短信相关的概念，请参见 [常用概念](https://intl.cloud.tencent.com/document/product/382/13299)。
...
>为了不影响使用体验，我们强烈建议2019年9月18日前申请开通短信服务的用户尽快 升级至新版控制台。

## 步骤1：开通短信服务
### 注册腾讯云账号
- 如果您还没有腾讯云账号，您需要 [注册腾讯云](https://intl.cloud.tencent.com/document/product/378/17985) 账号，并完成 [企业实名认证](https://intl.cloud.tencent.com/document/product/378/10496)，未进行实名认证的用户无法购买中国境内的资源。
- 如果您已有实名认证的腾讯云账号，请直接进行下一步操作。

### 申请开通短信服务
>?首次登录短信控制台时，需要申请开通短信服务。

登录 [短信控制台](https://console.cloud.tencent.com/sms)，勾选【我已阅读并同意 腾讯云短信 服务协议】，单击【开始接入】即可开通。
...
2. 选择【国际/港澳台短信】>【短信内容配置】>【短信签名】，单击【创建签名】。
3. 结合实际情况设置以下参数：
 - 签名类型：选择【公司】。
...
2. 选择【国际/港澳台短信】>【短信内容配置】>【短信正文】，单击【创建正文模板】。
3. 结合实际情况设置以下参数：
 - 模板名称：输入`验证码`。
 - 短信类型：选择【普通短信】。
...
您通过控制台或 [API](https://intl.cloud.tencent.com/document/product/382/34689) 发送短信，本文以使用控制台为例。
...
- 单击目标应用名称【TEST】进入应用详情页，选择【国际/港澳台短信】>【统计分析】，您可以查看当前应用下所有国际/港澳台短信的数据记录以及相关分析。
