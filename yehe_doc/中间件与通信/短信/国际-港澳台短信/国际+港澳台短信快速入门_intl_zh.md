本文以企业认证用户向境外手机用户发送`Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`为例，帮助您了解如何快速使用国际/港澳台短信服务。更多短信相关的概念，请参见 [常用概念](https://intl.cloud.tencent.com/document/product/382/13299)。
...
2. 结合实际情况和 [正文模板审核标准](https://intl.cloud.tencent.com/document/product/382/40659) 设置以下参数：
 - 模板名称：输入`验证码`。
 - 短信类型：选择【普通短信】。
...
您通过控制台或 [API](https://intl.cloud.tencent.com/document/product/382/40463) 发送短信，本文以使用控制台为例。
