...
请检查模板是否含有违禁内容，具体违禁行业和内容请参考 [正文模板审核标准](https://intl.cloud.tencent.com/document/product/382/40659)。

### 我如何知道短信哪些是能发的，哪些是不能发的？

请参考 [签名审核标准](https://intl.cloud.tencent.com/document/product/382/40658) 和 [正文模板审核标准](https://intl.cloud.tencent.com/document/product/382/40659)，根据相关规范申请签名与模板。
...
更多详情请参见 [变量规范](https://intl.cloud.tencent.com/document/product/382/40659#variable)。
...
如果您急需使用短信功能，请[提交工单](https://console.cloud.tencent.com/workorder/category) ，我们会加速审核进度。
对于审核通过的内容模版，不表示一定会下发成功（运营商侧也会有抽查审核机制），如遇到短信发送失败，可 [提交工单](https://console.cloud.tencent.com/workorder/category) 详细沟通。
