...
请参考 签名审核标准 和 正文模板审核标准，根据相关规范申请签名与模板。
...
如果您急需使用短信功能，请咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773)，我们会加速审核进度。如果审核未通过，也可咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773) 详细沟通。
对于审核通过的内容模版，不表示一定会下发成功（运营商侧也会有抽查审核机制），如遇到短信发送失败，可咨询 [sms helper](https://intl.cloud.tencent.com/document/product/382/3773) 详细沟通。
