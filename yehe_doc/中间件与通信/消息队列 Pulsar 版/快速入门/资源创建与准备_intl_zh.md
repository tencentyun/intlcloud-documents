...
> ?更多集群相关介绍与操作请参见 [集群管理](https://intl.cloud.tencent.com/document/product/1110/42928)。

### 步骤2：创建命名空间

在 TDMQ Pulsar 版控制台的 **[命名空间](https://console.cloud.tencent.com/tdmq/env)** 页面，选择好地域和刚刚创建好的集群，单击**新建**，创建一个命名空间。
...
1. 在 **[Topic 管理](https://console.cloud.tencent.com/tdmq/topic)** 页面，在顶部选择目标地域、当前集群和命名空间，单击**新建**，创建一个 Topic。
