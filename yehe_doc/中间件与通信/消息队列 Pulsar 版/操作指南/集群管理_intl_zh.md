...
- **专业集群**：  独占物理资源，数据安全，使用几乎无限制，未达到使用要求会额外计算资源占用费。

> ?
>
> - 当前暂不提供专业集群资源，正式商业化后开启申请。届时将通过邮件、短信的方式，提前1个月通知各位开发者。
> - 当前集群存在多个版本，详细说明请参见 [集群版本更新记录](https://intl.cloud.tencent.com/document/product/1110/42898)。
...
3. 在新建集群对话框，选择需要创建的集群类型并设置集群的相关属性：
   ...
   - 资源标签：设置资源标签，关于标签的详细介绍请参见 [标签管理](https://intl.cloud.tencent.com/document/product/1110/42939)。
4. 单击**确定**完成所在地域环境的创建。
...
2. 在集群中创建 [命名空间](https://intl.cloud.tencent.com/document/product/1110/42929)。 
3. 在集群中创建 [角色](https://intl.cloud.tencent.com/document/product/1110/42936) 并授予该命名空间的生产消费权限。
4. 在命名空间中创建 [Topic](https://intl.cloud.tencent.com/document/product/1110/42930)。 
5. 按照 [SDK 文档](https://intl.cloud.tencent.com/document/product/1110/42945) 的提示编写 Demo，配置上链接信息和密钥，进行消息的生产和消费。
