...
推送服务 debug 模式下，过滤关键字 “OtherPush”，查看相关返回码日志（例如 `[OtherPush_XG_MI] register failed, errorCode: 22022, reason: Invalid package name: com.xxx.xxx`），并前往 [厂商通道注册失败排查指南](https://intl.cloud.tencent.com/document/product/1024/37006) 查找对应原因，获取解决办法。
