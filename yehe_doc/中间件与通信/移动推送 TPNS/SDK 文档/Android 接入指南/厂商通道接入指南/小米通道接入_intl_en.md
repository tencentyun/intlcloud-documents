...
1. Go to the **[Push Platform](https://admin.xmpush.xiaomi.com/)** to obtain `balabala`, sign up for a Mi developer account, and get three key parameters of `AppId`, `AppKey`, and `AppSecret`. For more information, see [Quick Connection Guide](https://dev.mi.com/console/doc/detail?pId=708).
2. Copy the application's `AppID`, `AppKey`, and `AppSecret` and paste them into **[TPNS console](https://console.cloud.tencent.com/tpns)** > **Configuration Management** > **Basic Configuration** > **Mi Official Push Channel**.
...
If you need to get parameters through the click callback or redirect to a custom page, you can use the intent to do so. For more information, see [FAQs for Android](https://intl.cloud.tencent.com/document/product/1024/32624).
