...
- Android：支持图片、音频。
- iOS：支持图片、音频、视频。
>?iOS 平台 TPNS 通道默认支持富媒体推送功能，APNs 通道需要 App 集成 [通知服务扩展插件](https://intl.cloud.tencent.com/document/product/1024/30730)。
...
详情可参见 [Push API 必要参数](https://intl.cloud.tencent.com/document/product/1024/33764) 说明。
