...
2. 前往 **App 推送管理** > **用户属性管理**，单击**新建用户属性**。
...
- iOS SDK 进行用户属性的设置，详情请参见 [用户属性设置](https://intl.cloud.tencent.com/document/product/1024/30727) 文档。
- Android SDK 进行用户属性的设置，详情请参见 [用户属性设置](https://intl.cloud.tencent.com/document/product/1024/30715) 文档。

#### 方式2： 通过 Rest API 绑定：

API 绑定方式可参考 [个性化推送相关 API](https://intl.cloud.tencent.com/document/product/1024/38571) 说明。

## 开始使用

### 控制台使用

1. 前往 **App 推送管理** > **推送任务**页面，单击新建推送。
...
4. 插入完成后，单击**测试预览**，确认信息无误后单击**发送确认**即可完成带用户属性的个性化推送。
...
其它消息字段说明可参考 API [消息体说明](https://intl.cloud.tencent.com/document/product/1024/33764)。
