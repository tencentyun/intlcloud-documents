...
| account_type | Integer | 否 | 账号类型，绑定时可选择账号类型，默认类型为account_type:0，取值可参考 [账号类型取值表](https://intl.cloud.tencent.com/document/product/1024/40598)|
...
| 参数名 | 类型 | 参数说明 |
| -------------- | ------- | ---------------------------------------- |
| ret_code | Integer | 错误码，详细参照 [错误码对照表](https://intl.cloud.tencent.com/document/product/1024/33763)。|
| err_msg | String | 错误信息|
