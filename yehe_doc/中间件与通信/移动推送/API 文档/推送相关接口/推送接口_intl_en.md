...
>- If the frequency is exceeded, a push exception may occur. If you need a higher frequency, [submit a ticket](https://console.cloud.tencent.com/workorder/category) for assistance.
>
...
| message       | Object  | Yes                     | Message body. For more information, see [message body type](#message.3A-message-body).                     |
