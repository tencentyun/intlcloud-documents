...
采用 AccessId 和 SecretKey 进行 Basic Auth 认证鉴权，密钥容易被获取，安全性不高，推荐使用 [签名认证](https://intl.cloud.tencent.com/document/product/1024/34213)。



## 获取密钥
1. 登录 [移动推送控制台](https://console.cloud.tencent.com/tpns)，选择左侧菜单**配置管理 > 基础配置**。
