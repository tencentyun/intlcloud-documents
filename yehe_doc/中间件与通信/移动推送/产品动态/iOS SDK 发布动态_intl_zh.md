...
<table>
 ...
 <tr>
	 ...
	 <td>  
		 ...
		 <li> 修复：修复了 App 跳转导致 移动推送 在线状态偶尔不准确的问题</li>
		 <li>增加：增加了使用应用内消息作为补推的能力</li>
	 </td>
	 <td>2021-08-26</td>
	 <td><li><a href="https://console.cloud.tencent.com/tpns/sdkdownload">SDK 下载</a></li>
		<li><a href="https://intl.cloud.tencent.com/document/product/1024/40597">升级指南 </a></li>
	 </td>
 </tr>
 </table>
...
<table>
 <tr>
	 ...
	 <td>  
			...
			<li> 修复：用户 iCloud 备份还原，两台设备具有同样 移动推送Token 问题</li>
	 ...
	 <td>2021-06-01</td>
	 <td><a href="https://intl.cloud.tencent.com/document/product/1024/40597">升级指南 </a></td>
 </tr>
 </table>
...
<table>
 ...
 <li>修复：1.2.5.2以前版本，可能出现 移动推送 token 重复的问题
 <li>修复：可能建立长连接失败的问题
...
<tr>
    ...
    <tr>
        <td>SDK 1.2.8.0 版本发布</td>
				<td><li> 新增「<b>用户属性</b>」相关接口，用于个性化推送</li><li> 新增「<b>应用内消息</b>」功能，以及若干应用内消息模板</li><li>支持通过 移动推送自建通道下发消息</li><li>修复已知问题</li></td>
        <td>2020-09-27</td>
        <td>-</li></td>
    </tr>        
</table>
...
<tr>
    ...
    <tr>
        ...
        <td><li> 提升稳定性，修复已知问题</li><li> 优化接入，新增注册回调方法</li><li>新增 移动推送自建通道，若 APNs 通道下发消息失败，将通过 移动推送自建通道进行消息补发</li><li>优化数据统计</li></td>
        <td>2020-05-06</td>
        <td><a href="https://intl.cloud.tencent.com/document/product/1024/30726">注册回调方法</a></li></td>
    </tr>        
</table>
...
<tr>
    ...
    <tr>
        ...
        <td>2020-03-19</td>
        <td><a href="https://intl.cloud.tencent.com/document/product/1024/30727">注销信鸽平台推送服务</a></td>
    </tr>
    <tr>
...
<tr>
    ...
    <tr>
        ...
        <td> 修复 SDK 获取 移动推送 Token 的问题</li></td>
        <td>2019-11-22</td>
        <td>-</td>
    </tr>
    <tr>
...
<tr>
    ...
    <tr>
        ...
        <td><li> 新增查询 移动推送 服务生成的 Token 接口</li><li> 修复单账号绑定失败的问题</li></td>
        <td>2019-08-08</td>
        <td>-</td>
    </tr>
</table>
