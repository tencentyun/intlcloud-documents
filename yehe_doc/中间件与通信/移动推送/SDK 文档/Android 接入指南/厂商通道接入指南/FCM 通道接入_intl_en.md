...
2. Legacy server key
Register the application at the [FireBase official website](https://firebase.google.com/?hl=zh-cn). Select **Firebase Projects** > ** Select a Project App** > **Settings** > **Cloud Messaging** to get the **Server Key** of the FCM app push, and enter the key in the [**Tencent Push Notification Service console**](https://console.cloud.tencent.com/tpns) > **Configuration Management** > **Basic Configuration** > **FCM Push Channel**.
