The server monitoring page displays the monitoring overview of all servers in the current cluster and the list of all nodes. It supports viewing heat maps of all servers.
...
2. Select **Server Monitoring** to view the monitoring information of all servers in the cluster.
...
![](https://main.qcloudimg.com/raw/93af4a6b4942e95a7fa4e79932ba4bb8.png)
