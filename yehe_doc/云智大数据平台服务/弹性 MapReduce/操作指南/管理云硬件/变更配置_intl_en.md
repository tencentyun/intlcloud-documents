## Operation Scenarios
This document describes how to adjust the instance configuration in the [EMR Console](https://console.cloud.tencent.com/emr).

## Directions
1. Log in to the [EMR Console](https://console.cloud.tencent.com/emr) and select **Cloud Hardware Management** in the left sidebar.
2. Select the instance to be adjusted based on your business needs and node type and click **Adjust configuration** in the **Operation** column.
