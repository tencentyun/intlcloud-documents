...
| Update | Description | Document |
| ---------------------- | ----------------------------------------------------- | ------------------------------------------------------------ |
| EMR supports cloud disk encryption | EMR allows whitelisted CBS users to select cloud disk encryption when creating an EMR cluster | [Cloud Disk Encryption](https://intl.cloud.tencent.com/document/product/362/33139) |
| Task nodes supports mounting multiple cloud disks | Task nodes supports mounting cloud disks when a cluster is created or scaled |   -   |
...
| Update | Description | Document |
| ---------- | ------------------------------------------------------------ | -------- |
| New models are available | The I3 model is available in the Beijing, Shanghai, and Guangzhou regions. This model is a CVM whitelist model, and you can purchase it only if you are in the I3 model whitelist | - |
