...
- 使用 TCP 协议连接 ES 集群的 Transport Client 官方已经不再维护，建议使用 HTTP 协议连接集群的 Java High Level Client 或者 Java Low Level Client 。详请参考 elastic 官方文档 [由 TransportClient 迁移至 Java High Level Client](https://www.elastic.co/guide/en/elasticsearch/client/java-rest/5.6/java-rest-high-level-migration.html)。
