...
- 对腾讯云帐户下资源的 CAM 访问管理（参见 [CAM 访问控制配置](https://intl.cloud.tencent.com/document/product/845/19550)）
...
对于已开启 [ES 集群用户登录认证](https://intl.cloud.tencent.com/document/product/845/35275) 的集群，用户将获得更多安全管理功能。白金版还可以进一步支持基于文档、字段级别的细粒度访问控制，详情请参考 Elastic 官网文档 [基于角色的访问控制](https://www.elastic.co/guide/en/elasticsearch/reference/current/authorization.html) 。
