...
For more information, please see [Special Inspection on ICP Filing Information](https://cloud.tencent.com/document/product/243/39385).
...
1. Log in to the Tencent Cloud Console, enter the [person-in-charge contact number inspection](https://console.cloud.tencent.com/beian/phone-number-verification) page, and click **Verify** in the "Operation" column as shown below:
![](https://main.qcloudimg.com/raw/625fac262bef96f9e73f7e3d0eda8d17.png)
2. Click **Send Verification Code** and enter the code received on your phone as shown below:
>If the website has multiple persons-in-charge, they all need to be verified.
>
...
You are recommended to rectify any incorrect ICP filing information as soon as possible based on the inspection opinions; otherwise, your website may not be accessed normally due to violation of applicable laws and regulations caused by false ICP filing information. If your ICP filing is canceled for transfer or deregistered, please take appropriate actions as instructed in [ICP Filing Transfer Application](https://cloud.tencent.com/document/product/243/37403) or [First-time ICP Filing Application](https://cloud.tencent.com/document/product/243/37402).
...
>Currently, you may not be able to apply for another ICP filing for certain domain names and launch them for access from nodes in Mainland China after their ICP filings are deregistered. For domain name suffixes for which ICP filing can be applied for, please see [Domain Name Suffixes Available for ICP Filing Application](https://cloud.tencent.com/document/product/243/18905#.E5.8F.AF.E5.A4.87.E6.A1.88.E7.9A.84.E5.9F.9F.E5.90.8D.E5.90.8E.E7.BC.80).
...
- If the phone number of the website's person-in-charge has been changed or cannot be reached, but the ICP filing information has been registered at another access service provider too, you can change the ICP filing information and modify the phone number at that provider. If there are no other access service providers for the ICP filing information, you need to [deregister the shell entity](https://intl.cloud.tencent.com/document/product/1022/31686) and submit a [first-time ICP filing application](https://cloud.tencent.com/document/product/243/37402) again.
- If the phone number of the website's person-in-charge can be reached, please follow the [requirements of provincial communications administration bureau](https://intl.cloud.tencent.com/document/product/1022/31671) for your ICP filing.
 - If the province where your ICP filing resides does not allow rectification after transfer, you need to [deregister the shell entity](https://intl.cloud.tencent.com/document/product/1022/31686) and submit a [first-time ICP filing application](https://cloud.tencent.com/document/product/243/37402) again.
 - If the province where your ICP filing resides allows rectification after transfer, you can submit an [ICP filing transfer application](https://cloud.tencent.com/document/product/243/37403) through Tencent Cloud. After the application is approved, your website can be normally accessed again. After successfully applying for ICP filing transfer, please submit an [ICP filing change application](https://cloud.tencent.com/document/product/243/37406).
...
If you fail to rectify your ICP filing information in the rectification period and fail to apply for ICP filing transfer long after it is canceled, please log in at [MIIT's website](http://www.beian.miit.gov.cn/publish/query/indexFirst.action?spm=a2c4g.11186623.2.90.7c37224457xNXe&file=indexFirst.action) and use your entity name to query whether there is entity information without website information.
 - If there is entity information without website information, you need to [deregister the shell entity](https://intl.cloud.tencent.com/document/product/1022/31686) and submit a [first-time ICP filing application](https://cloud.tencent.com/document/product/243/37402) again.
 - If there is no ICP filing information, you can submit a [first-time ICP filing application](https://cloud.tencent.com/document/product/243/37402) through Tencent Cloud. After the application is approved, your website can be normally accessed again.
 - If there is entity information with information of other websites, you can submit an [ICP filing application for new website (original ICP filing obtained outside Tencent Cloud)](https://cloud.tencent.com/document/product/243/37405).
