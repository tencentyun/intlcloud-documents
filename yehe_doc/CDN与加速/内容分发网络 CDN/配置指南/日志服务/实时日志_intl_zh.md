...
为启用实时日志服务，请先开通 [日志服务（CLS）](https://console.cloud.tencent.com/cls/search?region=ap-shanghai) 并授权 CDN 以创建日志集。
...
>- CLS 日志集为收费服务，该费用由日志服务收取，CDN 日志投递功能不收费，详细的计费标准请参见：[日志集计费概述](https://intl.cloud.tencent.com/document/product/614/37509)。
...
日志检索支持多种类型的检索分析方式及图表分析形式，详细说明可见 [日志检索](https://www.tencentcloud.com/document/product/614/12503)。
