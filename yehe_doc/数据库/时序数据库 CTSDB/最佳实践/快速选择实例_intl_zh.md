时序数据库 CTSDB 支持快速配置和自定义配置两种选择模式，下面分别详细叙述。建议您主要从三个方面需求来考虑如何选择合适的实例规格：性能需求、容量需求、其他要求。实例性能请参考 [产品性能](https://intl.cloud.tencent.com/document/product/1100/40938)。
