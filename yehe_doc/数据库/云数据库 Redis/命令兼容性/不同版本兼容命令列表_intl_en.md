...
The following table lists the versions and architectures supported by different commands. &#10003; indicates "supported", x indicates "unsupported", and - indicates that cross-slot access is not applicable to the command:
- For more information on custom commands, see [Memory Edition (Cluster Architecture)](https://intl.cloud.tencent.com/document/product/239/18336).
- For more information on command compatibility of Memory Edition (Cluster Architecture), see [Memory Edition (Cluster Architecture)](https://intl.cloud.tencent.com/document/product/239/18336).
