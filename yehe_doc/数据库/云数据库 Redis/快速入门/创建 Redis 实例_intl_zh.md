...
您可根据本文的介绍，购买和配置您的第一台 [云数据库 Redis](https://intl.cloud.tencent.com/document/product/239/3205) 实例。 
...
1. 使用腾讯云账号登录 [Redis 购买页](https://buy.intl.cloud.tencent.com/redis)。
2. 请参见下表的参数解释，根据您的实际需求选择实例配置。
   ...
   <tr>
   <td>计费模式</td>
   <td>支持<b>按量计费</b>，如何选择计费方式，请参见 <a href="https://intl.cloud.tencent.com/document/product/239/31954">计费概述</a>。</td></tr>	
   <tr>
   <td>地域</td>
   ...
   <tr>
   <td>兼容版本</td>
   <td>基于开源 Redis 引擎的高性能版本，兼容 Redis 6.0版本、5.0版本、4.0版本、2.8版本。2.8版暂停售卖，建议您选择4.0及以上版本，如需购买2.8、6.0版本请 <a href="https://intl.cloud.tencent.com/document/product/239/31959">提交工单</a>申请。</td></tr>	 
   <tr> 
       <td>架构版本</td>
   <td>4.0及以上版本支持标准架构、集群架构，2.8版本仅支持标准架构。产品架构详情，请参见 <a href="https://intl.cloud.tencent.com/document/product/239/31959">标准架构</a>与 <a href="https://intl.cloud.tencent.com/document/product/239/18336">集群架构</a>。</td></tr>
   <tr>
   <td>内存容量</td>
...
<td>网络类型</td>
   ...
   <tr>
   <td>购买数量</td>
   <td>按量计费每个地域配额最大数量为100台，每个实例配额最大数量为30台。</td></tr> 
   </tbody></table>
3. 确认参数配置无误，单击**立即购买**，提示购买成功，单击**前往控制台**，返回实例列表，待实例状态显示为**运行中**，即可正常使用。

## 后续操作

使用云服务器 CVM 直接访问云数据库的内网地址，请参见 [连接 Redis 实例](https://intl.cloud.tencent.com/document/product/239/9897)。

## 相关操作

#### 变更实例规格

您可根据业务所处的实际情况灵活调整 Redis 实例的规格，从而更好满足资源充分利用和成本实时优化等需求。 具体操作，请参见 [变更实例规格](https://intl.cloud.tencent.com/document/product/239/31934)。

#### 为实例指定项目

已指定项目的实例也可重新指定到其他项目。具体操作，请参见 [为实例指定项目](https://intl.cloud.tencent.com/document/product/239/31933)。
...
#### 重置实例访问密码
 ...
 如果您忘记默认账号的密码或需更新旧密码时，可直接对密码进行重置。 具体操作，请参见 [重置密码](https://intl.cloud.tencent.com/document/product/239/46557)。

#### 升级实例

- Redis 支持低版本实例向高版本升级，也支持跨版本升级，具体操作，请参见 [升级实例版本](https://intl.cloud.tencent.com/document/product/239/37710)。
- Redis 提供了标准架构升级至集群架构的功能 ，具体操作，请参见 [升级实例架构](https://intl.cloud.tencent.com/document/product/239/37860)。

#### 欠费说明

开通云数据库 Redis 后，请确保您的账户余额充足。账户余额不足可能导致欠费甚至实例被回收，请参见 [欠费说明](https://intl.cloud.tencent.com/document/product/239/31956)。

## 相关 API

| 接口名称                                                     | 接口功能         |
| :----------------------------------------------------------- | :--------------- |
| [CreateInstances](https://intl.cloud.tencent.com/document/product/239/32069) | 创建 Redis 实例    |
| [ModifyInstance](https://intl.cloud.tencent.com/document/product/239/32057) | 修改实例相关信息 |
