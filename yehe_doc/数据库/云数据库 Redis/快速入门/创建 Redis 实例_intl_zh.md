...
1. 登录 [Redis 购买页](https://buy.intl.cloud.tencent.com/redis)，根据您的实际需求选择配置，确认无误后，单击**立即购买**。
 ...
 - **架构版本**：4.0及以上版本支持标准架构、集群架构，2.8版本仅支持标准架构。
 - **内存容量**：单节点的内存容量可选范围为256MB - 64GB。
...
## 后续步骤
- 使用云服务器 CVM 直接访问云数据库的内网地址，请参见 [连接 Redis 数据库](https://intl.cloud.tencent.com/document/product/239/9897)。
