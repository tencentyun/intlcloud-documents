...
Follow the directions below to purchase pay-as-you-go TencentDB for Redis instances on the [purchase page](https://buy.intl.cloud.tencent.com/redis) in the console.

### Pay-as-you-go
1. Log in to the [TencentDB for Redis purchase page](https://buy.intl.cloud.tencent.com/redis).
...
For more information on how to purchase TencentDB for Redis instances via an API, please see [CreateInstances](https://intl.cloud.tencent.com/document/product/239/32069).
