...
### 问题原因
数据库含有多 key 操作或有事务操作，涉及跨 slot 操作。具体信息，请参见 [标准架构迁移集群架构检查](https://intl.cloud.tencent.com/document/product/239/37594)。
...
### 解决方法
- 排查源端网络环境是否存在问题。具体操作，请参见 [连接 DB 检查](https://intl.cloud.tencent.com/document/product/571/42552)。
- 清理源端数据库存在的大 key。具体操作，请参见 [内存分析](https://intl.cloud.tencent.com/document/product/239/47576) 快速查找大key，评估并进行删除。
...
### 解决方法
扩容代理带宽或者串行执行迁移任务。具体操作，请参见 [带宽调整](https://intl.cloud.tencent.com/document/product/239/46560)。
