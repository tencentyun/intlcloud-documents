...
Redis 4.0 版本能够体验更灵活的规格配置，更高的性能以及更完善的功能，我们将协助您尽快将 Redis 旧集群版实例升级至 Redis 4.0 内存版（标准架构）或4.0内存版（集群架构），请参见 [Redis 内存版（标准架构）](https://intl.cloud.tencent.com/document/product/239/31959) 和 [Redis 内存版（集群架构）](https://intl.cloud.tencent.com/document/product/239/18336)。
...
- 已安装好数据导入工具 redis-port，工具使用说明和下载地址请参见 [工具介绍](https://intl.cloud.tencent.com/document/product/239/31940)。
