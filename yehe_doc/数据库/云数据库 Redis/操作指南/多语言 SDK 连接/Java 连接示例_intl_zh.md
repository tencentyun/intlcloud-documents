...
## 准备工作
- 在 [Redis 控制台](https://console.cloud.tencent.com/redis) 的**实例详情**页面的**网络信息**区域，获取连接数据库的**内网IPv4地址**及端口。具体信息，请参见 [查看实例详情](https://intl.cloud.tencent.com/document/product/239/47923)。
- 已获取访问数据库的账号与密码。具体操作，请参见 [管理账号](https://intl.cloud.tencent.com/document/product/239/34590)。
- 下载客户端 [Jedis](https://github.com/xetorthio/jedis/wiki/Getting-started)，推荐使用最新版本。
- 如果使用 SSL 加密方式连接数据库，请 [开通 SSL 加密](https://intl.cloud.tencent.com/document/product/239/48048)，获取 SSL 认证证书文件。
