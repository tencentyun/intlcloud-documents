...
- 版本说明
 ...
 - 存量已有实例：
   - 兼容版本为2.8，可根据需要升级兼容版本至4.0、5.0或6.0，才能开通 SSL 加密。具体操作，请参见 [版本升级](https://intl.cloud.tencent.com/document/product/239/37710)。
   - 兼容版本为4.0、5.0、6.0，需升级代理版本至5.6.0才能支持。具体操作，请参见 [代理升级](https://intl.cloud.tencent.com/document/product/239/47582)。
- 架构说明
标准架构与集群架构均支持 SSL 加密。
...
7. 等待**加密状态**显示为**已开通**，单击**下载证书**。
8. 等待**开启 SSL** 的状态为**已开启**，单击**下载证书**。
9. 在页面左下角，将获取到的证书 **-crt.zip** 放在服务端，使用 SSL 加密方式访问数据库。
客户端 Java 代码连接示例，请参见 [Java 连接示例](https://intl.cloud.tencent.com/document/product/239/7043)；客户端 Python 程序代码连接示例，请参见 [Python 连接示例](https://intl.cloud.tencent.com/document/product/239/7045)。
