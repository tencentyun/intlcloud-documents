...
- 已创建数据库实例，且已配置基础网络或私有网络。具体操作，请参见 [创建实例](https://intl.cloud.tencent.com/document/product/239/37712)。
- 已创建待切换的私有网络环境。具体操作，请参见 [创建私有网络](https://intl.cloud.tencent.com/document/product/215/31805)。
...
| API 接口                                                      | 接口含义         |
| ------------------------------------------------------------ | ---------------- |
| [ModifyNetworkConfig](https://intl.cloud.tencent.com/document/product/239/32056) | 修改实例网络配置 |
