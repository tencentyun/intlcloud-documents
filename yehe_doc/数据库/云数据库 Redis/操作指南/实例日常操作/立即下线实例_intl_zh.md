...
主动退还实例或者按量计费实例账户余额不足时，实例均被移入在回收站保留，若数据已完成备份，且确认不再需要时，在保留期内可立即释放实例所有资源，从而避免资源浪费。
...
| 接口名称                                                     | 接口含义           |
| ------------------------------------------------------------ | ------------------ |
| [CleanUpInstance](https://intl.cloud.tencent.com/document/product/239/32071) | 回收站实例立即下线 |
