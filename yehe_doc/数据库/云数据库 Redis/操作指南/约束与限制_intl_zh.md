...
云数据库 SQL Server 实例分为三个版本，即基础版、双机高可用版、集群版实例。不同系列支持的功能不同，详见 [功能概览及差异](https://intl.cloud.tencent.com/document/product/238/46495)。
...
<tr><td>数据库最大数量（<a href="https://intl.cloud.tencent.com/document/product/238/2021" target="_blank">与实例 CPU 核数相关</a>）</td><td>2017版：340<br>2019版：340</td><td>2008 R2版：70<br>2012、2014、2016版：300</td><td>400</td></tr>
...
## 数据库数量[](id:SJKSL)
>!
>- 当高可用版和集群版数据库数量大于100时，必须要设置参数 max worker threads 的值为20000。如果使用默认值0，则无法创建数量100以上的数据库。设置方法请参见 [设置实例参数](https://intl.cloud.tencent.com/document/product/238/41609)。
