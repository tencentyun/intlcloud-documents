...
## 前提条件
- 已 [创建全球复制组](https://intl.cloud.tencent.com/document/product/239/45603)，且复制组状态为**运行中**。
- 已 [给复制组添加实例](https://intl.cloud.tencent.com/document/product/239/45603)，且实例状态为**运行中**。
