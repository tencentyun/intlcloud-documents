...
## 前提条件
- 云数据库 Redis 实例 [已销毁](https://intl.cloud.tencent.com/document/product/239/31937)。
- 腾讯云账户余额充足。
...
>?因 Redis 的内存数据库特性，若需使用批量恢复实例功能，请通过 [提交工单](https://console.cloud.tencent.com/workorder/category) 发起提单申请。
