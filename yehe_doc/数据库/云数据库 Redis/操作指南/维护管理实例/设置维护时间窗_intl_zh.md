...
| API 接口                                                      | API 解释                |
| ------------------------------------------------------------ | ---------------------- |
| [DescribeMaintenanceWindow](https://intl.cloud.tencent.com/document/product/239/37833) | 查询实例维护时间窗     |
| [ModifyMaintenanceWindow](https://intl.cloud.tencent.com/document/product/239/37832) | 修改实例维护时间窗时间 |
