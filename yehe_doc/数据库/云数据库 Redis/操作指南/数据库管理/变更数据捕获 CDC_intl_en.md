...
2. On the instance management page, select the **Database Management** tab, select the row of the target database, and click **Other** > **Enable/Disable CDC** in the **Operation** column.
...
You can view the task progress of enabling or disabling CDC through **Current Task** in the top-right corner of the **Database Management** tab.
