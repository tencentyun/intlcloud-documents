...
- 慢查询分析经常作为数据库性能优化的重要依据，[数据库智能管家 DBbrain](https://intl.cloud.tencent.com/document/product/1035/36027) 是腾讯云推出的一款为用户提供数据库性能优化、安全、管理等功能的数据库自治云服务。 云数据 Redis 慢日志接入DBbrain 进行分析统计。

## 计费说明

[数据库智能管家 DBbrain](https://intl.cloud.tencent.com/document/product/1035/36027) 的慢日志分析 ，其目前处于公测阶段，您可以免费试用。 具体信息，请参见其 [购买指南](https://intl.cloud.tencent.com/document/product/1035/36023)。
...
2. 在**数据库智能管家 DBbrain** 的**诊断优化**所在**慢日志分析**页面，选择查询时间段，根据需求查看实例级别或 Proxy 级别的慢日志信息。
![](https://qcloudimg.tencent-cloud.cn/raw/43fb18ccf043ae9cc8f5bb67de399673.png)

## 相关 API
| API 接口                 | API 描述                                                      |
| ----------------------- | ------------------------------------------------------------ |
| [DescribeSlowLog](https://intl.cloud.tencent.com/document/product/239/33294) | 查询实例慢查询记录 |
| [DescribeProxySlowLog](https://intl.cloud.tencent.com/document/product/239/38626) | 查询代理慢查询 |
