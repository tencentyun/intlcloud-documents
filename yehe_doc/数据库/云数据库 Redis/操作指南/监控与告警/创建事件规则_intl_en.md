...
- [Message push](https://intl.cloud.tencent.com/document/product/1108/46779) (supported by rules only in the Tencent Cloud service event bus)
- [CLS](https://intl.cloud.tencent.com/document/product/1108/46992)
- [SCF](https://intl.cloud.tencent.com/document/product/1108/46254)
...
3. Click **Create event rule**. On the **Rule pattern** page, configure parameters by referring to the following descriptions:
![](https://qcloudimg.tencent-cloud.cn/raw/d3c784dcfdd5f1dd2dd3a90ff6283df9.png)
   ...
   <tr>
   <td rowspan="4"><b>Basic information</b></td>
   <td>Region</td>
   ...
   <td>Rule pattern</td><td>Select <b>Default</b>.</td></tr>
   <tr>
...
| [GetRule](https://intl.cloud.tencent.com/document/product/1108/45815) | Gets the event rule details. |
...
## More Operations
You can view, edit, and delete event rules. For more information, see [Managing Event Rule](https://intl.cloud.tencent.com/document/product/1108/42290).

## FAQs
For FAQs about event rule concepts and billing, see [FAQs](https://intl.cloud.tencent.com/document/product/1108/42292).
