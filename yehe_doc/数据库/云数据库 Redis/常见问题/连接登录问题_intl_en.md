...
Common causes of connection failure: network/security group issues, password issues, and connection issues (i.e., the maximum number of connections has been reached).
...
If CVM and Redis instances are in different [regions](https://intl.cloud.tencent.com/document/product/239/4106), they are in different VPCs, so they cannot interconnect directly over private network. We recommend that you use [CCN](https://intl.cloud.tencent.com/document/product/1003) to connect the VPCs.
...
No. Because instances under different accounts are in different VPCs. We recommend that you use [CCN](https://intl.cloud.tencent.com/document/product/1003) for connection.
