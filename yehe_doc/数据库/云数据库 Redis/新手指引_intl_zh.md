...
- [云数据库 Redis 是怎么工作的？](https://intl.cloud.tencent.com/document/product/239/3205)
- [我为什么选择云数据库 Redis？](https://intl.cloud.tencent.com/document/product/239/7021)
- [云数据库 Redis 的各个应用场景介绍。](https://intl.cloud.tencent.com/document/product/239/3249)
- [使用云数据库 Redis 有哪些限制？](https://intl.cloud.tencent.com/document/product/239/17952)

-----

## 2. 云数据库 Redis 的计费模式
云数据库 Redis 的计费模式为**按量计费**。您需要全面了解云数据库 Redis 的计费模式，有利于您选择最优的计费方案。详情请参见 [计费概述](https://intl.cloud.tencent.com/document/product/239/31954)。

-----

## 3. 新手入门
#### 3.1 创建 Redis 实例
在使用云数据库 Redis 之前，您需要注册腾讯云账号并且购买云数据库 Redis 服务。详情请参见 [创建 Redis 实例](https://intl.cloud.tencent.com/document/product/239/37712)。


#### 3.2 连接 Redis 实例
您可通过云服务器，以内外网两种不同的方式访问云数据库 Redis。详情请参见 [连接 Redis 实例](https://intl.cloud.tencent.com/document/product/239/9897)。

-----

## 4. 控制台界面
以下为云数据库 Redis 控制台总览页面：
![](https://main.qcloudimg.com/raw/ef1ed21d8032e349d152f45f653458ea.png)
-----
...
- [管理账号](https://intl.cloud.tencent.com/document/product/239/34590)
- [禁用命令](https://intl.cloud.tencent.com/document/product/239/32550)
