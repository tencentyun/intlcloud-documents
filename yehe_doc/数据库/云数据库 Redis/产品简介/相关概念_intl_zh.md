...
[**地域和可用区**](https://intl.cloud.tencent.com/document/product/239/4106)：Redis 实例和其他资源的物理位置。

[**腾讯云控制台**](https://console.cloud.tencent.com/cdb)：基于 Web 的用户界面。

[**项目**](https://intl.cloud.tencent.com/zh/document/product/378/34726)：为了让开发商更好的管理云产品而开发的功能，该功能主要以项目为单位来进行，通过将各个云产品分别分配到各个项目中来实现项目管理。
