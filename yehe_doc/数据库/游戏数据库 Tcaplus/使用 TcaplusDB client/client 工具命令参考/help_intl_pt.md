## Visão geral
Este comando é usado para aprender a como usar os comandos.

## Sintaxe
```
## Obtenção de todos os comandos e seus usos
help;
 
## Obtenção de instruções detalhadas de um comando específico
help [command];
```
