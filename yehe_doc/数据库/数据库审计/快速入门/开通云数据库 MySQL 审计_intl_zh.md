...
>!
>- 规则创建成功后，需关联审计策略才能生效。
>- SQL 审计规则详细使用说明，请参见 [SQL 审计规则](https://intl.cloud.tencent.com/document/product/1102/47770)。
...
>?
>- 审计日志保存时长支持选择7天、30天、3个月、6个月、1年、3年、5年。开通完后也可在控制台修改保存时长，请参见 [修改日志保存时长](https://intl.cloud.tencent.com/document/product/1102/47771)。
>- 为保证满足安全合规性对 SQL 日志保留时长的要求，建议用户选择180天及以上的保存时长。
4. 在**创建策略**页，设置策略名称，选择已创建的 [审计规则](https://intl.cloud.tencent.com/document/product/1102/47770)，单击**创建策略**。
...
3. 在弹出的对话框，设置策略名称，选择已创建的 [审计规则](https://intl.cloud.tencent.com/document/product/1102/47770)，单击**确定**。

## 查看审计日志
开通审计后，可在**审计日志**页查看对应的 SQL 审计日志，请参见 [审计日志](https://intl.cloud.tencent.com/document/product/1102/47772)。
