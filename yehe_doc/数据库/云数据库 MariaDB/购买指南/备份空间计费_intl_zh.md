云数据库 MariaDB 的备份空间用于存储某个地域下所有 MariaDB 实例的备份文件，备份文件由数据备份（冷备份）和日志备份（Binlog 备份）组成。
...
## 备份生命周期
备份生命周期与 [实例生命周期](https://intl.cloud.tencent.com/document/product/237/37511) 一致。
