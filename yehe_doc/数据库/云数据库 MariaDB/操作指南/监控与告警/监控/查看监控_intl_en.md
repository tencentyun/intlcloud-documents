...
|---------|---------|---------|
| Viewing data in the TDSQL-C for MySQL console | The console makes it simple for you to visually locate problems in a familiar way. | [Viewing Monitoring Data in the Console](https://www.tencentcloud.com/document/product/1098/50191) |
...
| Pulling data through TencentCloud API  | You can flexibly pull monitoring metric data to analyze and process it or connect it to other platforms. | [Using API to Pull Tencent Cloud Service Monitoring Data](https://www.tencentcloud.com/document/product/248/39917) |
