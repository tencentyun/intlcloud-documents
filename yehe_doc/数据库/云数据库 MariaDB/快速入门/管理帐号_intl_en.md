...
>
 ...
 - **Maximum Connections**: The number of concurrent connections under this account, which is subjected to the maximum connections of the instance and can be set when creating an account for TencentDB for MariaDB 5.6 and 8.0. 
