## Exception
Log in to the [TencentDB for MariaDB console](https://console.cloud.tencent.com/mariadb) and click an instance ID to enter the instance management page. On the **Monitoring and Alarms** tab, you can view two IO metrics.

| Metric | Category | Description |
| ------ | ------ | ------ |
|IOUsageRate| Instance monitoring | Maximum IO utilization of the primary node |
