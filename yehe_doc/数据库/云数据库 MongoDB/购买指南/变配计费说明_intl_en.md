...
- **Replica set**: Configuration adjustment refers to adjusting the mongod configurations, including the mongod node computing specification and memory, disk capacity, primary node quantity, and secondary node quantity. After the adjustment, fees will be charged by the new configurations.
...
#### Pay-as-you-go
The instance will be billed based on the new specification on the next hour under tier 1, and fees will be settled on each hour.
