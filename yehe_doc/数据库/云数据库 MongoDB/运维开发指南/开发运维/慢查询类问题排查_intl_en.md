...
The keywords that require attention include the following:
 ...
 - `COLLSCAN` indicates that a full-collection scan is performed. `IXSCAN` indicates that an index scan is performed. For descriptions of other fields, see [Explain Results](https://docs.mongodb.com/manual/reference/explain-results/index.html).<br>
