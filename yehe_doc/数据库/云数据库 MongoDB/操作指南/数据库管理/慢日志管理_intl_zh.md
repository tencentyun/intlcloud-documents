...
## 版本说明
当前 MongoDB 4.4、4.2、4.0、3.6和3.2版本均支持对慢日志进行管理。
...
| API 接口                 | API 描述                                                      |
| ----------------------- | ------------------------------------------------------------ |
| DescribeSlowLogs        | [获取慢日志信息](https://intl.cloud.tencent.com/document/product/240/36929) |
| DescribeSlowLogPatterns | [获取慢日志统计信息](https://intl.cloud.tencent.com/document/product/240/36930) |
