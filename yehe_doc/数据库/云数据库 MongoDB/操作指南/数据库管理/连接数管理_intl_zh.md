...
## 版本说明
- 副本集：MongoDB 4.4、4.2、4.0、3.6和3.2版本均支持对连接数进行管理。
- 分片集群：MongoDB 4.4、4.0、3.6和3.2版本均支持对连接数进行管理。4.2版本暂不支持。
...
| API 名称                   | API 接口                                                      |
| ------------------------- | ------------------------------------------------------------ |
| DescribeClientConnections | [查询实例客户端连接信息](https://intl.cloud.tencent.com/document/product/240/34703) |
