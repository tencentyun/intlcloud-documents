...
11. 通过 Mongo Shell 方式连接数据库，请参见 [使用 Mongo Shell 通过 SSL 认证连接数据库](https://intl.cloud.tencent.com/document/product/240/48469)。
通过多语言 SDK 连接数据库，请参见 [使用多语言 SDK 通过 SSL 认证连接数据库](https://intl.cloud.tencent.com/document/product/240/48470)。
