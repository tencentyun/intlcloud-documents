...
10. 待任务执行完成，通过如下方式备份数据至本地查看。
  ...
  - 内网方式：复制内网地址，在 CVM 服务器中，通过wget命令格式：`wget -c '内网地址' -O backup.tar` 进行内网高速下载。如何登录 CVM，请参见 [登录 CVM](www.tencentcloud.com/document/product/213/10517)。
