...
## 使用须知
- 实例备份过程中不影响业务使用。
- 备份文件存储在腾讯云对象存储（Cloud Object Storage，COS）中，不会占用云数据库 MongoDB 实例的存储空间。关于对象存储服务的更多信息，请参见 [对象存储](https://intl.cloud.tencent.com/document/product/436)。 
...
<tr>
<td>备份异常是否通知</td>
<td><ul><li>指备份任务执行异常时是否通知用户。</li><li>通知方式为腾讯云监控事件，事件通知为白名单方式，如需开通请 <a href="https://console.cloud.tencent.com/workorder/category">提交工单</a>。</li>MongoDB 的云监控支持事件，请参见 <a href="https://intl.cloud.tencent.com/document/product/248/32823">事件列表</a>。</ul></td></tr>
</tbody></table>      
...
10. 待任务执行完成，通过如下方式备份数据至本地查看。
  ...
  - 内网方式：复制内网地址，在 CVM 服务器中，通过wget命令格式：`wget -c '内网地址' -O backup.tar` 进行内网高速下载。如何登录 CVM，请参见 [登录 CVM](https://intl.cloud.tencent.com/document/product/213/10517)。

## 相关 API
| 接口                       | 说明                                                         |
| -------------------------- | ------------------------------------------------------------ |
| DescribeDBBackups          | [查询实例备份列表](https://intl.cloud.tencent.com/document/product/240/40342) |
| CreateBackupDBInstance     | [备份实例](https://intl.cloud.tencent.com/document/product/240/37922) |
| DescribeBackupDownloadTask | [查询备份下载任务信息](https://intl.cloud.tencent.com/document/product/240/40342) |
| CreateBackupDownloadTask   | [创建备份下载任务](https://intl.cloud.tencent.com/document/product/240/40343) |
