...
>!
>- TencentDB for MongoDB 4.x replica set instances do not support retaining the old IP address, which will be released immediately after the switch. Therefore, switch the network during the maintenance time.
