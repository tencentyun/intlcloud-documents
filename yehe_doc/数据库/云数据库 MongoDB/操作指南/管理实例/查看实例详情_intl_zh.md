...
## 更多操作
### 新建实例
在实例列表上方，单击**新建实例**，您也可以创建实例。具体配置参数，请参见快速入门的 [创建 MongoDB 实例](https://intl.cloud.tencent.com/document/product/240/3551)。
...
## API
通过 API 获取云数据库列表，请参见 [查询云数据库实例](https://intl.cloud.tencent.com/document/product/240/34702)。
