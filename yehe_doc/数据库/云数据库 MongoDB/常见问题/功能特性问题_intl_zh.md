...
### 如何获取实例的慢日志？
可使用 [慢日志](https://intl.cloud.tencent.com/document/product/240/31454) 查询功能获取慢查询详情。

### MongoDB 是否支持无密码访问？
云数据库 MongoDB 支持开启 [免认证访问实例](https://intl.cloud.tencent.com/document/product/240/39007) 的功能，帮助您快速连接访问数据库。免认证可以高效快速访问数据库实例，但也相应存在安全风险，请您仔细评估是否开启免认证访问数据库的功能。
...
### MongoDB 是否支持维护时间窗？
 云数据库 MongoDB 支持在控制台调整实例的维护时间，以适应业务需求的变化，请参见 [设置实例维护时间](https://intl.cloud.tencent.com/document/product/240/31190)。
