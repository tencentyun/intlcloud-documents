...
## Ikhtisar
Dokumen ini menjelaskan cara membuat grup tabel TcaplusDB di konsol.

## Prasyarat
- Anda telah membuat [kluster TcaplusDB](https://intl.cloud.tencent.com/document/product/1016/32714).

## Petunjuk
1. Masuk ke [konsol TcaplusDB](https://console.cloud.tencent.com/tcaplusdb/app), pilih **Cluster List** (Daftar Kluster) di bilah sisi kiri, pilih kluster yang diinginkan, dan klik **Create Table Group** (Buat Grup Tabel).
