...
## 操作步骤
### 下载软件包
1. 下载依赖包和 Tcaplus Protobuf API 软件包，参见 [SDK 下载](https://intl.cloud.tencent.com/document/product/1016/30285)。
2. 解压缩，以下是软件包的结构。
```
...
### 准备环境
1. 请确保已经在 [TcaplusDB](https://console.cloud.tencent.com/tcaplusdb/app) 开通了游戏业务，并且已经获取到对应的 App 信息（例如 AppId、ZoneId、AppKey）。
2. 解压缩依赖包并安装，本文以`TSF4G_BASE-2.7.28.164975_Win64Vc14Mt_Release.zip`依赖包为例，实际以  [Windows 平台依赖包下载](https://intl.cloud.tencent.com/document/product/1016/30285#windows-.E5.B9.B3.E5.8F.B0.E4.BE.9D.E8.B5.96.E5.8C.85.E4.B8.8B.E8.BD.BD) 提供的依赖包为准。
