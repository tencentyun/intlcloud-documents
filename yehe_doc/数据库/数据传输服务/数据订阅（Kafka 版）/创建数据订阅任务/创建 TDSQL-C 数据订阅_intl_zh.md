...
## 前提条件
- 已 [创建 TDSQL-C for MySQL](https://intl.cloud.tencent.com/document/product/1098/40626)，并且数据库版本符合要求，请参见 [数据订阅支持的数据库](https://intl.cloud.tencent.com/document/product/571/42663)。
- 已在源端实例中开启 Binlog。
...
>?如果校验失败，请根据 [校验不通过处理方法](https://intl.cloud.tencent.com/document/product/571/42552) 进行修正，并重新进行校验。
>
