本场景介绍使用 DTS 创建云数据库 MariaDB 的数据订阅任务操作指导。
...
9. 订阅实例进入运行中状态之后，就可以开始消费数据。Kafka 的消费需要进行密码认证，具体示例请参考 [数据消费 Demo](https://intl.cloud.tencent.com/document/product/571/48488)，我们提供了多种语言的 Demo 代码，也对消费的主要流程和关键的数据结构进行了说明。
