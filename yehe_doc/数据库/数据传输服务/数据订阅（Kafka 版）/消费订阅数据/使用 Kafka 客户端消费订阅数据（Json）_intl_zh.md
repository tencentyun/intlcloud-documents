...
操作步骤：
1. 创建新版数据订阅任务，详情请参见 [数据订阅 Kafka版](https://intl.cloud.tencent.com/document/product/571/47354)。
...
5. 运行 Demo。
 ...
 - `broker` 为数据订阅 Kafka 的内网访问地址，`topic` 为数据订阅任务的订阅 topic，这两个可在 [订阅详情](https://intl.cloud.tencent.com/document/product/571/42660) 页查看。
 - `group`、`user`、`password` 分别为消费组的名称、账号和密码，可在 [消费管理](https://intl.cloud.tencent.com/document/product/571/39535) 页查看，
