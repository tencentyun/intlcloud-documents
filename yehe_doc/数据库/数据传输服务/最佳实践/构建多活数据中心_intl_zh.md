...
多活数据中心是通过创建多个双向同步来实现，每个双向同步由两个单向同步任务来构建，所以单向同步的约束、操作限制等要求都需要满足，请参考 [数据同步](https://intl.cloud.tencent.com/document/product/571/42579) 中的对应同步场景。
...
## 操作步骤
构建多活数据中心即创建多个双向同步，详细步骤请参考 [构建双向同步数据结构](https://intl.cloud.tencent.com/document/product/571/42605)。
