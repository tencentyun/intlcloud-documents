...
因为双向同步是通过创建两个单向同步任务来构建双向拓扑，所以单向同步的约束、操作限制等要求都需要满足，请参考 [数据同步](https://intl.cloud.tencent.com/document/product/571/42579) 中的对应同步场景。
...
1. 登录 [数据同步购买页](https://buy.intl.cloud.tencent.com/dts)，选择相应配置，单击**立即购买**。
<table>
