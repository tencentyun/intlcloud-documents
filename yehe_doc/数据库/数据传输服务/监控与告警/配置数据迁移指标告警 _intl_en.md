...
You can use CM to set alarm rules for important metrics during data migration. CM will send notifications to you as soon as a metric becomes abnormal, so you can take corresponding measures.  
