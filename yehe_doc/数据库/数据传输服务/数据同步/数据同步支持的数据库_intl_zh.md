...
| --------------------- | ------------ | ------------------------------------- | ---------------------------------------- |
| [MySQL > MySQL](https://intl.cloud.tencent.com/document/product/571/47344) | 入云         | <ul><li>自建 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0<li>第三方云厂商<ul><li>阿里云 RDS 5.6、5.7、8.0<li>阿里云 PolarDB 5.6、5.7、8.0<li>AWS RDS MySQL 5.6、5.7、8.0<li>AWS Aurora MySQL 5.6、5.7 | 云数据库 MySQL 5.5、5.6、5.7、8.0 |
| [MariaDB > MySQL](https://intl.cloud.tencent.com/document/product/571/47344) | 入云 | <li>自建 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云数据库 MySQL 5.5、5.6、5.7、8.0 |
| [Percona > MySQL](https://intl.cloud.tencent.com/document/product/571/47344) | 入云 | 自建 Percona 5.5、5.6、5.7、8.0 | 云数据库 MySQL 5.5、5.6、5.7、8.0 |
| [TDSQL-C > MySQL](https://intl.cloud.tencent.com/document/product/571/47348) | 入云 | 云原生数据库 TDSQL-C 5.7、8.0 | 云数据库 MySQL 5.7、8.0 |
| [TDSQL MySQL > MySQL](https://intl.cloud.tencent.com/document/product/571/47350) | 入云 | 云数据库 TDSQL MySQL 5.7、8.0 | 云数据库 MySQL 5.7、8.0 |
| [MySQL > MariaDB](https://intl.cloud.tencent.com/document/product/571/47346) | 入云 | <li>自建 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 |
| [MariaDB > MariaDB](https://intl.cloud.tencent.com/document/product/571/47346) | 入云 | <li>自建 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 |
| [Percona > MariaDB](https://intl.cloud.tencent.com/document/product/571/47346) | 入云 | 自建 Percona 5.5、5.6、5.7、8.0 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 |
| [TDSQL MySQL > MariaDB](https://intl.cloud.tencent.com/document/product/571/47350) | 入云 | 云数据库 TDSQL MySQL 5.7、8.0、10.0、10.1 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 |
| [MySQL > TDSQL-C](https://intl.cloud.tencent.com/document/product/571/47348) | 入云         | <ul><li>自建数据库 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0<li>第三方云厂商<ul><li>阿里云 RDS 5.6、5.7、8.0<li>阿里云 PolarDB 5.6、5.7、8.0<li>AWS RDS MySQL 5.6、5.7、8.0<li>AWS Aurora MySQL 5.6、5.7 | 云原生数据库 TDSQL-C 5.7、8.0 |
| [TDSQL-C > TDSQL-C](https://intl.cloud.tencent.com/document/product/571/47348) | 入云 | 云原生数据库 TDSQL-C 5.7、8.0 | 云原生数据库 TDSQL-C 5.7、8.0 |
| [MySQL > TDSQL MySQL](https://intl.cloud.tencent.com/document/product/571/47350) | 入云         | <li>自建数据库 MySQL 5.6、5.7、8.0<li>云数据库 MySQL 5.6、5.7、8.0 | 云数据库 TDSQL MySQL 5.7、8.0 |
| [MariaDB > TDSQL MySQL](https://intl.cloud.tencent.com/document/product/571/47350) | 入云         | <li>自建数据库 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云数据库 TDSQL MySQL 5.7、8.0、10.0、10.1 |
| [Percona > TDSQL MySQL](https://intl.cloud.tencent.com/document/product/571/47350) | 入云         | 自建 Percona 5.5、5.6、5.7、8.0 | 云数据库 TDSQL MySQL 5.7、8.0 |
| [TDSQL MySQL > TDSQL MySQL](https://intl.cloud.tencent.com/document/product/571/47350) | 入云 | 云数据库 TDSQL MySQL 5.7、8.0、10.0、10.1 | 云数据库 TDSQL MySQL 5.7、8.0、10.0、10.1 |
...
>- 跨账号同步指源数据库和目标库都属于腾讯云数据库实例，但所属不同的主账号名下，这种数据库实例之间的数据同步，具体操作请参考 [云数据库跨账号实例间同步](https://intl.cloud.tencent.com/document/product/571/47336)。
>
