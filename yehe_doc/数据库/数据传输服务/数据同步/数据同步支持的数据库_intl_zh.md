...
- 私有网络 VPC：源数据和目标数据库都部署在腾讯云上，且有 [私有网络](https://intl.cloud.tencent.com/document/product/215)。数据同步功能支持 VPC 接入类型，如果需要使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请。
- 云数据库：源数据库属于腾讯云数据库实例。
...
| MySQL  >   TDSQL-A PostgreSQL版 | 入云 | 云数据库 MySQL 5.6、5.7 | TDSQL-A PostgreSQL版 | <li>结构初始化<li>全量数据初始化 |
