...
## 前提条件
- 已 [创建云数据库 MySQL](https://intl.cloud.tencent.com/document/product/236/37785)，支持的 MySQL 版本：MySQL 5.6、MySQL 5.7。
...
4. 在配置同步任务页面，配置源端实例、帐号密码，配置目标端实例、帐号和密码，测试连通性后，单击【下一步】。
 ...
 - 接入类型：目前支持云数据库。
 - 实例 ID：选择源实例 ID。
 - 源实例数据库帐号和密码：填入实际 [数据库帐号和密码](https://intl.cloud.tencent.com/document/product/236/31901)，并单击【测试连通性】。
