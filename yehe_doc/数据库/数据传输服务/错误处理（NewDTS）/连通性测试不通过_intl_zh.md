...
- Telnet 测试不通过，可能原因如下。
  ...
  - [选定一种接入类型并进行连通性校验通过后，又修改为其他接入类型](#7)。
...
1. 在 `redis.conf` 中关闭 bind 配置，或者将 bind 配置修改为`0.0.0.0`。
...
## [网络冲突问题](id:4)
选择 [VPN/专线](https://intl.cloud.tencent.com/document/product/571/42651) 接入、[云联网](https://intl.cloud.tencent.com/document/product/571/42650) 接入方式的可以参考相应链接指导进行检查。

## [迁移帐号授权问题](id:5)
请参考 [数据迁移](https://intl.cloud.tencent.com/document/product/571/42645)、[数据同步](https://intl.cloud.tencent.com/document/product/571/47344) 中的对应场景，重新对迁移帐号授权。
