...
<tr>
<td>Host Address</td><td>IP address or domain name for accessing the source SQL Server database.</td></tr>
<tr>
<td>Port</td><td>Port for accessing the source SQL Server database.</td></tr>
<tr>
