...
#### 任务一：账号迁移
>?如下仅对设置目标库只读相关的操作进行差异介绍，用户配置时需要参考 [基础迁移操作指导](https://www.tencentcloud.com/document/product/571/42645)，包括对迁移账号的授权，关注操作限制，注意事项等等。
...
>?账号迁移的详细要求请参考 [账号迁移](https://www.tencentcloud.com/document/product/571/48483)。
>
