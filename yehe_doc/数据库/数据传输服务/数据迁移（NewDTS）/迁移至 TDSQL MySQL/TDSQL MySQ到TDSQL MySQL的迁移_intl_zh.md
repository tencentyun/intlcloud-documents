...
## 前提条件
- 已 [创建 TDSQL MySQL版](https://intl.cloud.tencent.com/document/product/1042/33336)。
...
- 不支持迁移 [二级分区](https://intl.cloud.tencent.com/document/product/1042/33361) 表。
...
- 增量迁移过程中，不支持源库新增分片、调整分片规格，否则迁移任务不会同步新增分片的数据或是任务报错暂停，如果需要长期保持增量同步并且支持源库的新增分片、调整分片操作，请使用 [TDSQL 数据同步](https://intl.cloud.tencent.com/document/product/571/47350) 来进行同步。
