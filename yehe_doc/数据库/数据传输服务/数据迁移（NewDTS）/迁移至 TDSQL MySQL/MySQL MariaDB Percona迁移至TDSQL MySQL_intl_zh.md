...
## 前提条件
- 已 [创建分布式数据库 TDSQL MySQL版](https://intl.cloud.tencent.com/document/product/1042/33336)。
...
<tr>
<td>接入类型</td><td>请根据您的场景选择，本场景选择“公网”，不同接入类型的准备工作请参考 <a href="https://intl.cloud.tencent.com/document/product/571/42652">准备工作概述</a>。
