...
- 增量同步：在全量数据迁移的基础上，DTS 会读取并解析源端阿里云 RDS MySQL 数据库的 binlog 信息，将源端阿里云 RDS MySQL 中的增量更新同步到目标云数据库 MySQL。通过增量数据同步完成应用在不停服的情况下平滑迁移到腾讯云。
...
<tr>
<td>所属地域</td><td>源库所属地域为 DTS 服务出口地域，请选择离阿里云 RDS MySQL 最近的一个地域即可。</td></tr>
<tr>
<td>主机地址</td><td>阿里云 RDS MySQL 访问 IP 地址，您可以在阿里云 RDS MySQL 的基本信息页面，获取数据库的访问地址。</td></tr>
<tr>
<td>端口</td><td>阿里云 RDS MySQL 访问端口，默认为3306。</td></tr>
<tr>
<td>帐号</td><td>阿里云 RDS MySQL 的数据库帐号，帐号权限需要满足要求。</td></tr>
<tr>
<td>密码</td><td>阿里云 RDS MySQL 的数据库帐号的密码。</td></tr>
<tr>
