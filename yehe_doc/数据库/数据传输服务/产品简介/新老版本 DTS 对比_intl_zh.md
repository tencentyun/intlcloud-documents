...
| 支持的版本     | 不支持跨版本迁移。         | 支持大部分数据库的跨版本迁移，支持的版本详情请参见 [数据迁移支持的数据库](https://intl.cloud.tencent.com/document/product/571/42580)。 |
...
| 支持的版本     | 不支持跨版本同步。          | 支持跨版本同步，支持的版本详情请参见 [数据同步支持的数据库](https://intl.cloud.tencent.com/document/product/571/42579)。 |
