...
| ------------------------- | ------------------------------------------------------------ |
| 1. Prepare               | Before creating a data sync task, you need to prepare the source and target databases and a network environment as instructed in [Overview](https://intl.cloud.tencent.com/document/product/571/42652) to meet the environment requirements. |
| 2. Create a data sync task       | This section provides only a basic sample sync task. For more scenarios, see [Data Sync from MySQL to TencentDB for MySQL](https://intl.cloud.tencent.com/document/product/571/42624). |
| 3. View the sync progress or perform other operations | <li>You can view the overall sync progress and perform operations such as verification and retry as instructed in [Viewing Task](https://intl.cloud.tencent.com/document/product/571/42620).<li>You can view various data sync metrics as instructed in [Viewing Monitoring Metric](https://intl.cloud.tencent.com/document/product/571/42606).</li> |
...
<strong>Table renaming</strong>: If needed, hover over the right side of a selected object, and the **Edit** icon will be displayed. Click it and then enter a new name in the pop-up window.
