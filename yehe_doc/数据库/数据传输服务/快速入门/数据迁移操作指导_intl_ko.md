...
## 관련 정보
- [데이터 마이그레이션 기능 개요](https://intl.cloud.tencent.com/document/product/571/13711).
- [데이터 마이그레이션이 지원 데이터베이스](https://intl.cloud.tencent.com/document/product/571/42647).
...
| 4. 비즈니스 전환 수행               | 비즈니스에 미치는 영향을 줄이기 위해 적절한 비즈니스 전환 시간을 선택해야 합니다. 자세한 내용은 [컷오버 설명](https://intl.cloud.tencent.com/document/product/571/42612)를 참고하십시오. |
