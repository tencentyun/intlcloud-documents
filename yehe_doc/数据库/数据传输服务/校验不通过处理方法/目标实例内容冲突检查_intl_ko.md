...
### [DB 테이블 매핑 사용(MySQL/MariaDB/Percona/TDSQL-C MySQL/TDSQL MySQL 전용)](id:1)
DTS 테이블 매핑 기능을 사용하여 동일한 이름으로 마이그레이션할 객체의 이름을 대상 데이터베이스의 다른 이름에 매핑할 수 있습니다. 
1. [DTS 콘솔](https://console.cloud.tencent.com/dts/migration)에 로그인하고 해당 마이그레이션 작업을 선택한 다음 **작업** 열에서 **더 보기** > **수정**을 클릭합니다. 
