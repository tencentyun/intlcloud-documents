...
>! 应安全要求，腾讯云数据库 PostgreSQL 关闭了 superuser 权限的使用。但因为部分操作必须要求 superuser 进行，所以云数据库 PostgreSQL 提供了 tencentdb_superuser 角色，请参见 [用户与权限操作](https://intl.cloud.tencent.com/document/product/409/43242)。
