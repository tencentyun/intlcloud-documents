## 背景
云数据库 PostgreSQL 于2021年05月11日对实例 [监控功能](https://intl.cloud.tencent.com/document/product/409/7564) 进行了升级，对老的部分监控策略进行了优化，新增了大量指标，并且全量支持5秒级监控。其中部分指标的采集数据和最大阈值会与旧的采集数据发生较大变化，本文主要介绍优化变动的细节。
