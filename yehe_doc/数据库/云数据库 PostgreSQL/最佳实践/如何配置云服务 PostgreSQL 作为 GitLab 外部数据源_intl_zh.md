...
1. 安装外部数据库 PostgreSQL，亦可直接使⽤云上数据库服务，如腾讯云数据库 PostgreSQL，要创建腾讯云数据库 PostgreSQL 请参见 [创建 PostgreSQL 实例](https://intl.cloud.tencent.com/document/product/409/40724)。
