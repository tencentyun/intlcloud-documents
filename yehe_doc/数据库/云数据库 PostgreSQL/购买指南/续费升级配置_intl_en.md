...
1. Log in to the [TencentDB for PostgreSQL console](https://console.cloud.tencent.com/pgsql), locate the desired instance in the instance list, and click **Adjust Configurations** in the **Operation** column.
