...
## DTS 数据迁移
详细数据迁移方案可参考 [PostgreSQL 到 PostgreSQL 的迁移](https://intl.cloud.tencent.com/document/product/571/42640)，目前支持多种源端 PostgreSQL 迁移到云数据库 PostgreSQL。

## 导入导出方案
### 步骤1：准备 PostgreSQL 实例
[购买 PostgreSQL 实例](https://intl.cloud.tencent.com/document/product/409/40724)，并在 [控制台](https://console.cloud.tencent.com/postgres) 获取连接地址。
>?请确保字符集与源实例一致。
