...
## 前提条件
已完成 PostgreSQL for Serverless 实例的准备，如未完成，请参见 [快速入门](https://intl.cloud.tencent.com/document/product/409/39715)。
...
[登录云服务器](https://intl.cloud.tencent.com/zh/document/product/213/10517)，在 PostgreSQL 客户端中，执行如下命令，恢复数据。
