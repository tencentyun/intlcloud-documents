...
**Case 2. The port is opened in the current security group**
In the pop-up window, read the note and click **OK**.
4. After public network access is enabled successfully, you can view the host and port in the public network address in the **Connection Info** section, which cannot be modified.
...
![](https://staticintl.cloudcachetci.com/yehe/backend-news/i6C8925_25.png)
