...
1. Use the Windows version of mysqldump to dump the data. For more information, see the description in [Data Migration with Command Line Tool](#AA).
...
For more information on how to access a database on a CVM instance, see [Connecting to Cluster](https://intl.cloud.tencent.com/document/product/1098/40627).
