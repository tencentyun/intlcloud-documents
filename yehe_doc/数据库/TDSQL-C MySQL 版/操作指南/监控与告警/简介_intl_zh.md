...
|---------|---------|
| 实例 | 支持监控读写实例、只读实例 |
| 数据库代理 | 支持监控数据库代理节点，详细请参见 [数据库代理监控](https://www.tencentcloud.com/document/product/1098/49995) |
...
## 监控指标
TDSQL-C MySQL 版提供了丰富的监控指标，帮助您更全面的了解数据库的资源使用率、性能及运行状况，具体监控项与监控指标请参见 [支持的监控指标](https://www.tencentcloud.com/document/product/1098/50193)。
