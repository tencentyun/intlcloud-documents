本文为您介绍在控制台查看异常告警（DBbrain）消息的操作。

[异常告警（DBbrain）](https://intl.cloud.tencent.com/document/product/1035/37177)通知服务为用户实时推送实例异常告警消息，方便用户及时便捷地了解数据库异常诊断问题。
