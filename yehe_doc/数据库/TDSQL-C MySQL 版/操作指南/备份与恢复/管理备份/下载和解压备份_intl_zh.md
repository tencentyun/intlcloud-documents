...
>?
>- 复制下载地址后 [登录到云数据库所在 VPC 下的 CVM（Linux 系统）](https://intl.cloud.tencent.com/document/product/213/10517)中，可运用 wget 命令进行内网高速下载。
...
>?
>- 复制下载地址后 [登录到云数据库所在 VPC 下的 CVM（Linux 系统）](https://intl.cloud.tencent.com/document/product/213/10517)中，运用 wget 命令进行内网高速下载。
>- 下载地址的有效期为12小时，超过12小时后，需要重新进入下载页面获取新生成的下载地址。
>- 使用 wget 下载时需要对 URL 添加英文引号。
>- wget 命令格式： wget -c "<备份文件下载地址>" -O <自定义名称>.xb
>
