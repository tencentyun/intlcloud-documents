...
This document describes how to view the backup list in the console.
...
- Automatic backups cannot be deleted manually. They will be automatically deleted after the retention period ends, which is 7 days and can be customized as needed. For more information, see [Setting Backup Retention Period](https://intl.cloud.tencent.com/document/product/1098/48396). 
- Manual backups can be manually deleted from the backup list in the TDSQL-C for MySQL console.

#### How can I reduce the backup space costs?
- Delete manual backups that are no longer used as instructed in [Deleting Backup](https://intl.cloud.tencent.com/document/product/1098/48394).
- Reduce the automatic backup retention period as needed to implement the regular deletion of automatic backups. For more information, see [Setting Backup Retention Period](https://intl.cloud.tencent.com/document/product/1098/48396).
