本文为您介绍如何通过 TDSQL-C MySQL 版控制台设置数据库代理连接地址。
...
2. 在集群管理页面，选择**数据库代理**页，在**连接地址**的**数据库代理地址**后单击<img src="https://main.qcloudimg.com/raw/be716b5360d5256a9d5e816e29872ec1.png"  style="margin:0;">图标。
