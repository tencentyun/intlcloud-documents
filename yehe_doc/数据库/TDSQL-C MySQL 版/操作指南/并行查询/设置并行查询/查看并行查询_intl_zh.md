TDSQL-C MySQL 版支持查看并行查询的执行计划，以及查看线程中哪些线程在执行并行查询计划。您可清晰了解到并行查询是如何在数据库中稳定生效，也可在并行查询执行过程中遇到问题时，帮助快速定位问题。
本文为您介绍查看并行查询的两种常用方法。
...
## 相关文档
- [开启或关闭并行查询](https://www.tencentcloud.com/document/product/1098/51769)
- [hint 语句控制](https://www.tencentcloud.com/document/product/1098/51765)
