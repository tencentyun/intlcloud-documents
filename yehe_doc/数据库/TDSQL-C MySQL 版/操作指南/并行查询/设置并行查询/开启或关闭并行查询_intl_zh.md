...
- SQL 语句在执行并行查询时将默认使用 txsql_parallel_degree 所设置的并行度，但用户可通过 hint 语句调整单条 SQL 语句的并行查询并行度，详细说明请参见 [hint 语句控制](https://www.tencentcloud.com/document/product/1098/51765)。
...
也可设置相关执行条件参数。控制台参数设置页面如下图所示。详细操作方法请参考 [设置实例参数](https://intl.cloud.tencent.com/document/product/1098/44602)。
...
TDSQL-C MySQL 版支持对单条 SQL 语句进行指定并行执行方式。对单条 SQL 语句进行设置时，将采用 hint 语句的方式进行操作，详细方法请参照 [hint 语句控制](https://www.tencentcloud.com/document/product/1098/51765)。

## 相关文档
- [查看并行查询](https://www.tencentcloud.com/document/product/1098/51764)
- [并行查询指标](https://www.tencentcloud.com/document/product/1098/51763)
