...
## 产品定价
详情请参见 [TDSQL-C MySQL 版购买页](https://buy.intl.cloud.tencent.com/cynosdb?regionId=8#/)。
...
- [API](https://intl.cloud.tencent.com/document/product/1098/40725)：控制台上所有的操作都可以通过 API 实现。
