TDSQL-C MySQL 版支持使用私有网络来实现更高程度的网络隔离控制，搭配使用 [安全组](https://intl.cloud.tencent.com/document/product/213/12452) 和 [私有网络](https://intl.cloud.tencent.com/document/product/215/535) 将极大提升访问 TDSQL-C MySQL 版的安全性。
