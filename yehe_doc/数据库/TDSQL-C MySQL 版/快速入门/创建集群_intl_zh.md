...
## 操作步骤
1. 登录 [购买页](https://buy.Intl.cloud.tencent.com/cynosdb?regionId=8)，完成**数据库配置**设置，单击**下一步**。
   ...
   - **实例规格**：计算实例规格和存储量请参考 [计费概述](https://intl.cloud.tencent.com/document/product/1098/40620)。
...
## 后续操作
购买 TDSQL-C MySQL 版集群后，可通过集群内外网地址或数据管理平台连接 TDSQL-C MySQL 版集群，请参见 [连接集群](https://intl.cloud.tencent.com/document/product/1098/40627)。
