...
You can log in to the [TDSQL-C for MySQL console](https://console.cloud.tencent.com/cynosdb) and click **Parameter Template** on the left sidebar to view parameters. The following parameter template features are supported:
