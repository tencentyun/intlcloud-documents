...
## Enabling SQL Audit
1. Log in to the [TDSQL-C for MySQL console](https://console.cloud.tencent.com/dls/cynosdb/instance), select **Database Audit** on the left sidebar, select a region at the top, click the **Audit Instance** tab, and click **Disabled** to filter instances whose audit is disabled.
...
>?
>- You can select 7 days, 30 days, 3 months, 6 months, 1 year, 3 years, and 5 years as the audit log retention period. You can also modify it in the console after enabling audit.
