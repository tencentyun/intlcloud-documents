...
### 3.1.9
#### 功能更新
- 新增 cdc 能力，可直接重复回溯/抽取用户自定义日志保留时间段的 binlog，解决了计算节点在 HA 等场景下丢失本地 binlog 的问题。设置 binlog 保留时间请参见 [设置备份保留时间](https://intl.cloud.tencent.com/document/product/1098/48396)。
...
### 3.1.8
#### 功能更新
- 增加并行查询特性，自动识别复杂查询，利用并行查询能力，调动多核计算资源，大幅缩短大查询响应时间，使用请参见 [开启或关闭并行查询](https://www.tencentcloud.com/document/product/1098/51769) 功能介绍。
...
### 3.1.7
#### 功能更新
- 新增密码字典参数，使用请参见 [自定义密码强度](https://www.tencentcloud.com/document/product/1098/49981) 功能介绍，优化了 HA 对字典文件依赖的问题。
...
- 支持数据库代理，使用请参见 [数据库代理](https://www.tencentcloud.com/document/product/1098/50004) 功能介绍。
- 支持只读实例执行逻辑备份。
