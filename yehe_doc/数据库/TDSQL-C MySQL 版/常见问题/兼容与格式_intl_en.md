...
No. To ensure that the execution plans of read-write and read-only instances are consistent, every time the read-write instance updates the statistics, the change will be synced to read-only instances.
