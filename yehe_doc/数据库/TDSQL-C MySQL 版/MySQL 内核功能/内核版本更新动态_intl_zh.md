...
本文为您介绍 TDSQL-C 内核版本更新动态，如需升级，请参见 [升级内核小版本](https://intl.cloud.tencent.com/document/product/1098/44617)。
...
### 2.0.14
#### 功能更新
- 支持 instant modify column，使用请参见 [Instant DDL 功能介绍](https://intl.cloud.tencent.com/document/product/1098/44588)。
...
### 2.0.13
#### 功能更新
- 支持 instant add column，使用请参见 [Instant DDL 功能介绍](https://intl.cloud.tencent.com/document/product/1098/44588)。
...
### 2.0.12
#### 功能更新
- 支持数据库审计，使用请参见 [开通云原生数据库 TDSQL-C 审计](https://intl.cloud.tencent.com/document/product/1102/41312)。
