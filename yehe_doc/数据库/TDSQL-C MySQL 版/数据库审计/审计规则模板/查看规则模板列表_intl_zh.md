...
2. 在左侧导航栏选择**数据库审计**。
3. 选择地域后，单击**规则模板**。
![](https://staticintl.cloudcachetci.com/yehe/backend-news/QdG5196_47.png)
4. 在规则模板列表里找到目标规则模板（也可在搜索框通过资源属性筛选快速查找），在其**操作**列单击**详情**。
5. 在弹窗下，可切换查看该规则模板的基本信息和参数设置情况。
基本信息页面
![](https://staticintl.cloudcachetci.com/yehe/backend-news/yK47350_48.png)
参数设置页面
![](https://staticintl.cloudcachetci.com/yehe/backend-news/SuH6491_49.png)
...
## 相关操作
- [新建规则模板](https://www.tencentcloud.com/document/product/1098/53392)
- [修改规则模板](https://www.tencentcloud.com/document/product/1098/53393)
- [删除规则模板](https://www.tencentcloud.com/document/product/1098/53394)
