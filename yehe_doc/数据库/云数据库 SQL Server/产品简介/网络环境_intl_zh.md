...
云数据库 SQL Server 支持 [私有网络和基础网络](https://intl.cloud.tencent.com/document/product/215/35505) 两种网络环境。

## 网络限制
- 处于同一地域的云服务产品之间通过内网互通。
- 处于同一地域不同可用区的私有网络云服务器访问不同可用区基础网络云数据库 SQL Server，需手动配置子网及分配私有网络 IP 后才能互通。
- 处于不同地域的云服务产品之间基础网络内网不能互通，私有网络之间需要 [对等连接](https://intl.cloud.tencent.com/document/product/553/18827) 支持。
