...
云数据库 SQL Server 目前不支持高可用版或集群版变更到基础版，如需架构调整，需要购买新的基础版实例后，[使用备份恢复迁移数据](https://intl.cloud.tencent.com/document/product/238/39005)。
...
云数据库 SQL Server 基础版、双机高可用版及集群版均支持版本升级，请参见 [调整实例版本](https://intl.cloud.tencent.com/document/product/238/44354)。
