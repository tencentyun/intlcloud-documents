...
- The highest TPM of the single-node architecture (formerly Basic Edition - SSD cloud disk) is 1.38 million.
...
- A SQL Server 2008 R2/2012/2014/2016/2017/2019 Enterprise two-node (formerly High Availability/Cluster Edition) instance is in the primary/replica two-node architecture, where the underlying layer is deployed on a physical machine. It supports the database mirroring (high-availability replication) scheme to implement automatic HA switch within seconds.
