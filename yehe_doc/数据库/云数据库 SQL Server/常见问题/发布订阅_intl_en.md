...
The publish/subscribe feature is available only when both the publishing and subscribing instances are TencentDB for SQL Server instances. In addition, this feature is supported only for TencentDB for SQL Server Dual-Server High Availability and Cluster Editions but not Basic Edition.

### Does TencentDB for SQL Server Basic Edition support publish/subscribe?
No.
...
- This feature is supported only for TencentDB for SQL Server Dual-Server High Availability and Cluster Editions but not Basic Edition.
