...
<td>Application scenarios such as I/O-intensive applications and small and medium relational databases.</td></tr>
 ...
 - Multi-AZ: Currently, only Shanghai, Beijing, Guangzhou, and Hong Kong (China) regions support selecting multi-AZ deployment. By combining multiple AZs into a combined "multi-AZ", the multi-AZ deployment mode protects databases from database instance failures and AZ outage.
 ...
 - Project List: TencentDB for SQL Server supports assigning instances to different projects for management. You can fuzzy search for projects by their name.
