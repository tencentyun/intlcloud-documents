...
- 通过外网地址访问实例，会降低实例的安全性，仅推荐用于开发、测试或辅助管理数据库，不提供可用性 SLA  保证。为了获得更快的传输速率和更高的安全性，建议使用内网地址连接数据库，外网不承担业务负载，如果需要承担业务负载，建议 [通过 CLB 开启外网服务](https://www.tencentcloud.com/document/product/238/48066)。
