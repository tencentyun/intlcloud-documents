...
2. After the final incremental backup file (i.e., the .bak file containing `_1diff1_1reconvery1`) is imported, the status of the target instance will change from read-only to usable, and you can switch your business to the TencentDB for SQL Server instance.
