...
## 前提条件
- SQL Server 实例下有除了超级权限账号和高级权限账号以外的账号，操作方法请参见 [创建账号](https://intl.cloud.tencent.com/document/product/238/7521)。
- SQL Server 实例下有创建至少一个数据库，操作方法请参见 [创建数据库](https://intl.cloud.tencent.com/document/product/238/35780)。
