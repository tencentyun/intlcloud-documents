...
详细计费说明和定价，请参见  [跨地域备份收费说明](https://www.tencentcloud.com/document/product/238/50229)。
...
| 计费生命周期 | <li>按量计费实例，默认在实例进入回收站后只保留3天，3天后随实例销毁 | <li>包月包月实例，默认在实例进入回收站后只保留7天，7天后随实例销毁<li>按量计费实例，默认在实例进入回收站后只保留3天，3天后随实例销毁 |
