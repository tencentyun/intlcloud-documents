...
## Viewing Backup Trend
1. Log in to the [TencentDB for SQL Server console](https://console.cloud.tencent.com/sqlserver).
2. On the left sidebar, select **Database Backup**.
3. Only the **Database Backup** page, select a region. Then, you can view the trend of total backup space size at the bottom of the overview page by time (last hour, last 24 hours, today, last 7 days, last 30 days, or a selected custom time period).
