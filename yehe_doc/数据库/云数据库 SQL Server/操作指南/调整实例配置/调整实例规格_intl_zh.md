## 实例规格
云数据库 SQL Server 支持的实例规格及价格详细可参见 [产品规格](https://intl.cloud.tencent.com/document/product/238/8294)。
...
<td>规格扩容<br>或<br>磁盘扩容<br>或<br>规格缩容</td><td>主从切换</td><td>1. 实例在调整配置过程中，会涉及主从切换，切换过程中会出现一次30秒～2分钟的闪断，请确保业务具备重连机制。<br>2. 闪断过程中，与数据库、账号、网络等相关的大部分操作将无法执行，请保证在业务低峰期进行切换操作。</td><td>需要选择生效时间</td></tr>
</tbody></table>	
...
<td rowspan="1">云盘</td><td>规格扩容<br>磁盘扩容<br>规格缩容</td><td>主从切换</td><td>1. 实例在调整配置过程中，会涉及主从切换，切换过程中会出现一次30秒～2分钟的闪断，请确保业务具备重连机制。<br>2. 闪断过程中，与数据库、账号、网络等相关的大部分操作将无法执行，请保证在业务低峰期进行切换操作。</td><td>需要选择生效时间</td></tr>
</tbody></table>
