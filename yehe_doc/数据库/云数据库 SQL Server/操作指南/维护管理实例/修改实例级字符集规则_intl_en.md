...
>- The character set collation for instances is `Chinese_PRC_CI_AS` by default.

## Prerequisites
You have [submitted a ticket](https://console.cloud.tencent.com/workorder/category) to apply for modifying the character set collation.
