...
- Dual-Server High-Availability Edition instances, Cluster Edition primary instances, and Basic Edition instances are supported.
>?If a primary instance of Dual-Server High Availability Edition or Cluster Edition has read-only replicas or implements the pub/sub messaging paradigm, you need to [submit a ticket](https://console.cloud.tencent.com/workorder/category) to migrate it across AZs.
...
>After instance data is migrated, an instance switch will occur (**upon migration completion** or **during maintenance time**), causing a momentary disconnection. After the switch is done, the whole process of cross-AZ migration is completed.
>
