...
## Prerequisites
You have [submitted a ticket](https://console.cloud.tencent.com/workorder/category) to apply for modifying the system time zone.

## Use limits
- **Limits on instance architecture and specification**
 - Dual-Server High Availability Edition or Cluster Edition instances only with 90-core 720 GB MEM support system time zone modification.
 - Basic Edition instances support system time zone modification.
...
4. For more information on how to configure other parameters on the purchase page, see [Creating TencentDB for SQL Server Instance](https://intl.cloud.tencent.com/document/product/238/31571). After setting all the parameters, click **Buy Now**.
