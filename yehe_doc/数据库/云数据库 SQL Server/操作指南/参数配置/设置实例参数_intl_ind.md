...
3. Pilih parameter target dan modifikasi nilainya di kolom **Current Value** (Nilai Saat Ini). Setelah mengonfirmasi bahwa semuanya sudah benar, klik **OK** (OKE).
...
2. Pada halaman manajemen instans, pilih tab **Parameter Configuration** (Konfigurasi Parameter) > **Parameter Settings** (Pengaturan Parameter), pilih baris parameter target, dan klik ![img](https://main.qcloudimg.com/raw/788902e3f8c335cf17de420f7181c2a8.png) di kolom **Current Value** (Nilai Saat Ini) untuk memodifikasi nilainya.
