...
| Adjust the configuration | In the instance list, you can adjust the configuration of your database instance. Instance upgrade and disaster recovery mode adjustment are supported. For more information, see [Adjusting Instance Specification](https://intl.cloud.tencent.com/document/product/238/35783). |
...
| System monitoring | On the**Instance Monitoring** tab, you can view the monitoring data of various core metrics of the current database. For more information, see [Monitoring Feature](https://intl.cloud.tencent.com/document/product/238/7524) . |
