...
### [Creating database account](id:cjzh)
1. In the [instance list](https://console.cloud.tencent.com/sqlserver), click an instance ID or **Manage** in the **Operation** column to access the instance management page.
...
### Creating database
1. In the [instance list](https://console.cloud.tencent.com/sqlserver), click an instance ID or **Manage** in the **Operation** column to access the instance management page.
2. Select the **Database Management** tab, click **Create Database**, and enter relevant information in the pop-up dialog box. After confirming that everything is correct, click **OK**
 ...
 - Authorize Account: you can authorize existing accounts to access the database. If you haven't created an account yet, see [Creating database account](#cjzh).
