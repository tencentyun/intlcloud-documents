...
1. Log in to the [TencentDB for SQL Server purchase page](https://buy.cloud.tencent.com/sqlserver), select the desired database configuration, read and indicate your consent to the Terms of Service, confirm that everything is correct, and click **Buy Now**.
...
<td>Application scenarios such as I/O-intensive applications and small and medium relational databases.</td></tr>
 ...
 - Tag: Categorize and manage resources with tags.
 - System Time Zone: By default, only **China Standard Time** is supported. To change it, [submit a ticket](https://console.cloud.tencent.com/workorder/category) for assistance.
 - Character Set Collation: The instance's character set provides a collation for system data, i.e., the case sensitivity and accent sensitivity attributes. By default, only **Chinese_PRC_CI_AS** is supported. To adjust it, [submit a ticket](https://console.cloud.tencent.com/workorder/category) for assistance.
...
### [Creating a database account](id:cjzh)
1. In the [instance list](https://console.cloud.tencent.com/sqlserver), click the ID or **Manage** in the **Operation** column of the target instance to enter the **Instance Management** page.
...
### Creating a database
1. In the [instance list](https://console.cloud.tencent.com/sqlserver), click the ID or **Manage** in the **Operation** column of the target instance to enter the **Instance Management** page.
2. On the **Instance Management** page, select **Database Management** > **Create Database**, set configuration items in the pop-up window, confirm that everything is correct, and click **OK**.
 ...
 - Authorize Account: You can authorize existing accounts to access the database. If you haven't created an account yet, see [Creating a database account](#cjzh).
