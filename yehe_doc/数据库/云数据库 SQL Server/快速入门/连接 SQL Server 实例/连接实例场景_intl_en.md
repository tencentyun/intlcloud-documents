...
**Connection method**: We recommend you connect them through [CCN](https://intl.cloud.tencent.com/document/product/1003/31985).
...
## Connecting to a TencentDB for SQL Server Instance from a Local Windows Computer
### Dual-Server High Availability/Cluster Edition instance
- Option 1: Use [VPN](https://intl.cloud.tencent.com/document/product/1037/32679), [Direct Connect](https://intl.cloud.tencent.com/document/product/216/7557), or [CCN](https://intl.cloud.tencent.com/document/product/1003/31985) for connection, which are more secure and stable.
- Option 2: Connect to the instance over the public network by [binding the instance to CLB to enable public network access](https://intl.cloud.tencent.com/document/product/238/11627#CLBKQWW).
- Option 3: Use a [Linux CVM instance with a public IP to map the ports](https://intl.cloud.tencent.com/document/product/238/11627#WWIPLJSL).

### Basic Edition instance
- Option 1: Use [VPN](https://intl.cloud.tencent.com/document/product/1037/32679), [Direct Connect](https://intl.cloud.tencent.com/document/product/216/7557), or [CCN](https://intl.cloud.tencent.com/document/product/1003/31985) for connection, which are more secure and stable.
- Option 2: Use a [Linux CVM instance with a public IP to map the ports](https://intl.cloud.tencent.com/document/product/238/11627#WWIPLJSL).
