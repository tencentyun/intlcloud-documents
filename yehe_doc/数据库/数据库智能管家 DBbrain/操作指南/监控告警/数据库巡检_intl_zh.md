...
数据库巡检列表展示了数据库实例所产生的巡检信息汇总，包括实例基本信息、健康等级、慢查询数、大表数量等。
 ...
 - 单击右上角的**邮件设置**，可配置数据库巡检产生健康报告的邮件接收相关信息，具体请参见 [数据库巡检健康报告邮件推送](https://intl.cloud.tencent.com/document/product/1035/39371)。
 - 单击**操作**列的**查看**，可以查看或下载该实例的健康报告。
 - 单击**操作**列的**邮件**，或者选取多条数据库巡检记录后单击**批量发送**，可将健康报告推送至指定的联系人邮箱，具体请参见 [历史健康报告邮件推送](https://intl.cloud.tencent.com/document/product/1035/39371)。
