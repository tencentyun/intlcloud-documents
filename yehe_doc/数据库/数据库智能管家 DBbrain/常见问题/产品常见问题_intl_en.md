...
DBbrain is compatible with SQL, NoSQL, and NewSQL databases. Currently, only MySQLand TDSQL-C are supported, but it will support more mainstream databases such as Redis, MongoDB, PostgreSQL, SQL Server, and MariaDB in the future.
