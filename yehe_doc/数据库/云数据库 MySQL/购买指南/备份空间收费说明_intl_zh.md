...
## 单节点云盘版备份价格
超过免费额度的备份空间，各地域收费价格如下。

| 地域 | 价格（美元/GB/小时） | 
|---------|---------|
| 上海、南京、重庆、成都、广州、北京 | 0.00003676 | 
| 弗吉尼亚、曼谷、法兰克福、东京、新加坡、首尔、多伦多、雅加达、硅谷、圣保罗、中国香港 | 0.00004118 | 

单节点云盘版实例目前支持的地域为：上海、成都、广州、北京，其他城市后续陆续开放。

## 本地盘备份价格
超出免费额度的备份空间，中国大陆地域按照0.000113美元/GB/小时的价格收费，其他地域价格请参见 [云数据库 MySQL 价格计算器](https://www.tencentcloud.com/pricing/cdb/calculator)。
