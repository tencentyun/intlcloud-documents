## Prasyarat
Identitas Anda perlu diverifikasi terlebih dahulu. Untuk informasi selengkapnya, lihat [Panduan Verifikasi Identitas](https://intl.cloud.tencent.com/document/product/378/3629).

## Membeli Instans di Konsol
1. Login ke [halaman pembelian TencentDB for MySQL](https://buy.Intl.cloud.tencent.com/cdb), konfigurasikan informasi instans berikut, dan klik **Buy Now** (Beli Sekarang).
...
>- Saat Anda membeli layanan Tencent Cloud, sebaiknya pilih wilayah terdekat untuk meminimalkan latensi akses dan meningkatkan kecepatan unduhan.
 ...
 - **Network** (Jaringan): pilih jaringan tempat instans TencentDB for MySQL berada, yaitu "Default-VPC (default)" secara default. Sebaiknya pilih VPC yang sama di wilayah yang sama dengan instans CVM yang akan dihubungkan. Jika tidak, instans MySQL tidak dapat dihubungkan dari instans CVM melalui jaringan pribadi.
...
>?Port 3306 harus dibuka untuk instans MySQL melalui aturan masuk grup keamanan. Instans MySQL menggunakan port jaringan pribadi 3306 secara default dan mendukung port kustom. Jika port default diubah, port baru harus dibuka di grup keamanan.
 ...
 - **Tag** (Tag): mengategorikan dan mengelola sumber daya dengan tag. Untuk informasi selengkapnya, lihat [Tag > Ikhtisar](https://intl.cloud.tencent.com/document/product/236/31917).
...
2. Anda akan dikembalikan ke daftar instans setelah membeli instans. Instans akan berada dalam status **Delivering** (Mengirim). Anda dapat menginisialisasi instans setelah sekitar 3-5 menit saat statusnya berubah menjadi **Uninitialized** (Belum Diinisialisasi).

## Membeli Instans melalui API
Untuk informasi selengkapnya tentang cara membeli instans TencentDB melalui API, lihat [CreateDBInstanceHour](https://intl.cloud.tencent.com/document/product/236/15865).

## Operasi Selanjutnya
- [Menginisialisasi Instans MySQL](https://intl.cloud.tencent.com/document/product/236/3128)
- [Menghubungkan ke Instans MySQL](https://intl.cloud.tencent.com/document/product/236/37788)
