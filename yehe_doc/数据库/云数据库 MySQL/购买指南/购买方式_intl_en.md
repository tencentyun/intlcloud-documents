...
1. Log in to the [TencentDB for MySQL purchase page](https://buy.intl.cloud.tencent.com/cdb), configure the following instance information, and click **Buy Now**.
 ...
 - **Database Version**: Currently, TencentDB for MySQL supports MySQL 8.0, 5.7, 5.6, and 5.5. For more information on the features of each version, see [MySQL’s official documentation](https://dev.mysql.com/doc/refman/5.7/en/).
