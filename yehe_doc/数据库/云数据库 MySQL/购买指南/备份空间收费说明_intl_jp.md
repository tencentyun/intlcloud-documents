...
## バックアップの価格
無料割り当てを超えるバックアップキャパシティについては、中国本土リージョンの場合、0.0008元/GB/時間という価格で課金されます。その他のリージョンの価格については、[TencentDB for MySQL価格計算機](https://buy.intl.cloud.tencent.com/price/cdb/calculator)をご参照ください。
