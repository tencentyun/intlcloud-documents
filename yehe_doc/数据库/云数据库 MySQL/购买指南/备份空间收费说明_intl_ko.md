...
## 백업 가격
프리 티어를 초과하는 백업 공간 사용량은 중국 본토에서 0.000113 USD/GB/시간의 요금이 부과됩니다. 중국 본토 외 리전의 가격은 [TencentDB for MySQL 가격 계산기](https://intl.cloud.tencent.com/pricing/cdb/calculator)를 참고하십시오.
...
>?[롤백 기능](https://intl.cloud.tencent.com/document/product/236/7276)은 데이터 백업 및 로그 백업(binlog)의 백업 주기와 보관일에 의존합니다. 자동 백업 빈도 및 보존 기간을 줄이면 인스턴스 데이터의 롤백 시간 범위에 영향을 줍니다. 실제 요구 사항에 따라 적절하게 백업을 구성합니다.
>
