...
云数据库 MySQL 将于2021年11月22日起，进行参数相关能力和发货流程的优化。本次优化涉及参数模版创建、参数对比、参数模版应用、参数修改等能力、可修改参数以及新购实例优化的更新。
...
参数模板详细介绍请参见 [使用参数模板](https://intl.cloud.tencent.com/document/product/236/31906)。
...
## 联系我们
若您有任何疑问，可随时 [联系我们](https://console.cloud.tencent.com/workorder/category)。感谢您长期以来对腾讯云的支持，腾讯云也将持续为您提供更高性价比的产品。
