...
클라우드 데이터베이스 MySQL은 2021년 11월 22일부터 매개변수 관련 기능 및 전달 프로세스의 최적화를 진행합니다. 이 최적화에는 매개변수 템플릿 생성, 매개변수 비교, 매개변수 템플릿 적용, 매개변수 수정 및 기타 기능, 수정 가능한 매개변수, 신규 구입 인스턴스 최적화 업데이트가 포함됩니다.
...
자세한 내용은 [MySQL 인스턴스 생성](https://cloud.tencent.com/document/product/236/61667)을 참고하십시오.
