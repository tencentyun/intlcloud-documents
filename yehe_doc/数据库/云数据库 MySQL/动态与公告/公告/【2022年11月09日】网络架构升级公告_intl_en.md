...
- **Starting from November 9, 2022, the new network architecture will be applied to newly purchased instances to deliver lower latency and higher performance.
- **On January 21, 2023, all existing database instances will be switched to the new network architecture**. A momentary disconnection from the database may occur during the switch. Make sure that your business has a reconnection mechanism.
...
- By Saturday, January 21, 2023, the network architecture of all existing instances will be switched to the new version.
