...
Log in to the [TencentDB for MySQL console](https://console.intl.cloud.tencent.com/cdb), click an instance ID to enter the instance management page, select **Database Management** > **Parameter Settings**, and modify the `max_connections` parameter.
...
Log in to the [TencentDB for MySQL console](https://console.intl.cloud.tencent.com/cdb), click the instance ID to enter the instance management page, select **Database Management** > **Parameter Settings**, and modify the `lower_case_table_names` parameter (`0`: case-sensitive, `1`: case-insensitive).
