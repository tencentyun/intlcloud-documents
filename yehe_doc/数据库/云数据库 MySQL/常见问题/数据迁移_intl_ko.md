...
2. **데이터베이스 관리** > **데이터베이스 리스트** > **데이터 가져오기**를 선택합니다. 가져올 파일과 대상 데이터베이스를 선택하고 확인을 클릭하여 데이터를 가져옵니다.
>?
...
[DTS 데이터 마이그레이션](https://intl.cloud.tencent.com/zh/document/product/571/34103) 기능을 사용하여, 마이그레이션할 데이터베이스를 연결하고 데이터를 동기화할 것을 권장합니다.

## 도시 내 인스턴스 간의 데이터 동기화
### 도시 내 이중 백업을 위해 2개의 인스턴스를 실시간으로 데이터 동기화할 수 있습니까?
