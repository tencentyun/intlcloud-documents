...
그 밖에 업무상 필요에 따라 백업파일 보관 주기 설정을 효율적으로 설정할 수 있습니다. 기본 보관 기간은 7일로 최대 1830일까지 설정이 가능하며, 백업 보관 기간이 지난 백업 파일은 자동 삭제됩니다.

기능 사용은 [데이터베이스 백업](https://intl.cloud.tencent.com/document/product/236/32340)을 참조하십시오.
