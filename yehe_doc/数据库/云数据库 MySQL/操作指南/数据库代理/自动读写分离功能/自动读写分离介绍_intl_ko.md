...
따라서 읽기 전용 인스턴스 생성 후, 데이터베이스 프록시를 구입하여 읽기/쓰기 분리 기능을 활성화할 수 있으며 응용 프로그램에서 데이터베이스 프록시 주소는구성하여 쓰기 요청을 원본 인스턴스에 자동으로 전달하고 읽기 요청을 원본 인스턴스에 자동으로 전달할 수 있습니다. 또한 다음과 같이 다른 서비스 문제에 대해서도 자연스러운 솔루션을 제공할 수 있습니다.
