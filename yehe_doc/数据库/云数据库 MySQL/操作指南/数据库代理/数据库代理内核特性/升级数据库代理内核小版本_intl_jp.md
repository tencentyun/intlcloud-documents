データベースプロキシがカーネルのサブバージョンを不定期更新しますので、コンソールで手動でアップグレードしてください。ここでは、コンソールでデータベースプロキシのカーネルサブバージョンをアップグレードする方法をご紹介します。
...
- アップグレードできない場合、データベースのカーネルサブバージョンが20211031より古いことが考えられるため、データベースのカーネルバージョンをアップグレードしてから、データベースプロキシのカーネルバージョンをアップグレードしてください。
