...
Performance metrics are monitored at the second level, such as the number of read/write requests, CPU, and memory. The number of proxies can be adjusted according to the [monitoring data](https://intl.cloud.tencent.com/document/product/236/42055) and business planning.
- **Hot reload**
...
- **Support for [automatic read/write separation](https://intl.cloud.tencent.com/document/product/236/42054)**
