...
3. 在弹出的创建帐号对话框，输入帐号名、主机、密码和确认密码等信息，单击**确定**即可完成创建。
 ...
 - **密码**：密码最小长度需要8 - 64个字符，至少包含英文、数字和符号 \_+-&amp;=!@#$%^\*() 中的2种，支持设置密码复杂度以提升数据库安全性，请参见 [设置密码复杂度](https://intl.cloud.tencent.com/document/product/236/49197)。
...
| API 名称                                                      | 描述     |
| ------------------------------------------------------------ | -------- |
| [CreateAccounts](https://intl.cloud.tencent.com/document/product/236/17502) | 创建云数据库的帐号 |
