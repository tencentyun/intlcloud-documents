...
- Its high-availability master/slave architecture helps avoid single point of failure for database.
...
- If any failure occurs in the master instance, the disaster recovery instance can be activated in seconds to provide full read/write capability.
...
>?
>- The time required to complete the creation depends on the amount of data, during which no operations can be performed on the master instance in the console. Please do so at an appropriate time.
