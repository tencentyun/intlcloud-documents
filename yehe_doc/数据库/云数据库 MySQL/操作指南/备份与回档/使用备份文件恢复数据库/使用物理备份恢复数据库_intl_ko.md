...
- XtraBackup 툴을 다운로드 및 설치합니다.
  - MySQL 5.6, 5.7 Percona XtraBackup 2.4.6 이상을 선택하십시오. [다운로드 주소](https://www.percona.com/downloads/percona-xtrabackup-2.4/latest/) 설치 설명은 [Percona XtraBackup 2.4를 참조하십시오 안내](https://docs.percona.com/percona-xtrabackup/2.4/installation/yum_repo.html)다. 
  - MySQL 8.0 Percona XtraBackup 8.0.22-15 이상을 선택하십시오. [다운로드 주소](https://www.percona.com/downloads/Percona-XtraBackup-LATEST/#) 설치 설명은 [Percona XtraBackup 8.0를 참조하십시오 안내](https://docs.percona.com/percona-xtrabackup/8.0/installation/yum_repo.html)다. 
