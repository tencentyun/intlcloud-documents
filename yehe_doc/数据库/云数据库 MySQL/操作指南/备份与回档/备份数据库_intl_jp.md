...
>- 手動バックアップはバックアップリストで手動で削除することで、バックアップキャパシティをリリースして、キャパシティの浪費と占用を回避します。手動で削除しない限り、データベースインスタンスのダウンロードまで保持され続けます。
...
期限切れのバックアップセットは自動的に削除され、ダウンロードや復元ができません。
...
| アーカイブ類サービス             | バックアップの保留時間を7日間とし、実際のサービスニーズにより手動でデータをバックアップし、使い終わったら適宜削除することをお勧めします |
| テスト類サービス             | バックアップの保留時間を7日間とし、実際のサービスニーズにより手動でデータをバックアップし、使い終わったら適宜削除することをお勧めします |
