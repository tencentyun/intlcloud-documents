...
- After you switch a source instance's network, the networks of read-only instances or disaster recovery instances associated with the source instance won't be automatically switched; that is, you need to manually switch them.
