...
>?A disaster recovery instance costs the same as the source instance associated with it. For more information, see [Pricing | TencentDB for MySQL](https://buy.intl.cloud.tencent.com/price/cdb).
