...
#### Modifying character set through SQL
...
#### Modifying character set in TencentDB for MySQL console
...
## Network Selection
We recommend you use a VPC. In the VPC, you can freely define IP range segmentation, IP addresses, and routing policies. Compared with the classic network, VPC is more suitable for scenarios where custom network configurations are required. For the comparison of VPC and classic network, see [Managing Network](https://intl.cloud.tencent.com/document/product/215/31807).
