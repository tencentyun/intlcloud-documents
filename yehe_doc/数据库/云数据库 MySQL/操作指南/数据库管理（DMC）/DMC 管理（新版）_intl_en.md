This document describes the features of the new version of DMC, such as database/table creation, database management, instance monitoring, instance session management, and visualized table data editing.
...
The new version of DMC for MySQL supports inserting, deleting, and updating data. You can click a table in the left **Table** list to insert, delete, and update its data in batches in the right pane, and then click **OK** in the **Quick Operation** pane to preview the SQL statements and implement the modification.
