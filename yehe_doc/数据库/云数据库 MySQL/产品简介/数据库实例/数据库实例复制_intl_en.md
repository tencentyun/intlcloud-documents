...
### Async Replication
After receiving a data update (including INSERT, UPDATE and DELETE operations) request from an application, the source performs the update operation. When the update is completed, the source immediately sends a response to the application and replicates the data to the replica.
