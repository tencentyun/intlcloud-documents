...
## 相关概念
[实例](https://intl.cloud.tencent.com/document/product/236/7268)：腾讯云上的 MySQL 数据库资源。

[实例类型](https://intl.cloud.tencent.com/document/product/236/7268)：MySQL 实例在节点数量、读写能力与地域部署上不同的搭配。

[只读实例](https://intl.cloud.tencent.com/document/product/236/7270)：仅提供读功能的 MySQL 实例。
...
[数据库代理](https://www.tencentcloud.com/document/product/236/42048)：位于云数据库服务和应用服务之间的网络代理服务，用于代理应用服务访问数据库时的所有请求。
...
通过购买云数据库 MySQL 实例来搭建云上的数据服务，请参考 [购买方式](https://intl.cloud.tencent.com/document/product/236/5160) 和  [快速入门](https://intl.cloud.tencent.com/document/product/236/37786)。

使用云数据库 MySQL 数据库迁移工具，来实现云上云下数据的搬迁，请参考 [数据迁移](https://intl.cloud.tencent.com/document/product/236)。

使用云数据库 MySQL 数据订阅工具，来实现数据旁路清洗与分析，请参考 [数据订阅](https://intl.cloud.tencent.com/document/product/571/42664)。

使用云数据库 MySQL 审计功能，来完善事后审计与追溯机制，请参考 [数据库审计](https://intl.cloud.tencent.com/document/product/1102/41311)。

通过购买云服务器，来部署您的计算服务，请参考 [云服务器](https://intl.cloud.tencent.com/document/product/213)。

使用腾讯云可观测平台服务监控云数据库 MySQL 实例的运行情况，请参考 [腾讯云可观测平台产品文档](https://intl.cloud.tencent.com/doc/product/248)。
