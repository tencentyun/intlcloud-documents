...
多可用区部署可保护数据库，以防数据库实例发生故障或可用区中断，有关地域和地域下支持的可用区请参见 [地域和可用区](https://intl.cloud.tencent.com/document/product/236/8458)。
...
### 支持地域
云数据库 MySQL 多可用区部署目前支持广州、深圳金融、上海、上海金融、南京、北京、成都、中国香港、新加坡、雅加达、曼谷、孟买、首尔、东京、弗吉尼亚、法兰克福地区。
