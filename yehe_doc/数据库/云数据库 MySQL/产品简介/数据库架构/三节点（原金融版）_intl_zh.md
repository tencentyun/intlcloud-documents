...
- 三节点架构，根据不同的隔离策略，可以分为通用型、独享型，请参见 [隔离策略](https://intl.cloud.tencent.com/document/product/236/39794)。
...
- 三节点实例可用性能够达到99.99%，具体协议请参见 [服务等级协议](https://intl.cloud.tencent.com/document/product/236/30978)。
