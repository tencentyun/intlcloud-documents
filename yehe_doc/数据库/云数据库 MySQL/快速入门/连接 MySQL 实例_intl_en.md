...
## Preparations
- You have initialized a TencentDB for MySQL instance. For more information, please see [Initializing MySQL Instance](https://intl.cloud.tencent.com/document/product/236/3128).
- You have created a database account and authorized specific IPs or IP ranges to access the TencentDB for MySQL instance. For more information, please see [Creating an Account](https://intl.cloud.tencent.com/document/product/236/31900) and [Modifying Host Addresses with Access Permissions](https://intl.cloud.tencent.com/document/product/236/31903). Or, you can use the root account.
- You have configured security group rules for the CVM instance and the TencentDB for MySQL instance to allow specific IPs or IP ranges to access the TencentDB for MySQL instance. For more information, please see [TencentDB Security Group Management](https://intl.cloud.tencent.com/document/product/236/14470).
