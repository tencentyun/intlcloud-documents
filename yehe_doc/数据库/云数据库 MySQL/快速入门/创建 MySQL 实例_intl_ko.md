...
1. [MySQL 구매 페이지](https://buy.intl.cloud.tencent.com/cdb)에 로그인하여 각 항목의 구성 정보를 필요에 따라 선택하고 오류가 없는지 확인한 뒤, **즉시 구매**를 클릭합니다.
 ...
 - **데이터베이스 버전**: TencentDB for MySQL에서 현재 지원하는 버전은 MySQL 8.0, MySQL 5.7, MySQL 5.6, MySQL 5.5입니다. 각 버전의 특징은 [공식 문서](https://dev.mysql.com/doc/refman/5.7/en/)를 참고 바랍니다. 
