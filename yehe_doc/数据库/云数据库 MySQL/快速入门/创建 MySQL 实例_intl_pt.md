...
Este documento descreve como criar uma instância do TencentDB for MySQL no console.

## Pré-requisitos
Você criou uma conta da Tencent Cloud e concluiu a verificação de identidade.
- Para criar uma conta da Tencent Cloud:
<div style="background-color:#00A4FF; width: 170px; height: 35px; line-height:35px; text-align:center;"><a href="https://intl.cloud.tencent.com/register" target="_blank"  style="color: white; font-size:16px;" hotrep="document.guide.3128.btn1">Clique aqui para criar uma conta da Tencent Cloud</a></div>
- Para verificar sua identidade:
<div style="background-color:#00A4FF; width: 170px; height: 35px; line-height:35px; text-align:center;"><a href="https://console.cloud.tencent.com/developer" target="_blank"  style="color: white; font-size:16px;"  hotrep="document.guide.3128.btn2">Clique aqui para verificar sua identidade</a></div>

## Instruções
1. Faça login na [página de aquisição do TencentDB for MySQL](https://buy.cloud.tencent.com/cdb), configure as seguintes informações da instância e clique em **Buy Now (Comprar agora)**.
...
## Operação posterior
Após criar uma instância do TencentDB for MySQL, é necessário inicializá-la antes do uso propriamente dito.
 Para mais informações, consulte [Inicialização de instância do MySQL](https://intl.cloud.tencent.com/document/product/236/3128).
