...
| FIRST_UPDATE_TIMESTAMP         | MYSQL_TYPE_DATETIME | Time when the statistics information of the SQL statement is generated for the first time.                            |
| LAST_UPDATE_TIMESTAMP          | MYSQL_TYPE_DATETIME | Time when the statistics information of the SQL statement is last updated.                              |
| LAST_ACCESS_TIMESTAMP          | MYSQL_TYPE_DATETIME | Time when the statistics information of the SQL statement is last accessed.                          |
| EXECUTE_COUNT                  | MYSQL_TYPE_LONGLONG | Number of executions of this SQL statement.                                       |
...
| LAST_AFFECTED_ROWS             | MYSQL_TYPE_LONGLONG | Number of rows affected last time.                                          |
