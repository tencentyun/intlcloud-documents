...
您可以在云数据库 MySQL [购买页](https://buy.Intl.cloud.tencent.com/cdb) 购买实例时，选择引擎为 RocksDB，其他参数项可参考 [创建 MySQL 实例](https://intl.cloud.tencent.com/document/product/236/37785)。
