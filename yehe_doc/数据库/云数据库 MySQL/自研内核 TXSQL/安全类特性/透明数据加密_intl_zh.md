## 功能介绍
在 TXSQL 中，我们沿用 MySQL 的透明加密体系，提供 KEYRING 插件的另外一种实现：KEYRING_KMS，将 KEYRING 与腾讯云企业级的 [密钥管理服务 KMS](https://intl.cloud.tencent.com/zh/document/product/1030) 集成。
...
## 使用说明
开启透明数据加密功能，请参见 [透明数据加密](https://intl.cloud.tencent.com/document/product/236/38491)。
