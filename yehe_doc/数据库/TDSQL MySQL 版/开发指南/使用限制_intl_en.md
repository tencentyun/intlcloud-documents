...
### Other limits
Up to 5,000 tables can be created by default. If you need to create more tables, please [submit a ticket](https://console.cloud.tencent.com/workorder/category).
