...
## 建表
- 分表、单表、广播表的区别详情请参考 [相关表详情文档](https://intl.cloud.tencent.com/document/product/1042/38142)。
- 分表键（shardkey）选择的限制请参考 [分表键详情文档](https://intl.cloud.tencent.com/document/product/1042/38506)。
