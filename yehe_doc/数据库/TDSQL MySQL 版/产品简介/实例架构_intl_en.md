...
<td rowspan = "2"><li>Supports read-only replicas.</li><li>Automatic node failover.</li><li>Default sampling granularity for monitoring: once every 5 minutes.</li><li>Maximum backup time: 7 days.</li><li>Operation log backup time: 7 days.</li><li>Supports database audit where audit logs can be retained for 15 days and an unlimited number of rules which can be configured.</li></td></tr>
<tr>
