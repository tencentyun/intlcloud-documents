...
开启数据加密后，暂时不支持用备份文件在本地恢复数据库实例，推荐采用 [回档数据库](https://intl.cloud.tencent.com/document/product/1042/47382) 进行恢复。 
>?如需使用数据加密功能，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请。


## 注意事项
- 目前实例 [开启密钥管理系统 KMS](https://intl.cloud.tencent.com/document/product/1030/32774) 后，不可创建灾备/只读实例。
- TDE 加密功能开通后无法关闭。
