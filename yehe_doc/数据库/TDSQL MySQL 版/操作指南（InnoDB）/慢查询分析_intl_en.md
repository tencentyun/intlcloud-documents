...
>- To download slow logs, you need to copy the download address, [log in to a (Linux) CVM instance in the same VPC as the database instance](https://intl.cloud.tencent.com/zh/document/product/213/10517), and run the `wget` command for download over the private network.
