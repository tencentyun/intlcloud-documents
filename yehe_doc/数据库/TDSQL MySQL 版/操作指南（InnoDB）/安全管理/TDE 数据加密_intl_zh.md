...
- 需开通 [密钥管理服务 KMS](https://intl.cloud.tencent.com/document/product/1030/32774)。如未开通，请根据 TDE 加密功能引导进行开通。
- 需获得 KMS 密钥权限。如未开通，请根据 TDE 加密功能引导进行开通。

## 注意事项
- 开启 KMS 后，可能产生密钥管理服务（KMS）费用，请参见 [KMS 购买指南](https://intl.cloud.tencent.com/document/product/1030/31967)。
- TDE 加密功能开通后无法关闭。
- 若已开通灾备/只读实例，暂时不支持 TDE 加密功能。
- 开启 TDE 加密功能后，暂时不支持创建灾备/只读实例。
- 开启 TDE 加密功能后，暂时不支持用备份文件在本地恢复数据库实例，推荐采用 [回档数据库](https://intl.cloud.tencent.com/document/product/1042/47382) 进行恢复。
