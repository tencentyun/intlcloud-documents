## カーネルカスタマイズ
カーネルコミュニティにより長期間サポートされる、4.14.105バージョンに基づきカスタマイズしました。クラウドのシーンに適した特徴が追加され、カーネルパフォーマンスが改善され、重大なバグが修正されました。
...
## ソフトウェアパッケージサポート
- CentOS 7バージョンのソフトウェアパッケージに基づきカスタマイズしました。
- ユーザーステータスのソフトウェアパッケージとCentOS 7バージョンは互換性があります。このバージョンのユーザーステータスのソフトウェアパッケージはTencentOS Server環境で直接使用することができます。
- YUMを使用してソフトウェアパッケージをアップデートおよびインストールします。
