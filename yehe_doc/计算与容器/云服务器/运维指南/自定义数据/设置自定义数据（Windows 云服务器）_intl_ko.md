...
- Windows Server 2019 데이터센터 에디션 64비트 중국어/영어 에디션
...
1. [인스턴스 생성](https://intl.cloud.tencent.com/document/product/213/4855)을 참조하여 인스턴스를 구매하고 "4. 보안 그룹과 호스트 설정”에서 [고급 설정]을 클릭하십시오. 다음 그림과 같습니다.
...
2. "고급 설정"에서 실제 요구에 따라 "사용자 정의 데이터"의 텍스트 박스에 준비한 내용을 입력하십시오.
 ...
 - Base64 인코딩 스크립트: 먼저[base64 양식 텍스트로 입력]을 선택하고 다시 [Base64 인코딩 스크립트](#Base64Script)를 입력합니다. 다음 그림과 같습니다.
