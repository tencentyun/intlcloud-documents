...
3. 内网访问链路建立成功后，可采用 [使用私有域解析 VPCDNS 自动配置](https://intl.cloud.tencent.com/document/product/1051/35492) 或  [使用 TCR 插件自动配置](https://intl.cloud.tencent.com/document/product/1051/35492) 实现内网域名解析。详情请参见 [内网访问控制](https://intl.cloud.tencent.com/document/product/1051/35492)。
