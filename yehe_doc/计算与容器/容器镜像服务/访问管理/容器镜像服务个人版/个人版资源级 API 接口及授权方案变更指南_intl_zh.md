...
API 升级期间，访问管理相关接口将同时兼容新旧的资源（Resource）描述方式及动作（Action），以保障用户自定义策略仍然生效。为方便您统一管理 API 接口及授权方案，建议您统一将授权方案升级为最新版本，详情请参考 [个人版授权方案示例](https://intl.cloud.tencent.com/document/product/1051/37250)。
...
具体授权方案请参考：[TKE 镜像仓库资源级权限设置](https://intl.cloud.tencent.com/document/product/457/11527)。
...
具体授权方案请参考：[个人版接入 CAM 的 API 列表](https://intl.cloud.tencent.com/document/product/1051/39861) 及 [个人版授权方案示例](https://intl.cloud.tencent.com/document/product/1051/37250)。
