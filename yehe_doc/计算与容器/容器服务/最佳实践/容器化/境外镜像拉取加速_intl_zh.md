...
腾讯云 [容器镜像服务 TCR](https://intl.cloud.tencent.com/document/product/1051) 企业版提供主流境外镜像托管平台加速服务, 可以有效解决境外镜像拉取难导致开源应用无法顺利部署的问题。本文将介绍 TKE 集群如何通过 TCR 加速服务实现境外镜像拉取加速。
...
- 加速服务目前仅面向容器服务 TKE、容器镜像服务 TCR 用户，如有需求请提交 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请使用。
- 加速服务目前只支持腾讯云 [私有网络 VPC](https://intl.cloud.tencent.com/document/product/215) 访问，公网访问能力暂未开放，相关域名可以访问但无法提供实际的加速功能。
- 如需使用其他主流镜像托管平台内镜像，请提交 [提交工单](https://console.cloud.tencent.com/workorder/category) 咨询。
...
```
 >?您还可以使用 Ansible 批量修改存量节点的 Containerd 配置，详情请参见 [使用 Ansible 批量操作 TKE 节点](https://intl.cloud.tencent.com/document/product/457/38427)。
