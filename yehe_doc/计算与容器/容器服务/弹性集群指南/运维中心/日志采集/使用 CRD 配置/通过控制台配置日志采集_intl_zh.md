...
## 操作场景
在弹性容器服务 EKS 中，用户可以 [通过环境变量配置日志采集](https://intl.cloud.tencent.com/document/product/457/37907)，按行采集日志、不解析。也可以通过自定义资源定义（CustomResourceDefinitions，CRD）的方式配置日志采集。
