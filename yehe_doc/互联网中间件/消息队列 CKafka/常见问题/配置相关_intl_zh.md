...
当前 CKafka 未开放自动创建 Topic 的开源接口，建议客户通过标准的 API 接口 [CreateTopic](https://intl.cloud.tencent.com/document/product/597/35347) 创建 Topic。
>
- 通过接口 [CreateTopic](https://intl.cloud.tencent.com/document/product/597/35347) 自动创建的 Topic 也会占用您实例中 Topic 和 Partition 的配额，请注意配额限制。
...
3. 消费者已经到最高设置（≥ 您的分区数），建议您再提高主题分区数，可以 [提交工单](https://console.cloud.tencent.com/workorder/category?level1_id=876&level2_id=951&source=0&data_title=%E6%B6%88%E6%81%AF%E9%98%9F%E5%88%97%20CKafka&step=1) 申请开通白名单，我们后台审核帮忙提高分区个数。
