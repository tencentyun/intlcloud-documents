...
目前 CKafka 服务可以完美兼容0.9、0.10、1.1、2.4版本的开源 Kafka API，实现用户零成本上云。

### 当前的 CKafka 是基于开源 Kafka 的哪个版本？
当前 CKafka 基于 Apache Kafka 0.10、1.1、2.4版本，推荐生产消费端选取对应版本的 SDK。
...
CKafka 可以兼容0.9、0.10、1.1、2.4版本的开源 Kafka，您可以通过 Kafka 客户端连接消息中心，并且把代码部署在腾讯云服务中生产或消费消息。
