...
3. On the instance purchase page, set the configuration information for purchase based on your actual needs.
	...
	- AZ: select an AZ according to your actual needs
		...
		- Pro Edition: if the current region supports multi-AZ deployment, you can select up to 2 AZs for deployment. For more information on how multi-AZ deployment works, please see [Multi-AZ Deployment](https://cloud.tencent.com/document/product/597/52786)
