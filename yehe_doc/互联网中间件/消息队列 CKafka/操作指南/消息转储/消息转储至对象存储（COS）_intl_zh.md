...
>- 通用转储模板常见的转储应用场景有 [Elasticsearch Service](https://intl.cloud.tencent.com/product/es)、[MySQL](https://intl.cloud.tencent.com/product/cdb)、PostgreSQL 等。
...
- 该功能基于云函数 SCF 服务提供。SCF 为用户提供了一定量 [免费额度](https://intl.cloud.tencent.com/document/product/583/12282) ，超额部分产生的收费，请以 SCF 服务的 [计费规则](https://intl.cloud.tencent.com/document/product/583/17299) 为准。
