...
2. 在 ckafka-migrate.py 文件中填写配置参数。
   ...
   # 美东弗吉尼 na-ashburn;北美多伦多 na-toronto;中国台北 ap-taipei;天津 ap-tianjin;
   # 深圳 ap-shenzhen;德国法兰克 eu-frankfur;首尔 ap-seoul;清远 ap-qingyuan;
   # 莫斯科 eu-moscow;曼谷 ap-bangkok;长沙 ap-changsha-ec;雅加达 ap-jakarta
