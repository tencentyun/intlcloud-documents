...
| 限制项              | 说明                                                         |
| ------------------- | ------------------------------------------------------------ |
| Topic 总数量        | 根据产品规格不同固定上限，详情可参考 [计费概述](https://intl.cloud.tencent.com/document/product/597/11745)。 |
...
| Consumer group 数量 | <li>标准版：实例级别 Consumer group 默认限制为50个。</li><li>专业版：实例级别 Consumer group 限制初始为50个，可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请升级到最高500个。</li> |
| 实例                | <li>不支持变更实例地域属性。</li><li>客户端实例最大连接数量为5000，实例连接超过该最大值会导致客户端无法创建新的连接，如评估该最大值在实际业务中不合理可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请扩大。</li> |
