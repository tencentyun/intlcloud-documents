...
>- 非独占型实例不能直接升配为独占型实例，请参考 [迁移数据到 CKafka](https://intl.cloud.tencent.com/document/product/597/17272)。如需独占型实例，请联系商务经理或 [提交工单](https://intl.cloud.tencent.com/login?s_url=https%3A%2F%2Fconsole.cloud.tencent.com%2Fworkorder%2Fcategory)，申请提交后我们将在5个工作日内进行审核并与您取得联系。
