...
This document describes how to use the PHP SDK to connect to CKafka via the default access point and send and receive messages in a VPC environment.
...
1. Create a configuration file named `ckafkasetting.php`.
```php
<?php
return [
...
| ----------------- | ------------------------------------------------------------ |
| bootstrap_servers | Default access point. You can obtain it as follows: in the [CKafka console](https://console.cloud.tencent.com/ckafka), go to the instance details page and click the **Basic Info** tab. Then you can find the default access point in the **Access Mode** area or in the **Private IP and Port** parameter in the **Configuration Info** area. |
