...
## 前提条件
已 [创建服务](https://intl.cloud.tencent.com/document/product/628/11787)。
...
* 访问方式选择内网 VPC 和公网时，会得到两个二级子域名，分别用于内网 VPC 访问或公网访问（内网 VPC 为白名单功能，可 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请开通）。
