...
>
>- 通用 API：适用于一般情况（后端业务未实现在 TSF 中），创建过程请参考 [创建通用 API](https://intl.cloud.tencent.com/document/product/628/11797)。
>- 微服务 API：适用于后端业务实现在 TSF 中的情况，创建过程请参考 [创建微服务 API](https://intl.cloud.tencent.com/document/product/628/17561)。
