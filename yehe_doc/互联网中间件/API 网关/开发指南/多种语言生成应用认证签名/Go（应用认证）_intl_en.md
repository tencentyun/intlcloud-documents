...
This document describes how to authenticate and manage your APIs through application-enabled authentication in Go.
...
5. Generate signing information in Go by referring to the [Sample Code](#示例代码).
