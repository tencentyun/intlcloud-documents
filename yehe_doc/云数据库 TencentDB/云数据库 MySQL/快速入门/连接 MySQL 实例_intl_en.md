...
If the verification with telnet found that the network access of the TencentDB instance was good, but an error was reported when you tried to log in to it on the command line in the CVM instance, please see [Connection](https://intl.cloud.tencent.com/document/product/236/37783).
