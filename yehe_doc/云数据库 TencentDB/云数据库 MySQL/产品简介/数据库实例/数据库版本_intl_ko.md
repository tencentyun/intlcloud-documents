...
- 풍부한 제품 형태: 단일 노드 고IO 버전, 고가용성 버전, 파이낸스 버전.
- 고성능의 분석 엔진 CStore 지원. CStore의 고성능 스토리지 엔진은 초당 백만개의 실시간 입력을 지원합니다. 이를 통해 수많은 데이터를 어떤 차원에서든 1000분의 1초 안에 실시간으로 조회할 수 있습니다. 해당 엔진은 [Submit Ticket](https://console.cloud.tencent.com/workorder/category)을 통해 활성화하십시오.
