...
2. Select **Database Management** > **Database List** and click **Data Import**.
...
>- Only incremental data import is supported. If there is obsolete data in the database, clear the data before the importing operation.
>- A single file does not exceed 2 GB. The file name allows English letters, numbers, and underlines.
