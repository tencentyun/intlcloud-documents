...
- **完备的性能监控**
提供了读/写请求数、CPU、内存等性能指标的秒级监控，可以根据 [监控数据](https://intl.cloud.tencent.com/document/product/236/42055) 及业务规划调整代理个数。
- **热加载**
主实例发生切换、变配、只读实例增减等情况，数据库代理可动态热加载配置，不会出现网络中断或重启。
- **支持 [自动读写分离](https://intl.cloud.tencent.com/document/product/236/42054)**
