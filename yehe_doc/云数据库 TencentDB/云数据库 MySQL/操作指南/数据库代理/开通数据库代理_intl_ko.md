...
[데이터베이스 프록시](https://intl.cloud.tencent.com/document/product/236/42048)는 CDB서비스와 애플리케이션 서비스 간에 위치한 네트워크 프록시 서비스이며 애플리케이션 서비스가 데이터베이스에 액세스할 때의 모든 요청을 중계합니다. 데이터베이스 프록시는 읽기/쓰기 분리, 연결 풀, 연결 유지 등 고급 기능을 지원하며, 고가용성, 고성능, 유지 보수 가능, 간단하고 알기 쉽다는 특징이 있습니다. 
