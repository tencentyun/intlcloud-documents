...
## 작업 순서
1. [MySQL 콘솔](https://console.cloud.tencent.com/cdb)에 로그인한 뒤, Instance List에서 인스턴스 명칭 혹은 '작업' 열의 [관리]를 클릭하여 인스턴스 관리 페이지에 접속합니다.
2. [조작 로그] 페이지에서 인스턴스의 슬로우 로그 상세, 오류 로그 상세, 롤백 로그를 조회하고 슬로우 로그를 다운로드할 수 있습니다.
<table>
<thead>
<tr>
<th>기능 항목</th>
