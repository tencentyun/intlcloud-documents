[MySQLコンソール](https://console.coud.tencent.com/cdb)又は[API](https://intl.coud.tencent.com/document/product/236/15860)でパラメータの一部を確認、変更でき、また、コンソールでパラメータ変更履歴を問い合わせることもできます。
...
3. 「パラメータ実行値」カラムで、変更したいパラメータを選択して変更を実行し、間違いがないことを確認した後、「変更確認」をクリックします。
![](https://main.qcloudimg.com/raw/5307fbeef4b1fccef478ab7fd57b3167.png)
4. 表示されたダイアログで同意をチェックし、【OK】をクリックします。
