...
>For read-only instance pricing, please see [Product Pricing](https://buy.cloud.tencent.com/price/cdb).
>
...
- The specification of a read-only instance can be different from that of the master instance, which makes it easier for you to upgrade the instance according to the load. You are recommended to keep the specifications of read-only instances in the same RO group the same.
...
4. Select the desired read-only instance configuration on the purchase page. After confirming that everything is correct, click **Buy Now**.
