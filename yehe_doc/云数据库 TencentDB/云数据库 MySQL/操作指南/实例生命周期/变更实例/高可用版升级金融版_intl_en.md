...
>
>- Only High-Availability Edition instances on MySQL 5.6 and 5.7 can be upgraded to the Finance Edition.
...
4. Confirm the price and return to the instance list where the instance status is "Changing configuration". After the status becomes "Running", the instance can be used normally in the console.
