...
<tbody><tr>
<td>Database backup page release</td>
...
<tbody><tr>
<td>Automatic backups fully upgraded to physical backup</td>
...
<td>A security group is a stateful virtual firewall capable of filtering. As an important means for network security isolation provided by Tencent Cloud, it can now be used to set network access controls for one or more TencentDB instances.</td>
<td>August 2017</td>
