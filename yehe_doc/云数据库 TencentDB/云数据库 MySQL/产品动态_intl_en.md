...
<td>By subscribing to events such as OOM, source-replica switch, read-only instance elimination, and instance migration caused by server failure, you can now stay on top of your instance statuses.</td>
<td>2019-11</td>
...
<td>Read-only instances can now adopt different specifications from those of source instances.</td>
<td>2017-08</td>
