...
<td>TencentDB for MySQL now supports three types of architectures including single-node (formerly Basic Edition), two-node (formerly High-availability Edition), and three-node (formerly Finance Edition), and three resource isolation policies including basic, general, and dedicated policies.</td>
<td>March 2021</td>
...
<tr>
<td>Read-only replicas support exclusive private network addresses</td>
<td>You can now configure a custom and exclusive private network address (IP and port) for a read-only replica.</td>
<td>March 2021</td>
<td><a href="https://intl.cloud.tencent.com/document/product/236/7270" target="_blank">Creating Read-only Replicas</a></td></tr>
</tbody></table>
...
<td>November 2020</td>
<td><a href="https://intl.cloud.tencent.com/document/product/236/38864" target="_blank">Clone Instances</a></td>
</tr>
</tbody></table>
...
<td>By subscribing to events such as OOM, source-replica switch, read-only replica removal, and instance migration caused by server failure, you can now stay on top of your instance statuses.</td>
<td>November 2019</td>
...
<tbody><tr>
<td>Read-only replicas now support elastic specifications</td>
<td>Read-only replicas can now adopt different specifications from those of source instances.</td>
<td>August 2017</td>
<td><a href="https://intl.cloud.tencent.com/document/product/236/7270" target="_blank">Read-only Replicas</a></td>
</tr>
<tr>
...
<tbody><tr>
<td>Read-only replica feature is available</td>
<td>TencentDB for MySQL allows you to create one or more read-only replicas, which is suitable for read/write separation and one-source-multiple-replica application scenarios and capable of greatly enhancing the read load capacity of your database.</td>
<td>March 2016</td>
<td><a href="https://intl.cloud.tencent.com/document/product/236/7270" target="_blank">Read-only Replicas</a></td>
</tr>
<tr>
