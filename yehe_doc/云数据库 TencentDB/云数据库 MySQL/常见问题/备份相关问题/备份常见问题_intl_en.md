...
TencentDB for MySQL offers a certain amount of backup capacity free of charge based on the region, which is equivalent to the sum of high-availability storage capacity in your region.
...
TencentDB for MySQL instances are fully backed up on a daily basis. For more information, please see [Backup Mode](https://intl.cloud.tencent.com/document/product/236/32340). You can also back up data in the following ways:
- Back up data with the mysqldump tool.
- Back up data with a third-party tool such as Navicat Premium.
- [Log in to phpMyAdmin](https://intl.cloud.tencent.com/document/product/236/32341) and back up data through **Export** on the topbar.
