...
### How do I enable the scheduler function in TencentDB for MySQL?
...
### How do I locate the SQL statement for full table scan in TencentDB for MySQL?
...
Even though TencentDB supports changing the default character set, you are recommended to explicitly specify the table encoding format when creating it and specify the connection encoding during connection establishment. In this way, your application will be more portable. For more information on the default MySQL character set and how to change it, please see <a href="https://intl.cloud.tencent.com/document/product/236/7259" target="_blank">Use Limits</a>. You can change the character set in the TencentDB Console.
