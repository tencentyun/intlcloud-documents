...
バックアップスペースの使用情報は、[MySQLコンソール](https://console.cloud.tencent.com/cdb/backup) のデータベースのバックアップページで表示できます。バックアップスペース課金の詳細については、[バックアップスペース料金の説明](https://cloud.tencent.com/document/product/236/36263)をご参照ください。
