...
<td>数据库类型</td>
<td>实例规格</td>
<td align="center">上海,广州,北京,南京,清远</td>
<td>成都,重庆</td>
<td>新加坡,香港,台北,多伦多,孟买</td>
<td>东京,首尔,俄罗斯,曼谷,法兰克福,硅谷,弗吉尼亚</td>
</tr>
<tr>
<td>高可用版-主实例</td>
<td>MySQL主实例</td>
...
1. 以上价格仅为实例规格的配置费用，存储空间、备份空间、带宽价格不在其中。
3. 本表格中的所有价格均为新购价格，续费、调整配置时的价格可能有所不同。
4. 官网价格会根据情况做适当调整，具体价格请参考官网，不作为长期有效数据。
...
<tbody><tr>
<td>数据库类型</td>
<td>上海,广州,北京,南京,清远</td>
<td>成都,重庆</td>
<td>香港,台北,新加坡,首尔,多伦多,孟买,曼谷</td>
<td>法兰克福,硅谷,弗吉尼亚</td>
<td>东京，莫斯科</td>
</tr>
<tr>
...
## 计费示例
【包年包月示例】：您在广州地域下，购买1个实例内存为4核8000MB、硬盘为500GB的包年包月云数据库 MySQL，购买时长为1个月。
当月费用计算如下：
实例价格 = 内存规格费用 + 存储空间费用 = （114.93美元/月 + 500GB × 0.1014美元/GB/月 ）× 1个月 = 165.63美元
【按量计费示例】：您在广州地域下，购买1个实例内存为4核8000MB、硬盘为500GB的按量计费云数据库 MySQL，购买时长为400个小时。
