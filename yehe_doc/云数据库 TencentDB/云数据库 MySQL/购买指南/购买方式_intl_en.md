...
1. Log in to the [MySQL purchase page](https://buy.cloud.tencent.com/cdb), specify the instance information based on your needs, and click **Buy Now**.
 ...
 - **Alarm Policy**: you can create an alarm policy to trigger alarms and send messages when the Tencent Cloud product state changes. For more information, please see [Alarming Feature](https://intl.cloud.tencent.com/document/product/236/8457).
