...
1. [MySQL 구매 페이지](https://buy.cloud.tencent.com/cdb)에 로그인하여, 각 항목의 구성 정보를 필요에 따라 선택하고 착오가 없는지 확인한 뒤, [바로 구매]를 클릭합니다.
 ...
 >?마스터/슬레이브 기기가 서로 다른 가용존에 있으면, 네트워크 동기화 딜레이가 2~3분가량 증가할 수 있습니다.
...
2. 결제를 완료하고 Instance List로 돌아온 뒤 "발주중"(약 3분~ 5분간 소요할 수 있으니 기다려 주시기 바랍니다.)으로 표시된 걸 볼 수 있고, 인스턴스 상태가 '초기화하지 않음'으로 바뀌었다면 초기화 작업을 진행할 수 있습니다.
