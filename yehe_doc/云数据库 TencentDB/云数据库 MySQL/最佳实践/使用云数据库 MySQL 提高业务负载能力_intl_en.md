...
### 1.1 データベースのバージョンを選択
TencentDB for MySQLは現在、以前のMySQLの5.5、5.6、5.7バージョンと完全な互換性を有していますが、5.6またはそれより高いバージョンの選択をお勧めします。これらはより安定したデータベースカーネルを有し、5.5およびこれより古いバージョンの設計を最適化してシステムパフォーマンスを向上させ、多くの新しい魅力ある特性を提供しています。
