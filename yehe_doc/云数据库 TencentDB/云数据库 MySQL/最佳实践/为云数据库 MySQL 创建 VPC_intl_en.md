...
You can create a custom route table, edit its routing policy, and associate it with a specified subnet. The route table associated with a subnet is used to specify outbound routes for the subnet.
...
3. In the pop-up dialog box, enter the name, network, and new routing policy and click **Create**. Return to the route table list and you can see the created route table.
...
4. Complete the purchase of the CVM instance as instructed by the page. For more information, please see [Purchasing Channels](https://intl.cloud.tencent.com/document/product/213/506) in the CVM documentation.
...
2. In the **Network** section on the purchase page, choose the VPC created previously and the corresponding subnet, and add the new TencentDB instance to the VPC.
