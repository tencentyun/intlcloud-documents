...
#### Fixes
- Fixed the error where replication would be interrupted if there were reserved words in the column name in a GRANT statement.
...
- Fixed the error where the system crashed due to the use of `NAME_CONST`.
...
- Supports the CATS lock scheduling method.
...
### Version 20180530
#### New features
- Supports the SQL auditing feature.
...
- Supports thread pool. To use this feature, please [submit a ticket](https://console.cloud.tencent.com/workorder/category) for application.
...
### Version 20180915
#### New features
- Automatically changes the MEMORY engine to InnoDB engine: if the global variable `cdb_convert_memory_to_innodb` is set to `ON`, the table engine will be changed to InnoDB from MEMORY when a table is created/modified.
- Supports automatic killing of idle tasks to reduce resource conflicts. To use this feature, please [submit a ticket](https://console.cloud.tencent.com/workorder/category) for application.
