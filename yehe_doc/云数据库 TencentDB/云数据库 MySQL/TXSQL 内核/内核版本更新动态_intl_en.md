...
## MySQL 8.0
### 20200630
Based on MySQL 8.0.18, TXSQL 8.0 is the first version of TXSQL 8.0 series. 

#### New features
- Supports async deletion of big tables.
- Supports dynamically enabling/disabling semi-sync mode.
- Supports automatic killing of long-running transactions.

#### Fixed MySQL bugs
- Fixed the error where switch failed due to inconsistent source-replica `log_pos`.
...
- Updates the feature for e-commerce flash sales. To use it, please [submit a ticket](https://console.cloud.tencent.com/workorder/category).
- Supports the SQL throttling feature. To apply for this feature, please [submit a ticket](https://console.cloud.tencent.com/workorder/category).
- Supports data encryption using a KMS custom key.
