...
### 20190930
#### 新機能：
- ユーザーはshow full processlistステートメントを実行して、「ユーザースレッドのメモリー使用状況」を確認することができます。この機能を有効化するには、[チケットを提出](https://console.cloud.tencent.com/workorder/category) して申請する必要があります。  
