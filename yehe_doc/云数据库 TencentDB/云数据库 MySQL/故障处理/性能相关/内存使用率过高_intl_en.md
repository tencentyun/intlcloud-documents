...
2. Reduce invalid persistent connections and lower the connection pool configuration or concurrency level on the program side without affecting the business. You can use DBbrain to [view the current session information](https://intl.cloud.tencent.com/document/product/1035/36037).
