...
1. Log in to the [DBbrain Console](https://console.cloud.tencent.com/dbbrain/analysis), select **Performance Optimization** on the left sidebar, and select **Performance Trends** at the top.
