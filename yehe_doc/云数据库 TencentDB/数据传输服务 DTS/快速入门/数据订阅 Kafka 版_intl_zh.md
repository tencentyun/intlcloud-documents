...
关于两级分区信息请参见 [两级分区](https://intl.cloud.tencent.com/document/product/1042/33361)。
...
## 数据消费
订阅实例进入“运行中”状态之后，就可以开始消费数据。具体的消费逻辑参见 [数据消费 Demo](https://intl.cloud.tencent.com/document/product/571/39538)，我们提供了多种语言的 Demo 代码供您参考，也对消费的主要流程和关键的数据结构进行了说明。

## 后续操作
数据订阅 Kafka 版支持用户创建多个消费组，进行多点消费，请参见 [新增消费组](https://intl.cloud.tencent.com/zh/document/product/571/39534)。
