...
### 步骤4：使用 SDK 消费数据
请参见 [SDK 使用指南](https://intl.cloud.tencent.com/document/product/571/8776)。

## 订阅案例
[拉取对应订阅表的变化至本地文件](https://intl.cloud.tencent.com/document/product/571/34107)
[拉取对应订阅表的变化至 Redis ](https://intl.cloud.tencent.com/document/product/571/34106)
[拉取对应订阅表的变化至 Kafka ](https://intl.cloud.tencent.com/document/product/571/16856)
