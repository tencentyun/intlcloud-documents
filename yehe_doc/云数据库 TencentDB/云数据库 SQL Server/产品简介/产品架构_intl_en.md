...
## Database Mirroring
Currently, TencentDB for SQL Server supports the database mirroring (high-availability replication) scheme by default to enable automatic switching in seconds, lowering the data loss to "zero".
