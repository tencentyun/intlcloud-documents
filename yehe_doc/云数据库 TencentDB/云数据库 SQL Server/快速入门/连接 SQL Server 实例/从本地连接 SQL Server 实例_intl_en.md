...
2. Prepare a Linux CVM instance **with a public IP**. For more information, please see [Customizing Linux CVM Configurations](/doc/product/213/2936).
3. Log in to the Linux CVM instance locally with an SSH tool such as SecureCRT (as demonstrated in this document) or PuTTY. For the login method, please see [Logging into Linux Instance](/doc/product/213/5436).
