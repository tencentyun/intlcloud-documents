## 实例列表页
在 [云数据库 SQL Server 控制台](https://console.cloud.tencent.com/sqlserver) 的实例列表页可查看实例相关信息，以及管理实例。
...
## 实例管理页
登录 [云数据库 SQL Server 控制台](https://console.cloud.tencent.com/sqlserver)，发货完成后，在实例列表，单击实例名或在“操作”列的【管理】，可以进入实例管理页面。您可以进行实例详情查看、实例监控、数据库管理等操作。
