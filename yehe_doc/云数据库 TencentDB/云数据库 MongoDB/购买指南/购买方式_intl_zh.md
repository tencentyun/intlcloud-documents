...
2. 在购买页选择各项配置，确认无误后单击【立即购买】。
 - **计费模式**：支持按量计费，计费模式详情参见 [计费概述](https://intl.intl.cloud.tencent.com/document/product/240/3550)。
 ...
 - **规格**：可选的计算规格参见 [计费概述](https://intl.intl.cloud.tencent.com/document/product/240/3550)。
