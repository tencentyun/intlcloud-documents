...
>- 对于分片集群，最大连接数取`片数 * 单片规格`和`20000`之间的较小值。
...
## 避免写满磁盘
实例磁盘被写满100%后，会被禁止执行写操作，请根据业务情况及时调整实例配置，调整实例配置请参见 [调整实例规格](https://intl.cloud.tencent.com/document/product/240/31192)，如果出现磁盘写满封禁情况，请 联系我们寻求相应的帮助。
