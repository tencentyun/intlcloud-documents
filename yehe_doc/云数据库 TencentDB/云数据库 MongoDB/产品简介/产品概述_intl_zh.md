...
分片集群在副本集的基础上，通过多组副本集的组合，可以实现数据的横向扩展，即分片集群（Sharded Cluster），各组件功能介绍如下：
...
>?
>- 单节点目前仅支持4.0版本。
>- 单节点不支持7天任意时间回档，如有数据恢复需求请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
>- 单节点不支持慢日志查询、连接数管理功能。
>- 单节点架构中，仅保留主节点，因此无法提供高可用服务。
