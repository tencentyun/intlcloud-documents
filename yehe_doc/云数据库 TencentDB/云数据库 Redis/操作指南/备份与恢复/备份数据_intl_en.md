...
1. On the instance management page, select the **Backup and Restore** tab, and click **Download** in the "Operation" column.
2. In the pop-up dialog box, copy the download address or click **Download** to download the backup file. Cross-AZ download is not supported.
