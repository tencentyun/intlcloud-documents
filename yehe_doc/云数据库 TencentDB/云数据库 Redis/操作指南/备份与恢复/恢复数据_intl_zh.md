## 操作场景
云数据库 Redis 社区版（2.8版）、CKV 版支持从备份中恢复整个实例。
	
>
>- 仅云数据库 Redis 社区版（2.8版）、CKV 版支持恢复实例，云数据库 Redis 社区版（不含2.8版）支持 [克隆数据](https://intl.cloud.tencent.com/document/product/239/31897)。
>- 恢复整个实例会中断实例对外提供的服务。
>- 实例恢复后数据将被覆盖，无法恢复。
...
>
![](https://main.qcloudimg.com/raw/55938a2c53684b588b95498fae36a991.png)
