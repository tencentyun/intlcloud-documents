...
- 提主过程中服务会有短暂访问抖动，抖动的时间从几秒到3分钟以内，切换过程中 BLPOP、BRPOP、BRPOPLPUSH、SUBSCRIBE 等阻塞命令会有一次或者多次失败。
- 提主过程可能会失败，通常重试即可执行成功。
- 切换主节点后，您的访问可能会跨可用区，导致访问延迟增加，[QPS](https://intl.cloud.tencent.com/document/product/239/31950#qps.2F.E5.B9.B6.E5.8F.91) 降低。
