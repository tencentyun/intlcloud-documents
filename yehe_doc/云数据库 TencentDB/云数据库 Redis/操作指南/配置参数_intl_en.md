...
2. On the **Parameter Configuration** > **Modifiable Parameters** tab, locate the desired parameter in the parameter list and click <img src="https://main.qcloudimg.com/raw/788902e3f8c335cf17de420f7181c2a8.png"  style="margin:0;"> in the **Current Value** column.
...
1. Log in to the [TencentDB for Redis console](https://console.cloud.tencent.com/redis), click an instance ID/name in the instance list, and enter the instance management page.
2. On the **Parameter Configuration** > **Modifiable Parameters** tab, click **Modify Current Value**.
...
1. Log in to the [TencentDB for Redis console](https://console.cloud.tencent.com/redis), click an instance ID/name in the instance list, and enter the instance management page.
2. View the parameter modification history on the **Parameter Configuration** > **Modification Log** tab.
...
<td>Redis v2.8, v4.0, and v5.0</td>
<tr>
...
<li>volatile-lru: evict keys with an expire set by trying to remove the less recently used (LRU) keys first.
...
<td>Redis v2.8, v4.0, and v5.0</td></tr>
<tr>
