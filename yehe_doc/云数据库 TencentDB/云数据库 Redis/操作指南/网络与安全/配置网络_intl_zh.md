...
>
1. 在  [Redis 控制台](https://console.cloud.tencent.com/redis) 的实例列表，单击实例名，进入实例详情页。
...
3. 在弹出的对话框中，配置新网络信息，单击【确认】即可更换网络。
  - 新IP地址：可选择自动分配或指定地址。
