...
2. <span id="step02">在安全组规则页面，选择【入站规则】>【添加规则】。</span>
3. 在弹出的对话框中，设置规则。
...
<table>
 ...
 - 协议端口：填写协议类型和端口范围，云数据库 Redis 的端口可在 [实例详情页](https://console.cloud.tencent.com/redis) 查看，默认为6379。您也可以引用 [参数模板](https://intl.cloud.tencent.com/document/product/215/31867) 中的协议端口或协议端口组。
