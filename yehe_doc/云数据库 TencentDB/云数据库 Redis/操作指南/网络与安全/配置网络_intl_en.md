...
>
1. In the instance list in the [TencentDB for Redis Console](https://console.cloud.tencent.com/redis), click an instance name to enter the instance details page.
...
3. In the pop-up dialog box, configure new network information and click **OK** to change the network.
