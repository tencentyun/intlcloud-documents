...
```
3. 配置 [云服务器安全组](https://intl.cloud.tencent.com/document/product/213/12452)，放开云服务器外网端口的访问权限，安全组规则建议仅放开需要访问的源地址。
4. 在访问端通过外网地址26.xx.xx.2:10001即可连接内网 Redis 实例，连接命令请参见 [连接实例](https://intl.cloud.tencent.com/document/product/239/9897#.E8.BF.9E.E6.8E.A5.E5.AE.9E.E4.BE.8B)。
