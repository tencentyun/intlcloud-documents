...
参考 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)，将预设策略 QcloudTcaplusDBFullAccess 授权给用户。
...
参考 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)，将预设策略 TcaplusDB 授权给用户。
    ...
    "statement": [
        {
            "action": "tcaplusdb:*",
            "resource": [
						"qcs::tcaplusdb::uin/164256472:table/tcaplus-c8d1caa4",
						"qcs::tcaplusdb::uin/164256472:table/tcaplus-d8d1cbb4",
						],
            "effect": "deny"
        }
    ]
...
更多 TcaplusDB 相关的策略语法请参考 [授权策略语法](https://intl.cloud.tencent.com/document/product/1016/35751)。
