...
更多关于实例规格，请参见  [TDSQL MySQL版 实例及分片配置](https://intl.cloud.tencent.com/document/product/1042/33354)。

### TDSQL MySQL版 语法和 MySQL 的兼容和限制有哪些?
...
TDSQL MySQL版 目前只支持单个分表键下的 JOIN 和 TRANSACTION，以及跨节点的 TRANSACTION，跨节点的 JOIN 暂不支持。
