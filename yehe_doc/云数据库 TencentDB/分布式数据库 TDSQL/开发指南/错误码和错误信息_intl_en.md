...
```
	    ...
	    ER_PROXY_ERROR_SHARDKEY,       /*Incorrect primary and secondary shardkeys were selected; for example, they should be different and should be certain columns in the table*/
      ...
      ER_PROXY_SQL_RETRY,
      ER_PROXY_CONN_BROKEN_ERROR,    /*The connection between the gateway and the backend database is broken*/
```
