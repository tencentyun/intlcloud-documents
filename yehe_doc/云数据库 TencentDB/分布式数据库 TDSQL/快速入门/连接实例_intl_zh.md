...
## 准备工作
### 创建帐号
1. 登录 [TDSQL 控制台](https://console.cloud.tencent.com/dcdb)，选择所需实例，单击实例名或“操作”列的【管理】，进入实例管理页面。
2. 选择【帐号管理】页，单击【创建帐号】。
...
### 获取外网地址
1. 登录 [TDSQL 控制台](https://console.cloud.tencent.com/dcdb)，单击实例名，进入实例详情页，在基本信息的“外网地址”处，单击【开启】。
