TencentDB for MariaDB supports full backup and incremental backup, and backups are compressed with LZ4. For more information on how to use LZ4, please see [Decompressing Backup and Log Files](https://cloud.tencent.com/document/product/237/2088).
