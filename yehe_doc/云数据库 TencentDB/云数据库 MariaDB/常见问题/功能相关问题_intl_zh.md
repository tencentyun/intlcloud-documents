...
云数据库 [控制台](https://console.cloud.tencent.com/tdsql) 支持大多数常见数据库参数，并对其设置了安全阈值，如果您需要修改的参数不存在，或无法修改为指定值，请 [提交工单](https://console.cloud.tencent.com/workorder/category)，我们会尽快为您处理。
