...
## 操作步骤
1. 进入 MariaDB 购买页，根据需求指定数据库实例信息，单击【立即购买】。
 - 计费模式：按量计费。
 ...
 - 实例版本：详见 [实例版本](https://intl.cloud.tencent.com/document/product/237/6918?from_cn_redirect=1)，备机越多，可用性越高。
