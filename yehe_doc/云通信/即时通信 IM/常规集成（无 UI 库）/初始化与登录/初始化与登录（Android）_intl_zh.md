...
## 初始化
类 [V2TIMManager](http://doc.qcloudtrtc.com/im/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html) 是 IM SDK 主核心类，负责 IM SDK 的初始化、登录、消息收发，建群退群等功能，是 IM SDK 的入口类。调用 [initSDK](http://doc.qcloudtrtc.com/im/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#ac905c315726b517ba62421471bbecf56) 接口即可完成初始化：
...
### SDKConfig
参数 `V2TIMSDKConfig` 用于对 SDK 进行初始化配置，常用于设置日志级别，即 [setLogLevel](http://doc.qcloudtrtc.com/im/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMSDKConfig.html#a033c4e90397236427f3dd65038df8033) 接口，日志级别如下表所示：
...
- IM SDK 的日志默认存储于 `/sdcard/tencenet/imsdklogs/应用包名` 目录下。
...
### 事件监听器
[V2TIMSDKListener](http://doc.qcloudtrtc.com/im/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMSDKListener.html) 提供了网络状态以及用户信息变更的监听：
...
### 登出
登出操作相对简单，使用 [logout](http://doc.qcloudtrtc.com/im/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMManager.html#a0398924fa1b62a8f5cc9b51673273b48) 函数即可。
