...
| roomID   | 直播间群聊房间 ID，此 ID 为即时通信IM所创建的直播群（AVChatRoom）群组 ID，该房间无加入人数限制可通过 [即时通信 IM 控制台](https://console.cloud.tencent.com/im-detail/qun-manage) 创建，或通过 [REST API](https://intl.cloud.tencent.com/document/product/1047/34620) 创建。 |
