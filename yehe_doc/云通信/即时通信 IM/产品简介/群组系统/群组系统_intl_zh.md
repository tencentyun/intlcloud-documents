...
- 可拓展的群成员人数上限：
  - 非直播群成员人数上限最高支持付费拓展到6000人，详情请参阅 [价格说明](https://intl.cloud.tencent.com/document/product/1047/34350)。
...
- [自定义群组类型](https://intl.cloud.tencent.com/document/product/1047/33529)
...
|解散群|只有 App 管理员可以解散群|群主和 App 管理员可以解散群|群主和 App 管理员可以解散群|只有群主和 App 管理员可以解散群|
...
>- 好友工作群（Work）、陌生人社交群（Public）和临时会议群（Meeting）具备历史消息存储能力，默认免费存储7天（旗舰版默认30天），如需保存更长时间，您可以在 [控制台](https://console.cloud.tencent.com/im) 修改消息存储时长。延长历史消息存储时长是付费增值服务，详情请参见 [价格说明](https://intl.cloud.tencent.com/document/product/1047/34350)。
