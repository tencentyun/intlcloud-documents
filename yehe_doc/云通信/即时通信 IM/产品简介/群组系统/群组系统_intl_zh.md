...
>
>- 音视频聊天室（AVChatRoom）和在线成员广播大群（BChatRoom）不设成员人数上限，但如果预期群成员会出现短时间内激增的场景（例如举行大型在线活动，单群成员人数达到5万或以上等情况），请提前联系商务工作人员，提供 SDKAppID 和活动预期发生时间进行服务资源报备。
...
在实际使用中，如果 IM 提供的 [五种群组形态](https://intl.cloud.tencent.com/document/product/1047/33529) 无法满足您的需求，您可以[提交工单](https://console.cloud.tencent.com/workorder/category) 申请修改现有群组形态或新增自定义群组形态。
