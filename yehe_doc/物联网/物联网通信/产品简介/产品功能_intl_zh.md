## 设备接入
### SDK 接入
物联网通信 IoT Hub 当前支持 Linux、Android 等平台的 SDK。物联网通信 SDK 下载地址请参见 [SDK 下载](https://intl.cloud.tencent.com/document/product/1105/41840) 文档。
...
支持创建网关类型产品与子设备类型产品，您可以绑定网关设备与对应的子设备，即可通过网关设备基于 MQTT 协议代理子设备上下线及收发消息。
