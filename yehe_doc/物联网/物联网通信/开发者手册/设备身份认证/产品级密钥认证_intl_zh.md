...
4. 设备固件烧录，具体步骤如下：
 ...
 2. 实现 SDK 中关于产品、设备信息读写的 HAL 层函数，包括 ProductID、ProductSecret 和 Devicename 等，并 SDK 中的开启动态注册功能，具体可参见 [设备接入](https://intl.cloud.tencent.com/document/product/1105/41842)。
