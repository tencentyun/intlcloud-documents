### 1. SDK
详情请参见 [ SDK 文档](https://intl.cloud.tencent.com/document/product/1105/41840)。目前支持 Linux、Android 平台的设备 SDK、并支持移植到不同的硬件平台 。
...
详情请参见 [设备影子详情](https://intl.cloud.tencent.com/document/product/1105/41834)。
...
详情请参见 [规则引擎详情](https://intl.cloud.tencent.com/document/product/1105/41484)。
...
物联网通信平台支持通过 [CAM](https://intl.cloud.tencent.com/product/cam) 安全地访问、使用和管理云账号的资源。通过对子账号与协作者的身份管理和策略管理，来实现物联网通信资源的隔离与协作。
