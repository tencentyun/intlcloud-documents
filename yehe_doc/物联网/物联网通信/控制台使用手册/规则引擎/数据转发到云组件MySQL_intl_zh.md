...
配置分为如下几个步骤：
 ...
 3. 输入实例的登录密码。
 4. 选择需要写入的数据库名。如果创建的 MySQL 实例下还没有建立数据库，请前往 MySQL 控制台创建一个新的数据库。具体操作请参见 [建立数据库和表](https://intl.cloud.tencent.com/document/product/236/39221)。
...
更多详情请参见 [建立数据库和表](https://intl.cloud.tencent.com/document/product/236/39221)。
