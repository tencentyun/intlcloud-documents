...
## 前提条件
新建资源栈前，您需要首先在平台设置中设置 [TIC 授权](https://intl.cloud.tencent.com/document/product/1043/36010#tic-.E6.8E.88.E6.9D.83)。
...
3. 指定新建资源栈的方式：
 ...
 - **公共模版**：选择私有模版，了解更多模版详情，请参见 [模版管理](https://intl.cloud.tencent.com/document/product/1043/37185)。
 - **输入模版内容**：编辑模式，直接编辑基础架构代码，支持多文件编写，支持常用快捷键操作（例如 Ctrl+s，Ctrl+z，Ctrl+x等）。
