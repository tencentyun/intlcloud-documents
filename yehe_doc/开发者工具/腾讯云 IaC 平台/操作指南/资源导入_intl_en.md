...
You can use the resource import feature of Tencent Infrastructure as Code (TIC) to import Tencent Cloud resources created using the console or Cloud APIs into a TIC stack for unified orchestration, with no need to delete or re-create Tencent Cloud resources.

>?You can only import existing Tencent Cloud resources into a new stack, not an existing stack.
...
3. In the **Select Mode** step, select a region, specify a template for importing resources, and select resources to import.
![image-20200710154557033](https://main.qcloudimg.com/raw/ec82cc68cfb8f353d36a29f1c7e1bc9f.png)
4. Click **Import** to import the selected resources.
5. The more resources you select to import, the longer the time required to import them. After the resources are imported, click **Import Completed** to go to the **Configure Stack** step.
![](https://main.qcloudimg.com/raw/89cf5c05edef27aaeb93ba42ed4968e5.png)

### Configuring the stack

1. After the resources are imported, stack configurations are generated automatically.
	 ![](https://main.qcloudimg.com/raw/dba3ee9b9394fdd3e6196b0eda65b996.png)
2. After you confirm the stack configurations, click **Next** to go to the **Plan** step.
...
1. Go to the [**Stacks**](https://console.cloud.tencent.com/tic/stacks) page, and click the name of the created stack to go to the stack details page.
2. Click the **Event** tab and view the stack status. **APPLY_IN_PROGRESS** indicates that resource information is being synchronized.
![image-20200710155056811](https://main.qcloudimg.com/raw/7676c44b8f3055e3ec59773adc313ff7.png)
3. Wait 10 seconds or more for the resource information synchronization to complete. Then, the stack status changes to **APPLY_COMPLETED**.
![image-20200710155906888](https://main.qcloudimg.com/raw/49a7e5b553f49ed0d7c0d40c69c0739a.png)
4. Verify that the resources have been imported into the created stack. On the **Resource** tab of the **Stacks** page, you can view the imported Tencent Cloud resources. To manage these resources, you only need to modify the configurations of the stack.
