...
* This version currently supports various [Tencent Cloud services](https://cloud.tencent.com/document/sdk/Description) such as CVM, VPC, and CBS and will support more services in the future.
...
* Get the calling address (endpoint), which is generally in the format of `*.tencentcloudapi.com` and varies by service. For example, the endpoint of CVM is `cvm.tencentcloudapi.com`. For specific endpoints, please see the [API documentation](https://cloud.tencent.com/document/api) of the corresponding service.
