...
public class Application {
    ...
    public static void Main(string[] args)
    {
        ...
        double RequestTimestamp = 1551113065;  // Timestamp: 2019-02-26 00:44:25. This parameter is used as an example and subject to the actual value
...
>! 1. The parameters are sorted only by name but not by value. <br>2. The parameters are sorted based on ASCII code but not in an alphabetical order or by value. For example, `InstanceIds.2` should be arranged behind `InstanceIds.12`. You can complete sorting by using a sorting function in a programming language, such as the `ksort` function in PHP.
>
...
public class Application {
    ...
    public static void Main(string[] args)
    {
        ...
        string action = "DescribeInstances";
        string version = "2017-03-12";
        double RequestTimestamp = 1465185768;  // Timestamp: 2019-02-26 00:44:25. This parameter is used as an example and subject to the actual value
        // long timestamp = ToTimestamp() / 1000;
        // string requestTimestamp = timestamp.ToString();
