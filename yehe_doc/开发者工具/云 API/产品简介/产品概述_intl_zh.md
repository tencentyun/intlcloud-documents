...
您可通过以下资源快速查询及使用云 API：
 -  **[API 中心](https://intl.cloud.tencent.com/document/api)**：可通过 API 中心快速了解腾讯云各产品 API 信息并使用云 API。
 -  **[API Explorer 工具](https://console.cloud.tencent.com/api/explorer)**：可使用 API Explorer 工具快速便捷完成 API 调用。
 -  **[SDK 中心](https://intl.cloud.tencent.com/document/494)**：可通过 SDK 中心使用对应的资源。
