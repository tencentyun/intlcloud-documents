...
- The default recipients of balance alerts are the account creator, global resource collaborators, and the finance administrator.
- The default method to receive alerts is via SMS.
- To modify the recipients and alert receiving methods, go to [Message Subscription](https://console.cloud.tencent.com/messageCenter/messageConfig).
...
- We will send you only one alert daily (00:00-24:00) and will stop after the first five days.
