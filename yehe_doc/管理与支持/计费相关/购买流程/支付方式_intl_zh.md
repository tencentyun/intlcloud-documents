...
## 付款方式页面
在[付款方式页面](https://console.cloud.tencent.com/accountv1/paymentmethods)中，用户可以查询其现有的付款方式，包括付款类型，帐户ID，收款人姓名，状态和操作。
...
•	用户可以单击“Add Payment Method”按钮跳转到添加付款方式页面。用户可以添加信用卡作为他们的付款方式。
