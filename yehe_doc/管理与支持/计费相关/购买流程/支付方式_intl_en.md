...
Go to [Payment Methods](https://console.cloud.tencent.com/accountv1/paymentmethods) to add a credit card.

2. How can I bind a credit card if I have already bound a PayPal account？
Go to [Payment Methods](https://console.cloud.tencent.com/accountv1/paymentmethods) to add a credit card and click **Make Default**. Then click **Delete** to delete the PayPal account.
