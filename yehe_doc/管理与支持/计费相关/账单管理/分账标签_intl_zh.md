...
已登录 [标签控制台](https://intl.cloud.tencent.com/login)。
...
1. 前往 [费用中心](https://console.intl.cloud.tencent.com/expense)，在左侧导航栏中，选择**费用账单** > **分账标签**。
...
1. 前往 [账单概览](https://console.intl.cloud.tencent.com/expense/bill/overview) 页面。
