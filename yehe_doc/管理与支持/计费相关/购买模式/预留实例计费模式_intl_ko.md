...
-   현재 클라우드 API를 통해 예약 인스턴스를 구매할 수 있으며, 클라우드 API를 사용하는 예약 인스턴스의 구매 방법과 구체적인 작업 순서는 CVM 제품 설명을 참조 바랍니다.
...
예시: 유효기간이 1년인 예약 인스턴스(CVM RI)를 2019-05-25 11:15:24 에 구매했다면 해당 예약 인스턴스의 유효기간은 2019-05-25 12:00:00 \~ 2020-05-24 12:00:00입니다. 유효기간이 3년인 예약 인스턴스(CVM RI)를 2019-05-25 11:15:24에 구매했다면 해당 예약 인스턴스의 유효기간은 2019-05-25 12:00:00~2022-05-24 12:00:00입니다.
...
-   구매에 성공하면 예약 인스턴스의 유효기간을 시간당으로 계산합니다. 종량제 인스턴스와의 매ㅋ칭 여부와 관계없이 유효기간 동안에는 예약 인스턴스 비용을 지불해야 하므로 예산, 리소스 현황에 맞게 결제 유형 및 유효기간을 선택하시기 바랍니다. 적용 시간은  시간당 기준으로 하며, 적용 해제 또한 만료일 매시 정각에 진행됩니다. 예시, 2019-05-25 11:15:24에 구매한 유효기간이 1년인 예약 인스턴스(CVM RI)의 적용 시간 및 과금 시작 시간은 2019-05-25 12:00:00이며, 적용 해제 시간은 2020-05-24 12:00:00입니다. 예약 인스턴스를 구매할 때 매칭 가능한 CVM 리소스가 있는 경우에는 2019-05-25 11:00:00-11:59:59부터 과금을 시작하며 시간당 요금율에 따라 결산 및 차감합니다.
