...
"**Pengontrol**" mengacu pada seseorang yang baik sendiri atau bersama-sama dengan satu atau lebih orang lain mengontrol pengumpulan, penyimpanan, pemrosesan atau penggunaan Data Pribadi;
...
"**Undang-Undang Perlindungan Data**" mengacu pada undang-undang perlindungan data yang berlaku sehubungan dengan pengumpulan, penyimpanan, pemrosesan, transfer, pengungkapan, dan penggunaan Data Pribadi apa pun yang berlaku dari waktu ke waktu kepada orang atau aktivitas dalam keadaan yang bersangkutan, termasuk California Civil Code bagian 1798.100 – 1798.199 (2020), California Consumer Privacy Act ("CCPA"), Arahan, Arahan e-Privasi, dan GDPR;
...
"**Data Pribadi**" mengacu pada informasi apa pun yang berkaitan dengan orang alami yang diidentifikasi atau dapat diidentifikasi, termasuk 'data pribadi' dan 'informasi pribadi' sebagaimana istilah-istilah tersebut didefinisikan dalam Undang-Undang Perlindungan Data;
...
"**Pemroses**" mengacu pada seseorang yang Memproses Data Pribadi atas nama satu atau lebih Pengontrol;
...
<li>setiap pengungkapan yang tidak sah dari, atau akses ke, Data Pribadi atau kerugian, kerusakan, atau penghancuran Data Pribadi; dan</li>
<li>setiap keluhan, komunikasi, atau permintaan material yang berkaitan dengan kewajiban Tencent berdasarkan Undang-Undang Perlindungan Data;</li>
...
1. Selain kewajiban Tencent lainnya sebagaimana ditetapkan di tempat lain dalam Perjanjian ini, jika berlaku untuk tujuan CCPA, Tencent akan bertindak sebagai "penyedia layanan" untuk Organisasi, yang sesuai dengan mana para pihak setuju bahwa semua Informasi Pribadi tersebut diungkapkan kepada Tencent untuk satu atau lebih tujuan bisnis dan penggunaannya atau berbagi oleh Organisasi dengan Tencent diperlukan untuk melakukan tujuan bisnis tersebut.
2. Tencent setuju bahwa mereka: (a) dilarang menyimpan, menggunakan, atau mengungkapkan Informasi Pribadi untuk tujuan apa pun selain untuk tujuan khusus melakukan layanan yang ditentukan dalam Ketentuan Layanan untuk Organisasi, termasuk, tanpa batasan, untuk menyimpan, menggunakan, atau mengungkapkan Informasi Pribadi tersebut untuk tujuan komersial selain menyediakan layanan yang ditentukan dalam Ketentuan Layanan.
3. Tencent tidak akan mengumpulkan, menjual, atau menggunakan Informasi Pribadi lebih lanjut kecuali jika diperlukan untuk melakukan tujuan bisnis.

Untuk tujuan Bagian ini [ ], "informasi pribadi," "penyedia layanan," "tujuan bisnis," "tujuan komersial," "mengumpulkan," dan "menjual" harus memiliki arti yang diberikan kepada mereka di CCPA.
