...
1）系统默认将经销商UIN的每日账单、月账单发送到COS桶。另外，腾讯云商务每月确认账单后，会手工触发将客户账号的合并账单存入经销商COS桶。

2）存储桶同时支持存入子账号的账单。勾选子账号UIN，可将子账号的账单存入父账号COS桶。
...
​      1）合作伙伴自用日账单：Day+2后，新增的bill_details会存储到COS存储bucket中。比如4月6日，将会有增加一个4月1日到~4月4日的汇总账单；4月8日，将会增加一个4月1日~4月6日的汇总账单。
