...
(1) The system sends the daily and monthly bills of your UINs to the COS bucket by default. In addition, after confirming the bills every month, the Tencent Cloud sales team will manually trigger the storage of the consolidated bills of customer accounts in your COS bucket.

(2) Bills of sub-accounts can also be stored in the bucket. If you select a sub-account UIN, you can store the bills of the sub-account in your COS bucket.
