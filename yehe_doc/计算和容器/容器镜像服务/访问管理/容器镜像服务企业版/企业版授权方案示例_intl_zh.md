...
>! 如您在容器镜像服务控制台中使用部分功能时需要外部权限，例如私有网络、云审计、云标签等，请参见 [支持 CAM 的产品](https://intl.cloud.tencent.com/document/product/598/10588) 中对应产品的「访问管理指南」文档。
...
若需要自定义编辑策略 JSON，请参见 [企业版接入 CAM 的 API 列表](https://intl.cloud.tencent.com/document/product/1051/39860) 以及 [策略语法](https://intl.cloud.tencent.com/document/product/598/33415)。
