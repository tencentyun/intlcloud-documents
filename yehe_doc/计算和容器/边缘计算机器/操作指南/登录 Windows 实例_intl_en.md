...
2. In the **Run** window, enter **mstsc** and press **Enter** to open the Remote Desktop Connection window as shown below:
...
4. Enter the instance's admin account/password in the **Windows Security** pop-up window as shown below:
