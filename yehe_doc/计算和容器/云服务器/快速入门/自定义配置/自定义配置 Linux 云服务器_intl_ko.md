...
신규 사용자의 Tencent Cloud 공식 사이트 [가입](https://intl.cloud.tencent.com/register) 관련 자세한 내용은 [Signing Up](https://intl.cloud.tencent.com/document/product/378/17985)을 참고하십시오.
...
<tr><td>이미지</td><td>필수</td><td>Tencent Cloud는 공용 이미지, 사용자 정의 이미지, 공유 이미지를 제공합니다. <a href="https://intl.cloud.tencent.com/document/product/213/4941">이미지 유형</a> 개요를 참고하십시오.</br>Tencent Cloud를 처음 사용하는 경우, 공용 이미지 선택을 권장합니다.</td></tr>
...
<table>
  ...
  <tr>
	<td>태그</td>
	<td>옵션</td>
	<td>클라우드 리소스의 분류, 검색 및 취합을 위해 필요에 따라 인스턴스에 태그를 추가할 수 있습니다. 태그에 대한 자세한 내용은 <a href="https://intl.cloud.tencent.com/document/product/651/13334">Tag</a>를 참고하십시오.</td>
  </tr>
  <tr>
	<td>인스턴스 이름</td>
	<td>옵션</td>
  ...
  <tr>
	...
	<td>인스턴스 폐기 방지</td>
	<td>옵션</td>
	<td>기본적으로 비활성화되어 있습니다. 필요에 따라 활성화할 수 있습니다. 활성화 하면 콘솔이나 API를 통해 인스턴스를 폐기할 수 없습니다. 자세한 내용은 <a href="https://intl.cloud.tencent.com/document/product/213/47383">인스턴스 폐기 방지 활성화</a>를 참고하십시오.</td>
     <li>
  ...
  <tr>
	...
	<ul>
	  ...
	  운영 체제는 Shell 형식을 지원하며 최대 16KB의 원시 데이터를 지원합니다. 자세한 내용은 <a href="https://intl.cloud.tencent.com/document/product/213/17525">사용자 설정 데이터</a>를 참고하십시오.
	  <br />
...
- [Linux 인스턴스에 로그인](https://intl.cloud.tencent.com/document/product/213/5436)
