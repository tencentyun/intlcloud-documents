...
<table>
<tr><th style="width: 20%">Category</th><th style="width: 12%">Required/Optional</th><th>Configuration Description</th></tr>
<tr><td>Security Group</td><td>Required</td><td>Used to configure the network access policies for one or more CVM instances.</br><b>Make sure that login port 3389 is open.</b>For more information, see <a href="https://intl.cloud.tencent.com/document/product/213/12452">Security Groups</a>.</td></tr>
...
<tr><td>Instance Name</td><td>Optional</td><td>The name of the CVM instance to be created.</br>It is user-defined. We recommend “CVM-01”.</td></tr>
<tr><td>Login Method</td><td>Required</td><td>Configure the method to log in to the CVM instance as needed.<ul><li><b>Custom Password</b>: Customize the password for logging in to the instance.</li><li><b>Random Password</b>: An automatically generated password will be sent through the <a href="https://console.cloud.tencent.com/message">Message Center</a>.</li></ul></td></tr>
<tr><td>Instance Termination Protection</td><td>Optional</td><td>It is disabled by default. You can enable it as needed. Then, you cannot terminate an instance in the console or via the API. For more information, see <a href="https://intl.cloud.tencent.com/document/product/213/47383">Enabling Instance Termination Protection.</a></td></tr>
...
5. Click **Buy Now** or **Activate** and complete the payment. You can then check your CVM instances in the [CVM console](https://console.cloud.tencent.com/cvm).
...
- [Log in to a Windows instance by using the standard method (recommended)](https://intl.cloud.tencent.com/document/product/213/41018)
- [Log in to a Windows instance by using the RDP file](https://intl.cloud.tencent.com/document/product/213/5435)
- [Log in to a Windows instance by using Remote Desktop](https://intl.cloud.tencent.com/document/product/213/32498)

## Formatting and Partitioning Data Disk
