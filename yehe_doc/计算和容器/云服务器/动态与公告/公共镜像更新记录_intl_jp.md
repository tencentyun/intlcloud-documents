>!
>- イメージの更新時間は地域によって異なる場合があります。このドキュメントに記載されているイメージの更新時間は、すべての地域のイメージの更新時間です。
> -Tencent Cloudが提供するパブリックイメージのメンテナンスサイクルは、公式に発表されたメンテナンスサイクルと同様です。公式メンテナンス時間の情報については、[付録：公式メンテナンス時間](#OfficialMaintenanceTime)をご参照ください。
>

## TencentOS Server
<table>
  <tr>
	<th style="width: 14%;">イメージバージョン</th>
	<th style="width: 44%;">イメージ情報</th>
	<th style="width: 14%;">更新時間</th>
	<th style="width: 28%;">更新内容</th>
  </tr>
  <tr>
	<td>TencentOS Server 3.1</td>
	<td>イメージID：<a href="https://console.cloud.tencent.com/cvm/image/detail?rid=16&id=img-eb30mz89">img-eb30mz89</a>
	<br />現在のカーネルバージョン：5.4.119-19.0006.tl3.x86_64</td>
	<td>2021-07-13</td>
	<td>新しいイメージがリリースされました。</td>
  </tr>
  <tr>
	<td>TencentOS Server 2.4</td>
	<td>イメージID：<a href="https://console.cloud.tencent.com/cvm/image/detail?rid=16&id=img-hdt9xxkt">img-hdt9xxkt</a>
	<br />現在のカーネルバージョン：4.14.105-19.0020.1.tl2.x86_64</td>
	<td>2021-05-31</td>
	<td>
	  <ul class="params">
		<li>カーネルバージョンを更新します。</li>
		<li>セキュリティパッチを更新します。</li>
	  </ul>
	</td>
  </tr>
</table>
...
<table>
	...
	<tr>
		...
		<td>
			<ul class="params">
				<li>新しいイメージがリリースされました。</li>
				<li>Cloud Physical Machine2.0をサポートします。</li>
				<li>IPv6をサポートします。</li>
			</ul>
		</td>
	</tr>
...
<table>
  <tr>
	<th style="width: 16%;">イメージバージョン</th>
	<th style="width: 38%;">イメージ情報</th>
	<th style="width: 14%;">更新時間</th>
  ...
  <tr>
	...
	<br />現在のカーネルバージョン：5.4.0-72-generic</td>
  </tr>
  <tr>
	<td>2021-04-03</td>
	<td>
  ...
  <tr>
	...
	<br />現在のカーネルバージョン：4.15.0-118-generic</td>
  </tr>
  <tr>
	<td>2021-06-30</td>
	<td>
  ...
  <tr>
	...
	<td>
	  <ul class="params">
		<li>システムパッチを更新します。</li>
		<li>CVE-2019-11477の脆弱性を修正します。</li>
	  </ul>
	</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<br />現在のカーネルバージョン：4.15.0-88-generic</td>
	<td>2021-04-23</td>
	<td>
	  <ul class="params">
		<li>カーネルバージョンを更新します。</li>
...
## [付録：公式メンテナンス時間](id:OfficialMaintenanceTime)


### CentOS
CentOSは、サポート終了（EOL）の日付情報を次のように正式に発表しました。詳細については、 [CentOS 製品仕様](https://wiki.centos.org/zh/About/Product#fnref-f049f6268e56bd37228bb469075b54ae8645fa40)をご覧ください。
<table>
  <tr>
	<th>システムバージョン</th>
	<th>完全な更新</th>
...
### Ubuntu
次の表に、Ubuntu長期サポート（LTS）リリースを示します。詳細については、 [Long term support and interim releases](https://ubuntu.com/about/release-cycle)をご参照ください。
<table>
  <tbody>
	<tr>
	  <th style="width: 23%;">システムバージョン</th>
	  <th>ハードウェアのメンテナンス・更新</th>
	  <th>メンテナンス更新</th>
	  <th>標準サポートを一時的にリリース</th>
	  <th>拡張セキュリティメンテナンス</th>
	</tr>
	<tr>
	  <td>Ubuntu 14.04 LTS</td>
	  <td>2014年初頭 - 2016年半ば</td>
	  <td>2016年半ば - 2018年半ば</td>
	  <td>-</td>
	  <td>2018年半ば-2022年初頭</td>
	</tr>
	<tr>
	  <td>Ubuntu 16.04 LTS</td>
	  <td>2016年初頭 - 2018年半ば</td>
	  <td>2018年半ば - 2021年初頭</td>
	  <td>-</td>
	  <td>2021年初頭 - 2024年初頭</td>
	</tr>
	<tr>
	  <td>Ubuntu 18.04 LTS</td>
	  <td>2018年初頭 - 2021年半ば</td>
	  <td>2018年初頭 - 2023年末</td>
	  <td>-</td>
	  <td>2023年後半 - 2028年初頭</td>
	</tr>
	<tr>
	  <td>Ubuntu 20.04 LTS (v5.4)</td>
	  <td>2020年初頭 - 2022年半ば</td>
	  <td>2022年半ば - 2024年末</td>
	  <td>-</td>
	  <td>2024年末～2030年初頭</td>
	</tr>
	<tr>
	  <td>Ubuntu 20.10
	  <br />(v5.8)</td>
	...
	<tr>
	  ...
	  <td>-</td>
	  <td>-</td>
	  <td>2021年末 - 2022年初頭</td>
	  <td>-</td>
	</tr>
	<tr>
	  <td>Ubuntu 22.04 LTS</td>
	  <td>2022年初頭 - 2024年末</td>
	  <td>2024年末 - 2026年末</td>
	  <td>-</td>
	  <td>2026年末 - 2032年初頭</td>
	</tr>
  </tbody>
</table>
...
### Debian
次の表は、Debian長期サポート（LTS）のリリースの日付を示しています。詳細については、 [Debian Long Term Support](https://wiki.debian.org/LTS)をご参照ください。
