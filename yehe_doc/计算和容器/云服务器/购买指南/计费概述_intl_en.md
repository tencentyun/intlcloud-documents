You can use the [CVM Price Calculator](https://intl.cloud.tencent.com/pricing/cvm/calculator) to check out the combined price of all the products you need. Also, you can add products to the shopping list to purchase all items together.
