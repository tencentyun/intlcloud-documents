...
>?본문은 일반 BGP IP의 공용 네트워크 비용을 소개합니다. 프리미엄 BGP IP, 가속 IP 및 정적 단일 회선 IP는 현재 BWP 과금만 지원합니다. [BWP](#bwp)를 참고하시기 바랍니다.
>
...
<th colspan="2" style="text-align:center;">가격(단위: CNY/GB)</th>
</tr>
</thead>
<tbody><tr>
<td>중국대륙(홍콩, 마카오 및 대만 제외), 싱가포르, 자카르타, 서울, 도쿄, 프랑크푸르트, 모스크바</td>
<td>0.12</td>
</tr>
<tr>
<td>중국홍콩, 상파울루</td>
