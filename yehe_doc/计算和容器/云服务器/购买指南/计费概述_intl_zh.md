...
根据底层硬件的不同，腾讯云目前提供了丰富的机型规格，具体详情可参考 [实例规格](https://intl.cloud.tencent.com/document/product/213/11518)。

关于不同实例类型价格，可参考 [实例计费模式](https://intl.cloud.tencent.com/document/product/213/2180)。
