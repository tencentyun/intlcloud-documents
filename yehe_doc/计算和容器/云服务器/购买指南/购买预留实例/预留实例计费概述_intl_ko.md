...
>? 
> - 예약 인스턴스는 현재 베타 테스트 중으로, 필요한 경우 [베타 테스트 사용 자격 신청](https://intl.cloud.tencent.com/apply/p/bvrqmrrp5ns) 페이지에서 신청하십시오. 신청 통과 후 Tencent Cloud에 로그인한 뒤 [가격 센터](https://intl.cloud.tencent.com/pricing/cvm)에서 가격을 확인할 수 있습니다.
