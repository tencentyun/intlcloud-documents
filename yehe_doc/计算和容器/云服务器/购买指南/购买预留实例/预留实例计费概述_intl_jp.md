...
>?
>- リザーブドインスタンスは内部テスト中です。必要な場合は[内部テスト使用資格申請](https://intl.cloud.tencent.com/apply/p/bvrqmrrp5ns)を申請してください。申請の許可後、Tencent Cloudにログインし[料金センター](https://intl.cloud.tencent.com/pricing/cvm)にアクセスして料金を確認できます。
