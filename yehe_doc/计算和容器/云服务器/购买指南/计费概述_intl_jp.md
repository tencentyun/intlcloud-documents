...
課金システムは次の２つを含みます：
<ul style="margin:0px">
<li>カスタムイメージの課金は、次の2種類の料金で構成されます：スナップショット料金：イメージはCloud Block Storage (CBS)のスナップショットサービスを使用しているため、カスタムイメージを保持すると、スナップショット料金が発生します。詳細については、<a href="https://intl.cloud.tencent.com/document/product/362/32415">課金概要</a>をご参照ください。</li>
