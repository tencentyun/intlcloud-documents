...
1. After shutting down, the instance's CPU and memory **will not be retained**. Therefore, the instance **might fail** when restarted. If so, try restarting once more or wait awhile before retrying.
