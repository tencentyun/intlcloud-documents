...
![关机](https://qcloudimg.tencent-cloud.cn/raw/4bb78140aacb12c7600ef6f7846d4d31.png)
...
:::
::: 使用\sAPI\s创建
您可以使用 CreateImage 接口创建自定义镜像。具体内容可以参考 [创建镜像 API](https://intl.cloud.tencent.com/zh/document/product/213/33276)。
:::
</dx-tabs>
