...
2. Na barra lateral esquerda, clique em **Images (Imagens)** e selecione a guia **Custom Image (Imagem personalizada)** para entrar na página de gerenciamento de imagens personalizadas.
