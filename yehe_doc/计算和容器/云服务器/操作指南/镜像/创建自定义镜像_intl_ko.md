...
2. 인스턴스의 관리 페이지에서 사용된 실제 뷰 모드에 따라 작동합니다.
  - **목록 뷰**: 인스턴스가 위치한 행의 오른쪽에서 **더보기** > **인스턴스 상태** > **종료**를 선택합니다. 아래 이미지와 같습니다.
...
![종료](https://qcloudimg.tencent-cloud.cn/raw/4bb78140aacb12c7600ef6f7846d4d31.png)


#### 사용자 정의 이미지 생성[](id:createOS)
1. 인스턴스의 관리 페이지에서 사용된 실제 뷰 모드에 따라 작동합니다.
   - **목록 뷰**: **더보기** > **이미지 생성**을 선택합니다. 아래 이미지와 같습니다.
