...
## 导入步骤
 ...
 3. 选择**自定义镜像**，单击**导入镜像**。
 4. 根据操作界面要求，先 [开通 COS](https://console.cloud.tencent.com/cos4/index)，再 [创建 bucket 存储桶](https://intl.cloud.tencent.com/document/product/436/13309) ，上传镜像文件到 bucket 并 [获取镜像文件 URL](https://intl.cloud.tencent.com/document/product/436/13322)。
 5. 单击**下一步**。
