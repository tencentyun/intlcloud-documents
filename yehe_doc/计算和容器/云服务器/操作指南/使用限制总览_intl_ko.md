...
<table>
	...
	<tr><td>CBS 연체 회수</td><td>정액 과금제의 엘라스틱 CBS는 기간 만료 후 7일 내에 연장하지 않으면 휴지통으로 회수됩니다. 휴지통으로 이동하면 해당 CBS와 CVM 마운트 관계는 자체적으로 해제되지 않습니다. 회수 메커니즘에 대한 자세한 내용은 <a href="https://intl.cloud.tencent.com/document/product/362/31625">연체 안내</a>를 참고하십시오. </td></tr>
</table>
