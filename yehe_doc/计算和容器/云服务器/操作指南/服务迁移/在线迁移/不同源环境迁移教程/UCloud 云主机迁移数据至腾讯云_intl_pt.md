...
## 3. Backup de dados
- Servidor de origem: é possível usar a funcionalidade de snapshot da UCloud ou outros métodos para fazer o backup dos dados.
...
1. Estabeleça uma conexão de rede privada entre o servidor de origem e o CVM de destino.
