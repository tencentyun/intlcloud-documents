...
## 3. Backup de dados
- Servidor de origem: é possível usar a funcionalidade de snapshot da VMWare ou outros métodos para fazer o backup dos dados.
