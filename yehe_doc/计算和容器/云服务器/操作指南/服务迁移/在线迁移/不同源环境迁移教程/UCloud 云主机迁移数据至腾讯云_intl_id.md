...
## 3. Mencadangkan Data
- Server sumber: Anda dapat menggunakan fitur snapshot UCloud atau metode lain untuk mencadangkan data.
...
1. Buat koneksi jaringan pribadi antara server sumber dan CVM tujuan.
