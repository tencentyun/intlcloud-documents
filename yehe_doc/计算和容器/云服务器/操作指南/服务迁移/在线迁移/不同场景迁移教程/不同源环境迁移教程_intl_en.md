...
You can click <b>Start/Retry</b> on the right of the task to start it, click **OK** in the pop-up window, and the task status will become **Migrating** as shown below:
