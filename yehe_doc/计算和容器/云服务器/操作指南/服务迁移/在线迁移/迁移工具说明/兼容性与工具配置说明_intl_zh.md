...
<table>
	...
	<tr><td>CentOS 5/6/7/8</td><td rowspan=7>Windows Server 2008 R2 及以上版本</td></tr>
...
您可参考 <a href="https://intl.cloud.tencent.com/document/product/213/35640">修改配置文件</a> 中的示例，结合实际业务场景修改配置文件。
