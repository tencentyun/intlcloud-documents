...
## Metadata 说明
实例元数据即表示实例的相关数据，可以用来配置或管理正在运行的实例。您可以通过实例内部访问和获取实例元数据，详情请参见 [查看实例元数据](http://intl.cloud.tencent.com/document/product/213/4934)。
...
更多操作详情请参见 [查看实例元数据](http://intl.cloud.tencent.com/document/product/213/4934)。
