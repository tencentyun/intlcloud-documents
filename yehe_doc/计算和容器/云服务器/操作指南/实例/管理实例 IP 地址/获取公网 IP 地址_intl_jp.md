...
2. インスタンスの管理画面で、実際に使用されているビューモードに従って操作します。
  - **リストビュー**：下図のように、マウスをメインIPアドレス列に移動し、<img src="https://main.qcloudimg.com/raw/6603ab4f907562addb1c01596c6296cd.png" style="margin: 0;"/>をクリックすれば、このIPアドレスをコピーできます。
...
:::
::: \sAPI\sを利用した取得
[インスタンスリストの確認](https://intl.cloud.tencent.com/document/product/213/33258) の関連インターフェースをご参照ください。
:::
::: インスタンスメタデータを利用した取得[](id:jump)
1. CVMのインスタンスにログインする。
具体的なログイン方法については、[Linuxインスタンスにログイン](https://intl.cloud.tencent.com/zh/document/product/213/5436) および [Windowsインスタンスにログイン](https://intl.cloud.tencent.com/document/product/213/41018)をご参照ください。
