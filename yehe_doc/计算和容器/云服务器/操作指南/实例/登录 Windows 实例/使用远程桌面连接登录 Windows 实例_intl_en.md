...
- You must already have the admin account/password for logging into Windows instance remotely.
 ...
 If you forgot the password, then [reset instance password](https://intl.cloud.tencent.com/document/product/213/16566).
...
For more information about how to obtain the public IP, see [Getting Public IP Addresses](https://intl.cloud.tencent.com/document/product/213/17940).
