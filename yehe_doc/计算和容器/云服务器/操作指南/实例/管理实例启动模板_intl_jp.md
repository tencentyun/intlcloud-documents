...
4. 「設定情報の確認」手順において、「『Tencent Cloudサービス契約』と『返金ルール』に同意する」を読んでチェックを入れ、**今すぐ作成**をクリックすれば完了です。
作成が成功すると、コンソールでインスタンスの起動テンプレートを確認できるようになります。
...
3. 「設定情報の確認」手順において、「『Tencent Cloudサービス契約』と『返金ルール』に同意する」を読んでチェックを入れます。
