## 작업 시나리오
클라우드 모니터링이 지원되는 CVM 리소스에 성능 소모 지표 임계값 알람을 설정하고 CVM 인스턴스 또는 플랫폼 인프라 서비스 상태에도 이벤트 알람을 설정하여, 이상 발생 즉시 WeChat, 이메일, SMS, 전화 등으로 조치를 취하도록 할 수 있습니다. 적절한 알람 생성은 응용 프로그램의 건전성과 신뢰성을 높일 수 있습니다. 본문에서는 알람 생성 방법을 소개합니다. 알람 관련 자세한 정보는 [알람 정책 생성](https://intl.cloud.tencent.com/document/product/248/38916)을 참고하십시오.
