...
- The public gateway CVM is available only in Linux operating system.
...
<table>
	...
	<tr><td>Cloud disks attached to a CVM</td><td>The CVM and cloud disks must be in the same availability zone.</td></tr>
	...
	<tr><td>Repossession of cloud disks due to overdue payment</td><td>For specific repossession mechanism, please see <a href="https://intl.cloud.tencent.com/document/product/362/31625">Overdue Policy</a>.</td></tr>
</table>
...
- Security groups associated with CVMs on the **classic network** **cannot filter packets** from or to TencentDB (MySQL, MariaDB, SQL Server, or PostgreSQL) and NoSQL (Redis or Memcached) databases. Instead, you can use iptables or purchase CFW to filter traffic for such instances.
