...
### 服务器高负载
**故障现象**：通过云监控，显示服务器 CPU 负载过高导致系统无法进行远程连接或者访问非常卡。
...
如果您需要自定义设置安全组规则，请参考 [添加安全组规则](https://intl.cloud.tencent.com/document/product/213/34272) 重新配置安全组规则。
