...
Windows Server 2012 R2, Windows Server 2016, and Windows Server 2019 Tencent Cloud CVMs use Virtio ENI drivers to optimize the network performance of virtualization hardware. Tencent Cloud will continue to improve ENIs for a better performance and easy troubleshooting. This document describes how to update the Virtio ENI driver and check the driver version.

## Prerequisites

You have logged in to the Windows CVM.
...
This document uses Windows Server 2016 Datacenter Edition 64-bit as an example. The obtained information is as shown below:
...
1. Download the Virtio ENI driver installation file for the operating system version through the browser in the CVM. 
