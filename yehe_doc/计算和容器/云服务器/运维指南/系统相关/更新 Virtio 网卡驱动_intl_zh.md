...
5. 在弹出的安全提示中，勾选“始终信任来自 “Tencent Technology（Shenzhen）Company Limited” 的软件”，单击**安装**。
...
2. 在打开的“运行”窗口中，输入 **ncpa.cpl**，并按 **Enter**。
2. 在打开的“网络连接”窗口中，右键单击“以太网”图标，选择**属性**。
4. 在弹出的“以太网 属性”窗口中，单击**配置**。
5. 在 “Tencent VirtIO Ethernet Adapter 属性”窗口中，选择**驱动程序**页签，即可查看当前驱动程序版本。
