...
이미지를 COS에 업로드하는 데 걸리는 시간은 이미지 파일 크기 및 대역폭과 관련이 있습니다. 압축 이미지 형식(qcow2 또는 vhd)을 사용하여 전송 및 마이그레이션 시간을 단축하는 것이 좋습니다.
...
### 마이그레이션 작업에 실패한 이유가 무엇인가요?
 ...
 - 대상 CVM 또는 클라우드 디스크가 만료되지 않았는지 확인하십시오.
...
### 온라인 마이그레이션 툴은 어디에서 다운로드할 수 있습니까?
