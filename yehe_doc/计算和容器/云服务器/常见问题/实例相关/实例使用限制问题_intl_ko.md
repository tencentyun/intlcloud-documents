...
### CVM 인스턴스 로그인 후 중국 외 웹 사이트에 액세스할 수 없는 이유는 무엇인가요?
중국 외 웹 사이트 액세스 시 인스턴스가 위치한 국가 혹은 지역의 정책 규정에 부합해야 합니다. 귀하의 CVM 인스턴스가 외부 네트워크를 정상으로 액세스할 수 있어야 하고, 액세스하려는 중국 외 웹사이트의 규정 준수를 보장해야 합니다.
