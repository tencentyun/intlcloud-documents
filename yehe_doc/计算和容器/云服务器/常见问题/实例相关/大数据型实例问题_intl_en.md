...
### What is Big Data  instance?

Big Data  instance is designed specifically for Hadoop distributed computing, massive log processing, distributed file system, large data warehouse, and other business scenarios. This CVM instance type is mainly used to solve the cloud computing and storage problems of massive business data.

### Which industry customers and business scenarios are Big Data D1 instances applicable to?

Big Data  instance is applicable to customers in the Internet, game, finance and other industries that require big data computing and storage analysis, as well as business scenarios that require massive data storage and offline computing. It can meet the storage, capacity and private network bandwidth requirements of distributed computing businesses represented by Hadoop.
...
* Local storage has a unit price as low as S2 1/10. Big Data D1 instance features massive storage capacity and high performance, while ensuring optimal cost-efficiency for big data scenarios. It has a total cost close to that of the self-built Hadoop cluster on an offline IDC.
...
### Big Data  instance specifications

Big Data instance specifications see [Big Data Instance Family](https://intl.cloud.tencent.com/document/product/213/11518#D)

### Notes on local data storage for Big Data  instance
...
### How can I purchase Big Data local disk?
...
### Does the local storage of Big Data instance support snapshot?
No.

### Does Big Data instance support configuration adjustment and failover?
...
### What is the difference between Big Data instance and High IO I2 instance?
