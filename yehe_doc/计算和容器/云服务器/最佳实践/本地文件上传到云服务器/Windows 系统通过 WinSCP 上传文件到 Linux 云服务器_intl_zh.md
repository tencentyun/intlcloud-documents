...
2. 在 “WinSCP” 文件传输界面的左侧窗格中，选择本地计算机文件的存放目录，如“F:\SSL证书\Nginx”，选中待传输的文件。
3. 在 “WinSCP” 文件传输界面的菜单栏中，单击【上传】。
4. 在弹出的“上传”对话框中，确认需要上传的文件及远程目录，单击【确定】，即可从本地计算机将文件上传到云服务器中。

### 下载文件
1. 在 “WinSCP” 文件传输界面的左侧窗格中，选择文件在服务器中待存放的目录，如“F:\SSL证书\Nginx”。
2. 在 “WinSCP” 文件传输界面是右侧窗格中，选择本地计算机文件的存放目录，如“/user”，选中待传输的文件。
3. 在 “WinSCP” 文件传输界面的菜单栏中，单击【下载】。
