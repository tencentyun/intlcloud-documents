...
本文使用了以下配置的云服务器实例，获取的相关信息请以实际情况为准：
 - **实例规格**：内存型 M6p 实例 M6p.LARGE16（4核16GB）。其他规格配置请参见 [内存型 M6p](https://intl.cloud.tencent.com/document/product/213/11518)。
...
## 前提条件
已创建并登录 [M6p 实例](https://intl.cloud.tencent.com/document/product/213/11518)。
