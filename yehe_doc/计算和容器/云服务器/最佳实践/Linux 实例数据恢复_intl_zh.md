...
腾讯云提供了 [创建快照](https://intl.cloud.tencent.com/document/product/362/5755)、[创建自定义镜像](https://intl.cloud.tencent.com/document/product/213/4942) 及 [对象存储](https://intl.cloud.tencent.com/document/product/436/6222) 等存储数据的方式，建议您定期进行数据备份，以提高数据安全性。
</dx-alert>
...
- 参考 [创建快照](https://intl.cloud.tencent.com/document/product/362/5755) 及 [创建自定义镜像](https://intl.cloud.tencent.com/document/product/213/4942) 进行数据备份，以确保出现问题时可恢复至初始状态。
