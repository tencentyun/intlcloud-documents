...
### 部署 AD 域控制器[](id:Step1)
1. 登录作为 DC 的实例，详情参见 [使用标准方式登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/41018)。
...
### 将客户端加入 AD 域
1. 登录作为客户端的实例，详情参见 [使用标准方式登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/41018)。
2. 修改 DNS 服务器地址。
