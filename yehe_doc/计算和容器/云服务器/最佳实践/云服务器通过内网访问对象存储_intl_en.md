...
1. Obtain and record the bucket access domain as instructed in [Bucket Overview](https://intl.cloud.tencent.com/document/product/436/38493).
...
## Test Connectivity
See the “Testing connectivity” section in [Request Creation Overview](https://intl.cloud.tencent.com/document/product/436/30613) for the COS access samples through a public network, access through Tencent Cloud CVMs (classic network) within the same region and access through Tencent Cloud CVMs (VPC) within the same region.


## Relevant Operations
- [Mounting COS to Windows Server as Local Drive](https://intl.cloud.tencent.com/document/product/436/40490)
- [Storing Remote WordPress Attachments to COS](https://intl.cloud.tencent.com/document/product/436/34082)
