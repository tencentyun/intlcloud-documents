...
클라우드 리소스에 대한 경보 규칙을 설정하는 것도 비즈니스 운영에 필수적입니다. 클라우드 모니터(CM)에서 텐센트 클라우드 서비스의 리소스 활용도, 애플리케이션 성능, 운영 현황 등 종합적인 정보를 볼 수 있다. 이 플랫폼은 또한 다중 메트릭 모니터링, 사용자 지정 경보, 교차 지역 및 교차 프로젝트 인스턴스 그룹화, 시각적 모니터링을 위한 Dashboard, Prometheus 호스팅과 같은 기능을 제공합니다. CM은 Tencent Cloud 서비스의 긴급 상황 감지 및 처리를 도와 시스템 안정성을 향상하고 OPS 효율성을 개선하며 OPS 비용을 절감할 수 있습니다.
