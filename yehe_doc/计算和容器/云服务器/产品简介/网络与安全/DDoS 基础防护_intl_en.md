...
Tencent Cloud CVM can enable Anti-DDoS Basic for free by default when creating an instance. On the CVM purchase page, select **Enable for free** for **Security Reinforcement** to enable Anti-DDoS Basic.
After Anti-DDoS Basic enabled, you can view the protection configuration of CVM on the [Overview Page](https://console.cloud.tencent.com/cvm/overview) in the CVM console, or the [Anti-DDoS Basic](https://console.cloud.tencent.com/ddos/ddos-basic) console.
