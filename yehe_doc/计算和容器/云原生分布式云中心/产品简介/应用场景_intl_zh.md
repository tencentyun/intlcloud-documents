...
支持通过 [第三方节点管理](https://intl.cloud.tencent.com/zh/document/product/457/45354)，[IDC 集群弹性扩容 EKS](https://intl.cloud.tencent.com/document/product/457/42975)，[边缘集群服务](https://intl.cloud.tencent.com/document/product/457/35390)等多种方式管理云上云下的资源。
...
![](https://qcloudimg.tencent-cloud.cn/raw/84bb78608586c50e46080f3af0441dff.png)

## 自动发布

现有各种类型的 DevOps 系统，可通过对接分布式云中心的 Hub Cluster 集群，以最小成本实现多云多集群的应用发布管理，灰度管理和应用的生命周期管理。免除了分别为开发、测试和生产环境集群进行的繁琐的配置和初始化工作，将应用发布逻辑与底层集群松耦合关联，灵活方便地扩展和管理业务发布，加速产品迭代和业务扩展。
