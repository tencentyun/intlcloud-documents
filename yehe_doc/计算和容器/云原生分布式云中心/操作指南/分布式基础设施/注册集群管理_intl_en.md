...
You can **register a cluster** to manage all types of distributed infrastructures in a unified way in TDCC, including clusters on Tencent Cloud, clusters of third-party vendors, clusters in external data center, edge clusters and others.
