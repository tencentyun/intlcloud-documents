...
支持。可登录 [云服务器控制台](https://console.cloud.tencent.com/cvm)，实例列表页找到对应的实例，单击操作栏【更多】>【资源调整】>【调整配置】进行调整。详细说明请参考 [调整实例配置](https://intl.cloud.tencent.com/document/product/416/19733)。
