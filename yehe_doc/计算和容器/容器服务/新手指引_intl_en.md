...
TKE enables you to manipulate clusters and services through the [TKE console](https://console.cloud.tencent.com/tke2/overview), [Kubectl](https://intl.cloud.tencent.com/document/product/457/30639) or [TencentCloud API](https://intl.cloud.tencent.com/document/product/1080/38759).




## 2. TKE Billing
The TKE service itself is currently free of charge, but you will be charged for cloud resources you actually use. For more information on the resource fees incurred by related products during the use of TKE, see [Billing Description](https://intl.cloud.tencent.com/document/product/457/6770).
...
Before using TKE, you need to sign up for a [Tencent Cloud account](https://intl.cloud.tencent.com/register) and complete the [identity verification](https://intl.cloud.tencent.com/document/product/378/3629).
...
If the host where the container resides has a public IP address and public network bandwidth, the container can access the public network directly. Otherwise, an NAT gateway is required for accessing the public network.
...
- If you have any questions about TKE, please [submit a ticket](https://console.cloud.tencent.com/workorder/category).
