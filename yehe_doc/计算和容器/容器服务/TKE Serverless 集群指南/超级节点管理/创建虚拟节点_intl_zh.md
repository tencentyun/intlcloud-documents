...
超级节点本身不收取费用，实际会根据工作负载申请的 CPU、GPU、内存数值以及工作负载的运行时间来核算费用，计费详情请参见 [弹性容器计费概述 ](https://intl.cloud.tencent.com/document/product/457/34054)、[弹性容器产品定价](https://intl.cloud.tencent.com/document/product/457/34055)、[弹性容器购买限制](https://intl.cloud.tencent.com/document/product/457/34056)。
...
4. 单击**新建节点**，在“新建超级节点”弹窗中，参考以下提示进行设置。
