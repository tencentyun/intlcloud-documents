...
<tr>
<th>Bugfix</th>
<td>Fixed the issue where an empty topic ID caused the logconfig to be deleted and recreated during topic replacement, and kept the topic name unchanged before and after the replacement.</td>
</tr>
</tbody></table>
