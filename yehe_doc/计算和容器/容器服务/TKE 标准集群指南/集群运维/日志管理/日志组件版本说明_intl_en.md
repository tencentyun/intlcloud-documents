...
|---------|---------|---------|
| tke-log-agent  | DeamonSet | Each log-agent Pod contains a controller container and a LogListener sidecar container, which are responsible for collecting logs generated by all the containers on the node. |
...
<tbody><tr>
<th>Feature</th>
<td>Added São Paulo and Intelligent Automobile Cloud Zone in Shanghai that can be shipped to by CLS.</td>
</tr>
<tr>
<th>Bugfix</th>
<td>-</td>
