...
- [策略管理](https://intl.cloud.tencent.com/document/product/598/10600)
...
如果您不了解如何为协作者关联预设策略，请参考 CAM 文档：[策略](https://intl.cloud.tencent.com/document/product/598/10600)、[授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。
...
#### 步骤1：创建自定义 [策略](https://intl.cloud.tencent.com/document/product/598/10600)。
...
#### 步骤2：关联自定义策略。
步骤1中的策略（ccr-policy-demo）创建完成以后，您可以将其关联到任意协作者，详见 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。策略关联完成后协作者即拥有**在任意命名空间下创建镜像仓库权限**。
