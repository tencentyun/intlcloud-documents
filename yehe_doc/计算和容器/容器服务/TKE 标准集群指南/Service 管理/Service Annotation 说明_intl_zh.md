...
**使用示例：**
使用方式详情见 [Service 使用已有 CLB](https://intl.cloud.tencent.com/document/product/457/36835)。
...
**使用示例：**
使用方式详情见 [Service Local 模式](https://intl.cloud.tencent.com/document/product/457/36836)。
...
**使用示例：**
使用方式详情见 [指定接入层后端](https://intl.cloud.tencent.com/document/product/457/36836)。
...
**使用示例：**
使用方式详情见 [Service 负载均衡配置](https://intl.cloud.tencent.com/document/product/457/36834)。
...
**使用示例：**
使用方式详情见 [Service 与 TkeServiceConfig 关联行为](https://intl.cloud.tencent.com/document/product/457/36834#service-.E4.B8.8E-tkeserviceconfig-.E5.85.B3.E8.81.94.E8.A1.8C.E4.B8.BA)。
...
**使用示例：**
使用方式详情见 [Service 扩展协议](https://intl.cloud.tencent.com/document/product/457/39141)。
...
**使用示例：**
仅在直连模式下支持，需要配合使用 `service.cloud.tencent.com/direct-access`，使用方式详情见 [Service 优雅停机](https://intl.cloud.tencent.com/document/product/457/42070)。
...
**使用示例：**
仅在直连模式下支持，需要配合使用 `service.cloud.tencent.com/direct-access`，使用方式详情见 [Service 优雅停机](https://intl.cloud.tencent.com/document/product/457/42070)中的相关能力。
