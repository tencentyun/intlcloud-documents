...
>- 容器服务控制台不支持云硬盘扩容，可前往 [云硬盘控制台](https://console.cloud.tencent.com/cvm/cbs/index) 进行扩容操作。详情请参见 [扩容云硬盘](https://intl.cloud.tencent.com/document/product/362/5747)。
>
...
由于静态创建云硬盘类型的 PV 时，需要绑定同类型可用 StorageClass，请参考 [创建 StorageClass](https://intl.cloud.tencent.com/document/product/457/36158) 完成创建。
...
```
- 云硬盘大小必须为10的倍数。
- 高性能云硬盘最小为10GB，SSD 和增强型 SSD 云硬盘最小为20GB，详情见 [创建云硬盘](https://intl.cloud.tencent.com/document/product/362/5744)。
