...
- CLB를 사용하여 CVM 인스턴스에서 클라이언트의 요청 트래픽을 자동으로 할당한 다음 CVM 인스턴스에서 실행되는 컨테이너로 전달할 수 있습니다. 자세한 내용은 [Cloud Load Balancer 문서](https://intl.cloud.tencent.com/zh/document/product/214)를 참고하십시오.
