...
### Enabling Network Policy add-on in TKE
For detailed directions, see [Network Policy](https://intl.cloud.tencent.com/document/product/457/39120).
...
### Feature testing of network policy add-on
...
| NetworkPolicy Feature| Supported or not |
|---------|---------|
...
### Feature testing of network policy add-on (legacy)
