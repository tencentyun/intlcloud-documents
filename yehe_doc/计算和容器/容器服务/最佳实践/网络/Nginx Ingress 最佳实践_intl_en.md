...
2. When creating a Nginx Ingress instance, you can check **Select CLB-to-Pod direct access mode** to enable traffic to bypass the NodePort and reach the Pod directly to improve performance, as shown in the figure below:
