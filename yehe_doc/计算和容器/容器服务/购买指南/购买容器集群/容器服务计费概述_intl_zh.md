...
- 如果您已经有存量的 TKE 集群，可以按需选择如下迁移方式：
	...
	- 通过迁移工具将 TKE 集群完整迁移至 EKS 集群，详情见 [TKE 托管集群迁移至 EKS 集群操作指南](https://intl.cloud.tencent.com/document/product/457/47002)。如遇到困难，可 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 联系我们。
