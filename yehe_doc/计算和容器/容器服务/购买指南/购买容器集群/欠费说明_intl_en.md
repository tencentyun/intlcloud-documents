...
<table>
	...
	<tr><td><b>＞ 15 days</b></td><td>If overdue payment of your account persists, the clusters will be deleted and cannot be recovered. All nodes in the clusters will be removed, but will not be released. We will notify the creator and all collaborators of the Tencent Cloud account through email and SMS when the clusters under the account are deleted.</td></tr>
</table>
