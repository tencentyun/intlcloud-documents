...
#### 클러스터 관리 요금
>! Tencent Cloud는 2022년 3월 21일 10:00(베이징 시간)부터 관리형 클러스터에 대한 요금을 부과합니다. [관리형 클러스터에 대한 과금 시작 관련 공지](https://intl.cloud.tencent.com/document/product/457/45156)를 참고하십시오.
>
...
TKE 사용 중에 생성된 기타 Tencent Cloud 서비스 리소스(CVM, CBS, CLB 등)는 각 리소스의 청구 모드에 따라 요금이 부과됩니다. 자세한 내용은 [Tencent Cloud Services 리소스 요금](#cloudproducts)을 참고하십시오.
...
| --------- | -------- | ------------------------------------------------------------ | -------- |
| 클러스터 수(개) | 사용량 과금 | 구매 시 [요금 동결](https://intl.cloud.tencent.com/document/product/555/12039)하고, 서비스는 시간 단위로 청구 | USD/시간  |
...
## Tencent 클라우드 서비스 리소스 요금[](id:cloudproducts)
...
| CBS | [CBS 과금 개요](https://intl.cloud.tencent.com/document/product/213/2255)| 
| CLB | [CLB 과금 안내](https://intl.cloud.tencent.com/document/product/214/36999)| 
