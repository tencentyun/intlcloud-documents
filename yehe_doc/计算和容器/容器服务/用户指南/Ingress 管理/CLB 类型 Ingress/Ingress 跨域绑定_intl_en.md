...
4. Click **Create** and configure the availability zone rules in the **Create Ingress** page. The configuration rules are as follows:
...
For the detailed Ingress annotations, please see [Ingress Annotation](https://intl.cloud.tencent.com/document/product/457/40675).
:::
</dx-tabs>
