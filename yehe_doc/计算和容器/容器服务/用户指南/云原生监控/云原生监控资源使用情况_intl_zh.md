...
该资源按实际指标存储量和存储时间（由用户在创建实例时定义）计费，计费详情请参见对象存储 [按量计费（后付费）](https://intl.cloud.tencent.com/document/product/436/32534) 文档。
...
该资源按实际使用量计费，计费详情请参见云硬盘 [价格总览](https://intl.cloud.tencent.com/document/product/362/2413) 文档。
