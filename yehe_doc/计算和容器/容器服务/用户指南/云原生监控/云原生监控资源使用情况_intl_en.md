...
The COS will be enabled in your account for persistent storage of metrics when a PROM instance is created. You can view the resource information in the [COS console](https://console.cloud.tencent.com/cos5) as shown in the figure below.
...
Five Premium Cloud Storage will be purchased in your account for temporary storage of metrics when a PROM instance is created. You can view the information about CBS resource and specification in the [CBS console](https://console.cloud.tencent.com/cvm/cbs/index?rid=1) as shown in the figure below.
![](https://qcloudimg.tencent-cloud.cn/raw/6137e43b4ed152234a41bfdaca6c0df3.png)

Where:
- Specification of the CBS used for Grafana is 10G.
- Specification of the CBS used for Thanos Rule component is 50G.
- Specification of the CBS used for Thanos Store component is 200G.
- Specification of the CBS used for AlertManager is 10G.
- Specification of the CBS used for Prometheus is varied depending on the actual metrics. 10G is used for about 30w series (about 30 nodes).
...
You cannot delete these resources in the corresponding consoles for now. You need to terminate the PROM instance in the [TPS console](https://console.cloud.tencent.com/tke2/prometheus/list?rid=1) to terminate all these resources. Tencent Cloud does not repossess PROM instances proactively. If you will not use Tencent Prometheus Service, you need to delete the PROM instances immediately to avoid additional charges.
