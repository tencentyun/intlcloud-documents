...
>!
> - CPU Request는 스케쥴링의 기초로 사용됩니다. 컨테이너가 생성되면 ‘할당된 CPU’ 리소스라고 하는 노드에서 CPU 리소스가 컨테이너에 할당됩니다.
...
>!
> - 메모리 Request는 스케쥴링의 기초로 사용됩니다. 컨테이너가 생성되면 ‘할당된 메모리’ 리소스라고 하는 노드에서 메모리 리소스가 컨테이너에 할당됩니다.
