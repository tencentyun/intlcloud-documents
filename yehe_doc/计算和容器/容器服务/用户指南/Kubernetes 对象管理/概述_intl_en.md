...
The Kubernetes objects are persistent entities in clusters and are used to host services running within the clusters. Different Kubernetes objects can represent different entities:
...
- Storage
    ...
    + StorageClass: used to describe the type of storage. When a PVC is created, storage of the specified type, namely storage template, is created by using StorageClass.
...
- Services
    + [Service Management](https://intl.cloud.tencent.com/document/product/457/36832)
...
- Storage
    + [Storage Management](https://intl.cloud.tencent.com/document/product/457/37769)
