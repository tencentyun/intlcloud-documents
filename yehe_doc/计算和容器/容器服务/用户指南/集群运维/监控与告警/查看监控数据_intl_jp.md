...
## 前提条件
コンソールにログインし、【[クラスター](https://console.cloud.tencent.com/tke2/cluster?rid=1)】の管理ページへ進んでいます。
...
2. **ノード管理**を展開して、ノードとMaster&Etcdノードの監視情報を確認できます。
 - **ノード**>**監視**を選択して、**ノード監視**ページへ進んで監視情報を確認できます。下図の通りです：
![](https://main.qcloudimg.com/raw/c1c1fca1e108f8479b50a895c2d2d0b5.png)
 - **Master&Etcd**>**監視**を選択して、**Master&Etcd監視**ページへ進んで監視情報を確認できます。下図の通りです：
...
1. 確認を必要とするクラスターID/名称を選択して、クラスターの管理ページへ進みます。
2. **ノード管理**>**ノード**を選択して、ノードリストページへ進みます。
3. 実際のニーズに応じて、ノード内のPod指標の確認方法を選択します。
 - ノードリストからPod指標を確認します。
    1. **監視**をクリックして、**ノード監視**ページへ進みます。
    2. **Pod**をクリックして、確認したいノードとして**所属ノード**を選択すると、ノード内のPodの監視指標比較チャートを確認できます。下図の通りです：
![](https://main.qcloudimg.com/raw/e58301ce2675d2de018a867c31fcfb69.png)
 - ノードの詳細ページでPod指標を確認します。
    ...
    2. **Pod管理**タブを選択し、**監視**をクリックして、ノード内のPodの監視指標比較チャートを確認できます。下図の通りです：
![](https://main.qcloudimg.com/raw/269631374cbe8ff955de4d691c53772c.png)

<span id="check4"></span>
### ワークロード指標の確認
1. 確認を必要とするクラスターID/名称を選択して、クラスターの管理ページへ進みます。
2. **ワークロード**>**任意のタイプのワークロード**を選択します。例えば、**Deployment**を選択して、Deployment管理ページへ進みます。
3. **監視**をクリックして、ワークロードの監視情報を確認できます。下図の通りです：
...
4. **Pod管理**タブを選択し、**監視**をクリックして、ワークロード内のすべてのPodの監視指標比較チャートを確認できます。下図の通りです：
![](https://main.qcloudimg.com/raw/bda91f0b0fb55cf87cf7258cc471ae1f.png)

<span id="check6"></span>
### Pod内のContainer指標の確認
1. [ワークロード内のPod指標の確認](#target)の[手順1](#first)-[手順3](#third)を参照して、ワークロードの詳細ページへ進みます。
2. **Pod管理**タブを選択し、**監視**をクリックして、**Pod監視**ページへ進みます。
3. **Container**をクリックして、確認したいPodとして**所属Pod**を選択すると、Pod内のContainerの監視指標比較チャートを確認できます。下図の通りです：
