...
>! 目前该功能正处于内测阶段，您可通过 [提交工单](https://console.intl.cloud.tencent.com/workorder) 开通使用。
...
- 节点上运行的独立网卡方案的 Pod 数量限制受到机型可绑定弹性网卡数量的影响。其最大数量为最大可绑定弹性网卡数量 - 1，详见 [VPC-CNI 模式 Pod 数量限制](https://intl.cloud.tencent.com/document/product/457/43559)。
