...
>! 
> - 本文档以已创建集群并已添加节点为例。关于如何创建集群，您可以参考 [创建集群](https://intl.cloud.tencent.com/document/product/457/40029) 进行创建。
...
3. [](id:step3)单击需要配置 SPD 策略的本端 VPN 通道的 ID/名称。
...
2. [](id:addCIDRStep2)找到 [设置同地域集群间互通](https://intl.cloud.tencent.com/document/product/457/44483) 或者 [设置跨地域集群间互通](https://intl.cloud.tencent.com/document/product/457/44483) 时配置的路由表，单击该路由表的 ID/名称，进入路由表的详情页面。
3. 单击**+新增路由策略**，追加容器网段。
