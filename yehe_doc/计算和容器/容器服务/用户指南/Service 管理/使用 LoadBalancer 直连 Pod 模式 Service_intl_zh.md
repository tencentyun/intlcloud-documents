...
- 默认 CLB 的后端数量限制是200个，如果您绑定的工作负载的副本数超过200时，可通过 [提交工单](https://console.intl.cloud.tencent.com/workorder) 提升负载均衡 CLB 的配额。
...
- 直连 Globalrouter 模式下的 Pod 为内测功能，您可通过以下两种方式进行使用：
 ...
 - **您可通过 [提交工单](https://console.intl.cloud.tencent.com/workorder) 进行申请。**此方式缺少云联网的 IP 校验功能，不推荐使用。
