...
**使用示例：**
使用方式详情见 [Service 扩展协议](https://intl.cloud.tencent.com/zh/document/product/457/39141)。
:::
...
支持 CLB 直连模式的优雅停机。
**使用示例：**
仅在直连模式下支持，需要配合使用 `service.cloud.tencent.com/direct-access`，使用方式详情见 [Service 优雅停机](https://intl.cloud.tencent.com/zh/document/product/457/42070)。
:::
