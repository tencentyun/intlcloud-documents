...
![](https://main.qcloudimg.com/raw/24a166447e301672141a4f2257d7a206.png)
 ...
 - **Login method**: Three login methods are available.
  ...
  - **Security services**: Free DDoS, Web Application Firewall (WAF) and Cloud Workload Protection (CWP) are activated by default. For more information, see [Cloud Workload Protection](https://intl.cloud.tencent.com/products/cwp).
