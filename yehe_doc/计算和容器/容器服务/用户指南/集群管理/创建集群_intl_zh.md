...
- **计费模式**：提供**按量计费**一种计费模式。详情请参见 [计费模式](https://intl.cloud.tencent.com/document/product/213/2180)。
...
- **Worker 配置**：当**节点来源**选择**新增节点**、**集群类型**选择**托管集群**时，该模块下所有设置项为默认项，您可根据实际需求进行更改。
   ...
   - **机型**：选择大于 CPU 4核的机型，具体选择方案请参看 [实例规格](https://intl.cloud.tencent.com/document/product/213/11518) 和 [快速入门 Linux 云服务器](https://intl.cloud.tencent.com/document/product/213/10517)。
...
![](https://main.qcloudimg.com/raw/24a166447e301672141a4f2257d7a206.png)
 ...
 - **登录方式**：提供三种登录方式：
    ...
    - **设置密码**：请根据提示设置对应密码。
  - **安全加固**：默认免费开通 DDoS 防护、WAF 和云镜主机防护，详情请参见[ T-Sec 主机安全官网页](https://intl.cloud.tencent.com/products/cwp)。
  - **云监控**：默认免费开通云产品监控、分析和实施告警，安装组件获取主机监控指标，详情请参见 [云监控 CM 官网主页](https://intl.cloud.tencent.com/products/cm)。
