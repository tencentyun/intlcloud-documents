...
<td> Service 使用已有 <a href="https://intl.cloud.tencent.com/document/product/214/524" target="_blank">负载均衡CLB</a> 创建，value 填写希望使用的 CLB 实例 ID。</td>
...
此外，弹性集群也支持和 TKE 普通集群一致的扩展协议，详情可参见 [Service 扩展协议](https://intl.cloud.tencent.com/document/product/457/39141)。
