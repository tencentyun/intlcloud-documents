...
From now to December 31, 2021, audit log and event data generated by EKS is **free of charge**. Select **Auto-create Logset** or select **Auto-create Log Topic** in an existing logset. For more information, see [Free Tier](https://intl.cloud.tencent.com/document/product/614/37889).
</dx-alert>
