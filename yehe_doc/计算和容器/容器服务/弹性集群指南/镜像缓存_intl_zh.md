...
4. 单击**创建**。创建完成后可在镜像缓存的列表，单击事件名称查看创建进程。
...
若需要在虚拟节点中使用镜像缓存，可通过指定 Pod 的 Annotation 来使用镜像缓存，具体可参考 EKS [Annotation 说明](https://intl.cloud.tencent.com/document/product/457/36162)。
