...
- [用户管理](https://intl.cloud.tencent.com/document/product/598/10599)
- [策略管理](https://intl.cloud.tencent.com/document/product/598/10601)
- [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)
...
该预设策略配置了容器镜像服务所有权限，如果协作者关联该预设策略后，将与管理者拥有相同的镜像仓库权限。详情请查看 [权限列表](https://intl.cloud.tencent.com/document/product/457/37499)。
...
如果您不了解如何为协作者关联预设策略，请参考 CAM 文档：[策略](https://intl.cloud.tencent.com/document/product/598/10601)、[授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。
...
当您分配权限时，请考虑这些要素：
- **资源(resource)**：该权限策略关联哪些镜像仓库，例如所有镜像仓库描述为 `qcs::ccr:::repo/*`，详见 [CAM 资源描述方式](https://intl.cloud.tencent.com/document/product/598/10606)。
...
1. 创建自定义 [策略](https://intl.cloud.tencent.com/document/product/598/10601)。
  1. 使用开发商账号登录腾讯云-控制台。
  2. 进入 [CAM 自定义策略管理页面](https://console.cloud.tencent.com/cam/policy/custom)，单击**新建自定义策略**，打开“选择创建策略方式”对话框。如下图所示：
![选择创建策略方式](https://qcloudimg.tencent-cloud.cn/raw/a8d3d5f685c6064b57461b1e9ece4ad0.png)
 3. 选择**按策略语法创建** > **空白模板**。
![选择模板](https://qcloudimg.tencent-cloud.cn/raw/2ac6c17390f5f9302693327465a77be4.png)
 4. 单击**下一步**，进入“编辑策略” 页面。
...
2. 关联自定义策略。步骤1中的策略（ccr-policy-demo）创建完成以后，您可以将其关联到任意协作者，详见 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。策略关联完成后协作者即拥有**在任意命名空间下创建镜像仓库权限**。
\_resource `qcs::ccr:::repo/*` 格式说明：
 - `qcs::ccr:::` 为固定格式，表示开发商的腾讯云容器镜像仓库服务。
 - `repo` 为固定前缀，代表资源类型，这里是镜像仓库。
 - 斜杠(`/`)后面的 `*` 表示匹配所有镜像仓库。

关于 resource 更详细的描述，请参考 [CAM 资源描述方式](https://intl.cloud.tencent.com/document/product/598/10606)。
...
![新建或删除镜像仓库命名空间权限](https://qcloudimg.tencent-cloud.cn/raw/385be310dee81a4d2e727130062d0561.png)
...
![镜像仓库权限](https://qcloudimg.tencent-cloud.cn/raw/7c37984880a3385e31a1b410373e91f0.png)
...
![镜像仓库权限](https://qcloudimg.tencent-cloud.cn/raw/07482dfbea7d0cd8fcfe8a74902b1eec.png)
