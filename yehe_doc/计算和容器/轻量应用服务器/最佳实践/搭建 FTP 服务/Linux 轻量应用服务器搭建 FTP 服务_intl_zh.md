...
## 操作步骤
### 步骤1：登录轻量应用服务器
您可以 [使用 WebShell 方式登录 Linux 实例](https://intl.cloud.tencent.com/document/product/1103/41523)。也可以根据实际操作习惯，选择其他不同的登录方式，详情请参见 [登录 Linux 实例](https://intl.cloud.tencent.com/document/product/1103/41388)。
...
### 步骤4：设置安全组
搭建好 FTP 服务后，您需要根据实际使用的 FTP 模式给 Linux 轻量应用服务器放通对应端口，详情请参见 [添加防火墙规则](https://intl.cloud.tencent.com/document/product/1103/41393?has_map=1#.E6.B7.BB.E5.8A.A0.E9.98.B2.E7.81.AB.E5.A2.99.E8.A7.84.E5.88.99)。
...
```
 ...
 - 若返回结果中已有 `w`，请前往 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 进行反馈。
