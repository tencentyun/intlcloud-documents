...
|**Operation Log Data** |Please note that this data is managed solely by Cloud Audit (though Lighthouse may access this data for the sole purpose of satisfying your request(s)).                                                                                                     Cloud Audit will delete this data within 1 year.|
