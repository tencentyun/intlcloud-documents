...
For more information, see <a href="https://buy.intl.cloud.tencent.com/lighthouse?region=5&zone=ap-hongkong-2&blueprintType=APP_OS&blueprintId=lhbp-8wbnak86&loginSet=AUTO&zone=ap-hongkong-2"> Tencent Cloud Lighthouse purchase page</a>.
:::
::: System image
...
You can use images to build a personal site, forum, or other platform with the operations instructed in **Best Practices**.
</dx-alert>
...
:::
::: Public bandwidth
It is the public network outbound bandwidth provided by Lighthouse in different regions, which guarantees stable and low-latency network quality.
...
- One private IP is assigned to each Lighthouse instance by default for communication between different Lighthouse instances.
...
- Register a domain name for building a website and publish information on the internet.
- Bind the domain name and resolve it for accessing your website directly with the domain name.
- Install a Secure Sockets Layer (SSL) certificate to provide security features for your website such as HTTPS, identity verification, and encrypted data transfer. For more information, see [SSL Certificates Service](https://intl.cloud.tencent.com/zh/document/product/1007).
- Create alarm policies in [Cloud Monitor](https://intl.cloud.tencent.com/document/product/248/32799) to monitor performance of the Lighthouse instance, and receive notifications when exceptions happen by email, SMS, or phone call. For more information, see [Creating Alarm Policy](https://intl.cloud.tencent.com/document/product/248/38916).
