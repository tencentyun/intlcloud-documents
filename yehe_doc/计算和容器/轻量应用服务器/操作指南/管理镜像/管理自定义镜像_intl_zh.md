...
## 注意事项
- 每个地域的自定义镜像配额为20个。
- 每个地域提供5个免费自定义镜像配额，超过该配额后将会产生费用。详情请参见 [自定义镜像计费说明](https://intl.cloud.tencent.com/document/product/1103/41403)。
- 如您的账户处于欠费状态：
...
- 目前暂不支持跨地域复制自定义镜像功能，您可关注 [轻量应用服务器 TencentCloud Lighthouse](https://intl.cloud.tencent.com/products/lighthouse) 页面及时获取最新信息。
...
4. 在轻量应用服务器购买页中，您可参考 [购买方式](https://intl.cloud.tencent.com/document/product/1103/41404) 选择实例其余配置项。
...
## 相关文档
- [产品概述](https://intl.cloud.tencent.com/document/product/1103/41261)
- [自定义镜像计费概述](https://intl.cloud.tencent.com/zh/document/product/1103/41403?lang=zh&pg=#.3Ca-id.3D.22customizeos.22.3E.E8.87.AA.E5.AE.9A.E4.B9.89.E9.95.9C.E5.83.8F.E8.AE.A1.E8.B4.B9.E6.A6.82.E8.BF.B0.3C.2Fa.3E)
