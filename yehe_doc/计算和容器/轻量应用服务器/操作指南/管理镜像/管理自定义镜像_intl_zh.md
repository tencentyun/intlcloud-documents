...
## 注意事项
- 每个地域的自定义镜像配额为20个，如需提升配额，请 [提交工单](https://console.intl.cloud.tencent.com/workorder/category) 进行申请。
...
- 目前暂不支持跨地域复制自定义镜像功能，您可关注 [轻量应用服务器 TencentCloud Lighthouse](https://www.tencentcloud.com/products/lighthouse) 页面及时获取最新信息。
...
- [自定义镜像计费概述](https://intl.cloud.tencent.com/document/product/1103/41403)
