...
<table>
   ...
   <tr>
      ...
      <td><ul  style="margin: 0;"><li>按量计费：CDN 回源流量（GB）x 每 GB 单价</li></ul></td>
   </tr>
   <tr>
      <td>跨地域复制流量</td>
      <td>数据从一个地域的存储桶传输到另一个地域的存储桶产生的流量<br><br>说明：在同地域的存储桶之间相互复制产生的流量免费。跨地域复制流量费用按照源存储桶所属地域的单价进行计算。</td>
      <td><ul  style="margin: 0;"><li>按量计费：跨地域复制流量（GB）x 每 GB 单价</li></ul></td>
   </tr>
   <tr>
      <td>全球加速流量</td>
      ...
      <td><ul  style="margin: 0;"><li>按量计费：全球加速流量（GB）x 每 GB 单价</li></ul></td>
   </tr> 
</table>
