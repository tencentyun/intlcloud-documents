...
使用量を詳細に予測できる場合は、よりお得な[リソースパック（前払い）](https://www.tencentcloud.com/document/product/436/54353)のご利用をお勧めします。[リソースパック購入ページ](https://buy.intl.cloud.tencent.com/price/cos?lang=en&pg=)で必要なリソースパックを選んで購入することができます。
...
<table>
   ...
   <tr>
      ...
      <td nowrap="nowrap"><ul style="margin: 0;"><li>1日あたりのストレージ容量料金 = ストレージ容量月単価 / 30 * 1日あたりのストレージ容量</li><li>1日あたりのストレージ容量 = 当日の「5分ごとのストレージ容量」の合計 / 288（サンプリングポイント数）</li></ul></td>
   </tr>
   <tr>
      <td>リクエスト料金</td>
