...
假设主账户 A 名下的存储桶需要授权给主账户 B 下的子账户 B0 操作权限，您需要先授予主账号 B 操作 A 名下存储桶的权限，再通过主账户 B 授予子账号 B0 操作 A 名下存储桶的权限。详情操作可参见 [授予其他主帐号下的子帐号操作名下存储桶的权限](https://intl.cloud.tencent.com/document/product/436/32971)。
...
如果您希望在 COS 私有读写的情况下，实现 CDN 回源 COS 时鉴权，可以参考 [CDN 回源鉴权](https://intl.cloud.tencent.com/document/product/436/18670)。
