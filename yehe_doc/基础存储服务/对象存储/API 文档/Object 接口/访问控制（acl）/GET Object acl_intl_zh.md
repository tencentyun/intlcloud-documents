...
| Permission | AccessControlPolicy.AccessControlList.Grant | 授予的权限信息，枚举值请参见 [ACL 概述](https://intl.cloud.tencent.com/document/product/436/30583) 文档中对象的操作部分，例如 READ，FULL_CONTROL 等 | Enum |

**Container 节点 AccessControlPolicy.AccessControlList.Grant.Grantee 的内容：**

| 节点名称（关键字） | 父节点 | 描述 | 类型 |
| --- | --- | --- | --- |
| URI | AccessControlPolicy.AccessControlList.Grant.Grantee | 预设用户组，请参见 [ACL 概述](https://intl.cloud.tencent.com/document/product/436/30583) 文档中预设用户组部分<br>例如`http://cam.qcloud.com/groups/global/AllUsers`或`http://cam.qcloud.com/groups/global/AuthenticatedUsers` | string |
