...
> ? 
>- 分块上传步骤说明：
>  1. 分块上传首先需要进行初始化，使用 [Initiate Multipart Upload](https://intl.cloud.tencent.com/document/product/436/7746) 接口实现，初始化后将得到一个 UploadId，唯一标识本次上传。
...
如果当前分块上传在初始化时使用了服务端加密，则此接口将返回服务端加密专用头部，请参见 [服务端加密专用头部](https://intl.cloud.tencent.com/document/product/436/7729#.E6.9C.8D.E5.8A.A1.E7.AB.AF.E5.8A.A0.E5.AF.86.E4.B8.93.E7.94.A8.E5.A4.B4.E9.83.A8)。
