...
| 节点名称（关键字） | 父节点   | 描述                            | 类型      | 是否必选 | 默认值 | 限制   |
| :--------------- | :------- | :------------------------------ | :-------- | -------- | ------ | ----- |
| State        | Request.NotifyConfig | 回调开关，Off/On | String | 否                 | Off  | 无 |
| Type         | Request.NotifyConfig | 回调类型         | String | 当 State=On 时，必选 | 无   | 普通回调：Url |
| Url          | Request.NotifyConfig | 回调地址         | String | 当 State=On 时，必选 | 无   | 无 |
