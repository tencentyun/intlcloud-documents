...
| sign          | 对象下载签名，如果预览的对象为私有读时，需要传入签名，详情请参见 [请求签名](https://intl.cloud.tencent.com/document/product/436/7778) 文档（注意：需要进行 urlencode）  | String | 否      |
...
该请求无特有错误信息，常见的错误信息请参见 [错误码](https://intl.cloud.tencent.com/document/product/436/7730) 文档。
...
>?您还可通过 JS-SDK 实现更多功能的定制，详情请参见 [自定义配置概述](https://intl.cloud.tencent.com/document/product/436/49415)。
