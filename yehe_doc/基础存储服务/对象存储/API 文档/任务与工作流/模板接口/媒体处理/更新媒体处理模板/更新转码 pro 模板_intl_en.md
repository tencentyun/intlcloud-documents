...
This API is used to update a professional transcoding template.
...
| :----------------- | :----- | :---------------------------------------- | :-------- | ---- |
| Request            | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49912" target="_blank">Same as `Request` in the professional transcoding template creation API.</a> | Container | Yes   |
...
| :----------------- | :----- | :----------------------------------------- | :-------- |
| Response           | None     | <a href="https://intl.cloud.tencent.com/document/product/1045/49912" target="_blank">Same as `Response` in the professional transcoding template creation API.</a> | Container |
