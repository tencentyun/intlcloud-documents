...
This API (`DescribeAIJob`) is used to query a specified job.
...
- <a href="https://www.tencentcloud.com/document/product/1045/49788#jobsDetail" target="_blank">Submitting Translation Job</a>
