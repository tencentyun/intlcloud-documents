...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | -------- |
| Snapshot           | Request.Operation | 指定该任务的参数，同创建截图模板 <a href="https://intl.cloud.tencent.com/document/product/1045/49909" target="_blank">CreateMediaTemplate</a> <br/>接口中的 Request.Snapshot | Container | 否       |
