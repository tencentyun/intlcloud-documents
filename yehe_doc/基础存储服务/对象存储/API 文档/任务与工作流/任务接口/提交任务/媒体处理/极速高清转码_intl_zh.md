...
| 节点名称（关键字）  | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------- | ----------------- | ------------------------------------------------------------ | --------- | -------- |
| TemplateId          | Request.Operation | 模板 ID, 此处需要传入极速高清模板                            | String    | 否       |
| WatermarkTemplateId | Request.Operation | 水印模板 ID，可以传多个水印模板 ID，最多传3个。              | String    | 否       |
| Watermark           | Request.Operation | 水印模板参数，同创建水印模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84725#Watermark" target="_blank">Request.Watermark</a> ，最多传3个。 | Container | 否       |
| DigitalWatermark    | Request.Operation | 数字水印参数,详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945" target="_blank">DigitalWatermark</a> | Container | 否       |
