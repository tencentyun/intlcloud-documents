...
| AudioMix           | Request.Operation.ConcatTemplate | 混音参数, 详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945" target="_blank">AudioMix</a> | Container数组  | 否       | 无     | 仅在 Audio.Remove 为 false 时生效 |
| AudioMixArray      | Request.Operation.Transcode      | 混音参数数组, 最多同时传2个。详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945Array" target="_blank">AudioMixArray</a> | Container数组  | 否       |    -    |           -                        |
