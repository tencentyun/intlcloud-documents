...
6. 在 COS 服务侧单击 <b>+</b>，定义新服务实例，服务实例名可自定义，例如`cos`或者`cos_test`，服务的配置如下所示。
...
####  部署方式
部署 COSN 插件方法请参考 [Hadoop 工具](https://intl.cloud.tencent.com/document/product/436/6884) 文档，但需注意以下几点：
