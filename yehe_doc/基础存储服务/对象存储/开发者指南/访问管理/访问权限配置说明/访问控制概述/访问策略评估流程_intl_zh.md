...
![访问策略评估流程](https://main.qcloudimg.com/raw/18a0cdea71b4360eec7de739d67eeecc.png)
...
策略上下文信息指的是策略中记录的权限详情，在 [最小权限原则](https://intl.cloud.tencent.com/document/product/436/32972) 下，用户需要在策略中明确指定以下信息：
...
撰写策略需要按照一定的策略语法撰写，可参见 [访问策略语言概述](https://intl.cloud.tencent.com/document/product/436/18023) 按照业务所需撰写。用户策略和存储桶策略的编写示例，可分别参见 [用户策略语法结构](https://intl.cloud.tencent.com/document/product/598/10604) 和 [存储桶策略示例](https://intl.cloud.tencent.com/document/product/436/18031)。
