...
| 对象存储 COS        | 是                     |  支持申请开通白名单，请您[联系我们](https://intl.cloud.tencent.com/contact-sales)开通白名单       |
...
- 通过分隔符格式投递：可以将数据按照分隔符格式投递到 COS，详情请参见 [分隔符格式投递](https://intl.cloud.tencent.com/document/product/614/31582)。
...
| PHP SDK        | [点此查阅](https://intl.cloud.tencent.com/document/product/436/31542) |
| Python SDK     | [点此查阅](https://intl.cloud.tencent.com/document/product/436/31546) |
| 小程序 SDK     | [点此查阅](https://intl.cloud.tencent.com/document/product/436/32457) |
