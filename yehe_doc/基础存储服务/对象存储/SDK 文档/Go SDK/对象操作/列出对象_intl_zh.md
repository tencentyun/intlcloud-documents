...
| VersionId          | ListVersionsResult.Version | 对象的版本 ID 当未启用版本控制时，该节点的值为空字符串当启用版本控制时，启用版本控制之前的对象，其版本 ID 为 null 当暂停版本控制时，新上传的对象其版本 ID 为 null，且同一个对象最多只存在一个版本 ID 为 null 的对象版本 | string    |
