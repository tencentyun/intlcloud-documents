...
- 简单上传接口 
 [PUT Object](https://intl.cloud.tencent.com/document/product/436/7749) ：默认使用 MD5 校验，暂不支持 CRC64 校验。
- 分块上传接口
  - [Upload Part](https://intl.cloud.tencent.com/document/product/436/7750)：默认使用 MD5 校验，暂不支持 CRC64 校验。
  - [Complete Multipart Upload](https://intl.cloud.tencent.com/document/product/436/7742)：默认使用 CRC64 校验，暂不支持 MD5 校验。
