...
## 第一步：SDK 介绍
react-native-cos-sdk 目前兼容支持 iOS、Android，是通过 React Native 桥接原生 [Android](https://intl.cloud.tencent.com/document/product/436/12159) 和 [iOS](https://intl.cloud.tencent.com/document/product/436/11280) 的 COS SDK 实现。
