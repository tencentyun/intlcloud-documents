...
| - - - Bucket             | 目标存储桶的名称<br>格式：`qcs::cos:<Region>:appid/<AppId>:<ShortBucketName>`<br>例如：`qcs::cos:ap-chengdu:appid/1250000000:backup` | Object      | 是   |
...
| - - - - Bucket             | 目标存储桶的名称<br>格式：`qcs::cos:<Region>:appid/<AppId>:<ShortBucketName>`<br>例如：`qcs::cos:ap-chengdu:appid/1250000000:backup` | Object      |
