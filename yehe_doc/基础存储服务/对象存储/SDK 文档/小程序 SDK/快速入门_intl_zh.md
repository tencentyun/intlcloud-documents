...
- SDK 常见问题请参见：[小程序 SDK 常见问题](https://intl.cloud.tencent.com/document/product/436/38958)。
...
强烈推荐使用高级上传接口uploadFile，自动针对小文件使用简单上传，大文件使用分块上传，性能更好。详情请参见 [高级上传](https://intl.cloud.tencent.com/document/product/436/43881) 文档。
