...
通过下载对象方法实现，用户只需要添加请求参数，请求参数格式如下，关于下载对象详细说明请参见 [下载对象](https://intl.cloud.tencent.com/document/product/436/31518)。
...
// endpoint 是 COS 访问域名信息，详情请参见 https://intl.cloud.tencent.com/document/product/1045 文档
