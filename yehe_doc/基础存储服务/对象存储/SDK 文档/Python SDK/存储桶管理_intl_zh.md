...
| [DELETE Bucket lifecycle](https://intl.cloud.tencent.com/document/product/436/8284) | 删除生命周期 | 删除存储桶的生命周期管理的配置 |
...
| API | 操作名 | 操作描述 |
| ------------------- | ------------ | ------------------ |
| [PUT Bucket policy](https://intl.cloud.tencent.com/document/product/436/8282) | 设置权限策略   | 设置存储桶的权限策略规则 |
| [GET Bucket policy](https://intl.cloud.tencent.com/document/product/436/8276) | 查询权限策略 | 查询存储桶的权限策略规则 |
| [DELETE Bucket policy](https://intl.cloud.tencent.com/document/product/436/8285) | 删除权限策略 | 删除存储桶的权限策略规则 |
...
| Condition |约束条件，可以不填，具体说明请参见 [condition](https://intl.cloud.tencent.com/document/product/598/10603) 说明|List|否 |
