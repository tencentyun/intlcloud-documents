...
| API                                                          | 操作描述                   |
| :----------------------------------------------------------- | :------------------------- |
|  [提交视频审核任务](https://www.tencentcloud.com/document/product/1045/48254)   | 用于提交一个视频审核任务   |
|  [查询视频审核任务结果](https://www.tencentcloud.com/document/product/1045/48255) | 用于查询指定的视频审核任务 |
