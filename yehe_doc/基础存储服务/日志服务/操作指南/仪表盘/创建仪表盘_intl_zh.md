...
| 操作            | 说明                                                         |
| --------------- | ------------------------------------------------------------ |
| 添加图表        | 仪表盘也提供统计图表创建的入口，支持简易图表创建和自定义图表创建，详情请参考 [添加图表](https://www.tencentcloud.com/document/product/614/43560)。 |
| 删除图表        | 删除已添加的图表。                                             |
| 编辑图表        | 进入图表编辑页面。                                             |
...
| 刷新            | 支持自动时间间隔与手动数据刷新。                               |
| 添加模板变量    | 模板变量支持仪表盘更灵活的定义与修改相关数据查询与过滤的参数，可以提高仪表盘的复用率和分析的颗粒度，详情请参考 [模板变量](https://www.tencentcloud.com/document/product/614/43561)。 |
