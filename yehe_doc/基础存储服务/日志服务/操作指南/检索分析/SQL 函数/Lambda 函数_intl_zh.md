...
Lambda 表达式需与函数一起使用，例如 [filter 函数](https://intl.cloud.tencent.com/document/product/614/43565#filter)、[reduce 函数](https://intl.cloud.tencent.com/document/product/614/43565#reduce)、[transform 函数](https://intl.cloud.tencent.com/document/product/614/43565#transform)、[zip_with 函数](https://intl.cloud.tencent.com/document/product/614/43565#zip_with)。Lambda 表达式的语法如下：
```
