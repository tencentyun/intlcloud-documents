...
- 对端账号为您账号的协作者之一。若不是协作者，请参见 [新建协作者](https://intl.cloud.tencent.com/document/product/598/32639)。
...
```
2. 将该策略授权给协作者，授权过程请参见 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。
