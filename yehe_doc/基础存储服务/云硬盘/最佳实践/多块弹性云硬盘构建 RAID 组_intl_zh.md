...
>!
>- 请及时对即将到期的弹性云硬盘进行 [续费](https://intl.cloud.tencent.com/document/product/362/36874) 操作，以免由于弹性云硬盘到期被系统强制隔离对 RAID 产生影响。
...
1. 以 root 用户 [登录云服务器](https://intl.cloud.tencent.com/document/product/213/5436)。
2. 执行以下命令，安装 mdadm。
```
yum install mdadm -y
```
