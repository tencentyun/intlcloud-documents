...
在快照商业化后，腾讯云仍旧在中国地域为用户提供80GB的免费额度。超过免费额度后，快照将按按量计费的模式每小时扣费，收费标准可参考 [价格总览](https://intl.cloud.tencent.com/document/product/362/2413#Snapshot)。免费额度策略如下：
- 免费额度覆盖范围可在 [快照概览](https://console.cloud.tencent.com/cvm/snapshot/overview) 中查看。
- 预计后续将取消快照免费额度策略，请您关注 [云硬盘产品动态](https://www.tencentcloud.com/document/product/362) 及时获取最新消息。
...
### 欠费说明
一旦您的腾讯云账户进入欠费状态，快照将会进入“已隔离”状态，且相关功能将会被冻结。冻结策略及注意事项请参见 [快照欠费说明](https://intl.cloud.tencent.com/document/product/362/31625)。
