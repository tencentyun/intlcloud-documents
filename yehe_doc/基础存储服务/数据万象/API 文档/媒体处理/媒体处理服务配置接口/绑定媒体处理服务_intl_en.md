...
This API (`CreateMediaBucket`) is used to bind a media bucket (i.e., authorizing the media processing service role to access the bucket).
...
| MediaBucket        | Response | Media bucket details, which are the same as `Response.MediaBucketList` in [DescribeMediaBuckets](https://intl.cloud.tencent.com/document/product/1045/49940). | Container |
