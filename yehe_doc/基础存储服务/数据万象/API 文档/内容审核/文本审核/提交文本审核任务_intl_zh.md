...
本接口用于提交一个文本审核任务。文本审核功能为异步任务方式，您可以通过提交文本审核任务审核您的文本文件，然后通过 [查询文本审核任务接口](https://intl.cloud.tencent.com/document/product/436/48189) 或 [文本审核回调](https://intl.cloud.tencent.com/document/product/436/48190) 查询审核结果。
...
<span id=3></span>
- 支持设置回调地址 Callback 获取检测结果，或通过 [查询文本审核任务结果接口](https://intl.cloud.tencent.com/document/product/436/48189) 主动轮询获取审核结果详情。
