...
| AudioMix           | Request | 混音参数，详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945" target="_blank">AudioMix</a>                                    | Container | 否   | Audio.Remove 为 false 时生效 |
| AudioMixArray      | Request | 混音参数, 最多同时传2个。详情见 <a href="https://intl.cloud.tencent.com/document/product/1045/49945Array" target="_blank">AudioMixArray</a>                                    | Container数组 | 否 | Audio.Remove 为 false 时生效 |
...
| TranscodeIndex        | Request.TransConfig | 指定处理的流编号，对应媒体信息中的 Response.MediaInfo.Stream.Video.Index </br>和 Response.MediaInfo.Stream.Audio.Index，详见 [获取媒体信息接口](https://www.tencentcloud.com/document/product/1045/43732) | String    | 否       | 无  | 无                                                   |
