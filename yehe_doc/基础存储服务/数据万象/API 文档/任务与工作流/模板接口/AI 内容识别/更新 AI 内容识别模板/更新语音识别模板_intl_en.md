...
| :----------------- | :----- | :------------- | :-------- | ---- |
| Request            | None     | <a href="https://www.tencentcloud.com/document/product/1045/50303#Request" target="_blank">Same as `Request` in the speech recognition template creation API.</a> | Container | Yes   |
