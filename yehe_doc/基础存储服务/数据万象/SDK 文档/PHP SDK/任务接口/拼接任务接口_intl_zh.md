...
| API           | 操作描述                 |
| ------------- |  ---------------------- |
| [提交拼接任务](https://intl.cloud.tencent.com/document/product/436/49046) | 提交一个拼接任务 |
...
| Audio              | Request.Operation. ConcatTemplate | 音频参数，同创建拼接模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/49907) 接口中的 Request.ConcatTemplate.Audio | Container      | 否       | 无     | 无                                |
| Video              | Request.Operation. ConcatTemplate | 视频参数，同创建拼接模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/49907) 接口中的 Request.ConcatTemplate.Video | Container      | 否       | 无     | 无                                |
| Container          | Request.Operation. ConcatTemplate | 封装格式，同创建拼接模板 [CreateMediaTemplate](https://intl.cloud.tencent.com/document/product/1045/49907) 接口中的 Request.ConcatTemplate.Container | Container      | 是       | 无     | 无                                |
| AudioMix           | Request.Operation. ConcatTemplate | 混音参数, 详情见 [AudioMix](https://intl.cloud.tencent.com/document/product/1045/49945) | Container数组  | 否       | 无     | 仅在 Audio.Remove 为 false 时生效 |
