...
- 成功：解析 API 返回的 XML 内容中的审核任务结果到 WebPageAuditingJobsDetail 结构中，具体返回参数可查看 [提交网页审核任务](https://intl.cloud.tencent.com/document/product/436/48282) 文档。
...
- 成功：解析 API 返回的 XML 内容中的审核任务结果到 WebPageAuditingJobsDetail 结构中，具体返回参数可查看 [查询网页审核任务结果](https://intl.cloud.tencent.com/document/product/436/48283) 文档。
