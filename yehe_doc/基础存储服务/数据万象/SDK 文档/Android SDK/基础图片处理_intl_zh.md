...
>? API 文档请参见 [缩放功能接口](https://intl.cloud.tencent.com/document/product/1045/33713)。
>
...
>? API 文档请参见 [裁剪功能接口](https://intl.cloud.tencent.com/document/product/1045/33714)。
>
...
>? 方位图说明，请参见 [gravity 介绍](https://intl.cloud.tencent.com/document/product/1045/33714#.E4.B9.9D.E5.AE.AB.E6.A0.BC.E6.96.B9.E4.BD.8D.E5.9B.BE)。
>
...
>? API 文档请参见 [旋转功能接口](https://intl.cloud.tencent.com/document/product/1045/33715)。
>
...
>? API 文档请参见 [格式转换接口](https://intl.cloud.tencent.com/document/product/1045/33716)。
>
...
数据万象提供三种变换类型：绝对变换、相对变换、最低质量变换，可调节图片质量。API 文档请参见 [质量变换接口](https://intl.cloud.tencent.com/document/product/1045/33717)。
...
高斯模糊功能，模糊半径，取值范围为1 - 50；正态分布的标准差，必须大于0。API 文档请参见 [高斯模糊接口](https://intl.cloud.tencent.com/document/product/1045/33718)。
...
图片锐化功能，value 为锐化参数值，取值范围为10 - 300间的整数，推荐使用70。参数值越大，锐化效果越明显。API 文档请参见 [锐化接口](https://intl.cloud.tencent.com/document/product/1045/33719)。
...
>?
> - API 文档请参见 [图片水印接口](https://intl.cloud.tencent.com/document/product/1045/33720) 和 [文字水印接口](https://intl.cloud.tencent.com/document/product/1045/33721)。
> - 方位图说明，请参见 [gravity](https://intl.cloud.tencent.com/document/product/1045/33721#1)。
> 
...
腾讯云数据万象通过 imageMogr2 接口可去除图片元信息，包括 EXIF 信息。API 文档请参见 [去除图片元信息接口](https://intl.cloud.tencent.com/document/product/1045/33725)。
