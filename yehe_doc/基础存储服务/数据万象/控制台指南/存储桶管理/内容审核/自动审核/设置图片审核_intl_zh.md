...
您也可以对对象存储（Cloud Object Storage，COS）中的**历史**图片文件进行扫描，审核涉黄、违法违规及广告传播的文件，详情请参见设置历史数据审核任务和 [图片审核](https://intl.cloud.tencent.com/document/product/1045/49320) API 文档。
