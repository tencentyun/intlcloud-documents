...
- 确保您的云服务器在网络流日志[ 支持列表](https://intl.cloud.tencent.com/document/product/682/18934)。
- 您已创建日志集和日志主题，具体操作请参见[ 新增日志集](https://intl.cloud.tencent.com/document/product/614/34238)、[新增日志主题](https://intl.cloud.tencent.com/document/product/614/34239)。
...
## 结果验证
约 15 分钟后，在”流日志“页面目标流日志右侧”操作“列单击【查看】。在”检索分析“页面选择操作时间，并输入服务器 B 的 IP 进行关键词检索，检索结果与服务器 A 中回执一致。
