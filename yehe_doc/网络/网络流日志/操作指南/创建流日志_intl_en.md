>The Flow Logs service is in beta test. If you want to use the service, please submit an application for beta eligibility.
...
> For more information on how to create logsets and log topics, please see [Creating Logsets and Log Topics](https://intl.cloud.tencent.com/document/product/682/18967).
...
>
>- You can view the records of a newly created flow log in CLS after 15 minutes upon the creation (10 minutes for the capture window and 5 minutes for data publishing).
