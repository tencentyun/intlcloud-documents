...
<td colspan="2">Both are public IPs and support public network access</td>
</tr>
<tr>
<td colspan="2">Acquisition method</td>
<td>It can only be obtained when you purchase a CVM</td>
<td><li>You can apply for an EIP in the console</li><li>You can convert a public IP address to an EIP</li></td>
</tr>
<tr>
...
<td>The IP resource fee is a part of the EIP fee, which varies by the account type</td>
</tr>
<tr>
...
<tr>
<td colspan="2">For the quota of public IPs 
   (including EIPs) bound to a CVM, see the limits on public IPs bound to a CVM
</td>
</tr>
<tr>
<td rowspan="4" >Operations</td>
<td>Converting an IP</td>
<td><br>A public IP can be converted to an EIP. The IP address will not change after the conversion</td>
...
<td>If you no longer need a public IP, you can log in to the <a href="https://console.cloud.tencent.com/cvm" target="_blank">CVM console</a>, locate the public IP, and in the “Operation” column, select <b>More > IP/ENI > Return Public IP</b> to return it</td>
...
- For more information about how to quickly build a Virtual Private Cloud (VPC) with IPv4 CIDR block, see [Building Up an IPv4 VPC](https://intl.cloud.tencent.com/document/product/215/31891).
