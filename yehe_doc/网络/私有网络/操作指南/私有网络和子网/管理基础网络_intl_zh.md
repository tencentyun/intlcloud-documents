...
2. 您可以通过 DescribeAccountVpcAttributes 接口查询账号的网络属性。
3. 如果您的业务必须使用基础网络服务，请 [提交申请](https://intl.cloud.tencent.com/apply/p/qnm7krv9glo)。
...
6. 基础网络关联到某个私有网络后，仅支持与私有网络主 CIDR 的资源通信，不支持与私有网络辅助 CIDR 的资源通信。


## 基础网络云服务器切换为私有网络
为了方便您使用私有网络，腾讯云提供单台和批量云服务器的基础网络切换至私有网络服务，操作步骤请参见 [切换私有网络服务](https://intl.cloud.tencent.com/document/product/213/20278)。
