...
## 如何规划子网数量？
- 一个私有网络可以同时拥有多个子网（默认配额为10个），相同私有网络下不同子网默认内网互通。
...
- **在规划私有网络网段时，请注意：**
 ...
 - VPC CIDR 和 子网 CIDR 创建后都不能修改。当 VPC CIDR 或 子网 CIDR 地址不足时，可通过 [创建辅助 CIDR ](https://intl.cloud.tencent.com/document/product/215/31805) 解决，但是由于辅助 CIDR 处于内测阶段，且会增加更多操作的复杂性，因此建议在创建 VPC 和子网时，合理规划网段地址。
...
## 相关文档
- 若需快速搭建一个具有 IPv4 CIDR 的私有网络，从新建私有网络和子网，到云服务器的购买并绑定一个弹性公网 IP，并最终实现公网访问，请参见 [快速搭建 IPv4 私有网络](https://intl.cloud.tencent.com/zh/document/product/215/31891)。
