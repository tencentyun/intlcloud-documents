...
普通公网 IP 不能与 CVM 等资源动态解绑和绑定，但您可以将普通公网 IP 转换为弹性公网 IP，详细操作请参见 [公网 IP 转换为 EIP](https://intl.cloud.tencent.com/document/product/213/16586) 。
...
弹性公网 IP 的申请、绑定、释放操作请参见 [弹性公网 IP-操作步骤](https://intl.cloud.tencent.com/document/product/213/16586)。 
弹性公网 IP 具有如下优势： 
- 独立持有的资源 
...
NAT 网关的相关配置操作，请参见 [NAT 网关-操作总览](https://intl.cloud.tencent.com/document/product/1015/12958)。
NAT 网关具有如下优势： 
- 安全的公网访问 
...
负载均衡的购买、配置操作请参见 [负载均衡-快速入门](https://intl.cloud.tencent.com/document/product/214/8975 )。
负载均衡具有如下优势： 
- 单集群高性能 
...
公网网关的相关配置操作，请参见 [配置公网网关](https://intl.cloud.tencent.com/document/product/215/33404)。
