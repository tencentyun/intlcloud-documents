...
>?
>- 目前 HAVIP 产品处于灰度优化中，上海和广州地域新用户暂停使用，非上海和非广州地域新用户如有需要，请提交 [内测申请](https://intl.cloud.tencent.com/apply/p/azh0w1qoavk)。
>- 上海和广州地域切换延时可能达1 - 2分钟，建议使用腾讯云 [CLB](https://intl.cloud.tencent.com/document/product/214)、TDaTa 等产品以满足需要。
...
- **关系型数据库主备**
两台数据库之间 keepalived 或 Windows Server Failover Cluster，需要 HAVIP 作为 virtual IP。详细操作请参见 [最佳实践-用 HAVIP + Windows Server Failover Cluster 搭建高可用 DB](https://intl.cloud.tencent.com/document/product/215/31878)。
