...
3. Select a target region to view the details of all HAVIPs you have applied for.
	...
	+ ID/Name: ID refers to the auto-generated ID of the HAVIP after being created. You can click on it to view the basic information of the HAVIP. Name is user-defined when the HAVIP is created.
	...
	+ EIP: refers to the bound EIP. If the HAVIP is not bound with an EIP yet, this field will be displayed as **-**.
...
3. Enter ID, name or address in the search box on the right to quickly search HAVIPs.
