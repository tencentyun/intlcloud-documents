...
> ?新建专用通道的共享专线功能于 2020 年 8 月 1 日零点关闭新增申请入口。若您已使用共享专用通道，该共享通道的功能不受影响，如果您主动删除该共享通道，将无法新增申请共享物理专用通道。
> 
...
2. 在“专用通道”页面上方单击 【+新建】，并配置名称、专线类型、接入网络、地域、关联的专线网关等基名称本配置，完成后单击【下一步】。
    ...
    <td> 选择您已申请的物理专线</td>
     ...
     <tr>
    <td>接入网络</td>
    <td>选择云联网、私有网络或黑石网络</td>
    </tr>
     <tr>
    <td>地域</td>
    <td>选择私有网络/黑石网络所在地域，若接入网络选择云联网，则默认为云联网专线网关所在地域。</td>
    </tr>
     <tr>
    <td>私有网络</td>
