After a metric or event alarm policy is configured for a connection or dedicated tunnel, you can view its alarm history and details on the Cloud Monitor console.
...
2. Select a period during which alarms are generated.
   The alarm records display the alarm details, including alarm object, alarm content, duration, and alarm status.
...
>? The product event lists all the connection/dedicated tunnel events under the current account during the custom period. The fields including Event, Affected Object, Object Details, Status, and Start Time are displayed.
