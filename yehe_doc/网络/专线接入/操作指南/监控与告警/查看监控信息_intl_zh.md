您可以在腾讯云控制台，查看物理专线或专用通道的网络监控数据，帮助您排查网络故障。您还可以通过 API 查看监控信息，详情请参见 [专线接入-物理专线监控指标](https://intl.cloud.tencent.com/document/product/248/10994)。
...
2. 查看物理专线网络监控数据。
 ...
 3. 在监控详情页面，可查看网络出带宽、网络入带宽数据，并通过单击【近24小时】、【近7天】或自定义日期，调整监控数据的时间轴。
      - 网络出带宽：物理专线的平均每秒出流量。
      - 网络入带宽：物理专线的平均每秒入流量。
![](https://main.qcloudimg.com/raw/9e62e4a19895d6fcea33446f3d2488fb.png)
3. 查看专用通道网络监控数据。
 1. 在左侧导航栏单击【专用通道】。
 2. 在专用通道列表页面，单击单击目标专用“监控”列的<img width="3%" src="https://main.qcloudimg.com/raw/52d8549cc2412c6527f332a3b88be44d.png"  >。
 3. 在监控详情页面，可查看网络出带宽、网络入带宽、出量包、入量包数据，并通过单击【近24小时】、【近7天】或自定义日期，调整监控数据的时间轴。
      - 网络出带宽：专用通道的平均每秒出流量。
      - 网络入带宽：专用通道的平均每秒入流量。
      - 出量包：专用通道的平均每秒出包量。
      - 入量包：专用通道的平均每秒入包量。
