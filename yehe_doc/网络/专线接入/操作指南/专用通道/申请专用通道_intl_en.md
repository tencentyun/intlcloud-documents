...
<tr>
<td>Tunnel</td>
<td>Set to<b>1.0</b> or <b>2.0</b> depending on the connection you selected.</td>
</tr>
<tr>
<td>Connection</td>
...
<td><ul><li>For a 1.0 tunnel, select from <b>CCN</b>, <b>BM Network</b> and <b>VPC</b>.</li><li>
 For a 2.0 tunnel, select either <b>CCN</b> or <b>VPC</b>.</li></ul></td>
</tr>
<tr>
<td>Region</td>
<td><ul><li>If <b>CCN</b> is selected for <b>Access Network</b>, the region is where the CCN-based direct connect gateway resides.</li><li>
 <li>If <b>VPC</b> is selected for <b>Access Network</b>, the region will be the connection region for a 2.0 tunnel, and any region for a 1.0 tunnel.</li><li>If <b>BM Network</b> is selected for <b>Access Network</b>, select a region for a 1.0 tunnel.</li></ul></td>
</tr>
<tr>
...
![](https://main.qcloudimg.com/raw/6383cc3251f63aceb9c7a31659be910d.png)
<table>
<tr>
 <th width="15%">Field</th>
<th width="85%">Description</th>
...
<td>Enter the connection secondary IP address on the Tencent Cloud side. This field is not supported when the mask of the connection IP address is 30 or 31.</td>
</tr>
<tr>
<td>CPE Peer IP</td>
...
> - `192.168.0.0/16` should be split into `192.168.0.0/17` + `192.168.128.0/17`.
>
4. Configure IDC devices. You can click **Download configuration guide** and complete the configurations as instructed in the guide.<img src="https://main.qcloudimg.com/raw/f5480a8e21884a3bbf1cd38c109f23bc.png"></img>
<table>
<tr>
