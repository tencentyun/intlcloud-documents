...
- **Carrier**: a provider of connection resources, including China Mobile, China Unicom, China Telecom, and other carriers that meet the Direct Connect Audit Standard.
 >? According to the relevant national laws, regulations and the [Notice on Regulating the Internet Network Access Marketplace (MIIT [2017] No. 32)](http://www.miit.gov.cn/n1146285/n1146352/n3054355/n3057709/n4704651/c5471876/content.html), you should choose an eligible connection provider to complete the construction of the Direct Connect service.
...
- If your local IDC resides in the same data center as a Tencent Cloud access point, you only need to apply for connection in the Tencent Cloud console. For detailed directions, please see [Applying for Connection](https://intl.cloud.tencent.com/document/product/216/19244).
