Tencent Cloud Direct Connect supports interconnecting IDC and Tencent Cloud resources through CCN to quickly build up a hybrid cloud featuring high security and high throughput. This document describes how to migrate an IDC to the cloud through CCN.
...
2. Click **+ New**.
3. In the pop-up window, enter the gateway name, select **CCN** for the **Associate Network**, leave the **CCN instance** empty, and click **OK**.

## Step 2: Add the IDC IP Range on the Direct Connect Gateway
1. Locate the direct connect gateway just created and click the **ID/Name** to access its details page.
2. Click the **IDC IP Range** tab.
3. Click **Add** to enter the IDC IP range.
...
2. Click **+New**.
3. In the pop-up window, enter relevant information as prompted. Select **CCN** for the **Access Network** and then select the CCN-based direct connect gateway just created.
