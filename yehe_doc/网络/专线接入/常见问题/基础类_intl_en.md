...
- [Why is the shared tunnel feature disused?](#63)
...
- If you want to use Direct Connect service, you can connect to Tencent Cloud by [applying for a tunnel](https://intl.cloud.tencent.com/document/product/216/19250). For more information on access methods, contact your Tencent Cloud sales rep.
...
### What are the differences between Direct Connect and IPsec VPN?
