...
Tencent Cloud Direct Connect partners can help you purchase Tencent Cloud Direct Connect. You can use the marketplace to learn more about [Tencent Cloud partners](https://market.cloud.tencent.com/categories/1042) and get help. In most cases, you do not need to apply for your own connections. Instead, you can just go to the Create a Dedicated Tunnel page and share the connections that are owned by our partners.
