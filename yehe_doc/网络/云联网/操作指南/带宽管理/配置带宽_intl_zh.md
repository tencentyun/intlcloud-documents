创建云联网并关联网络实例后，还需要配置带宽才能正常通信。对于月预付费用户，则需额外购买云联网关联的两端地域带宽；对于月95后付费用户，则需配置云联网关联的两端地域带宽限制。此功能正在内测中，如需使用，请[联系商务](https://intl.cloud.tencent.com/contact-sales)。
...
3. 在“带宽管理”页面单击【购买带宽】，并在“购买带宽”对话框中执行以下操作：
    1. 选择云联网关联的两端地域，并设置目标带宽上限和购买时长。
