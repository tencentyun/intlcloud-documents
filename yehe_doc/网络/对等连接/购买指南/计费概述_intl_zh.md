...
- 日峰值计费：取当日出入带宽峰值结算。
- 月95计费：取当月的月95带宽峰值结算（月95计费模式暂不全量开放，如需使用，请 [提交申请](https://intl.cloud.tencent.com/apply/p/clg22aj1t6n) ）。
>!
...
- **日峰值计费示例**
如果对等连接发起方在上海，接受方在广州，当日的出带宽峰值为20Mbps，入带宽峰值为30Mbps，则当日带宽峰值取30Mbps，带宽所在阶梯单价为1.98USD/Mbps/天，则当日费用为：30 * 1.98 = 59.4 USD，于次日上午的8 - 10点之间对发起方进行扣费。

 <span id=yjf> </span>

### 月95计费
取当月的月95带宽峰值结算（月95计费模式暂不全量开放，如需使用，请 [提交申请](https://intl.cloud.tencent.com/apply/p/clg22aj1t6n) ）。
...
如果对等连接发起方在上海，接受方在广州，6月在上海和广州之间有14天产生的跨地域互通带宽消耗大于10Kbps，月95带宽峰值为60Mbps，则：
   ...
   - 阶梯单价： 取60Mbps所处阶梯单价：24 USD/Mbps/月。
  

则6月费用 = 月95带宽峰值 × 有效天占比 × 阶梯单价 = 60 ×（14 / 30）× 24 = 672 USD，于7月1日上午的8 - 10点之间对发起方进行扣费。
