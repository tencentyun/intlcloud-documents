...
1. Public network CLB: you need to open the CLB VIP to the internet on the backend CVM instance security group, so that CLB can use the VIP to detect the backend CVM instance health status.
...
![](https://main.qcloudimg.com/raw/aa63186904b28db4052f77aa3c7b4b01.png)
...
![](https://main.qcloudimg.com/raw/82bdc7cad2c3f4700ffc710d36ecbdbf.png)
>
...
![](https://main.qcloudimg.com/raw/8d5bbbc3cd4e24e19500c68859d81bdd.png)
The CLB security group configuration is completed, which only allows access to CLB from port 80.
![](https://main.qcloudimg.com/raw/6e0e1c2f834bb7425ef3ca010114165a.png)
...
![](https://main.qcloudimg.com/raw/5577ee19d3ff023d72e489f0cf82f676.png)
...
>- For the public network CLB instance used in this example, the CLB VIP needs to be opened to the internet on the backend CVM instance security group for health checks. The current IP 0.0.0.0/0 already contains the CLB VIP.
