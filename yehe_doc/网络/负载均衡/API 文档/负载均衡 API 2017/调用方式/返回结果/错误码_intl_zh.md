>? **当前页面接口为旧版 API，未来可能停止维护。负载均衡 API 3.0 版本接口定义更加规范，访问时延下降显著，建议使用 <a href="https://intl.cloud.tencent.com/document/product/214/33789" target="_blank">负载均衡 API 3.0</a>。**
>
