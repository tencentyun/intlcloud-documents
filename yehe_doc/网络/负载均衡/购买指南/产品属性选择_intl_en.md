...
- **Billing Description**
  - For public network CLB instances purchased by non-bill-by-IP accounts, only instance fees will be charged. The public network bandwidth and traffic fees generated by services can be billed on the real server. For more information, please see [Billing Description for Non-Bill-by-IP Account](https://intl.cloud.tencent.com/document/product/214/8848).
  - For public network CLB instances purchased by bill-by-IP accounts, instance fees and public network fees will be charged.
