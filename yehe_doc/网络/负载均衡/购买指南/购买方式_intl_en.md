Tencent Cloud allows you to purchase CLB instances either from the console or via API. This document describes these two purchase methods in detail.
...
2. For the **Instance type**, select "Cloud Load Balancer".
