...
- 支持配置负载均衡访问日志到 CLS 的地域包括：广州、上海、南京、北京、重庆、成都、中国香港、新加坡、孟买、硅谷、多伦多、东京、法兰克福，可直接在控制台使用或通过 API 配置。
...
> ? 使用 CLS 方案后，用户可根据业务成本、使用等实际需求，将访问日志再存储到 COS， 详情请参见 [投递简介 ](https://intl.cloud.tencent.com/document/product/614/32940)。
