...
## 使用限制
- 当前 CLB 中的 QUIC 协议正在内测中，如有需要，请提交[内测申请](https://intl.cloud.tencent.com/apply/p/o18084f2opi)进行使用。
- 当前支持 QUIC 的地域为：北京、上海及孟买。
- 当前仅公网负载均衡的七层 HTTPS 监听器支持 QUIC 协议。

<span id="making"></span>
## 操作步骤
1. 根据需求创建负载均衡实例，详情请参见 [创建负载均衡实例](https://intl.cloud.tencent.com/document/product/214/6149)。
...
## 后续操作
填写完基本配置后，可继续完成 [健康检查](https://intl.cloud.tencent.com/document/product/214/6097) 和 [会话保持](https://intl.cloud.tencent.com/document/product/214/6154) 的相关操作。
