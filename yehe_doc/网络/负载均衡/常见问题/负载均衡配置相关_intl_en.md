...
### How do I configure the security group of a CLB real server? How to configure the access blacklist?
...
For more information on the security group, please see [Real Sever Security Group Configuration Description](https://intl.cloud.tencent.com/document/product/214/6157).
