...
- 非带宽上移账户的负载均衡不收取任何的流量或带宽费用。负载均衡服务产生的公网流量费用，由绑定的后端的 CVM 收取，建议购买后端 CVM 时，公网带宽选择按使用流量计费，并设定合理的最高的带宽峰值上限，这样就无需关注 CLB 出口的总流量的涨跌。互联网 Web 业务的流量起伏较大，无法准确预测。若按带宽计费，带宽买多了不划算，买得太少，业务高峰期会出现丢包的情况。
