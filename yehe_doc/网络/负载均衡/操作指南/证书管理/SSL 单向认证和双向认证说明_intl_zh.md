...
>?负载均衡 CLB 可在创建 TCP SSL 监听器或 HTTPS 监听器时，选择 SSL 解析方式为单向认证或双向认证，详情请参见 [配置 TCP SSL 监听器](https://intl.cloud.tencent.com/document/product/214/32519)、[配置 HTTPS 监听器](https://intl.cloud.tencent.com/document/product/214/32516)。
...
## 相关文档
[证书要求及转换证书格式](https://intl.cloud.tencent.com/document/product/214/6155)
