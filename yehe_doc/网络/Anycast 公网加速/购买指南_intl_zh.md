...
### 加速流量费用
Anycast 弹性公网 IP 产生的流量，称为加速流量。我们对加速流量按带宽收费，单价高于普通公网网络。按一个账户下加速流量的总流量曲线进行95消峰后，按出和入高的方向进行收费，具体价格（单位：美元/Mbps/月）如下：
...
Anycast 弹性公网 IP 是弹性公网 IP 的一种，没有绑定实例的情况下会收取资源占用费。详情请参见计费模块中的 [IP 资源费用](https://intl.cloud.tencent.com/document/product/213/17156)  相关内容。
