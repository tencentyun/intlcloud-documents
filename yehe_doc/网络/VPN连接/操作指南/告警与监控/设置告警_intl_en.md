...
When the alarm condition is triggered, you will receive an alarm notification via SMS, email, or WeChat. You can also click **Alarm History** on the left sidebar to find the alarm. For more information about alarms, see [Alarm Configuration](https://intl.cloud.tencent.com/document/product/248/38908).
