...
>
4. Enter the gateway name, such as TomVPNGw. Select the network (such as TomVPC), bandwidth cap, billing method, and click **Create**. After the VPN gateway is created, the system randomly assigns it a public IP address such as `203.195.147.82`.
