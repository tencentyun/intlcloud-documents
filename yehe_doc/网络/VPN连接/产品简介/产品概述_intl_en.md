...
- VPN gateway: an IPsec VPN gateway.
 ...
 - VPN gateway for CCN: VPN gateway can be associated with CCN. Each VPN gateway for CCN can create multiple VPN tunnels. Each VPN tunnel can connect one local IDC. 
