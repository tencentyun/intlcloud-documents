...
有关私有网络的更多计费信息，详情请参见 [私有网络价格总览](https://intl.cloud.tencent.com/document/product/215/35500)。

### 用户创建的 NAT 网关没有使用为什么还会扣费？
由于 NAT 网关具备双机热备的特性，系统每3秒会分别给 NAT 网关的主备服务器发送一个5KB的探测包，因此每天会产生0.2747GB的流量，对应中国大陆（不含港澳台地区）、中国香港、北美会分别产生：0.12 USD/GB、0.12 USD/GB、0.077 USD/GB的费用。
...
详情请参见 [路由策略优先级说明](https://intl.cloud.tencent.com/document/product/215/31810)。
