...
## iOS 接入流程
1. 首先需要 [接入 TRTC](https://intl.cloud.tencent.com/document/product/647/35102)，跑通流程。
...
```
4.2 接入 ASR 的 QCloudAudioDataSource 协议如下，[协议详情](https://intl.cloud.tencent.com/document/product/1118/43383)。代码可参考工程中 QDAudioDataSource.m 文件。
...
.build(); 
```
 - 接入 ASR 的 PcmAudioDataSource 接口实现如下，[协议详情](https://intl.cloud.tencent.com/document/product/1118/43388)。代码可参考工程中 AudioDataSource.java 文件。
```java
