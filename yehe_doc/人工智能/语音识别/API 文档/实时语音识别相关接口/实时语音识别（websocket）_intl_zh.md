...
| engine_model_type | 是 | String | 引擎模型类型<br>非电话场景：<br>• 16k_zh：16k 中文普通话通用；<br>• 16k_en：16k 英语；<br>• 16k_ja：16k 日语；<br>• 16k_id 印度尼西亚语；<br>• 16k_vi 越南语；<br>• 16k_ms 马来语；<br>• 16k_fil 菲律宾语；|
