...
| engine_model_type | Yes | String | The engine model type <br>For phone call scenarios:<br>• 8k_zh：8kHz, for Mandarin in general scenarios,<br>• 8k_en：8kHz, for English;<br>For non-phone call scenarios:<br>• 16k_zh:16 kHz, for Mandarin in general scenarios;<br>• 16k_en:16 kHz, for English;<br>• 16k_ko:16 kHz, for Korean;<br>• 16k_ja:16 kHz, for Japanese;<br>• 16k_th:16 kHz, for Thai;<br>• 16k_id:16 kHz, for Bahasa; <br>• 16k_vi:16kHz, for Vietnamese; <br>• 16k_ms:16kHz, for Malay; <br>• 16k_fil:16kHz, for Filipino;<br>• 16k_pt:16kHz, for Portuguese;<br>• 16k_tr:16kHz, for Turkish; <br>• 16k_ar:16kHz, for Arabic; <br>• 16k_es:16kHz, for spanish;<br>• 16k_hi:16kHz, for Hindi;<br>• 16k_fr:16kHz, for French;|
...
| reinforce_hotword|No | Integer |Hot word enhancement function. The default is 0, 0: not enabled, 1: enabled<br> After activation (only 8k_zh, 16k_zh supported), the homophonic replacement function will be enabled, and homophonic words and phrases will be configured in the hot words section.|
