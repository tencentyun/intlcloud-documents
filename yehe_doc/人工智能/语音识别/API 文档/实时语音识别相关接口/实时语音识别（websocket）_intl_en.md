...
| Item | Description |
|---------|---------|
| Language | Supported languages include Mandarin, English, Japanese, Bahasa, Vietnamese, Malay, Filipino, Portuguese, Turkish, Arabic, Spanish, Hindi and French. You can set the language through the `engine_model_type` parameter. |
