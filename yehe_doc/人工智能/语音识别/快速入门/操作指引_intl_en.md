...
### Activating Service
Log in to the [ASR console](https://console.cloud.tencent.com/asr) and activate the service.

### Making a Purchase
ASR services are pay-as-you-go once activated. For more information, see [Billing Overview](https://intl.cloud.tencent.com/document/product/1118/43352).

### Using ASR
To use the ASR service, you can choose one of the four options below.
<table>
<tr>
...
<tr>
<th>Online feature call through <a href="https://console.cloud.tencent.com/api/explorer?Product=asr&Version=2019-06-14&Action=CreateAsyncRecognitionTask&SignVersion=">API 3.0 Explorer</a></th>
...
<td>Tencent Cloud has developed an SDK that supports feature development by calling ASR APIs. The SDK currently supports multiple programming languages, including Python, Java, PHP, Go, Node.js, and .NET. <b>You can download the applicable SDK in the documentation of each service</b>.</td>
<td><a href="https://intl.cloud.tencent.com/document/product/1118/43356">Quick Server API Connection</a></td>
</tr>
<tr>
...
### Viewing Calls
Log in to the [ASR console](https://console.cloud.tencent.com/asr) to view the usage of each service provided by ASR.
