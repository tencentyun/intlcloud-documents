## AI Multi-Language Video Transcription and Translation Subtitles Platform Service Level Agreement

**In order to use the AI Multi-Language Video Transcription and Translation Subtitles Platform Service (the “Service”), you shall read and comply with this AI Multi-Language Video Transcription and Translation Subtitles Platform Service Level Agreement (this “Agreement”, or this “SLA”) and the Tencent Cloud Service Agreement. This Agreement contains, among others, the terms and definitions of the Service, level indicators of the Service Availability or success rate, compensation plan and release of liabilities. Please carefully read and fully understand each and every provision hereof, and the provisions restricting or releasing certain liabilities, or otherwise related to your material rights and interests, are in bold font or underlined or otherwise brought to your special attention.**

**Please do not purchase the Service unless and until you have fully read, and completely understood and accepted all the terms hereof. By clicking “Agree”/ “Next”, or by purchasing or using the Service, or by otherwise accepting this Agreement, whether express or implied, you are deemed to have read, and agreed to be bound by, this Agreement. This Agreement shall then have legal effect on both you and Tencent Cloud, constituting a binding legal document on both parties.**

### 1.   Terms and Definitions

#### 1.1 The AI Multi-Language Video Transcription and Translation Subtitles Platform Service Provided by Tencent Cloud 

The Service provides you, among others, with subtitle transcription of audio and video files, multi-language translation of subtitles, and subtitle editing and embedding services by utilizing machine translation function, depending on your actual use.
...
#### 1.3 Downtime
Only the time of Service Unavailability that lasts for one minute continuously or longer shall be counted toward Downtime. Service Unavailability that lasts for shorter than one minute shall not be counted toward Downtime.

#### 1.4 Unavailability
The Unavailability of the Service means the Service is interrupted due to a problem with the equipment, the data center or the product functions of the Tencent Cloud Service, or an improper operation by Tencent Cloud itself. Otherwise, the Service Unavailability shall not be deemed to occur, and the corresponding time of interruption shall not be counted toward Downtime.

### 2.   Service Availability

#### 2.1  Calculation of Service Availability
Service Availability = (1 – Downtime within a Service Month / Total Service Time within a Service Month) × 100%

#### 2.2  Service Availability/Service Indicator Standard
**The Service Availability of the Service provided by Tencent Cloud will be no less than 99.99%.** You are entitled to the compensation as set forth in Section 3 of this Agreement if the Service Availability fails to meet the aforementioned standard, other than in any circumstance as provided in the Release of Liabilities provisions.

### 3.   Compensation Plan
In respect of the Service, if the Service Availability fails to meet the abovementioned standard, you will be entitled to compensations in accordance with the following terms:
...
(1) the username and email account for login used for the Service;
(2) the specific time period of Service Unavailability, accurate to minutes; 
(3) the screenshot of the page having problem(s), which must contain the error information.

### 4.   Release of Liabilities

**If the Service Unavailability results from any of the following reasons, the corresponding period of Service Unavailability shall not be counted toward Service Downtime, is not eligible for compensation by Tencent Cloud, and Tencent Cloud shall not be held liable to you:**
...
4.7 any use in a manner exceeding the maximum service capacity as specified by the current version for sale;

4.8 any Service Unavailability or failure to meet the Service Availability standard due to any reason not attributable to Tencent Cloud;
