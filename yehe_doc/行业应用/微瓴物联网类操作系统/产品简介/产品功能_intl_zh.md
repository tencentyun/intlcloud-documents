...
### 空间数字化
腾讯云微瓴为建筑搭建数据空间映射关系，将建筑内的设备、应用、服务、数据统一，以空间的维度搭建[ 数字孪生 ](https://intl.cloud.tencent.com/document/product/1115/43281)化的建筑，把各项终端作为数据的入口，空间作为数据沉淀与分享的平台，并联同物联能力形成一个空间、终端、数据三端可持续循环反哺的数据生态系统，让建筑演变成一个智慧空间，可以衍生出丰富标准的空间能力与空间服务。
