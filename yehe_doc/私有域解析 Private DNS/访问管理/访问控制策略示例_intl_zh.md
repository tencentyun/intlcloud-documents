...
请参考 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)，将预设策略 **QcloudPrivateDNSFullAccess** 授权给用户。
策略语法如下：
```
{
  "version": "2.0",
...
请参考 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)，将预设策略 **QcloudCVMInnerReadOnlyAccess** 授权给用户。
策略语法如下：
```
{
  "version": "2.0",
