...
本教程将指导您完成以下过程：启动一个腾讯云数据库 TencentDB 实例，通过腾讯云 CVM 配置一个 LAMP 应用程序，以连接腾讯云数据库 TencentDB 实例的高可用性环境。
...
3. 测试 Apache ：
>**注意：**
此步骤需要您的云主机在安全组中配置来源为 **all**，端口协议为 **TCP:80** 的入站规则。关于安全组的配置方法请参考 [安全组](https://cloud.tencent.com/document/product/213/12452)。
