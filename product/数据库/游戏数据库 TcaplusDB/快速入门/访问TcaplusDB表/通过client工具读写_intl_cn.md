...
确保您已经在 [腾讯云TcaplusDB](https://intl.cloud.tencent.com/product/tcaplus) 创建了游戏应用 App，并且已经获取对应的 App 信息（包括：AppId，ZoneId，AppKey）。当前 Tcaplus RESTful API 只支持通过 protobuf 定义的表。
