...
In the following example, you receive the following access point information and created a table tb_online in the deployment unit with the TableGroupID of 1.
