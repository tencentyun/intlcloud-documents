TencentDB for MongoDB monitoring provides multi-dimensional custom alarm features which will send alarms via SMS when metric data exceeds certain thresholds.
