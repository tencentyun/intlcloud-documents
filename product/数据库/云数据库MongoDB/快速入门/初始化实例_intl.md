After you successfully purchase a TencentDB for MongoDB instance, you can find it in the [Instance List](https://console.cloud.tencent.com/mongodb) on the console, as shown below.<br>
