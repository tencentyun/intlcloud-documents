## Operation Scenario
After you activate Tencent Cloud VOD, the system will assign you a default domain name `xxx.vod2.myqcloud.com`, which will be used by default for all resources of VOD. You can also add and resolve a custom domain name by logging in to the [VOD Console](https://console.cloud.tencent.com/video/cdnlog).
## Prerequisites
- You have successfully applied for the video service. For detailed steps, see [Purchase Process](https://cloud.tencent.com/document/product/266/2839).
- The domain name to be added has successfully obtained an ICP filing. For detailed steps, see [ICP Filing Application Process](https://cloud.tencent.com/document/product/243/18909).
...
It takes a few minutes to add a domain name. Please wait patiently. After the domain name is added, you can view its status, CNAME, and type in the domain name list.
