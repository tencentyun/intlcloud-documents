...
| Device subscription | Device subscription and subscription cancellation take effect immediately; for example, a device sends an SUB request to topic A, and if another message is sent to topic A later, the device can receive the message immediately |
...
| Offline messages and retention period | Up to 50 unconfirmed Qos=1 messages can be retained for 1 day |
