...
- You only need to configure the IoT Hub but not the China Telecom NB-IoT platform in order to achieve the features above.  
...
The application platform receives the pushed data through HTTP POST with the following body content:  
```
