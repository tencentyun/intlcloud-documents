...
Based on users’ management demand, categorized tags (used for filtering and classification) and notes of devices under the same product are supported to improve upper-layer applications’ device management.
