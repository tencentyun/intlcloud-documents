## 开通国际短信服务
 ...
 ### 登录腾讯云短信控制台
 登录腾讯云短信 SMS【[控制台](https://console.cloud.tencent.com/smsv2)】，首次登录短信 SMS 控制台需要申请开通短信服务。
 ...
 >2. 短信签名和模板提交后，我们会在半个工作日内完成审核，如有需求可设置常用手机和邮箱，用于即时接收该应用短信内容审核通知。发送Global SMS可不带签名，发送Mainland China SMS必须包含签名。
