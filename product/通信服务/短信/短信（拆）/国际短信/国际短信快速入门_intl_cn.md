本文以企业认证用户创建一个名为“TEST”的应用，并使用该应用向境外手机用户发送`[Tencent Cloud]Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`为例，帮助您了解如何快速使用国际/港澳台短信服务。更多短信相关的概念，请参见 [常用概念](https://cloud.tencent.com/document/product/382/13299)。

## 步骤1：开通短信服务
### 注册腾讯云账号
- 如果您还没有腾讯云账号，您需要 [注册腾讯云](https://cloud.tencent.com/document/product/378/17985) 账号。
