...
### VPN 连接的计费模式是什么？
- VPN 通道和对端网关免费。
- VPN 网关按月收费，单价已包含 IDC 带宽的费用，云服务器无需重复购买网络带宽。VPN 网关支持按量付费和按月付费两种计费模式。详情请参见 [ 计费概述](/document/product/215/4956?&_ga=1.243861126.2021346868.1522395796#.E8.AE.A1.E8.B4.B9.E6.A8.A1.E5.BC.8F)。
