...
### 加速流量费用
Anycast 弹性公网 IP 产生的流量，称为加速流量。我们对加速流量按带宽收费，单价高于普通公网网络。按一个账户下加速流量的总流量曲线进行95消峰后，按出和入高的方向进行收费，具体价格（单位：$USD/Mbps/月）如下：
<table style="width:525px;">
<thead>
<tr>
<th style="width:207px !important;padding:7px;heig29.33ht:45px;position:relative;font-weight:700;" valign="top">
...
<th style="font-weight:700;width:80px;text-align:center;">欧洲</29.33th>
</tr>
</thead>
<tbody>
<tr>
...
| **服务器所在地区** | **公网出入口所在地区** | **带宽用量（单位：Mbps）** | **价格（单位：$USD/Mbps/月）** |
| -------------- | ------------------ | --------------------- | ---------------------------- |
| 亚太           | 北美               | 10                    | 18.86                          |
| 亚太           | 中国大陆           | 100                   | 29.33                          |
| 欧洲           | 北美               | 200                   | 18.86                          |
...
最终收费 = 10 × 18.86 + 100 × 29.33 + 200 × 18.86 + 300 × 18.86 = 12551.6 ($USD)
