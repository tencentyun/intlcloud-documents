You can query monitoring information (outbound and inbound bandwidth, latency) of a Dedicated Tunnel via console or APIs. The console operations are as follows:
