...
| 专用通道 / 物理专线 | 20 个 | 否 |
| 专线网关 / 私有网络 | 1 个 | 否 |
| 本端 IP 转换 / 专线网关 | 100 条 | 是 |
| 对端 IP 转换 / 专线网关 | 100 条 | 是 |
| 本端源 IP 端口转换 IP 数 / 专线网关 | 20 个 | 是 |
| 本端目的 IP 端口转换 / 专线网关 | 100 条 | 是 |
...
- 本端源 IP 端口转换最大支持 100 个 IP 地址池，每个地址池支持最大 20 条 ACL 规则（如有需求，可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请提高配额）。
...
- 本端目的 IP 端口转换最大支持 100 个 IP 端口映射（如有需求，可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请提高配额）。
