...
### 如何设置跨地域互联告警？
用户可以进入 [腾讯云控制台](https://console.cloud.tencent.com/) 设置跨地域互联告警，详情请参见 [设置跨地域互联告警](/document/product/553/18851)。
### 如何删除对等连接？
用户可以进入 [腾讯云控制台](https://console.cloud.tencent.com/) 删除对等连接，详情请参见[ 删除对等连接](/document/product/553/18848)。
...
详情请参见 [同账号创建对等连接通信](/document/product/553/18836)。
