...
>路由表条目的状态有两种：
>- 若无网段冲突，则状态默认为【有效】。
>- 若与其他已有路由产生了冲突，则状态为【无效】。冲突规则及限制请参见 [使用限制 - 路由限制](/document/product/877/18679#.E8.B7.AF.E7.94.B1.E9.99.90.E5.88.B6 )。
>
>如果您需要使用无效路由，请参见 [停用路由](/document/product/877/18746) 和 [启用无效路由](/document/product/877/18750)。
