CDN 为您提供了两种计费模式： **带宽计费** 和 **流量计费**，您可以根据自身业务形态选择合适的计费模式。
...
<table  style="width:494px">
	<thead>
		<tr>
			<th scope="col" style="width: 100px;" rowspan="2">地域</th>
			<th scope="col" style="width: 200px;" colspan="2">带宽计费方式（USD/Mbps/日）</th>
		</tr>
		<tr>
			<th scope="col" style="width: 100px;">带宽阶梯</th>
			<th scope="col" style="width: 200px;">价格</th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<table  style="width:494px">
	<thead>
		<tr>
			<th scope="col" style="width: 100px;" rowspan="2">地域</th>
			<th scope="col" style="width: 200px;" colspan="2">流量计费方式（USD/GB）</th>
		</tr>
		<tr>
			<th scope="col" style="width: 100px;">流量阶梯</th>
			<th scope="col" style="width: 200px;">价格</th>
		</tr>
	</thead>
	<tbody>
...
## 大客户计费
若您已经在腾讯云，或未来预期在腾讯云的月消耗金额大于2万美元，您可以通过商务洽谈的方式获得更优惠的价格及月结等更加灵活的计费方式，欢迎 [提交工单](https://console.cloud.tencent.com/workorder/category/create?level1_id=83&level2_id=85&level1_name=%E5%AD%98%E5%82%A8%E4%B8%8ECDN&level2_name=%E5%86%85%E5%AE%B9%E5%88%86%E5%8F%91%E7%BD%91%E7%BB%9C%20%20CDN) 咨询更多详情。