...
**1. ****THE SERVICES AND APPLICATIONS.** The Services are further described at <http://intl.cloud.tencent.com>, and include: (a) the documentation for the Services (as may be updated from time to time) in the form generally made available by Tencent to its customers for use with the Services; (b) the APIs, mobile applications, and Software provided by Tencent in connection with the Services; and (c) any additional services purchased by you. The Services allow you to create applications using the Services or run applications on the Services ("**Applications**"). Applications include any source code written by you to be used with the Services or otherwise hosted on Tencent Cloud. 
...
**4. **USE OF SERVICES**
 ...
 (c)  <u>Service Regions</u>. Certain Services allow you to select a geographically defined service region in which User Data is stored in order to provide the Services (a "**Service Region**"). Where a Service Region applies, Tencent will, upon your request, store User Data in the Service Region you select when User Data is being used for the provision of those Services. However, notwithstanding the foregoing, Tencent may transfer and store User Data for backup purposes in a location other than the selected Service Region. In addition, you acknowledge that the Tencent contracting entity which is a party to these Terms may not be the entity in custody or control of User Data. If you use Services that do not require the selection of a Service Region, Tencent may process and store User Data in any location. If your selected Service Region is the PRC, then the PRC Service Region Terms below apply with respect to those Services for which the PRC is the selected Service Region.
 ...
 **8.**             **INTELLECTUAL PROPERTY RIGHTS AND USER DATA**
 ...
 (d) <u>User Data</u>. 
                 (i)        “**User Data**” means any data, information, media or other content submitted by you or your End Users to the Services, but excluding any data provided by Tencent or its Affiliates as part of your general Account.
...
​                      (v)        any person agrees to acquire or acquires the legal, beneficial or equitable ownership, directly or indirectly, of 50% or more of your capital stock or the equivalent right under contract to control your management decisions; or

​                      (vi)        Tencent, at its sole discretion, terminates its provision of or access to the Services (1) in your jurisdiction or industry sector or field of business, or (2) for all of its users or customers. 
...
​                      (i)        Upon termination of these Terms: (i) you will pay Tencent any Fees or other amounts owed under these Terms within thirty (30) days of termination, (ii) you will delete the Software and remove from the Services any Application and User Data; and (iii) upon Tencent’s request, you will use commercially reasonable efforts to return or destroy all Tencent Confidential Information. Tencent has no obligation to make accessible to you any User Data after the termination of these Terms.
