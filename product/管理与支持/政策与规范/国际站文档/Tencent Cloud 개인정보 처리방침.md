...
### 모듈
본 개인 정보 보호 정책의 [모듈](#modules) 섹션에 명시된 모듈은 귀하가 특정 기능 (각 관련 모듈에 정의된 대로) 을 사용하는 경우 적용되고, 본 개인 정보 보호 정책의 일부를 구성합니다. 귀하는 해당 모듈에 설명된 대로 당사가 귀하의 개인 정보를 수집, 처리, 사용 및 보관할 것임을 인정합니다. 더 자세한 내용은 아래 [모듈](#modules)을 참조하십시오.
...
| ------------------------------------- | ------------------------------------- | ------------------------------------- |
|소재지, 성명, 이메일 주소, IP 주소, 이용자 에이전트 (또는 웹 사이트 브라우저), 장치 ID 및 Tencent Cloud ID, 주소 (도시 및 우편 번호 포함)  |이 정보를 사용하여 다음을 수행합니다:· 귀하의 요청에 따라 Tencent Cloud 계정을 생성;· 비밀번호 재설정 허용;<br>· 이용자 지원 제공; 및</br><br>· 당사의 약관, 조건 및 정책 시행</br>      | 서비스 제공을 위해 귀하와 계약을 수행하는 데 필요하므로 이 정보를 처리합니다. |
|휴대폰 번호, 이메일 주소 [필수]  |당사는이 정보를 사용합니다:· Tencent Cloud 계정 확인;· 보안 보호를 위해 (계정 확인을 활성화하면 계정 비밀번호, 이메일 주소 등을 수정할 경우, SMS 알림 및 2단계 인증 코드를 보내는 데 사용됩니다.);· 제품 알림용;· 주문 확인 용; 및<br>· 서비스 정보 (예: 계좌 잔액 정보 및 계좌 잔액이 부족해지면 연락)</br>    |귀하의 신원을 확인하고 서비스에 대해 귀하와 소통하는 것은 당사의 정당한 이익입니다.  |
...
|문의 데이터 (웹 사이트 연락처 양식을 통해 또는 판매 문의의 일부로 문의서를 제출할 때 제공되는 데이터):<br>•귀하의 이름, 이메일, 회사명 및 비즈니스 서비스) [필수]</br><br>•전화 번호 및 위치 [선택사항]</br>  | 당사는 귀하의 요청에 응답하기 위해 이 정보를 사용합니다.  | 귀하의 요청에 응답하기 위해 필요한 이 정보를 처리하는 것은 당사의 정당한 이익입니다. |
...
각 개인 정보가 사용되는 유형에 대한 자세한 내용은 개인 정보 보호 정책의 주요 부분에 있는 이 차트를 참조하십시오.
...
언제든지 계정 포털에서 일부 데이터에 액세스하고 수정할 수 있습니다. 귀하는 당사가 처리하는 정보 중에서 귀하와 관련된 다른 개인 정보가 있다고 생각하거나 부정확한 정보를 수정할 수 없는 경우에는 cloudlegalnotices@tencent.com으로 연락하여 이를 요청할 수 있습니다. 귀하는 또한 특정한 개인 정보의 사본을 받을 권리도 있습니다 (아래 이동성 참조). 싱가포르 법률에 따라 귀하은 귀하의 데이터를 삭제할 법률적 권리가 없지만, 당사는 귀하가 요청할 경우 귀하의 데이터를 삭제할 수 있습니다.
...
귀하는 태국 개인 정보 보호법 등 해당 데이터 개인 정보 보호법 및 규정에서 규정한 범위 내에서 당사가 보관한 귀하의 모든 개인 정보의 사용 또는 제공을 중단, 제한 및/또는 데이터 이동을 요청할 수 있습니다. 이러한 요청을 하려면 cloudlegalnotices@tencent.com으로 문의하십시오.
