...
데이터 컨트롤러 (Data Controller) (EEA, UK 및 스위스 이외): [서비스 약관](https://intl.cloud.tencent.com/document/product/301/9248).에 규정된 바와 같이 귀하와 계약을 체결한 업체
...
-   **제3자로부터 당사가 입수하는 정보**. Tencent Cloud를 통해 이용자 계정의 관리자가 접근권을 결정할 수 있습니다. 그렇게 함에 있어서, 귀하가 사용하는 본 서비스의 관리자 (귀하일 수도 있음) 는 본 서비스에 접근하는 다른 사람의 이메일 주소를 그 계정 아래로 포함시킬 수 있습니다. 귀하가 계정 관리자인 경우, 귀하는 관련된 그 개인의 이메일 주소를 이러한 목적으로 제공하는데 대해 그 개인의 동의를 받았다는 것을 인정하고 당사에게 이를 보증하는 것입니다.

당사는 귀하가 Tencent와 소통할 때마다, 예컨대, 귀하가 이메일로 당사와 연락을 취할 때, 새로운 본 서비스를 활성화할 때, 또는 당사 웹 사이트에 있는 서식을 완료할 때, 귀하의 정보를 수집하고 보관합니다. 당사는 귀하가 구매하는 본 서비스에 대한 정보, 예컨대 인증 코드, 구매 날짜 및 지원 문제와 관련된 정보와 같은 정보를 보관합니다.

#### 쿠키

당사는 본 서비스에 대한 귀하의 사용 경험을 향상시키기 위해 쿠키 및 기타 유사한 기술 (예, 웹비콘, 플래쉬 쿠키 등) (이하 “쿠키” 라 한다)을 사용합니다. 쿠키는 작은 파일로서, 그것이 귀하의 장치에 설치되면, 당사가 소정의 기능과 기능성을 제공할 수 있게 됩니다.

귀하는 그러한 쿠키의 설치를 허용하거나 나중에 작동을 중지시킬 수 있는 옵션이 있습니다. 귀하는 모든 쿠키를 수락하거나, 또는 쿠키 설치 시 통지하도록 웹 브라우저에 지시하거나, 또는 귀하의 컴퓨터 웹 브라우저에 있는 관련기능을 조정하여 모든 쿠키의 수락을 거부할 수도 있습니다. 그러나 쿠키 설치를 거부하는 경우, Tencent Cloud는 귀하가 사용할 수 있는 본 서비스 중 일부를 제공하지 못할 수 있습니다.

당사가 사용하는 쿠키에 대해 보다 상세한 정보를 원하시면, 당사의 [쿠키 정책](https://intl.cloud.tencent.com/document/product/301/17346)을 참조하십시오.

#### 아동

당사의 서비스는 아동들을 위한 것이 아닙니다. 아동은 어떠한 목적으로도 본 서비스를 이용하지 않아야 합니다. 당사는 만 16세 미만의 미성년자가 당사의 서비스에 등록하고/하거나 어떤 개인 식별정보도 제공하는 것을 절대로 허용하지는 않습니다. 귀하가 만 16세 미만이라면, 당사의 서비스를 이용하기 위해 가입하거나 또는 본 서비스를 통해 귀하 자신에 대한 정보를 제공하지 마십시오.

### 당사가 귀하의 개인정보를 이용하는 방법

당사는 다음과 같은 방법으로, 다음과 같은 법적 근거에 따라 정보를 이용합니다.

| 개인정보 |이용 목적| 처리의 법적 근거(EEA 및 UK에만 해당) |
| ------------------------------------- | ------------------------------------- | ------------------------------------- |
|소재지, 성명, 이메일 주소, IP 주소, 이용자 에이전트 (또는 웹 사이트 브라우저), 장치 ID 및 Tencent Cloud ID, 주소 (도시 및 우편 번호 포함)  |이 정보를 사용하여 다음을 수행합니다:· 귀하의 요청에 따라 Tencent Cloud 계정을 생성;</br>· 비밀번호 재설정 허용;· 이용자 지원 제공; 및</br>· 당사의 약관, 조건 및 정책 시행</br>      | 서비스 제공을 위해 귀하와 계약을 수행하는 데 필요하므로 이 정보를 처리합니다. |
|휴대폰 번호, 이메일 주소 [필수]  |당사는이 정보를 사용합니다:· Tencent Cloud 계정 확인;· 보안 보호를 위해 (계정 확인을 활성화하면 계정 비밀번호, 이메일 주소 등을 수정할 경우, SMS 알림 및 2단계 인증 코드를 보내는 데 사용됩니다.);</br>· 제품 알림용;· 주문 확인 용; 및<br>· 서비스 정보 (예: 계좌 잔액 정보 및 계좌 잔액이 부족해지면 연락)</br>    |귀하의 신원을 확인하고 서비스에 대해 귀하와 소통하는 것은 당사의 정당한 이익입니다.  |
|사진 신분증 (예, 운전면허증 또는 여권) 성명, 주소[필수]   |서비스를 위해 중국 (홍콩 (중국), 마카오 (중국) 및 대만(중국) 제외) 에 위치한 서버를 사용하기로 선택한 경우, 당사는 귀하의 사진 신분증 (또는 귀하가 기업 고객인 경우 기업 문서) 을 사용합니다. 귀하의 계정이 현지 법률에 따라 합법적으로 확인되었는지 확인합니다.   |법률적 요구 사항이 필요한 관할 지역에서 사용할 수 있도록 서비스를 활성화할 수 있도록 이러한 데이터를 처리하는 것은 당사의 정당한 이익입니다.  |
|신용 카드 정보 (카드 번호, 이름, 유효 기간, 보안 코드) [필수]   |당사는 귀하의 신용 카드 정보를 사용하여 서비스 사용에 대한 귀하의 결제를 처리합니다.  |당사는 서비스에 대한 결제를 용이하게 하기 위해 귀하와의 계약을 이행하는 데 필요하므로 이 정보를 처리합니다.  |
|거래 기록 (예: 서비스 결제 날짜 및 시간) [필수]   |거래 기록을 볼 수 있도록 거래 기록에 대한 액세스를 제공합니다.   |당사는 서비스와 관련하여 결제를 관리하기 위해 귀하와 계약을 수행하는 데 필요하므로 이 정보를 처리합니다.  |
|로그 데이터, 메타 데이터, IP 주소, 이용자 티켓, 이용자 에이전트, 접속 날짜 및 시간, Tencent Cloud 웹 사이트 내 각각의 URL 방문 (직접 또는 제3자 웹 사이트에서 참조를 한 것인지 여부는 불문), [선택 사항]    |당사는 이 정보를 전략 및 서비스 개선 및 분석에 사용합니다.   |당사의 전략과 서비스를 개선하는 것은 우리의 정당한 이익입니다.   |
|고객 서비스 티켓/채팅 콘텐츠, IP 주소, Tencent Cloud ID, 사고 세부 정보 및 대응 단계 [필수]   |이 정보를 사용하여 다음을 수행합니다. · 서비스에 대한 귀하의 우려와 불만을 처리합니다. · 문제 해결, 데이터 분석, 테스트, 연구, 통계 및 조사 목적을 포함한 내부 운영 및 서비스를 개선 및 관리하고 서비스를 안전하고 완벽하게 유지합니다.   |당사의 서비스를 개선하고 귀하에게 제공된 서비스와 관련하여 지원을 제공하는 것은 당사의 정당한 이익입니다.  |
|사고와 관련된 로그 및 메타 데이터 [선택사항]  |당사는 서비스 및 대응을 개선하기 위해 이 정보를 사용합니다.   | 당사의 서비스 및 대응을 개선하는 것은 당사의 정당한 이익입니다.  |
|문의 데이터 (웹 사이트 연락처 양식을 통해 또는 판매 문의의 일부로 문의서를 제출할 때 제공되는 데이터):</br>•귀하의 이름, 이메일, 회사명 및 비즈니스 서비스) [필수]</br>•전화 번호 및 위치 [선택사항]</br>  | 당사는 귀하의 요청에 응답하기 위해 이 정보를 사용합니다.  | 귀하의 요청에 응답하기 위해 필요한 이 정보를 처리하는 것은 당사의 정당한 이익입니다. |
|프로모션 연락처 데이터: 이름, 이메일, 전화 번호, 비즈니스 서비스 및 업종 [선택사항]  | 당사는 이 정보를 사용하여 제품과 서비스를 귀하에게 홍보합니다.  | 당사는 귀하의 동의 하에 이 정보를 처리합니다. 이 동의는 언제든지 철회할 수 있습니다. |
|마케팅 데이터: 이름, 비즈니스 이메일, 전화 번호, 회사명, 국가/지역, 산업 및 직위 [필수].  | 이 정보를 다음과 같이 사용합니다:·온라인 이벤트 및 웹세미나에 귀하를 예약·제품 알림용 및·주문 확인용.  | 당사는 귀하의 동의 하에 이 정보를 처리합니다. 이 동의는 언제든지 철회할 수 있습니다. |
|이름, 이메일 주소, 국가 코드, 전화 번호, 회사명, 비즈니스 서비스, 문의 [필수].  | 이 정보를 다음과 같이 사용합니다:· COVID-19 클라우드 리소스 지원 프로그램용 애플리케이션을 처리하기 위해· 당사 제품에 대한 요청에 응답하기 위해· 제품 알림용 및· 주문 확인용. | 당사는 지원을 제공하기 위해 귀하와의 계약에 따라 이 정보를 처리합니다. | 



### 당사가 귀하의 개인정보를 공유하고 보관하는 방법
...
-   **관련 그룹회사** [**제3자**](https://intl.cloud.tencent.com/services/thirdParties) 페이지에 나열된 업체를 포함합니다. 당사의 서비스를 운영하기 위해 당사는 귀하의 개인정보를 이 회사들과 공유합니다.
...
-   **법 집행기관, 공공기관 또는 그 밖의 사법 기관 및 단체.** 당사는 법률상 정보를 공개해야 하는 경우, 또는 다음 각 호에 해당하여 그러한 정보의 이용이 합리적으로 필요하다고 당사가 신의성실로써 판단하는 경우에 정보를 공개합니다.
    ...
    -   법에서 요구하거나 허용하는 바에 따라, 당사나 당사의 이용자, 제3자 또는 일반 공중의 권리, 재산 또는 안전을 보호하기 위해 (사기 방지 및 신용위험 감소를 목적으로 다른 회사 및 기관과 정보를 교환하는 경우 포함)및

-   **당사 또는 당사의 사업의 전부나 실질적인 전부를 인수하는 제3자.** 당사는 당사가 사업을 양도 또는 양수하는 경우나 합병을 하는 때에는 제3자에게 정보를 공개할 것이며, 이 경우 당사는 귀하의 데이터를 잠재적인 양수인에게 공개할 것입니다. 당사는 당사가 다른 회사나 사업을 양도, 양수, 합병 또는 그러한 회사나 사업체와 제휴를 하는 경우나, 당사의 자산 중 일부나 전부를 양도하는 경우에도 정보를 제3자에게 공개할 것입니다. 이러한 거래에서는, 이용자 정보는 이전된 자산 중에 포함될 수도 있습니다.
...
| **정보**                                                     | **보존** **기간**                                            |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 위치, 이메일 주소, 비밀번호, IP 주소, 이용자 에이전트(또는 웹 사이트 브라우저), 장치 ID, Tencent Cloud ID, 인증코드, 휴대폰 번호, 이름, 주소(도시 및 우편번호 포함) | **계정** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
|신용 카드 정보 (카드 번호, 이름, 유효 기간, 보안 코드) | **계정** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
| 거래 기록                                                    | **결제** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 90일 이내에 정보가 말소됩니다. |
| 사진 신분증 (예, 운전면허증 또는 여권) 성명, 주소 | **계정** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
| 로그 데이터, 메타 데이터, IP 주소, 이용자 에이전트, 접속 날짜 및 시간, Tencent Cloud 웹 사이트 내에서의 각각 URL 방문 (직접 방문 또는 제3자 웹 사이트에서 참조를 한 것인지 여부는 불문) | **본** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
| 고객 서비스 티켓/채팅 컨텐츠, IP 주소, Tencent Cloud ID, 사고 세부 내역 및 대응 조치 | **본** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 24시간 이내에 정보가 말소됩니다. |
| 사고와 관련된 로그 및 메타 데이터                            | **본** **데이터는** **계정이** **현존하는** **동안** **보존**됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
| 문의 데이터 (귀하가 당사 웹 사이트 연락 서식을 통해서, 또는 귀하의 성명, 이메일 및 전화번호를 포함하는 문의서를, 판매 문의의 일환으로 제출할 때에 제공되는 데이터) | **문의** **데이터는** **문의사항이** **해결될** **때까지** **보존**되며, 그와 같이 해결된 때로부터 180일 이내에 말소됩니다. 단, 귀하가 본 데이터를 보존하도록 하고 장래에 더 많은 정보를 받기로 동의하는 경우에는 예외로 합니다. |
|프로모션 연락처 데이터: 이름, 이메일 및 전화 번호              |이러한 데이터는 귀하가 더 이상 홍보 정보를 받기를 원하지 않는다고 당사에게 말할 때까지 보존됩니다.   |
| 마케팅 데이터: 이름, 이메일 및 전화 번호, 회사명, 국가, 산업 및 직위.                     | 이러한 데이터는 귀하가 **더** **이상** **홍보** **정보를** **받기를** **원하지** **않는다고** **당사에게** **말할** **때까지** **보존**됩니다. |
...
**당사가 귀하의 개인정보를 처리하는 방법에 대해 귀하가 민원을 제기하고자 하는 경우, 우선적으로 <cloudlegalnotices@tencent.com>으로 당사의 개인정보 보호책임자에게 연락하시면 당사는 가급적 조속히 귀하의 요청사항을 처리하도록 노력하겠습니다. 이렇게 하더라도, 귀하가 생각하기에 당사가 데이터 보호법을 침해했다고 생각하는 경우, 귀하가 거주하거나 근무하는 EU 국가의 데이터 보호 감독당국에 민원을 제기할 수 있는 귀하의 권리는 침해되지 않습니다.**
...
귀하는 해당 법률이 제공하는 범위 내에서 다음과 같은 권리를 가질 수 있습니다.
 ...
 - *삭제 또는 차단할 권리*. 귀하는 당사의 파일 시스템에서 귀하의 개인 정보를 차단, 제거 또는 파기하는 것을 중지, 철회 또는 명령할 권리가 있습니다.</br>
...
6.[안면 인식](https://intl.cloud.tencent.com/document/product/1059/38786).
