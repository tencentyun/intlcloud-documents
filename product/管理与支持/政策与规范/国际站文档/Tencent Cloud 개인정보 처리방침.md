...
| 사진 신분증 (예, 운전면허증 또는 여권) 성명, 주소 | <u>**계정** **데이터는** **계정이** **현존하는** **동안** **보존**</u>됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
| 로그 데이터, 메타 데이터, IP 주소, 이용자 에이전트, 접속 날짜 및 시간, Tencent Cloud 웹 사이트 내에서의 각각 URL 방문 (직접 방문 또는 제3자 웹 사이트에서 참조를 한 것인지 여부는 불문) | <u>**본** **데이터는** **계정이** **현존하는** **동안** **보존**</u>됩니다. 계정이 삭제된 날로부터 30일 이내에 정보가 말소됩니다. |
...
특정 기능 (각 관련 모듈에 정의된 대로) 을 사용할 경우, 다음 모듈이 이 개인 정보 보호 정책에 적용되고 일부가 구성되어야 합니다. 귀하는 당사가 해당 모듈에 설명된 대로 귀하의 개인 정보를 수집, 처리, 사용 및 보관한다는 것을 인정합니다.</br>

1.[Tencent 푸시 알림 서비스](https://intl.cloud.tencent.com/ko/document/product/1024/36175).</br>
