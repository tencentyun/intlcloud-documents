...
Besides, roles can be used by role-enabled Tencent Cloud products and services. To find out whether a Tencent Cloud product or service supports service roles, see [Cloud Services Supporting CAM](https://cloud.tencent.com/document/product/598/10588).
