...
The enterprise account CompanyExample directly authorizes the preset policies QcloudCLBFullAccess and QcloudCLBFinanceAccess to the sub-account Developer. For more information on authorization, please see [Authorization Management](https://intl.cloud.tencent.com/document/product/598/10602).
