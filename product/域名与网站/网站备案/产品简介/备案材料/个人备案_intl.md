...
| Item | Note |
| ------------------ | ------------------------------------------------------------ |
| Domain name certificate | In Hunan, Guizhou, Jiangsu, Shaanxi, Shandong (if more than 4 domain names are submitted at a time) and Henan (if more than 10 domain names are submitted at a time), individual applicant shall provide domain name certificate. |
...
| Website construction proposal | In Guangdong, if the individual applicant has already obtained ICP filing for more than 10 websites, a website construction proposal shall be submitted when applying for ICP filing for new websites. |
