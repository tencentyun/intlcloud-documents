...
### 一台服务器能否进行多次备案？
能但是有限制。目前一个腾讯云账号只能有一个主体的备案信息，如需使用同一服务器办理其他主体的备案，您可以利用备案授权码进行备案。
...
### 试用期的云服务器能否备案？
请根据您的试用服务器的 [计费模式](https://intl.cloud.tencent.com/document/product/213/2180) 来判断能否备案。
- 按量计费的云服务器，不支持备案。
...
### 同一台服务器能否进行多主体备案？
目前限制一个腾讯云账号只能有一个主体的备案信息（主体即为个人或单位）。如需使用同一服务器办理其他主体的备案，您可以利用备案授权码进行备案，使用方法参考[备案授权码常见问题](https://intl.cloud.tencent.com/document/product/1022/31688) 。
