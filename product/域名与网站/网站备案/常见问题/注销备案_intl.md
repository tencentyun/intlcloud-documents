...
- Yes, if the application has not been submitted to regulatory bureaus.
- No, if the application has already been submitted to regulatory bureaus.
...
> After the transfer is canceled, if you don't switch to another access provider promptly, the ICP filing of the website may be deregistered by regulatory bureaus. 
