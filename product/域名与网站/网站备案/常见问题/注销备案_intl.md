...
When you submit an application for ICP filing deregistration through Tencent Cloud, you need to provide the correct ICP filing password. Communication Administration Bureaus' system will review the application and complete the deregistration process automatically within 3 to 20 business days. 
...
- Yes, if the application has not been submitted to the Communication Administration Bureaus.
- No, if the application has already been submitted to the Communication Administration Bureaus.
...
> After the transfer is canceled, if you don't switch to another access provider promptly, the ICP filing of the website may be deregistered by the Communication Administration Bureaus. 
