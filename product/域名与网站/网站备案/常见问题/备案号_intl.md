...
1. The ICP filing entity proactively applied for ICP filing deregistration directly to the competent authority or through the access provider.         
...
3. The website information is false or inaccurate, or some information is missing in the ICP filing, and if the access provider cancels the access, the competent authority will perform deregistration.    
 ...
 - The website information is false or incorrect, for example, the owner's phone number has been changed or canceled, and if this is found during the spot checks by the competent authority or MIIT, deregistration will be performed.  
