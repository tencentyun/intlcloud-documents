...
## 2. Input Parameters
The following request parameter list only provides the API request parameters. Common request parameters are required when the API is called. For more information, see [Common Request Parameters](https://intl.cloud.tencent.com/document/api/377/4153) page. The Action field for this API is CertUpload.
...
The "data" parameter contains the number of domain names under the account as well as the list of domain names.
