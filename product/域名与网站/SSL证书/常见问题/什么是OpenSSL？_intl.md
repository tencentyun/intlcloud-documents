...
Official download URL: https://www.openssl.org/source/

#### 2. Installation Method on Windows

The installation package for Windows is not available on OpenSSL website. You can use tools provided by other open source platforms, for example: http://slproweb.com/products/Win32OpenSSL.html 
...
2.4 After www.domain.com.pfx is generated in D:\, you can continue to complete the certificate installation in IIS Manager.
