...
腾讯云账号和 DNSPod 帐号是互通的，目前域名都统一在域名服务控制台中查看。

### 域名注册成功后如何开具发票？
域名注册成功后，如需开具发票可以参考如下操作：
1. 登录腾讯云【控制台】>【费用】>【费用中心】>[【发票管理】](https://console.cloud.tencent.com/account/invoice) 中，填写发票信息和邮寄信息；
...
### 目前域名付费支持那些支付方式？
腾讯云目前支持的支付方式有：Paypal,  Credit Card支付，线下打款。

### 域名转出有什么要求？
如果您需要做域名转移操作，请您使用在腾讯云注册该域名的账号，在域名服务页面申请域名转出就可以获得转移密码，但是域名转出需要域名注册满 60 天才可以申请，如果是新注册未满 60 天的域名，建议您耐心等待。
...
### 域名一次性最多可以购买几年？
根据 ICANN 规定，域名最高可以购买 10 年，第 1 年我们收取的是首次注册的费用，第 2 年到第 10 年是按照续费的价格收取的。
