...
>4. 中国国内域名 .cn / .com.cn / .net.cn / .ac.cn / .中国 注册成功后 5 天内必须实名认证，否则域名会处于锁定状态无法正常使用，待实名审核通过后，1-2 个工作日恢复正常状态。
...
在实名认证页面，您首先需要确认域名信息：在注册域名的时候已经填写了域名信息，如果您想修改域名信息，单击【更改】即可，然后提交域名认证资料，上传身份证正面件扫描件（营业执照正面件扫描件），核对下系统自动补充的证件号，再单击【提交】。
