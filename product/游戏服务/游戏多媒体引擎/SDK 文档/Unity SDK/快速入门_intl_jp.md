## 概要		
 ...
 Tencent Cloudゲームマルチメディアエンジン（GME）SDKへようこそ。Unity開発者がTencent Cloud GME製品のAPIを容易にデバッグして導入するために、ここでUnity開発のためのクイック導入文書を紹介します。		
...
```		
 ...
 | key    		|string 	|Tencent Cloudコンソールからの暗号鍵				|	
