iOS 개발자가 Tencent Cloud GME API를 디버깅하고 연결하는 데 도움이 되도록 여기에 iOS 개발에 적합한 액세스 기술 문서를 소개합니다.
...
### 백 엔드 재생 소리 설정
백 엔드 재생 소리 설정, 방 입장 전에 호출합니다.
그 밖에 응용프로그램은 아래 2가지 사항을 주의해야 합니다.
- 백 엔드로 전환 시 오디오 엔진의 캡처와 재생이 일시 중지(PauseAudio)되지 않습니다.
