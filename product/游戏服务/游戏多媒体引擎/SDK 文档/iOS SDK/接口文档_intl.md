## Overview
This article is a detailed description with the purpose of helping iOS developers debug and access APIs for Tencent Cloud's Game Multimedia Engine (GME).
