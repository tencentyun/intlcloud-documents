This document provides an overview that makes it easy for mini program developers to debug and integrate the APIs for Tencent Cloud's Game Multimedia Engine (GME).
