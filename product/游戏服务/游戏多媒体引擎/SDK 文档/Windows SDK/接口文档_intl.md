## Overview
This article talks about integration for Windows in detail to help Windows developers debug and integrate APIs for Tencent Cloud's Game Multimedia Engine (GME). 
