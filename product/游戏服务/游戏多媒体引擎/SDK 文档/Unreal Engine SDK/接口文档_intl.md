...
For the user who enters a room in a team chatting mode without involving range voice, use the API for entering a room in team chatting mode. For more information, see [Range Voice](https://cloud.tencent.com/document/product/607/17972).
