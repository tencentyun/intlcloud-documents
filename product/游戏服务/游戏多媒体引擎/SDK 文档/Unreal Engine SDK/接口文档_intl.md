...
For the user who enters a room in a team chatting mode without involving range voice, use the API for entering a room in team chatting mode. For more information, see [Range Voice](https://intl.cloud.tencent.com/document/product/607/17972).
...
This API is used to add an ID to the audio data blacklist. A returned value of 0 indicates the call is successful.
#### Function prototype  
