This getting started article is trying to help Windows developers debug and integrate APIs for Tencent Cloud's Game Multimedia Engine (GME). 
...
This API is used to generate AuthBuffer for encryption and authentication. For more information on about deployment at the backend, see [Authentication Key](https://intl.cloud.tencent.com/document/product/607/12218).  
