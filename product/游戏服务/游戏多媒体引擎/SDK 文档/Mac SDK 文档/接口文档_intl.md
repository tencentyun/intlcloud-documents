## Overview
This article talks about integration for Mac in detail to help Mac developers debug and integrate APIs for Tencent Cloud's Game Multimedia Engine (GME).
...
This API is used to enable/disable the audio sending. Enable means sending the captured. 
