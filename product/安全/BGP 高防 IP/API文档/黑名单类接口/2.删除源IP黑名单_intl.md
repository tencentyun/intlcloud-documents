...
## API Description
This API (RemoveSrcBlackIP) is used to remove one or more IPs from the blacklist of an Anti-DDoS service pack.
Protocol: `HTTPS`
Domain Name: `bgpip.api.qcloud.com`
`RemoveSrcBlackIP`

## Request Parameters
The following request parameter list only provides the API-specific request parameters. Common request parameters are required when the API is called. For more information, see [Common Request Parameters](https://cloud.tencent.com/document/product/1014/31224). The Action field for this API is `RemoveSrcBlackIP`.
