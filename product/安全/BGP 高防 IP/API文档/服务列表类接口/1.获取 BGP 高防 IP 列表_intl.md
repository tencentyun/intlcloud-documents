...
## API Description
This API (BGPIPGetServicePacks) is used to get a list of all Anti-DDoS Advanced service packs of the user. 
Protocol: `HTTPS`
...
|---------|---------|---------|---------|
| filtering. name | No | String | Search by the name of the Anti-DDoS Advanced service pack. Fuzzy search is supported. |
| filtering.ip | No | String | Search by the IP of the Anti-DDoS Advance service pack. Fuzzy search is supported. |
...
| elasticLimit | 10000| Integer | Unit: Mbps. Upper limit of the elastic protection bandwidth. The Anti-DDoS Advance IP will be blocked when this limit is exceeded. |
