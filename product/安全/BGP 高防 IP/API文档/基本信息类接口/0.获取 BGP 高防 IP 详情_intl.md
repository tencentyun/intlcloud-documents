...
## Request Parameters
Below is a list of API request parameters. Common request parameters need to be added to your request when calling the API. For more information, see [Common Request Parameters](https://cloud.tencent.com/document/product/1014/31224). The Action field for this API is `BGPIPGetInfo`.
...
| elasticLimit | 10000| Integer | Unit: Mbps. Upper limit of elastic protection bandwidth. The Anti-DDoS Advanced IP will be blocked in case this limit is exceeded. |
