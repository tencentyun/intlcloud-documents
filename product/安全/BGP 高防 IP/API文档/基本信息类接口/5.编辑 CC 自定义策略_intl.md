...
## API Description
This API (EditCustomCCStrategy) is used to edit a custom CC protection policy. The policy can be edited only when CC protection is enabled for the Anti-DDoS Advanced instance. This API is identified by field **bgpId** and **name**, and overwrites the existing policy.
Protocol: `HTTPS`
