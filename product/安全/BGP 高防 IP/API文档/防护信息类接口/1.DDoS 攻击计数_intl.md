...
## API Description
This API (BGPIPDDoSGetCounter) is used to get the detailed information of DDoS attacks against an Anti-DDoS Advanced IP, including total attack count, attack peak, and the number of times the elastic protection is enabled.
Protocol: `HTTPS`
