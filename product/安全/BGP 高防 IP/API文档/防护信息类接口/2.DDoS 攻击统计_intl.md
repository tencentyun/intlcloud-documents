...
|---------|---------|---------|---------|
| before | [1,000 Mbps,…] | Array | Attack traffic peak before protection enabled, i.e. the maximum traffic in each stride. For example, if duration is 5 minutes, the result is the maximum attack traffic within 5 minutes. |
| after | [50 Mbps,…] | Array | Cleaned traffic peak after protection enabled, i.e. the maximum traffic in each stride. For example, if the duration is 5 minutes, the result is the maximum cleaned traffic within 5 minutes. |
