...
| transRules | [obj,…] | Array | Attack details. Elements in the arrays: <pre>{</br>"id": "rule-00000001",</br>"protocol": "TCP" </br>"virtualPort": "80",</br>"sourcePort": "80",</br>"ipList": "10.2.3.4；10.1.1.1"</br>}</pre>. |
