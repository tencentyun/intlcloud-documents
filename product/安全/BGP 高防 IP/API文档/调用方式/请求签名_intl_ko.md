...
| 4101 | API에 접근 권한 없음 | 해당 서브 사용자가 이 API를 호출할 권한을 부여받지 않았습니다. 개발사에게 연락하여 권한을 부여하도록 요청하십시오. 세부 정보는 [권한 부여 전략](https://cloud.tencent.com/document/product/598/10601)을 참조하십시오.|
| 4102 | 본 API에서 조작된 리소스에 접근 권한 없음 | 요청한 리소스 매개변수 중, 개발사에 의해 접근 권한을 부여받지 않은 리소스가 존재합니다. message 필드에서 접근 권한이 없는 리소스 ID를 확인하십시오.</br>개발사에게 연락하십시오. 세부 정보는 [권한 부여 전략](https://cloud.tencent.com/document/product/598/10601)을 참조하십시오.|
