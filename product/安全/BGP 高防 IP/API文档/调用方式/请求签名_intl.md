...
| 4101 | No access to this API | The sub-user is not authorized to call the API. Contact the developer for authorization. For more information, see [Authorization Policy](https://cloud.tencent.com/document/product/598/10601). |
