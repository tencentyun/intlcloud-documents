...
1. Select the game project on the left navigation bar "Project Explorer" in Eclipse, right-click the mouse, select "Properties" in the pop-up menu, then select "Java Build Path" on the left navigation bar of the "Properties" window, and click "Add JARs" in "Libraries" to add tp2.jar.
