...
### CIFS/SMB 文件系统
SMB（Server Message Block）协议是微软推出的，用于访问网络中文件、打印机和其他共享网络资源的应用层通信协议；而 CIFS(Common Internet File System) 协议则是公共的或开放的 SMB 协议版本。CIFS/SMB 文件系统可以更好的支持 Windows 客户端的访问。
