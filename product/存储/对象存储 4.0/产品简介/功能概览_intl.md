Before using COS, read [Basic Concepts](https://intl.cloud.tencent.com/document/product/436/6225?!preview&!editLang=en) to learn the definitions of COS basic concepts including bucket, object, region, access domain name, etc.
...
| [Deleting Bucket](https://intl.cloud.tencent.com/document/product/436/30361) | To deleted a bucket, you first need to delete all objects in it and fragments in **Incomplete Upload**. |
...
| [Origin-pull Settings](https://intl.cloud.tencent.com/document/product/436/13310) | An origin server address is set to read the data requested by a request from the origin server in different ways, to meet the needs of hot migration of data and redirection of specific requests. |
...
| [Setting Cross Origin Resource Sharing](https://intl.cloud.tencent.com/document/product/436/13318?!preview&!editLang=en) | COS provides the CORS settings in the HTML5 standard. For this purpose, COS supports responding to OPTIONS requests and returning specific setting rules to browsers according to the rules set by developers. |
