...
CDN acceleration is used to speed up the download and delivery of content in COS buckets, especially in the scenarios where the same content is repeatedly downloaded.
...
1. Log in to the [COS Console](https://console.cloud.tencent.com/cos5), go to the **Bucket List** in the left pane, and then click the bucket (e.g. example) that you need to set the domain name to enter the bucket details page, as shown below: 
![](https://main.qcloudimg.com/raw/688c1dc518cb417461bc9d4645e4c41c.png)
...
4. Log in to the [CDN Console](https://console.cloud.tencent.com/cdn/access), go to **Domain Name Management** in the left pane, click **Management** for the domain name to be configured, and then select **Security Configuration**. Enter the authentication key and validity period, and then click **OK**, as shown below:
