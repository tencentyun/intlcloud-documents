...
## 设置步骤
1. 登录 [对象存储控制台](https://console.cloud.tencent.com/cos5)，进入左侧菜单栏【存储桶列表】，选择需要设置防盗链的存储桶（如 example-1250000000），进入存储桶。
...
3. 确认当前状态为开启，选择名单类型（黑名单或白名单），设置好相应域名，设置完成单击【保存】即可。
  ...
  ![防盗链设置2](https://main.qcloudimg.com/raw/6cd5d73cd869071d4b6d22c6db0c5091.png)
