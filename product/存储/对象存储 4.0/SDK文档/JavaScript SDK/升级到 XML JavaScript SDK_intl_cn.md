...
如果您仍然采用后台手动计算签名，再返回前端使用的方式，请注意我们的签名算法发生了改变。签名不再区分单次和多次签名，而是通过设置签名的有效期来保证安全性。请参考 [XML 请求签名](https://intl.cloud.tencent.com/document/product/436/7778) 文档更新您签名的实现。
