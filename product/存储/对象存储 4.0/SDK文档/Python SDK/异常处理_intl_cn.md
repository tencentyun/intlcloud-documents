...
| status_code   | response 的 status 状态码，更多详情请参阅 [COS 错误码](https://intl.cloud.tencent.com/document/product/436/7730) | string |
| error_code    | 请求失败时 body 返回的 Error Code，更多详情请参阅 [COS 错误码](https://intl.cloud.tencent.com/document/product/436/7730) | string |
| error_msg | 请求失败时 body 返回的 Error Message，更多详情请参阅 [COS 错误码](https://intl.cloud.tencent.com/document/product/436/7730) | string |
