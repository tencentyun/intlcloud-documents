...
Calculate the message digest using [HMAC-SHA1](#preparations) with [SignKey](#generating-signkey) as the key and [StringToSign] as the message, which is the Signature.
