...
Calculate the message digest using [HMAC-SHA1](#preparations) with [SignKey](#generating-signkey) as the key and [StringToSign](https://intl.cloud.tencent.com/document/product/436/7778#generating-stringtosign) as the message, which is the Signature.
