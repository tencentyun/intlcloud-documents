...
|:---|:-- |:--|:--|
| AccessControlPolicy | None | Container for saving results of Get Bucket ACL | Container |

Content of Container node AccessControlPolicy:

| Node Name (Keyword) | Parent Node | Description | Type |
|:---|:-- |:--|:--|
| Owner | AccessControlPolicy | Information of Bucket owner |  Container |
...
| Node Name (Keyword) | Parent Node | Description | Type |
|:---|:-- |:--|:--|
| ID | AccessControlPolicy.Owner |  Bucket owner ID. </br>Format: qcs::cam::uin/&lt;OwnerUin&gt;:uin/&lt;SubUin&gt; in case of root account, &lt;OwnerUin&gt; and &lt;SubUin&gt; use the same value |  String |
| DisplayName | AccessControlPolicy.Owner | Name of Bucket owner |  String |

Content of Container node AccessControlList:

| Node Name (Keyword)          | Parent Node | Description                                    | Type        |
| ------------ | ------------------------------------- | --------- |:--|
| Grant | AccessControlPolicy.AccessControlList | A single Bucket authorization information entry. Each AccessControlList can contain 100 Grant entries | Container    |
