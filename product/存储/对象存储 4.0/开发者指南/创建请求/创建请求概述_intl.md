...
Tencent Cloud COS is a web-based storage service accessed using the HTTP/HTTPS protocol. You can use the REST API or [COS SDK](https://cloud.tencent.com/document/product/436/6474) to access COS.
...
To access COS using COS SDKs, you only need to configure your security credentials before initiating the request. To access COS using the REST API, calculate the request signature according to [Request Signature](https://cloud.tencent.com/document/api/436/7778) or generate one using the [COS Signature Tool](https://cloud.tencent.com/document/product/436/30442).
...
The [Region and Access Domain Name](https://cloud.tencent.com/document/product/436/6224) document provides a list of domain names that can be used to initiate access requests via the REST API.
