...
| [WeCOS to Slim Down Mini Programs ](/doc/product/436/8218) | This tool uploads image in Mini Programs to COS automatically, replaces image reference address with COS online address, and removes image resources from the project directory, reducing Mini Program size. |
