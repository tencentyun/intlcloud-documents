...
请求中的 Host 字段为 ${region}.cls.myqcloud.com 其中 region 字段为日志服务区域，例如北京区域填写 ap-beijing，上海区填写 ap-shanghai，完整区域列表格式参考[地域列表](https://cloud.tencent.com/document/product/614/18940)。
