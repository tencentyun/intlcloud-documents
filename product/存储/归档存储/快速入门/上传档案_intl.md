After creating a vault, you can upload an archive to it. For more information on archives, see [Concepts](https://cloud.tencent.com/document/product/572/8727).
...
## 2. Upload an archive
Click **Select Archives** to select one or more local files to upload on the pop-up page. You can also drag and drop the files to the upload area. You can enter archive descriptions as needed or delete unneeded archives in the list of archives to upload, and then click **Upload**.
