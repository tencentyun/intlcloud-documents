...
<td>The trial version only supports the Guangzhou, Shanghai and Beijing regions.
</td>
</tr>
<tr>
...
<td>The trial version only supports 0.1.0 (Spark 2.3.2, Hadoop 2.7.3, Hive 2.1.0).
</td>
</tr>
<tr>
<td>Master node</td>
<td>D1</td>
<td>The trial version supports selecting a Big Data D1 model with four types of configuration. Please select the memory and CPU core quantity of the master node as needed. </td>
</tr>
</table>
...
| Name | Meaning | Note |
| ------------ | ------------------ | ------------------------------------------------------------ |
| Core compute node | Responsible for the cluster's storage tasks | The trial version supports selecting a Big Data D1 model with four types of configuration. You can select the memory and CPU core quantity of the node as needed. |
| Elastic compute node | Responsible for the cluster's computation tasks | The trial version supports selecting a MEM Optimized model with various types of configuration. You can select the memory and CPU core quantity of the node as needed. |
