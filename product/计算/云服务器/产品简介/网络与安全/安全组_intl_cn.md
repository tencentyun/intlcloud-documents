...
### 快速入门
[安全组](https://intl.cloud.tencent.com/document/product/213/12452) 是腾讯云提供的实例级别防火墙，可以对任意云服务器进行入/出流量控制。
...
## 安全组云 API
安全组的开发者工具，您可通过云 API 来完成安全组操作、安全组与 CVM 实例的配置管理等，详见 [安全组相关接口](https://intl.cloud.tencent.com/document/api/213/15689) 。
