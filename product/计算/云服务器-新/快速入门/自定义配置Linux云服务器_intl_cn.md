...
## 前提条件
 ...
 1. 开始自定义配置前，您需完成[【快速入门 Linux 云服务器】](https://cloud.tencent.com/document/product/213/2936#.E6.AD.A5.E9.AA.A4.E4.B8.80.EF.BC.9A.E5.87.86.E5.A4.87.E4.B8.8E.E9.80.89.E5.9E.8B)文档中的步骤一。
 2. 登录腾讯云官网，选择【云产品】-【计算与网络】-【云服务器】，单击【立即选购】按钮，进入 [云服务器购买页面](https://buy.cloud.tencent.com/buy/cvm) 。
 3. 单击【自定义配置】，进入自定义配置界面。

<div id="page2"></div>
## 选择地域与机型
![image-20181010153405408](自定义配置Linux云服务器_intl_cn.assets/image-20181010153405408.png)
...
<div id="page3"></div>
## 选择镜像
![image-20181009174332701](自定义配置Linux云服务器_intl_cn.assets/image-20181009174332701.png)
 1. 选择镜像提供方。
腾讯云提供公共镜像、自定义镜像、共享镜像、服务市场，您可参考 [镜像类型](https://cloud.tencent.com/document/product/213/4941) 进行选择。
...
<div id="page4"></div>
## 选择存储与网络
![](自定义配置Linux云服务器_intl_cn.assets/image-20181009174426285.png)
 1. 选择硬盘类型和数据盘大小。
...
- 私有网络：适合更高阶的用户，不同私有网络间逻辑隔离。
	>**注意：**
	> 公网网关是私有网络与公网的一种接口，可转发私有网络中不同子网内无外网 IP 的云服务器请求。更多详情请见 [公网网关](http://cloud.tencent.com/doc/product/215/%E7%BD%91%E5%85%B3#1.-公网网关) 。
...
<div id="page5"></div>
## 设置信息
![image-20181009174512418](自定义配置Linux云服务器_intl_cn.assets/image-20181009174512418.png)
...
- 自动生成密码：自动生成的密码将会以站内信方式发送。
 ...
 3. 选择安全组（**确保登录端口 22 开放**，更多信息见 [安全组](http://cloud.tencent.com/doc/product/213/%E5%AE%89%E5%85%A8%E7%BB%84)） 。
...
单击 [这里](https://cloud.tencent.com/document/product/213/2936#.E6.AD.A5.E9.AA.A4.E4.B8.89.EF.BC.9A.E7.99.BB.E5.BD.95-linux-.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8) ，继续 Linux 云服务器的登录、格式化与分区数据盘等后续配置。
