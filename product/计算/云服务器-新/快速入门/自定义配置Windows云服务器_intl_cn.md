...
<div id="page2"></div>
## 选择地域与机型
![image-20181010153405408](自定义配置Windows云服务器_intl_cn.assets/image-20181010153405408.png)
...
<div id="page3"></div>
## 选择镜像
![image-20181010105754025](自定义配置Windows云服务器_intl_cn.assets/image-20181010105754025.png)
 1. 选择镜像提供方。
...
<div id="page4"></div>
## 选择存储与网络
![image-20181009174426285](自定义配置Windows云服务器_intl_cn.assets/image-20181009174426285.png)
 1. 选择硬盘类型和数据盘大小。
...
<div id="page5"></div>
## 设置信息
![image-20181009174512418](自定义配置Windows云服务器_intl_cn.assets/image-20181009174512418.png)
