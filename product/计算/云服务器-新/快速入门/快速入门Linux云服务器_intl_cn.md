...
本步骤介绍 Linux 云服务器的创建。
 ...
 2. 选择地域和机型。靠近您客户的地域可降低访问延迟，提高下载速度。
    ...
    ![image-20181009174217646](快速入门Linux云服务器_intl_cn.assets/image-20181009174217646.png)

 3. 选择镜像。选择符合需求的 Linux 操作系统。

    ![image-20181009174332701](快速入门Linux云服务器_intl_cn.assets/image-20181009174332701.png)

 4. 选择储存和公网带宽。若不需要连接到公网，带宽值选 0 。

    ![image-20181009174426285](快速入门Linux云服务器_intl_cn.assets/image-20181009174426285.png)

 5. 设置安全组、账户名和登录方式。

    ![image-20181009174512418](快速入门Linux云服务器_intl_cn.assets/image-20181009174512418.png)

 6. 确定服务器设置并选择服务器数量。

    ![image-20181009174613350](快速入门Linux云服务器_intl_cn.assets/image-20181009174613350.png)
...
完成云服务器的购买和创建后，云服务器的实例名称、公网 IP 地址、内网 IP 地址、登录名、初始登录密码等信息都将以 [站内信](https://console.cloud.tencent.com/message) 的方式发送到账户上。
 ...
 3. 站内信页面即可查看新创建的云服务器，及登录名与密码等信息。如下图黄色高亮区域
    ...
    ![image-20181009175141548](快速入门Linux云服务器_intl_cn.assets/image-20181009175141548.png)


### 控制台登录云服务器
 1. 在云服务器列表的操作列，单击【Log In】按钮即可连接至 Linux 云服务器：
    ![image-20181010110440283](快速入门Linux云服务器_intl_cn.assets/image-20181010110440283.png)

 2. 输入帐号（root 或着您设置的用户名）和站内信中的初始密码（或您修改后的密码）即可登录。

    ![image-20181010110542743](快速入门Linux云服务器_intl_cn.assets/image-20181010110542743.png)
