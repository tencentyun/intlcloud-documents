...
**公共镜像** 是由腾讯云官方提供、支持和维护的镜像，包含基础操作系统和腾讯云提供的初始化组件，所有用户均可使用。
...
公共镜像特质：
 ...
 - **限制：**暂无使用限制。
 - **费用：**除部分境外地域的 Windows 类型镜像需收取一定 License 费用外，其余全部免费。
...
更多操作方法与限制，请参阅 [创建自定义镜像](/doc/product/213/4942)、[复制自定义镜像](/doc/product/213/4943)、[共享自定义镜像](/doc/product/213/4944)、[取消共享自定义镜像](/doc/product/213/7148)、[导入自定义镜像](/doc/product/213/4945) 。
...
共享镜像特质：
 ...
 - **限制：**每个自定义镜像最多可共享给 50 个腾讯云用户。镜像共享仅支持共享到对方账户相同地域下。
