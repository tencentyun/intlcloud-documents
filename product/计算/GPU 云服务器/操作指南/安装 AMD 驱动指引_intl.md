GPU instances can only operate normally with appropriate GPU drivers. To use AMD GPU instances, you must install AMD GPU drivers suitable for your compiling environment.
