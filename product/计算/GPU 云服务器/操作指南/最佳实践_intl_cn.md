...
## 存储
- 对于可靠性要求极高的数据，请使用 [腾讯云云硬盘](/doc/product/362) 以保证数据持久可靠存储，尽量不要选择 [本地盘](/doc/product/213/5798) 来存储（渲染型 GA2 仅支持云硬盘存储）。
...
## 备份与恢复
- 通过 [云主机控制台](https://console.cloud.tencent.com/cvm/index) 回滚备份好的 [自定义镜像](/doc/product/213/4942) 恢复等方式。
