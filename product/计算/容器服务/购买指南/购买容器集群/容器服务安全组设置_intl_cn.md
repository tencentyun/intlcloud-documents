...
## 安全组
安全组是一种有状态的包过滤功能的虚拟防火墙，它用于设置单台或多台云服务器的网络访问控制，是腾讯云提供的重要的网络安全隔离手段。更多安全组的介绍可以查看 [安全组](https://intl.cloud.tencent.com/document/product/213/12452)。
...
集群中服务的访问方式，可以参考 [服务访问方式设置](https://intl.cloud.tencent.com/document/product/457/9098) 。
