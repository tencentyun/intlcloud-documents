...
Method 1:  Mount the configurations in the configuration file to a container in the form of data volume. [View details](https://intl.cloud.tencent.com/document/product/457/11034)
Method 2:  Deploy multiple environments using configuration file and application template. [View details](https://intl.cloud.tencent.com/document/product/457/11033)
Method 3:  When you create a service, import configurations to environment variable using configuration file. [View details](https://intl.cloud.tencent.com/document/product/457/11034)
