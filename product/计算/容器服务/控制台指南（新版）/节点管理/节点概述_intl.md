...
A node is a basic element of a container cluster. Depending on the businesses, a node can be either a virtual machine or a physical machine. Each node contains the basic components required for running a Pod, such as Kubelet and Kube-proxy.
