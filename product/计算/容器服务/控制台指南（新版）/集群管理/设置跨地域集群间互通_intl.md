...
3. <span id="step3">Click the ID/name of the cluster for which to set cross-region cross-cluster communication to go to the management page of the cluster. See the figure below: </span>
...
2. In the left navigation pane, click **[Peering Connection](https://console.cloud.tencent.com/vpc/conn)** to go to the peering connection management page and record the **ID/name** of the peering connection. See the figure below:
![](https://main.qcloudimg.com/raw/a4c3a0168f3a0ac7feb4051a1cac78d5.png)
3. <span id="VPCStep3">In the left navigation pane, click **[Subnet](https://console.cloud.tencent.com/vpc/subnet)** to go to the subnet management page. </span>
