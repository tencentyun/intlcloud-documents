...
<table>
     ...
     <tr>
         <td>加密</td>
         <td>可选参数。</br>如果使用磁盘加密功能，则勾选【加密】。非加密快照仅支持创建非加密云硬盘。</td>
     </tr>
     <tr>
         <td>硬盘名称</td>
...
### 使用快照创建云硬盘
如果您希望创建的新云硬盘直接包含相关数据，则可以选择 [使用快照创建云硬盘](https://intl.cloud.tencent.com/document/product/362/5757)。
