...
1. Log in to Tencent Cloud Console (https://intl.console.cloud.tencent.com/), and select **Products** -> **Cloud Compute & Network** -> [**Virtual Private Cloud**](https://console.cloud.tencent.com/vpc/vpc?rid=8) -> **Flow Logs**.
<!-- >**Note:** 
