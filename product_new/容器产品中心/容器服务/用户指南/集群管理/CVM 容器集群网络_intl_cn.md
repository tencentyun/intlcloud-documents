...
- **集群网络**：为集群内主机分配在节点网络地址范围内的 IP 地址，您可以选择私有网络中的子网用于集群的节点网络。更多私有网络的介绍可参看 [私有网络和子网](https://intl.cloud.tencent.com/document/product/215/535) 。
...
- 集群内容器与容器之间互通。
- 集群内容器与节点直接互通。
- 集群内容器与 云数据库 TencentDB、[云数据库 Redis](https://intl.cloud.tencent.com/document/product/239)、云数据库 Memcached等资源同一 VPC 下内网互通。
- [设置同地域集群间互通](https://intl.cloud.tencent.com/document/product/457/30645)。
- [设置跨地域集群间互通](https://intl.cloud.tencent.com/document/product/457/30646)。
