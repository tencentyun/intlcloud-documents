...
- 目前仅支持同类型的操作系统修改如：使用 CentOS 基础镜像制作 CentOS 类的自定义镜像。
...
4. 在 “创建集群” 页面，设置集群的基本信息。
 ...
 - **运行时组件**：提供 “docker” 和 “containerd” 两种选择，详情请查看 [如何选择 Containerd 和 Docker](https://intl.cloud.tencent.com/document/product/457/31088)。
...
7. 在 “选择机型” 中，选择部署模式和机型。
 主要参数信息如下：
 - **Master**：Master 的部署方法决定了您集群的管理模式，我们提供了两种集群托管模式选择。详情请参见 [集群概述](https://intl.cloud.tencent.com/document/product/457/30635)。
...
9. 在 “选择机型” 中，选择部署模式和机型。
 ...
 - **Master**：Master 的部署方法决定了您集群的管理模式，我们提供了两种集群托管模式选择。参阅 [集群概述](https://intl.cloud.tencent.com/document/product/457/30635)。
 - **Node**：Node 配置的是集群运行服务真正使用的工作节点。您可以在创建集群时购置云服务器作为 Node 节点，也可以在集群创建完成后再添加 Node 节点。
 - **计费模式**：提供“按量计费” 计费模式。详细对比请查看 [计费模式](https://intl.cloud.tencent.com/document/product/213/2180)。
 - **Master&Etcd机型**：
     - **可用区**：您可以同时选择多个可用区部署您的 Master 或 Etcd，保证集群更高的可用性。
     - **节点网络**：您可以同时选择多个子网的资源部署您的 Master 或 Etcd，保证集群更高的可用性。
     - **机型**：选择大于 CPU 4核的机型，具体选择方案请参看 [实例规格](https://intl.cloud.tencent.com/document/product/213/11518) 和 [快速入门 Linux 云服务器](https://intl.cloud.tencent.com/document/product/213/2936)。
     - **系统盘**：默认为“本地硬盘50G”，您可以根据机型选择本地硬盘、云硬盘、SSD 云硬盘、高性能云硬盘等。存储盘选择请参考 [存储概述](https://intl.cloud.tencent.com/document/product/213/4952)。
     - **数据盘**：Master 和 Etcd 因为不建议部署其他应用，默认不配置数据盘，您可以购置后再添加云盘。
     - **公网宽带**：勾选**分配免费公网IP**，系统将免费分配公网 IP。提供两种计费模式，详细对比请参看 [公网计费模式](https://intl.cloud.tencent.com/document/product/213/10578)。
 ...
 - **Node机型**：当 “**Node**” 选择为 “**新增**” 时，可选。
     ...
     - **机型**：机型选择方案参看 [实例规格](https://intl.cloud.tencent.com/document/product/213/11518) 和 [快速入门 Linux 云服务器](https://intl.cloud.tencent.com/document/product/213/2936)。
     - **系统盘**：默认为“本地硬盘50G”，您可以根据机型选择本地硬盘、云硬盘、SSD 云硬盘、高性能云硬盘等。存储盘选择请参考 [存储概述](https://intl.cloud.tencent.com/document/product/213/4952)。
...
主要参数信息如下：
 - **数据盘挂载**：默认勾选。
 - **安全组**：安全组具有防火墙的功能，用于设置云服务器的网络访问控制。参看  [容器服务安全组设置](https://intl.cloud.tencent.com/document/product/457/9084) 。
 - **登录方式**：提供三种登录方式。
     - **设置密码**：请根据提示设置对应密码。
     - **立即关联密钥**：密钥对是通过算法生成的一对参数，是一种比常规密码更安全的登录云服务器的方式。详细参看 [SSH 密钥](https://intl.cloud.tencent.com/document/product/213/6092)。
