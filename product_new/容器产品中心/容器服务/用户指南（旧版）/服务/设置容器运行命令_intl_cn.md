...
## 容器如何执行命令和参数
如何将 docker run 命令适配到腾讯云容器服务，单击查看 [详情](https://intl.cloud.tencent.com/document/product/457/9883)。
 
...
>- 通过容器服务控制台设置容器运行命令和参数示例请参考 [Command 和 Args](https://intl.cloud.tencent.com/document/product/457/9883)。
