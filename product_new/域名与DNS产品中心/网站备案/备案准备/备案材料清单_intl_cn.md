...
| -------------------- | ------------------------------------------------------------ |
| 域名证书             | 内蒙古、湖南、江苏、贵州、重庆、陕西（提交五个或以上的域名）、河南（提交五个或以上的域名）需提供域名证书。 |
| 前置或专项审批文件   | 若网站内容涉及新闻、出版、药品和医疗器械、广播电影电视节目、文化等相关内容，需要出具指定单位开具的前置或专项审批文件。若网站涉及医疗相关的内容，请咨询省药监局确定是否需要出具前置审批文件。 详情请参考前置审批相关(https://intl.cloud.tencent.com/document/product/1039/32931)。|
