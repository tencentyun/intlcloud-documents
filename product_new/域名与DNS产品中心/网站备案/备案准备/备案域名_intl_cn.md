...
- 网站备案域名通过国家批复的域名注册服务机构进行注册管理（即境外注册商所注册的域名不能直接备案，需转入境内有资质的服务商，例如腾讯云）。
[工业和信息化部域名行业管理信息公示](http://xn--eqrt2g.xn--vuq861b/#)
- 网站备案域名在域名注册有效期内（以域名 WHOIS 信息中的过期时间为准）。
- 网站备案域名为已通过实名认证的域名。<!--腾讯云域名实名认证操作指南()-->
...
如域名注册人为单位、单位主要负责人或高级管理人员，则需提供相关证明材料（仅部分省份，具体可参考 [各省管局规则](https://intl.cloud.tencent.com/document/product/1022/31671)），示例如下：
