...
>모 애플리케이션의 실시간 음성 이용시간은 150분일 경우 무료입니다. 혹 1일내 실시간 음성 채팅 이용 시간이 1000분일 경우 요금은 1000분으로 집계되어 부과합니다. 요금=1000분 \* 0.0059/분=5.9위안(음성 채팅 시간 기준으로 요금을 부과시 단가는 0.0059위안/분입니다).
