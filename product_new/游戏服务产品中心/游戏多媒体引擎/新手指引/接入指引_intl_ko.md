[Tencent Cloud GME SDK]를 이용해주셔서 감사합니다(https://cloud.tencent.com/product/tmg?idx=1). 개발자가 Tencent Cloud GME 제품 API를 테스트하는 편의성을 위해 GME SDK 액세스 매뉴얼을 소개드립니다.
...
- 음질이 다르면 요금 결제방식도 달라집니다. 요금 결제 관련 사항은 [제품 가격]을 참조(https://cloud.tencent.com/document/product/607/17808)하거나, Tencent Cloud 비즈니스 담당자에게 문의하시기 바랍니다. 설정을 완료하면 재수정할 수 있습니다.
...
- 인증 상세 내역은 [인증 보안키]를 참조해주세요(https://intl.cloud.tencent.com/document/product/607/12218).
...
### 2. 액세스 준비
SDK를 액세스하려면 Tencent Cloudd에서 제공하는 appid와 권한 보안키를 적용해야 합니다. 즉 앱 관리 리스트의 AppID와 앱 설정의 인증 메시지 모듈을 사용해야 합니다.

플랫폼 관련 디테일한 설정은 각 플랫폼의 프로그래밍 설정 파일을 참조해주세요

### 3. 공식 Demo 사용 시 주의사항
Demo에 Tencent Cloud 테스트 계정을 포함하므로, 성능을 체험할 수 있습니다. 혹 멤버를 교체하거나 회사 테스트 계정이 필요하다면 Demo 의 대응하는 인터페이스에서 Tencent Cloud 테스트 계정 AppID를 개발자가 콘솔에서 획득한 AppID로 변경해야 합니다. 또한 AVChatViewController-GetAuthBuffer함수에서 실시간 음성의 권한 보안키를 수정해야 합니다
...
## 콘솔 사용량 통계
궁금한 사항은 [운영 매뉴얼]을 참조해주세요(https://intl.cloud.tencent.com/document/product/607/17448).


## 예외 사항 처리
궁금한 사항은 [일반 문제]를 참조해주세요(https://intl.cloud.tencent.com/document/product/607/30254)
궁금한 사항은 [에러코드]를 참조해주세요(https://intl.cloud.tencent.com/document/product/607/15173).
