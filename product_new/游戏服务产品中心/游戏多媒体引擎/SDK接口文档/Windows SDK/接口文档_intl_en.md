This document describes how to access and debug GME APIs for Windows.
...
### Getting a singleton
The GME SDK is provided in the form of singleton. All calls begin with `ITMGContext` and callbacks are passed to the application through `ITMGDelegate`.    
#### Function prototype 
...
class Callback : public SetTMGDelegate 
{
	virtual void OnEvent(ITMG_MAIN_EVENT_TYPE eventType,const char* data)
	{
  		switch(eventType)
  		{
   			// Identify the message type and process
  		}
 	}
}
