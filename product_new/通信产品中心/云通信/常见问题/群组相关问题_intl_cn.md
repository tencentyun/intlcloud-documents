...
- [Android 对群成员进行禁言](https://intl.cloud.tencent.com/document/product/1027/31254)
- [iOS 对群成员进行禁言](https://intl.cloud.tencent.com/document/product/1027/31269)
- [Web 对群成员禁言](https://intl.cloud.tencent.com/document/product/1027/31292)


另外 App 管理员也可通过 REST API 对任意群的任意成员设置禁言，详细请参阅 [REST API：批量禁言和取消禁言](https://intl.cloud.tencent.com/document/product/1027/31353) 文档。


### 如何查看被禁言的成员及禁言时间？
管理员和群主可以通过 IM SDK 提供的接口对成员设置或取消禁言（取消禁言只需要把禁言时间设置为 0 即可）。
查询成员禁言信息，是通过查询群成员资料来实现的。详细设置文档可参阅以下 SDK 文档：
- [Android 获取本人在群里的资料](https://intl.cloud.tencent.com/document/product/1027/31254)
- [iOS 获取本人在群里的资料](https://intl.cloud.tencent.com/document/product/1027/31269#.E8.8E.B7.E5.8F.96.E6.9C.AC.E4.BA.BA.E5.9C.A8.E7.BE.A4.E9.87.8C.E7.9A.84.E8.B5.84.E6.96.99)
- [Web 获取群成员列表](https://intl.cloud.tencent.com/document/product/1027/31292#1-.E8.8E.B7.E5.8F.96.E7.BE.A4.E6.88.90.E5.91.98.E5.88.97.E8.A1.A8)

另外 App 管理员也可通过 REST API 查询成员禁言信息，详细请参阅 [REST API：获取群组被禁言用户列表](https://intl.cloud.tencent.com/document/product/1027/31354) 文档。
...
私有群、公开群和聊天室群消息默认支持 7 天漫游，如果需要延长群消息漫游保存时间，可以 [提交工单](https://console.cloud.tencent.com/workorder/category?level1_id=29&level2_id=40&source=0&data_title=%E4%BA%91%E9%80%9A%E4%BF%A1%20%20IM&step=1) 申请开通配置 。
