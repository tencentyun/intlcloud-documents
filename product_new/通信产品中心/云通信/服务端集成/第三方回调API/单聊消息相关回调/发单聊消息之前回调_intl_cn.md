...
- 要启用回调，必须配置回调 URL，并打开本回调对应的开关，配置方法详见 [第三方回调配置](https://intl.cloud.tencent.com/document/product/1027/31377) 文档。
...
| MsgBody | Array | 消息体，具体参见 [消息格式描述](https://intl.cloud.tencent.com/document/product/1027/31212) 文档 |
...
| MsgBody | Array | 选填 | 经过 App 修改之后的消息体，云通信 IM 后台将把修改后的消息发送给好友，具体格式参见 [消息格式描述](https://intl.cloud.tencent.com/document/product/1027/31212) |

## 参考

- [第三方回调简介](https://intl.cloud.tencent.com/document/product/1027/31376)
- [发单聊消息之后回调](https://intl.cloud.tencent.com/document/product/1027/31388)
- REST API：[单发单聊消息](https://intl.cloud.tencent.com/document/product/1027/31318)
- REST API：[批量发单聊消息](https://intl.cloud.tencent.com/document/product/1027/31319)
