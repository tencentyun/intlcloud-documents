...
- **基础形式**
用来向群中进行邀请加人，一次请求最多支持添加500个成员。后台默认情况下会给群中所有成员下发加群系统通知（除没有激活的 Private 类型群组外）。
```
{
...
| 10007 | 操作权限不足，请确认该群组类型是否支持邀请加群。比如 AVChatRoom 和 BChatRoom 不允许任何人拉人入群 |
| 10014 | 群已满员，无法将请求中的用户加入群组，请尝试减少请求中 Member_Account 的数量或者修改该【群基础资料】的 MaxMemberNum 字段值。跳转到 [群基础资料](https://intl.cloud.tencent.com/document/product/1027/31214#.E7.BE.A4.E5.9F.BA.E7.A1.80.E8.B5.84.E6.96.99) |
...
| 10037 | 被邀请的成员加入群组数量超过了限制，请检查并删除群组数量超过限制的 Member_Account 或者按实际需要【购买升级】。 |
...
- [拉人入群之前回调](https://intl.cloud.tencent.com/document/product/1027/31393)
- [新成员入群之后回调](https://intl.cloud.tencent.com/document/product/1027/31394)
- [群组满员之后回调](https://intl.cloud.tencent.com/document/product/1027/31398)
