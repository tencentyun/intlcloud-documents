...
>- 音视频聊天室不支持删除群成员，对这种类型的群组进行操作时会返回10004错误。如果管理员希望达到删除群成员的效果，可以通过设置 [批量禁言和取消禁言](https://intl.cloud.tencent.com/document/product/1027/31353) 的方式实现；
...
## 可能触发的回调
[群成员离开之后回调](https://intl.cloud.tencent.com/document/product/1027/31395)