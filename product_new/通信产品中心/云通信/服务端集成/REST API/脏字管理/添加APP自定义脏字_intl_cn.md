## 背景说明
- 脏字指云通信 IM 为 App 配置的敏感词，如果检查的内容包含脏字将拒绝请求，并返回错误码 [30005](https://intl.cloud.tencent.com/document/product/1027/31406#.E5.85.B3.E7.B3.BB.E9.93.BE.E9.94.99.E8.AF.AF.E7.A0.81)、[40005](https://intl.cloud.tencent.com/document/product/1027/31406#.E8.B5.84.E6.96.99.E9.94.99.E8.AF.AF.E7.A0.81) 或 [80001](https://intl.cloud.tencent.com/document/product/1027/31406#.E5.90.8E.E5.8F.B0.E5.85.AC.E5.85.B1.E9.94.99.E8.AF.AF.E7.A0.81)。
- 脏字检查的内容包括单聊和群组消息（只检查文本消息 [TIMTextElem](https://intl.cloud.tencent.com/document/product/1027/31212#.E6.96.87.E6.9C.AC.E6.B6.88.E6.81.AF.E5.85.83.E7.B4.A0)，不支持对自定义消息 [TIMCustomElem](https://intl.cloud.tencent.com/document/product/1027/31212) 的过滤）、群名片、群组资料（群名称、群简介、群公告）、用户资料和好友关系链中 bytes 类型的数据（如昵称、好友备注和好友分组等）。
- 云通信 IM 的脏字集已经涵盖了一批默认脏字（主要是政治、色情等领域）。
...
- 查询 App 的自定义脏字（[v4/openim_dirty_words/get](https://intl.cloud.tencent.com/document/product/1027/31366)）
- 删除 App 的自定义脏字（[v4/openim_dirty_words/delete](https://intl.cloud.tencent.com/document/product/1027/31368)）
