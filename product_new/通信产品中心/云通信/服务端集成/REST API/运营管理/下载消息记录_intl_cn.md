...
文件第一行记录了该文件的基本信息，接下来的每一行记录一条消息，直到最后一行“]}”结束，每条消息格式可参考 [TIMMsgElement对象](https://intl.cloud.tencent.com/document/product/1027/31212#.E5.9B.BE.E5.83.8F.E6.B6.88.E6.81.AF.E5.85.83.E7.B4.A0) 的定义；
