...
| 功能类型       | 功能描述    |
| -------------- | -------------- |
| 全球接入简介   | 云通信 IM 提供覆盖全球的高连通、高可靠、强安全的网络连接通道，自研多重最优寻址算法，具有全网调度能力，终端在海外登录时，IM SDK 会访问就近接入点或加速点 |
...
| 离线消息 | 用户登录后退到后台，当有用户给其发消息时，云通信 IM 支持离线推送 |
...
您可以在腾讯云 [云通信 IM 控制台](https://console.cloud.tencent.com/avc) 根据您的需求对您的应用进行配置。
...
云通信 IM 控制台的 [统计分析](https://console.cloud.tencent.com/avc/stat/coredata/1400170138) 功能有各类维度的数据统计，为您提供运营数据。
