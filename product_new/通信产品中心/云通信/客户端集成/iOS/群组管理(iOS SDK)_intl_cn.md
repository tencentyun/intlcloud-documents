...
群组消息与 C2C （单聊）消息相同，仅在获取 `Conversation` 时的会话类型不同，可参照 [消息发送](https://intl.cloud.tencent.com/document/product/1027/31267#.E6.B6.88.E6.81.AF.E5.8F.91.E9.80.81) 部分。
...
云通信 IM 中内置了私有群、公开群、聊天室、音视频聊天室和在线成员广播大群五种群组类型，详情请见 [群组形态介绍](https://intl.cloud.tencent.com/document/product/1027/31214)。创建时可指定群组名称以及要加入的用户列表，创建成功后返回群组 ID，可通过群组 ID 获取 `Conversation` 收发消息等。
...
>- 这里的资料仅跟群相关资料，例如禁言时间、成员角色变更等，不包括用户昵称等本身资料，对于群内人数可能过多，不建议实时更新，建议的做法是直接显示消息体内的资料，参考：[消息发送者以及相关资料](https://intl.cloud.tencent.com/document/product/1027/31267)
