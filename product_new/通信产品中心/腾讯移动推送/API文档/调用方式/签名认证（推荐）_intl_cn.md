...
| 参数 | 说明 |
| --- | --- |
| AccessId | 移动推送 TPNS 后台分配的应用 ID，请前往 [移动推送 TPNS 控制台](https://console.cloud.tencent.com/tpns) 获取|
| SecretKey | 移动推送 TPNS 后台分配的 SecretKey，与 AccessId 对应，请前往 [移动推送 TPNS 控制台](https://console.cloud.tencent.com/tpns) 获取|
| Sign | 接口签名方式 |
| timeStamp |      请求时间戳 |
