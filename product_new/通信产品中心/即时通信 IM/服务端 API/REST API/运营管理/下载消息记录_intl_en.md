...
The following table only describes parameters that are modified when this API is invoked. For details on other parameters, see [RESTful API Overview](https://cloud.tencent.com/document/product/269/1519).

| Parameter | Description |
| ------------------ | ------------------------------------ |
| v4/open_msg_svc/get_history | Request API |
| sdkappid | SDKAppID assigned by the IM console when an app is created |
| identifier | The value of this parameter must be an app admin account. For details, see [App Admins](https://cloud.tencent.com/document/product/269/31999#app-.E7.AE.A1.E7.90.86.E5.91.98). |
| usersig | The signature generated by the app admin account. For details on the operation, see [Generating UserSig](https://cloud.tencent.com/document/product/269/32688). |
