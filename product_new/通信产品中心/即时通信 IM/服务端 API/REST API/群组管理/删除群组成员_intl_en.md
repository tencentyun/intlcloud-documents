...
IM provides the preceding five built-in group types. For details, see [Group Systems](https://cloud.tencent.com/document/product/269/1502).

>
>- AVChatRoom groups do not support deleting group members. If you try to delete the members of an AVChatRoom group, error 10004 returns. To achieve the effect of deleting a member, the admin can use [Batch Muting and Unmuting](https://cloud.tencent.com/document/product/269/1627).
...
## References
Adding a group member ([v4/group_open_http_svc/add_group_member](https://cloud.tencent.com/document/product/269/1621))

## Callback That May Be Triggered
[Callback after removing a group member](https://cloud.tencent.com/document/product/269/1668)
