...
通过 [REST API 在线调试工具](https://avc.cloud.tencent.com/im/APITester/APITester.html#v4/group_open_http_svc/destroy_group) 调试本接口。

## 参考
创建群组（[v4/group_open_http_svc/create_group](https://intl.cloud.tencent.com/document/product/1047/34895)）。

## 可能触发的回调
[群组解散之后回调](https://intl.cloud.tencent.com/document/product/1047/34377)。
