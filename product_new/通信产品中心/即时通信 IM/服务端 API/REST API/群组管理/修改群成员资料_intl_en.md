...
| AppMemberDefinedData | Array | Optional | The group member custom field. By default, this field is unavailable and needs to be enabled before use. For details, see [Group Systems](https://cloud.tencent.com/document/product/269/1502). |
...
## References
Obtaining group members’ detailed profiles ([v4/group_open_http_svc/get_group_member_info](https://cloud.tencent.com/document/product/269/1617))
