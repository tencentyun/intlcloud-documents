...
>
>- If the group type is set to AVChatRoom, for details on the number of groups that can be created, see [Pricing](https://cloud.tencent.com/document/product/269/11673).
>- If the group type is set to BChatRoom, the number of groups that can be created is 5. For details, see [Differences in Group Limits](https://cloud.tencent.com/document/product/269/1502#.E7.BE.A4.E7.BB.84.E9.99.90.E5.88.B6.E5.B7.AE.E5.BC.82).
...
| GroupId | String | Optional | To simplify group IDs and make them memorable and propagatable, Tencent Cloud allows apps to [customize group IDs](https://cloud.tencent.com/document/product/269/1502#.E8.87.AA.E5.AE.9A.E4.B9.89.E7.BE.A4.E7.BB.84-id) when creating groups through the RESTful API. |
...
| ApplyJoinOption | String | Optional | The method for handling group requests, which can be FreeAccess (unrestricted), NeedPermission (approval required), or DisableApply (denied). The default method is NeedPermission if this field is not specified. <br>This field is valid only for creating [groups](https://cloud.tencent.com/document/product/269/1502#.E7.BE.A4.E6.88.90.E5.91.98.E6.93.8D.E4.BD.9C.E5.B7.AE.E5.BC.82) that allow joining. |
| AppDefinedData | Array | Optional | Group custom fields. By default, this field is unavailable and needs to be enabled for use. For details, see [Custom Fields](https://cloud.tencent.com/document/product/269/1502#.E8.87.AA.E5.AE.9A.E4.B9.89.E5.AD.97.E6.AE.B5). |
| MemberList | Array | Optional | The initial group member list with maximum 500 members. For details on group member information fields, see [Group Member Profiles](https://cloud.tencent.com/document/product/269/1502#.E7.BE.A4.E6.88.90.E5.91.98.E8.B5.84.E6.96.99). |
| AppMemberDefinedData | Array | Optional | Group member custom fields. By default, this field is unavailable and needs to be enabled for use. For details, see [Custom Fields](https://cloud.tencent.com/document/product/269/1502#.E8.87.AA.E5.AE.9A.E4.B9.89.E5.AD.97.E6.AE.B5). |
...
| 10036 | The number of created AVChatRoom groups exceeds the limit. In this case, dismiss some AVChatRoom groups first or purchase an upgraded quota by referring to [Pricing](https://cloud.tencent.com/document/product/269/11673). |
| 10037 | The request specifies Owner_Account, but the number of groups that the group owner has created or joined exceeds the limit. In this case, the group owner needs to quit some groups first or purchase an upgraded quota by referring to [Pricing](https://cloud.tencent.com/document/product/269/11673). |
| 10038 | The number of members imported into the request packet exceeds the limit. In this case, reduce the number of imported members in the `MemberList` parameter or purchase an upgraded quota by referring to [Pricing](https://cloud.tencent.com/document/product/269/11673). |
...
## References
Dismissing a group ([v4/group_open_http_svc/destroy_group](https://cloud.tencent.com/document/product/269/1624))

## Callbacks That Can Be Triggered

- [Callback before creating a group](https://cloud.tencent.com/document/product/269/1662)
- [Callback after creating a group](https://cloud.tencent.com/document/product/269/1663)
