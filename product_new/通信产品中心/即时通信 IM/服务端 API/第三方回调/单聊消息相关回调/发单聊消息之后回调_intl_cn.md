...
-  要启用回调，必须配置回调 URL，并打开本回调对应的开关，配置方法详见 [第三方回调配置](https://intl.cloud.tencent.com/document/product/1047/34520)。
...
| SendMsgResult | Integer | 该条消息的下发结果，0表示下发成功，非0表示下发失败，具体可参见 [错误码](https://intl.cloud.tencent.com/document/product/1047/34348#.E6.B6.88.E6.81.AF.E9.94.99.E8.AF.AF.E7.A0.812) |
