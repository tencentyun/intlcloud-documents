...
2. 在弹出的添加群组对话框中，配置以下参数：
 ...
 - 群类型：请设置群组类型，支持私有群。公开群、聊天室、互动直播室和在线成员广播大群，群组的详细介绍请参见 [群组形态介绍](https://intl.cloud.tencent.com/document/product/1047/33529#.E7.BE.A4.E7.BB.84.E5.BD.A2.E6.80.81.E4.BB.8B.E7.BB.8D)。
3. 单击【确定】保存配置。
