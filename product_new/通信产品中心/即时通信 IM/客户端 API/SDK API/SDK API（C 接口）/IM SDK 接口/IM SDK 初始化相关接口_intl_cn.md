...
- `json_sdk_config` 中 `kTIMSdkConfigLogFilePath` 和 `kTIMSdkConfigConfigFilePath` 两个 JSON Key 是必填字段，详情请参考 [SdkConfig](https://intl.cloud.tencent.com/document/product/1047/34551#sdkconfig)。
