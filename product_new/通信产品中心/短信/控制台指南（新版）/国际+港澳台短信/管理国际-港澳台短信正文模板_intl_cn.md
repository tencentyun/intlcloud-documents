...
2. 在左侧导航栏选择【国际/港澳台短信】>【正文模板管理】，单击【创建正文模板】。
3. 结合实际情况和 正文模板审核标准 设置以下参数：
 - 模板名称：模板的名称，便于识别。
...
1. 在 [正文模板管理](https://console.cloud.tencent.com/smsv2/isms-template) 页面，您可以查看正文模板信息。
 - ID：正文模板 ID，由系统自动生成。已审核通过的正文模板 ID 可指定为使用 API 或 SDK 发送短信时的`tpl_id`参数值。
 - 内容：短信正文的实际内容。
 - 状态/原因：正文模板的状态，包括【待审核】、【未通过】以及【已通过】。若正文模板处于【未通过】状态，可单击【查看详情】了解详细的未通过原因或建议。
 - 申请时间：创建正文模板的时间。
...
1. 在 [正文模板管理](https://console.cloud.tencent.com/smsv2/isms-template) 页面，单击目标正文模板所在行的【删除】。
2. 在弹出的对话框中，单击【删除】。
