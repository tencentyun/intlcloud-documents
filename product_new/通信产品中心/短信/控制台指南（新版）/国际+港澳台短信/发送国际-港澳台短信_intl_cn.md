...
4. 根据实际需求设置以下参数：
 ...
 - 发送时间：支持【立即发送】或【定时发送】。
 - 发送对象：单击【模板下载】，填写表格中的客户手机号和短信自定义内容信息，单击上传表格，最大支持上传30MB大小的表格文件。
   ...
   <table>
	 ...
	 <tr>      
        <td>示例：139xxxxxxxx<br>填写说明：请填写待发送短信的客户手机号，同一次发送的所有客户手机号归属地都必须为境外地区。单元格需采用常规格式，即不包含任何特定的数字格式。</td>   
...
## 相关文档
您也可以通过 API 或 SDK 发送短信，具体操作请参见 [API 文档](https://intl.cloud.tencent.com/document/product/382/39155) 或 [SDK 文档](https://intl.cloud.tencent.com/document/product/382/36788)。
