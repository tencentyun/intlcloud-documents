本文以企业认证用户向境外手机用户发送`[Tencent Cloud]Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`为例，帮助您了解如何快速使用国际/港澳台短信服务。更多短信相关的概念，请参见 [常用概念](https://intl.cloud.tencent.com/document/product/382/13299)。
