...
>配置基于标签的管理权限与配置非标签的管理权限入口相同，在【[访问管理](https://console.cloud.tencent.com/cam)】>【[策略](https://console.cloud.tencent.com/cam/policy)】中，新建【按照标签授权】策略，详细操作请参考 [按标签授权](https://intl.cloud.tencent.com/document/product/598/10601)。
