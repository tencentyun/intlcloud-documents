## 接口描述
本接口 (RewindQueue)用于消息回溯功能，具体功能参见 [消息回溯功能](https://intl.cloud.tencent.com/document/product/406/8129)。
...
## 错误码
以下是接口特有错误码，如果您要查找的错误码不在其中，可能在 [公共错误码](https://intl.cloud.tencent.com/document/product/406/5903)中。
