...
### 一. 制作自定义镜像
1. 自定义镜像流程，参考 [Windows自定义镜像](https://intl.cloud.tencent.com/zh/document/product/599/13035)。
...
- 渲染素材较小时，推荐将全部素材压缩成 gzip包，上传至对象存储。可参考 [上传对象](https://intl.cloud.tencent.com/zh/document/product/436/6233)。
- 渲染素材较大时，推荐存放在文件存储上。
...
![](https://main.qcloudimg.com/raw/15650e325d5507a0302896e44de45f7f.png)
 ...
  * Stdout日志：格式参考 [COS、CFS 路径填写](https://intl.cloud.tencent.com/zh/document/product/599/13996)
...
![](https://main.qcloudimg.com/raw/a7d312aa78f460b30ed67d1758b395ba.png)
 ...
  * 输出路径映射-COS CFS路径：格式参考 [COS、CFS 路径填写](https://intl.cloud.tencent.com/zh/document/product/599/13996)
...
7. 渲染结果查询，参考 [查看对象信息](https://intl.cloud.tencent.com/zh/document/product/436/13326)。
...
- **并行渲染多张图片**：Batch 支持指定并发渲染数，通过 [环境变量](https://intl.cloud.tencent.com/zh/document/product/599/11752) 区分不同的渲染实例，每个渲染实例读取不同的渲染素材，实现并行渲染。
