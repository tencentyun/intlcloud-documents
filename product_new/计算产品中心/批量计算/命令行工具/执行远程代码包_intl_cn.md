...
## 1. 前置准备
请根据 [前置准备](https://intl.cloud.tencent.com/zh/document/product/599/10548) 里的说明完成准备，并了解如何配置自定义信息里的通用部分。
...
如果返回 JobId 字段则代表提交成功，没有则检查返回值排查错误，也可以加入 [用户反馈](https://intl.cloud.tencent.com/zh/document/product/599/10806) 里的沟通群向管理员咨询。

## 4. 查看状态
参考 [简单开始](https://intl.cloud.tencent.com/zh/document/product/599/10551) 同名章节。
