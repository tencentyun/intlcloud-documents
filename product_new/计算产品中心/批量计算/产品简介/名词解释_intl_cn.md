...
## 镜像
镜像（Image）配置在任务里，创建实例时使用，它必须是一个标准的或者自定义的 CVM 镜像，您需要预先将计算环境和应用程序准备好并制作成自定义镜像，您可以在 [镜像控制台>>>](https://console.cloud.tencent.com/cvm/image?rid=1&imageType=1) 查看您的自定义镜像，如何制作自定义镜像请查看 [创建自定义镜像>>>](https://intl.cloud.tencent.com/zh/document/product/213/4942) 。
## 计算环境
