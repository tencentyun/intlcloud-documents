...
9. 在 “选择机型” 中，选择部署模式和机型。如下图所示：
 ...
 - **Master**：Master 的部署方法决定了您集群的管理模式，我们提供了两种集群托管模式选择。参阅 [集群概述](https://intl.cloud.tencent.com/document/product/457/30635)。
 - **Node**：Node 配置的是集群运行服务真正使用的工作节点。您可以在创建集群时购置云服务器作为 Node 节点，也可以在集群创建完成后再添加 Node 节点。
 - **计费模式**：提供 “后付费” 计费模式。具体描述请查看 [计费模式](https://intl.cloud.tencent.com/document/product/213/2180)。
 - **Master&Etcd机型**：
    - **可用区**：您可以同时选择多个可用区部署您的 Master 或 Etcd，保证集群更高的可用性。
    - **节点网络**：您可以同时选择多个子网的资源部署您的 Master 或 Etcd，保证集群更高的可用性。
    - **机型**：选择大于 CPU 4核的机型，具体选择方案请参看 [实例类型概述](https://intl.cloud.tencent.com/document/product/213/11518#.E5.8F.AF.E7.94.A8.E5.AE.9E.E4.BE.8B.E7.B1.BB.E5.9E.8B2) 和 [确定云服务器配置方案](https://intl.cloud.tencent.com/document/product/213/2764#.E7.A1.AE.E5.AE.9A.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8.E9.85.8D.E7.BD.AE.E6.96.B9.E6.A1.88)。
    - **系统盘**：您可以根据区域、机型选择本地硬盘、云硬盘、SSD 云硬盘、高性能云硬盘等。存储盘选择请参考 [存储概述](https://intl.cloud.tencent.com/document/product/213/4952)。
    - **数据盘**：Master 和 Etcd 因为不建议部署其他应用，默认不配置数据盘，您可以购置后再添加云盘。
    - **公网宽带**：勾选**分配免费公网IP**，系统将免费分配公网 IP。提供按流量计费模式，具体描述请参看 [公网计费模式](https://intl.cloud.tencent.com/document/product/213/10578)。
 - **Node机型**：当 “**Node**” 选择为 “**新增**” 时，可选。
    ...
    - **机型**：机型选择方案参看 [实例类型概述](https://intl.cloud.tencent.com/document/product/213/11518#.E5.8F.AF.E7.94.A8.E5.AE.9E.E4.BE.8B.E7.B1.BB.E5.9E.8B2) 和 [确定云服务器配置方案](https://intl.cloud.tencent.com/document/product/213/2764#.E7.A1.AE.E5.AE.9A.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8.E9.85.8D.E7.BD.AE.E6.96.B9.E6.A1.88)。
    - **系统盘**：您可以根据区域、机型选择本地硬盘、云硬盘、SSD 云硬盘、高性能云硬盘等。存储盘选择请参考 [存储概述](https://intl.cloud.tencent.com/document/product/213/4952)。
