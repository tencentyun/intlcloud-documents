...
### 手动添加/移除节点
#### 新建节点
具体操作请参考 [新建节点](https://intl.cloud.tencent.com/document/product/457/30652#createNode)。
...
具体操作请参考 [添加已有节点](https://intl.cloud.tencent.com/document/product/457/30652#addExistingNode)。
添加过程中，您可以在 “云服务器配置” 页面，配置需要添加到集群的云服务器，并对集群进行扩缩容。

#### 移除节点
具体操作请参考 [移除节点](https://intl.cloud.tencent.com/document/product/457/30653)。
...
**启动配置**：
 ...
 - 实例类型：提供 “按量计费” 和 “[竞价计费](https://intl.cloud.tencent.com/document/product/213/17816)” 两种模式，请根据实际需求进行选择。
 - 机型设置：请根据实际需求进行选择。
 - 登录方式：
    - 设置密码：请根据提示设置对应密码。
    - 立即关联密码：密钥对是通过一种算法生成的一对参数，是比常规密码更安全的登录云服务器的方式，具体详情可参阅 [SSH 密钥](https://intl.cloud.tencent.com/document/product/213/6092)。
