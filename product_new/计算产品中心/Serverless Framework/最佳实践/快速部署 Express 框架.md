...
如您的账号未[登陆](https://intl.cloud.tencent.com/login)或[注册](https://intl.cloud.tencent.com/register)腾讯云，您可以直接通过`微信`扫描命令行中的二维码进行授权登陆和注册。
...
如果没有腾讯云账号，可以在此[注册新账号](https://intl.cloud.tencent.com/register)。
