...
如您的账号未[登陆](https://intl.cloud.tencent.com/login)或[注册](https://intl.cloud.tencent.com/register)腾讯云，您可以在运行`serverless deploy`云端部署命令后，直接用`微信`扫描命令中弹出的二维码，对云账户进行授权登陆和注册。
...
## 前提条件
- 已注册腾讯云账户，注册指引可参考 [注册腾讯云](https://intl.cloud.tencent.com/document/product/378/17985)。
...
## 使用配置
1. 在本地创建 Serverless 示例模板，详情请参考 [创建服务](https://intl.cloud.tencent.com/document/product/1040/33171)。
