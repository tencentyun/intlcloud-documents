...
- **[快速部署 Express 框架](https://intl.cloud.tencent.com/document/product/1040/33161)**
通过Express 组件，您无需对项目进行大量更改，就可以将现有服务轻松上云：只需短短几秒，便能在腾讯云 Serverless 架构上部署按需计费的 Express.js 应用程序。
- **[快速部署静态网站](https://intl.cloud.tencent.com/document/product/1040/33162)**
静态网站组件现已支持最新的 Web 框架和技术（例如：React 和 Vue.js 等应用程序），您可以在几秒钟内将自己的静态网站部署到对象存储 COS 中。
- **[快速部署一个全栈应用（vue.js+express.js）](https://intl.cloud.tencent.com/document/product/1040/33160)**
...
- [云函数 SCF 组件](https://intl.cloud.tencent.com/document/product/1040/33164)
- [API 网关组件](https://intl.cloud.tencent.com/document/product/1040/33165)
- [对象存储 COS 组件](https://intl.cloud.tencent.com/document/product/1040/33166)
- [访问管理 CAM-角色组件](https://intl.cloud.tencent.com/document/product/1040/33167)
- [访问管理 CAM-策略组件](https://intl.cloud.tencent.com/document/product/1040/33168)
