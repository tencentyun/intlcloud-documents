You can call the [created hello-world function](https://intl.cloud.tencent.com/document/product/583/9204) using the test template provided by the console as follows.
