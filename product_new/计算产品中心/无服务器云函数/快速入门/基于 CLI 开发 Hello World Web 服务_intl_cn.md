...
#### 方式1
1. 安装 Python 2.7 或 3.6+ 版本，您可以参考[ Python 安装教程](https://intl.cloud.tencent.com/document/product/583/32754#.E5.AE.89.E8.A3.85-python) 进行安装。
...
2. 获取账号的 APPID，SecretId，SecretKey 以及产品期望所属的地域，配置信息获取途径请参见 [配置账号信息](https://intl.cloud.tencent.com/document/product/583/32754#.E9.85.8D.E7.BD.AE.E8.B4.A6.E5.8F.B7.E4.BF.A1.E6.81.AF)。
