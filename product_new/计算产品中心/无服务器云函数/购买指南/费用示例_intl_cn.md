...
- 调用次数月费用：（259200 × 30 / 10000 - 100）× 0.0015 = 1.02 美元

在这种情况下，总花费为：调用次数费用 1.02 美元。
...
- 调用次数月费用：（72000 × 30 / 10000 - 100）× 0.0015 = 0.17 美元
- 外网出流量费用：（70.31 × 30 / 1024）× 0.12  = 0.25 美元

在这种情况下，总花费为：资源使用费用 0.35 + 调用次数费用 0.17 + 外网出流量费用 0.25 =  0.77美元。
