...
直接上传至 SCF 平台，或通过上传 COS 再导入 SCF 方式提交的代码包，要求为 [ZIP 格式](https://zh.wikipedia.org/zh-hans/ZIP%E6%A0%BC%E5%BC%8F) 。用于压缩或解压的工具，在 Windows 平台下可使用例如 7-Zip 工具，在 Linux 平台下可使用 zip 命令行工具。
