...
**深圳／上海金融专区特别说明：**
针对金融行业监管要求定制的合规专区，具有高安全，高隔离性的特点。 目前提供云服务器、云硬盘、金融数据库、Redis存储、人脸识别等服务，已认证通过的金融行业客户可提工单申请使用专区。更多信息请参考**金融专区介绍**。
...
可用区具备以下特性：
- 同一腾讯云账户下相同地域不同可用区，但在同一个 [VPC（私有网络）](https://intl.cloud.tencent.com/document/product/215) 下的云产品之间均通过内网互通，可以直接使用 [内网 IP](https://intl.cloud.tencent.com/document/product/213/5225) 访问。
