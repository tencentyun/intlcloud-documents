...
快照跨地域复制目前处于灰度内测阶段，您可以 [申请](https://console.cloud.tencent.com/act/apply/snapshotcopy) 使用腾讯云云硬盘快照跨地域复制。

## 使用限制
- **内测申请**：快照跨地域复制目前处于灰度使用阶段，需要 [申请](https://console.cloud.tencent.com/act/apply/snapshotcopy) 才能使用该功能。
