...
1. 参考 [创建实例](https://cloud.tencent.com/document/product/213/4855) 购买实例，并在 “4.设置安全组和主机” 中单击【高级设置】。
2. 在 “高级设置” 中，根据实际需求，在 “自定义数据” 的文本框中输入准备的文本内容。
 - PowerShell 脚本：直接输入 [PowerShell 脚本](#PowerShellScript)。
 - Base64 编码脚本：需先勾选【输入为base64格式文本】，再输入 [Base64 编码脚本](#Base64Script)。
...
如果存在 `tencentcloud.txt` 文本文件，则表示配置成功。
