...
<table>
	...
	<tr><td>中国大陆地区</br>法兰克福</br>首尔</td><td>0.03</td></tr>
...
#### 计费示例
用户在1小时内一个 EIP 累计闲置15分钟（900秒），则应收费用为：0.03 美元/小时 \*（900/3600）小时 = 0.0075（美元）

> 建议您主动并及时释放不再使用的弹性公网 IP，以保证 IP 资源的合理利用，节省您的费用。操作指引参见 [释放弹性公网 IP](https://intl.cloud.tencent.com/document/product/213/16586)。
>
