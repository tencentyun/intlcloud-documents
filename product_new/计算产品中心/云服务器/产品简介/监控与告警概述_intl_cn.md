...
更多内容请见 [云监控的基本功能](https://intl.cloud.tencent.com/document/product/248)。
...
- **告警设置：**可设置监控指标界限值，当到达条件时，及时发送告警信息至关心的群体中。详情参考 [创建告警策略](http://intl.cloud.tencent.com/document/product/248/6215)。
