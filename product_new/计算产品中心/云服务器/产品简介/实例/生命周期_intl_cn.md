...
- **实例有以下状态：**
	...
	<tr><td>运行中</td><td>稳定状态</td><td>实例正常运行状态，这个状态的实例可以上运行您的业务。</td></tr>
...
更多实例启动信息请参考 [创建实例](https://intl.cloud.tencent.com/document/product/213/4855)、[登录 Windows 实例](https://intl.cloud.tencent.com/document/product/213/32498) 和 [登录 Linux 实例](https://intl.cloud.tencent.com/document/product/213/5436)。
