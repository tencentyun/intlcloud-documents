인스턴스의 안전성을 보장하기 위해 Tencent Cloud는 두가지 암호화 로그인 방법을 제공합니다. [비밀번호 로그인](https://intl.cloud.tencent.com/doc/product/213/6093) 및 SSH 키 쌍 로그인. 본 문서는 SSH 키 쌍 로그인 구성에 대해 설명합니다.
