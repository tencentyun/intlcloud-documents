...
当您希望对某类标签的实例进行筛选时，可通过以下操作进行筛选。

1. 在搜索框中，选择【标签】。
2. 在【标签:】后输入标签键和标签值，单击 <img src="https://main.qcloudimg.com/raw/3cca38f08eaa87087cdd1b81eaf08a0a.png" style="margin: 0;"> 进行搜索。如下图所示：
例如，您希望筛选出负责人为张三的云服务器资源，可输入`标签:owner:zhangsan`。
