...
## 가져오기 순서
 ...
 4. 작업 인터페이스 요구에 따라 먼저 [COS 활성화](https://console.cloud.tencent.com/cos4/index)를 한 뒤, [bucket 생성](/doc/product/436/6232)을 할 경우 미러 이미지 파일이 bucket에 업로드되며 [미러 이미지 파일 URL을 획득](https://intl.cloud.tencent.com/document/product/436/13322)합니다.
 5. [다음 단계]를 클릭하십시오.
