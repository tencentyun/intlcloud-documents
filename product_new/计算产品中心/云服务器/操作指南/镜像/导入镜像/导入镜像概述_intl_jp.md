...
## インポート手順
 ...
 4. 操作インターフェースの要件に従って、まず [COSをアクティブ](https://console.cloud.tencent.com/cos4/index)し、 [ bucket バケットを作成](/doc/product/436/6232)して 、イメージファイルを bucketにアップロードしてから、 [イメージファイルのURLを取得](https://intl.cloud.tencent.com/document/product/436/13322)します。
 5.【次へ】をクリックします。
