...
### 使用 API 获取
请参考 [DescribeInstances 接口](https://intl.cloud.tencent.com/zh/document/product/213/15728)。
...
vi /etc/resolv.conf
```
3. 按 **i** 或 **Insert** 切换至编辑模式，并根据 [内网 DNS](https://intl.cloud.tencent.com/zh/document/product/213/5225#.E5.86.85.E7.BD.91-dns) 列表中对应的不同地域，修改 DNS IP。
