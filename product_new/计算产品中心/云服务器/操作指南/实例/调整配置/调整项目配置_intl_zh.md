...
2. 在需要调整的实例右侧操作栏，单击【更多】>【资源调整】>【调整配置】。
3. 在 “选择目标配置” 中，确认实例状态以及操作，**选择需要的机型和实例规格，并仔细确认规格和性能参数**，单击【下一步】。
4. 根据实例的计费模式，确认费用，单击【下一步】。
	- 按量计费实例：请确认新规格所需冻结的金额。调整配置后，按量计费价格将从第一阶梯开始计费，请明确规则后进行操作。
...
您可以使用 ResizeInstance 和 ResizeInstanceHour 接口实例配置。具体内容可参考 [调整实例配置 API](https://intl.cloud.tencent.com/document/product/213/33239)。
