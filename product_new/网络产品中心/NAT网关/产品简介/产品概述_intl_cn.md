## 简介
NAT 网关（NAT Gateway）是一种支持 IP 地址转换服务，提供 [SNAT](https://intl.cloud.tencent.com/document/product/1015/30227) （Source Network Address Translation，源网络地址转换）和 [DNAT](https://intl.cloud.tencent.com/document/product/1015/30227)（Destination Network Address Translation，目的网络地址转换） 能力，可为 [私有网络（VPC）](https://intl.cloud.tencent.com/document/product/215/535)内的资源提供安全、高性能的 Internet 访问服务。NAT 网关支持高达99.99%的高可用性、5Gbps的带宽以及1000 万以上的并发连接数，其典型应用场景如下：
...
| 公网 IP  | 最多绑定10个EIP                          | 1个EIP 或普通公网 IP                      |
| 公网限速   |5G（ 最大可支持50G，请[提交工单](https://console.cloud.tencent.com/workorder/category)申请） | 取决于云服务器限速                                |
| 最大连接数  | 1000万                                   | 50万                                      |
...
| 费用     | 大陆地区：<br/>小型（最大100万连接数）：0.09USD / 小时<br/>中型（最大300万连接数）：0.27USD / 小时<br/>大型（最大1000万连接数）：0.89USD / 小时 | 仅需支付对应云服务器的配置费用，不收取额外费用 |

由上表可知，NAT 网关具有如下优势：
- 大容量
最大支持1000万并发连接、5Gbps带宽和10个EIP，满足大规模用户诉求。
- 双机热备高可用
