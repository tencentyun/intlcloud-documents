You can remove an EIP from a bandwidth package. After the removal, the bandwidth cap and billing mode of the EIP are reset to those before the EIP was added to the bandwidth package.
