...
### 我应该如何开通带宽包？
后付费带宽包需提交 [内测申请](https://cloud.tencent.com/act/apply/bwp_apply) 开通。

### 腾讯云共享带宽包有几种类型？
腾讯云共享带宽包分为两种类型：一种为设备带宽包，另一种为 IP 带宽包，详情请参见 [产品类别](https://intl.cloud.tencent.com/document/product/684/15246)。
