When you create a cross-account peering connection or a shared direct connect, you need to enter the account ID of the peer developer, which you can check as follows:
