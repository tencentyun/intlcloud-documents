...
负载均衡可覆盖传统型负载均衡的所有功能。从产品功能、产品性能等多方面考虑，建议您使用的实例类型是负载均衡，二者的详细对比参见 [实例类型](https://intl.intl.cloud.tencent.com/document/product/214/8847)。
...
> 3. 如您需支持上述高级能力，请直接使用负载均衡，而非传统型负载均衡，详情请参见 [实例类型](https://intl.intl.cloud.tencent.com/document/product/214/8847)。
