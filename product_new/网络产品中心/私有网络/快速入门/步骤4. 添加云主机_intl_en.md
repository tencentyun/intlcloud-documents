...
1) Log in to [Tencent Cloud Console](https://console.cloud.tencent.com/), click "Virtual Private Cloud" in the navigation bar, or click "Experience" in Tencent Cloud's [VPC Overview](https://intl.cloud.tencent.com/product/vpc) page to enter the [VPC Console](https://console.cloud.tencent.com/vpc/).
...
1)	On the [CVM Overview](https://intl.cloud.tencent.com/product/cvm) page, click "Experience" button.
