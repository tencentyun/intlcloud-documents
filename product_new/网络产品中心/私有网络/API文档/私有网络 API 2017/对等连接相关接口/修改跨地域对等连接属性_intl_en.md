...
```
https://vpc.api.qcloud.com/v2/index.php?Action=ModifyVpcPeeringConnectionEx&<Common request parameters>&peeringConnectionId=pcx-krmzap90&peeringConnectionName=uuuuuuu
```
