## 基本概念
网络访问控制列表（Access Control List，ACL）是一个子网级别无状态的可选安全层，用于控制进出子网的数据流，可以精确到协议和端口粒度。如下图所示，其规则与 [安全组](https://intl.cloud.tencent.com/document/product/215/31889) 相似，但由于网络 ACL 无状态的特性，设置入站规则允许某些访问后，如果没有设置相应的出站规则，也会导致无法响应访问。
...
## 计费方式
网络 ACL 服务供用户免费使用。
更多私有网络服务价格，请参见 [计费概述](http://intl.cloud.tencent.com/document/product/215/3079)。

## 操作指南
控制台操作详情，请参见 [操作总览](https://intl.cloud.tencent.com/document/product/215/31850)。
