...
### 使用弹性网卡有什么约束？
根据 CPU 和内存配置不同，云服务器可以绑定的弹性网卡数和单网卡绑定内网 IP 数有较大不同，详情请参见 [使用限制](https://intl.cloud.tencent.com/document/product/576/18527)。

### 弹性公网 IP 不通怎么办？
弹性公网 IP 不通，一般有如下原因：

- 弹性公网 IP 没有绑定云资源。绑定方法的详情请参见 [EIP 绑定云资源](https://intl.cloud.tencent.com/document/product/213/16586)。
