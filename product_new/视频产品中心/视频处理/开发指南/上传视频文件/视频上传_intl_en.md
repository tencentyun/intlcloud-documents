...
- Upload in the console: You can log in to the [COS Console](https://console.cloud.tencent.com/product/cos) and [upload](https://intl.cloud.tencent.com/document/product/436/13321) local video files to a COS bucket. This method is suitable for uploading a small number of videos.
