...
在任务配置部分需要使用已创建的各类型模板，全部参数模板可在 [媒体处理控制台 - 模板设置](https://console.cloud.tencent.com/mps/templates) 中查询，新建自定义参数模板请参见 [模板参数说明](https://intl.cloud.tencent.com/document/product/1041/33494)。
