...
Generally, a UGC or PGC video platform interacts with content providers, content consumers, and VOD in the following ways (for more information on steps 1–3, please see [Upload from Client](https://cloud.tencent.com/document/product/266/9219)):
<img src="https://main.qcloudimg.com/raw/1583662375b390c774d1298e41cda9fd.png" width="400">
1. The video application backend authenticates the content provider and distributes to them a [signature for upload from client](https://cloud.tencent.com/document/product/266/9221) after authentication is passed.
2. The content provider uploads the content to be shared to VOD.
3. VOD notifies the application backend of [relevant information](https://cloud.tencent.com/document/product/266/7830) such as the `FileId` and playback URL of the uploaded video.
...
5. VOD notifies the application backend of the audit result through [ProcedureStateChanged](https://cloud.tencent.com/document/product/266/9636).
