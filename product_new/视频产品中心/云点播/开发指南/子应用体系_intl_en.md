...
3. Click **Use now** to enable the subapplication feature of VOD.
...
* Via Server API: use the [PullUpload](https://intl.cloud.tencent.com/document/product/266/34118) API. For more information, please see [Specifying a Subapplication in a Server API](#p2).
