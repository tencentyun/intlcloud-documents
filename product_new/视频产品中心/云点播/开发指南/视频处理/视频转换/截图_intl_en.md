...
* Call the server API [ProcessMedia](#APIhttps://intL.cloud.tencent.com/document/product/266/33427) to initiate a task: specify the [screencapturing template](#jt) ID in the `MediaProcessTask.SnapshotByTimeOffsetTaskSet` parameter in the request.
