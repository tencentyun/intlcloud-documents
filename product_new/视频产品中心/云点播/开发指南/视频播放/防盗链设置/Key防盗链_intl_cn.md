...
>开启 Key 防盗链请参见 [设置防盗链](https://intl.cloud.tencent.com/document/product/266/14060#key-.E9.98.B2.E7.9B.97.E9.93.BE)。
...
| 参数名 | 必选 | 说明                                                         |
| ------ | ---- | ------------------------------------------------------------ |
| `KEY`    | 是   | 开启 Key 防盗链时填写的密钥。必须由大小写字母（a - Z）或者数字（0 - 9）组成，长度在8 - 20个字符之间。建议在控制台中单击【生成KEY】生成，具体操作步骤请参见 [设置防盗链](https://intl.cloud.tencent.com/document/product/266/14060#key-.E9.98.B2.E7.9B.97.E9.93.BE)。 |
