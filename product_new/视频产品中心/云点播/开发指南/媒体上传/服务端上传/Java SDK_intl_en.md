VOD provides an SDK for Java for uploading videos from a server. For more information on the upload process, please see [Upload Videos from Server](/document/product/266/9759).
