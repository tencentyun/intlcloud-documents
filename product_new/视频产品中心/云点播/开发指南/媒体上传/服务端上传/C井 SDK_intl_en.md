VOD provides an SDK for C# for uploading videos from a server. For more information on the upload process, please see [Upload Videos from Server](/document/product/266/9759).
...
| SubAppId | ID of a [subapplication](/document/product/266/14574) in VOD. If you need to access a resource in a subapplication, enter the subapp ID in this field; otherwise, leave it empty. | Integer | No |
