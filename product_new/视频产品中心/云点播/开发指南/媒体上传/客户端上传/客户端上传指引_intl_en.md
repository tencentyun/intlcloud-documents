...
Activate VOD. For more information, please see [Purchase Guide](https://cloud.tencent.com/document/product/266/2839).
...
The client needs to apply to the signature distribution server of the application for an upload signature. For detailed directions, please see [Signature for Upload from Client](https://cloud.tencent.com/document/product/266/9221). Below are samples of generating signatures in different programming languages:
- [Sample of Signature in PHP](/document/product/266/10638#php-.E7.AD.BE.E5.90.8D.E7.A4.BA.E4.BE.8B)
- [Sample of Signature in Java](/document/product/266/10638#java-.E7.AD.BE.E5.90.8D.E7.A4.BA.E4.BE.8B)
- [Sample of Signature in Node.js](/document/product/266/10638#node.js-.E7.AD.BE.E5.90.8D.E7.A4.BA.E4.BE.8B)
- [Sample of Signature in C#](/document/product/266/10638#c.23-.E7.AD.BE.E5.90.8D.E7.A4.BA.E4.BE.8B)
- [Sample of Signature in Python](https://cloud.tencent.com/document/product/266/10638#python-.E7.AD.BE.E5.90.8D.E7.A4.BA.E4.BE.8B)
...
- [Upload SDK for Web](/document/product/266/9239)

#### Advanced features

- <span id = "p1"></span>**Specify a task flow during upload**
If you want to automatically initiate a [video processing task flow](https://cloud.tencent.com/document/product/266/33475#.E4.BB.BB.E5.8A.A1.E6.B5.81) such as transcoding and screencapturing upon video upload completion, you can set the `procedure` parameter when generating the [upload signature](/document/product/266/9221#.E7.AD.BE.E5.90.8D.E5.8F.82.E6.95.B0), and the parameter value should the name of the desired task flow template. VOD supports [creating task flow templates](https://cloud.tencent.com/document/product/266/33819) and naming them. When initiating a task flow, you can use the task flow template name to indicate the desired task.
- **Specify a storage region during upload**
The storage region provided by VOD is "Chongqing" by default. If you want to store files in another region, you need to activate it in the console. For more information, please see [Upload Storage Settings](/document/product/266/14059). After the settings are made, the storage region can be specified by the `storageRegion` parameter when the [upload signature](/document/product/266/9221#.E7.AD.BE.E5.90.8D.E5.8F.82.E6.95.B0) is generated, and the parameter value should be a [region abbreviation](/document/product/266/9760#.E4.B8.8A.E4.BC.A0.E5.AD.98.E5.82.A8).
...
How to use one-time signature: you just need to set `oneTimeValid` to 1 when the application backend distributes the signature. For more information, please see [Signature for Upload from Client](/document/product/266/9221).
...
You can enable the resumable upload feature for the application as shown below:
	- For the [upload SDK for Android](/document/product/266/9539), set `enableResume` to `True` during upload.
	- For the [upload SDK for iOS](/document/product/266/13793), set `enableResume` to `True` during upload.
	- For the [upload SDK for Web](/document/product/266/9239), resumable upload is a built-in feature with no additional operation needed.
...
After a video upload is completed, VOD will initiate an [event notification - video upload completion](/document/product/266/7830) to the application backend, through which the application backend can become aware of the video upload event. To receive event notifications, you need to go to [Console - Callbacks](https://console.cloud.tencent.com/vod/callback) to enable event notification. [Event notification - video upload completion](/document/product/266/7830) mainly contains the following information:
...
- VOD supports automatic video processing upon video upload completion. If a [video processing task flow](https://cloud.tencent.com/document/product/266/33475#.E4.BB.BB.E5.8A.A1.E6.B5.81) is specified during upload, the task ID will also be included in the event notification content, i.e., the `data.procedureTaskId` field.

For more information, please see:
- [Task Management and Event Notification](https://cloud.tencent.com/document/product/266/33475#.E7.BB.93.E6.9E.9C.E9.80.9A.E7.9F.A5)
- [Event Notification - Video Upload Completion](/document/product/266/7830)
