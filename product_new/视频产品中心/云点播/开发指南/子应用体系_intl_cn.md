...
#### 服务端 API 方式
使用 API 方式进行上传时涉及到 [ApplyUpload](https://cloud.tencent.com/document/product/266/31767) 和 [CommitUpload](https://cloud.tencent.com/document/product/266/31766) 两个接口，具体用法请参见 [在服务端 API 中指定子应用](#p2)。
我们强烈建议使用 SDK 来进行上传。
...
## 权限管理
云点播已接入访问管理 CAM，支持子应用维度的授权，详情请参见 [访问管理](https://cloud.tencent.com/document/product/266/39337)。
