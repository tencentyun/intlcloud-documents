>
>- This document describes the callback on v3.0. For legacy callback on v2.0, please see [Legacy Callback](https://cloud.tencent.com/document/product/266/33796#ClipComplete).
...
## Event Description
If the application is configured with event notification, after a video is clipped, the application backend can get an event notification through "normal callback" or "reliable callback". The content of the event notification is the [`ClipTask2017` structure](https://cloud.tencent.com/document/api/266/31773#ClipTask2017).
