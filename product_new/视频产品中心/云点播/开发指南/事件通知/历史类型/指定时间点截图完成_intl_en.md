>
>- This document describes the callback on v3.0. For legacy callback on v2.0, please see [Legacy Callback](https://cloud.tencent.com/document/product/266/33796#CreateSnapshotByTimeOffsetComplete).
...
## Event Description
If the application is configured with event notification, after a time point screenshot is captured, the application backend can get an event notification through "normal callback" or "reliable callback". The content of the event notification is the [`SnapshotByTimeOffsetTask2017` structure](https://cloud.tencent.com/document/api/266/31773#SnapshotByTimeOffsetTask2017).
