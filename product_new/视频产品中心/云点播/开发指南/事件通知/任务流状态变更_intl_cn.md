...
当 App 配置了事件通知后，在任务流的状态发生变更后，App 后台即可通过“普通回调”或“可靠回调”的方式获取该事件通知。事件通知内容为 [ProcedureTask 结构](https://intl.cloud.tencent.com/document/product/266/34187#ProcedureTask)。
