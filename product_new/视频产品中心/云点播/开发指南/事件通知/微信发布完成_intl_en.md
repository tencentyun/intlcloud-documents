...
## Event Description
If the application is configured with event notification, after a video is published on WeChat, the application backend can get an event notification through "normal callback" or "reliable callback". The content of the event notification is the [`WechatPublishComplete` structure](https://cloud.tencent.com/document/api/266/31773#EventContent).
