...
## 事件说明
当 App 配置了事件通知，并且在微信发布完成后，App 后台即可通过“普通回调”或“可靠回调”的方式获取该事件通知。事件通知内容为 [WechatPublishComplete 结构](https://intl.cloud.tencent.com/document/product/266/34187#EventContent)。
