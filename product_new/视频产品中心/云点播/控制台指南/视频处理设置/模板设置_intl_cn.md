...
您可根据业务需要使用自适应码流模板，自适应码流模板为系统预设模板，不支持自定义创建。
+ 模板 ID：10
+ 模板类型：系统预设
+ 打包类型：HLS
+ DRM 类型：不加密
...
### 时间点截图
在截图类型中选择时间点截图，**采样的时间点需在截图任务配置中指定，模板设置中仅进行截图类型的配置**，时间点的截图任务配置请参见 [任务配置说明](https://intl.cloud.tencent.com/document/product/266/14058#p1)。
...
## 转动图模板
您可根据业务需要创建转动图模板，按照指定时间段截取所需要的转动图。**转动图的时间段需在任务流的转动图任务配置中指定，模板设置中仅进行转动图类型设置**，转动图任务配置请参见 [任务配置说明](https://intl.cloud.tencent.com/document/product/266/14058#p1)。
...
| 20002   | WebP                | 320 x 等比缩放 | 10          |
| 20003   | WebP               | 等比缩放 x 360 |  10          |
| 20004   | WebP                | 同源                 | 10          |
| 20005   | WebP               |540 x 960    | 10         |
