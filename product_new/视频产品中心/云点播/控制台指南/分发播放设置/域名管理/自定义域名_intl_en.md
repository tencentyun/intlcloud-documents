...
## Prerequisites
- You have activated VOD. For more information, please see [Purchase Guide](https://cloud.tencent.com/document/product/266/2839).
...
>The following uses Tencent Cloud DNS as the DNS service provider to illustrate how to add a CNAME record. The detailed steps vary by provider. For more information, please see [CNAME Configuration](https://cloud.tencent.com/document/product/570/11134).
