...
Tencent Cloud can help you apply for ICP filing for your website with a server located in Mainland China. For more information, see [Website ICP Filing Application](https://intl.cloud.tencent.com/product/cns). You can also complete the application process through other cloud service providers or on the website of [the Ministry of Industry and Information Technology](https://intl.cloud.tencent.com/product/icp) on your own.
