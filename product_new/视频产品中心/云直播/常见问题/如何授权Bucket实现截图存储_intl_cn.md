...
>!
> - Bucket name 为 examplebucket，不含右侧数字。  
> - 以上信息均可按照业务实际需要配置。
3. 您可以根据业务需求开启 COS bucket 的 CDN 加速，单击已创建的存储桶名称或【配置管理】，单击左侧的【域名与传输管理】>【默认 CDN 加速域名】，在【默认 CDN 加速域名】配置项中单击【编辑】，把当前状态设置为开启，然后配置下方选项，具体配置方法可参见 [开启默认 CDN 加速域名](https://intl.cloud.tencent.com/zh/document/product/436/31505)，配置完成之后点击【保存】即可开启CDN加速。
