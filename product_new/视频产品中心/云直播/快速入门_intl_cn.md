本教程将指引您快速了解云直播服务。在您试用云直播服务前，建议您提前阅读云直播 [价格总览](https://intl.cloud.tencent.com/document/product/267/2819)，清楚**收费项目**和**价格**，避免产生误解。
...
您可通过使用【自有域名】添加已完成备案的自有域名；也可以在通过身份核验后使用【域名租赁】，租赁腾讯云提供的播放域名，快速体验和使用直播服务。
...
3. 单击【添加域名】，选择域名类型为【自有域名】，单击【确定】进入自有域名添加页。
...
>- 如果您使用其他 DNS 服务商，更多操作请参见 [CNAME 配置](https://intl.cloud.tencent.com/document/product/267/31057)。

<span id="step1_2"></span>
### 添加租赁域名
1. 登录云直播控制台，选择[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)。
2. 单击【添加域名】，选择域名类型为【域名租赁】，单击【确定】。
3. 进入域名租赁身份核验页，单击上传手持身份证照片，输入身份证号码和姓名，单击【确定】提交身份核验。
4. 身份核验通过后，单击【继续完成域名租赁】，进入租赁域名添加页。
5. 自定义输入4 - 9位的数字或字母的域名前缀，单击【确定】。 
6. 弹窗提示，单击【前往购买】进入域名租赁资源包购买页。
7. 选择您所需购买的套餐配额，单击【立即购买】。
8. 付款成功后，返回域名租赁添加页，单击【已完成购买】即可成功添加租赁域名。

>
>- 初次使用域名租赁，建议先完成身份核验再购买资源包，避免因身份核验不通过而无法使用租赁资源包。
>- 云直播默认提供测试域名`xxxx.livepush.myqcloud.com`，您可通过该域名进行推流测试，但不建议您在正式业务中使用这个域名作为推流域名。
>- 域名添加成功后，您可通过[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)的域名列表查看域名信息。若您需要对已添加成功的域名进行管理。
...
>- 您可根据实际业务需求，在生成推流地址前配置创建对应的 [功能模板](https://intl.cloud.tencent.com/document/product/267/34223，并关联到推流域名下。增值功能价格请参见 [价格总览](https://intl.cloud.tencent.com/document/product/267/2819) 。
...
- 小程序推流，通过微信搜索小程序 [“腾讯视频云”](https://intl.cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.A8.8B.E5.BA.8F-demo)，选择【RTMP 推流】，填入推流地址，单击【开始】开始推流。	
...
3. 您可以根据业务场景使用以下方式测试直播流是否能正常播放：
   1. PC 端直播流测试，建议您使用VLC 等工具进行播放体验，具体请参见 [播放实践](https://intl.cloud.tencent.com/document/product/267/31559#.E5.9C.BA.E6.99.AF.E5.9B.9B.EF.BC.9Aweb-.E7.AB.AF.E6.92.AD.E6.94.BE)。
   2. Web 端播放测试，建议您选用播放器 SDK 里的  TCPlayerLite 播放器 进行播放，具体请参见 [直播播放](https://intl.cloud.tencent.com/document/product/267/31559)。
   3. 小程序直播流测试，建议您通过微信搜索小程序 [“腾讯视频云”](https://intl.cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.A8.8B.E5.BA.8F-demo)，选中【直播播放】，扫描直播地址二维码，单击左下角播放按钮播放观看。
