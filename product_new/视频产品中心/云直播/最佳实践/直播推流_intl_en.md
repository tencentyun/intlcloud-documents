...
1. Get a push address.
  ...
  Tap **New** to the right of the push address bar on the Camera Push page, and the system will automatically create a push address and generate four QR codes of the playback address which will be automatically copied to the clipboard for you to paste into the player. You can also scan a QR code to watch the video. See the figure below:
