...
- **Playback domain name**
 ...
 - If you already have a domain name, you can apply for [ICP filing](https://cloud.tencent.com/product/ba) and then add it in [Domain Name Management](https://console.cloud.tencent.com/live/domainmanage).
