...
>
>- 为了保障您的直播安全，系统会自动开启推流鉴权。您也可以在[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)>对应推流域名>【推流配置】中，自定义设置鉴权信息。推流地址格式为：
...
>- 若您需要**长效的推流地址**，您可进入[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)，选择推流域名单击【管理】，选择【推流配置】，参考【推流地址实例代码】中的示例代码进行计算生成。
## 直播推流
...
## 直播播放
详细直播播放方法，请参见 [直播播放](https://intl.cloud.tencent.com/document/product/267/31559)。

## 常见问题
**后台如何自动拼装推流地址？**
   您可以参考 [常见问题-如何自主拼装推流URL](https://intl.cloud.tencent.com/document/product/267/32480)。

**防盗链是如何计算的？**
    您可以参考 [最佳实践-防盗链的计算](https://intl.cloud.tencent.com/document/product/267/31560)。
