...
1. Log in to the Tencent Cloud Console and go to the [LVB](https://console.cloud.tencent.com/live) service in the navigation bar. Click **Manage Domain** in the left sidebar to enter the domain name management page and get the CNAME address.
...
![](https://main.qcloudimg.com/raw/2f3b789874c7c7968679e6282c14f260.png)
 ...
 - Record Value: enter the CNAME value corresponding to the domain name on the domain name management page in the Tencent Cloud Console in the format of domain.livecdn.liveplay.myqcloud.com.
 - TTL: it is recommended to select 10 minutes.
Click **OK** to submit.

5. Verify whether the CNAME record is in effect. Once configured, the CNAME record will take effect in about 15 minutes. If <img src="https://main.qcloudimg.com/raw/8283d3a1d6e6993df5b81f5034b3bbb9.png"  style="margin:0;"> is displayed for the CNAME value corresponding to the domain name on the domain name management page of LVB, the CNAME record is configured successful. If the record does not take effect after a long time, see [CNAME Configuration Troubleshooting](https://cloud.tencent.com/document/product/267/30010#.E9.85.8D.E7.BD.AE.E5.AE.8C.E6.88.90-cname-.E5.90.8E.EF.BC.8C.E4.BE.9D.E6.97.A7.E6.98.BE.E7.A4.BA-cname-.E6.9C.AA.E9.85.8D.E7.BD.AE.E6.98.AF.E4.BB.80.E4.B9.88.E5.8E.9F.E5.9B.A0.EF.BC.9F).

>? The instructions in this document are based on the Alibaba Cloud version as of March 1, 2019. If the Alibaba Cloud Console is updated but this document has not, please adjust the steps as needed. If you are unable to set up a record successfully, please [contact our customer service](https://cloud.tencent.com/about/connect).
...
>? The instructions in this document are based on the Baidu Cloud version as of March 1, 2019. If the Baidu Cloud Console is updated but this document has not, please adjust the steps as needed. If you are unable to set up a record successfully, please [contact our customer service](https://cloud.tencent.com/about/connect).
