...
1. 登录 实时音视频控制台，单击【创建应用】。
 如果您已有应用，请记录其 SDKAppID 然后直接 [下载 SDK 和 Demo 源码](#step-2.-download-the-sdk-and-demo-source-code)。否则，继续执行下一步。
...
1. 在 [步骤2](#step-2.-download-the-sdk-and-demo-source-code) 中解压的 Demo 源码包目录中，找到并打开 `GenerateTestUserSig`文件。
  <table>
     <tr>
