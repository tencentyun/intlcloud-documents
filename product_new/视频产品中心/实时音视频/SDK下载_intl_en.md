...
The lite edition only includes TRTC and TXLivePlayer and has the smallest storage footprint. It is suitable for users focusing on TRTC-related features.
...
<table>
   <tr>
      ...
      <th width="0px" style="text-align:center">Impact on Installation Package Size</td>
   </tr>
   <tr>
...
>? 
> - Read [How to Downsize Installation Package](https://cloud.tencent.com/document/product/647/34400) to learn how to reduce the storage footprint of the SDK.
...
In addition to TRTC, the professional edition incorporates various audio/video-related features including [Superplayer (Player+)](https://cloud.tencent.com/product/player), [MLVB](https://cloud.tencent.com/product/mlvb), and [UGSV](https://cloud.tencent.com/product/ugsv). Because the core modules are highly reusable, the professional edition has a lower storage footprint than the two individual SDKs combined and also avoids symbol duplicate.
...
<table>
   <tr>
      ...
      <th width="0px" style="text-align:center">Impact on Installation Package Size</td>
      <th width="0px" style="text-align:center">Downsize Installation Package</td>
   </tr>
   <tr>
      <td style="text-align:center">iOS</td>
...
In addition to all the features of the Professional edition, the enterprise edition includes a set of AI special-effect components such as eye enlarging, face slimming, beauty filter, and dynamic stickers. To run the enterprise edition, contact a Tencent Cloud sales reps to obtain the decompression password and license after downloading it.
...
<table>
  <tr>
    ...
    <th width="100px" style="text-align:center"><a href="https://cloud.tencent.com/document/product/454/7873"></a><br>LiteAV_Smart</th>
    <th width="100px" style="text-align:center"><a href="https://cloud.tencent.com/document/product/584/9366"></a><br>LiteAV_UGC</th>
    <th width="100px" style="text-align:center"><a href="https://cloud.tencent.com/document/product/647/32689"></a><br>LiteAV_TRTC</th>
  ...
  <tr>
    <td rowspan='2' style="text-align:center">Live Push</td>
    <td style="text-align:center">Camera Push</td>
   ...
   <tr>
    <td style="text-align:center">Screencapturing Push</td>
    <td style="text-align:center">&#10003;</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
  ...
  <tr>
    <td rowspan='3' style="text-align:center">LVB Playback</td>
  ...
  <tr>
    <td rowspan='2' style="text-align:center">LVB Co-anchoring</td>
  ...
  <tr>
    ...
    <td style="text-align:center">Two-person call</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">&#10003;</td>
    <td style="text-align:center">-</td>
  ...
  <tr>
    <td rowspan='4' style="text-align:center">AI Special Effects</td>
  ...
  <tr>
    <td style="text-align:center">Face V-shaping/Nose Beautifying</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
  ...
  <tr>
    <td style="text-align:center">Dynamic Stickers</td>
   <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
    <td style="text-align:center">-</td>
