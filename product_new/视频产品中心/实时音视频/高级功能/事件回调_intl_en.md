...
| Field                   | Value| Description            |
| ----------------------- | ---- | ---------------------- |
| EVENT_TYPE_CREATE_ROOM  | 101  | Room created           |
| EVENT_TYPE_DISMISS_ROOM | 102  | Room closed            |
| EVENT_TYPE_ENTER_ROOM   | 103  | Room entered           |
| EVENT_TYPE_EXIT_ROOM    | 104  | Room exited            |
| EVENT_TYPE_START_VIDEO  | 201  | Start to send video    |
| EVENT_TYPE_STOP_VIDEO   | 202  | Stop to send video     |
| EVENT_TYPE_START_AUDIO  | 203  | Start to send audio    |
| EVENT_TYPE_STOP_AUDIO   | 204  | Stop to send audio     |
| EVENT_TYPE_START_ASSIT  | 205  | Start to send metadata |
| EVENT_TYPE_STOP_ASSIT   | 206  | Stop to send metadata  |
