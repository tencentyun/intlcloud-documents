商用的音视频解决方案考虑到取证、质检、审核和存档等场景，可能会有录制的需求。实时音视频服务使用 [云直播](https://intl.cloud.tencent.com/document/product/267) 服务的能力为您提供全程的云端录制功能，录制下来的文件可以通过 [云点播](https://intl.cloud.tencent.com/document/product/266) 平台获取。
