...
|ERR_SERVER_SSO_VERIFICATION_EXPIRED|-70017|内部第三方票据验证超时，请重试|
|ERR_SERVER_SSO_VERIFICATION_FAILED|-70018|内部第三方票据验证超时，请重试|
|ERR_SERVER_SSO_APPID_NOT_FOUND|-70020|sdkAppId 未找到，请确认是否已经在腾讯云上配置|
|ERR_SERVER_SSO_ACCOUNT_IN_BLACKLIST|-70051|帐号已被拉入黑名单|
...
|ERR_SERVER_SSO_ACCOUNT_EXCEED_PURCHASES|-70398|创建账号数量超过数量限制|
