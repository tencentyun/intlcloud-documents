...
|---|---|---|
|ERR_NULL|0|No error|
|ERR_CAMERA_START_FAIL|-1301|Failed to enable the camera; for example, the configuration program (driver) of the camera on Windows or macOS was exceptional. In this case, please try to disable the camera and then enable it again, restart the device, or update the configuration program|
...
|ERR_MIC_START_FAIL|-1302|Failed to enable the mic; for example, the configuration program (driver) of the mic on Windows or macOS was exceptional. In this case, please try to disable the mic and then enable it again, restart the device, or update the configuration program|
...
|ERR_SPEAKER_START_FAIL|-1321|Failed to enable the speaker; for example, the configuration program (driver) of the speaker on Windows or macOS was exceptional. In this case, please try to disable the speaker and then enable it again, restart the device, or update the configuration program|
