...
## 准备工作
在使用基本功能前，请确保您已完成以下骤，详见 [跑通Demo(小程序)](https://intl.cloud.tencent.com/document/product/647/35123/35087)，[快速集成(小程序)](https://intl.cloud.tencent.com/document/product/647/35123/35098)。
...
## 部署签名服务
在初始化组件时需要签名服务进行签发 userSig，详情请参见 [如何计算 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。

## 集成&lt;webrtc-room&gt; 组件
阅读文档 [集成SDK（小程序）](https://intl.cloud.tencent.com/document/product/647/35123/35096)，并按照里面的步骤将 &lt;webrtc-room&gt; 组件导入到您的小程序工程中之后，即可以按照如下步骤操作基本的音视频功能。
...
- **userSig**
基于 sdkAppID 和 userID 可以计算出 userSig，计算方法请参见 [如何计算 UserSig](https://intl.cloud.tencent.com/document/product/647/35166)。
