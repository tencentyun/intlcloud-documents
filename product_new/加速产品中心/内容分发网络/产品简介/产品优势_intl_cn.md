...
**统计监控**
腾讯云 CDN 为您提供了多维度的数据分析，包括消耗统计、访问统计、请求状态统计、源站数据统计等。若您需要对此类统计数据进行实时监控，可至 [云监控](https://intl.cloud.tencent.com/product/cm) 配置相应告警，便于您实时了解业务状态。同时，腾讯云 CDN 每月会为您提供运营数据月报，便于您了解月度业务波动。
...
以上是使用业界通用的基调对比测试得出的结果，详细测试数据和结果可以查阅 [CDN性能说明（抽样）](https://intl.cloud.tencent.com/doc/product/228/1198) 。
