Tencent Cloud CDN offers a tool to check if a node IP is hosted by its own cloud. You can use this tool to check whether the node IP is a Tencent Cloud CDN node IP.  
