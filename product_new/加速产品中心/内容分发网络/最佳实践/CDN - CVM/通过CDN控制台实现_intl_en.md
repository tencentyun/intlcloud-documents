...
>According to regulations, if the origin server is at an accelerated domain name of Tencent Cloud CVM, the domain name configured for the host header should obtain an ICP filing for services in Mainland China through Tencent Cloud. For more information, please see [Host header configuration](https://intl.cloud.tencent.com/document/product/228/6293).
