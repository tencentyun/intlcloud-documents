### 什么是缓存刷新？
缓存刷新方式有 URL 刷新、目录刷新和 URL 预热。（详细操作步骤请参见 [缓存刷新](https://itnl.cloud.tencent.com/document/product/228/6299)）
- URL 刷新是以文件为单位进行缓存刷新。
...
### 怎么查看缓存刷新的记录？
您可以在 CDN 控制台中查看缓存刷新的记录，详情请参见 [操作记录](https://intl.cloud.tencent.com/document/product/228/6299#.E6.93.8D.E4.BD.9C.E8.AE.B0.E5.BD.95)。
