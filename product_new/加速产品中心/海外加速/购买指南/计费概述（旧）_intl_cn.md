> 海外加速（GCD）产品的通用计费模式将于2020年1月1日00:00起，从按量付费按月结算，升级为按量付费按日结算。本文档为升级前的计费模式，有效期截止至2019年12月31日。[计费概述（新）](https://intl.cloud.tencent.com/document/product/1014/30437)为升级后的计费模式，将于2020年1月1日起生效。
