...
- Your password is shared by multiple users, leading to high risk of leakage.
- You cannot limit the access permission of other users, leading to security risks due to possible operational errors.
