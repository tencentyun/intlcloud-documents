## 操作场景
BGP 高防包支持查看近90天内重要操作的日志，如有需要，您可以登录 [DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview) 查看。可查看的日志包含以下类别：
- 防护对象 IP 更换日志         
- DDoS 高级防护策略变更操作日志 
- 清洗阈值调整日志
- 防护等级变更日志   
...
>- 独享包：指提供单个 IP 独享 DDoS 防护能力的 BGP 高防包。
>- 共享包：指提供多个 IP 共享 DDoS 防护能力的 BGP 高防包。
