...
CMK 密钥轮换为用户提供透明密钥轮换能力，CMK 密钥轮换后不影响用户业务，兼容轮换前加密的密文，此外提供 [ReEncrypt ](https://intl.cloud.tencent.com/document/product/1030/32183)接口可以将密文刷新。本文为您介绍如何通过控制台启用密钥轮换。
