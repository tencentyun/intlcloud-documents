...
以腾讯云 CVM 为例，当用户调用腾讯云 CVM 的查看实例列表（DescribeInstances）接口时，其请求参数为：
...
| 4101 | 未被开发商授权访问本接口 | 该子用户未被授权调用此接口。请联系开发商授权，详情请查阅 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。|
| 4102 | 未被开发商授权访问本接口中所操作的资源 | 请求的资源参数中，存在未被开发商授权访问的资源，请在 message 字段中查看无权查看的资源 ID。</br>请联系开发商授权，详情请查阅 [授权管理](https://intl.cloud.tencent.com/document/product/598/10602)。|
