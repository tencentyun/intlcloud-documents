...
</td><td> 具体操作的指令接口名称，例如想要调用 <a href="https://intl.cloud.tencent.com/document/product/378/4400" title="查询项目列表">查询项目列表</a> 接口，则 Action 参数即为 DescribeProject。
</td><td> 是
</td></tr>
<tr>
<td> Region
</td><td> String
</td><td> 区域参数。各区域的参数值为：<br>北京：bj，广州：gz，上海：sh，中国香港：hk，北美：ca。
</td><td> 否
</td></tr>
<tr>
<td> Timestamp
...
假设用户想要查询当前账号下的项目列表，则其请求链接的形式可能如下：
...
一个完整的请求需要两类请求参数：公共请求参数和接口请求参数。这里只列出了上述5个公共请求参数，并未列出接口请求参数，有关接口请求参数的说明可见 <a href="/doc/api/372/接口请求参数" title="接口请求参数">接口请求参数</a> 小节。
