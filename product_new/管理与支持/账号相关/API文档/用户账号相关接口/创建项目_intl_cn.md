...
- 接口名：AddProject。
- 接口描述：创建项目。项目为一个虚拟概念，用户可以在一个账户下面建立多个项目，每个项目中管理不同的资源。一个账号下最多创建100个项目。
...
<th><b>描述</b></th>
<tr>
<td> projectName <td> 是 <td> String <td> 待创建的项目名称，名称只允许为“中文”、“英文”或者“数字” 三者组成
<tr>
<td> projectDesc <td> 否 <td> String <td> 待创建的项目描述
</tbody></table>
