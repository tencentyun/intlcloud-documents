...
|-60972|无效地域。|请检查请求地域是否支持数据万象服务。万象现有地域详见 [地域与域名](https://intl.cloud.tencent.com/document/product/1045/33423)。|
...
其他透传自 COS 下载侧错误码详见 [COS 错误码](https://intl.cloud.tencent.com/document/product/436/7730)。