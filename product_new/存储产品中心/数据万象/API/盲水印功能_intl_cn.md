...
盲水印是付费服务，使用时需在相应 bucket 配置页中通过开关开通服务。每个账户拥有三千次免费额度，超出后进行计费。具体费用请查阅 [购买指南](https://intl.cloud.tencent.com/document/product/1045/33431)。
...
>!
- COS 简单上传文件接口详情，请查阅 [COS 文档](https://intl.cloud.tencent.com/document/product/436/7749)。
...
>!
>- COS 简单上传文件接口详情，请参见 [COS 文档](https://intl.cloud.tencent.com/document/product/436/7749)。
>- Authorization: Auth String （详细请参见 [请求签名](https://intl.cloud.tencent.com/document/product/436/7778) 章节）。
