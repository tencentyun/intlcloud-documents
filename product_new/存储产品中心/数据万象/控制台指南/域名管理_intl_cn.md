https://intl.cloud.tencent.com/document/product/1045/33431## 基本概念
...
例如：test-1250000000.picsgp.myqcloud.com
```
...
**系统分配域名- 内网跨区域访问：** 系统分配域名可以用于在同区域的不同腾讯云产品之间进行访问。但是，若需要实现内网跨区域的访问， 例如，所在区域为中国香港的 CVM 需要使用新加坡的数据万象上的数据，则需要使用 VPC 部署专属网络通道，实现高速访问体验。请查看 [私有网络](https://intl.cloud.tencent.com/product/vpc)。
...
![示例3](https://main.qcloudimg.com/raw/56e43e68a65383896809c10802e5542f.png)
>请到相应的域名解析商处进行配置，此处以腾讯云解析为例。

4. 单击【添加】，添加一条  CNAME 记录。
![示例4](https://main.qcloudimg.com/raw/ad59496dd74d261e84da91ed8a2b2462.png)
...
>开启静态网站功能，可通过自定义域名直接打开浏览文件，关于如何开启静态网站功能，请参考 [静态网站托管](https://intl.cloud.tencent.com/document/product/436/14984) 。
