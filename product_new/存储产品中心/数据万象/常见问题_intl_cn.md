### 数据万象有哪些图片处理功能？
数据万象拥有缩放、裁剪、转码、水印等图片处理功能，还提供盲水印、二维码识别等增值服务，满足您的多种业务需求。
...
### 图片处理如何收费？
数据万象对基础图片处理、盲水印、二维码识别等功能以及请求过程中产生的CDN 回源流量和外网出流量收取费用。费用详情请参考 [购买指南](https://intl.cloud.tencent.com/document/product/1045/33431)。
...
原因可能是原图 EXIF 信息过多，占了大部分图片容量，一次调整图片分辨率后，图片大小没有太大的变化。可使用 Strip参数，过滤 EXIF 信息。具体使用方法请参照 [去除元信息](https://intl.cloud.tencent.com/document/product/1045/33725)。
