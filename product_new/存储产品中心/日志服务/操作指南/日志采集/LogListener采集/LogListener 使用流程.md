...
4. 前往日志主题的采集配置页，输入日志路径确定数据源，并绑定机器组。详细操作示例可参阅 [单行全文采集](https://intl.cloud.tencent.com/document/product/614/17421) 文档。
5. 前往日志主题的索引配置页，配置全文或键值索引，并开启索引。详细操作示例可参阅 [单行全文采集](https://intl.cloud.tencent.com/document/product/614/17421) 文档。
