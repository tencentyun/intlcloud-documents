...
## 操作步骤
>本例通过控制台购买一块弹性普通云硬盘，更多关于如何创建云硬盘的详细内容，请参考 [创建云硬盘](https://intl.cloud.tencent.com/document/product/362/5744)。
...
## 后续操作
云硬盘创建完成后，您需要将其挂载到同一可用区中的云服务器上才能被当做数据盘使用，具体操作请参考 [挂载云硬盘](https://intl.cloud.tencent.com/document/product/362/31594)。
