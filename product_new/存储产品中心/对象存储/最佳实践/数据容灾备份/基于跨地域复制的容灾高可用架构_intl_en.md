...
The cross-region replication feature of COS enables cross-region sync of incremental data. Data you upload can be copied to a bucket in another region in seconds or minutes, depending on the file size and distance. Cross-region replication allows you to make a remote redundant backup of data for disaster recovery and business continuity. For more information, please see [Cross-region Replication Overview](https://intl.intl.cloud.tencent.com/document/product/436/19237). To enable this feature, you need to enable versioning first. For more information on versioning, please see [Versioning Overview](https://intl.intl.cloud.tencent.com/document/product/436/19883).
...
- [Scheduled Automatic Testing and Alarming via Email](https://cloud.tencent.com/document/product/583/35399)
