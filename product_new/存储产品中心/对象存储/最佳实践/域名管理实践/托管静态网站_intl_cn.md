...
- [内容分发网络 CDN](https://intl.cloud.tencent.com/product/cdn)：结合 CDN 和 DNS 解析服务，使得域名和网站内容绑定的同时，还可以为静态网站加速，降低访问延迟，提高可用性。
...
- 已注册域名但未备案，请进行 [域名备案](https://intl.cloud.tencent.com/product/icp)。
- 未注册域名，请先 [注册域名](https://dnspod.cloud.tencent.com/?from=qcloud)，再进行 [域名备案](https://intl.cloud.tencent.com/product/icp)。
...
如您首次使用 COS，可以通过控制台的概览界面上的【创建存储桶】直接创建存储桶，或者单击左侧【存储桶列表】导航栏进行创建，具体操作请参见 [创建存储桶](https://intl.cloud.tencent.com/document/product/436/13309) 文档。
...
（2）将您的网站内容上传到已创建好的存储桶。具体操作请参见 [上传对象](https://intl.cloud.tencent.com/document/product/436/13321) 文档。
