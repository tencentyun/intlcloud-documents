...
首先，我们需要先了解几个关键概念：主账号、子账号（用户）和用户。CAM 的相关术语、配置详细描述请查阅 [CAM 概述](https://intl.cloud.tencent.com/document/product/598/10583)。
...
4. 根据系统提供的策略选择，可配置简单的策略，如 COS 的存储桶列表的访问权限，只读权限等。如需配置更复杂的策略，可进行 [步骤二：对子账号授予权限](#.E6.AD.A5.E9.AA.A4.E4.BA.8C.EF.BC.9A.E5.AF.B9.E5.AD.90.E8.B4.A6.E5.8F.B7.E6.8E.88.E4.BA.88.E6.9D.83.E9.99.90)。
...
## 策略示例
以下提供几种典型场景的策略示例，在配置自定义策略时，您可将以下参考策略复制粘贴至输入框【编辑策略内容】，根据实际配置修改即可。更多 COS 常见场景的策略语法请参阅 [CAM 产品文档](https://intl.cloud.tencent.com/document/product/598) 的**商用案例**部分。
...
更丰富的生效条件填写，可查看 [生效条件](https://intl.cloud.tencent.com/document/product/598/10608)。
