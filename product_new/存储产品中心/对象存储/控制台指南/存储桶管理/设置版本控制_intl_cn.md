...
4. 开启版本控制后，单击显示历史版本。若您将同名文件上传到该存储桶，将会看到您在不同时间点所上传的同名文件；或者在您删除文件后，将会看到文件被删除的记录，而删除前的同名文件仍然保留。您可以根据不同版本对文件进行删除或找回。
![](https://main.qcloudimg.com/raw/8c6f1392b492d7e756edd846a45fa42c.png)
