...
3. 在存储桶详情的【文件列表】选项页下，找到需要设置权限的对象，并单击右侧的【详情】，进入文件详情页。（若是文件夹，可单击右侧的【设置权限】）。
![](https://main.qcloudimg.com/raw/abf28489e1fd4dd76eac0b0878284a73.jpg)
4. 单击【对象权限】页签，根据实际需求设置访问权限（如赋予子账号对象权限，子账号 ID 可在 [访问管理](https://console.cloud.tencent.com/cam) 控制台查看）。
![](https://main.qcloudimg.com/raw/f193b4c5c26fb8ce00d13432fb4c93f6.jpg)
6. 最后单击【保存】，即可修改对象的访问权限。
