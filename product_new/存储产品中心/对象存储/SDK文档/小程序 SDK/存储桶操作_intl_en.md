...
| GrantRead        | Grants the grantee the read permission in the format of id=" ",id=" "<br>When you need to authorize a sub-account, use `id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`<br>When you need to authorize a root account, use `id="qcs::cam::uin/<OwnerUin>:uin/<OwnerUin>"`<br>Examples: `'id="qcs::cam::uin/100000000001:uin/100000000001", id="qcs::cam::uin/100000000001:uin/100000000011"'` | String | No |
...
This API is used to delete an empty bucket under the specified account. If the deletion is successful, the returned HTTP status code will be 200 or 204.
...
| - - ID | A string representing the user ID <br>Format: `qcs::cam::uin/100000000001:uin/100000000001` <br>Here, 100000000001 is uin | Object | No |
...
| - - - ID | A string representing the user ID <br>Format: `qcs::cam::uin/100000000001:uin/100000000001` <br>Here, 100000000001 is uin | String | No |
