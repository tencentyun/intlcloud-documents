...
| Key                    | 对象键（Object 的名称），对象在存储桶中的唯一标识，详情请参见 [对象键说明](https://intl.cloud.tencent.com/document/product/436/13324) | String   | 是   |
...
>?该接口是读取文件内容到 JS 变量，如果需要发起浏览器下载文件，可以通过 cos.getObjectUrl 获取 url 再触发浏览器下载，详情请参见 [预签名 URL](https://intl.cloud.tencent.com/document/product/436/31711) 文档。
...
| - - Key                   | 对象键（Object 的名称），对象在存储桶中的唯一标识，详情请参见 [对象键说明](https://intl.cloud.tencent.com/document/product/436/13324) | String      |
...
| Bucket             | 存储桶的名称，命名格式为 BucketName-APPID，此处填写的存储桶名称必须为此格式 | String  | 是   |
| Region             | 存储桶所在地域，枚举值请参见 [地域和访问域名](https://intl.cloud.tencent.com/document/product/436/6224) | String  | 是   |
| Key                | 对象键（对象的名称），对象在存储桶中的唯一标识，详情请参见 [对象键说明](https://intl.cloud.tencent.com/document/product/436/13324) | String  | 是   |
