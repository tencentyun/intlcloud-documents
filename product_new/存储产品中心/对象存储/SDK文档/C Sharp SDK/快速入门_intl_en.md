...
#### Relevant Resources
- The COS XML SDK for C# source code can be downloaded [here](https://github.com/tencentyun/qcloud-sdk-dotnet).
- The sample demo can be download [here](https://github.com/tencentyun/qcloud-sdk-dotnet-demo).

#### Environmental Dependency
- COS XML SDK for C#: Developed based on .NET Standard 2.0.
