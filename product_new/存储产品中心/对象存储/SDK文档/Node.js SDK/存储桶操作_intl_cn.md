...
| - - Location     | 存储桶所在地域。枚举值请参见 [地域和访问域名](https://intl.cloud.tencent.com/document/product/436/6224) 文档，例如 ap-guangzhou，ap-beijing，ap-hongkong 等 | String |
...
| - - - URI           | 预设用户组，请参见 [ACL 概述](https://intl.cloud.tencent.com/document/product/436/30583) 文档中预设用户组部分，例如<br>`http://cam.qcloud.com/groups/global/AllUsers`或<br>`http://cam.qcloud.com/groups/global/AuthenticatedUsers` | String      |    否  |
