...
>?关于本文中出现的 SecretId、SecretKey、Bucket 等名称的含义和获取方式请参考 [COS 术语信息](https://intl.cloud.tencent.com/document/product/436/18507)。
...
| - Region | Bucket 所在地域，枚举值请见：[Bucket 地域信息](https://intl.cloud.tencent.com/document/product/436/6224) | String   |
...
| - Key     | 对象键（Object 的名称），对象在存储桶中的唯一标识，了解更多可参阅 [对象键说明](https://intl.cloud.tencent.com/document/product/436/13324) | String   | 否   |
