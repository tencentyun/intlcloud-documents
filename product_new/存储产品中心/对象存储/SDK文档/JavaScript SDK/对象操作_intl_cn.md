...
| - headers         | 请求返回的头部信息                                           | Object      |
| - statusCode      | 请求返回的 HTTP 状态码，例如200、403、404等                  | Number      |
| - Name            | 存储桶的名称，格式为 BucketName-APPID，如 examplebucket-1250000000 | String      |
...
| UploadAddMetaMd5       | 当上传时，给对象的元数据信息增加 x-cos-meta-md5 赋值为对象内容的 MD5 值，格式为32位小写字符串。例如4d00d79b6733c9cc066584a02ed03410 | String           | 否   |
...
> !建议对象大小1MB - 5GB，超过5GB的对象请使用高级接口复制对象 [Slice Copy File](https://intl.cloud.tencent.com/document/product/436/31538)。
...
cos.putObjectAcl({
    ...
    AccessControlPolicy: {
        ...
        "Grants": [{
            "Grantee": {
                "ID": "qcs::cam::uin/100000000011:uin/100000000011", // 100000000011 是 UIN 账号
            },
            "Permission": "WRITE"
        }]
    }
