...
策略内容可保持为默认，也可根据实际需求编辑策略内容（详见策略 [语法结构](https://intl.cloud.tencent.com/document/product/598/10604) 和 [支持 CAM 的产品](https://intl.cloud.tencent.com/document/product/598/10588)）。
