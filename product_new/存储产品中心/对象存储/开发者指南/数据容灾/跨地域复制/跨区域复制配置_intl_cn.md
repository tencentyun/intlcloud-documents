...
## 使用方法
### 使用对象存储控制台
通过对象存储控制台设置跨地域复制规则，请参见 [设置跨地域复制](https://intl.cloud.tencent.com/document/product/436/19235) 控制台指南文档。
### 使用 REST API
...
### 使用 C++ SDK
对象存储 COS 的 C++ SDK 中提供了该方法，请参见 C++ [存储桶管理](https://intl.cloud.tencent.com/document/product/436/31523) 文档进行设置。
