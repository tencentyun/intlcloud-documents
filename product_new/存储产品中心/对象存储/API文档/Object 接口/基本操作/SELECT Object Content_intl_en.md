...
The following table shows the composition of the elements in a request body:
...
| RequestProgress | SelectRequest | Whether to return the query progress information (QueryProgress). If this parameter is selected, COS Select will periodically return the query progress information. | Container | No |

**InputSerialization container element**

| Node Name | Parent Node | Description | Type | Required |
| --------------- | ------------------ | ------------------------------------------------------------ | --------- | ---------------------------- |
| CompressionType | InputSerialization | Describes the compression format of the object to be extracted: <br><li>If the object has not been compressed, this parameter is NONE<br><li>If the object has been compressed, COS Select currently supports gzip and bzip2 formats. Value range: NONE, GZIP, and BZIP2. Default value: NONE. | String | No |
| CSV/JSON | InputSerialization | Describes the required file parameters under the corresponding object format. For example, for CSV format, the delimiter needs to be specified. | Container | Yes<br>CSV or JSON |
...
| FieldDelimiter | CSV | Specifies the character separating rows in a CSV object, which is `,` by default. You can specify any octal character. This parameter supports up to 1 byte. Default value: `, `. | String | No |
...
| InvalidRequestParameter | The input RecordDelimiter of CSV is invalid | The record delimiter of the CSV file is invalid. | 400 Bad Request |
| InvalidRequestParameter | The input FieldDelimiter of CSV is invalid | The field delimiter of the CSV file is invalid. | 400 Bad Request |
| InvalidRequestParameter | The input QuoteCharacter of CSV is invalid | The quote character of the CSV file is invalid. | 400 Bad Request |
