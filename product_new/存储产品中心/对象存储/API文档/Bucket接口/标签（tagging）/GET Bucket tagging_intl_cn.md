...
该请求操作的实现使用公共请求头，了解公共请求头详情，请查阅 [公共请求头部](https://intl.cloud.tencent.com/document/product/436/7728 "公共请求头部") 文档。
...
如下请求申请获取存储桶`examplebucket-1250000000`下的标签信息，COS 解析该请求后并返回了该存储桶下已有的{age:18}和{name:xiaoming}两个标签。
