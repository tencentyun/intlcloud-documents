...
```
>Authorization: Auth String ，详情信息请参阅 [请求签名](https://intl.cloud.tencent.com/document/product/436/7778) 文档。
...
### 错误码
该请求操作返回如下错误信息，常见的错误信息请参阅 [错误码](https://intl.cloud.tencent.com/document/product/436/7730) 文档。
