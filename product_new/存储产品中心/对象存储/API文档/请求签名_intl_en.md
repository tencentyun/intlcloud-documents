...
3. Get KeyTime by splicing the two timestamps above in the format `StartTimestamp;EndTimestamp`.
**Sample: **`1557902800;1557910000`

### Step 2. Generate SignKey
Calculate the message digest (hash value), which is SignKey, using [HMAC-SHA1](#.E5.87.86.E5.A4.87.E5.B7.A5.E4.BD.9C) with [SecretKey](#.E5.87.86.E5.A4.87.E5.B7.A5.E4.BD.9C) as the key and [KeyTime](#.E7.94.9F.E6.88.90-keytime) as the message.

**Sample:** `36bcd76dbb8c9f066472fec403df8a34cab34c77`
...
- `\n` is a line break.
- SHA1(HttpString) is the message digest generated by calculating the [HttpString](#.E6.AD.A5.E9.AA.A45.EF.BC.9A.E7.94.9F.E6.88.90-httpstring) using [SHA1](#.E5.87.86.E5.A4.87.E5.B7.A5.E4.BD.9C).

### Step 7. Generate Signature
Signature is the message digest calculated using [HMAC-SHA1](#.E5.87.86.E5.A4.87.E5.B7.A5.E4.BD.9C) with [SignKey](#.E6.AD.A5.E9.AA.A42.EF.BC.9A.E7.94.9F.E6.88.90-signkey) as the key and [StringToSign](#.E6.AD.A5.E9.AA.A46.EF.BC.9A.E7.94.9F.E6.88.90-stringtosign) as the message.
