...
| Feature | Description |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Uploading file/folder](https://intl.cloud.tencent.com/document/product/436/32565#Uploading File) | This feature allows you to upload files/folders to a bucket separately, in batches, or incrementally |
