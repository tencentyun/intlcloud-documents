...
|        fs.cosn.bucket.region        |Enter the region of the bucket to be accessed. The enumerated values are the region abbreviations in [Regions and Endpoints](https://intl.cloud.tencent.com/document/product/436/6224), such as ap-beijing and ap-guangzhou. It is compatible with the original configuration: fs.cosn.userinfo.region |  None |Yes|
