...
若您使用的域名是 CDN 加速域名，请在 CDN 控制台配置跨域，详情请参见 [跨域配置](https://intl.cloud.tencent.com/document/product/228/6296) 文档。
...
您可以结合 COS 与云函数 SCF 进行设置。相关实践文档请参见 [获取 COS 上的图像并创建缩略图](https://intl.cloud.tencent.com/document/product/583/9728)。
