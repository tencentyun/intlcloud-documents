...
按量计费方式适用于对象存储提供服务的所有地域。对象存储提供服务的地域，请参阅 [地域和访问域名](https://intl.cloud.tencent.com/document/product/436/6224)。
...
用户可以免费享受 COS 对象存储提供的一定量的标准存储容量，欢迎试用体验。免费额度详情参阅 [免费额度](https://intl.cloud.tencent.com/document/product/436/6240)。

### 相关链接

1. 了解 COS 所有计费方式的产品定价，请参阅 [COS 产品定价](https://intl.cloud.tencent.com/document/product/436/6239)。
2. 关于 COS 的欠费停服策略：数据的保留和销毁时间、以及相关计费说明，请参阅 [COS 欠费说明](https://intl.cloud.tencent.com/document/product/436/10044)。
...
对象存储 COS 的计费项包括四部分：存储容量费用、请求费用、数据取回费用、流量费用。下面是各计费项的详细说明，定价详情，请参阅 [COS 产品定价](https://intl.cloud.tencent.com/document/product/436/6239)。
...
>?
>- 相同地域内，腾讯云产品之间会自动使用内网访问，不产生流量费用。关于如何判断是否为腾讯云内网访问，请参阅 [内网访问判断方法](https://intl.cloud.tencent.com/document/product/436/30613)。
