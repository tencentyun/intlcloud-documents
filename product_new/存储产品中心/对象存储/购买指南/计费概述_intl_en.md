...
| ------------------ | ------------------------------------------------------------ |
| Pay-as-you-go (postpaid) | All regions where the service is provided. For more information, see [Regions and Access Domain Names](https://cloud.tencent.com/document/product/436/6224) |


## Free Tier

New users will receive a certain amount of standard storage capacity provided by COS free of charge in six months after activating the COS service. For more information, see [Free Tier](https://cloud.tencent.com/document/product/436/6240).
...
COS offers three object storage classes for different access frequencies: standard storage, standard_IA storage, and archive storage. For more information, see [COS Storage Classes](https://cloud.tencent.com/document/product/436/33417).
...
1. For COS pricing in each billing method, see COS [Product Pricing](https://cloud.tencent.com/document/product/436/6239).
2. For more information on arrears processing in COS, data retention and purge schedule, and billing descriptions, see COS [Arrears Processing](https://cloud.tencent.com/document/product/436/10044).
