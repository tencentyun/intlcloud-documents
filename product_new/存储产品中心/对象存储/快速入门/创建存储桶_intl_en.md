...
2. Click **Bucket List** on the left sidebar, and then click **Create Bucket**.
...
3. In the **Create Bucket** dialog box, configure the information as follows:
 ...
 - **Region**: Select the COS region where your business is operated mostly or most of your users reside. It is non-modifiable once being configured. For more information on regions, see [Regions & Endpoints](https://cloud.tencent.com/document/product/436/6224).
 - **Access Permission**: Three access permissions for buckets are available by default: "Private Read/Write", "Public Read/Private Write" and "Public Read/Write". The permission can still be modified after configuration. For more information, see [Bucket Access Permissions](https://intl.cloud.tencent.com/document/product/436/13315).
 - **Bucket Tag**: Bucket tags are used to identify and group buckets for an easier management. For more information, see [Setting Bucket Tags](https://intl.cloud.tencent.com/document/product/436/30928).
