## 控制台迁移数据
1. 登录 [云数据库 MySQL 控制台](https://console.cloud.tencent.com/cdb) 下载备份文件和日志，详见 <a href="https://intl.cloud.tencent.com/document/product/236/7274" target="_blank">下载备份文件<a/>。
...
### Windows 迁移数据
1. 使用 Windows 系统的 mysqldump 工具 dump 出数据。
>!请保证数据库版本一致，mysqldump 工具的版本一致，数据库字符集一致。您可以通过参数```--default-character-set```来指定字符集。
...
更多字符集编码问题，请参见 <a href="https://intl.cloud.tencent.com/document/product/236/7259#.E5.AD.97.E7.AC.A6.E9.9B.86.E8.AF.B4.E6.98.8E" target="_blank">使用限制</a> 的字符集说明。
