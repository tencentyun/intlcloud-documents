...
您也可以在命令行界面（CLI）或者使用云数据库 API 查看、下载数据库日志，请参见 [查询备份日志](https://intl.cloud.tencent.com/document/product/236/15842) 与 [查询二进制日志](https://intl.cloud.tencent.com/document/product/236/15843)。
