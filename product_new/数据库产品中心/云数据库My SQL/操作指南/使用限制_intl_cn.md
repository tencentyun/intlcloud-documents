...
### 关于慢查询的说明
- 对于使用 Linux 云服务器的开发者，可以通过云数据库导出工具获取慢查询日志，请参见 [下载备份文件和日志](https://intl.cloud.tencent.com/document/product/236/7274)。
...
### 网络选择
- 私有网络和基础网络的对比请参见 [私有网络介绍](https://intl.cloud.tencent.com/zh/document/product/215#2.-.E7.A7.81.E6.9C.89.E7.BD.91.E7.BB.9C.E4.B8.8E.E5.9F.BA.E7.A1.80.E7.BD.91.E7.BB.9C)。
