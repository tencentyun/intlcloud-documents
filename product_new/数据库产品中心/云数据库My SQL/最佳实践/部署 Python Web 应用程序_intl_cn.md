...
### 登录到云服务器实例
云服务器的购买和访问请参考 [快速入门 Linux 云服务器](http://intl.cloud.tencent.com/document/product/213/2936)。
...
```
3. 测试 Apache。
>!此步骤需要您的云服务器在安全组中配置来源为 **all**，端口协议为 **TCP:80** 的入站规则。关于安全组的配置方法请参考 [安全组](http://intl.cloud.tencent.com/document/product/213/12452)。
>
...
```
3. 测试通过即可进行数据库操作，更多的数据库操作请参考 [模型和数据库](https://docs.djangoproject.com/en/1.11/topics/db/)。
