...
1. 登录 [MySQL 控制台](https://console.cloud.tencent.com/cdb)，选择需要排查的 MySQL 实例，单击实例名，进入实例管理页面。
2. 在实例管理页面，选择【连接检查】页面。
3. 检查内网连接问题时，需单击【添加访问此实例的云主机】，添加访问此 MySQL 实例的 CVM 实例。
...
3. 检查外网连接问题时，需单击【添加访问此实例的外网服务器】，添加访问此 MySQL 实例的外网服务器。
4. 添加完成后，单击【开始检查】，在检查任务完成后，会生成检查报告。
![](https://main.qcloudimg.com/raw/43d9e61c2052797740e7ef6817251f5e.png)
5. 在检查报告的状态列，单击【查看报告】可查看检查结果。
