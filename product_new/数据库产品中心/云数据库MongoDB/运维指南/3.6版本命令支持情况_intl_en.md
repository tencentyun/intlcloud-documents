For MongoDB's official commands, please see the [official documentation](https://docs.mongodb.com/master/reference/command/?spm=a2c4g.11186623.2.3.ADiuQo).
The commands that are not supported by TencentDB for MongoDB v3.6 are as follows:
