...
在 [控制台](https://console.cloud.tencent.com/mongodb) 中可以查看分片集群实例的详细信息，如分片的构成，片节点的规格和已使用容量，同时也可以在控制台上进行实例的 [扩容](https://intl.cloud.tencent.com/document/product/240/31192) 等操作。
