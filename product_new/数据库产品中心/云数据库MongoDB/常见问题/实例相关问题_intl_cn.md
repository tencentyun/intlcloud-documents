...
连接示例请参见 [完整的连接说明](https://intl.cloud.tencent.com/document/product/240/3563) 。

### MongoDB 的实例范围是多少？是否支持升级连接数？
请参见 [连接限制说明](https://intl.cloud.tencent.com/document/product/240/622)，连接数和实例规格相关，可以通过升级规格以获取更大的连接数。
