...
## 1. 查询可创建实例规格
在创建实例前，我们需要先查询能够创建的实例规格， 可以通过[查询可创建实例规格）](https://intl.cloud.tencent.com//document/product/240/8318)接口查询。
...
| 参数名称 | 类型 | 描述 |
|:---------|---------|---------|
| region | String | 区域ID，详见<a href='https://intl.cloud.tencent.com/document/product/213/6976'>公共请求参数</a> |
...
| vpcId | 否 | Int | vpc网络ID, 如果是基础网络， vpcId=0,  vpc网络下，取值以查询[私有网络列表](https://intl.cloud.tencent.com/doc/api/245/1372) 返回的vpcid为准|0 |
| subnetId | 否 | Int | 基础网络下， subnetId无效， vpc子网下，取值以查询[私有网络列表](https://intl.cloud.tencent.com/doc/api/245/1372) 返回的subnetid为准|0 |
| projectId | 否 | Int | 项目id，取值以用户账户>用户账户相关接口查询>[项目列表](https://intl.cloud.tencent.com/doc/api/403/4400)返回的projectId为准|0 |
