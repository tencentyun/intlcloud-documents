...
详细操作参考 [操作指南- MySQL 数据迁移](<https://intl.cloud.tencent.com/zh/document/product/571/13706>)。

## Redis 迁移
在线迁移工具暂不支持的迁移类型：主从版、集群版、新一代 Redis 三者实例间的迁移。
详细操作请参考 [操作指南-Redis 数据迁移](<https://intl.cloud.tencent.com/zh/document/product/571/13748>)。
...
详细操作参考请 [操作指南- PostgreSQL 数据迁移](<https://intl.cloud.tencent.com/zh/document/product/571/16309>)。
