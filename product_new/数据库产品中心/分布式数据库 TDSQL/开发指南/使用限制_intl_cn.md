...
### SQL 支持类型详述
DDL 语法兼容，具体参考 [DDL语句](https://intl.cloud.tencent.com/document/product/1042/33358)。
```
	CREATE TABLE Syntax
	CREATE INDEX Syntax
	DROP TABLE Syntax
...
```
DML 语法兼容，具体参考 [创建分表](https://intl.cloud.tencent.com/document/product/1042/33379)。
```
	INSERT Syntax
	REPLACE Syntax
	UPDATE Syntax
