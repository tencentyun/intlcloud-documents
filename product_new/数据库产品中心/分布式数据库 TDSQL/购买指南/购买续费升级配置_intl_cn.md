## 实例购买
您可登录 [TDSQL MySQL版 购买页](https://console.cloud.tencent.com/tdsqld/tdpg/buy) 购买实例，实例单节点（例如，一主一从为2个节点）一次最多能购买8个分片。
实例购买后，需初始化实例方可正常运行。
...
### 新增分片
1. 登录 [TDSQL MySQL版 控制台](https://console.cloud.tencent.com/tdsqld)，在实例列表，单击实例名或“操作”列的【管理】，进入实例管理页面。
