...
由状态改变触发告警后，您可以及时进行相应的预防或补救措施。因此，合理地创建告警能帮助您提高应用程序的健壮性和可靠性。有关告警的更多信息，请参见云监控的 [告警配置](https://cloud.tencent.com/doc/product/248/1073)。
...
### 步骤2：关联对象
创建完告警策略后，您可以为其关联相应告警对象，对象达到告警触发条件时会发送告警。
