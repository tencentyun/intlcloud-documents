...
### Adjusting instance configurations
On the **Instance List** page, click **Adjust Configurations** in the "Operation" column to upgrade the configuration of a database instance, including its specification and disk capacity.
