...
#### 计算（节点机型）
不同的规格的硬件配置，提供不同的计算能力，可以满足不同集群写入和查询请求下对性能的需求。另外腾讯云 ES 也提供了多个【高级特性】版本，其中基础版和白金版包含了 Elastic 官方的商业功能（原 X-Pack 插件）。不同的【高级特性】版本，节点机型定价不同，详情可参见  [产品定价](https://intl.intl.cloud.tencent.com/document/product/845/18376)。
