...
进行 Ghost 网站搭建，您需要熟悉 Liunx 操作系统及命令，例如 [Ubuntu 环境下通过 Apt-get 安装软件](https://intl.cloud.tencent.com/document/product/213/2123) 等常用命令。
...
### 步骤2：创建新用户
1. 当您登录 Ubuntu 操作系统的云服务器后，请参考 [Ubuntu 系统使用 root 用户登录](https://intl.intl.cloud.tencent.com/document/product/213/17278) 切换为 root 用户。
