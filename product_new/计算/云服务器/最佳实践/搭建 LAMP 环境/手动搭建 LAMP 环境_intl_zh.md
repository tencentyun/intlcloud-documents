...
进行手动搭建 LAMP 环境，您需要熟悉 Linux 命令，例如  [CentOS 环境下通过 YUM 安装软件](https://intl.cloud.tencent.com/document/product/213/2046) 等常用命令，并对所安装软件使用的版本特性比较了解。
...
## 相关操作
在完成了 LAMP 环境搭建后，您可在此基础上进行 [手动搭建 Drupal 网站](https://intl.cloud.tencent.com/document/product/213/34814) 实践，了解并掌握更多关于云服务器的相关功能。
