...
reboot
```
7. 等待约1分钟，并通过 [VNC 登录该 CVM 实例](https://intl.cloud.tencent.com/document/product/213/32494)。登录界面如下图所示：
...
reboot
```
8. 等待约1分钟，并通过 [VNC 登录该 CVM 实例](https://intl.cloud.tencent.com/document/product/213/32494)。登录界面如下图所示：
