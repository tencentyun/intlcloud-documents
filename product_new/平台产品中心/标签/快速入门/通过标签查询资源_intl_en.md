...
3. On the resource tags page, select the following information to set the filtering criteria.
 - Resource type: this is the type of the resource to be queried. Only products that support tags are allowed. For details, see [Products that Support Tags](https://intl.cloud.tencent.com/document/product/651/32577).
