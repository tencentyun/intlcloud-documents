...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as QCE/VPNGW for VPC VPN gateways. This value must be capitalized for API 3.0 |
...
| :----------------------------- | :------- | :----------------- | :------------------------------------- |
| Instances.N.Dimensions.0.Name | vpnGwId | VPN gateway ID | Enter a string-type dimension name, such as vpnGwId |
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of one VPN gateway in a VPC using a statistical period of 60 seconds for a specified length of time.
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of multiple VPN gateways in a VPC using a statistical period of 60 seconds for a specified length of time.
