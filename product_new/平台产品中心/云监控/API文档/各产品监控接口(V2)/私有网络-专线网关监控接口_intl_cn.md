...
| Namespace | 是 | String | 命名空间，每个云产品会有一个命名空间，API 3.0接口版本的必须是大写，如：QCE/DCG |
...
| 参数名称 | 维度名称 | 维度解释 | 格式 |
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | directConnectGatewayId | 入参为专线网关 ID | String 类型维度名称：directConnectGatewayId |
| Instances.N.Dimensions.0.Value | directConnectGatewayId | 具体的专线网关 ID | 输入具体 directConnectGatewayId，如 dcg-4d545d |
