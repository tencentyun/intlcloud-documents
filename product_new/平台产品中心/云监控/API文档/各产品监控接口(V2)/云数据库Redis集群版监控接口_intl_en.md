...
| ConnectionsMin | Connections | Count |
...
### Sample 3. Getting the number of shard-level GET commands of one TencentDB for Redis instance

This example shows you how to get the monitoring data for the number of shard-level GET commands of one TencentDB for Redis instance using a statistical period of 60 seconds for a specified length of time.
...
### Sample 4. Getting the number of shard-level GET commands of multiple TencentDB for Redis instances

This example shows you how to get the monitoring data for the number of shard-level GET commands of multiple TencentDB for Redis instances using a statistical period of 60 seconds for a specified length of time.
