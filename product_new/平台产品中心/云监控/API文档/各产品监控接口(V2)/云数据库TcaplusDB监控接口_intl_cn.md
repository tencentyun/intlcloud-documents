...
&Instances.N.Dimensions.1.Value=应用申请的具体ID
...
| Region      | 否       | String                                                       | 公共参数，表示查询的是哪个地域实例的监控数据；支持的地域可查看TcaplusDB支持的[地域列表](https://intl.cloud.tencent.com/document/product/1016/35019) |
