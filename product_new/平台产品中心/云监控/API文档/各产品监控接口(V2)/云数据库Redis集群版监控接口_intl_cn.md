...
| Instances.N.Dimensions.0.Value | instanceid | 具体实例的 ID | 输入实例的具体 redis 实例 ID，如 tdsql-123456 也即是实例串号，如 crs-ifmymj41，可通过 [查询CRS实例列表接口](https://intl.cloud.tencent.com/document/api/239/1384) 查询 |
