...
| Region      | 否       | String                                                       | 公共参数，表示查询的是哪个地域实例的监控数据；可查看云函数支持的 [地域列表](https://intl.cloud.tencent.com/document/product/583/17238) |
| Namespace   | 是       | String                                                       | 命名空间，每个云产品会有一个命名空间，如云函数命名空间： QCE/SCF_V2 （API 3.0接口版本的必须是大写） |
...
| 参数名称                       | 维度名称     | 维度解释         | 格式                                     |
| :----------------------------- | :----------- | :--------------- | :--------------------------------------- |
| Instances.N.Dimensions.0.Name  | functionName | 云函数名称       | 输入String类型维度名称，如：functionName |
| Instances.N.Dimensions.0.Value | functionName | 具体的云函数名称 | 输入具体函数名称，如：test               |
| Instances.N.Dimensions.0.Name  | version      | 云函数版本       | 输入String类型维度名称，如：functionName |
| Instances.N.Dimensions.0.Value | version      | 具体的云函数版本 | 输入函数具体版本，如：$latest            |
