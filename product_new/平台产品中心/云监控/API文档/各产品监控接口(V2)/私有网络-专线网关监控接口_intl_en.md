...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as QCE/DCG for VPC Direct Connect gateway namespaces. This value must be capitalized for API 3.0 |
...
| :----------------------------- | :--------------------- | :---------------- | :-------------------------------------------------- |
| Instances.N.Dimensions.0.Name | directConnectGatewayId | Direct Connect gateway ID | Enter a string-type dimension name, such as directConnectGatewayId |
| Instances.N.Dimensions.0.Value | directConnectGatewayId | Specific ID of the Direct Connect gateway | Enter a specific Direct Connect gateway ID, such as dcg-4d545d |
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of one Direct Connect gateway in a VPC using a statistical period of 60 seconds for a specified length of time.
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of multiple Direct Connect gateways in a VPC using a statistical period of 60 seconds for a specified length of time.
