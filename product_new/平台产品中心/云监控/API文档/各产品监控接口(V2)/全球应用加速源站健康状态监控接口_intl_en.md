...
To query the health monitoring data of a GAAP origin server, use the following input parameter values:
&Namespace=QCE/QAAP
...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as `QCE/QAAP`, which must be capitalized for API 3.0 |
...
| :--------------------- | :------------------------------------------- | :--- |
| ListenerRsStatus | Origin server health status under the listener (0: exception, 1: normal) | - |
...
### Sample 1. Getting the health monitoring data of one GAAP origin server under the listener

This example shows you how to get the health monitoring data of one GAAP origin server under a listener at 60-second statistical period during a certain period of time.
...
### Sample 2. Getting the health monitoring data of multiple GAAP origin servers under the listener

This example shows you how to get the health monitoring data of multiple GAAP origin servers under a listener at 60-second statistical period during a certain period of time.
