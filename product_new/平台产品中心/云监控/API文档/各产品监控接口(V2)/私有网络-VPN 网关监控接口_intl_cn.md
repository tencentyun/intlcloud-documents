...
| Namespace | 是 | String | 命名空间，每个云产品会有一个命名空间，API 3.0接口版本的必须是大写，如： QCE/VPNGW |
...
| 参数名称 | 维度名称 | 维度解释 | 格式 |
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | vpnGwId | 为 VPN 网关 ID | String 类型维度名称：vpnGwId |
| Instances.N.Dimensions.0.Value | vpnGwId | 具体的 VPN 网关 ID | 输入具体 vpnGwId，如vpngw-q7v069tf |
