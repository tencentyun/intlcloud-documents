...
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | instanceId | CKafka instance ID | String-type dimension name: instanceId |
...
| ------------------------ | ----------- | ---- | ---------------------- |
| InstanceMsgHeap | Message heap in instance | MB | instanceId |
| InstanceProCount | Messages produced by instance | - | instanceId |
| InstanceConCount | Messages consumed by instance | - | instanceId |
| InstanceProReqCount | Production requests in instance | - | instanceId |
| InstanceConReqCount | Consumption requests in instance | - | instanceId |
| InstanceMsgCount | Persistent messages in instance | - | instanceId |
| InstanceProFlow | Production traffic in instance | MB/min | instanceId |
| InstanceConFlow | Consumption traffic in instance | MB/min | instanceId |
...
| InstanceMaxConFlow | Maximum consumption traffic in instance | MB/s | instanceId |
| InstanceMaxProFlow | Maximum production traffic in instance | MB/s | instanceId |
...
### Sample 1 
This example shows you how to get the maximum production traffic of one CKafka instance using a statistical period of 60 seconds for a specified length of time.
...
### Sample 2 
This example shows you how to get the maximum production traffic of multiple CKafka instances using a statistical period of 60 seconds for a specified length of time.
