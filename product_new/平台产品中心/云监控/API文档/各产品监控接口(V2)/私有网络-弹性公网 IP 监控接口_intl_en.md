...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as QCE/LB for VPC EIP namespaces. This value must be capitalized for API 3.0 |
...
| :----------------------------- | :------- | :--------------------------- | :--------------------------------- |
| Instances.N.Dimensions.0.Name | eip | EIP ID | Enter a string-type dimension name, such as eip |
| Instances.N.Dimensions.0.Value | eip | Specific EIP | Enter a specific EIP, such as 111.111.111.11 |
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of one EIP in a VPC using a statistical period of 60 seconds for a specified length of time.
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of multiple EIPs in a VPC using a statistical period of 60 seconds for a specified length of time.
