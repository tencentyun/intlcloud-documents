...
To query the monitoring data of a Direct Connect physical tunnel, use the following input parameters:
...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as `QCE/DC`. This value must be capitalized for API 3.0 |
...
### Sample 1 
This example shows you how to get the inbound bandwidth monitoring data of one Direct Connect physical tunnel using a statistical period of 300 seconds for a specified length of time.
...
### Sample 2 
This example shows you how to get the inbound bandwidth monitoring data of multiple Direct Connect physical tunnels using a statistical period of 300 seconds for a specified length of time.
