...
| Namespace   | 是       | String                                                       | 命名空间，每个云产品会有一个命名空间，如全球应用加速通道负载命名空间：QCE/QAAP（API 3.0接口版本的必须是大写） |
...
| 参数名称                       | 维度名称  | 维度解释    | 格式                                   |
| :----------------------------- | :-------- | :---------- | :------------------------------------- |
| Instances.N.Dimensions.0.Name  | channelId | 加速通道 ID | 输入String类型维度名称，如：channelId  |
| Instances.N.Dimensions.0.Value | channelId | 加速通道 ID | 输入加速通道具体ID，如： link-abcd1234 |
