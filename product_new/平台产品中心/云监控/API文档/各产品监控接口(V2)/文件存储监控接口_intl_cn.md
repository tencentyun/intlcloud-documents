...
| 参数名称                       | 维度名称     | 维度解释         | 格式                                |
| :----------------------------- | :----------- | :--------------- | :---------------------------------- |
| Instances.N.Dimensions.0.Name  | FileSystemId | 入参为文件系统ID | String类型维度名称：FileSystemId    |
| Instances.N.Dimensions.0.Value | FileSystemId | 具体文件系统ID   | 输入具体文件系统ID，如cfs-fjojeogej |
