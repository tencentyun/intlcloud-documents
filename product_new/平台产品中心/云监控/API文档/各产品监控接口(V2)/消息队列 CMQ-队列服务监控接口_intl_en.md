...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace such as `QCE/CMQ`. This value must be capitalized for API 3.0 |
...
| -------------------- | ---------- | ---- | ----------------- |
| InvisibleMsgNum | Invisible messages in queue | - | queueId, queueName |
| VisibleMsgNum | Visible messages in queue | - | queueId, queueName |
| SendMsgReqCount | Requests for sending messages | - | queueId, queueName |
| SendMsgNum | Sent messages | - | queueId, queueName |
| RecvMsgReqCount | Requests for receiving messages | - | queueId, queueName |
| RecvMsgNum | Received messages | - | queueId, queueName |
| RecvNullMsgNum | Received empty messages | - | queueId, queueName |
| BatchRecvNullMsgNum | Batch received empty messages | - | queueId, queueName |
| DelMsgReqCount | Requests for deleting messages | - | queueId, queueName |
| DelMsgNum | Deleted messages | - | queueId, queueName |
| SendMsgSize | Size of sent messages | MB | queueId, queueName |
| BatchSendMsgSize | Size of batch sent messages | MB | queueId, queueName |
| BatchSendMsgReqCount | Requests for batch sending messages | - | queueId, queueName |
| BatchRecvMsgReqCount | Requests for batch receiving messages | - | queueId, queueName |
| BatchDelMsgReqCount | Requests for batch deleting messages | - | queueId, queueName |
| MsgHeapNum | Backlogged messages | - | queueId, queueName |
...
This example shows you how to get the number of invisible messages in one CMQ queue using a statistical period of 300 seconds for a specified length of time.
...
This example shows you how to get the number of invisible messages in multiple CMQ queues using a statistical period of 300 seconds for a specified length of time.
