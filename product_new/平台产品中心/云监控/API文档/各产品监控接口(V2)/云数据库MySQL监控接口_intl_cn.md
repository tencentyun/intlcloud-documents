...
| Region      | 否       | String                                                       | 公共参数，表示查询的是哪个地域实例的监控数据；可查看云数据库MySQL支持的 [地域列表](https://intl.cloud.tencent.com/document/product/236/15833) |
| Namespace   | 是       | String                                                       | 命名空间，每个云产品会有一个命名空间，如云数据库MySQL命名空间：QCE/CDB（API 3.0接口版本的必须是大写） |
...
| 参数名称                       | 维度名称     | 维度解释                                                     | 格式                                     |
| :----------------------------- | :----------- | :----------------------------------------------------------- | :--------------------------------------- |
| Instances.N.Dimensions.0.Name  | InstanceId   | 数据库实例 ID                                                | 输入String类型维度名称，如：topicId      |
| Instances.N.Dimensions.0.Value | InstanceId   | 数据库的具体ID                                               | 输入具体实例ID，如 ：topic-i4p4k0u0      |
| Instances.N.Dimensions.1.Name  | InstanceType | 数据库实例类型                                               | 输入String类型维度名称，如：InstanceType |
