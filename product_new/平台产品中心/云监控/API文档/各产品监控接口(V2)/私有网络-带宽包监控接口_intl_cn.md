...
| Namespace | 是 | String | 命名空间，每个云产品会有一个命名空间，API 3.0接口版本的必须是大写，如： QCE/BWP |
...
| 参数名称 | 维度名称 | 维度解释 | 格式 |
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | bandwidthPackageId | 入参为带宽包 ID | String 类型维度名称：bandwidthPackageId |
| Instances.N.Dimensions.0.Value | bandwidthPackageId | 具体的带宽包 ID | 具体实例名称，如 pdcg-4d545d |
