...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace such as `QCE/BWP`. This value must be capitalized for API 3.0 |
...
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | bandwidthPackageId | Bandwidth package ID | String-type dimension name: bandwidthPackageId |
| Instances.N.Dimensions.0.Value | bandwidthPackageId | Specific bandwidth package ID | Specific package name, such as pdcg-4d545d |
...
### Sample 1 
This example shows you how to get the public network outbound bandwidth of one bandwidth package in a VPC using a statistical period of 60 seconds for a specified length of time.
...
```
### Sample 2 
This example shows you how to get the public network outbound bandwidth of multiple bandwidth packages in a VPC using a statistical period of 60 seconds for a specified length of time.
