...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as `QCE/VPNX`. This value must be capitalized for API 3.0 |
...
| ------------------ | ---------------- | ------------- | ----------------------------- |
| Instances.N.Dimensions.0.Name | vpnConnId | VPN tunnel ID | String-type dimension name: vpnConnId |
| Instances.N.Dimensions.0.Value | vpnConnId | Specific VPN tunnel ID | Specific instance name, such as vpnx-12345678 |
...
### Sample 1 
This example shows you how to get the public network outbound bandwidth of one VPN tunnel in a VPC using a statistical period of 60 seconds for a specified length of time.
...
```
### Sample 2 
This example shows you how to get the public network outbound bandwidth of multiple VPN tunnels in a VPC using a statistical period of 60 seconds for a specified length of time.
