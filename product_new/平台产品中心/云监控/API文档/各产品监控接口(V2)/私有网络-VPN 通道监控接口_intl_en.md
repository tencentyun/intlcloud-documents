...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as QCE/VPNX for VPC VPN tunnel namespaces. This value must be capitalized for API 3.0 |
...
| :----------------------------- | :-------- | :---------------- | :------------------------------------- |
| Instances.N.Dimensions.0.Name | vpnConnId | VPN tunnel ID | Enter a string-type dimension name, such as vpnConnId |
| Instances.N.Dimensions.0.Value | vpnConnId | Specific VPN tunnel ID | Enter a specific VPN connection ID, such as vpnx-12345678 |
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of one VPN tunnel in a VPC using a statistical period of 60 seconds for a specified length of time.
...
This example shows you how to get the monitoring data for the public network outbound bandwidth of multiple VPN tunnels in a VPC using a statistical period of 60 seconds for a specified length of time.
