...
| Namespace | Yes | String | Namespace. Each Tencent Cloud product has a namespace, such as QCE/DCX for dedicated tunnels. This value must be capitalized for API 3.0 |
...
| :----------------------------- | :------------------ | :---------------- | :----------------------------------------------------------- |
| Instances.N.Dimensions.0.Name | directConnectConnId | Dedicated tunnel ID | Enter a string-type dimension name, such as directConnectConnId |
| Instances.N.Dimensions.0.Value | Specific dedicated tunnel ID | Specific dedicated tunnel ID | `unInstanceId` field of the String type obtained through the [DescribeInstances](https://intl.cloud.tencent.com/document/product/213/33258) API |
...
| Inpkg | Inbound packets | Packets/second | directConnectConnId |
| Outpkg | Outbound packets | Packets/second | directConnectConnId |
...
This example shows you how to get the monitoring data for the inbound bandwidth of one Direct Connect dedicated tunnel using a statistical period of 300 seconds for a specified length of time.
...
This example shows you how to get the monitoring data for the inbound bandwidth of multiple Direct Connect dedicated tunnels using a statistical period of 300 seconds for a specified length of time.
