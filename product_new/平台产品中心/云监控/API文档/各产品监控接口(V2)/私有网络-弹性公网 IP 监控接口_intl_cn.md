...
| Namespace   | 是       | String                                                       | 命名空间，每个云产品会有一个命名空间，如私有网络弹性公网 IP命名空间：QCE/LB（API 3.0接口版本的必须是大写） |
...
| 参数名称                       | 维度名称 | 维度解释                     | 格式                               |
| :----------------------------- | :------- | :--------------------------- | :--------------------------------- |
| Instances.N.Dimensions.0.Name  | eip      | 入参为弹性公网 IP 的 ID      | 输入String 类型维度名称，如：eip   |
| Instances.N.Dimensions.0.Value | eip      | 具体的弹性公网 IP 的 IP 地址 | 输入具体IP地址，如：111.111.111.11 |
