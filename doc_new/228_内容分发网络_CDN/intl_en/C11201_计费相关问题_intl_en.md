...
### 9. What happens if I fail to pay CDN on time?
See [Arrears](https://cloud.tencent.com/document/product/228/2954).

### 10. If the origin server uses COS, will there be charges for traffic generated by origin-pull from CDN to COS?
...
### 11. When CDN is disabled (or deactivated), will it generate traffic and incur fees?
