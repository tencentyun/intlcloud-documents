...
- 未启用版本控制状态下：添加、检索和删除对象等操作方式不变，详情请参阅 [对象管理](https://cloud.tencent.com/document/product/436/13321) 目录下的文档。
...
您可以通过以下过程，使用 versions 参数和 prefix 请求参数检索某对象的所有版本。有关 prefix 的更多信息，请参阅 [GET Bucket Object Versions](https://cloud.tencent.com/document/product/436/35521) 文档。
检索某一对象的所有版本，请求示例如下：
