...
```
For more information about Spark command line parameters, see the [community documentation](http://spark.apache.org/docs/latest/sql-programming-guide.html).
...
### Compiling the Code and Packaging It for Upload
...
[19,Justin]
```
For more spark-submit parameters, run the following command lines, or see the [official documentation](https://spark.apache.org/docs/latest/submitting-applications.html).
