...
[访问控制（CAM）](https://intl.cloud.tencent.com/document/product/598/17848)用于管理腾讯云账户下资源访问权限，通过 CAM，您可以通过身份管理和策略管理控制哪些子账号有哪些资源的操作权限。
...
了解更多请参阅 [CAM ](https://intl.cloud.tencent.com/document/product/598/10583) 产品文档。
