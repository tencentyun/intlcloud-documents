**The Cloud Block Storage Service Level Agreement (New Version) is currently available to the public for comments and will take effect as of June 15, 2019. Any service availability issue in relation to the Cloud Block Storage on or before June 14, 2019 is governed by the Cloud Block Storage Service Level Agreement (Old Version), while the service availability of CBS service as from June 15, 2019 shall be subject to the Cloud Block Storage Service Level Agreement (New Version) .**
