...
Push interruption diagnostics helps you quickly check the record of live push interruptions and their reasons.
...
After the live push is interrupted, select **Auxiliary Tools** > **Push Interruption Diagnostics** in the left sidebar to enter the push interruption diagnostics page.
...
<td  >Internal error in the LVB system.</td>
 ...
 <tr >
<td colspan='2'  >12</td>
<td  >Exception with the push link network.</td>
 </tr>
 <tr  >
<td colspan='2'  >13</td>
<td  >Exception with the push link network.</td>
...
<td  >The access mode is channel mode, but the corresponding push channel has not been created yet.</td>
 ...
 <tr >
<td >307</td>
<td  >The access mode is channel mode, but the current push channel has been turned off.</td>
 </tr>
 <tr >
<td >308</td>
