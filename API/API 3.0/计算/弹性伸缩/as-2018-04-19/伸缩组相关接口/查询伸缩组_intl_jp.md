...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| AutoScalingGroupSet | Array of [AutoScalingGroup](https://cloud.tencent.com/document/api/377/20453#AutoScalingGroup) | スケーリンググループの詳細情報のリスト。|
