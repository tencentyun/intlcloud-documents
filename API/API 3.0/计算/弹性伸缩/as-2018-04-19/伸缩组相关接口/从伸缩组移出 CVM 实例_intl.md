...
This API (DettachInstances) is used to remove a CVM instance from a scaling group but not terminate it.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DetachInstances |
...
### Removing an Instance from a Scaling Group
