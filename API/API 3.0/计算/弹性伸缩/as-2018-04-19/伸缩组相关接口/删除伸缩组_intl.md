...
This API (DeleteAutoScalingGroup) deletes the specified scaling group. The prerequisite is that the scaling group currently has no instances and is not performing a scaling activity.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteAutoScalingGroup |
