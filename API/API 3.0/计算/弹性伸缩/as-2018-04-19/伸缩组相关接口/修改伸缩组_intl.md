...
| RetryPolicy | No | String | Retry policy; valid values: IMMEDIATE_RETRY, INCREMENTAL_INTERVALS; IMMEDIATE_RETRY by default. <br/><br><li> IMMEDIATE_RETRY: Retrying the operation immediately, but the retry stops after 5 consecutive failures. <br/><br><li> INCREMENTAL_INTERVALS: ation after 3 seconds, 10 seconds, 20 seconds, and so on. The interval may go from a second to a day. |
