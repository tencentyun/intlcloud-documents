...
| Tags.N | 否 | Array of [Tag](/document/api/377/20453#Tag) | 标签描述列表。通过指定该参数可以支持绑定标签到伸缩组。同时绑定标签到相应的资源实例， |
| ServiceSettings | 否 | [ServiceSettings](/document/api/377/20453#ServiceSettings) | 服务设置，包括云监控不健康替换等服务设置。 |
