...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| AutoScalingInstanceSet | Array of [Instance](https://cloud.tencent.com/document/api/377/20453#Instance) | 인스턴스 세부 정보 리스트. |
