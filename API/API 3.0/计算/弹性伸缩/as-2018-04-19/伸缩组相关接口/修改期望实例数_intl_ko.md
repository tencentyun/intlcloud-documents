...
본 API(ModifyDesiredCapacity)는 지정 조정 그룹의 에상 인스턴스 수 수정에 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 본 API 값: ModifyDesiredCapacity |
...
| DesiredCapacity | 예 | Integer | 에상 인스턴스 수 |
