...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| AutoScalingGroupSet | Array of [AutoScalingGroup](https://cloud.tencent.com/document/api/377/20453#AutoScalingGroup) | 伸缩组详细信息列表。|
