...
This API (DisableAutoScalingGroup) is used to disable the specified scaling group.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DisableAutoScalingGroup |
