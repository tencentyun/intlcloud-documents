...
본 API(DeleteAutoScalingGroup)는 지정 조정 그룹을 삭제하는 데 사용됩니다. 삭제 전제는 조정 그룹 내 인스턴스가 없고 현재 조정 활동을 실행하지 않는 것입니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 본 API 값: DeleteAutoScalingGroup |
