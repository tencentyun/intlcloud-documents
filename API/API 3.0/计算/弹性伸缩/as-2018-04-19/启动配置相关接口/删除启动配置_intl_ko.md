...
본 API(DeleteLaunchConfiguration)는 시동 구성을 삭제하는 데 사용됩니다.

* 시동 구성이 조정 그룹 내 이미 적용된 상태이면 해당 시동 구성은 삭제할 수 없습니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 본 API의 값: DeleteLaunchConfiguration |
...
| LaunchConfigurationId | 예 | String | 삭제할 시동 구성 ID. |
