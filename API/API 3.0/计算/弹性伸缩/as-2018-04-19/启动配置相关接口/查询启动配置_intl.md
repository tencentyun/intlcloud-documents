...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLaunchConfigurations |
...
| Filters.N | No | Array of [Filter](/document/api/377/31018#Filter) | Filter. <br/><li> launch-configuration-id - String - Required: No - (Filter) Filter by launch configuration ID. </li><li> launch-configuration-name - String - Required: No - (Filter) Filter by launch configuration name. </li><br/>The maximum number of `Filters` per request is 10. The upper limit for `Filter.Values` is 5. The parameter does not support specifying both `LaunchConfigurationIds` and `Filters` at the same time. |
...
| LaunchConfigurationSet | Array of [LaunchConfiguration](/document/api/377/31018#LaunchConfiguration) | List of launch configuration details. |
