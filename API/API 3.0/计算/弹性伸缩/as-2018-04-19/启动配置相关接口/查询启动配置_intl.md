...
| Filters.N | No | Array of [Filter](https://cloud.tencent.com/document/api/377/20453#Filter) | Filter conditions. <br/><li> launch-configuration-id - String - Required: No - (Filter condition) Filter by launch configuration ID. </li><li> launch-configuration-name - String - Required: No - (Filter condition) Filter by launch configuration name. </li><br/>The maximum number of `Filters` per request is 10, while that of `Filter.Values` is 5. This parameter does not support specifying both `LaunchConfigurationIds` and `Filters` at the same time. |
...
| LaunchConfigurationSet | Array of [LaunchConfiguration](https://cloud.tencent.com/document/api/377/20453#LaunchConfiguration) | List of launch configuration details |
