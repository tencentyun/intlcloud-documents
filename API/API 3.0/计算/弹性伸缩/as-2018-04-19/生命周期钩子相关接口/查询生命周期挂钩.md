...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| LifecycleHookSet | Array of [LifecycleHook](https://cloud.tencent.com/document/api/377/20453#LifecycleHook) | 生命周期挂钩数组|
