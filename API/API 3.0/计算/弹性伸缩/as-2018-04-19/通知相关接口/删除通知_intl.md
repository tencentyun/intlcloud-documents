...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteNotificationConfiguration |
| Version | Yes | String | Common parameter. The value used for this API: 2018-04-19 |
| Region | Yes | String | Common parameter. For more information, see the [list of regions](/document/api/377/20426#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8) supported by the product. |
| AutoScalingNotificationId | No | String | ID of the notification to be deleted. |
...
### Sample 1. Deleting a Notification

#### Input Sample Code

```
https://as.tencentcloudapi.com/?Action=DeleteNotificationConfiguration
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=as&Version=2018-04-19&Action=DeleteNotificationConfiguration)
