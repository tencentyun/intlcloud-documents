...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteScalingPolicy |
...
| AutoScalingPolicyId | Yes | String | ID of the alarm policy to be deleted. |
...
### Sample 1. Deleting an Alarm Policy

#### Input Sample Code

```
https://as.tencentcloudapi.com/?Action=DeleteScalingPolicy
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=as&Version=2018-04-19&Action=DeleteScalingPolicy)
