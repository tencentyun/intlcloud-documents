...
|---------|---------|---------|
| ScalingPolicySet | Array of [ScalingPolicy](https://cloud.tencent.com/document/api/377/20453#ScalingPolicy) | List of AS alarm trigger policy details. |
