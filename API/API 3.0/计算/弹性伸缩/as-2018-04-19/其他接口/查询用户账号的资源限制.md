...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| MaxNumberOfLaunchConfigurations | Integer | 用户账户被允许创建的启动配置最大数量|
| NumberOfLaunchConfigurations | Integer | 用户账户启动配置的当前数量|
| MaxNumberOfAutoScalingGroups | Integer | 用户账户被允许创建的伸缩组最大数量|
| NumberOfAutoScalingGroups | Integer | 用户账户伸缩组的当前数量|
