...
본 API(DeleteScheduledAction)는 특정 시간 제한 태스크를 삭제하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 아니요 | String | 공통 매개변수, 본 API 값: DeleteScheduledAction |
...
| ScheduledActionId | 예 | String | 삭제 대기 중인 시간 제한 태스크 ID. |
