...
This API (DeleteScheduledAction) is used to delete a scheduled task.
...
| ScheduledActionId | Yes | String | ID of the scheduled task to be deleted |
...
### Example 1 Delete a scheduled task
