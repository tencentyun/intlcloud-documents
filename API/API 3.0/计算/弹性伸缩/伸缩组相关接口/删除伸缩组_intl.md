...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​ used for this API: DeleteAutoScalingGroup |
...
### Example 1 Delete a scaling group
...
| ResourceInUse.ActivityInProgress | A scaling activity is being executed in the scaling group |
| ResourceInUse.InstanceInGroup | Working instances exist in the scaling group |
