...
This API (DettachInstances) is used to remove CVM instances from a scaling group. Instances removed via this API will not be terminated.
...
### Example 1 Remove CVM instances from a scaling group
