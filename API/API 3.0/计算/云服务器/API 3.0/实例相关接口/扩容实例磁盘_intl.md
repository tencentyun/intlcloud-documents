...
* Only the data disk purchased with the instance is supported, and the [data disk type](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/213/9452#block_device) is: `CLOUD_BASIC`, `CLOUD_PREMIUM`, `CLOUD_SSD`. * The [CDH](https://cloud.tencent.com/document/product/416) instance is not supported to use this API to expand the capacity of data disk.
