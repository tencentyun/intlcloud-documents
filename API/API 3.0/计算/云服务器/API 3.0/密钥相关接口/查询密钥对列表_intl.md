...
| KeyPairSet | Array of [KeyPair](https://cloud.tencent.com/document/api/213/15753#KeyPair) | List of details of key pairs. |
...
| InvalidFilterValue.LimitExceeded | The number of parameter values of [`Filter`](https://cloud.tencent.com/document/api/213/9451#filter) exceeds the limit. |
