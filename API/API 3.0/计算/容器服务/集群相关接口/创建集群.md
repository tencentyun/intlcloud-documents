...
| ClusterCIDRSettings | 是 | [ClusterCIDRSettings](https://cloud.tencent.com/document/api/457/31866#ClusterCIDRSettings) | 集群容器网络配置信息 |
| ClusterType | 是 | String | 集群类型，托管集群：MANAGED_CLUSTER，独立集群：INDEPENDENT_CLUSTER。 |
| RunInstancesForNode.N | 否 | Array of [RunInstancesForNode](https://cloud.tencent.com/document/api/457/31866#RunInstancesForNode) | CVM创建透传参数，json化字符串格式，详见[CVM创建实例](https://intl.cloud.tencent.com/document/product/213/33237)接口。 |
| ClusterBasicSettings | 否 | [ClusterBasicSettings](https://cloud.tencent.com/document/api/457/31866#ClusterBasicSettings) | 集群的基本配置信息 |
| ClusterAdvancedSettings | 否 | [ClusterAdvancedSettings](https://cloud.tencent.com/document/api/457/31866#ClusterAdvancedSettings) | 集群高级配置信息 |
| InstanceAdvancedSettings | 否 | [InstanceAdvancedSettings](https://cloud.tencent.com/document/api/457/31866#InstanceAdvancedSettings) | 节点高级配置信息 |
| ExistedInstancesForNode.N | 否 | Array of [ExistedInstancesForNode](https://cloud.tencent.com/document/api/457/31866#ExistedInstancesForNode) | 已存在实例的配置信息 |
