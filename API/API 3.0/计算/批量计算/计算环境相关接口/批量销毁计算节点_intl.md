...
This API is used to batch terminate compute nodes. It is not allowed to repeatedly terminate the same node.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: TerminateComputeNodes |
...
### Example 1. Batch Terminating Compute Nodes

#### Input

```
https://batch.tencentcloudapi.com/?Action=TerminateComputeNodes
&EnvId=env-lcx7qbbr
&ComputeNodeId.0=node-lcpcej85
&ComputeNodeId.1=node-lcz8jkvw
