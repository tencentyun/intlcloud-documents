...
| Filters | No | [Filter](https://cloud.tencent.com/document/api/599/30482#Filter) | Filters |

## 3. Output Parameters

| Parameter name | Type | Description |
|---------|---------|---------|
| InstanceTypeQuotaSet | Array of [InstanceTypeQuotaItem](https://cloud.tencent.com/document/api/599/30482#InstanceTypeQuotaItem) | List of model configurations in the availability zone. |
