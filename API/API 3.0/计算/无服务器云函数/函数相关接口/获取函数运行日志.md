...
| Filter | 否 | [Filter](https://cloud.tencent.com/document/api/583/17244#Filter) | 日志过滤条件。可用来区分正确和错误日志，filter.retCode=not0 表示只返回错误日志，filter.retCode=is0 表示只返回正确日志，不传，则返回所有日志 |
...
| Data | Array of [FunctionLog](https://cloud.tencent.com/document/api/583/17244#FunctionLog) | 函数日志信息|
