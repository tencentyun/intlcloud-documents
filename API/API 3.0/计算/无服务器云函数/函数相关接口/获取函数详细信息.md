...
| Triggers | Array of [Trigger](https://cloud.tencent.com/document/api/583/17244#Trigger) | 函数的触发器列表|
...
| VpcConfig | [VpcConfig](https://cloud.tencent.com/document/api/583/17244#VpcConfig) | 函数的私有网络|
| UseGpu | String | 是否使用GPU|
| Environment | [Environment](https://cloud.tencent.com/document/api/583/17244#Environment) | 函数的环境变量|
