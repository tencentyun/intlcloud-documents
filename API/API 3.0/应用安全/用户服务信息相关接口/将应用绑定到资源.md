...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateBindInstance |
| Version | 是 | String | 公共参数，本接口取值：2018-04-08 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| ResourceId | 是 | String | 资源id，全局唯一 |
| AppIconUrl | 是 | String | app的icon的url |
| AppName | 是 | String | app的名称 |
| AppPkgName | 是 | String | app的包名 |
...
```
https://ms.tencentcloudapi.com/?Action=CreateBindInstance
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=ms&Version=2018-04-08&Action=CreateBindInstance)
