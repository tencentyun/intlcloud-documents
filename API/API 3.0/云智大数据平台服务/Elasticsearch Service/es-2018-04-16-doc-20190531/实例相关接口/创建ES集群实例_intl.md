...
| MultiZoneInfo.N | No | Array of [MultiZoneInfo](https://cloud.tencent.com/document/api/845/30634#MultiZoneInfo) | Details of AZs in multi-AZ deployment mode, which has to be passed in if DeployMode is 1 |
