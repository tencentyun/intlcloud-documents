...
| ResourceSpec | 是 | [ResourceSpec](https://cloud.tencent.com/document/api/589/33981#ResourceSpec) | 询价资源描述 |
| Currency | 是 | String | 货币种类 |
| PayMode | 是 | Integer | 计费类型 |
| SupportHA | 是 | Integer | 是否支持HA， 1 支持，0 不支持 |
| Software.N | 是 | Array of String | 软件列表 |
| Placement | 是 | [Placement](https://cloud.tencent.com/document/api/589/33981#Placement) | 位置信息 |
| VPCSettings | 是 | [VPCSettings](https://cloud.tencent.com/document/api/589/33981#VPCSettings) | VPC信息 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Result | [InquiryPriceResult](https://cloud.tencent.com/document/api/589/33981#InquiryPriceResult) | 询价结果|
