...
This API is used to batch delete Tencent Cloud organizational units.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: DeleteOrganizationNodes |
| Version | Yes | String | Common parameter; the version of this API: 2018-12-25 |
| Region | No | String | Common parameter; this parameter is not required for this API. |
| NodeIds.N | Yes | Array of Integer | The list of the organizational unit IDs  |
...
### Example 1: Deleting a Tencent Cloud Organizational Unit

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=DeleteOrganizationNodes
&NodeIds.0=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=DeleteOrganizationNodes)
