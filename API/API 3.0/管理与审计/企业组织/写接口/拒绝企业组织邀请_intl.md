...
This API is used to decline a Tencent Cloud Organization invitation.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: DenyOrganizationInvitation |
...
### Example 1: Declining a Tencent Cloud Organization Invitation

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=DenyOrganizationInvitation
&Id=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=DenyOrganizationInvitation)
