...
This API is used to accept an invitation to join a Tencent Cloud Organization.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: AcceptOrganizationInvitation |
| Version | Yes | String | Common parameter; the version of this API: 2018-12-25 |
| Region | No | String | Common parameter; this parameter is not required for this API. |
| Id | Yes | Integer | Invitation ID |
...
### Example 1: Accepting a Tencent Cloud Organization Invitation

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=AcceptOrganizationInvitation
&Id=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=AcceptOrganizationInvitation)
