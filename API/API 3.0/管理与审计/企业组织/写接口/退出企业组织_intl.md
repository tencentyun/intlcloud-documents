...
This API is used to quit a Tencent Cloud Organization.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: QuitOrganization |
| Version | Yes | String | Common parameter; the version of this API: 2018-12-25 |
| Region | No | String | Common parameter; this parameter is not required for this API. |
| OrgId | Yes | Integer | Tencent Cloud Organization ID |
...
### Example 1: Quitting a Tencent Cloud Organization

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=QuitOrganization
&OrgId=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=QuitOrganization)
