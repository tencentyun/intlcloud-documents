...
This API is used to cancel a Tencent Cloud Organization invitation.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: CancelOrganizationInvitation |
...
### Example 1: Canceling a Tencent Cloud Organization Invitation

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=CancelOrganizationInvitation
&Id=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=CancelOrganizationInvitation)
