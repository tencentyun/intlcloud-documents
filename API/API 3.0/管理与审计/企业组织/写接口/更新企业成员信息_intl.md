...
This API is used to update Tencent Cloud Organization member information.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: UpdateOrganizationMember |
...
### Example 1: Updating Tencent Cloud Organization Member Information

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=UpdateOrganizationMember
&MemberUin=123
&Name="test"
&Remark="test"
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=UpdateOrganizationMember)
