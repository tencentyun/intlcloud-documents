...
This API is used to send a Tencent Cloud Organization invitation.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: SendOrganizationInvitation |
| Version | Yes | String | Common parameter; the version of this API: 2018-12-25 |
| Region | No | String | Common parameter; this parameter is not required for this API. |
| InviteUin | Yes | Integer | The UIN of the account to be invited |
...
### Example 1: Sending a Tencent Cloud Organization Invitation
