...
This API is used to obtain the Tencent Cloud Organization information.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: GetOrganization |
...
### Example 1: Obtaining TCO Information

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=GetOrganization
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=GetOrganization)
