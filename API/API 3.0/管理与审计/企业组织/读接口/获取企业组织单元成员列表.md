...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ListOrganizationNodeMembers |
| Version | 是 | String | 公共参数，本接口取值：2018-12-25 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| NodeId | 是 | Integer | 企业组织单元ID |
...
| Members | Array of [OrgMember](https://cloud.tencent.com/document/api/850/38749#OrgMember) | 成员列表|
