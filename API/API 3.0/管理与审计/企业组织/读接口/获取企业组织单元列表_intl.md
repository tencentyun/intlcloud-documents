...
This API is used to obtain the Tencent Cloud organizational unit list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value used for this API: ListOrganizationNodes |
...
|---------|---------|---------|
| Nodes | Array of [OrgNode](https://cloud.tencent.com/document/api/850/38749#OrgNode) | Tencent Cloud organizational unit list |
...
### Example 1: Obtaining the Tencent Cloud Organizational Unit List

#### Input Example

```
https://organization.tencentcloudapi.com/?Action=ListOrganizationNodes
&Nodes.0=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=organization&Version=2018-12-25&Action=ListOrganizationNodes)
