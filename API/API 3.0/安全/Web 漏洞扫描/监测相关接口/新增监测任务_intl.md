...
This API (CreateMonitors) is used to add monitoring tasks for one or more websites.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CreateMonitors |
...
### Example 1. Adding Monitoring Task

#### Input Example

```
https://cws.tencentcloudapi.com/?Action=CreateMonitors
