...
This API (DeleteMonitors) is used to delete monitoring tasks.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteMonitors |
| Version | Yes | String | Common parameter; the value for this API: 2018-03-12 |
| Region | No | String | Common parameter; not passed in for this API |
| MonitorIds.N | Yes | Array of Integer | List of monitoring task IDs |
...
### Example 1. Deleting Monitoring Task

#### Input Example

```
https://cws.tencentcloudapi.com/?Action=DeleteMonitors
&MonitorIds.0=1
&MonitorIds.1=2
