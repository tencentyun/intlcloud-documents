...
This API (DeleteSites) is used to delete a website.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteSites |
...
### Example 1. Deleting Website

#### Input Example

```
https://cws.tencentcloudapi.com/?Action=DeleteSites
&SiteIds.0=1
&SiteIds.1=2
