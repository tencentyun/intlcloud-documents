...
| AppInfos.N | 是 | Array of [AppInfo](https://cloud.tencent.com/document/api/283/17759#AppInfo) | 待扫描的app信息列表，一次最多提交20个 |
| ScanInfo | 是 | [ScanInfo](https://cloud.tencent.com/document/api/283/17759#ScanInfo) | 扫描信息 |
