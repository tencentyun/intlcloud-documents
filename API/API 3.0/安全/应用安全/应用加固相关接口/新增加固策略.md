...
| PlanName | 是 | String | 策略名称 |
| PlanInfo | 是 | [PlanInfo](https://cloud.tencent.com/document/api/283/17759#PlanInfo) | 策略具体信息 |
...
```
https://ms.tencentcloudapi.com/?Action=CreateShieldPlanInstance
...
&PlanInfo.SoInfo.SoFileNames.0=1.so
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=ms&Version=2018-04-08&Action=CreateShieldPlanInstance)
