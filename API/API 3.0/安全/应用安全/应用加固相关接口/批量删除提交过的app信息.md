...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DeleteShieldInstances |
| Version | 是 | String | 公共参数，本接口取值：2018-04-08 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| ItemIds.N | 是 | Array of String | 任务唯一标识ItemId的列表 |
...
### 示例1 根据ItemId对加固实例进行删除

#### 输入示例

```
https://ms.tencentcloudapi.com/?Action=DeleteShieldInstances
&ItemIds.0=hhussxu-hui2677-kk
&ItemIds.1=xyuu-csu-ee78236l
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=ms&Version=2018-04-08&Action=DeleteShieldInstances)
