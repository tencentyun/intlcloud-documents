...
This API (RescanImpactedHosts) is used to redetect a vulnerability.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: RescanImpactedHost. |
| Version | Yes | String | Common parameter. The value used for this API: 2/28/2018 |
| Region | No | String | Common parameter. This parameter is not required for this API. |
| Id | Yes | Integer | Vulnerability ID. |
...
### Example 1 Redetect a vulnerability

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=RescanImpactedHost
&Id=1
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=RescanImpactedHost)
