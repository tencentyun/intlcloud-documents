...
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/296/19867#Filter) | 过滤条件。<br/><li>Status - String - 是否必填：否 - 状态筛选（UN_OPERATED：待处理 &#124; FIXED：已修复）</li> |
...
| ImpactedHosts | Array of [ImpactedHost](https://cloud.tencent.com/document/api/296/19867#ImpactedHost) | 漏洞影响机器列表数组|
