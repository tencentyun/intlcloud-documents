...
This API (CreateProcessTask) is used to create a real-time pull process task.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: CreateProcessTask |
...
### Example 1 Create a real-time pull process task

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=CreateProcessTask
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=CreateProcessTask)
