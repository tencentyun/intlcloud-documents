...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/><li>Username - String - 是否必填：否 - 帐号名</li> |
...
| HistoryAccounts | Array of [HistoryAccount](/document/api/296/19867#HistoryAccount) | 帐号变更历史数据数组。|
