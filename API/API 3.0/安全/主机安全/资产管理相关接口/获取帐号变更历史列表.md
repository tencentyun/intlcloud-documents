...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeHistoryAccounts |
...
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/296/19867#Filter) | 过滤条件。<br/><li>Username - String - 是否必填：否 - 帐号名</li> |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TotalCount | Integer | 帐号变更历史列表记录总数。|
| HistoryAccounts | Array of [HistoryAccount](https://cloud.tencent.com/document/api/296/19867#HistoryAccount) | 帐号变更历史数据数组。|
