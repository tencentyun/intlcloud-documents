...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeProcessTaskStatus |
...
|---------|---------|---------|
| Status | String | Task status. <br/><li>COMPLETE: Completed (you can call the DescribeProcesses API to obtain the real-time process list) </li><li>AGENT_OFFLINE: The HS client is offline. </li><li>COLLECTING: Obtaining process </li><li>FAILED: Failed to get the process </li> |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=DescribeProcessTaskStatus)
