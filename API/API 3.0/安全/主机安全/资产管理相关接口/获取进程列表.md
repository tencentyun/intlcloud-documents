...
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/296/19867#Filter) | 过滤条件。<br/><li>ProcessName - String - 是否必填：否 - 进程名</li><li>MachineIp - String - 是否必填：否 - 主机内网IP</li> |
...
| Processes | Array of [Process](https://cloud.tencent.com/document/api/296/19867#Process) | 进程列表数据数组。|
