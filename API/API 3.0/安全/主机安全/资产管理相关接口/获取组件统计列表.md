...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/>ComponentName - String - 是否必填：否 - 组件名称 |
...
| ComponentStatistics | Array of [ComponentStatistics](/document/api/296/19867#ComponentStatistics) | 组件统计列表数据数组。|
