...
This API (UntrustMaliciousRequest) is used to untrust malicious requests.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: UntrustMaliciousRequest. |
| Version | Yes | String | Common parameter. The value used for this API: 2/28/2018 |
| Region | No | String | Common parameter. This parameter is not required for this API. |
| Id | Yes | Integer | Trusted record ID. |
...
### Example 1 Untrust a malicious request

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=UntrustMaliciousRequest
&Id=1
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=UntrustMaliciousRequest)
