...
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/296/19867#Filter) | 过滤条件。<br/><li>Status - String - 是否必填：否 - 状态筛选（UN_OPERATED: 待处理 &#124; TRUSTED：已信任 &#124; UN_TRUSTED：已取消信任）</li><li>Domain - String - 是否必填：否 - 恶意请求的域名</li><li>MachineIp - String - 是否必填：否 - 主机内网IP</li> |
...
| MaliciousRequests | Array of [MaliciousRequest](https://cloud.tencent.com/document/api/296/19867#MaliciousRequest) | 恶意请求记录数组。|
