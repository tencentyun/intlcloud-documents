...
This API (RecoverMalwares) is used to recover isolated Trojan files in batches.
...
| Ids.N | Yes | Array of Integer | Array of Trojan IDs. A maximum of 200 IDs can be recovered at a time. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| SuccessIds | Array of Integer | Array of IDs of Trojans successfully recovered. |
| FailedIds | Array of Integer | Array of IDs of Trojans that failed to be recovered. |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Recover Trojan files

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=RecoverMalwares
&Ids.0=123
&Ids.1=456
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=RecoverMalwares)
