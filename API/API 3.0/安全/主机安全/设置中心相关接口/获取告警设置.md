...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeAlarmAttribute |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Offline | String | 防护软件离线告警状态：<br/><li>OPEN：告警已开启</li><li>CLOSE： 告警已关闭</li>|
| Malware | String | 发现木马告警状态：<br/><li>OPEN：告警已开启</li><li>CLOSE： 告警已关闭</li>|
| NonlocalLogin | String | 发现异地登录告警状态：<br/><li>OPEN：告警已开启</li><li>CLOSE： 告警已关闭</li>|
| CrackSuccess | String | 被暴力破解成功告警状态：<br/><li>OPEN：告警已开启</li><li>CLOSE： 告警已关闭</li>|
