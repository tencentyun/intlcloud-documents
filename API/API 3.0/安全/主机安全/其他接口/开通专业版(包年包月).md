...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：OpenProVersionPrepaid |
...
| Machines.N | 是 | Array of [ProVersionMachine](https://cloud.tencent.com/document/api/296/19867#ProVersionMachine) | 需要开通专业版主机信息数组。 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| DealIds | Array of String | 订单ID列表。|
