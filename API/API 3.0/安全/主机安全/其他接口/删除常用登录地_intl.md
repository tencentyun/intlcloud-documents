...
This API (DeleteUsualLoginPlaces) is used to delete common login locations.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DeleteUsualLoginPlaces. |
| Version | Yes | String | Common parameter. The value used for this API: 2/28/2018 |
| Region | No | String | Common parameter. This parameter is not required for this API. |
| Uuid | Yes | String | Uuid of the HS client. |
| CityIds.N | Yes | Array of Integer | Array of added common login city IDs. |
...
### Example 1 Delete common login locations

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=DeleteUsualLoginPlaces
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=DeleteUsualLoginPlaces)
