...
This API (DescribeWeeklyReports) is used to obtain the weekly report list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeWeeklyReports. |
...
|---------|---------|---------|
| WeeklyReports | Array of [WeeklyReport](https://cloud.tencent.com/document/api/296/19867#WeeklyReport) | Array of weekly reports of HS Pro. |
| TotalCount | Integer | Total number of records. |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Obtain the list of weekly reports of HS Pro

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=DescribeWeeklyReports
&Limit=10
&Offset=0
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=DescribeWeeklyReports)
