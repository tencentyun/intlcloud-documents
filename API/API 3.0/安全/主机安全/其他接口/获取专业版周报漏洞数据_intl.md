...
|---------|---------|---------|
| WeeklyReportVuls | Array of [WeeklyReportVul](https://cloud.tencent.com/document/api/296/19867#WeeklyReportVul) | Array of vulnerability data in the weekly report of HS Pro. |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=DescribeWeeklyReportVuls)
