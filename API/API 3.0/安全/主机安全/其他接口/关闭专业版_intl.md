...
This API (CloseProVersion) is used to deactivate HS Pro.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: CloseProVersion. |
| Version | Yes | String | Common parameter. The value used for this API: 2/28/2018 |
| Region | No | String | Common parameter. This parameter is not required for this API. |
| Quuid | No | String | Unique Uuid of the host.<br/>InstanceId of a CPM, and Uuid of a CVM. |
...
### Example 1 Deactivate HS Pro

#### Input example

```
https://yunjing.tencentcloudapi.com/?Action=CloseProVersion
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=yunjing&Version=2018-02-28&Action=CloseProVersion)
