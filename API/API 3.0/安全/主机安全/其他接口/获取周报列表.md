...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeWeeklyReports |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| WeeklyReports | Array of [WeeklyReport](https://cloud.tencent.com/document/api/296/19867#WeeklyReport) | 专业周报列表数组。|
