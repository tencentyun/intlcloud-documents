...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeWeeklyReportBruteAttacks |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| WeeklyReportBruteAttacks | Array of [WeeklyReportBruteAttack](https://cloud.tencent.com/document/api/296/19867#WeeklyReportBruteAttack) | 专业周报密码破解数组。|
