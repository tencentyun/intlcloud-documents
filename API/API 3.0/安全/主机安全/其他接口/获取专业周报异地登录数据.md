...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeWeeklyReportNonlocalLoginPlaces |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| WeeklyReportNonlocalLoginPlaces | Array of [WeeklyReportNonlocalLoginPlace](https://cloud.tencent.com/document/api/296/19867#WeeklyReportNonlocalLoginPlace) | 专业周报异地登录数据。|
