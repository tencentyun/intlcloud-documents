...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateUsualLoginPlaces |
| Version | 是 | String | 公共参数，本接口取值：2018-02-28 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| Uuids.N | 是 | Array of String | 云镜客户端UUID数组。 |
| Places.N | 是 | Array of [Place](https://cloud.tencent.com/document/api/296/19867#Place) | 登录地域信息数组。 |
