...
| ChargePrepaid | 是 | [ChargePrepaid](/document/api/296/19867#ChargePrepaid) | 预付费模式(包年包月)参数设置。 |
| Machines.N | 是 | Array of [ProVersionMachine](/document/api/296/19867#ProVersionMachine) | 需要开通专业版机器列表数组。 |
