...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：InquiryPriceOpenProVersionPrepaid |
| Version | 是 | String | 公共参数，本接口取值：2018-02-28 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| ChargePrepaid | 是 | [ChargePrepaid](https://cloud.tencent.com/document/api/296/19867#ChargePrepaid) | 预付费模式(包年包月)参数设置。 |
| Machines.N | 是 | Array of [ProVersionMachine](https://cloud.tencent.com/document/api/296/19867#ProVersionMachine) | 需要开通专业版机器列表数组。 |
