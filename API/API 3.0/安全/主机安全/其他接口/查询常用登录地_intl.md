...
This API (DescribeUsualLoginPlaces) is used to query common login locations.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeUsualLoginPlaces. |
...
|---------|---------|---------|
| UsualLoginPlaces | Array of [UsualPlace](https://cloud.tencent.com/document/api/296/19867#UsualPlace) | Array of common login locations. |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Query common login locations
