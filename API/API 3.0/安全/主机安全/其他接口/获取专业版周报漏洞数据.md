...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeWeeklyReportVuls |
| Version | 是 | String | 公共参数，本接口取值：2018-02-28 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| BeginDate | 是 | Date | 专业版周报开始时间。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| WeeklyReportVuls | Array of [WeeklyReportVul](https://cloud.tencent.com/document/api/296/19867#WeeklyReportVul) | 专业周报漏洞数据数组。|
