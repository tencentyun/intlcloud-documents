...
|---------|---------|---------|
| WeeklyReportNonlocalLoginPlaces | Array of [WeeklyReportNonlocalLoginPlace](https://cloud.tencent.com/document/api/296/19867#WeeklyReportNonlocalLoginPlace) | Remote login data in the weekly report of HS Pro. |
