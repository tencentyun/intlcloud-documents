...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeOverviewStatistics |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| OnlineMachineNum | Integer | 服务器在线数。|
| ProVersionMachineNum | Integer | 专业服务器数。|
| MalwareNum | Integer | 木马文件数。|
| NonlocalLoginNum | Integer | 异地登录数。|
| BruteAttackSuccessNum | Integer | 暴力破解成功数。|
| VulNum | Integer | 漏洞数。|
| BaseLineNum | Integer | 安全基线数。|
