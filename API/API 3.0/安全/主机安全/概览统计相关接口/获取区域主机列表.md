...
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/296/19867#Filter) | 过滤条件。<br/><li>Keywords - String - 是否必填：否 - 查询关键字 </li><li>Status - String - 是否必填：否 - 客户端在线状态（OFFLINE: 离线 &#124; ONLINE: 在线）</li><li>Version - String  是否必填：否 - 当前防护版本（ PRO_VERSION：专业版 &#124; BASIC_VERSION：基础版）</li><br/>每个过滤条件只支持一个值，暂不支持多个值“或”关系查询 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Machines | Array of [Machine](https://cloud.tencent.com/document/api/296/19867#Machine) | 主机列表|
