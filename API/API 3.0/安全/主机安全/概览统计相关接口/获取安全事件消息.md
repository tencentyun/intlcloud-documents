...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeSecurityDynamics |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| SecurityDynamics | Array of [SecurityDynamic](https://cloud.tencent.com/document/api/296/19867#SecurityDynamic) | 安全事件消息数组。|
