...
This API disables the specified customer master keys (CMKs) in batches.
...
| KeyIds.N | Yes | Array of String | List of IDs of CMKs to be disabled in batches. Up to 100 CMKs are supported at a time |
...
Disable the specified list of CMKs in batches.
