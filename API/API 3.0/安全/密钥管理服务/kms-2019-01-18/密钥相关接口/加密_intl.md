...
This API is used to encrypt up to 4 KB of data. Such data include database passwords, RSA keys, or other sensitive information. You can also use `DataKey` generated by API GenerateDataKey to encrypt or decrypt your local data.
