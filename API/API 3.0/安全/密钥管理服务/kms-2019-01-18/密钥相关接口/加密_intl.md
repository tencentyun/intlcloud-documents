...
This API encrypts maximum 4 KB of data. Such data includes database passwords, RSA keys, or other sensitive information. You can also use `DataKey` generated by API GenerateDataKey to encrypt or decrypt your local data.
