...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeKey |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| KeyMetadata | [KeyMetadata](https://cloud.tencent.com/document/api/573/34431#KeyMetadata) | 密钥属性信息<br/>注意：此字段可能返回 null，表示取不到有效值。|
