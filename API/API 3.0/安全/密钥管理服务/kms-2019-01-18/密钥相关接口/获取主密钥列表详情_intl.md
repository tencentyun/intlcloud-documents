...
| KeyMetadatas | Array of [KeyMetadata](https://cloud.tencent.com/document/api/573/34431#KeyMetadata) | List of attributes returned <br/>Note: This field may return null, indicating that no valid values can be obtained. |
