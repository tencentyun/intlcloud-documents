...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeAccessRegions |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TotalCount | Integer | 加速区域总数|
| AccessRegionSet | Array of [RegionDetail](/document/api/608/37023#RegionDetail) | 加速区域详情列表|
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DescribeAccessRegions)
