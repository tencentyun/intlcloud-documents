...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DeleteSecurityRules |
| Version | 是 | String | 公共参数，本接口取值：2018-05-29 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| PolicyId | 是 | String | 安全策略ID |
| RuleIdList.N | 是 | Array of String | 访问规则ID列表 |
...
```
https://gaap.tencentcloudapi.com/?Action=DeleteSecurityRules
&PolicyId=sp-xxxx
&RuleIdList.0=sr-xxx
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DeleteSecurityRules)
