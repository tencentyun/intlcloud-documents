...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：OpenSecurityPolicy |
| Version | 是 | String | 公共参数，本接口取值：2018-05-29 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| ProxyId | 是 | String | 需开启安全策略的通道ID |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TaskId | String | 异步流程ID，可以通过DescribeAsyncTaskStatus接口查询流程运行状态|
...
```
https://gaap.tencentcloudapi.com/?Action=OpenSecurityPolicy
&ProxyId=link-xxxx
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=OpenSecurityPolicy)
