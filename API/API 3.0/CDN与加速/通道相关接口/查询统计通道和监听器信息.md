...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeProxyAndStatisticsListeners |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| ProxySet | Array of [ProxySimpleInfo](/document/api/608/37023#ProxySimpleInfo) | 可以统计的通道信息|
| TotalCount | Integer | 通道数量|
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DescribeProxyAndStatisticsListeners)
