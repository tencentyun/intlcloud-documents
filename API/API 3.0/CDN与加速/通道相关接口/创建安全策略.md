...
| ProxyId | 是 | String | 加速通道ID |
| DefaultAction | 是 | String | 默认策略：ACCEPT或DROP |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| PolicyId | String | 安全策略ID|
...
```
https://gaap.tencentcloudapi.com/?Action=CreateSecurityPolicy
&ProxyId=link-1234
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=CreateSecurityPolicy)
