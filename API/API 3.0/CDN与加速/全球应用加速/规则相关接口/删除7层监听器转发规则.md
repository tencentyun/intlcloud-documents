...
| Force | 是 | Integer | 是否可以强制删除已绑定源站的转发规则，0非强制，1强制 |
...
```
https://gaap.tencentcloudapi.com/?Action=DeleteRule
&ListenerId=0
&RuleId=rule-18vhg67
&Force=1
&<公共请求参数>
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DeleteRule)
