...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeRegionAndPrice |
...
| Currency | String | 带宽价格货币类型：<br/>CNY 人民币<br/>USD 美元|
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DescribeRegionAndPrice)
