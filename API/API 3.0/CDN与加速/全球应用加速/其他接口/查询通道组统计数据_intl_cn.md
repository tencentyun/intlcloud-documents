...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeProxyGroupStatistics |
| Version | 是 | String | 公共参数，本接口取值：2018-05-29 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| GroupId | 是 | String | 通道组ID |
| StartTime | 是 | Timestamp | 起始时间 |
| EndTime | 是 | Timestamp | 结束时间 |
| MetricNames.N | 是 | Array of String | 统计指标名称列表，支持: 入带宽:InBandwidth, 出带宽:OutBandwidth, 并发:Concurrent, 入包量:InPackets, 出包量:OutPackets |
...
```
https://gaap.tencentcloudapi.com/?Action=DescribeProxyGroupStatistics
&GroupId=lg-rfgt56hy
&MetricNames.0=InputBandwidth
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DescribeProxyGroupStatistics)
