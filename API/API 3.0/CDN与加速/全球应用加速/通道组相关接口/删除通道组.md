...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DeleteProxyGroup |
| Version | 是 | String | 公共参数，本接口取值：2018-05-29 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| GroupId | 否 | String | 需要删除的通道组ID。 |
...
```
https://gaap.tencentcloudapi.com/?Action=DeleteProxyGroup
&GroupId=lg-b7h4d02f
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DeleteProxyGroup)
