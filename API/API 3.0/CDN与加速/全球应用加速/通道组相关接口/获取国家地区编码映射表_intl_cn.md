...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeCountryAreaMapping |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| CountryAreaMappingList | Array of [CountryAreaMap](/document/api/608/37023#CountryAreaMap) | 国家地区编码映射表。|
...
```
https://gaap.tencentcloudapi.com/?Action=DescribeCountryAreaMapping
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=DescribeCountryAreaMapping)
