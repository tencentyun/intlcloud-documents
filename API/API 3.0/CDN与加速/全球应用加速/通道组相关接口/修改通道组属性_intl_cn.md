...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyProxyGroupAttribute |
| Version | 是 | String | 公共参数，本接口取值：2018-05-29 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| GroupId | 是 | String | 需要修改的通道组ID。 |
| GroupName | 否 | String | 修改后的通道组名称：不超过30个字符，超过部分会被截断。 |
...
```
https://gaap.tencentcloudapi.com/?Action=ModifyProxyGroupAttribute
&GroupId=lg-b7h4d02f
&GroupName=newName
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=gaap&Version=2018-05-29&Action=ModifyProxyGroupAttribute)
