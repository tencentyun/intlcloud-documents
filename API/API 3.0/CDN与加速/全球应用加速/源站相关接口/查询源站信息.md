...
| TagSet.N | 否 | Array of [TagPair](https://cloud.tencent.com/document/api/608/37023#TagPair) | 标签列表，当存在该字段时，拉取对应标签下的资源列表。<br/>最多支持5个标签，当存在两个或两个以上的标签时，满足其中任意一个标签时，源站会被拉取出来。 |
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/608/37023#Filter) | 过滤条件。filter的name取值(RealServerName,RealServerIP) |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| RealServerSet | Array of [BindRealServerInfo](https://cloud.tencent.com/document/api/608/37023#BindRealServerInfo) | 源站信息列表|
