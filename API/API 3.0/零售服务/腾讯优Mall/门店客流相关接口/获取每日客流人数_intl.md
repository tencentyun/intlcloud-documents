...
This API queries the total number of visitors to a shop per day in the specified time period. Supported time range: last 365 days (including the current day).
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; its value for this API: DescribeShopTrafficInfo |
...
| ShopDayTrafficInfoSet | Array of [ShopDayTrafficInfo](https://cloud.tencent.com/document/api/860/18465#ShopDayTrafficInfo) | Visitor traffic information list |
| RequestId | String | The unique request ID which is returned for each request. The RequestId for the current request needs to be provided when troubleshooting. |

## 4. Examples

### Example 1. Getting Number of Daily Visitors - Success

#### Input Example

```
https://youmall.tencentcloudapi.com/?Action=DescribeShopTrafficInfo
...
### Example 2. Getting Number of Daily Visitors - Failure
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=youmall&Version=2018-02-28&Action=DescribeShopTrafficInfo)
