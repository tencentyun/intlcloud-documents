...
This API queries the total number of daily visitors and average stay time in all zones (configured when deploying YouMall) of a specified shop in the specified time period. Supported time range: last 365 days (including the current day).
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; its value for this API: DescribeZoneTrafficInfo |
...
### Example 1. Getting Zone-specific Number of Visitors and Stay Time - Success

#### Input Example

```
https://youmall.tencentcloudapi.com/?Action=DescribeZoneTrafficInfo
        ...
        "ZoneTrafficInfoDetailSet": [
          {
            ...
            "TrafficCount": 122,
            "ZoneId": 1,
            "ZoneName": "Toiletries zone"
          },
          {
            "AvgStayTime": 1300,
            "TrafficCount": 1202,
            "ZoneId": 2,
            "ZoneName": "Kitchenware zone"
          }
        ]
      },
      {
...
### Example 2. Getting Zone-specific Number of Visitors and Stay Time - Failure
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=youmall&Version=2018-02-28&Action=DescribeZoneTrafficInfo)
