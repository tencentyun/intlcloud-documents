...
|---------|---------|---------|
| CacheOptResult | [CacheOptResult](https://cloud.tencent.com/document/api/228/30987#CacheOptResult) | Action result <br/>Note: This field may return null, indicating that no valid values can be obtained. |
