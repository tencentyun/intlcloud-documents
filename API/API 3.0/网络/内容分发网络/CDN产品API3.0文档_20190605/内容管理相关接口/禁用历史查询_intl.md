...
|---------|---------|---------|
| UrlRecordList | Array of [UrlRecord](https://cloud.tencent.com/document/api/228/30987#UrlRecord) | Blocking history <br/>Note: This field may return null, indicating that no valid values can be obtained. |
