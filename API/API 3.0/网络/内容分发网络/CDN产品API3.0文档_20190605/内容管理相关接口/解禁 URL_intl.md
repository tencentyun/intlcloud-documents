...
EnableCaches enables one or more URLs that have been manually blocked. It takes about 5 to 10 minutes for the unblocked URLs to take effect across the entire network. (This API is in beta)
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter, the name of this API: EnableCaches |
...
|---------|---------|---------|
| CacheOptResult | [CacheOptResult](https://cloud.tencent.com/document/api/228/30987#CacheOptResult) | Result list <br/>Note: This field may return null, indicating that no valid values can be obtained. |
