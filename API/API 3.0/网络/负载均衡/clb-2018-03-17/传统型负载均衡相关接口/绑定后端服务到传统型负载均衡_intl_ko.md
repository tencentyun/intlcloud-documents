...
RegisterTargetsWithClassicalLB는 RS를 전통형 CLB에 바인딩하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: RegisterTargetsWithClassicalLB |
...
| Targets.N | 예 | Array of [ClassicalTargetInfo](https://cloud.tencent.com/document/api/214/30694#ClassicalTargetInfo) | RS 정보 |
