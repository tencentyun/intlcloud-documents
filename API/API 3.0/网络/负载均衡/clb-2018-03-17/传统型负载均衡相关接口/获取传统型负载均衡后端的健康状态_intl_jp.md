...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| HealthList | Array of [ClassicalHealth](https://cloud.tencent.com/document/api/214/30694#ClassicalHealth) | バックエンドの正常性リスト<br/>注意：このフィールドはnullを返す可能性があり、有効値を取得できないことを表します。|
