...
DescribeClassicalLBTargets는 전통형 CLB가 바인딩한 RS를 획득하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: DescribeClassicalLBTargets |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| Targets | Array of [ClassicalTarget](https://cloud.tencent.com/document/api/214/30694#ClassicalTarget) | RS 리스트<br/>주의: 이 필드는 null을 반환할 수 있으며 유효값을 얻지 못했음을 의미합니다.|
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시 1 전통형 CLB의 RS 정보 획득
