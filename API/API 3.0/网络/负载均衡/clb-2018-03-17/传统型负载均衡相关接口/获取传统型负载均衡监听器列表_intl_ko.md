...
DescribeClassicalLBListeners는 전통형 CLB 정보를 획득하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: DescribeClassicalLBListeners |
...
| ListenerIds.N | 아니요 | Array of String | 로드밸런서 수신기 ID 리스트, 범위: [1-65535] |
| Protocol | 아니요 | String | CLB가 수신한 프로토콜, 'TCP', 'UDP', 'HTTP', 'HTTPS' |
| ListenerPort | 아니요 | Integer | CLB 수신 포트 |
| Status | 아니요 | Integer | 수신기의 상태, 0은 생성 중, 1은 운행 중을 의미함 |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| Listeners | Array of [ClassicalListener](https://cloud.tencent.com/document/api/214/30694#ClassicalListener) | 수신기 리스트<br/>주의: 이 필드는 null을 반환할 수 있으며 유효값을 얻지 못했음을 의미합니다.|
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시 1 전통형 CLB의 수신기 정보 획득

#### 입력 예시

```
https://clb.tencentcloudapi.com/?Action=DescribeClassicalLBListeners
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=clb&Version=2018-03-17&Action=DescribeClassicalLBListeners)
