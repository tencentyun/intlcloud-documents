...
DescribeClassicalLBTargetsは、従来型CLBにバインディングされたRSを取得するために使用されます
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeClassicalLBTargets |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| Targets | Array of [ClassicalTarget](https://cloud.tencent.com/document/api/214/30694#ClassicalTarget) | RSリスト<br/>注意：このフィールドはnullを返す可能性があり、有効値を取得できないことを表します。|
