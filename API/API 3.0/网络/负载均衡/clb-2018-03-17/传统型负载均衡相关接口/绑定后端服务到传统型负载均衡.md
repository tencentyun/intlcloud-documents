...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：RegisterTargetsWithClassicalLB |
...
| Targets.N | 是 | Array of [ClassicalTargetInfo](https://cloud.tencent.com/document/api/214/30694#ClassicalTargetInfo) | 后端服务信息 |
