...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyTargetPort |
...
| Targets.N | 是 | Array of [Target](https://cloud.tencent.com/document/api/214/30694#Target) | 要修改端口的后端机器列表 |
| NewPort | 是 | Integer | 后端机器绑定到监听器的新端口 |
| LocationId | 否 | String | 转发规则的ID |
...
将注册到监听器lbl-d1ubsydq的云服务器ins-dm4xtz0i的端口从原来的233改为334
