...
DescribeTargets API는 응용형 로드밸런서 인스턴스의 수신기가 백 엔드에 바인딩한 CVM 리스트를 조회하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: DescribeTargets |
...
| ListenerIds.N | 아니요 | Array of String | 수신기 ID 리스트 |
| Protocol | 아니요 | String | 수신기 프로토콜 유형 |
| Port | 아니요 | Integer | CLB 수신기 포트 |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| Listeners | Array of [ListenerBackend](https://cloud.tencent.com/document/api/214/30694#ListenerBackend) | 수신기 백 엔드가 바인딩한 CVM 정보|
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시 1 수신기에 등록한 CVM 조회
