...
CreateRule APIは、既存のアプリケーション型CLBの7層リスナー下で転送規則を作成するために使用されます。7層リスナーにおいて、RSはリスナーにではなく、規則にバインディングされる必要があります。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：CreateRule |
...
| Rules.N | はい | Array of [RuleInput](https://cloud.tencent.com/document/api/214/30694#RuleInput) | 転送規則の新規作成情報 |
