...
DeleteLoadBalancer API는 사용자가 지정한 로드밸런서 인스턴스를 삭제하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: DeleteLoadBalancer |
...
| LoadBalancerIds.N | 예 | Array of String | 삭제할 로드밸런서 인스턴스 ID 배열 |
