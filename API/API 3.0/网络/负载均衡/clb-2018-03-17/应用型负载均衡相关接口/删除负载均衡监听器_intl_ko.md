...
이 API는 응용형(4계층과 7계층) 로드밸런서 인스턴스의 수신기를 삭제하는 데 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: DeleteListener |
...
| LoadBalancerId | 예 | String | 응용형 로드밸런서 인스턴스 ID |
| ListenerId | 예 | String | 삭제할 수신기 ID |
