...
ロードバランサーインスタンスの属性を変更し、現在、ロードバランサーインスタンス名を変更するためにしか使用されません。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyLoadBalancerAttributes |
...
| LoadBalancerId | はい | String | CLBの唯一のID |
| LoadBalancerName | いいえ | String | ロードバランサーインスタンス名 |
