...
로드밸런서 인스턴스의 속성을 수정합니다. 현재는 로드밸런서 인스턴스의 이름을 수정하는 데만 사용됩니다.
...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, API 값: ModifyLoadBalancerAttributes |
...
| LoadBalancerId | 예 | String | CLB의 고유 ID |
