...
This API (DescribeAccountAttributes) is used to query the attributes of your account.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DescribeAccountAttributes |
...
|---------|---------|---------|
| AccountAttributeSet | Array of [AccountAttribute](https://cloud.tencent.com/document/api/215/##AccountAttribute) | Your account attribute object |
...
### Example 1 Query the network attributes of the account

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DescribeAccountAttributes
&Version=2017-03-12
...
### Example 2 Query the network attributes of the account
...
```
{
  "Response": {
    ...
    "RequestId": "e74cec1b-882a-4a91-aeb7-587731e0ecb2"
  }
}
```
