...
| Filters.N | No | Array of [Filter](https://cloud.tencent.com/document/api/215/##Filter) | Filter conditions.<br/><li> address-template-name - String - (Filter condition ) IP address template name.</li><li> address-template-id - String - (Filter condition ) IP address template instance ID, such as ipm-mdunqeb6.</li> |
...
| AddressTemplateSet | Array of [AddressTemplate](https://cloud.tencent.com/document/api/215/##AddressTemplate) | IP address template. |
