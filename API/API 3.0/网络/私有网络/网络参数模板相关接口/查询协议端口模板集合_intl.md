...
| Filters.N | No | Array of [Filter](https://cloud.tencent.com/document/api/215/##Filter) | Filter conditions.<br/><li> service-template-group-name - String - (Filter condition ) Protocol port template group name.</li><li> service-template-group-id - String - (Filter condition ) Protocol port template group instance ID, such as ppmg-e6dy460g.</li> |
...
| ServiceTemplateGroupSet | Array of [ServiceTemplateGroup](https://cloud.tencent.com/document/api/215/##ServiceTemplateGroup) | Protocol port template group. |
