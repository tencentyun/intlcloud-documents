...
| ServiceTemplateGroupName | Yes | String | Protocol port template group name |
| ServiceTemplateIds.N | Yes | Array of String | Protocol port template instance ID, such as ppm-4dw6agho. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| ServiceTemplateGroup | [ServiceTemplateGroup](https://cloud.tencent.com/document/api/215/##ServiceTemplateGroup) | Protocol port template group object. |
...
### Example 1 Create a protocol port template group
