...
This API (TransformAddress) is used to convert an ordinary public IP into an [Elastic IP](https://intl.cloud.tencent.com/document/product/213/5733) (EIP).
* The platform imposes a quota on the number of attempts to unbind an EIP and reallocate an ordinary public IP per day for each region (See [Overview of EIP products](https://intl.cloud.tencent.com/document/product/213/5733)). The above quota can be obtained through API [DescribeAddressQuota](https://cloud.tencent.com/document/api/213/1378).
