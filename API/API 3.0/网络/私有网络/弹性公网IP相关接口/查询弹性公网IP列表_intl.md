...
This API (DescribeAddresses) is used to query the details of one or more [Elastic IPs](https://intl.cloud.tencent.com/document/product/213/5733) (EIP).
...
| AddressSet | Array of [Address](https://cloud.tencent.com/document/api/215/##Address) | List of details of EIPs. |
