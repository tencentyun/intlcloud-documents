...
This API (DeleteRoutes) is used to delete routing policies in a route table in batch.
...
| Routes.N | Yes | Array of [Route](https://cloud.tencent.com/document/api/215/##Route) | Routing policy object. |
...
### Example 1 Delete routing policies

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DeleteRoutes
&Version=2017-03-12
