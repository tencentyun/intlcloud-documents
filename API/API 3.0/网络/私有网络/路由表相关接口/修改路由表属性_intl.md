...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyRouteTableAttribute |
...
### Example 1 Modify the attributes of a route table

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=ModifyRouteTableAttribute
&Version=2017-03-12
