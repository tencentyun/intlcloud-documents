...
| SecurityGroupPolicySet | Yes | [SecurityGroupPolicySet](https://cloud.tencent.com/document/api/215/##SecurityGroupPolicySet) | Security group policy set. SecurityGroupPolicySet object must specify new egress and ingress policies at the same time. SecurityGroupPolicy object does not support custom index (PolicyIndex). |
