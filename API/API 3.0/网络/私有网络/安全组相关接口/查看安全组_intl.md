...
| Filters.N | No | Array of [Filter](https://cloud.tencent.com/document/api/215/##Filter) | Filter condition. SecurityGroupIds and Filters cannot be specified at the same time.<br/><li> project-id - Integer - (Filter condition) Project ID.</li><li> security-group-name - String - (Filter condition) Security group name.</li> |
...
|---------|---------|---------|
| SecurityGroupSet | Array of [SecurityGroup](https://cloud.tencent.com/document/api/215/##SecurityGroup) | Security group object. |
