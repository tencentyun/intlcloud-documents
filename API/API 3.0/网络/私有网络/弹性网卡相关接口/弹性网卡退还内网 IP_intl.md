...
*To return the secondary private IPs associated with an ENI, the API will dissociate these IPs from the ENI. The primary private IP of the ENI cannot be returned.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: UnassignPrivateIpAddresses |
...
| PrivateIpAddresses.N | Yes | Array of [PrivateIpAddressSpecification](https://cloud.tencent.com/document/api/215/##PrivateIpAddressSpecification) | Specifies the private IP information. |
...
### Example 1 Return private IPs of ENI

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=UnassignPrivateIpAddresses
&Version=2017-03-12
