...
This API (DownloadCustomerGatewayConfiguration) is used to download VPN tunnel configuration.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DownloadCustomerGatewayConfiguration |
...
| CustomerGatewayVendor | Yes | [CustomerGatewayVendor](https://cloud.tencent.com/document/api/215/##CustomerGatewayVendor) | Customer gateway vendor information object, which can be obtained through DescribeCustomerGatewayVendors. |
| InterfaceName | Yes | String | Name of the physical API for tunnel access device. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| CustomerGatewayConfiguration | String | Configuration information in XML format. |
...
### Example 1 Download VPN tunnel configuration

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DownloadCustomerGatewayConfiguration
&Version=2017-03-12
