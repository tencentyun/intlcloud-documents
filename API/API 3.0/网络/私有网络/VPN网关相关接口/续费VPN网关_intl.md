...
This API (RenewVpnGateway) is used to renew prepaid VPN gateways. Only IPSEC gateways are supported.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: RenewVpnGateway |
...
| InstanceChargePrepaid | Yes | [InstanceChargePrepaid](https://cloud.tencent.com/document/api/215/##InstanceChargePrepaid) | Prepaid billing method. |
...
### Example 1 Renew a VPN gateway

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=RenewVpnGateway
&Version=2017-03-12
