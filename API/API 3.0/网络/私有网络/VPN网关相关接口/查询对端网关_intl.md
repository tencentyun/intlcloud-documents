...
|---------|---------|---------|
| CustomerGatewaySet | Array of [CustomerGateway](https://cloud.tencent.com/document/api/215/##CustomerGateway) | Customer gateway object list |
