...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteCustomerGateway |
...
### Example 1 Delete a customer gateway

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DeleteCustomerGateway
&Version=2017-03-12
