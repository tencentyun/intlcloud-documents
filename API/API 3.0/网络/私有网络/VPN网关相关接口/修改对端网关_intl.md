...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyCustomerGatewayAttribute |
...
### Example 1 Modify the customer gateway

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=ModifyCustomerGatewayAttribute
&Version=2017-03-12
