...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteVpnConnection |
...
### Example 1 Delete a VPN tunnel

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DeleteVpnConnection
&Version=2017-03-12
