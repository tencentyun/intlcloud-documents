...
| SecurityPolicyDatabases.N | Yes | Array of [SecurityPolicyDatabase](https://cloud.tencent.com/document/api/215/##SecurityPolicyDatabase) | SPD policy group, such as {"10.0.0.5/24":["172.123.10.5/16"]}, where 10.0.0.5/24 is an IP address range of the VPC and 172.123.10.5/16 is an IP address range of the IDC. You can specify which IP address ranges in the VPC can communicate with which IP address ranges in your IDC. |
| IKEOptionsSpecification | No | [IKEOptionsSpecification](https://cloud.tencent.com/document/api/215/##IKEOptionsSpecification) | IKE (Internet Key Exchange) configuration. IKE is provided with a self-protection mechanism. The network security protocol is configured by the user. |
| IPSECOptionsSpecification | No | [IPSECOptionsSpecification](https://cloud.tencent.com/document/api/215/##IPSECOptionsSpecification) | IPSec configuration. The IPSec secure session configuration is provided by Tencent Cloud. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| VpnConnection | [VpnConnection](https://cloud.tencent.com/document/api/215/##VpnConnection) | Tunnel instance object. |
