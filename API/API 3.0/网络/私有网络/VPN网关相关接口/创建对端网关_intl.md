...
| CustomerGatewayName | Yes | String | Customer gateway name, which is limited to 60 characters. |
| IpAddress | Yes | String | Public IP of the customer gateway. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| CustomerGateway | [CustomerGateway](https://cloud.tencent.com/document/api/215/##CustomerGateway) | Customer gateway object |
...
| VpcLimitExceeded | The limit of requested VPC resources for the specific region has been reached. |

## 5. Example

### Example 1 Create a customer gateway
