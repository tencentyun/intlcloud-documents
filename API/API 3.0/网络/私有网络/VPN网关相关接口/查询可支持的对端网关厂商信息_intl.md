...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DescribeCustomerGatewayVendors |
...
|---------|---------|---------|
| CustomerGatewayVendorSet | Array of [CustomerGatewayVendor](https://cloud.tencent.com/document/api/215/##CustomerGatewayVendor) | Customer gateway vendor information object. |
...
### Example 1 Query the information of supported customer gateway vendors

#### Input example

```
https://vpc.tencentcloudapi.com/?Action=DescribeCustomerGatewayVendors
&Version=2017-03-12
