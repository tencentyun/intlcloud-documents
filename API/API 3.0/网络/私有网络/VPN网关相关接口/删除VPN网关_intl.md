...
This API (DeleteVpnGateway) is used to delete VPN gateways. Only postpaid IPSEC gateway instances in running can be deleted.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteVpnGateway |
