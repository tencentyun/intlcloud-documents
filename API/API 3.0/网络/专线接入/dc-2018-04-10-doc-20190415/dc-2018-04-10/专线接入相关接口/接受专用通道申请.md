...
| DirectConnectTunnelId | 是 | String | 物理专线拥有者接受共享专用通道申请 |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=dc&Version=2018-04-10&Action=AcceptDirectConnectTunnel)
