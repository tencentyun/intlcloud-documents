...
| BgpPeer | 否 | [BgpPeer](https://cloud.tencent.com/document/api/216/18418#BgpPeer) | 用户侧BGP，包括Asn，AuthKey |
| RouteFilterPrefixes.N | 否 | Array of [RouteFilterPrefix](https://cloud.tencent.com/document/api/216/18418#RouteFilterPrefix) | 用户侧网段地址 |
