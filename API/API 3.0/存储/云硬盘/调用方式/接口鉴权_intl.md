...
Take the CVM API DescribeInstances as an example. When you invoke this API, the request parameters may be as follows:

| Parameter Name | Description | Parameter Value |
|---------|---------|---------|
| Action | API name | DescribeInstances |
...
## 3. Encoding Signature

The generated signature cannot be directly used as a request parameter and needs to be URL encoded.
...
**Note: The network libraries of some programming languages automatically URL encode all parameters, in which case there is no need to URL encode the signature; otherwise, two rounds of URL encoding will cause the signature to fail.**
