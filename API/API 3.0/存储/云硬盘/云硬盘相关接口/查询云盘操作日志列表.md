...
| Filters.N | 是 | Array of [Filter](https://cloud.tencent.com/document/api/362/15669#Filter) | 过滤条件。支持以下条件：<br/><li>disk-id - Array of String - 是否必填：是 - 按云盘ID过滤，每个请求最多可指定10个云盘ID。 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| DiskOperationLogSet | Array of [DiskOperationLog](https://cloud.tencent.com/document/api/362/15669#DiskOperationLog) | 云盘的操作日志列表。|
