...
* 只支持修改弹性云盘的项目ID。随云主机创建的云硬盘项目ID与云主机联动。可以通过[DescribeDisks](https://intl.cloud.tencent.com/document/product/362/16315)接口查询，见输出参数中Portable字段解释。
...
| ProjectId | 否 | Integer | 新的云硬盘项目ID，只支持修改弹性云盘的项目ID。通过[DescribeProject](https://cloud.tencent.com/document/api/378/4400)接口查询可用项目及其ID。 |
