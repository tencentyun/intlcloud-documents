...
| InstanceIds.N | 是 | Array of String | 云服务器实例ID，通过[DescribeInstances](https://intl.cloud.tencent.com/document/product/213/33258)接口查询。 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| AttachDetail | Array of [AttachDetail](https://cloud.tencent.com/document/api/362/15669#AttachDetail) | 各个云服务器已挂载和可挂载弹性云盘的数量。|
