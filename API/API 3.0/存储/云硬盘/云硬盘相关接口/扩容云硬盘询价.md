...
| DiskId | 是 | String | 云硬盘ID， 通过[DescribeDisks](https://intl.cloud.tencent.com/document/product/362/16315)接口查询。 |
| DiskSize | 是 | Integer | 云硬盘扩容后的大小，单位为GB，不得小于当前云硬盘大小。云盘大小取值范围参见云硬盘[产品分类](https://intl.cloud.tencent.com/document/product/362/31636)的说明。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| DiskPrice | [PrepayPrice](https://cloud.tencent.com/document/api/362/15669#PrepayPrice) | 描述了扩容云盘的价格。|
