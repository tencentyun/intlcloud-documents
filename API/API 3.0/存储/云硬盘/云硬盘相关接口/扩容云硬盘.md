...
* 只支持扩容弹性云盘。云硬盘类型可以通过[DescribeDisks](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/16315)接口查询，见输出参数中Portable字段解释。随云主机创建的云硬盘需通过[ResizeInstanceDisks](https://intl.cloud.tencent.com/document/product/213/33238)接口扩容。
* 本接口为异步接口，接口成功返回时，云盘并未立即扩容到指定大小，可通过接口[DescribeDisks](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态为“EXPANDING”，表示正在扩容中，当状态变为“UNATTACHED”，表示扩容完成。 
...
| DiskId | 是 | String | 云硬盘ID， 通过[DescribeDisks](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/16315)接口查询。 |
| DiskSize | 是 | Integer | 云硬盘扩容后的大小，单位为GB，必须大于当前云硬盘大小。云盘大小取值范围参见云硬盘[产品分类](https://intl.cloud.tencent.com/document/product/362/31636)的说明。 |
