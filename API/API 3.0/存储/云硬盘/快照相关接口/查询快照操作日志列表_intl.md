...
| Filters.N | Yes | Array of [Filter](https://cloud.tencent.com/document/api/362/15669#Filter) | Filter conditions. <br/><li>snapshot-id - Array of String - Required or not: Yes - Filtered according to the snapshot ID. Each request can specify up to 10 snapshot IDs. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| SnapshotOperationLogSet | Array of [SnapshotOperationLog](https://cloud.tencent.com/document/api/362/15669#SnapshotOperationLog) | The snapshot operation log list. |
