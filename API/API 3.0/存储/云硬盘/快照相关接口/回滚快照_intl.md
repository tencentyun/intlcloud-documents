...
* The snapshot can only be rolled back to the original cloud disk. If you want to duplicate data on a data disk snapshots to other cloud disks, please use the API [CreateDisks](https://intl.cloud.tencent.com/document/product/362/16312) to create one or more elastic cloud disks and then copy the snapshot data to the created cloud disks. 
* The snapshot for rollback must be in NORMAL status. The snapshot status can be queried in the SnapshotState field in the output parameter of API [DescribeSnapshots](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/15647).
* For elastic cloud disks, the cloud disk must be in UNMOUNTED status. You can check the status in the `Attached` filed returned by API [DescribeDisks](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/16315). For non-elastic cloud disks purchased together with instances, the instance must be in SHUTDOWN status. You can check the status using API [DescribeInstancesStatus](https://intl.cloud.tencent.com/document/product/213/33256).
...
| SnapshotId | Yes | String | Snapshot ID, which can be queried via [DescribeSnapshots](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/15647). |
| DiskId | Yes | String | ID of the original cloud disk corresponding to the snapshot, which can be queried via the API [DescribeDisks](https://intl.cloud.tencent.comhttps://intl.cloud.tencent.com/document/product/362/16315). |
