...
* 每个地域可创建的定期快照策略数量限制请参考文档[定期快照](https://intl.cloud.tencent.com/document/product/362/35238)。
...
| Policy.N | 是 | Array of [Policy](https://cloud.tencent.com/document/api/362/15669#Policy) | 定期快照的执行策略。 |
