...
* You can unbind multiple cloud disks from one snapshot policy in batches. 
...
| DiskIds.N | Yes | Array of String | The list of the IDs of the cloud disks to be unbound from the scheduled snapshot policy. |
| AutoSnapshotPolicyId | Yes | String | The ID of the scheduled snapshot policy to be unbound. |
...
### Sample 1. Unbinding a Scheduled Snapshot Policy
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cbs&Version=2017-03-12&Action=UnbindAutoSnapshotPolicy)
