...
* You can delete scheduled snapshot policies in batches. If one of the scheduled snapshot policies in a batch cannot be deleted, the operation is not performed and a specific error code is returned.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DeleteAutoSnapshotPolicies |
...
| AutoSnapshotPolicyIds.N | String | The list of IDs of the scheduled snapshot policies to be deleted. |
...
### Sample 1. Batch Deleting Scheduled Snapshot Policies
