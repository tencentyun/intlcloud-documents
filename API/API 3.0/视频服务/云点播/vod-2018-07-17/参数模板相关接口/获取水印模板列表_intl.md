...
| WatermarkTemplateSet | Array of [WatermarkTemplate](https://cloud.tencent.com/document/api/266/31773#WatermarkTemplate) | List of watermark template details. <br/>Note: This field may return null, indicating that no effective values can be obtained. |
