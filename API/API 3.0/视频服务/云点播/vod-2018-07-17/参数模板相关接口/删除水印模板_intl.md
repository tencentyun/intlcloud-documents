...
This API deletes a custom watermarking template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteWatermarkTemplate |
...
## 4. Sample
### Sample 1. Deleting a Watermarking Template
#### Input Sample Code
```
https://vod.tencentcloudapi.com/?Action=DeleteWatermarkTemplate
&Definition=1001
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=vod&Version=2018-07-17&Action=DeleteWatermarkTemplate)
### SDK
