...
This API creates a custom watermarking template. Up to 1,000 ones can be created.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CreateWatermarkTemplate |
| Version | Yes | String | Common parameter; the value for this API: 2018-07-17 |
| Region | No | String | Common parameter; not passed in for this API |
| Type | Yes | String | Watermark type; value range: <br/><li>image: Image watermark; </li><li>text: Text watermark. </li> |
...
| ImageTemplate | No | [ImageWatermarkInput](/document/api/266/31773#ImageWatermarkInput) | Image watermarking template. This field is required if Type is image. It is invalid if Type is text. |
| TextTemplate | No | [TextWatermarkTemplateInput](/document/api/266/31773#TextWatermarkTemplateInput) | Text watermarking template. This field is required if Type is text. It is invalid if Type is image. |
| SvgTemplate | No | [SvgWatermarkInput](/document/api/266/31773#SvgWatermarkInput) | SVG watermarking template. This field is required if Type is svg. It is invalid if Type is image or text. |
...
## 4. Sample
### Sample 1. Creating a Watermarking Template
#### Input Sample Code
```
