...
| VideoTemplate | 否 | [VideoTemplateInfo](https://cloud.tencent.com/document/api/266/31773#VideoTemplateInfo) | 视频流配置参数，当 RemoveVideo 为 0，该字段必填。 |
| AudioTemplate | 否 | [AudioTemplateInfo](https://cloud.tencent.com/document/api/266/31773#AudioTemplateInfo) | 音频流配置参数，当 RemoveAudio 为 0，该字段必填。 |
