...
| CreateTime | String | 任务的创建时间，采用 [ISO 日期格式](https://intl.cloud.tencent.com/document/product/266/11732)。|
| BeginProcessTime | String | 任务开始执行的时间，采用 [ISO 日期格式](https://intl.cloud.tencent.com/document/product/266/11732)。|
| FinishTime | String | 任务执行完毕的时间，采用 [ISO 日期格式](https://intl.cloud.tencent.com/document/product/266/11732)。|
| ProcedureTask | [ProcedureTask](https://cloud.tencent.com/document/api/266/31773#ProcedureTask) | 视频处理任务信息，仅当 TaskType 为 Procedure，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| EditMediaTask | [EditMediaTask](https://cloud.tencent.com/document/api/266/31773#EditMediaTask) | 视频编辑任务信息，仅当 TaskType 为 EditMedia，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| WechatPublishTask | [WechatPublishTask](https://cloud.tencent.com/document/api/266/31773#WechatPublishTask) | 微信发布任务信息，仅当 TaskType 为 WechatPublish，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| TranscodeTask | [TranscodeTask2017](https://cloud.tencent.com/document/api/266/31773#TranscodeTask2017) | 视频转码任务信息，仅当 TaskType 为 Transcode，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| SnapshotByTimeOffsetTask | [SnapshotByTimeOffsetTask2017](https://cloud.tencent.com/document/api/266/31773#SnapshotByTimeOffsetTask2017) | 视频指定时间点截图任务信息，仅当 TaskType 为 SnapshotByTimeOffset，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| ConcatTask | [ConcatTask2017](https://cloud.tencent.com/document/api/266/31773#ConcatTask2017) | 视频拼接任务信息，仅当 TaskType 为 Concat，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| ClipTask | [ClipTask2017](https://cloud.tencent.com/document/api/266/31773#ClipTask2017) | 视频剪辑任务信息，仅当 TaskType 为 Clip，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
| CreateImageSpriteTask | [CreateImageSpriteTask2017](https://cloud.tencent.com/document/api/266/31773#CreateImageSpriteTask2017) | 截取雪碧图任务信息，仅当 TaskType 为 ImageSprite，该字段有值。<br/>注意：此字段可能返回 null，表示取不到有效值。|
