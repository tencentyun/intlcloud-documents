...
* A category can be deleted only when it has no subcategories and associated media files;
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteClass |
