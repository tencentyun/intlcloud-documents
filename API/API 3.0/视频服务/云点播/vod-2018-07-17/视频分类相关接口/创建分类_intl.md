...
* It does not affect the categories of existing media assets. If you need to modify the category of a media asset, call the [media file properties modifying API](/document/product/266/31762).
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CreateClass |
...
| ClassName | Yes | String | Category name of 1-64 characters. |
