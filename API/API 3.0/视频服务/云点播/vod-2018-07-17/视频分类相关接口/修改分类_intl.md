...
This API modifies the category of a media file.  
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: ModifyClass  |
...
## 4. Sample
### Sample 1. Modifying the Category of a Video
#### Input Sample Code
```
https://vod.tencentcloudapi.com/?Action=ModifyClass
&ClassId=1
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=vod&Version=2018-07-17&Action=ModifyClass)
...
| FailedOperation.ClassNameDuplicate | The operation is failed: The category does not exist. |
| InternalError | The error is caused internally. |
| InvalidParameterValue.ClassId | The class ID provided is invalid. |
