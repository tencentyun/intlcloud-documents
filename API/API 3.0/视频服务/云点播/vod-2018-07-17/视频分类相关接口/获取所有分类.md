...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeAllClass |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| ClassInfoSet | Array of [MediaClassInfo](https://cloud.tencent.com/document/api/266/31773#MediaClassInfo) | 分类信息集合<br/>注意：此字段可能返回 null，表示取不到有效值。|
