...
|---------|---------|---------|
| ClassInfoSet | Array of [MediaClassInfo](https://cloud.tencent.com/document/api/266/31773#MediaClassInfo) | Category information set <br/>Note: Null means no valid values returned. |
