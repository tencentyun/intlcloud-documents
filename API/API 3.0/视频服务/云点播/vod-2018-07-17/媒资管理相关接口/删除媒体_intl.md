...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteMedia |
...
| DeleteParts.N | No | Array of [MediaDeleteItem](https://cloud.tencent.com/document/api/266/31773#MediaDeleteItem) | Specify the ones to be deleted in the current call. The default value is "[]", which means to delete the media file and all its corresponding files generated by video processing. |
