...
```
### 2. Splicing the String to Sign
The string to sign is spliced in the following format:
```
StringToSign =
    Algorithm + \n +
    RequestTimestamp + \n +
...
According to the rules above, the string to sign obtained in the example is as follows (for a clear display, the \n line break is replaced by adding a new line):
```
TC3-HMAC-SHA256
1539084154
...
1) Derive signing key with the following pseudocode:
```
...
public class TencentCloudAPITC3Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ************* Step 2: Splice the string to sign *************
