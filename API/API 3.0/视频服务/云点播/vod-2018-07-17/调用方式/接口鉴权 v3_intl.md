...
| AuthFailure.SignatureFailure | The Signature was not incorrectly calculated. Please follow the API authentication documentation to calculate the signature. |
