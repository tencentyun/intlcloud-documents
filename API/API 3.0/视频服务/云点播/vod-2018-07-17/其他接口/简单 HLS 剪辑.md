...
|---------|---------|---------|
| Url | String | 裁剪后的视频地址。|
| MetaData | [MediaMetaData](https://cloud.tencent.com/document/api/266/31773#MediaMetaData) | 裁剪后的视频元信息。目前`Size`，`Rotate`，`VideoDuration`，`AudioDuration` 几个字段暂时缺省，没有真实数据。|
