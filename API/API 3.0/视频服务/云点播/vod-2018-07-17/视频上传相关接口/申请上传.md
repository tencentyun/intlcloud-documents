...
* 上传流程请参考[服务端上传综述](https://intl.cloud.tencent.com/document/product/266/33912)。
...
| Region | 是 | String | 公共参数，详见产品支持的[地域列表](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/266/31756#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8)。 |
| MediaType | 是 | String | 媒体类型，可选值请参考[上传能力综述](https://intl.cloud.tencent.com/document/product/266/9760)。 |
| MediaName | 否 | String | 媒体名称。 |
| CoverType | 否 | String | 封面类型，可选值请参考[上传能力综述](https://intl.cloud.tencent.com/document/product/266/9760)。 |
| Procedure | 否 | String | 媒体后续任务操作，详见[上传指定任务流](https://intl.cloud.tencent.com/document/product/266/33912)。 |
| ExpireTime | 否 | Timestamp | 媒体文件过期时间，格式按照 ISO 8601 标准表示，详见 [ISO 日期格式说明](https://intl.cloud.tencent.com/document/product/266/11732)。 |
...
| TempCertificate | [TempCertificate](https://cloud.tencent.com/document/api/266/31773#TempCertificate) | 临时凭证，用于上传接口的权限验证。|
