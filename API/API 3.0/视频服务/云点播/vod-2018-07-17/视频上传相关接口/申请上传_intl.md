...
* For the detailed uploading process, see [Server Upload Overview](https://intl.cloud.tencent.com/document/product/266/33912).
...
| Region | Yes | String | Common parameters; for details, see the [Region List](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/266/31756#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8). |
| MediaType | Yes | String | Media type. For valid values, see [Upload Overview](https://intl.cloud.tencent.com/document/product/266/9760). |
| MediaName | No | String | Media name. |
| CoverType | No | String | Cover type. For valid values, see [Upload Overview](https://intl.cloud.tencent.com/document/product/266/9760). |
| Procedure | No | String | Subsequent tasks. For more information, see [Upload-specific Task Flow](https://intl.cloud.tencent.com/document/product/266/33912). |
| ExpireTime | No | Timestamp | Expiration time of the media file in ISO 8601 format. For more information, see [Notes on ISO Date Format](https://intl.cloud.tencent.com/document/product/266/11732). |
...
| TempCertificate | [TempCertificate](https://cloud.tencent.com/document/api/266/31773#TempCertificate) | Temporary credentials used for API request authentication. |
