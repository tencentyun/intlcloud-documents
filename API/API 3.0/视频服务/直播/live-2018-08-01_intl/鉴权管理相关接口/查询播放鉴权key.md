...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLivePlayAuthKey |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| PlayAuthKeyInfo | [PlayAuthKeyInfo](https://cloud.tencent.com/document/api/267/20474#PlayAuthKeyInfo) | 播放鉴权key信息。|
