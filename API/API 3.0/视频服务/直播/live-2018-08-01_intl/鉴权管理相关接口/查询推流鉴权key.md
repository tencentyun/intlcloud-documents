...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLivePushAuthKey |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| PushAuthKeyInfo | [PushAuthKeyInfo](https://cloud.tencent.com/document/api/267/20474#PushAuthKeyInfo) | 推流鉴权key信息。|
