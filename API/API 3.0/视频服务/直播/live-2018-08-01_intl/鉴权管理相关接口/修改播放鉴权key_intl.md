...
This API modifies the playback authentication key.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyLivePlayAuthKey |
...
| AuthKey | No | String | Authentication key |
| AuthDelta | No | Integer | Validity period in seconds |
| AuthBackKey | No | String | Authentication back key |
