...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLivePlayAuthKey |
...
|---------|---------|---------|
| PlayAuthKeyInfo | [PlayAuthKeyInfo](/document/api/267/20474#PlayAuthKeyInfo) | Playback authentication key information |
