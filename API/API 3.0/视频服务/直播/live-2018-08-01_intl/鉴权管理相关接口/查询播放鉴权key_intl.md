...
This API queries the playback authentication key.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLivePlayAuthKey |
...
|---------|---------|---------|
| PlayAuthKeyInfo | [PlayAuthKeyInfo](https://cloud.tencent.com/document/api/267/20474#PlayAuthKeyInfo) | Playback authentication key information |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLivePlayAuthKey)
