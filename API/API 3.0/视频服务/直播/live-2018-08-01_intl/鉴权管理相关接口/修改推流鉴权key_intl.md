...
This API modifies the LVB upstream authentication key.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: ModifyLivePushAuthKey |
| Version | Yes | String | Common parameter; the version of this API: 2018-08-01 |
| Region | No | String | Common parameter; optional for this API |
| DomainName | Yes | String | Push domain name |
| Enable | No | Integer | Whether to enable; 0: disabled; 1: enabled |
| MasterAuthKey | No | String | Master authentication key |
| BackupAuthKey | No | String | Backup authentication key |
...
```
https://live.tencentcloudapi.com/?Action=ModifyLivePushAuthKey
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyLivePushAuthKey)
