...
This API modifies the screencapture template configuration.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyLiveSnapshotTemplate |
...
| SnapshotInterval | No | Integer | Screencapture interval |
| Width | No | Integer | Screenshot width |
| Height | No | Integer | Screenshot height |
| PornFlag | No | Integer | Whether to enable porn detection; 0: disabled, 1: enabled |
| CosAppId | No | Integer | COS AppId |
...
```
https://live.tencentcloudapi.com/?Action=ModifyLiveSnapshotTemplate
&TemplateId=1000
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyLiveSnapshotTemplate)
