...
This API deletes the screencapture template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveSnapshotTemplate |
...
```
https://live.tencentcloudapi.com/?Action=DeleteLiveSnapshotTemplate
&TemplateId=1000
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveSnapshotTemplate)
