...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveSnapshotTemplates |
...
|---------|---------|---------|
| Templates | Array of [SnapshotTemplateInfo](/document/api/267/20474#SnapshotTemplateInfo) | Screencapture template list. |
