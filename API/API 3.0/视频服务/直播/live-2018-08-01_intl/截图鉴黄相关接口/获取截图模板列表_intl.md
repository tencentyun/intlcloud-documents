...
This API gets the screencapture template list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveSnapshotTemplates |
...
|---------|---------|---------|
| Templates | Array of [SnapshotTemplateInfo](https://cloud.tencent.com/document/api/267/20474#SnapshotTemplateInfo) | Screencapture template list. |
