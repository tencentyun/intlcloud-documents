...
This API gets the screencapture rule list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveSnapshotRules |
...
|---------|---------|---------|
| Rules | Array of [RuleInfo](https://cloud.tencent.com/document/api/267/20474#RuleInfo) | Rule list. |
