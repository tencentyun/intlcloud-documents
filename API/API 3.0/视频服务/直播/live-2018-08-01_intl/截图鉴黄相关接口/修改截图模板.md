...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyLiveSnapshotTemplate |
| Version | 是 | String | 公共参数，本接口取值：2018-08-01 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| TemplateId | 是 | Integer | 模板Id。 |
| TemplateName | 否 | String | 模板名称。 |
| Description | 否 | String | 描述信息。 |
| SnapshotInterval | 否 | Integer | 截图时间间隔 |
| Width | 否 | Integer | 截图宽度。 |
| Height | 否 | Integer | 截图高度。 |
| PornFlag | 否 | Integer | 是否开启鉴黄，0：不开启，1：开启。 |
| CosAppId | 否 | Integer | Cos AppId。 |
| CosBucket | 否 | String | Cos Bucket名称。 |
| CosRegion | 否 | String | Cos 地域。 |
