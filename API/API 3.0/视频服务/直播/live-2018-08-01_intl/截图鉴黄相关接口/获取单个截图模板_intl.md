...
This API gets a single screencapture template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveSnapshotTemplate |
...
|---------|---------|---------|
| Template | [SnapshotTemplateInfo](https://cloud.tencent.com/document/api/267/20474#SnapshotTemplateInfo) | Screencapture template information |
