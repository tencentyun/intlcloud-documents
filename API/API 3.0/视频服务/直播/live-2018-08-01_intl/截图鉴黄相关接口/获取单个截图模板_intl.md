...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveSnapshotTemplate |
...
|---------|---------|---------|
| Template | [SnapshotTemplateInfo](/document/api/267/20474#SnapshotTemplateInfo) | Screencapture template information |
