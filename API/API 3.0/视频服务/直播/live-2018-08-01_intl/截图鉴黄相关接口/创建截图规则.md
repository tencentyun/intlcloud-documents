...
创建截图规则，需要先调用[CreateLiveSnapshotTemplate](https://intl.cloud.tencent.com/document/product/267/30834)接口创建截图模板，然后将返回的模板id绑定到流进行使用。
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateLiveSnapshotRule |
