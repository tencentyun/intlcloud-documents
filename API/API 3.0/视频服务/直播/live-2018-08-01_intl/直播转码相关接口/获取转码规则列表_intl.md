...
This API gets the transcoding rule list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveTranscodeRules |
...
|---------|---------|---------|
| Rules | Array of [RuleInfo](https://cloud.tencent.com/document/api/267/20474#RuleInfo) | Transcoding rule list. |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveTranscodeRules
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveTranscodeRules)
