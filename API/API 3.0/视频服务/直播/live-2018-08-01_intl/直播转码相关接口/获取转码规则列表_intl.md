...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveTranscodeRules |
...
|---------|---------|---------|
| Rules | Array of [RuleInfo](/document/api/267/20474#RuleInfo) | Transcoding rule list. |
