...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveTranscodeTemplates |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Templates | Array of [TemplateInfo](https://cloud.tencent.com/document/api/267/20474#TemplateInfo) | 转码模板列表。|
