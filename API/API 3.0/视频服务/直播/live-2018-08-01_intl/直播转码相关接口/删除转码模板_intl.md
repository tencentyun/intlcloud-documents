...
This API deletes the transcoding template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveTranscodeTemplate |
...
```
https://live.tencentcloudapi.com/?Action=DeleteLiveTranscodeTemplate
&TemplateId=1000
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveTranscodeTemplate)
