...
This gets the transcoding template list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveTranscodeTemplates |
...
|---------|---------|---------|
| Templates | Array of [TemplateInfo](https://cloud.tencent.com/document/api/267/20474#TemplateInfo) | Transcoding template list. |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveTranscodeTemplates
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveTranscodeTemplates)
