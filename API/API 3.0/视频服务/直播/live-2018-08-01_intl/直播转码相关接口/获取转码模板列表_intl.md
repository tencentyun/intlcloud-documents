...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveTranscodeTemplates |
...
|---------|---------|---------|
| Templates | Array of [TemplateInfo](/document/api/267/20474#TemplateInfo) | Transcoding template list. |
