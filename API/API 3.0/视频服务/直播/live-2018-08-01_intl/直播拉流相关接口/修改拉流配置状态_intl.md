...
This API modifies the LVB pull configuration status.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyPullStreamStatus |
...
```
https://live.tencentcloudapi.com/?Action=ModifyPullStreamStatus
&ConfigIds.0="123"
&ConfigIds.1="456"
&Status="2"
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyPullStreamStatus)
