...
This API modifies the LVB downstream configuration status.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: ModifyDownStreamStatus |
| Version | Yes | String | Common parameter; the version of this API: 2018-08-01 |
| Region | No | String | Common parameter; optional for this API |
| ConfigIds.N | Yes | Array of String | Configuration ID list |
| Status | Yes | String | Target status. 0: invalid, 2: running, 4: paused |
...
```
https://live.tencentcloudapi.com/?Action=ModifyDownStreamStatus
&ConfigIds.0="123"
&ConfigIds.1="456"
&Status="2"
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyDownStreamStatus)
