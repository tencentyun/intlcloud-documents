...
This API deletes the LVB downstream configuration.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteDownStreamConfig |
...
```
https://live.tencentcloudapi.com/?Action=DeleteDownStreamConfig
&ConfigId=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteDownStreamConfig)
