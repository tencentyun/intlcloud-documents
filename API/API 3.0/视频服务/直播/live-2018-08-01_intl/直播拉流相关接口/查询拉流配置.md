...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribePullStreamConfigs |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| PullStreamConfigs | Array of [PullStreamConfig](https://cloud.tencent.com/document/api/267/20474#PullStreamConfig) | 拉流配置。|
