...
This API updates the pull configuration.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyPullStreamConfig |
...
```
https://live.tencentcloudapi.com/?Action=ModifyPullStreamConfig
&ConfigId=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyPullStreamConfig)
