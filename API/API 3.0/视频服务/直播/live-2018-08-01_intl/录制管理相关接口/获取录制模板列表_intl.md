...
This API gets the recording template list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveRecordTemplates |
...
|---------|---------|---------|
| Templates | Array of [RecordTemplateInfo](/document/api/267/20474#RecordTemplateInfo) | Recording template information list. |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveRecordTemplates
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveRecordTemplates)
