...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveRecordTemplates |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Templates | Array of [RecordTemplateInfo](https://cloud.tencent.com/document/api/267/20474#RecordTemplateInfo) | 录制模板信息列表。|
