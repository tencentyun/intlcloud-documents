...
This API gets the recording rule list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveRecordRules |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveRecordRules
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveRecordRules)
