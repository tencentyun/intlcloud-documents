...
This API deletes the recording template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveRecordTemplate |
...
```
https://live.tencentcloudapi.com/?Action=DeleteLiveRecordTemplate
&TemplateId=1000
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveRecordTemplate)
