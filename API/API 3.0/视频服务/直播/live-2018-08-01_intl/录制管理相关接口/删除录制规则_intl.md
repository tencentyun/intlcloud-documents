...
This API deletes the recording rule.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteLiveRecordRule  |
| Version | Yes | String | Common parameter; the version of this API: 2018-08-01 |
| Region | No | String | Common parameter; optional for this API |
| DomainName | Yes | String | Upstream domain name Domain name+AppName+StreamName uniquely identifies a single transcoding rule. If you need to delete it, strong match is required. Even if AppName is blank, you need to pass in a blank string to make a strong match |
| AppName | Yes | String | Upstream path Domain name+AppName+StreamName uniquely identifies a single transcoding rule. If you need to delete it, strong match is required. Even if AppName is blank, you need to pass in a blank string to make a strong match |
| StreamName | Yes | String | Stream name Domain name+AppName+StreamName uniquely identifies a single transcoding rule. If you need to delete it, strong match is required. Even if AppName is blank, you need to pass in a blank string to make a strong match |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveRecordRule)
