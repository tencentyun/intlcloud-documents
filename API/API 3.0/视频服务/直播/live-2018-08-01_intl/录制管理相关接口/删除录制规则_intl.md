...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveRecordRule |
| Version | Yes | String | Common parameter; the value for this API: 2018-08-01 |
| Region | No | String | Common parameter; not passed in for this API |
| DomainName | Yes | String | Push domain name Domain name+AppName+StreamName uniquely identifies a single transcoding rule. If you need to delete it, strong match is required. Even if AppName is blank, you need to pass in a blank string to make a strong match |
| AppName | Yes | String | Push path Domain name+AppName+StreamName uniquely identifies a single transcoding rule. If you need to delete it, strong match is required. Even if AppName is blank, you need to pass in a blank string to make a strong match |
