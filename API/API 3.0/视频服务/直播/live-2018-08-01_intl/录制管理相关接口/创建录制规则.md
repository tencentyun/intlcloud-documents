...
创建录制规则，需要先调用[CreateLiveRecordTemplate](https://intl.cloud.tencent.com/document/product/267/30845)接口创建录制模板，将返回的模板id绑定到流使用。
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateLiveRecordRule |
