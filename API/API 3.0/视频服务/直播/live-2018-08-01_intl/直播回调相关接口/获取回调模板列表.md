...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveCallbackTemplates |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Templates | Array of [CallBackTemplateInfo](https://cloud.tencent.com/document/api/267/20474#CallBackTemplateInfo) | 模板信息列表。|
