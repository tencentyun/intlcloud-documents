...
This API gets a single callback template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveCallbackTemplate |
...
|---------|---------|---------|
| Template | [CallBackTemplateInfo](https://cloud.tencent.com/document/api/267/20474#CallBackTemplateInfo) | Callback template information |
