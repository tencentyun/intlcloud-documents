...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveCallbackTemplate |
...
|---------|---------|---------|
| Template | [CallBackTemplateInfo](/document/api/267/20474#CallBackTemplateInfo) | Callback template information |
