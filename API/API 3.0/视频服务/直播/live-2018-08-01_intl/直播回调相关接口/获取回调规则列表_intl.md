...
This API gets the callback rule list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveCallbackRules |
...
|---------|---------|---------|
| Rules | Array of [CallBackRuleInfo](https://cloud.tencent.com/document/api/267/20474#CallBackRuleInfo) | Rule information list |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveCallbackRules)
