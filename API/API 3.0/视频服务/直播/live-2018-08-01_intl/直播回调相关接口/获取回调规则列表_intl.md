...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveCallbackRules |
...
|---------|---------|---------|
| Rules | Array of [CallBackRuleInfo](/document/api/267/20474#CallBackRuleInfo) | Rule information list |
