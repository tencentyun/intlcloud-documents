...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveCallbackRules |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Rules | Array of [CallBackRuleInfo](https://cloud.tencent.com/document/api/267/20474#CallBackRuleInfo) | 规则信息列表。|
