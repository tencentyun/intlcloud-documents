...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveCallbackTemplates |
...
|---------|---------|---------|
| Templates | Array of [CallBackTemplateInfo](/document/api/267/20474#CallBackTemplateInfo) | Template information list |
