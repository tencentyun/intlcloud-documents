...
This API gets the callback template list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveCallbackTemplates |
...
|---------|---------|---------|
| Templates | Array of [CallBackTemplateInfo](https://cloud.tencent.com/document/api/267/20474#CallBackTemplateInfo) | Template information list |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveCallbackTemplates)
