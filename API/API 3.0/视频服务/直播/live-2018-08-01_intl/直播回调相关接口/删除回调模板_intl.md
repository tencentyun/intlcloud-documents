...
This API deletes the callback template.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveCallbackTemplate |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveCallbackTemplate)
