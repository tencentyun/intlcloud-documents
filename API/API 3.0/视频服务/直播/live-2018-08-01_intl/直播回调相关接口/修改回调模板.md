...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyLiveCallbackTemplate |
| Version | 是 | String | 公共参数，本接口取值：2018-08-01 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| TemplateId | 是 | Integer | 模板Id。 |
| TemplateName | 否 | String | 模板名称。 |
| Description | 否 | String | 描述信息。 |
| StreamBeginNotifyUrl | 否 | String | 开播回调URL。 |
| StreamEndNotifyUrl | 否 | String | 断流回调URL。 |
| RecordNotifyUrl | 否 | String | 录制回调URL。 |
| SnapshotNotifyUrl | 否 | String | 截图回调URL。 |
| PornCensorshipNotifyUrl | 否 | String | 鉴黄回调URL。 |
