...
This API unbinds the domain name certificate.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: UnBindLiveDomainCert |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=UnBindLiveDomainCert)
