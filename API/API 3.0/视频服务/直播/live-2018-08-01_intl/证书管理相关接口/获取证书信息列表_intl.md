...
This API obtains the certificate information list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveCerts |
...
|---------|---------|---------|
| CertInfoSet | Array of [CertInfo](https://cloud.tencent.com/document/api/267/20474#CertInfo) | Certificate information list. |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveCerts)
