...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveCerts |
...
|---------|---------|---------|
| CertInfoSet | Array of [CertInfo](/document/api/267/20474#CertInfo) | Certificate information list. |
