...
This API modifies the domain name and information binded to the certificate.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: ModifyLiveDomainCert |
...
| CertId | No | Integer | Certificate ID |
...
```
https://live.tencentcloudapi.com/?Action=ModifyLiveDomainCert
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=ModifyLiveDomainCert)
