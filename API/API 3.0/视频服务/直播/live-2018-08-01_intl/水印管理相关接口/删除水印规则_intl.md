...
This API delete the watermarking rule.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveWatermarkRule |
...
```
https://live.tencentcloudapi.com/?Action=DeleteLiveWatermarkRule
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveWatermarkRule)
