...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CreateLiveWatermarkRule |
...
| TemplateId | Yes | Integer | Watermark ID, which is the WatermarkId returned by calling the [AddLiveWatermark](/document/product/267/30154) API. |
