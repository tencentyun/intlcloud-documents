...
To create a watermarking rule, you need to first call the [AddLiveWatermark](https://intl.cloud.tencent.com/document/product/267/30826) API to add a watermark and bind the returned watermark ID to the stream.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: CreateLiveWatermarkRule |
...
| TemplateId | Yes | Integer | Watermark ID, which is the WatermarkId returned by calling the [AddLiveWatermark](https://intl.cloud.tencent.com/document/product/267/30826) API. |
...
```
https://live.tencentcloudapi.com/?Action=CreateLiveWatermarkRule
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=CreateLiveWatermarkRule)
