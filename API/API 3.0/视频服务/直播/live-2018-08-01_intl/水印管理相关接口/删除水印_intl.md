...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteLiveWatermark |
...
```
https://live.tencentcloudapi.com/?Action=DeleteLiveWatermark
&WatermarkId=123
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DeleteLiveWatermark)
