...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveWatermark |
...
|---------|---------|---------|
| Watermark | [WatermarkInfo](/document/api/267/20474#WatermarkInfo) | Watermark information |
