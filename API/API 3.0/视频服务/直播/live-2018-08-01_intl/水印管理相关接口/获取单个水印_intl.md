...
This API gets the information of a single watermark.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveWatermark |
...
|---------|---------|---------|
| Watermark | [WatermarkInfo](https://cloud.tencent.com/document/api/267/20474#WatermarkInfo) | Watermark information |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveWatermark
&WatermarkId=10001
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveWatermark)
