...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveWatermarks |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TotalNum | Integer | 水印总个数。|
| WatermarkList | Array of [WatermarkInfo](https://cloud.tencent.com/document/api/267/20474#WatermarkInfo) | 水印信息列表。|
