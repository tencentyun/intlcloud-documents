...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveWatermarkRules |
...
|---------|---------|---------|
| Rules | Array of [RuleInfo](/document/api/267/20474#RuleInfo) | Watermarking rule list |
