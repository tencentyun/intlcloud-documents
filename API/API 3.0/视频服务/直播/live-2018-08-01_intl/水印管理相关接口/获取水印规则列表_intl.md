...
This API gets the watermarking rule list.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveWatermarkRules |
...
|---------|---------|---------|
| Rules | Array of [RuleInfo](https://cloud.tencent.com/document/api/267/20474#RuleInfo) | Watermarking rule list |
...
```
https://live.tencentcloudapi.com/?Action=DescribeLiveWatermarkRules
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveWatermarkRules)
