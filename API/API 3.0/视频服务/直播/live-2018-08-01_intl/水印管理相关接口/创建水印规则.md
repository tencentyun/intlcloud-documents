...
创建水印规则，需要先调用[AddLiveWatermark](https://intl.cloud.tencent.com/document/product/267/30826)接口添加水印，将返回的水印id绑定到流使用。
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateLiveWatermarkRule |
| Version | 是 | String | 公共参数，本接口取值：2018-08-01 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| DomainName | 是 | String | 推流域名。 |
| AppName | 是 | String | 推流路径。 |
| StreamName | 是 | String | 流名称。 |
| TemplateId | 是 | Integer | 水印Id，即调用[AddLiveWatermark](https://intl.cloud.tencent.com/document/product/267/30826)接口返回的WatermarkId。 |
