...
This API returns the status such as active, inactive or forbidden.

Default API request frequency limit: 1,000 times/second.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeLiveStreamState |
