...
This API returns the status of the stream such as active, inactive or prohibited.

Default API request rate limit: 1000 requests/second.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DescribeLiveStreamState |
| Version | Yes | String | Common parameter; the version of this API: 2018-08-01 |
| Region | No | String | Common parameter; optional for this API |
| AppName | Yes | String | Application name |
| DomainName | Yes | String | Your upstream domain name |
...
|---------|---------|---------|
| StreamState | String | Stream status. <br/>active: active, <br/>inactive: inactive, <br/>forbid: forbidden |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=live&Version=2018-08-01&Action=DescribeLiveStreamState)
