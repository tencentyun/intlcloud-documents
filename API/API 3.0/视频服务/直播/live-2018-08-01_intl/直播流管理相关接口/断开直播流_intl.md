...
This API disconnects the push connection, which can be resumed.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DropLiveStream |
...
This API can be called when the push stream of a VJ needs to be paused for some reasons.
