...
This API forbids the push of a specific stream. You can preset a time point to resume the stream.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ForbidLiveStream |
