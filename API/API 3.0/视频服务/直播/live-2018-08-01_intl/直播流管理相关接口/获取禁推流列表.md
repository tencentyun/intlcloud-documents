...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeLiveForbidStreamList |
| Version | 是 | String | 公共参数，本接口取值：2018-08-01 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| PageNum | 否 | Integer | 取得第几页，默认1。 |
| PageSize | 否 | Integer | 每页大小，最大100。 <br/>取值：1~100之前的任意整数。<br/>默认值：10。 |
...
| ForbidStreamList | Array of [ForbidStreamInfo](https://cloud.tencent.com/document/api/267/20474#ForbidStreamInfo) | 禁推流列表。|
