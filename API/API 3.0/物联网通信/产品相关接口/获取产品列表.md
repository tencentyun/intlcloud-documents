...
| Offset | 是 | Integer | 分页偏移，Offset从0开始 |
| Limit | 是 | Integer | 分页大小，当前页面中显示的最大数量，值范围 10-250。 |
| Filters.N | 否 | Array of [Filter](https://cloud.tencent.com/document/api/634/19497#Filter) | 过滤条件 |
...
| Products | Array of [ProductInfo](https://cloud.tencent.com/document/api/634/19497#ProductInfo) | 产品详细信息列表|
