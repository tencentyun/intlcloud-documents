...
| Limit | 是 | Integer | 分页的大小，数值范围 10-100 |
| FirmwareVersion | 否 | String | 设备固件版本号，若不带此参数会返回所有固件版本的设备 |
...
| Devices | Array of [DeviceInfo](https://cloud.tencent.com/document/api/634/19497#DeviceInfo) | 设备详细信息列表|
