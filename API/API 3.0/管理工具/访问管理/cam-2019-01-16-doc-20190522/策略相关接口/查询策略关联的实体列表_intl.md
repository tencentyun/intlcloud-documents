...
| List | Array of [AttachEntityOfPolicy](https://cloud.tencent.com/document/api/598/33167#AttachEntityOfPolicy) | Entity list <br/>Note: This field may return null, indicating that no valid values can be obtained. |
