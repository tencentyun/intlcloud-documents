...
This API (DetachGroupPolicy) unbinds a policy from a user group.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DetachGroupPolicy |
| Version | Yes | String | Common parameter; the version of this API: 2019-01-16 |
| Region | No | String | Common parameter; optional for this API. |
| PolicyId | Yes | Integer | Policy ID |
| DetachGroupId | Yes | Integer | User group ID |
...
### Sample 1. Unbinding a Policy from a User Group

Unbind policy 524497 from a user group (ID: 3449)

#### Input Sample Code

```
https://cam.tencentcloudapi.com/?Action=DetachGroupPolicy
&PolicyId=524497
&DetachGroupId=3449
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cam&Version=2019-01-16&Action=DetachGroupPolicy)
