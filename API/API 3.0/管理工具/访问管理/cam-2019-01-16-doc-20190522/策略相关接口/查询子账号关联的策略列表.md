...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ListAttachedUserPolicies |
| Version | 是 | String | 公共参数，本接口取值：2019-01-16 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| TargetUin | 是 | Integer | 子账号 uin |
...
| List | Array of [AttachPolicyInfo](https://cloud.tencent.com/document/api/598/33167#AttachPolicyInfo) | 策略列表|
