...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateSAMLProvider |
| Version | 是 | String | 公共参数，本接口取值：2019-01-16 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| Name | 是 | String | SAML身份提供商名称 |
| Description | 是 | String | SAML身份提供商描述 |
| SAMLMetadataDocument | 是 | String | SAML身份提供商Base64编码的元数据文档 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| ProviderArn | String | SAML身份提供商资源描述符|
