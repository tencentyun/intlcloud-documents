...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteUser |
...
### Sample 1. Deleting a Sub-user

#### Input Sample Code

```
https://cam.tencentcloudapi.com/?Action=DeleteUser
&Name=test124
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cam&Version=2019-01-16&Action=DeleteUser)
