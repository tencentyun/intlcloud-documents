...
| Info.N | Yes | Array of [GroupIdOfUidInfo](https://cloud.tencent.com/document/api/598/33167#GroupIdOfUidInfo) | UID of the user to be removed and the array corresponding to the user group ID |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cam&Version=2019-01-16&Action=RemoveUserFromGroup)
...
This API has no error codes related to business logic. For other error codes, see [Common Error Codes](https://cloud.tencent.com/document/api/598/15694#.E5.85.AC.E5.85.B1.E9.94.99.E8.AF.AF.E7.A0.81).