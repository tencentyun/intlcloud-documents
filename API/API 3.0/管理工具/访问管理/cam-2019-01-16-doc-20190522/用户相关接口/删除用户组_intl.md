...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the name of this API: DeleteGroup |
...
### Sample 1. Deleting a User Group

#### Input Sample Code

```
https://cam.tencentcloudapi.com/?Action=DeleteGroup
&GroupId=2020
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cam&Version=2019-01-16&Action=DeleteGroup)
