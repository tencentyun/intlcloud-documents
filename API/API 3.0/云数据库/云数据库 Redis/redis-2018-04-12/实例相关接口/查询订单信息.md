...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeInstanceDealDetail |
...
| DealIds.N | 是 | Array of String | 订单ID数组 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| DealDetails | Array of [TradeDealDetail](https://cloud.tencent.com/document/api/239/20022#TradeDealDetail) | 订单详细信息|
