...
Modify network configuration of an instance
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyNetworkConfig |
...
| VpcId | No | String | VPC ID, which is needed for changeVpc and changeBaseToVpc |
| SubnetId | No | String | Subnet ID, which is needed for changeVpc and changeBaseToVpc |
