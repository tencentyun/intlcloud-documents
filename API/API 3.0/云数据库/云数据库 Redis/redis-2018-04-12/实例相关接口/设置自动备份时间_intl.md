...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyAutoBackupConfig |
...
| WeekDays.N | Yes | Array of String | Date; value range: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday |
