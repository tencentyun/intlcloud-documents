...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyAutoBackupConfig |
...
| WeekDays.N | 是 | Array of String | 日期 Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday |
| TimePeriod | 是 | String | 时间段 00:00-01:00, 01:00-02:00...... 23:00-00:00 |
| AutoBackupType | 否 | Integer | 自动备份类型： 1 “定时回档” |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| AutoBackupType | Integer | 自动备份类型： 1 “定时回档”|
| WeekDays | Array of String | 日期Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday。|
| TimePeriod | String | 时间段 00:00-01:00, 01:00-02:00...... 23:00-00:00|
