...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeInstanceDealDetail |
...
| DealIds.N | 예 | Array of String | 주문 ID 배열 |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| DealDetails | Array of [TradeDealDetail](https://cloud.tencent.com/document/api/239/20022#TradeDealDetail) | 주분 세부 정보|
