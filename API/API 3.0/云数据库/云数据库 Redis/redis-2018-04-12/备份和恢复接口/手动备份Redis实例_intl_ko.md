...
| 매개변수 이름 | 필수 여부 | 유형 | 설명 |
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ManualBackupInstance |
...
| InstanceId | 예 | String | 작업 대기 중인 인스턴스 ID, DescribeInstance API를 통해 반환값의 InstanceId로 획득할 수 있습니다. |
| Remark | 아니요 | String | 백업의 주석 정보 |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TaskId | Integer | 태스크 ID|
