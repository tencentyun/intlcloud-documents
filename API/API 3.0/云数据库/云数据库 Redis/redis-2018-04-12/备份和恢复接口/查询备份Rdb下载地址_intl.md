...
Query the download address of a backup RDB
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DescribeBackupUrl |
...
| BackupId | Yes | String | Backup ID, which can be queried through the DescribeInstanceBackups API |
