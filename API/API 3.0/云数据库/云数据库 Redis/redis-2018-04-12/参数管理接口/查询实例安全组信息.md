...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeInstanceSecurityGroup |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| InstanceSecurityGroupsDetail | Array of [InstanceSecurityGroupDetail](https://cloud.tencent.com/document/api/239/20022#InstanceSecurityGroupDetail) | 实例安全组信息|
