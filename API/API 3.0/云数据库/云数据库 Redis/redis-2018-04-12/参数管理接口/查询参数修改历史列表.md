...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TotalCount | Integer | 总的修改历史记录数。|
| InstanceParamHistory | Array of [InstanceParamHistory](https://cloud.tencent.com/document/api/239/20022#InstanceParamHistory) | 修改历史记录信息。|
