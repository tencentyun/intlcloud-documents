...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyInstanceParams |
...
| InstanceParams.N | 是 | Array of [InstanceParam](https://cloud.tencent.com/document/api/239/20022#InstanceParam) | 实例修改的参数列表 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Changed | Boolean | 修改是否成功。|
