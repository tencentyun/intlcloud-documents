...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeProjectSecurityGroup |
...
| ProjectId | 否 | Integer | 0:默认项目；-1 所有项目; >0: 特定项目 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| SecurityGroupDetails | Array of [SecurityGroupDetail](https://cloud.tencent.com/document/api/239/20022#SecurityGroupDetail) | 项目安全组|
