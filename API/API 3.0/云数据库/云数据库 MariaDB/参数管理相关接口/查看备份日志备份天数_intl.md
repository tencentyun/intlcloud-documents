...
This API (DescribeLogFileRetentionPeriod) is used to view the configurations for the retention period of backup logs in the database.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DescribeLogFileRetentionPeriod. |
...
| Days | Integer | Retention period of backup logs |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 View the retention period of backup logs
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=mariadb&Version=2017-03-12&Action=DescribeLogFileRetentionPeriod)
