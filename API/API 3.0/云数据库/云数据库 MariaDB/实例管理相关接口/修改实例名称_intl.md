...
This API (ModifyDBInstanceName) is used to modify the name of a database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyDBInstanceName. |
...
| InstanceId | Yes | String | Instance ID to be modified, such as tdsql-ow728lmc. It can be obtained by querying instance details via DescribeDBInstances. |
| InstanceName | Yes | String | New instance name. Letters, numbers, underscores, and hyphens are allowed. |
...
### Example 1 Modify an instance name

#### Input example

```
https://mariadb.tencentcloudapi.com/?Action=ModifyDBInstanceName
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=mariadb&Version=2017-03-12&Action=ModifyDBInstanceName)
