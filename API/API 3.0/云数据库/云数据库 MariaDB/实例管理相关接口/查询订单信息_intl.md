...
This API (DescribeOrders) is used to query orders in the database. You can use the order ID to query instances related to the order and the corresponding task process ID.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeOrders. |
...
| DealNames.N | Yes | Array of String | List of long order IDs to be queried. It is returned by APIs of instance creation, renewal and capacity expansion. |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| TotalCount | Array of Integer | Quantity of orders returned |
| Deals | Array of [Deal](https://cloud.tencent.com/document/api/237/16191#Deal) | List of order information |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Query order information

#### Input example

```
https://mariadb.tencentcloudapi.com/?Action=DescribeOrders
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=mariadb&Version=2017-03-12&Action=DescribeOrders)
...
| InternalError.QueryOrderFailed | Failed to query order information |
| InvalidParameter.DealNameNotGiven | No order ID to be queried specified |
