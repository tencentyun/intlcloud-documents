...
This API (DescribeUpgradePrice) is used to query the price of capacity extension when you expand the capacity of a database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeUpgradePrice. |
...
### Example 1 Query the price of capacity expansion of a database instance

#### Input example

```
https://mariadb.tencentcloudapi.com/?Action=DescribeUpgradePrice
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=mariadb&Version=2017-03-12&Action=DescribeUpgradePrice)
