...
This API (DescribeDBResourceUsageDetails) is used to view the current performance data of a database instance.
...
|---------|---------|---------|
| Master | [ResourceUsageMonitorSet](https://cloud.tencent.comhttps://cloud.tencent.comhttps://cloud.tencent.com/document/api/237/16191#ResourceUsageMonitorSet) | Monitoring data of the usage of the master node |
| Slave1 | [ResourceUsageMonitorSet](https://cloud.tencent.comhttps://cloud.tencent.comhttps://cloud.tencent.com/document/api/237/16191#ResourceUsageMonitorSet) | Monitoring data of the usage of slave 1 |
| Slave2 | [ResourceUsageMonitorSet](https://cloud.tencent.comhttps://cloud.tencent.comhttps://cloud.tencent.com/document/api/237/16191#ResourceUsageMonitorSet) | Monitoring data of the usage of slave 2 |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 View the details of instance resource usage
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=mariadb&Version=2017-03-12&Action=DescribeDBResourceUsageDetails)
