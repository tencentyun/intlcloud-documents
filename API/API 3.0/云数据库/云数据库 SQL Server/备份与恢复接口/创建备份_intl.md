...
| Strategy | No | Integer | Backup strategy (0 - Instance backup, 1 - Multi-database backup) |
| DBNames.N | No | Array of String | List of names of databases to be backed up (this parameter is required only for multi-database backup) |
| InstanceId | No | String | Instance ID, such as mssql-i1z41iwd |
