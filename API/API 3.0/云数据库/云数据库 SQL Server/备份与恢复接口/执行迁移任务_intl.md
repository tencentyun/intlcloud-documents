...
This API (RunMigration) is used to start a migration task.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: RunMigration |
...
|---------|---------|---------|
| FlowId | Integer | The process ID returned after a migration process starts |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Run a migration task

#### Input example

```
https://sqlserver.tencentcloudapi.com/?Action=RunMigration
&MigrateId=2729
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=RunMigration)
