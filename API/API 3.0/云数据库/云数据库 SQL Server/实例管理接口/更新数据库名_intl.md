...
This API (ModifyDBName) is used to modify database names.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyDBName |
| Version | Yes | String | Common parameter. The value used for this API: 2018-03-28 |
| Region | Yes | String | Common parameter. For more information, see the [list of regions](/document/api/238/19930#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8) supported by the product. |
| InstanceId | Yes | String | Instance ID |
| OldDBName | Yes | String | Old database name |
| NewDBName | Yes | String | New database name |
...
### Example 1 Modify the database name

#### Input example

```
https://sqlserver.tencentcloudapi.com/?Action=ModifyDBName
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=ModifyDBName)
