...
This API (CreateAccount) is used to create an instance account.
...
| Accounts.N | Yes | Array of [AccountCreateInfo](/document/api/238/19976#AccountCreateInfo) | Database instance account information |
...
### Example 1 Create an instance account
