...
This API (DeleteAccount) is used to delete the account of an instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DeleteAccount |
...
| UserNames.N | Yes | Array of String | Array of user names of the instance |
...
### Example 1 Delete the account of an instance

#### Input example

```
https://sqlserver.tencentcloudapi.com/?Action=DeleteAccount
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=DeleteAccount)
