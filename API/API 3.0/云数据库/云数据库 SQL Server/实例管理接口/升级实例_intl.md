...
This API (UpgradeDBInstance) is used to upgrade an instance.
...
| AutoVoucher | No | Integer | Indicates whether to use vouchers automatically. 0: Yes; 1: No (default) |
