...
This API (ModifyDBInstanceRenewFlag) is used to modify the renewal flag of an instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyDBInstanceRenewFlag |
| Version | Yes | String | Common parameter. The value used for this API: 2018-03-28 |
| Region | Yes | String | Common parameter. For more information, see the [list of regions](/document/api/238/19930#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8) supported by the product. |
| RenewFlags.N | Yes | Array of [InstanceRenewInfo](/document/api/238/19976#InstanceRenewInfo) | Details of instance renewal flag modification |
...
### Example 1 Set the instance renewal flag
