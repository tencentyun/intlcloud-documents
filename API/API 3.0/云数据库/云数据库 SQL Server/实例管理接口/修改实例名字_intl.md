...
This API (ModifyDBInstanceName) is used to modify the name of an instance.
...
| InstanceName | Yes | String | New database instance name |
...
### Example 1 Change the name of the instance mssql-njj2mtpl to testModifyInstanceName

#### Input example

```
https://sqlserver.tencentcloudapi.com/?Action=ModifyDBInstanceName
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=ModifyDBInstanceName)
