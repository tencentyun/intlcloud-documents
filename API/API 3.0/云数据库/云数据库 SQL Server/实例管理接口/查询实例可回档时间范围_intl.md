...
This API (DescribeRollbackTime) is used to query the rollback time range available for an instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DescribeRollbackTime |
| Version | Yes | String | Common parameter. The value used for this API: 2018-03-28 |
| Region | Yes | String | Common parameter. For more information, see the [list of regions](/document/api/238/19930#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8) supported by the product. |
| InstanceId | Yes | String | Instance ID |
| DBs.N | Yes | Array of String | The list of the databases to be queried |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| Details | Array of [DbRollbackTimeInfo](/document/api/238/19976#DbRollbackTimeInfo) | Information of the rollback time range available for the database instance |
| RequestId | String | The unique ID of a request, which is required for each troubleshooting case. |

## 4. Example

### Example 1 Query the rollback time range available for db1 in the instance mssql-j8kv137v
