...
This API (DeleteDB) is used to delete a database.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: DeleteDB |
...
| Names.N | Yes | Array of String | Array of database names |
