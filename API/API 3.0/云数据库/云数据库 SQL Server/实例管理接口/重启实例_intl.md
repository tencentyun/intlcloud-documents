...
This API (RestartDBInstance) is used to restart a database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value​used for this API: RestartDBInstance |
...
### Example 1 Restart the database instance mssql-niycdqff
