...
| DealNames.N | Yes | Array of String | Array of orders. The order name will be returned after shipment, which can be used to query the shipment status via the API DescribeOrders |

## 3. Output Parameters

| Parameter Name | Type | Description |
|---------|---------|---------|
| Deals | Array of [DealInfo](/document/api/238/19976#DealInfo) | Array of order information |
| TotalCount | Integer | Number of orders whose information is returned |
...
|---------|---------|
| FailedOperation.QueryOrderFailed | Failed to query orders |
