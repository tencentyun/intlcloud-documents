...
This API (ModifyAccountRemark) is used to modify the remarks of an account.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: ModifyAccountRemark |
...
| Accounts.N | Yes | Array of [AccountRemark](/document/api/238/19976#AccountRemark) | Modifies the account remarks |
...
### Example 1 Modify the remarks of an account
