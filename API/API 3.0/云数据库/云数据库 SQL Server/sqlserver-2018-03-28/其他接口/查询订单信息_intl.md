...
This API (DescribeOrders) describes order details.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: DescribeOrders |
...
| DealNames.N | Yes | Array of String | Order array. The order name will be returned upon shipping, which can be used to call the DescribeOrders API to query shipment status |

## 3. Output Parameters

| Parameter name | Type | Description |
|---------|---------|---------|
| Deals | Array of [DealInfo](https://cloud.tencent.com/document/api/238/19976#DealInfo) | Order information array |
| TotalCount | Integer | Number of orders returned |
| RequestId | String | The ID of the request. Each request returns a unique ID. The RequestId is required to troubleshoot issues. |

## 4. Samples

### Sample 1. Querying Orders

#### Input Sample Code

```
https://sqlserver.tencentcloudapi.com/?Action=DescribeOrders
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=DescribeOrders)
