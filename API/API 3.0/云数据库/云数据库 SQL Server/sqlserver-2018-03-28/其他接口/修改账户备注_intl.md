...
This API (ModifyAccountRemark) modifies account remarks.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: ModifyAccountRemark |
...
| InstanceId | Yes | String | Instance ID, for example, mssql-j8kv137v |
 Accounts.N | Yes | Array of [AccountRemark](https://cloud.tencent.com/document/api/238/19976#AccountRemark) | Information of the specified account whose remark is to be modified |
...
### Sample 1. Modifying Account Remarks

#### Input Sample Code

```
https://sqlserver.tencentcloudapi.com/?Action=ModifyAccountRemark
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=ModifyAccountRemark)
