...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyAccountRemark |
...
| Accounts.N | 是 | Array of [AccountRemark](https://cloud.tencent.com/document/api/238/19976#AccountRemark) | 修改备注的账户信息 |
