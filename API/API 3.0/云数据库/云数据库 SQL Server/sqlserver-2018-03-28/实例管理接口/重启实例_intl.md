...
This API (RestartDBInstance) restarts the specified database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: RestartDBInstance |
...
### Sample 1. Restarting the Database Instance mssql-niycdqff
