...
| DBRemarks.N | Yes | Array of [DBRemark](https://cloud.tencent.com/document/api/238/19976#DBRemark) | Array of database names and remarks, where each element contains a database name and the corresponding remarks |
