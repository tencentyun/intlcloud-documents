...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：CreateAccount |
...
| Accounts.N | 是 | Array of [AccountCreateInfo](https://cloud.tencent.com/document/api/238/19976#AccountCreateInfo) | 数据库实例账户信息 |
