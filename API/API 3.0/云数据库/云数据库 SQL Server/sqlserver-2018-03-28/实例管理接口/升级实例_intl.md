...
This API (UpgradeDBInstance) upgrades the specified database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: UpgradeDBInstance |
...
| AutoVoucher | No | Integer | Whether to automatically use vouchers. 0: no, 1: yes. 0 by default |
| VoucherIds.N | No | Array of String | Voucher IDs (currently, only one voucher can be used for one order) |
...
### Sample 1. Upgrading an Instance
