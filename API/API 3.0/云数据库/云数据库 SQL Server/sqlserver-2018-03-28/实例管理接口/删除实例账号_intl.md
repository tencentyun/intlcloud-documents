...
This API (DeleteAccount) deletes the specified instance account.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: DeleteAccount |
...
| UserNames.N | Yes | Array of String | Instance username array |
...
### Sample 1. Deleting an Instance Account
