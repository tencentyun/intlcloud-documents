...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeRollbackTime |
...
| DBs.N | 是 | Array of String | 需要查询的数据库列表 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Details | Array of [DbRollbackTimeInfo](https://cloud.tencent.com/document/api/238/19976#DbRollbackTimeInfo) | 数据库可回档实例信息|
| RequestId | String | 唯一请求ID，每次请求都会返回。定位问题时需要提供该次请求的RequestId。|

## 4. 示例

### 示例1 查询实例mssql-j8kv137v中db1的可回档时间
