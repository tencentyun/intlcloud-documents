...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyDBRemark |
...
| DBRemarks.N | 是 | Array of [DBRemark](https://cloud.tencent.com/document/api/238/19976#DBRemark) | 数据库名称及备注数组，每个元素包含数据库名和对应的备注 |
