...
|---------|---------|---------|
| Details | Array of [DbRollbackTimeInfo](https://cloud.tencent.com/document/api/238/19976#DbRollbackTimeInfo) | Information of the time range available for database rollback |
