...
This API (DeleteDB) deletes the specified database.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: DeleteDB |
...
| Names.N | Yes | Array of String | Database name array |
...
### Sample 1. Deleting a Database

#### Input Sample Code

```
https://sqlserver.tencentcloudapi.com/?Action=DeleteDB
&Names.0=test_db
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=DeleteDB)
