...
This API (ModifyDBInstanceName) renames the specified database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: ModifyDBInstanceName |
...
| InstanceName | Yes | String | New name of the database instance |
...
### Sample 1. Renaming the instance mssql-njj2mtpl to testModifyInstanceName
