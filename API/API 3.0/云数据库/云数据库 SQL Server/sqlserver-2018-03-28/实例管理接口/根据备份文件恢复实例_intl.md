...
This API (RestoreInstance) restores the specified baked-up instance.
...
| BackupId | Yes | Integer | Backup file ID, which can be obtained through the Id field in the return of the DescribeBackups API |
...
### Sample 1. Restoring an Instance
