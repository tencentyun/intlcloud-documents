...
This API (ModifyDBName) renames the specified a database.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: ModifyDBName |
...
| NewDBName | Yes | String | New name of the database |
