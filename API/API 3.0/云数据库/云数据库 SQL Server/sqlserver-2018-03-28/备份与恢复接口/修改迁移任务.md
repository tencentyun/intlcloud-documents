...
| Source | 否 | [MigrateSource](/document/api/238/19976#MigrateSource) | 迁移源，若不填则不修改 |
| Target | 否 | [MigrateTarget](/document/api/238/19976#MigrateTarget) | 迁移目标，若不填则不修改 |
| MigrateDBSet.N | 否 | Array of [MigrateDB](/document/api/238/19976#MigrateDB) | 迁移DB对象 ，离线迁移（SourceType=4或SourceType=5）不使用，若不填则不修改 |
