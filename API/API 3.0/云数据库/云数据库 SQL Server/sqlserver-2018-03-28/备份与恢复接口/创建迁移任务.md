...
| Source | 是 | [MigrateSource](/document/api/238/19976#MigrateSource) | 迁移源 |
| Target | 是 | [MigrateTarget](/document/api/238/19976#MigrateTarget) | 迁移目标 |
| MigrateDBSet.N | 否 | Array of [MigrateDB](/document/api/238/19976#MigrateDB) | 迁移DB对象 ，离线迁移不使用（SourceType=4或SourceType=5）。 |
