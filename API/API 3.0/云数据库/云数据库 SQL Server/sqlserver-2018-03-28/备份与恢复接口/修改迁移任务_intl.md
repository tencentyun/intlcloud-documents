...
| Source | [MigrateSource](https://cloud.tencent.com/document/api/238/19976#MigrateSource) | Migration source. If this is left blank, no modification will be made |
| Target | No | [MigrateTarget](https://cloud.tencent.com/document/api/238/19976#MigrateTarget) | Migration target. If this is left blank, no modification will be made |
| MigrateDBSet.N | No | Array of [MigrateDB](https://cloud.tencent.com/document/api/238/19976#MigrateDB) | Database objects to be migrated. This parameter is not used for offline migration (SourceType=4 or SourceType=5). If this is left blank, no modification will be made |
