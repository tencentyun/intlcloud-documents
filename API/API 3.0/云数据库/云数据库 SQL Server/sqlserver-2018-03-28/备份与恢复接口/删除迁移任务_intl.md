...
This API (DeleteMigration) deletes the specified migration task.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: DeleteMigration |
...
### Sample 1. Deleting a Migration Task
