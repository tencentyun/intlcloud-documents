...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The name of this API: CreateMigration |
...
| MigrateType | Yes | Integer | Migration type (1: structure migration, 2: data migration, 3: incremental synchronization) |
| SourceType | Yes | Integer | Type of migration source. 1: TencentDB for SQL Server, 2: SQL Server database created by CVM, 4: SQL Server backup restoration, 5: SQL Server backup restoration (in COS mode) |
| Source | Yes | [MigrateSource](https://cloud.tencent.com/document/api/238/19976#MigrateSource) | Migration source |
| Target | Yes | [MigrateTarget](https://cloud.tencent.com/document/api/238/19976#MigrateTarget) | Migration target |
| MigrateDBSet.N | No | Array of [MigrateDB](https://cloud.tencent.com/document/api/238/19976#MigrateDB) | Database objects to be migrated. This parameter is not used for offline migration (SourceType=4 or SourceType=5) |
...
### Sample 1. Creating a Migration Task
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sqlserver&Version=2018-03-28&Action=CreateMigration)
