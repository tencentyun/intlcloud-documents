...
このAPI（DescribeParamTemplates）はパラメータテンプレートリストを照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeParamTemplates |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| TotalCount | Integer | このユーザーのパラメータテンプレート数量。|
| Items | Array of [ParamTemplateInfo](https://cloud.tencent.com/document/api/236/15878#ParamTemplateInfo) | パラメータテンプレートの詳細。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 パラメータテンプレートリストの照合

#### 入力例

```
https://cdb.tencentcloudapi.com/?Action=DescribeParamTemplates
&<共通リクエストパラメータ>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeParamTemplates)
