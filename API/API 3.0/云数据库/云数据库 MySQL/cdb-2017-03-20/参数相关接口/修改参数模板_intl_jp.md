...
このAPI（ModifyParamTemplate）はパラメータテンプレートを変更するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyParamTemplate |
...
| TemplateId | はい | Integer | テンプレートID。 |
| Name | いいえ | String | テンプレート名。 |
| Description | いいえ | String | テンプレートの説明。 |
