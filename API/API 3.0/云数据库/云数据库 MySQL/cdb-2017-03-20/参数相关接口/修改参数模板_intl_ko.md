...
이 API(ModifyParamTemplate)는 매개변수 템플릿 수정에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyParamTemplate |
...
| TemplateId | 예 | Integer | 템플릿 ID. |
| Name | 아니요 | String | 템플릿 이름. |
| Description | 아니요 | String | 템플릿 설명. |
| ParamList.N | 아니요 | Array of [Parameter](https://cloud.tencent.com/document/api/236/15878#Parameter) | 매개변수 리스트. |
