...
このAPI（DescribeInstanceParamRecords）はインスタンスパラメータ変更履歴を照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeInstanceParamRecords |
...
| Limit | いいえ | Integer | ページングのサイズ。 |

## 3. 出力パラメータ

| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| TotalCount | Integer | 条件を満たす記録数|
| Items | Array of [ParamRecord](https://cloud.tencent.com/document/api/236/15878#ParamRecord) | パラメータ変更記録|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 インスタンスパラメータ変更履歴の照合
