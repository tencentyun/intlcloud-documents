...
이 API(DescribeParamTemplateInfo)는 매개변수 템플릿 세부 정보 조회에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeParamTemplateInfo |
...
| TemplateId | 예 | Integer | 매개변수 템플릿 ID. |
...
| EngineVersion | String | 매개변수 템플릿 설명. |
| TotalCount | Integer | 매개변수 템플릿의 매개변수 수량. |
| Items | Array of [ParameterDetail](https://cloud.tencent.com/document/api/236/15878#ParameterDetail) | 매개변수 세부 정보 |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 매개변수 템플릿 세부 정보 조회
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeParamTemplateInfo)
