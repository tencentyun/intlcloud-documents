...
| ParamList.N | Yes | Array of [Parameter](https://cloud.tencent.com/document/api/236/##Parameter) | List of parameters to be modified. Each element is a combination of "name" and "currentValue". "name" is the parameter name, and "currentValue" is the modified value. |
