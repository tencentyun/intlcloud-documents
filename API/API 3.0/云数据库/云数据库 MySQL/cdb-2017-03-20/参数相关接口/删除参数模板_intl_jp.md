...
このAPI（DeleteParamTemplate）はメータテンプレートを削除するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DeleteParamTemplate |
...
```
https://cdb.tencentcloudapi.com/?Action=DeleteParamTemplate
&TemplateId=1234
&<共通リクエストパラメータ>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DeleteParamTemplate)
