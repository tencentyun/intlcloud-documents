...
이 API(DescribeParamTemplates)는 매개변수 템플릿 리스트를 조회합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeParamTemplates |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TotalCount | Integer | 이 사용자의 매개변수 템플릿 수량입니다. |
| Items | Array of [ParamTemplateInfo](https://cloud.tencent.com/document/api/236/15878#ParamTemplateInfo) | 매개변수 템플릿 세부 정보입니다. |
