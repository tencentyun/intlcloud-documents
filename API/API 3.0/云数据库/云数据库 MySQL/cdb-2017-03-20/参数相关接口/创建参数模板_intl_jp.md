...
このAPI（CreateParamTemplate）はパラメータテンプレートを作成するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：CreateParamTemplate |
...
| Name | はい | String | パラメータテンプレート名。 |
| Description | いいえ | String | パラメータテンプレートの説明。 |
| EngineVersion | いいえ | String | MySQLバージョン。 |
| TemplateId | いいえ | Integer | ソースパラメータテンプレートID。 |
| ParamList.N | いいえ | Array of [Parameter](https://cloud.tencent.com/document/api/236/15878#Parameter) | パラメータリスト。 |
