...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeDatabases |
...
| Limit | 否 | Integer | 单次请求数量，默认值为20，最小值为1，最大值为100。 |
| DatabaseRegexp | 否 | String | 匹配数据库库名的正则表达式，规则同MySQL官网 |
