...
이 API(DescribeDatabases)는 데이터베이스 인스턴스의 데이터베이스 정보 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeDatabases |
...
| Limit | 아니요 | Integer | 1회 요청의 반환 수량, 기본값은 20, 최소값은 1, 최대값은 100입니다. |
| DatabaseRegexp | 아니요 | String | 데이터베이스 이름과 일치하는 정규식. 규칙은 MySQL 공식 웹사이트와 동일합니다. |
...
| Items | Array of String | 반환된 인스턴스 정보. |
