...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：StartBatchRollback |
...
| Instances.N | 是 | Array of [RollbackInstancesInfo](https://cloud.tencent.com/document/api/236/15878#RollbackInstancesInfo) | 用于回档的实例详情信息 |
