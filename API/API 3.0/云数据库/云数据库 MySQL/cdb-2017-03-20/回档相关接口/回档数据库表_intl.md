...
This API (StartBatchRollback) is used to roll back the tables of a database instance in batch.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: StartBatchRollback |
...
| Instances.N | Yes | Array of [RollbackInstancesInfo](https://cloud.tencent.com/document/api/236/##RollbackInstancesInfo) | Details of the instance for rollback |
...
### Example 1 Roll back database tables
