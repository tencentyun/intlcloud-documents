...
이 API(StartBatchRollback)는 데이터베이스 인스턴스의 데이터베이스 테이블 배치 롤백에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: StartBatchRollback |
...
| Instances.N | 아니요 | Array of [RollbackInstancesInfo](https://cloud.tencent.com/document/api/236/15878#RollbackInstancesInfo) | 롤백에 사용한 인스턴스 상세 정보. |
