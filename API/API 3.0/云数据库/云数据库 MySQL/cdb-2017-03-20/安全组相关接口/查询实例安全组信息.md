...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeDBSecurityGroups |
...
| InstanceId | 是 | String | 实例ID，格式如：cdb-c1nl9rpv或者cdbro-c1nl9rpv，与云数据库控制台页面中显示的实例ID相同。 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Groups | Array of [SecurityGroup](https://cloud.tencent.com/document/api/236/15878#SecurityGroup) | 安全组详情。|
