...
このAPI（ModifyDBInstanceSecurityGroups）はインスタンスにバインディングされるセキュリティグループを変更するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyDBInstanceSecurityGroups |
...
| SecurityGroupIds.N | はい | Array of String | 変更するセキュリティグループIDリスト。1つまたは複数のセキュリティグループIdからなる配列です。 |
