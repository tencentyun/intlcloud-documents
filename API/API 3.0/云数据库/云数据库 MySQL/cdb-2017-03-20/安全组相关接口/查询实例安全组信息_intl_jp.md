...
このAPI（DescribeDBSecurityGroups）はインスタンスのセキュリティグループの詳細を照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeDBSecurityGroups |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| Groups | Array of [SecurityGroup](https://cloud.tencent.com/document/api/236/15878#SecurityGroup) | セキュリティグループの詳細。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 インスタンスセキュリティグループ情報の照合
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeDBSecurityGroups)
