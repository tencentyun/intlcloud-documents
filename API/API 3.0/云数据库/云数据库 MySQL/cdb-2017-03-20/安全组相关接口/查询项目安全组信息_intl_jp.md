...
このAPI（DescribeProjectSecurityGroups）はプロジェクトのセキュリティグループの詳細を照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeProjectSecurityGroups |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeProjectSecurityGroups)
