...
이 API(DescribeDBSecurityGroups)는 인스턴스의 보안 그룹 세부 정보 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeDBSecurityGroups |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| Groups | Array of [SecurityGroup](https://cloud.tencent.com/document/api/236/15878#SecurityGroup) | 보안 그룹 세부 정보. |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 인스턴스의 보안 그룹 정보 조회
