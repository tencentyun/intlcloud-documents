...
이 API(DisassociateSecurityGroups)는 인스턴스에서 보안 그룹 배치 언바인딩에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DisassociateSecurityGroups |
...
| SecurityGroupId | 예 | String | 보안 그룹 ID. |
| InstanceIds.N | 예 | Array of String | 인스턴스 ID 리스트, 한 개 또는 여러 개의 인스턴스 ID로 구성된 배열. |
