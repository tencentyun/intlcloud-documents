...
이 API(DescribeProjectSecurityGroups)는 프로젝트의 보안 그룹 상세 정보 조회에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeProjectSecurityGroups |
