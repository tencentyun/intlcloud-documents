...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Cpu | [DeviceCpuInfo](https://cloud.tencent.com/document/api/236/15878#DeviceCpuInfo) | 实例CPU监控数据|
| Mem | [DeviceMemInfo](https://cloud.tencent.com/document/api/236/15878#DeviceMemInfo) | 实例内存监控数据|
| Net | [DeviceNetInfo](https://cloud.tencent.com/document/api/236/15878#DeviceNetInfo) | 实例网络监控数据|
| Disk | [DeviceDiskInfo](https://cloud.tencent.com/document/api/236/15878#DeviceDiskInfo) | 实例磁盘监控数据|
