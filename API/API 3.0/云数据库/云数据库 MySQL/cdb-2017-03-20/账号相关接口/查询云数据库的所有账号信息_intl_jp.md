...
該当API（DescribeAccounts）はデータベースのすべてのアカウント情報の照合に使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、該当APIの値：DescribeAccounts |
...
| Limit | いいえ | Integer | 単回リクエストによって返された数量。デフォルト値は20、最小値は1、最大値は100です。 |

## 3. 出力パラメータ

| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| TotalCount | Integer | 照合条件を満たすアカウントの数量。|
| Items | Array of [AccountInfo](https://cloud.tencent.com/document/api/236/15878#AccountInfo) | 照合条件を満たすアカウントの詳細情報。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 データベースのすべてのアカウント情報を照合する
