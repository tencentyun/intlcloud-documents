...
이 API(VerifyRootAccount)는 데이터베이스 인스턴스의 ROOT 계정에 권한 부여 작업을 위한 충분한 권한이 있는지 확인하는 데 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: VerifyRootAccount |
...
| Password | 예 | String | 인스턴스 ROOT 계정의 비밀번호. |
...
```
https://cdb.tencentcloudapi.com/?Action=VerifyRootAccount
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=VerifyRootAccount)
