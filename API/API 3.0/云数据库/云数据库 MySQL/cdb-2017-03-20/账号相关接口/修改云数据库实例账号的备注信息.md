...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：ModifyAccountDescription |
...
| Accounts.N | 是 | Array of [Account](https://cloud.tencent.com/document/api/236/15878#Account) | 云数据库账号。 |
| Description | 否 | String | 数据库账号的备注信息。 |
