...
This API (CreateAccounts) is used to create a database account. A new account name and domain name as well as a password need to be specified, and the remarks of the account should also be set.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: CreateAccounts |
...
| Accounts.N | No | Array of [Account](https://cloud.tencent.com/document/api/236/##Account) | Database account. |
| Password | Yes | String | New account password. |
| Description | No | String | Remarks. |
...
### Example 1 Create a database account
