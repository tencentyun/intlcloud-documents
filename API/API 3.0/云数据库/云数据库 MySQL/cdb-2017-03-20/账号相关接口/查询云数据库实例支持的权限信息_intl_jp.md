...
該当API（DescribeSupportedPrivileges）はデータベースがサポートする権限情報（グローバル権限、データベース権限、テーブル権限および列権限を含む）の照合に使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、該当APIの値：DescribeSupportedPrivileges |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| GlobalSupportedPrivileges | Array of String | インスタンスがサポートするグローバル権限。|
| DatabaseSupportedPrivileges | Array of String | インスタンスがサポートするデータベース権限。|
| TableSupportedPrivileges | Array of String | インスタンスがサポートするデータベーステーブル権限。|
| ColumnSupportedPrivileges | Array of String | インスタンスがサポートするデータベース列権限。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 データベースインスタンスがサポートする権限情報を照合する
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeSupportedPrivileges)
