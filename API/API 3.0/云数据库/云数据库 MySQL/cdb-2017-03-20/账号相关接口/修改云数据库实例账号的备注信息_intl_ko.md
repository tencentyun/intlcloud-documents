...
이 API(ModifyAccountDescription)는 데이터베이스 계정의 비고 정보 수정에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyAccountDescription |
...
| Accounts.N | 예 | Array of [Account](https://cloud.tencent.com/document/api/236/15878#Account) | 데이터베이스 계정. |
| Description | 아니요 | String | 데이터베이스 계정의 비고 정보. |
