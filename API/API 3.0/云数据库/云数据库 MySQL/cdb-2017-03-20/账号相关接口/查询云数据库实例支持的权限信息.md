...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeSupportedPrivileges |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| GlobalSupportedPrivileges | Array of String | 实例支持的全局权限。|
| DatabaseSupportedPrivileges | Array of String | 实例支持的数据库权限。|
| TableSupportedPrivileges | Array of String | 实例支持的数据库表权限。|
| ColumnSupportedPrivileges | Array of String | 实例支持的数据库列权限。|
