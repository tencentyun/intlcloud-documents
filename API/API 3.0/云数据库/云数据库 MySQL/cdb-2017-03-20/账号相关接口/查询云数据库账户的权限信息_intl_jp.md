...
該当API（DescribeAccountPrivileges）はデータベースアカウントがサポートする権限情報の照合に使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、該当APIの値：DescribeAccountPrivileges |
...
| User | はい | String | データベースのアカウント名称。 |
| Host | はい | String | データベースのアカウントドメイン名。 |

## 3. 出力パラメータ

| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| GlobalPrivileges | Array of String | グローバル権限配列。|
| DatabasePrivileges | Array of [DatabasePrivilege](https://cloud.tencent.com/document/api/236/15878#DatabasePrivilege) | データベース権限配列。|
| TablePrivileges | Array of [TablePrivilege](https://cloud.tencent.com/document/api/236/15878#TablePrivilege) | データベース中のテーブル権限配列。|
| ColumnPrivileges | Array of [ColumnPrivilege](https://cloud.tencent.com/document/api/236/15878#ColumnPrivilege) | データベーステーブル中の列権限配列。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 データベースアカウントの権限情報を照合する
