...
| DatabasePrivileges | Array of [DatabasePrivilege](/document/api/236/15878#DatabasePrivilege) | データベース権限配列。|
| TablePrivileges | Array of [TablePrivilege](/document/api/236/15878#TablePrivilege) | データベース中のテーブル権限配列。|
| ColumnPrivileges | Array of [ColumnPrivilege](/document/api/236/15878#ColumnPrivilege) | データベーステーブル中の列権限配列。|
