...
該当API（ModifyAccountDescription）はデータベースのアカウントの備考情報の変更に使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、該当APIの値：ModifyAccountDescription |
...
| Accounts.N | はい | Array of [Account](https://cloud.tencent.com/document/api/236/15878#Account) | データベースアカウント。 |
| Description | いいえ | String | データベースアカウントの備考情報。 |
...
### 例1 データベースインスタンスアカウントの備考情報を変更する

#### 入力例

```
https://cdb.tencentcloudapi.com/?Action=ModifyAccountDescription
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=ModifyAccountDescription)
