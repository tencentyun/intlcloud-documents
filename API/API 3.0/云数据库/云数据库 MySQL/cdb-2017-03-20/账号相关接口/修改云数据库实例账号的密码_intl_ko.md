...
이 API(ModifyAccountPassword)는 데이터베이스 계정의 비밀번호 수정에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyAccountPassword |
...
| NewPassword | 예 | String | 데이터베이스 계정의 새 비밀번호. |
