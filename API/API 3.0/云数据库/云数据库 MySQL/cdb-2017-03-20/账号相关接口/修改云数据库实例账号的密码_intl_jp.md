...
該当API（ModifyAccountPassword）はデータベースアカウントのパスワードの変更に使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、該当APIの値：ModifyAccountPassword |
...
| NewPassword | はい | String | データベースアカウントの新しいパスワード。 |
...
### 例1 データベースインスタンスアカウントのパスワードを変更する
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=ModifyAccountPassword)
