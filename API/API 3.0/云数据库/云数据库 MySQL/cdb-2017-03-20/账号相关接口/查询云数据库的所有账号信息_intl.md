...
This API (DescribeAccounts) is used to query the information of database accounts.
...
|---------|---------|---------|
| TotalCount | Integer | Number of accounts that meet the condition. |
| Items | Array of [AccountInfo](https://cloud.tencent.com/document/api/236/##AccountInfo) | Details of accounts that meet the condition. |
...
### Example 1 Query the information of database accounts
