...
| DatabasePrivileges | Array of [DatabasePrivilege](/document/api/236/15878#DatabasePrivilege) | 数据库权限数组。|
| TablePrivileges | Array of [TablePrivilege](/document/api/236/15878#TablePrivilege) | 数据库中的表权限数组。|
| ColumnPrivileges | Array of [ColumnPrivilege](/document/api/236/15878#ColumnPrivilege) | 数据库表中的列权限数组。|
