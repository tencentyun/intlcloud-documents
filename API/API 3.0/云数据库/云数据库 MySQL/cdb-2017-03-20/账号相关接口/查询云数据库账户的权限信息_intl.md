...
| DatabasePrivileges | Array of [DatabasePrivilege](https://cloud.tencent.com/document/api/236/##DatabasePrivilege) | Array of global permissions of the database. |
| TablePrivileges | Array of [TablePrivilege](https://cloud.tencent.com/document/api/236/##TablePrivilege) | Array of table permissions of the database. |
| ColumnPrivileges | Array of [ColumnPrivilege](https://cloud.tencent.com/document/api/236/##ColumnPrivilege) | Array of column permissions of the database. |
