...
このAPI（DeleteBackup）はデータベースバックアップを削除するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DeleteBackup |
...
| BackupId | はい | Integer | バックアップタスクID。このタスクIDは[データベースバックアップの作成](https://cloud.tencent.com/document/api/236/15844) APIで返されたタスクIDです。 |
...
```
https://cdb.tencentcloudapi.com/?Action=DeleteBackup
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DeleteBackup)
