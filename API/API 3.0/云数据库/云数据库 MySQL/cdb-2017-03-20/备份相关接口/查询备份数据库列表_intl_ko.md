...
이 API(DescribeBackupDatabases)는 백업 데이터베이스 리스트 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeBackupDatabases |
...
| StartTime | 예 | String | 시작 시간, 형식: 2017-07-12 10:29:20. |
| SearchDatabase | 아니요 | String | 조회할 데이터베이스 이름 접두사. |
| Offset | 아니요 | Integer | 페이징 오프셋. |
| Limit | 아니요 | Integer | 페이징 크기, 최소값은 1, 최대값은 2000입니다. |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TotalCount | Integer | 반환된 데이터 개수 |
| Items | Array of [DatabaseName](https://cloud.tencent.com/document/api/236/15878#DatabaseName) | 조회 조건에 부합하는 데이터베이스 배열 |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 백업 데이터베이스 리스트 조회
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeBackupDatabases)
