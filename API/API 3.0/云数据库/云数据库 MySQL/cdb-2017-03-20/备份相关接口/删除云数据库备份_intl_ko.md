...
이 API(DeleteBackup)는 데이터베이스 백업 삭제에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DeleteBackup |
...
| BackupId | 예 | Integer | 백업 태스크 ID. 이 태스크 ID는 [데이터베이스 백업 생성](https://cloud.tencent.com/document/api/236/15844) API에서 반환된 태스크 ID입니다. |
