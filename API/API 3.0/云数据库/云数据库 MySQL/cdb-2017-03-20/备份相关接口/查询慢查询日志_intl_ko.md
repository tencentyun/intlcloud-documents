...
이 API(DescribeSlowLogs)는 데이터베이스 인스턴스의 슬로우 로그 획득에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeSlowLogs |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TotalCount | Integer | 조회 조건에 부합하는 슬로우 로그 총수 |
| Items | Array of [SlowLogInfo](https://cloud.tencent.com/document/api/236/15878#SlowLogInfo) | 조회 조건에 부합하는 슬로우 로그 상세 정보|
