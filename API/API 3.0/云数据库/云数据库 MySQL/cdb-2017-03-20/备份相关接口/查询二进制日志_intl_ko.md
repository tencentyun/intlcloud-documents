...
이 API(DescribeBinlogs)는 데이터베이스 인스턴스의 이진 데이터 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeBinlogs |
...
| Offset | 아니요 | Integer | 오프셋, 최소값은 0입니다. |
| Limit | 아니요 | Integer | 페이징 크기, 기본값은 20, 최소값은 1, 최대값은 100입니다. |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TotalCount | Integer | 조회 조건에 부합하는 로그 파일 총수 |
| Items | Array of [BinlogInfo](https://cloud.tencent.com/document/api/236/15878#BinlogInfo) | 조회 조건에 부합하는 이진 로그 파일 세부 정보 |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeBinlogs)
