...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeBinlogs |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| TotalCount | Integer | 符合查询条件的日志文件总数|
| Items | Array of [BinlogInfo](https://cloud.tencent.com/document/api/236/15878#BinlogInfo) | 符合查询条件的二进制日志文件详情|
