...
이 API(DescribeBackupTables)는 지정한 데이터베이스의 백업 데이터 테이블 이름 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeBackupTables |
...
| DatabaseName | 예 | String | 지정된 데이터베이스 이름. |
| SearchTable | 아니요 | String | 조회할 데이터 테이블 이름 접두사. |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| TotalCount | Integer | 반환할 데이터 개수. |
| Items | Array of [TableName](https://cloud.tencent.com/document/api/236/15878#TableName) | 조건에 부합하는 데이터 테이블 배열. |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 지정 데이터베이스의 백업 데이터 테이블 조회
