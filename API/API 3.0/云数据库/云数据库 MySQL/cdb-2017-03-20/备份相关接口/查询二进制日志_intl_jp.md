...
このAPI（DescribeBinlogs）はデータベースインスタンスの2進数データを照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeBinlogs |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| TotalCount | Integer | 照合条件を満たすログファイル総数|
| Items | Array of [BinlogInfo](https://cloud.tencent.com/document/api/236/15878#BinlogInfo) | 照合条件を満たす2進数ログファイルの詳細|
