...
このAPI（DescribeBackupDatabases）はバックアップデータベースリストを照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeBackupDatabases |
...
| SearchDatabase | いいえ | String | 照合するデータベース名の接頭辞。 |
...
| Items | Array of [DatabaseName](https://cloud.tencent.com/document/api/236/15878#DatabaseName) | 照合条件を満たすデータベース配列|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 バックアップデータベースリストの照合
