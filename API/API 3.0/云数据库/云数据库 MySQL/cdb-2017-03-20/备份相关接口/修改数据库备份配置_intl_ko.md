...
이 API(ModifyBackupConfig)는 데이터베이스 백업 구성 정보 수정에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyBackupConfig |
...
| ExpireDays | 아니요 | Integer | 백업 만료 시간, 단위는 일, 최소값은 7일, 최대값은 732일입니다. |
| StartTime | 아니요 | String | 백업 시간 범위, 형식: 02:00-06:00, 시작점과 종료점 시간은 현재 정각으로 제한되며, 현재 선택 가능한 범위: 02:00--06:00, 06:00-10:00, 10:00-14:00, 14:00-18:00, 18:00-22:00, 22:00-02:00. |
| BackupMethod | 아니요 | String | 대상 백업 방식, 선택 가능 값: logical - 로직 콜드 백업, physical - 물리적 콜드 백업. 기본 백업 방법은 로직 콜드 백업입니다. |
