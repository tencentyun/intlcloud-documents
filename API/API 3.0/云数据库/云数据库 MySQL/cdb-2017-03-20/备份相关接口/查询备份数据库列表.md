...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeBackupDatabases |
...
| SearchDatabase | 否 | String | 要查询的数据库名前缀。 |
...
| Items | Array of [DatabaseName](https://cloud.tencent.com/document/api/236/15878#DatabaseName) | 符合查询条件的数据库数组|
