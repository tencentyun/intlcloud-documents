...
이 API(DescribeBackups)는 데이터베이스 인스턴스의 백업 데이터 조회에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeBackups |
...
| Items | Array of [BackupInfo](https://cloud.tencent.com/document/api/236/15878#BackupInfo) | 조회 조건에 부합하는 백업 정보 세부 정보 |
