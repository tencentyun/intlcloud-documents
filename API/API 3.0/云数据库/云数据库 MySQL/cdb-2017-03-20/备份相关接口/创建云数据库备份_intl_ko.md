...
이 API(CreateBackup)는 데이터베이스 백업 생성에 사용됩니다.

기본적 API 요청 빈도 제한: 1회/초.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: CreateBackup |
...
| BackupMethod | 예 | String | 대상 백업 방법, 선택 가능 값: logical - 로직 콜드 백업, physical - 물리적 콜드 백업. |

## 3. 출력 매개변수

| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| BackupId | Integer | 백업 태스크 ID.|
