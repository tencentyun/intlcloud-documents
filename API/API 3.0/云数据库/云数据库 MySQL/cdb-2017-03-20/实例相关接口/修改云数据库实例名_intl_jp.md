...
このAPI（ModifyDBInstanceName）はデータベースインスタンス名を変更するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyDBInstanceName |
...
| InstanceName | はい | String | インスタンス名。 |
...
```
https://cdb.tencentcloudapi.com/?Action=ModifyDBInstanceName
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=ModifyDBInstanceName)
