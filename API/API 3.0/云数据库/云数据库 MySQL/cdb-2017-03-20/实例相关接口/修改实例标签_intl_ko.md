...
인스턴스 태그에 대해 추가, 수정 또는 삭제를 할 수 있습니다
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyInstanceTag |
...
| ReplaceTags.N | 아니요 | Array of [TagInfo](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/236/15878#TagInfo) | 추가 또는 수정할 태그 |
| DeleteTags.N | 아니요 | Array of [TagInfo](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/236/15878#TagInfo) | 삭제할 태그 |
...
이 API를 사용하여 인스턴스 태그를 추가, 수정 또는 삭제할 수 있습니다.
