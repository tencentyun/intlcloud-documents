...
This API (IsolateDBInstance) is used to terminate a database instance. A terminated database cannot be accessed via the IP or the port. Postpaid instances become deactivated upon termination.

Prepaid instances cannot be terminated via this API.
...
### Example 1 Isolate a database instance

#### Input example

```
https://cdb.tencentcloudapi.com/?Action=IsolateDBInstance
&InstanceIds=cdb-ezq1vzem
