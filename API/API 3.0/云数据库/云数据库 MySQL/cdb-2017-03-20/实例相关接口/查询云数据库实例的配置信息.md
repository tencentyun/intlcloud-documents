...
| SlaveConfig | [SlaveConfig](/document/api/236/15878#SlaveConfig) | 从库的配置信息。|
| BackupConfig | [BackupConfig](/document/api/236/15878#BackupConfig) | ECDB第二个从库的配置信息，只有ECDB实例才有这个字段。|
