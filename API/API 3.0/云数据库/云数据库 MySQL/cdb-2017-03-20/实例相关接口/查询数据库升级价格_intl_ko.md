...
| Cpu | 아니요 | Integer | 업그레이드 후 코어 수, 단위: 코어, 유효한 CPU 값을 입력하기 위해 [데이터베이스 판매 가능 사양 획득](https://intl.cloud.tencent.com/document/product/236/17229) API를 사용하여 업그레이드 가능한 코어 수를 확인하십시오. 해당 값을 지정하지 않은 경우 Memory 크기에 따라 기본값을 보완적으로 입력합니다. |
