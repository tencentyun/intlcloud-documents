...
이 API(DescribeDBInstanceCharset)는 데이터베이스 인스턴스의 문자 집합 조회, 문자 집합의 이름 획득에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeDBInstanceCharset |
...
| 매개변수 이름 | 유형 | 설명 |
|---------|---------|---------|
| Charset | String | 인스턴스의 기본 문자 집합, 예: "latin1", "utf8" 등. |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 데이터베이스 인스턴스의 문자 집합 조회
