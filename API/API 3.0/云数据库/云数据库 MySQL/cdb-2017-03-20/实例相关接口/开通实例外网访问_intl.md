...
This API (OpenWanService) is used to enable the access to an instance from public network.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: OpenWanService |
...
### Example 1 Enable the access to an instance from public network
