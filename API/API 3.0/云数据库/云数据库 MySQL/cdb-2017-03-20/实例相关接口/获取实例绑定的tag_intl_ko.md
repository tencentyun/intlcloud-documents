...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeTagsOfInstanceIds |
...
| InstanceIds.N | 예 | Array of String | 인스턴스 리스트 |
| Offset | 아니요 | Integer | 오프셋 |
| Limit | 아니요 | Integer | 각 페이지에서 반환할 태그 수량 |
...
|---------|---------|---------|
| Offset | Integer | 오프셋 |
| Limit | Integer | 각 페이지에서 반환할 태그 수량 |
| Rows | Array of [TagsInfoOfInstance](https://cloud.tencent.com/document/api/236/15878#TagsInfoOfInstance) | 인스턴스 태그 정보 |
