...
This API (OpenDBInstanceGTID) is used to enable the GTID of a database instance. Only instances of version 5.6 or above are supported.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: OpenDBInstanceGTID |
...
### Example 1 Enable the GTID of an instance
