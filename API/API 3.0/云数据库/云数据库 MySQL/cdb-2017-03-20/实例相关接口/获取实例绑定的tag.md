...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeTagsOfInstanceIds |
...
|---------|---------|---------|
| Offset | Integer | 偏移量|
| Limit | Integer | 每页返回多少个标签|
| Rows | Array of [TagsInfoOfInstance](https://cloud.tencent.com/document/api/236/15878#TagsInfoOfInstance) | 实例标签信息|
