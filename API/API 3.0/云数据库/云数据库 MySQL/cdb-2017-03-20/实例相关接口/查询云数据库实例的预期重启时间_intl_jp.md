...
このAPI（DescribeDBInstanceRebootTime）はデータベースインスタンスの再起動予定所要時間を照合するために使用されます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeDBInstanceRebootTime |
...
| InstanceIds.N | はい | Array of String | インスタンスのID。フォーマット：cdb-c1nl9rpv。データベースコンソールページで表示されるインスタンスIDと同じ。 |
...
| Items | Array of [InstanceRebootTime](https://cloud.tencent.com/document/api/236/15878#InstanceRebootTime) | 返されたパラメータ情報。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 データベースインスタンスの再起動予定所要時間の照合
