...
이 API(DescribeDBInstanceRebootTime)는 데이터베이스 인스턴스 다시 시작 예상 필요 시간 조회에 사용됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: DescribeDBInstanceRebootTime |
...
| Items | Array of [InstanceRebootTime](https://cloud.tencent.com/document/api/236/15878#InstanceRebootTime) | 반환된 매개변수 정보. |
| RequestId | String | 유일한 요청 ID, 매회 요청 시마다 반환됩니다. 문제를 찾을 경우 해당 요청의 RequestId를 제공해야 합니다. |

## 4. 예시

### 예시1 데이터베이스 인스턴스의 다시 시작 예상 시간 조회
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=DescribeDBInstanceRebootTime)
