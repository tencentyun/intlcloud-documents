...
This API (SwitchForUpgrade) is used to switch to a new instance. You can initiate the switch if the instance is in "to be switched" status during master instance upgrade.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: SwitchForUpgrade |
...
### Example 1 Switch to a new instance
