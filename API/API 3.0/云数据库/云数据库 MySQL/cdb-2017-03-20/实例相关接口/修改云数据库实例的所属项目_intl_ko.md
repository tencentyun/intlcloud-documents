...
이 API(ModifyDBInstanceProject)는 데이터베이스 인스턴스의 소속 프로젝트 수정에 사용합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: ModifyDBInstanceProject |
...
| InstanceIds.N | 예 | Array of String | 인스턴스 ID 배열, 형식 예: cdb-c1nl9rpv, TencentDB 콘솔 페이지에 표시된 인스턴스 ID와 동일합니다. [인스턴스 리스트 조회](https://cloud.tencent.com/document/api/236/15872) API를 사용하여 획득할 수 있으며, 그 값은 출력 매개변수 중 필드 InstanceId의 값입니다 |
| NewProjectId | 아니요 | Integer | 프로젝트 ID. |
