...
このAPI（DescribeDBInstanceGTID）はデータベースインスタンスのGTIDが有効になっているかどうかを照合するために使用されます。バージョン5.5とその以前のインスタンスに対応しません。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：DescribeDBInstanceGTID |
...
| パラメータ名 | タイプ | 説明 |
|---------|---------|---------|
| IsGTIDOpen | Integer | GTIDが有効になっているかどうかのフラグ：0-無効、1-有効。|
| RequestId | String | 唯一のリクエストID、リクエストごとに返します。問題を特定するときに、このリクエストのRequestIdが必要です。|

## 4. 例

### 例1 クラウドデータインスタンスのGTIDが有効になっているかどうかの照合
