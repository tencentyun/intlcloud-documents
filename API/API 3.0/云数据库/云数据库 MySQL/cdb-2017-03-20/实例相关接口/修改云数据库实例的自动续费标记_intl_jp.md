...
このAPI（ModifyAutoRenewFlag）はデータベースインスタンスの自動更新フラグを変更するために使用されます。年額/月額のインスタンスのみが自動更新フラグを設定できます。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyAutoRenewFlag |
...
| AutoRenew | はい | Integer | 自動更新フラグ。設定可能な値：0-非自動更新、1-自動更新。 |
