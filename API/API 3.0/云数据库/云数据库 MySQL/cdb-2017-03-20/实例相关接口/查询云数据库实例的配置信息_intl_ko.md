...
| SlaveConfig | [SlaveConfig](/document/api/236/15878#SlaveConfig) | 슬레이브 데이터베이스의 구성 정보. |
| BackupConfig | [BackupConfig](/document/api/236/15878#BackupConfig) | ECDB 두 번째 슬레이브 데이터베이스의 구성 정보, ECDB 인스턴스에만 이 필드가 있습니다. |
