...
This API (DescribeDBInstanceGTID) is used to query whether the GTID is enabled for a database instance. Instances of version 5.5 or below are not supported.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DescribeDBInstanceGTID |
...
|---------|---------|---------|
| IsGTIDOpen | Integer | Indicates whether GTID is enable. 0 - Not enabled; 1 - Enabled. |
...
### Example 1 Query whether GTID is enabled for a database instance
