...
이 API(SwitchForUpgrade)는 새로운 인스턴스로 전환 및 액세스에 사용되며, 마스터 인스턴스가 업그레이드 중에 전환 대기 중인 인스턴스에 대하여 사용자가 해당 프로세스를 직접 시작할 수 있습니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: SwitchForUpgrade |
