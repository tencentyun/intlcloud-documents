...
このAPI（OpenDBInstanceGTID）はデータベースインスタンスのGTIDを有効化するために使用されます。バージョン5.6以降のインスタンスのみをサポートします。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：OpenDBInstanceGTID |
...
```
https://cdb.tencentcloudapi.com/?Action=OpenDBInstanceGTID
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=OpenDBInstanceGTID)
