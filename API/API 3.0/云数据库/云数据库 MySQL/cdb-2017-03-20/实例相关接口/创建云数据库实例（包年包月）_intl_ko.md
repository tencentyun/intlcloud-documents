...
| RoGroup | 아니요 | [RoGroup](https://cloud.tencent.com/document/api/236/15878#RoGroup) | 읽기 전용 인스턴스 매개변수 |
| InstanceName | 아니요 | String | 인스턴스 이름 |
| ResourceTags.N | 아니요 | Array of [TagInfo](https://cloud.tencent.com/document/api/236/15878#TagInfo) | 인스턴스에 바인딩할 태그 |
