...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：ModifyInstanceTag |
...
| InstanceId | はい | String | インスタンスID |
| ReplaceTags.N | いいえ | Array of [TagInfo](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/236/15878#TagInfo) | 追加または変更するタグ |
| DeleteTags.N | いいえ | Array of [TagInfo](https://cloud.tencent.comhttps://cloud.tencent.com/document/api/236/15878#TagInfo) | 削除するタグ |
