...
このAPI（UpgradeDBInstanceEngineVersion）はデータベースインスタンスバージョンをアップグレードするために使用されます。インスタンスタイプについては、マスタインスタンス、ディザスタリカバリインスタンス、読み取り専用インスタンスをサポートします。
...
| パラメータ名 | 必須項目 | タイプ | 説明 |
|---------|---------|---------|---------|
| Action | はい | String | 共通パラメータ、このAPIの値：UpgradeDBInstanceEngineVersion |
