...
이 API(IsolateDBInstance)는 데이터베이스 인스턴스 폐기에 사용됩니다. 폐기 후에는 IP 및 포트를 통해 데이터베이스에 액세스할 수 없으며, 사용량 기반 요금제 인스턴스는 폐기 후 바로 비활성화됩니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: IsolateDBInstance |
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=cdb&Version=2017-03-20&Action=IsolateDBInstance)
