...
This API (DescribeDBInstanceCharset) is used to query the character set name of a database instance.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter. The value used for this API: DescribeDBInstanceCharset |
...
|---------|---------|---------|
| Charset | String | The default character set of the instance, such as "latin1" and "utf8". |
...
### Example 1 Query the character set of a database instance
