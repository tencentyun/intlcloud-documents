...
| SlaveConfig | [SlaveConfig](https://cloud.tencent.com/document/api/236/15878#SlaveConfig) | スレーブデータベースの構成情報。|
| BackupConfig | [BackupConfig](https://cloud.tencent.com/document/api/236/15878#BackupConfig) | ECDB第2のスレーブデータベースの構成情報。このフィールドはECDBインスタンスにのみ使用可能です。|
