...
이 API(OpenWanService)는 인스턴스 공중망 액세스 활성화에 사용됩니다.

주의: 공중망 접근을 활성화하기 전에 먼저 인스턴스에 대해 [인스턴스 초기화](https://cloud.tencent.com/document/api/236/15873) 조작을 해야 합니다.
...
|---------|---------|---------|---------|
| Action | 예 | String | 공통 매개변수, 이 API 값: OpenWanService |
