...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/><li>Keywords - String - 是否必填：否 - 查询关键字 </li><li>Status - String - 是否必填：否 - 木马状态（UN_OPERATED: 未处理 &#124; SEGREGATED: 已隔离&#124;TRUSTED：信任）</li><br/>每个过滤条件只支持一个值，暂不支持多个值“或”关系查询。 |
...
| Malwares | Array of [Malware](/document/api/296/19867#Malware) | Malware数组。|
