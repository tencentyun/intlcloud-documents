...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/><li>Keywords - String - 是否必填：否 -  查询关键字</li><li>Status - String - 是否必填：否 -  查询状态（FAILED：破解失败 &#124;SUCCESS：破解成功）</li> |
...
| BruteAttacks | Array of [BruteAttack](/document/api/296/19867#BruteAttack) | 暴力破解事件列表|
