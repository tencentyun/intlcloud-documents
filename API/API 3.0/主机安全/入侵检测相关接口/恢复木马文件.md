...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：RecoverMalwares |
| Version | 是 | String | 公共参数，本接口取值：2018-02-28 |
| Region | 否 | String | 公共参数，本接口不需要传递此参数。 |
| Ids.N | 是 | Array of Integer | 木马Id数组,单次最大删除不能超过200条 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| SuccessIds | Array of Integer | 恢复成功id数组|
| FailedIds | Array of Integer | 恢复失败id数组|
