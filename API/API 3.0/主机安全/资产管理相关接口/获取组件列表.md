...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/><li>ComponentVersion - String - 是否必填：否 - 组件版本号</li><li>MachineIp - String - 是否必填：否 - 主机内网IP</li> |
...
| Components | Array of [Component](/document/api/296/19867#Component) | 组件列表数据。|
