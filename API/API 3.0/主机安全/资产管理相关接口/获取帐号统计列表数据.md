...
| Filters.N | 否 | Array of [Filter](/document/api/296/19867#Filter) | 过滤条件。<br/><li>Username - String - 是否必填：否 - 帐号用户名</li> |
...
| AccountStatistics | Array of [AccountStatistics](/document/api/296/19867#AccountStatistics) | 帐号统计列表。|
