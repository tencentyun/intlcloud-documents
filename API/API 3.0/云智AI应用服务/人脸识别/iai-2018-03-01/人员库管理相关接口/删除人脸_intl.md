...
This API deletes the face images of a person. If the person has only one face image, an error will be returned.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeleteFace |
| Version | Yes | String | Common parameter; the value for this API: 2018-03-01 |
| Region | No | String | Common parameter; not passed in for this API |
| PersonId | Yes | String | Person ID |
| FaceIds.N | Yes | Array of String | The list of IDs of the faces to be deleted |

## 3. Output Parameters

| Parameter name | Type | Description |
|---------|---------|---------|
| SucDeletedNum | Integer | Number of faces successfully deleted |
| SucFaceIds | Array of String | The list of IDs of the faces successfully deleted |
| RequestId | String | The unique request ID which is returned for each request. The RequestId for the current request needs to be provided when troubleshooting |

## 4. Sample

### Sample 1. API for Deleting Faces

This API deletes the face images of a person

#### Input Sample Code

```
https://iai.tencentcloudapi.com/?Action=DeleteFace
&PersonId=1001
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=iai&Version=2018-03-01&Action=DeleteFace)
