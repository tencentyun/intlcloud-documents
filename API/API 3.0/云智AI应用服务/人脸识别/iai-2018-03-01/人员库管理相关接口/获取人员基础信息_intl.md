...
This API gets information about the specified person, including name, gender, and face.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: GetPersonBaseInfo |
...
### Sample 1. API for Getting Basic Information of a Person
