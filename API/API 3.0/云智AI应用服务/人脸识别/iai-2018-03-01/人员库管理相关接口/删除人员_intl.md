...
This API deletes a person, which will cause them to be deleted from all groups. Meanwhile, all face information corresponding to the person will be deleted.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: DeletePerson |
...
### Sample 1. API for Deleting a Person

This API deletes the information of a specified person

#### Input Sample Code

```
https://iai.tencentcloudapi.com/?Action=DeletePerson
&PersonId=2001
&Version=2018-03-01
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=iai&Version=2018-03-01&Action=DeletePerson)
