...
| GroupName | 否 | String | 人员库名称 |
| GroupExDescriptionInfos.N | 否 | Array of [GroupExDescriptionInfo](https://cloud.tencent.com/document/api/867/32807#GroupExDescriptionInfo) | 需要修改的人员库自定义描述字段，key-value |
| Tag | 否 | String | 人员库信息备注 |
