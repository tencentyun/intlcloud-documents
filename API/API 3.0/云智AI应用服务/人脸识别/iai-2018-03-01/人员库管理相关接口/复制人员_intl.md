...
This API copies a person in a group to another group (without copying the person's description). One person can exist in up to 100 groups at the same time.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CopyPerson |
| Version | Yes | String | Common parameter; the value for this API: 2018-03-01 |
| Region | No | String | Common parameter; not passed in for this API |
| PersonId | Yes | String | Person ID |
| GroupIds.N | Yes | Array of String | The list of groups to add the person to |

## 3. Output Parameters

| Parameter name | Type | Description |
|---------|---------|---------|
| SucGroupNum | Integer | Number of groups to which the person is successfully added |
| SucGroupIds | Array of String | The list of groups to which the person is successfully added |
| RequestId | String | The unique request ID which is returned for each request. The RequestId for the current request needs to be provided when troubleshooting |

## 4. Sample

### Sample 1. API for Copying a Person
