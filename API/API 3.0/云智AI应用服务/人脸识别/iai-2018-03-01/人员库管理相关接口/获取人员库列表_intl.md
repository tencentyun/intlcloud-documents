...
This API gets the list of groups.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: GetGroupList |
...
|---------|---------|---------|
| GroupInfos | Array of [GroupInfo](https://cloud.tencent.com/document/api/867/32807#GroupInfo) | Returned group information |
...
### Sample 1. API for Getting Group List
...
```
https://iai.tencentcloudapi.com/?Action=GetGroupList
&Offset=0
&Limit=10
&Version=2018-03-01
...
The number of returns cannot be above 1,000
...
```
{
  "Response": {
    "Error": {
      ...
      "Message": "The number of returns is out of the valid range."
    },
...
The starting number cannot be below 0
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=iai&Version=2018-03-01&Action=GetGroupList)
