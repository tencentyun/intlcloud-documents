...
This API modifies the person description of a specified group.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyPersonGroupInfo |
...
| PersonExDescriptionInfos.N | Yes | Array of [PersonExDescriptionInfo](https://cloud.tencent.com/document/api/867/32807#PersonExDescriptionInfo) | Content of the person description field to be modified; key-value |
...
### Sample 1. API for Modifying a Person Description

#### Input Sample Code

```
https://iai.tencentcloudapi.com/?Action=ModifyPersonGroupInfo
...
### Sample 2. API for Modifying a Person Description
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=iai&Version=2018-03-01&Action=ModifyPersonGroupInfo)
