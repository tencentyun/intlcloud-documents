...
This API modifies the information of a person, including name and gender. The changes to person name and gender will be synchronized to all the groups that contain the person.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: ModifyPersonBaseInfo |
| Version | Yes | String | Common parameter; the value for this API: 2018-03-01 |
| Region | No | String | Common parameter; not passed in for this API |
| PersonId | Yes | String | Person ID |
| PersonName | No | String | Person name to be modified |
| Gender | No | Integer | Gender of the person to be modified |
...
### Sample 1. API for Modifying a Person's Basic Information

#### Input Sample Code

```
https://iai.tencentcloudapi.com/?Action=ModifyPersonBaseInfo
&PersonId=1001
&PersonName=EvanLiao
&Gender=1
&Version=2018-03-01
...
### Sample 2. API for Modifying a Person's Basic Information
...
Error with the set person gender
...
```
{
  "Response": {
    "Error": {
      ...
      "Message": "Error with the set person gender. 0 - blank; 1 - male; 2 - female."
    },
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=iai&Version=2018-03-01&Action=ModifyPersonBaseInfo)
