...
This API determines whether a person in an image corresponds to a given PersonId. For more information about PersonId, see the [group management APIs](https://cloud.tencent.com/document/product/867/32794). Unlike the [face comparison](https://cloud.tencent.com/document/product/867/32802) API, [face verification](https://cloud.tencent.com/document/product/867/32806) is used to determine "whether the person in the image is someone specified" whose information is stored in a group. This "someone" may have multiple face images, and [face comparison](https://cloud.tencent.com/document/product/867/32802) is used to determine the similarity between two faces.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: VerifyFace |
| Version | Yes | String | Common parameter; the value for this API: 2018-03-01 |
| Region | No | String | Common parameter; not passed in for this API |
| PersonId | Yes | String | ID of the person to be verified. For more information about PersonId, see the group management APIs. |
...
|---------|---------|---------|
| Score | Float | Similarity between the given face image and the PersonId. If there are multiple faces under the PersonId, the score of the highest similarity is returned. |
| IsMatch | Boolean | The judgment whether the person in the image matches the PersonId. |
