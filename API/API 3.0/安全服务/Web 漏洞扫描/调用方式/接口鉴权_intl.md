...
2) Request host: The domain name of the request to view the list of instances (DescribeInstances) is cvm.tencentcloudapi.com. The actual request domain name varies for different modules to which the API belongs. For details, see the instructions of the specific API.
