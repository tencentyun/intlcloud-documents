...
This API (CreateSites) is used to add one or more websites.
...
|---------|---------|---------|---------|
| Action | Yes | String | Common parameter; the value for this API: CreateSites |
...
| UserAgent | No | String | ID of the client accessing the website |

## 3. Output Parameters

| Parameter name | Type | Description |
|---------|---------|---------|
| Number | Integer | Number of new websites. |
| RequestId | String | The unique request ID which is returned for each request. The RequestId for the current request needs to be provided when troubleshooting. |

## 4. Examples

### Example 1. Adding Website for Scan

#### Input Example

```
https://cws.tencentcloudapi.com/?Action=CreateSites
