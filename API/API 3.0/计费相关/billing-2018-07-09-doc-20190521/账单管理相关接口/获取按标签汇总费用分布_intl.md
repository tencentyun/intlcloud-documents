...
| SummaryOverview | [TagSummaryOverviewItem](/document/api/555/19183#TagSummaryOverviewItem) | Detailed cost distribution for all tags<br/>Note: This field may return null, indicating that no valid values can be obtained. |
