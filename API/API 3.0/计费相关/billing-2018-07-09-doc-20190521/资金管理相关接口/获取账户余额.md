...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：DescribeAccountBalance |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Balance | Integer | 云账户信息中的”展示可用余额”字段，单位为"分"|
...
```
https://billing.tencentcloudapi.com/?Action=DescribeAccountBalance
&<公共请求参数>
```
...
* [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=billing&Version=2018-07-09&Action=DescribeAccountBalance)
